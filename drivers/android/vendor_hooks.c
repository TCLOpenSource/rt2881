...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_write_oom_score_adj);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_wakeup_kswapd);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_kswapd_sleep);
#endif /* CONFIG_RTK_KDRV_KILLER */
#ifdef CONFIG_RTK_KDRV_ADJUSTER
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_update_oom_score_adj);
#endif
