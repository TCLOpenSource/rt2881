...
typedef struct HAL_AUDIO_DSPGAIN
{
    SINT32 dsp_gain;
    SINT32 dsp_fine;
} HAL_AUDIO_DSPGAIN_T ;
...
typedef  enum
{
	...
	HAL_AUDIO_ADEC6     = 6,
	HAL_AUDIO_ADEC7     = 7,
	HAL_AUDIO_ADEC_MAX  = HAL_AUDIO_ADEC7,
...
typedef  enum
{
	AUDIO_MIX_ADEC0 = (1 << 0), 	/*Audio Decoder Input 0*/
	AUDIO_MIX_ADEC1 = (1 << 1), 	/*Audio Decoder Input 1*/
	AUDIO_MIX_ADEC2 = (1 << 2), 	/*Audio Decoder Input 2*/
	AUDIO_MIX_ADEC3 = (1 << 3), 	/*Audio Decoder Input 3*/
	AUDIO_MIX_ADEC4 = (1 << 4), 	/*Audio Decoder Input 4*/
	AUDIO_MIX_ADEC5 = (1 << 5), 	/*Audio Decoder Input 5*/
	AUDIO_MIX_ADEC6 = (1 << 6), 	/*Audio Decoder Input 6*/
	AUDIO_MIX_ADEC7 = (1 << 7), 	/*Audio Decoder Input 7*/
	AUDIO_MIX_AMIX0 = (1 << 8), 	/*Audio Mixer Input (ALSA) 0*/
	AUDIO_MIX_AMIX1 = (1 << 9), 	/*Audio Mixer Input (ALSA) 1*/
	AUDIO_MIX_AMIX2 = (1 << 10), 	/*Audio Mixer Input (ALSA) 2*/
	AUDIO_MIX_AMIX3 = (1 << 11), 	/*Audio Mixer Input (ALSA) 3*/
	AUDIO_MIX_AMIX4 = (1 << 12), 	/*Audio Mixer Input (ALSA) 4*/
	AUDIO_MIX_AMIX5 = (1 << 13), 	/*Audio Mixer Input (ALSA) 5*/
	AUDIO_MIX_AMIX6 = (1 << 14), 	/*Audio Mixer Input (ALSA) 6*/
	AUDIO_MIX_AMIX7 = (1 << 15), 	/*Audio Mixer Input (ALSA) 7*/
	AUDIO_MIX_ALL = 0xFFFF,
} HAL_AUDIO_MIX_INDEX_T;
...
typedef  enum
{
	HAL_AUDIO_DP0			= 0,
	HAL_AUDIO_DP1			= 1,
	HAL_AUDIO_DP_MAX		= HAL_AUDIO_DP1,
} HAL_AUDIO_DP_INDEX_T;
...
typedef  enum
{
	...
	HAL_AUDIO_BT3           = 0x400,
	HAL_AUDIO_BT4           = 0x800,
	HAL_AUDIO_UAC1          = 0x1000,
	HAL_AUDIO_UAC2          = 0x2000,
} HAL_AUDIO_SNDOUT_T;
...
typedef  enum
{
	...
	HAL_AUDIO_RESOURCE_DP				= 34,	/* Audio Display Port 0. */
	HAL_AUDIO_RESOURCE_DP1				= 35,	/* Audio Display Port 1. */
	HAL_AUDIO_RESOURCE_ADEC2			= 36,
	HAL_AUDIO_RESOURCE_ADEC3			= 37,
	HAL_AUDIO_RESOURCE_ADEC4			= 38,
	HAL_AUDIO_RESOURCE_ADEC5			= 39,
	HAL_AUDIO_RESOURCE_ADEC6			= 40,
	HAL_AUDIO_RESOURCE_ADEC7			= 41,
	HAL_AUDIO_RESOURCE_I2SIN			= 42,
	HAL_AUDIO_RESOURCE_UACIN			= 43,
	HAL_AUDIO_RESOURCE_SPDIFIN			= 44,
	HAL_AUDIO_RESOURCE_MAX				= 45,	/* Audio Resource Max */
...
typedef  enum
{
	...
	HAL_AUDIO_ARC_BYPASS_EAC3_AAC_DTSHD = 41,
        HAL_AUDIO_ARC_BYPASS_MAT_TRUEHD     = 42,
        HAL_AUDIO_ARC_BYPASS_MAT_TRUEHD_NODTSHD = 43,
        HAL_AUDIO_ARC_BYPASS_MAT_TRUEHD_NODTS   = 44,
...
typedef  enum
{
	HAL_AUDIO_TRICK_NORMAL_PLAY			= 0, 	///<  rate : Normal Play, DVR Play
	HAL_AUDIO_TRICK_SLOW_MOTION_0P25X 	= 1,	///<  rate : 0.25 Play
	HAL_AUDIO_TRICK_SLOW_MOTION_0P50X 	= 2,	///<  rate : 0.50 Play
	HAL_AUDIO_TRICK_SLOW_MOTION_0P75X 	= 3,	///<  rate : 0.75 Play
	HAL_AUDIO_TRICK_FAST_FORWARD_1P25X 	= 4, 	///<  rate : 1.25 Play
	HAL_AUDIO_TRICK_FAST_FORWARD_1P50X 	= 5, 	///<  rate : 1.50 Play
	HAL_AUDIO_TRICK_FAST_FORWARD_1P75X 	= 6, 	///<  rate : 1.75 Play
	HAL_AUDIO_TRICK_FAST_FORWARD_2P00X	= 7,	///<  rate : 2.00 Play
...
typedef enum {
  ...
  HAL_AUDIO_VX_PARAM_TSX_APP_LSTNR_DIST,
  HAL_AUDIO_VX_PARAM_TSX_APP_BTTMSPKTOCTR_DIST,
  HAL_AUDIO_VX_PARAM_TSX_APP_TOPSPKTOCTR_DIST,
  ...
  HAL_AUDIO_VX_PARAM_TBHDX_APP_FRT_SPKSZIR,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_FRT_BASSCTRL,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_FRT_HPRATIO,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_FRT_EXTBASS,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_CTR_SPKSZIR,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_CTR_BASSCTRL,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_CTR_HPRATIO,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_CTR_EXTBASS,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_SUR_SPKSZIR,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_SUR_BASSCTRL,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_SUR_HPRATIO,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_SUR_EXTBASS,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_REAR_SPKSZIR,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_REAR_BASSCTRL,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_REAR_HPRATIO,
  HAL_AUDIO_VX_PARAM_TBHDX_APP_REAR_EXTBASS,
  ...
  HAL_AUDIO_VX_PARAM_MBHL_APP_LOWCROSS,
  HAL_AUDIO_VX_PARAM_MBHL_APP_MIDCROSS,
  ...
  HAL_AUDIO_VX_PARAM_AEQ_CH_LINK,
  HAL_AUDIO_VX_PARAM_AEQ_BAND_NUM,
  HAL_AUDIO_VX_PARAM_AEQ_BAND_EN,
  HAL_AUDIO_VX_PARAM_AEQ_BAND_FREQ,
  HAL_AUDIO_VX_PARAM_AEQ_BAND_GAIN,
  HAL_AUDIO_VX_PARAM_AEQ_BAND_Q_FACOTR,
  HAL_AUDIO_VX_PARAM_AEQ_BAND_TYPE,
  ...
  HAL_AUDIO_VX_PARAM_ILDETECT_UPMIX_ENABLE_I32,
  HAL_AUDIO_VX_PARAM_ILDETECT_UPMIX_LOW_LEVEL_THRESHOLD_I32,
  HAL_AUDIO_VX_PARAM_ILDETECT_UPMIX_PEAK_HOLD_COUNT_I32,
  HAL_AUDIO_VX_PARAM_ILDETECT_UPMIX_ORIGLR_MIXBACK_I32,
  HAL_AUDIO_VX_PARAM_ILDETECT_UPMIX_SURROUND_GAIN_I32,
  HAL_AUDIO_VX_PARAM_ILDETECT_UPMIX_SRRND_DELAY_ENABLE_I32,
  HAL_AUDIO_VX_PARAM_ILDETECT_UPMIX_PROCESS_DISCARD_I32,
  HAL_AUDIO_VX_PARAM_ILDETECT_UPMIX_CONTROLS_STU,
...
typedef struct HAL_AUDIO_RHAL_INFO
{
    ...
    HAL_AUDIO_MIX_INDEX_T           audiomixIndex;
