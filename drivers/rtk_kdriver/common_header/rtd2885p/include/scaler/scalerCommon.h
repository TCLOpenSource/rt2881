...
#define	REDUCE_DI_HSD_WIDTH_LIMIT_THRESHOLD		3840//this is for RTRN input max size
//
//[crixus]scart out
...
typedef struct _SLR_VOINFO {
    ...
    */
    ...
    unsigned int                        adaptive_flag;
    unsigned int                        voUsing2pMode;
} SLR_VOINFO;
// oliver-
