...
typedef struct _VIP_SCALER_Decide_NNSR_scaling_up_INFO {
	...
	unsigned int vtotal;
	unsigned int htotal;
	unsigned int s1_freq;
	unsigned int vblank;
	unsigned int vact_input;
	unsigned int hact_input;
	unsigned int hend;
	unsigned int vend;
	unsigned int tbMode;
	unsigned int tbv;
	unsigned int tbh;
	unsigned int linerate_ratio;
	unsigned int SrnnClk;
	unsigned int mode_support;

	unsigned int PC_mode_check;
	unsigned int Main_iSize_nWidth;
	unsigned int Main_iSize_nLength;
	unsigned int Main_oSize_nWidth;
	unsigned int Main_oSize_nLength;
	unsigned int Sub_iSize_nWidth;
	unsigned int Sub_iSize_nLength;
	unsigned int iFrameRate;
	unsigned int isSubIdle_forNNSR;
	unsigned int drv_memory_get_game_mode_flag;
	unsigned int fwif_color_Get_PQ_SR_MODE;
	unsigned int NNSR_byPass_flag;
	unsigned int dataFs;
	unsigned int is_scaler_input_2p_mode;
	unsigned int force_enable_two_step_uzu;	
	unsigned int get_hdmi_vrr_4k60_mode;
	unsigned int Get_DISPLAY_REFRESH_RATE;
	unsigned int AI_SR_MODE;
	unsigned int ScalerGetMainINFO_SLR_INPUT_V_FREQ_1000;
	
	unsigned int _90k_clk;
} VIP_SCALER_Decide_NNSR_scaling_up_INFO;

typedef struct _VIP_SMT_Decide_NNSR_scaling_up_INFO {
	unsigned int pixel_clk;
	unsigned int vact;
	unsigned int hact;
	unsigned int vsta;
	...
	unsigned int iFrameRate;
	unsigned int isSubIdle_forNNSR;
	unsigned int scaler_get_gamemode_fs;
	unsigned int scaler_get_gamemode_frc;
	unsigned int ScalerVIP_Get_SR_MODE;
	unsigned int NNSR_byPass_flag;
	unsigned int dataFs;
	unsigned int IMD_SCALER_INPUT_2P_MODE;
	unsigned int force_enable_two_step_uzu;
	unsigned int Get_DISPLAY_REFRESH_RATE;
	unsigned int AI_SR_MODE;
	unsigned int IMD_SMOOTH_V_FREQ_1000;
	
	unsigned int _90k_clk;
} VIP_SMT_Decide_NNSR_scaling_up_INFO;

typedef struct _VIP_Decide_NNSR_scaling_up_INFO {
	VIP_SCALER_Decide_NNSR_scaling_up_INFO NNSR_SCALER_INFO;
	VIP_SMT_Decide_NNSR_scaling_up_INFO NNSR_SMT_INFO;
	unsigned int final_apply_flag;
	
} VIP_Decide_NNSR_scaling_up_INFO;
...
typedef struct _VIP_ScalingUp_Ctrl{
	...
	VIP_Decide_NNSR_scaling_up_INFO Decide_NNSR_scaling_up_INFO;
} VIP_ScalingUp_Ctrl;
