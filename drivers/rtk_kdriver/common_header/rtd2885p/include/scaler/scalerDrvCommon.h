...
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE 0x77
...
#define DTGM_2_GOLDEN_VSYNC_LINE_DELAY_7F 0x7F
#define DTGM_2_GOLDEN_VSYNC_PIXE_LDELAY_0  0

#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_INX_144PANEL 0x6b
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL 0x0 // 0x8c
...
#define MAX_VO_VSYNC_DELAY_LINE_CNT 4   // Maximum VO to UZD Vsync line delay ( from DIC )
...
#define WIDTH_FOR_EDGESMOOTH_DECIDE_LINE_MODE 2048

// enable 2nd-uzu with main path only parameters
#define PQDC_MINI_PORCH 50  // DIC theoretical value in PQDC line buffer mode : 20
...
SCALERIOC_FILM_CTRL_MEMC,
SCALERIOC_SUB_SRNN,//sub srnn
SCALERIOC_SMOOTH_TOGGLE_STATUS_UNDER_GAME_MODE,
SCALERIOC_ECO_MODE,
SCLAERIOC_SET_VT_DC2H_BUF_STATUS,
FORCE_RUN_FAKE_SCALER_STATE,
DOLBY_VISION_L1L4_STATS,
...
#if 1 //not move to nonlibdma_scalerDrvCommon.h, change to use commonly
...
#endif
#endif //move to nonlibdma_scalerDrvCommon.h
...
typedef enum
{
	DOLBY_HDR1_OUTPUT_SELECT_HDR1 = 0,
	DOLBY_HDR1_OUTPUT_SELECT_HW5,
	DOLBY_HDR2_OUTPUT_SELECT_HDR2,
	DOLBY_HDR2_OUTPUT_SELECT_HW5_CORE2_SLICE0,
	DOLBY_HDR2_OUTPUT_SELECT_HW5_CORE2_SLICE1,
}DOLBY_HDR_OUTPUT_SELECT_T;
...
struct dolby_vision_l1l4_stats {
	unsigned short min;
	unsigned short max;
	unsigned short mid;
	unsigned short std;
