...
enum vpq_ioc_pq_cmd
{
	...
	VPQ_IOC_PQ_CMD_GET_90K_CLK = 86,
	VPQ_IOC_PQ_CMD_GENERAL_CMD = 87,
	VPQ_IOC_PQ_CMD_GET_NN_TEE_BUF = 88,
	VPQ_IOC_PQ_CMD_FREE_NN_TEE_BUF = 89,
	VPQ_IOC_PQ_CMD_GET_AI_MODEL_LIST = 90,
	VPQ_IOC_PQ_CMD_EN_AI_DBGOSD = 91,
	VPQ_IOC_PQ_CMD_GET_AI_ALLOW_MODE = 92,
	VPQ_IOC_PQ_CMD_AI_SET_AP_MASK  = 93,
	VPQ_IOC_PQ_CMD_AI_GET_AP_STATE = 94,
	VPQ_IOC_PQ_CMD_AI_GET_FACE_LIST = 95,
};
...
enum {
	VPQ_GENERAL_CMD_GET_90KCLK = 0,
	VPQ_GENERAL_CMD_SEMANTIC_DONE,
	VPQ_GENERAL_CMD_NUM,
};
...
typedef struct {
	uint8_t count;
	NN_FACE_RECT_T list[AI_MAX_FACE_NUM];
} NN_FACE_T;
...
#define VPQ_IOC_GET_90K_CLK						_IOR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_GET_90K_CLK, unsigned int)
#define VPQ_IOC_PQ_GENERAL_CMD					_IOWR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_GENERAL_CMD, CMD_GENERAL_T)
#define VPQ_IOC_GET_NN_TEE_BUF				    _IOWR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_GET_NN_TEE_BUF, NN_BUF_INFO_T)
#define VPQ_IOC_FREE_NN_TEE_BUF				    _IOWR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_FREE_NN_TEE_BUF, NN_BUF_INFO_T)
#define VPQ_IOC_AI_MODEL_LIST			_IOR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_GET_AI_MODEL_LIST, unsigned int)
#define VPQ_IOC_EN_AI_DBGOSD			_IOW(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_EN_AI_DBGOSD, NN_DBGOSD_T)
#define VPQ_IOC_AI_ALLOW_MODE			_IOR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_GET_AI_ALLOW_MODE, unsigned int)
#define VPQ_IOC_AI_SET_AP_MASK			_IOW(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_AI_SET_AP_MASK, NN_APMASK_T)
#define VPQ_IOC_AI_GET_AP_STATE			_IOR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_AI_GET_AP_STATE, unsigned int)
#define VPQ_IOC_AI_GET_FACE_LIST		_IOR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_AI_GET_FACE_LIST, unsigned int)
