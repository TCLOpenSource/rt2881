...
typedef struct _VIP_NN_MEMORY_CTRL {
	...
	u32 *pVir_addr_align;
#ifndef CONFIG_ARM64
	u32 *reserve;	// reserve another 4 bytes to align with ap
#endif
} VIP_NN_MEMORY_CTRL;
#else
...
typedef enum _VIP_NN_BUFFER_INDEX{
	...
	VIP_NN_BUFFER_480FULLDEFOCUS=9,		// defocus
	VIP_NN_BUFFER_MAX,
} VIP_NN_BUFFER_INDEX;
...
#define AI_DEFOCUS_WIDTH			480
#define AI_DEFOCUS_HEIGHT			256
#define AI_DEFOCUS_OUTPUT_WIDTH		480
#define AI_DEFOCUS_OUTPUT_HEIGHT	256

#define VIPLITE_HEAP_SIZE (30*1024*1024)
#define NN_TA_HEAP_SIZE   (8*1024*1024)
#define MODEL_HEAP_SIZE   (0)//(1*1024*1024)
