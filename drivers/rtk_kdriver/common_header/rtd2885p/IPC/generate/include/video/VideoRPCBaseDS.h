...
extern  bool_t xdr_VIDEO_ENC_LEVEL (XDR *, VIDEO_ENC_LEVEL*);
...
extern  bool_t xdr_VIDEO_RESOURCE_INFO_TYPE (XDR *, VIDEO_RESOURCE_INFO_TYPE*);
...
extern bool_t xdr_VIDEO_ENC_LEVEL ();
...
extern bool_t xdr_VIDEO_RESOURCE_INFO_TYPE ();
