...
#define RPC_TOAGENT_SET_DEFAULT_PRL_SVC     AUDIO_RPC_ToAgent_SetDefaultPrl_0_svc
#define RPC_TOAGENT_SET_AC4_DIALENHANCE_GAIN_SVC    AUDIO_RPC_ToAgent_Set_AC4_DialEnhanceGain_0_svc
#define RPC_TOAGENT_AO_LGSE_SETDOWNMIX_SVC  AUDIO_RPC_ToAgent_AO_LGSE_SetDownMix_0_svc
#define RPC_TOAGENT_SET_AC4_PRESGROUPIDX_SVC  AUDIO_RPC_ToAgent_Set_AC4_PresGroupIdx_0_svc
...
#define RPC_TOAGENT_SETSEGMENTSHM_SVC		AUDIO_RPC_ToAgent_SetSegmentShm_0_svc
