...
//	 UINT32 PPOVERLAY_memcdtg_FREE_DH_TOTAL_S_R;
	...
	//OSD SPLIT
	 unsigned int PPOVERLAY_osddtg_DV_TOTAL_S_R; 
	 unsigned int PPOVERLAY_osddtg_DH_TOTAL_S_R;
	 unsigned int PPOVERLAY_osddtg_DV_DEN_Start_End_S_R;
	 unsigned int PPOVERLAY_osddtg_DH_DEN_Start_End_S_R;
	 unsigned int PPOVERLAY_OSDDTG_CONTROL_S_R;
	 unsigned int PPOVERLAY_OSDDTG_CONTROL2_S_R;
	 unsigned int PPOVERLAY_osddtg_fractional_fsync_S_R;
	 unsigned int PPOVERLAY_osd_dtg_dh_width_S_R;
	 unsigned int PPOVERLAY_osd_dtg_dv_length_S_R;
	 ...
	 UINT32 SFG_PIF_FIFO_CTRL2B_S_R;
	 UINT32 SFG_PIF_FIFO_CTRL2C_S_R;
	 UINT32 SFG_PIF_FIFO_CTRL3_S_R;
	 UINT32 SFG_PIF_FIFO_CTRL4_S_R;
	 UINT32 SFG_PIF_FIFO_CTRL5_S_R;
	 UINT32 SFG_PIF_FIFO_CTRL5B_S_R;
	 ...
	 UINT32 SFG_PIF_MUX_CLK_SEL0_S_R;
	 UINT32 SFG_PIF_MUX_CLK_SEL1_S_R;
	 UINT32 SFG_PIF_FIFO_MUX_CTRL1_S_R;
	 UINT32 SFG_PIF_FIFO_MUX_CTRL2_S_R;
	 UINT32 SFG_PIF_FIFO_MUX_CTRL2B_S_R;
	 ...
	 UINT32 SFG_TXPLL_CLK_SEL_CTL_S_R;
 ...
 /* need confirm @k4l  <=== */
	 ...
	 //vby1 osd
	 unsigned int VBY1_OSD_OSD_VIDEO_FORMAT_S_R;
	 unsigned int VBY1_OSD_OSD_LANE_STATUS_S_R;
	 unsigned int VBY1_OSD_OSD_CTL_S_R;
	 unsigned int VBY1_OSD_OSD_TRANSMIT_CONTROL_S_R;
	 unsigned int VBY1_OSD_OSD_THREE_FLAG_S_R;
	 unsigned int VBY1_OSD_OSD_CRC_CONTROL_S_R;
	 unsigned int VBY1_OSD_OSD_VBY1_STATUS_FW_CTRL_S_R;
	 unsigned int VBY1_OSD_OSD_DPHY_CTL_S_R;
	 ...
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_A_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_B_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_C_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_D_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_E_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_F_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_G_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_H_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_I_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_J_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_K_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_L_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_M_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_N_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_O_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDS_PHY_CTRL_P_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60A_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60B_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60C_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60D_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60E_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60F_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60G_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60H_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60I_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60J_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60K_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60L_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60M_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60N_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60O_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_60P_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61A_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61B_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61C_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61D_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61E_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61F_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61G_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61H_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61I_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61J_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61K_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61L_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61M_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61N_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61O_S_R;
	 UINT32 PINMUX_LVDSPHY_LVDSEPIVBY1_PHY_CTRL_1_61P_S_R;
