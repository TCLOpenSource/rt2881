...
typedef struct
{
	...
	signed char nHPLLTune1;	/* for tunning HPLL */
	signed char nHPLLTune2;	/* for tunning HPLL */
	signed char nHPLLTune3;	/* for tunning HPLL */
	signed char nHPLLTune4;	/* for tunning HPLL */

	unsigned char nColorKillEnable;
	signed char nColorKillTune1;	/* for tunning Color Kill Level */
	signed char nColorKillTune2;	/* for tunning Color Kill Level */
	signed char nColorKillTune3;	/* for tunning Color Kill Level */
	signed char nColorKillTune4;	/* for tunning Color Kill Level */

	signed char nLockThreshold1;	/* for tunning Lock sensitivity */
	signed char nLockThreshold2;	/* for tunning Lock sensitivity */
