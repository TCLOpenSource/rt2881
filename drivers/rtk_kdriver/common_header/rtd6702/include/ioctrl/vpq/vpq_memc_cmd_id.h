...
#define VPQ_IOC_MEMC_SETBLUR_UILEVEL		_IOW(VPQ_IOC_MEMC_MAGIC, 23, int)
#define VPQ_IOC_MEMC_SETJUDDER_UILEVEL		_IOW(VPQ_IOC_MEMC_MAGIC, 24, int)
#define VPQ_IOC_MEMC_SETBLUR_MOTIONLEVEL		_IOW(VPQ_IOC_MEMC_MAGIC, 25, int)
#define VPQ_IOC_MEMC_SETJUDDER_MOTIONLEVEL		_IOW(VPQ_IOC_MEMC_MAGIC, 26, int)
#define VPQ_IOC_MEMC_SET_TABLE_FROM_BIN				_IOW(VPQ_IOC_MEMC_MAGIC, 27, int)

#define VPQ_MEMC_IOC_MAXNR 28
#else
#define VPQ_IOC_MEMC_SET_TABLE_FROM_BIN				_IOW(VPQ_IOC_MEMC_MAGIC, 23, int)
#define VPQ_MEMC_IOC_MAXNR 24
#endif
