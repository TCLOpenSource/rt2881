...
typedef enum _VIP_NN_BUFFER_INDEX{
	...
	VIP_NN_BUFFER_256FULL=5,		//object segment
	VIP_NN_BUFFER_480FULL=6,		// semantic
	VIP_NN_BUFFER_MAX,
	VIP_NN_BUFFER_240X136CROP,	//hack for rhal compile,not support on mark2
} VIP_NN_BUFFER_INDEX;
...
#define VIPLITE_HEAP_SIZE (38*1024*1024)
#define MODEL_HEAP_SIZE   (1*1024*1024)
#define NB_BUF_SIZE       (3*1024*1024+128*1024)
