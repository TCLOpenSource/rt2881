...
#define	REDUCE_SDNR_WIDTH_LIMIT_THRESHOLD		8192//this is for RTRN input max size
#define	REDUCE_DI_HSD_WIDTH_LIMIT_THRESHOLD		8192//this is for RTRN input max size
//
//[crixus]scart out
...
typedef struct _StructDisplayInfo{
	...
	unsigned char vodma_plane;
      ...
      unsigned short rgb_quantization_range;
      unsigned short ycc_quantization_range;
      unsigned short ext_colorimetry;
      unsigned char inClk4PixelMode; // input source in 4 pixel mode
      unsigned char hdmitxDscSrc;
#endif
...
/* === HDMITX ========== */
	TX_TIMING_READY_IDX,
	VO_SET_GATING_IDX,
	VO_IV_CHANGE, // Signal to VO when TX needs timing change
	VO_ENABLE_GATING_IDX,
/* === HDMITX End ========== */
