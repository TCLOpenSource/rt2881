...
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE 0x74
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_8K 0xc1
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_120PANEL 0x67
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_144PANEL 0x9a
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL 0x86b
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL_8K 0xfab
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL_144PANEL 0x57
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_GAMEMODE  0x37 // since nnsr mode enlarge delay, add extra 0x30 delay to avoid frame tear
...
#define DTG_DEFAULT_S1IP_LINE_DELAY_8K 0x47 //hw default setting 71
#define DTG_DEFAULT_S1IP_UZU3RD_LINE_DELAY_8K 0xf //hw default setting 15
#define DTG_DEFAULT_TIME_BORROW_V_8K 0x23 //hw default setting for time borrow 35
...
#define _VO_GATTING_OFFSET 8 // vo lead to den start tolerance
...
#define DEFAULT_FRC_IV2DV_DELAY 8
#define DEFAULT_FS_IV2DV_DELAY 8
...
#define DATAFS_DISABLE_GATTING_WIDTH 2048
#define DATAFS_DISABLE_GATTING_HEIGHT 1152
...
#if 1 // 6_buffer
#define ME_TOTAL_SIZE 0x663d20 // 0x673A40//0x654000
#define ME_SHARE_TOTAL_SIZE 0x38f40 // 0x84E40//0x1fa40
...
#define KME_TOTAL_SIZE_8K (ME_TOTAL_SIZE + ME_SHARE_TOTAL_SIZE + MV_INFO_TOTAL_SIZE)
#if 1 // MK2
#define KMC_TOTAL_SIZE_8buf_8bit 0x614B800 // 0x39D7D00 + 0x2463000 = 0x614B800
#define KMC_TOTAL_SIZE_8buf_10bit 0x3ce8800 + 0x2857800 // 0x4cba800 + 0x2857800
#define KMC_TOTAL_SIZE_6buf_10bit 0x57CD800 // 0x398be00 + 0x1E41A00

#define KMC_TOTAL_SIZE_8buf_8bit_8K 0xF20D000 // 0xA947000 + 0x48C6000
#define KMC_TOTAL_SIZE_8buf_10bit_8K 0x1CF89000 // 0x12FC0000 + 0x9FC9000
#define KMC_TOTAL_SIZE_6buf_10bit_8K 0x15BA6C00 // 0xE3D0000 + 0x77D6C00
#else // M7
#define KMC_TOTAL_SIZE_8buf_8bit 0x3ce8800
#define KMC_TOTAL_SIZE_8buf_10bit 0x3ce8800 // 0x4cba800
...
#define KMEMC_TOTAL_SIZE_8buf_8bit_8K (KME_TOTAL_SIZE + MEMC_IPME_TOTAL_SIZE + KME1_RPT_TOTAL_SIZE + KMC_TOTAL_SIZE_8buf_8bit_8K)
#define KMEMC_TOTAL_SIZE_8buf_10bit_8K (KME_TOTAL_SIZE + MEMC_IPME_TOTAL_SIZE + KME1_RPT_TOTAL_SIZE + KMC_TOTAL_SIZE_8buf_10bit_8K)
#define KMEMC_TOTAL_SIZE_6buf_10bit_8K (KME_TOTAL_SIZE + MEMC_IPME_TOTAL_SIZE + KME1_RPT_TOTAL_SIZE + KMC_TOTAL_SIZE_6buf_10bit_8K)
...
#define M_DOMAIN_WIDTH_8K 	(7680)
#define M_DOMAIN_LEN_8K		(4320)
...
#define CARVEOUT_FOR_MAIN_SIZE_16BITS	((drvif_memory_get_data_align((M_DOMAIN_WIDTH_4K * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_4K + FINAL_BURST_LENTH) * 3)
#define CARVEOUT_FOR_SUB_SIZE_12BITS	((drvif_memory_get_data_align((M_DOMAIN_WIDTH_4K * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_4K + FINAL_BURST_LENTH) * 3)
#define CARVEOUT_FOR_I3DDMA_SIZE_20BITS	((drvif_memory_get_data_align((M_DOMAIN_WIDTH_8K * 20 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_8K + FINAL_BURST_LENTH) * 3)
#else
#define CARVEOUT_FOR_MAIN_SIZE_16BITS	((((M_DOMAIN_WIDTH_4K * 16 + 256) / 8) * M_DOMAIN_LEN_4K + FINAL_BURST_LENTH) * 3)
#define CARVEOUT_FOR_SUB_SIZE_12BITS	((((M_DOMAIN_WIDTH_4K * 12 + 256) / 8) * M_DOMAIN_LEN_4K + FINAL_BURST_LENTH) * 3)
#define CARVEOUT_FOR_I3DDMA_SIZE_20BITS	((((M_DOMAIN_WIDTH_8K * 20 + 256) / 8) * M_DOMAIN_LEN_8K + FINAL_BURST_LENTH) * 3)
#endif
...
#endif
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE + FINAL_BURST_LENTH)//livezoomcase
#else //#ifdef CONFIG_BW_96B_ALIGNED
...
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K (((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8) * M_DOMAIN_LEN_MAX_SIZE + FINAL_BURST_LENTH)//livezoomcase
#endif
...
typedef enum {
     ...
     VO_FILM_8K4K,		//vo film mode 8k4k  50/60->25/30
