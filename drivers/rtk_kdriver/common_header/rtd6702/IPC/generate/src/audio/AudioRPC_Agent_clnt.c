...
extern void * AllocateRpcMem(int c,void *s);
extern INT8U ReleaseRpcMem(void *pMem);
#define AllocateMem(a,b) AllocateRpcMem((a),(b))
#define ReleaseMem(a) ReleaseRpcMem(a)
#else
