...
/**
 ************************************************************************
 * \fn  HRESULT  VIDEO_RPC_VOUT_ToAgent_VOCLOCK_TO_VODMA (void)
 * \brief
 *    This function is used to notify vodma to set vo clock
 *
 * \return
 *
 ************************************************************************
 */
HRESULT VIDEO_RPC_VOUT_ToAgent_VOCLOCK_TO_VODMA () = VIDEO_RPC_VOUT_FUNC_BASE + 701;
