...
#define HDCP2_IOC_HDCP_CertificateKey					_IOW(HDCP2_IOC_MAGIC, HDCP2_IOC_IDX_43, HDCP_CERT_KEY_PARA_T)
#define HDCP2_IOC_HDCP_CertificateTxKey					_IOW(HDCP2_IOC_MAGIC, HDCP2_IOC_IDX_44, HDCP_CERT_KEY_PARA_T)
#define HDCP2_IOC_HDCP_DeltTxKey					    _IOW(HDCP2_IOC_MAGIC, HDCP2_IOC_IDX_45, unsigned int)
#define HDCP2_IOC_HDCP_SetTxKey					        _IOW(HDCP2_IOC_MAGIC, HDCP2_IOC_IDX_46, HDCP_TX_KEY_PARA_T)
#define HDCP2_IOC_HDCP_ApplyTxKey				        _IOW(HDCP2_IOC_MAGIC, HDCP2_IOC_IDX_47, unsigned int)
#endif
