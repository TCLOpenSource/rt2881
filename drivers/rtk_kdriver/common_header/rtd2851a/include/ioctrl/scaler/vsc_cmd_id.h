...
typedef enum
{
	...
	KADP_VIDEO_DDI_WIN_COLOR_MAXN		/**< use to check overflow*/
...
typedef enum
{
    ...
    OPERATE_TCON_TYPE,      //tcon normal case
    OPERATE_HSR_TCON_TYPE,  //tcon hsr120 case
...
#define VSC_IOC_OPERATE_EXTEND                  _IOW(VSC_IOC_MAGIC, VSC_IOC_IDX_97, KADP_VSC_OPERATE_EXTEND_T)
