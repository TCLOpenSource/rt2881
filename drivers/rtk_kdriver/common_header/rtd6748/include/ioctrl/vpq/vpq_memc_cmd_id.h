...
#define VPQ_IOC_MEMC_GET_UI_SUPPORT					_IOW(VPQ_IOC_MEMC_MAGIC, 27, int)
#define VPQ_IOC_MEMC_SET_TABLE_FROM_BIN				_IOW(VPQ_IOC_MEMC_MAGIC, 28, int)

#define VPQ_MEMC_IOC_MAXNR 29
