...
typedef enum
{
	...
	SC_OUT_SINGLE_T       ,//<H13 DRIVE ¿äÃ» SINGLE TOP ONLY>
	SC_OUT_SINGLE_LA     ,
	SC_OUT_MAX            ,//MAX
...
typedef struct
{
    ...
    KADP_VIDEO_RECT_T active_size;//bbd result
    KADP_VIDEO_RECT_T ori_size;//video resolution
}KADP_BBD_RESULT_INFO;


/*
Update the BBD subcribe
*/
typedef struct
{
	KADP_VIDEO_WID_T wid;
	unsigned int bbd_subscribe_event;
}KADP_BBD_SUBSCRIBE_INFO;
...
typedef enum KADP_VSC_INPUT_TYPE
{
    ...
    KADP_VSC_INPUTSRC_HDD,
    KADP_VSC_INPUTSRC_VBY1RX,
    KADP_VSC_INPUTSRC_DP,
    KADP_VSC_INPUTSRC_CAMERA,
    KADP_VSC_INPUTSRC_MAX = KADP_VSC_INPUTSRC_CAMERA,
...
typedef struct
{
	KADP_VIDEO_WID_T wid;//main 0, sub 1
	unsigned char connect;//connect 1, disconnect 0
	unsigned char lowdelay;//lowdelay on 1, lowdelay off 0
	unsigned char dolby;//dolby video: 1
}VSC_FAKE_SCALER_PARA_T;
...
typedef struct
{
   	signed int format;	/**< update by LG */
...
/*
- KADP_VSC_DP_SRC_MINIDP: Mini dp
- KADP_VSC_DP_SRC_TYPEC: type type c
*/
typedef enum KADP_VSC_DP_SRC_TYPE
{
    KADP_VSC_DP_SRC_MINIDP = 0,
    KADP_VSC_DP_SRC_TYPEC
} KADP_VSC_DP_SRC_T;
...
#if defined(CONFIG_COMPAT) && defined(CONFIG_ARM64)
typedef struct KADP_VSC_OPERATE_EXTEND
{
    unsigned int operateType;
    unsigned int dataLen;
    unsigned int pExtendData;
}KADP_VSC_OPERATE_EXTEND_T;
#else
typedef struct KADP_VSC_OPERATE_EXTEND
{
    unsigned int operateType;
    unsigned int dataLen;
    unsigned char *pExtendData;
}KADP_VSC_OPERATE_EXTEND_T;

#endif

typedef struct KADP_VSC_AI_TRANS_FUNC_INFO {//for scaler to check av sync
	unsigned short Enable;		//Enable or disable
	unsigned short Frame_Delay_Num;	//frame delay number
} KADP_VSC_AI_TRANS_FUNC_INFO_T;

typedef enum
{
    OPERATE_MULTIVIEW = 0,  //multiview
    OPERATE_DLG_BY_AP,      //4k2k144 ap control dlg
    OPERATE_PMIC_TYPE,      //pmic normal case
    OPERATE_HSR_PMIC_TYPE,  //pmic hsr120 case
    OPERATE_TCON_TYPE,      //tcon default case
    OPERATE_HSR_TCON_TYPE,  //tcon 4k1k120 case
    OPERATE_HSR_INI_PARSE,  //panel ini parse

    //add support more tcon setting
    OPERATE_HSR_TCON_4k1k144_TYPE,
    OPERATE_HSR_TCON_4k2k144_TYPE,
    OPERATE_HSR_TCON_4k1k240_TYPE,
    OPERATE_HSR_TCON_4k1k288_TYPE,

    //add support more pmic setting
    OPERATE_HSR_PMIC_4k1k144_TYPE,
    OPERATE_HSR_PMIC_4k2k144_TYPE,
    OPERATE_HSR_PMIC_4k1k240_TYPE,
    OPERATE_HSR_PMIC_4k1k288_TYPE,
    //PANEL_ONLY_SUPPORT_FIXED_REFRESH
    OPERATE_PANEL_ONLY_SUPPORT_FIXED_REFRESH,

    //eye diagrams
    OPERATE_HSR_EYE_DEFAULT_TYPE,
    OPERATE_HSR_EYE_4k2k60_TYPE,
    OPERATE_HSR_EYE_4k1k120_TYPE,
    OPERATE_HSR_EYE_4k1k144_TYPE,
    OPERATE_HSR_EYE_4k2k120_TYPE,
    OPERATE_HSR_EYE_4k2k144_TYPE,
    OPERATE_HSR_EYE_4k1k240_TYPE,
    OPERATE_HSR_EYE_4k1k288_TYPE,
    OPERATE_HSR_EYE_4k1k300_TYPE,
    OPERATE_HSR_EYE_4k1k330_TYPE,
    //4k60 mode
    OPERATE_DIRECT_DRIVING,

    //add new tcon bin
    OPERATE_HSR_TCON_4k2k60_TYPE,
    OPERATE_HSR_TCON_4k2k120_TYPE
}KADP_OPERATE_TYPE;
...
#define VSC_IOC_SUBSCRIBE_BBD_EVENT             _IO(VSC_IOC_MAGIC,  VSC_IOC_IDX_94)
#define VSC_IOC_WAIT_BBD_INFO_QUEUE             _IO(VSC_IOC_MAGIC,  VSC_IOC_IDX_95)
#define VSC_IOC_FAKE_SCALER						_IOW(VSC_IOC_MAGIC, VSC_IOC_IDX_96, VSC_FAKE_SCALER_PARA_T)
#define VSC_IOC_OPERATE_EXTEND                  _IOW(VSC_IOC_MAGIC, VSC_IOC_IDX_97, unsigned int)
#define VSC_IOC_SET_AI_TRANS_FUNC_INFO				_IOW(VSC_IOC_MAGIC, VSC_IOC_IDX_98, KADP_VSC_AI_TRANS_FUNC_INFO_T)
