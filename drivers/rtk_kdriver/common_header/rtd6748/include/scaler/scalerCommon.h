...
/* 0.001Hz Precision */
#define V_FREQ_m_short_OFFSET			500		// 0.500Hz
#define V_FREQ_m_medium_OFFSET			1000	// 1.000Hz
#define V_FREQ_m_long_OFFSET			2000	// 2.000Hz

#define V_FREQ_m_23000					23000

#define V_FREQ_m_24000					24000
#define V_FREQ_m_24000_mOFFSET			( V_FREQ_m_24000 - V_FREQ_m_short_OFFSET ) // 23500

#define V_FREQ_m_24500					24500

#define V_FREQ_m_25000					25000
#define V_FREQ_m_25000_pOFFSET			( V_FREQ_m_25000 + V_FREQ_m_short_OFFSET ) // 25500

#define V_FREQ_m_30000					30000
#define V_FREQ_m_30000_mOFFSET			( V_FREQ_m_30000 - V_FREQ_m_short_OFFSET ) // 29500
#define V_FREQ_m_30000_pOFFSET			( V_FREQ_m_30000 + V_FREQ_m_short_OFFSET ) // 30500

#define V_FREQ_m_48000					48000
#define V_FREQ_m_48000_mOFFSET			( V_FREQ_m_48000 - V_FREQ_m_short_OFFSET ) // 39500
#define V_FREQ_m_48000_pOFFSET			( V_FREQ_m_48000 + V_FREQ_m_short_OFFSET ) // 40500

#define V_FREQ_m_50000					50000
#define V_FREQ_m_50000_mOFFSET			( V_FREQ_m_50000 - V_FREQ_m_short_OFFSET ) // 49500
#define V_FREQ_m_50000_pOFFSET			( V_FREQ_m_50000 + V_FREQ_m_short_OFFSET ) // 50500

#define V_FREQ_m_60000					60000
#define V_FREQ_m_60000_mOFFSET			( V_FREQ_m_60000 - V_FREQ_m_short_OFFSET ) // 59500
#define V_FREQ_m_60000_pOFFSET			( V_FREQ_m_60000 + V_FREQ_m_short_OFFSET ) // 60500

#define V_FREQ_m_100000					100000
#define V_FREQ_m_100000_mOFFSET			( V_FREQ_m_100000 - V_FREQ_m_medium_OFFSET) // 99000
#define V_FREQ_m_100000_pOFFSET			( V_FREQ_m_100000 + V_FREQ_m_medium_OFFSET) //101000

#define V_FREQ_m_120000					120000
#define V_FREQ_m_120000_mOFFSET			( V_FREQ_m_120000 - V_FREQ_m_medium_OFFSET) //119000
#define V_FREQ_m_120000_pOFFSET			( V_FREQ_m_120000 + V_FREQ_m_medium_OFFSET) //121000

#define V_FREQ_m_144000					144000
#define V_FREQ_m_144000_mOFFSET			( V_FREQ_m_144000 - V_FREQ_m_medium_OFFSET ) //143000
#define V_FREQ_m_144000_pOFFSET			( V_FREQ_m_144000 + V_FREQ_m_medium_OFFSET ) //145000

#define V_FREQ_m_165000					165000
#define V_FREQ_m_165000_mOFFSET			( V_FREQ_m_165000 - V_FREQ_m_medium_OFFSET ) //164000
#define V_FREQ_m_165000_pOFFSET			( V_FREQ_m_165000 + V_FREQ_m_medium_OFFSET ) //165000

#define V_FREQ_m_200000					200000
#define V_FREQ_m_200000_mOFFSET			( V_FREQ_m_200000 - V_FREQ_m_medium_OFFSET ) //199000
#define V_FREQ_m_200000_pOFFSET			( V_FREQ_m_200000 + V_FREQ_m_medium_OFFSET ) //201000

#define V_FREQ_m_240000					240000
#define V_FREQ_m_240000_mOFFSET			( V_FREQ_m_240000 - V_FREQ_m_medium_OFFSET ) //239000
#define V_FREQ_m_240000_pOFFSET			( V_FREQ_m_240000 + V_FREQ_m_medium_OFFSET ) //241000

#define V_FREQ_m_288000					288000
#define V_FREQ_m_288000_mOFFSET			( V_FREQ_m_288000 - V_FREQ_m_medium_OFFSET ) //287000
#define V_FREQ_m_288000_pOFFSET			( V_FREQ_m_288000 + V_FREQ_m_long_OFFSET   ) //290000
...
typedef enum _SCALER_RLK_I2C_ONLY_CMDS{
    SCALER_RLK_I2C_ONLY_HOST_DLG_MODE = 0,
    SCALER_RLK_I2C_ONLY_HOST_VRR = 1,
    SCALER_RLK_I2C_ONLY_HOST_FREESYNC = 2,
    SCALER_RLK_I2C_ONLY_CMDS_MAX,
} SCALER_RLK_I2C_ONLY_CMDS;
...
typedef struct _SLR_VOINFO {
    ...
    */
    ...
    unsigned int                        film_en;
    unsigned int                        oriFilmFramerate;
} SLR_VOINFO;
// oliver-
...
typedef enum {
	ROTATEBUF_IDX_CAP = 0,
	ROTATEBUF_IDX_DISP_FIRST,
	ROTATEBUF_IDX_DISP_SEC,
	ROTATEBUF_IDX_DISP_THIRD,
    ROTATEBUF_IDX_UNKNOWN
}eRotateBufIdx;
...
typedef struct _SCALER_DISP_INFO {
	...
	unsigned int	bypass_memc_cma_alloc_flag_scaler;
} SCALER_DISP_INFO;
...
typedef struct _FAKE_SHAREMEM_PARAM {
	unsigned int fake_scaler_state;
	unsigned int fake_low_delay;
	unsigned int fake_dolby;
} FAKE_SHAREMEM_PARAM;
