...
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_144PANEL 0x9a
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL 0x43
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL_39 0x39

#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL_144PANEL 0x57
...
#define DTG_VS_BY_HS_EN_IV2DV_OFFSET 0x3
...
#define _M_PRE_READ_MARGIN 3
#define _M_PRE_READ_MARGIN_FHD 6
#define _M_DATA_FS_PRE_READ 5
#define _VO_GATTING_OFFSET 10  // vo lead to den start tolerance
#define _VO_GATTING_OLED_OFFSET 3  // vo lead to den start tolerance

#define _VRR_MAX_SUPPORT_FRAMERATE (Get_DISPLAY_REFRESH_RATE() * 10)
...
HDMI_DOLBY_TYPE_FLAG,
SCALER_VIDEO_LATENCY,
...
#endif
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE + FINAL_BURST_LENTH)//4k pc mode size
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K120_CO_BUFFER (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE + 2*FINAL_BURST_LENTH)//4k120 co buffer size
#define MDOMAIN_MAIN_BUFFER_SIZE_10BITS_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 10 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE + FINAL_BURST_LENTH)//4k cp karaoke
...
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K (((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8) * M_DOMAIN_LEN_MAX_SIZE + FINAL_BURST_LENTH)//4k pc mode size
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K120_CO_BUFFER (((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8) * M_DOMAIN_LEN_MAX_SIZE + 2*FINAL_BURST_LENTH)//4k120 co buffer size
#define MDOMAIN_MAIN_BUFFER_SIZE_10BITS_4K (((M_DOMAIN_WIDTH_MAX_SIZE * 10 + 256) / 8) * M_DOMAIN_LEN_MAX_SIZE + FINAL_BURST_LENTH)//4k cp karaoke
...
typedef struct _SCLAER_VIDEO_LATENCY {
	unsigned int video_latency_main;
	unsigned int video_latency_sub;
} SCALER_VIDEO_LATENCY_DATA;

typedef struct _DOLBY_HDMI_DP_TYPE {
	unsigned int dolby_vsem;
	unsigned int main_dolby_type;
	unsigned int sub_dolby_type;
} DOLBY_HDMI_DP_TYPE;
