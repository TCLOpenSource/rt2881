...
#define VIP_SUPPORT_NNSR_BIN_V2
#define YH_OLD_DEF 0 //can be remove
/*##################################################*/
/*######### Type enum ##########*/
/*##################################################*/
...
#define DI_MA_Adjust_Table_MAX 12
...
#define DCCHist_Factor_Table_MAX	20 //10
#define DCC_skin_tone_TABLE_MAX	7
#define Color_Independent_Blending_Table_MAX	20//7
#define USER_DEFINE_CURVE_DCC_TBL_NUM	20//10
#define USER_DEFINE_CURVE_DCC_SEGMENT_NUM	129
#define Database_DCC_Curve_TABLE_MAX	20//10
#define Database_DCC_Curve_Case_Item_MAX	10
#define DCC_CURVE_Segment_NUM	129
#define DCC_CURVE_User_Gain_Parameter   4
#define DCC_Curve_Adjust_TABLE_MAX	20//10
#define DCC_Chroma_Compensation_TABLE_MAX	20//10
#define Chroma_Gain_Seg_MAX	65
#define Chroma_Gain_Limit_Seg_MAX 21
#define DCC_AdaptCtrl_Level_TABLE_MAX 20//10
#define DCC_coef_Control_Table_MAX	10
#define DCC_Boundary_Check_Table_MAX	20//10
#define DCC_Level_and_Blend_Coef_Table_MAX	20//10
...
typedef enum _VIP_RLK_I2C_ONLY_CMDS{
	...
	VIP_RLK_I2C_ONLY_Color_Temp_Info,
	VIP_RLK_I2C_ONLY_Gamma_set_Info,
	VIP_RLK_I2C_ONLY_PQ_ByPass_Info,
...
typedef struct {
	unsigned short Param_SRNN_mode2_2X[SRNN_Weight_Num_mode2];
	unsigned short Param_SRNN_mode5_3X[SRNN_Weight_Num_mode5];
#ifdef VIP_SUPPORT_NNSR_BIN_V2
	unsigned short Param_SRNN_mode5_3X_2[SRNN_Weight_Num_mode5];
#endif
	unsigned short Param_SRNN_mode7_4X[SRNN_Weight_Num_mode7];
	unsigned short Param_SRNN_HSR_mode2_2X[SRNN_Weight_Num_mode2];
	unsigned short Param_SRNN_HSR_mode5_3X[SRNN_Weight_Num_mode5];
#ifdef VIP_SUPPORT_NNSR_BIN_V2
	unsigned short Param_SRNN_HSR_mode5_3X_2[SRNN_Weight_Num_mode5];
#endif	
	unsigned short Param_SRNN_HSR_mode7_4X[SRNN_Weight_Num_mode7];
	unsigned short Param_SRNN_CG_mode2_2X[SRNN_Weight_Num_mode2];
	unsigned short Param_SRNN_CG_mode5_3X[SRNN_Weight_Num_mode5];
	unsigned short Param_SRNN_CG_mode5_3X_2[SRNN_Weight_Num_mode5];
	unsigned short Param_SRNN_CG_mode7_4X[SRNN_Weight_Num_mode7];
	unsigned short Param_SRNN_HSR_CG_mode2_2X[SRNN_Weight_Num_mode2];
	unsigned short Param_SRNN_HSR_CG_mode5_3X[SRNN_Weight_Num_mode5];
	unsigned short Param_SRNN_HSR_CG_mode5_3X_2[SRNN_Weight_Num_mode5];
	unsigned short Param_SRNN_HSR_CG_mode7_4X[SRNN_Weight_Num_mode7];
	unsigned short Param_SRNN_Reserved_mode2_2X[SRNN_Weight_Num_mode2];
	unsigned short Param_SRNN_Reserved_mode5_3X[SRNN_Weight_Num_mode5];
	unsigned short Param_SRNN_Reserved_mode5_3X_2[SRNN_Weight_Num_mode5];
	unsigned short Param_SRNN_Reserved_mode7_4X[SRNN_Weight_Num_mode7];
}DRV_SRNN_PARAM;
...
#define SLR_AI_Sematic_Table_Max 35
//#define SLR_AI_Ctrl_byte_NUM 128
typedef enum _SLR_AI_CTRL_Byte_Items{
		SLR_AI_CTRL_Byte_Sat_Gain_en = 0,
		SLR_AI_CTRL_Byte_Sat_Gain,

		SLR_AI_Ctrl_byte_NUM = 128,
} SLR_AI_CTRL_Byte_Items;
...
typedef struct _SLR_VIP_TABLE_AIPQ {
	...
	int Semantic_TBL[SLR_AI_Sematic_Table_Max][SLR_AI_CTRL_Items_Max+SLR_AI_CTRL_Items_Max][SLR_AI_Sematic_Items_Max];	// normal and hsr on
...
typedef struct _VIP_VD_VER_MISC_INFO{  //512 bytes
	char vipver[64];
	char customer_version[448];
} VIP_VD_VER_MISC_INFO;
...
typedef struct _VIP_VDCti{
	int data[8][18];
} VIP_VDCti;

typedef struct _VIP_VDDigitalFilter{
	int data[8][5];
} VIP_VDDigitalFilter;

typedef struct _SLR_VIP_TABLE_VD {
	VIP_VD_VER_MISC_INFO m_pVipVerMiscInfoVD;
	VIP_VDBlackLevel mBLMTbl[2];
	VIP_VDYcbcrDelay mYcbcrDelayTbl[4];
	VIP_VDCti mCtiTbl[4];
	VIP_VDDigitalFilter mDigitalFilterTbl[4];
} SLR_VIP_TABLE_VD;
...
#ifdef VIP_SUPPORT_TCON_OUTGAMMA_V2	
...
///////////////////*************************************************////////////////////////////
#define SLR_VIP_PCID_Rgn_TBL_X_Num 3
