...
typedef struct{
	...
	unsigned char ld_abi_global_bvgain_en;/*no this HW*/
	unsigned char ld_global_bvgain;
	unsigned char ld_ai_global_bvgain;
	unsigned char ld_abi_global_bvgain;/*no this HW*/
}DRV_LD_Global_Gain;

typedef struct{
	unsigned int ld_pixel_bv_gain;/*no this HW*/
	unsigned int ld_pixel_bv_offset;/*no this HW*/
}DRV_LD_Bl_Pixel_Bv_Gain_Offset;

typedef struct {
	unsigned char ld_spatialremap2en;/*no this HW*/
	unsigned short ld_spatialremaptab2[65];/*no this HW*/
...
typedef struct {
	...
	unsigned char ld_boost_gain_shift;/*no this HW*/
	unsigned char ld_boost_input_bv_shift;/*no this HW*/
...
typedef struct {
	...
	unsigned char ld_spi_out_num; // no this HW
	unsigned char ld_spatial_throughput; // no this HW
...
typedef struct {
	...
	DRV_LD_Spatial_Remap2 LD_Spatial_Remap2;/*no this HW*/
	DRV_LD_Spatial_Remap3 LD_Spatial_Remap3;/*no this HW*/
	...
	DRV_LD_Backlight_LPF LD_Backlight_LPF;/*no this HW*/
	DRV_LD_Global_Gain LD_Global_Gain;/*no this HW*/
	DRV_LD_Bl_Pixel_Bv_Gain_Offset LD_Pixel_Bv_Gain_Offset;/*no this HW*/
...
#define SLR_VIP_VALC_LUT_Size 4096
...
typedef struct{
	...
	unsigned int Width;
	unsigned int Height;
}SLR_VIP_valc_demo_ctrl_t;

typedef struct{
	unsigned char enable;
	SLR_VIP_valc_demo_ctrl_t Boundary;
}SLR_VIP_valc_win_ctrl_t;

typedef struct {
	unsigned char Multi_func_en;
	unsigned char Overlap_en;
	unsigned char Window_out_en;
}SLR_VIP_valc_multi_scene_en_ctrl_t;

typedef struct{
	unsigned char enable;
	SLR_VIP_valc_demo_ctrl_t Boundary;
}SLR_VIP_valc_scene_1_ctrl_t;

typedef struct{
	unsigned char enable;
	SLR_VIP_valc_demo_ctrl_t Boundary;
}SLR_VIP_valc_scene_2_ctrl_t;

typedef struct {
	SLR_VIP_valc_win_ctrl_t Window;
	SLR_VIP_valc_multi_scene_en_ctrl_t Scene_en;
	SLR_VIP_valc_scene_1_ctrl_t Scene_1;
	SLR_VIP_valc_scene_2_ctrl_t Scene_2;
}SLR_VIP_valc_window_ctrl_t;
...
typedef struct _SLR_VIP_TABLE_VALC {
	...
	SLR_VIP_valc_window_ctrl_t win_ctrl_t;
...
typedef struct{
	...
	unsigned char localgain_edge_gain0;
	unsigned char localgain_edge_gain1;
	unsigned char localgain_edge_gain2;
	unsigned char localgain_edge_gain3;
	unsigned char localgain_edge_gain4;
	unsigned char localgain_edge_gain5;
	unsigned char localgain_edge_gain6;
	unsigned char localgain_edge_gain7;
	unsigned char localgain_edge_gain8;
	unsigned char localgain_edge_gain9;		
} DRV_OD_Local_Gain;
...
typedef struct _SLR_VIP_TABLE_OD {
	...
	DRV_OD_Vertical_Gain_ctrl Vertical_Gain_ctrl;//ml9 no this HW
	DRV_OD_Vertical_Gain_ctrl Vertical_Gain_ctrl_REC;//ml9 no this HW
