...
enum vpq_ioc_pq_cmd
{
	...
	VPQ_IOC_PQ_CMD_GET_NN_TA_BUF = 88,
	VPQ_IOC_PQ_CMD_FREE_NN_TA_BUF = 89,
...
#define VPQ_IOC_GET_NN_TA_BUF				    _IOWR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_GET_NN_TA_BUF, NN_BUF_INFO_T)
#define VPQ_IOC_FREE_NN_TA_BUF				    _IOWR(VPQ_IOC_MAGIC, VPQ_IOC_PQ_CMD_FREE_NN_TA_BUF, NN_BUF_INFO_T)
