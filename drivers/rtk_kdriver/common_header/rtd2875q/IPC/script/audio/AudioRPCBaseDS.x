...
enum AUDIO_DEC_TYPE{
    ...
    AUDIO_AC3_PASSTHORUGH_TYPE = 50,
    AUDIO_IAMF_DECODER_TYPE = 51
};
...
enum ENUM_AUDIO_CHANNEL_OUT
{
    ...
    NON_PCM_OUT_EN_AUTO_MAT_AAC        = 273,
    NON_PCM_OUT_EN_AUTO_FORCED_MAT     = 274,
    NON_PCM_OUT_EN_AUTO_BYPASS_MAT     = 275,
    NON_PCM_OUT_EN_AUTO_BYPASS_MAT_AAC = 276,
    NON_PCM_OUT_EN_AUTO_BYPASS_MAT_TRUEHD = 277,
} ;
...
enum AUDIO_CONFIG_CMD_MSG
{
    ...
    AUDIO_CONFIG_CMD_AO_LOW_LATENCY = 139,
    AUDIO_CONFIG_CMD_AEC_SOURCE = 140,
    AUDIO_CONFIG_CMD_GET_LATENCY = 141,
    AUDIO_CONFIG_CMD_DIAS_LOW_POWER = 142,
    AUDIO_CONFIG_CMD_AISOUND_CONTROL = 143,
    AUDIO_CONFIG_CMD_BTMIC_CONTROL = 144,
    AUDIO_CONFIG_CMD_DD_SCALE_2CH = 145,
    AUDIO_CONFIG_CMD_DD_COMP_2CH = 146,
    AUDIO_CONFIG_CMD_AAC_PRL = 147,
    AUDIO_CONFIG_CMD_CONTINUOUS_OUT = 148,
    AUDIO_CONFIG_CMD_AD_MIXING = 149,
    AUDIO_CONFIG_CMD_BS_PASSHTROUGH_ON = 150,
    AUDIO_CONFIG_CMD_CHANNEL_MODE = 151,
    AUDIO_CONFIG_CMD_AIDK_DUMP = 152,
    AUDIO_CONFIG_CMD_AC4_SHORT_PROGRAM_INDEX = 153,
    AUDIO_CONFIG_CMD_SET_PRESCALE_VOLUME = 154,
    AUDIO_CONFIG_CMD_INIT_SPK_COUNTER_BUFFER = 155,
    AUDIO_CONFIG_CMD_SET_FLEXR_CONFIG = 156,
    AUDIO_CONFIG_CMD_ENABLE_FLEX_MODE = 157,
    AUDIO_CONFIG_CMD_ENFORCE_SINGLE_OA_ELEMENT = 158,
    AUDIO_CONFIG_CMD_SET_FLEXR_CENTER_EXTRACT_MODE = 159,
    AUDIO_CONFIG_CMD_SET_SNDOUT_MIXTYPE = 160,
    AUDIO_CONFIG_CMD_SET_MAINAUDIO_DEVICE = 161,
    AUDIO_CONFIG_CMD_SET_HDMI_FULLCAP_PORT = 162,
    AUDIO_CONFIG_CMD_HDMITX = 163,
    AUDIO_CONFIG_CMD_SET_ASRC_DRIFT = 164
};
...
enum AUDIO_CONFIG_DEVICE
{
    ...
    ENUM_DEVICE_CAPTURE   = 25,
    ENUM_DEVICE_BITSTREAM_OUT    = 26,
    ENUM_DEVICE_SE_BT_SUR = 27,
    ENUM_DEVICE_USB_AUDIO = 28,
    ENUM_DEVICE_UACOUT1 = 29,
    ENUM_DEVICE_UACOUT2 = 30,
    ENUM_DEVICE_MAX = 31
};
...
enum AUDIO_ENUM_PRIVAETINFO
{
    ...
    ENUM_PRIVATEINFO_AUDIO_GET_QUICK_SHOW_INFO,
    ENUM_PRIVATEINFO_AUDIO_GET_SPDIF_CS,
    ENUM_PRIVATEINFO_AUDIO_CONFIG_EQ_BASS_PARAM,
    ENUM_PRIVATEINFO_AUDIO_SET_VIDEO_COMMON_ID
};
...
struct AUDIO_RPC_LGSE_DBG_INFO
{
    long front_input_data[8];
    long surr_input_data[2];
    int  front_ch_in;
    int  front_acmode;
    int  surr_ch_in;
    int  surr_acmode;
...
enum ENUM_VIRTUALX_CMD_TYPE
{
	...
	ENUM_VIRTUALX_CMD_TYPE_LOUDNESS_CONTROL_SETPARAM,
	ENUM_VIRTUALX_CMD_TYPE_LOUDNESS_CONTROL_GETPARAM,
	ENUM_VIRTUALX_CMD_TYPE_GEQ_SETPARAM,
	ENUM_VIRTUALX_CMD_TYPE_GEQ_GETPARAM,
	ENUM_VIRTUALX_CMD_TYPE_AEQ_SETPARAM,
	ENUM_VIRTUALX_CMD_TYPE_AEQ_GETPARAM,
	ENUM_VIRTUALX_CMD_TYPE_MULTI_RATE_SETPARAM,
	ENUM_VIRTUALX_CMD_TYPE_MULTI_RATE_GETPARAM,
	ENUM_VIRTUALX_CMD_TYPE_ILDETECT_UPMIX_SETPARAM,
	ENUM_VIRTUALX_CMD_TYPE_ILDETECT_UPMIX_GETPARAM
};

enum enum_dtsParamVirtualxlib1Type
{
    ENUM_DTS_PARAM_VIRTUALXLIB1_FIRST_PARAM = 0x10019400,


    ENUM_DTS_PARAM_VX_ENABLE_I32 = ENUM_DTS_PARAM_VIRTUALXLIB1_FIRST_PARAM,
    ...
    ENUM_DTS_PARAM_VX_GAIN_COMPENSATION_I32,


    ENUM_DTS_PARAM_VX_PROCESS_DISCARD_I32,
    ...
    ENUM_DTS_PARAM_TSX_PHANTOM_CENTER_GAIN_I32,
    ...
    ENUM_DTS_PARAM_TSX_HEIGHTOUTCH_GAIN_I32,


    ENUM_DTS_PARAM_TSX_LFE_GAIN_I32,


    ENUM_DTS_PARAM_TSX_LRMIX_RATIO2CTRGAIN_I32,


    ENUM_DTS_PARAM_TSX_PRECOND_FRONT_I32,


    ENUM_DTS_PARAM_TSX_PRECOND_SURND_I32,


    ENUM_DTS_PARAM_TSX_TOPSPK_LOC_CTRL_I32,


    ENUM_DTS_PARAM_TSX_FRONT_WIDE_ENABLE_I32,


    ENUM_DTS_PARAM_TSX_HEIGHT_VIRTUALIZER_ENABLE_I32,


    ENUM_DTS_PARAM_TSX_FRONT_SURROUND_ENABLE_I32,
    ...
    ENUM_DTS_PARAM_VX_CS2TO3_ENABLE_I32,


    ENUM_DTS_PARAM_TSX_CUSTOMCOEFF_STU,
    ...
    ENUM_DTS_PARAM_TSX_LPR_GAIN_I32 = -1,


    ENUM_DTS_PARAM_TSX_PROCESS_DISCARD_I32 = -1,


    ENUM_DTS_PARAM_TSX_FRNT_CTRL_I32 = -1,


    ENUM_DTS_PARAM_TSX_SRND_CTRL_I32 = -1,

    ENUM_DTS_PARAM_VIRTUALXLIB1_APP_FIRST_PARAM = 0x1001a400,

    ENUM_DTS_PARAM_TSX_APP_LSTNR_DIST_F32,

    ENUM_DTS_PARAM_TSX_APP_BTTMSPKTOCTR_DIST_F32,

    ENUM_DTS_PARAM_TSX_APP_TOPSPKTOCTR_DIST_F32,

    ENUM_DTS_PARAM_VIRTUALXLIB1_APP_LAST_PARAM
};
...
enum enum_dtsParamTBHDxType
{
    ...
    ENUM_DTS_PARAM_TBHDX_FRONT_ENABLE_I32 = ENUM_DTS_PARAM_TBHDX_FIRST_PARAM,


    ENUM_DTS_PARAM_TBHDX_FRONT_MODE_I32,


    ENUM_DTS_PARAM_TBHDX_FRONT_SPKSIZE_I32,


    ENUM_DTS_PARAM_TBHDX_FRONT_DYNAMICS_I32,


    ENUM_DTS_PARAM_TBHDX_FRONT_HP_ENABLE_I32,


    ENUM_DTS_PARAM_TBHDX_FRONT_HPORDER_I32,


    ENUM_DTS_PARAM_TBHDX_FRONT_BASSLVL_I32,


    ENUM_DTS_PARAM_TBHDX_FRONT_EXTBASS_I32,


    ENUM_DTS_PARAM_TBHDX_FRONT_INPUT_GAIN_I32,


    ENUM_DTS_PARAM_TBHDX_FRONT_BYPASS_GAIN_I32,


    ENUM_DTS_PARAM_TBHDX_FRONT_CUSTOMCOEFF_STU,


    ENUM_DTS_PARAM_TBHDX_REAR_ENABLE_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_MODE_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_SPKSIZE_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_DYNAMICS_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_HP_ENABLE_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_HPORDER_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_BASSLVL_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_EXTBASS_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_INPUT_GAIN_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_BYPASS_GAIN_I32,


    ENUM_DTS_PARAM_TBHDX_REAR_CUSTOMCOEFF_STU,


    ENUM_DTS_PARAM_TBHDX_CENTER_ENABLE_I32,


    ENUM_DTS_PARAM_TBHDX_CENTER_SPKSIZE_I32,


    ENUM_DTS_PARAM_TBHDX_CENTER_DYNAMICS_I32,


    ENUM_DTS_PARAM_TBHDX_CENTER_HP_ENABLE_I32,


    ENUM_DTS_PARAM_TBHDX_CENTER_HPORDER_I32,


    ENUM_DTS_PARAM_TBHDX_CENTER_BASSLVL_I32,


    ENUM_DTS_PARAM_TBHDX_CENTER_EXTBASS_I32,


    ENUM_DTS_PARAM_TBHDX_CENTER_INPUT_GAIN_I32,


    ENUM_DTS_PARAM_TBHDX_CENTER_BYPASS_GAIN_I32,


    ENUM_DTS_PARAM_TBHDX_CENTER_CUSTOMCOEFF_STU,


    ENUM_DTS_PARAM_TBHDX_SRRND_ENABLE_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_MODE_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_SPKSIZE_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_DYNAMICS_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_HP_ENABLE_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_HPORDER_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_BASSLVL_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_EXTBASS_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_INPUT_GAIN_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_BYPASS_GAIN_I32,


    ENUM_DTS_PARAM_TBHDX_SRRND_CUSTOMCOEFF_STU,


    ENUM_DTS_PARAM_TBHDX_DELAY_MATCHING_GAIN_I32,


    ENUM_DTS_PARAM_TBHDX_PROCESS_DISCARD_I32,


    ENUM_DTS_PARAM_TBHDX_DELAY_I32,
    ...
    ENUM_DTS_PARAM_TBHDX_ENABLE_I32 = -1,


	ENUM_DTS_PARAM_TBHDX_MONO_MODE_I32 = -1,


	ENUM_DTS_PARAM_TBHDX_SPKSIZE_I32 = -1,


	ENUM_DTS_PARAM_TBHDX_MAXGAIN_I32 = -1,


	ENUM_DTS_PARAM_TBHDX_HP_ENABLE_I32 = -1,


	ENUM_DTS_PARAM_TBHDX_HPORDER_I32 = -1,


	ENUM_DTS_PARAM_TBHDX_TEMP_GAIN_I32 = -1,

	ENUM_DTS_PARAM_TBHDX_APP_FRT_SPKSZIR_I32 = 0x10017301,

	ENUM_DTS_PARAM_TBHDX_APP_FRT_BASSCTRL_F32,

	ENUM_DTS_PARAM_TBHDX_APP_FRT_HPRATIO_F32,

	ENUM_DTS_PARAM_TBHDX_APP_FRT_EXTBASS_F32,

	ENUM_DTS_PARAM_TBHDX_APP_CTR_SPKSZIR_I32,

	ENUM_DTS_PARAM_TBHDX_APP_CTR_BASSCTRL_F32,

	ENUM_DTS_PARAM_TBHDX_APP_CTR_HPRATIO_F32,

	ENUM_DTS_PARAM_TBHDX_APP_CTR_EXTBASS_F32,

	ENUM_DTS_PARAM_TBHDX_APP_SUR_SPKSZIR_I32,

	ENUM_DTS_PARAM_TBHDX_APP_SUR_BASSCTRL_F32,

	ENUM_DTS_PARAM_TBHDX_APP_SUR_HPRATIO_F32,

	ENUM_DTS_PARAM_TBHDX_APP_SUR_EXTBASS_F32,

	ENUM_DTS_PARAM_TBHDX_APP_REAR_SPKSZIR_I32,

	ENUM_DTS_PARAM_TBHDX_APP_REAR_BASSCTRL_F32,

	ENUM_DTS_PARAM_TBHDX_APP_REAR_HPRATIO_F32,

	ENUM_DTS_PARAM_TBHDX_APP_REAR_EXTBASS_F32
};
...
enum enum_dtsParamMbhlType
{
    ...
    ENUM_DTS_PARAM_MBHL_IO_MODE_I32,


    ENUM_DTS_PARAM_MBHL_ALG_DELAY_I32,


    ENUM_DTS_PARAM_MBHL_ALG_GAIN_I32,
    ...
    ENUM_DTS_PARAM_MBHL_AC_ENABLE_I32,


    ENUM_DTS_PARAM_MBHL_AC_LEVEL_I32,


    ENUM_DTS_PARAM_MBHL_CP_ENABLE_I32,


    ENUM_DTS_PARAM_MBHL_CP_LEVEL_I32,
    ...
    ENUM_DTS_PARAM_MBHL_PROCESS_DISCARD_I32,
    ...
    ENUM_DTS_PARAM_MBHL_APP_FRT_LOWCROSS_F32 = -1,


    ENUM_DTS_PARAM_MBHL_APP_FRT_MIDCROSS_F32 = -1,

    ENUM_DTS_PARAM_MBHL_APP_FIRST_PARAM = 0x10027300,

    ENUM_DTS_PARAM_MBHL_APP_LOWCROSS_F32,

    ENUM_DTS_PARAM_MBHL_APP_MIDCROSS_F32,
...
enum enum_dtsParamLoudnessControlType
{
    ENUM_DTS_PARAM_LOUDNESS_CONTROL_FIRST_PARAM_1 = 0x10016350,


    ENUM_DTS_PARAM_LOUDNESS_CONTROL_ENABLE_I32_1 = ENUM_DTS_PARAM_LOUDNESS_CONTROL_FIRST_PARAM_1,


    ENUM_DTS_PARAM_LOUDNESS_CONTROL_IO_MODE_I32_1,


    ENUM_DTS_PARAM_LOUDNESS_CONTROL_TARGET_LOUDNESS_I32_1,


    ENUM_DTS_PARAM_LOUDNESS_CONTROL_PRESET_I32_1,


    ENUM_DTS_PARAM_LOUDNESS_CONTROL_DISCARD_I32_1,


    ENUM_DTS_PARAM_LOUDNESS_CONTROL_LATENCY_MODE_I32_1,


    ENUM_DTS_PARAM_LOUDNESS_CONTROL_DELAY_I32_1,


    ENUM_DTS_PARAM_LOUDNESS_CONTROL_CONTROLS_STU_1,


    ENUM_DTS_PARAM_LOUDNESS_CONTROL_LAST_PARAM_1 = ENUM_DTS_PARAM_LOUDNESS_CONTROL_CONTROLS_STU_1
};

struct AUDIO_VIRTUALX_Loudness_Control_PARAM_INFO
{
	enum_dtsParamLoudnessControlType ParameterType;
	int ValueSize;
	int Value[50];
};

enum enum_dtsParamGeq10bType
{
    ENUM_DTS_PARAM_GEQ10B_FIRST_PARAM = 0x10015040,


    ENUM_DTS_PARAM_GEQ10B_ENABLE_I32 = ENUM_DTS_PARAM_GEQ10B_FIRST_PARAM,


    ENUM_DTS_PARAM_GEQ10B_CHANNEL_CTRL_MASK_I32,


    ENUM_DTS_PARAM_GEQ10B_INPUT_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND0_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND1_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND2_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND3_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND4_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND5_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND6_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND7_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND8_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_BAND9_GAIN_I32,


    ENUM_DTS_PARAM_GEQ10B_DISCARD_I32,


    ENUM_DTS_PARAM_GEQ10B_CONTROLS_STU,


    ENUM_DTS_PARAM_GEQ10B_LAST_PARAM = ENUM_DTS_PARAM_GEQ10B_CONTROLS_STU
};

struct AUDIO_VIRTUALX_Geq10b_PARAM_INFO
{
	enum_dtsParamGeq10bType ParameterType;
	int ValueSize;
	int Value[50];
};

enum enum_dtsParamAeqType
{
    ENUM_DTS_PARAM_AEQ_FIRST_PARAM = 0x10015030,


    ENUM_DTS_PARAM_AEQ_ENABLE_I32 = ENUM_DTS_PARAM_AEQ_FIRST_PARAM,


    ENUM_DTS_PARAM_AEQ_CHANNEL_CTRL_MASK_I32,


    ENUM_DTS_PARAM_AEQ_INPUT_GAIN_I32,


    ENUM_DTS_PARAM_AEQ_OUTPUT_GAIN_I32,


    ENUM_DTS_PARAM_AEQ_BYPASS_GAIN_I32,


    ENUM_DTS_PARAM_AEQ_CONTROLS_STU,


    ENUM_DTS_PARAM_AEQ_CUSTOMCOEFF_STU,


    ENUM_DTS_PARAM_AEQ_PROCESS_DISCARD_I32,


    ENUM_DTS_PARAM_AEQ_LAST_PARAM = ENUM_DTS_PARAM_AEQ_PROCESS_DISCARD_I32,

    ENUM_DTS_PARAM_APP_AEQ_FIRST_PARAM = 0x10016030,

    ENUM_DTS_PARAM_APP_AEQ_CH_LINK_I32,

    ENUM_DTS_PARAM_APP_AEQ_BAND_NUM_I32,

    ENUM_DTS_PARAM_APP_AEQ_BAND_EN_I32,

    ENUM_DTS_PARAM_APP_AEQ_BAND_FREQ_I32,

    ENUM_DTS_PARAM_APP_AEQ_BAND_GAIN_I32,

    ENUM_DTS_PARAM_APP_AEQ_BAND_Q_FACOTR_I32,

    ENUM_DTS_PARAM_APP_AEQ_BAND_TYPE_I32,

    ENUM_DTS_PARAM_APP_AEQ_COEF_FILE_STR,

    ENUM_DTS_PARAM_APP_AEQ_LAST_PARAM
};

struct AUDIO_VIRTUALX_Aeq_PARAM_INFO
{
	enum_dtsParamAeqType ParameterType;
	int ValueSize;
	int Value[50];
};

enum enum_dtsParamMultiRateType
{
    ENUM_DTS_PARAM_MULTIRATE_FIRST_PARAM = 0x10016370,


    ENUM_DTS_PARAM_MULTIRATE_ENABLE_I32 = ENUM_DTS_PARAM_MULTIRATE_FIRST_PARAM,


    ENUM_DTS_PARAM_MULTIRATE_FILTER_MODE_I32,


    ENUM_DTS_PARAM_MULTIRATE_IN_MODE_I32,


    ENUM_DTS_PARAM_MULTIRATE_OUT_MODE_I32,


    ENUM_DTS_PARAM_MULTIRATE_UPMIX_ENABLE_I32,


    ENUM_DTS_PARAM_MULTIRATE_DELAY_COMPENSATION_I32,


    ENUM_DTS_PARAM_MULTIRATE_GAIN_COMPENSATION_I32,


    ENUM_DTS_PARAM_MULTIRATE_CONTROLS_STU,


    ENUM_DTS_PARAM_MULTIRATE_LAST_PARAM = ENUM_DTS_PARAM_MULTIRATE_CONTROLS_STU
};

struct AUDIO_VIRTUALX_MultiRate_PARAM_INFO
{
	enum_dtsParamMultiRateType ParameterType;
	int ValueSize;
	int Value[50];
};

enum enum_dtsParamILDetectUpmixType {
    ENUM_DTS_PARAM_ILDETECT_UPMIX_FIRST_PARAM = 0x71000000,

    ENUM_DTS_PARAM_ILDETECT_UPMIX_ENABLE_I32,

    ENUM_DTS_PARAM_ILDETECT_UPMIX_LOW_LEVEL_THRESHOLD_I32,

    ENUM_DTS_PARAM_ILDETECT_UPMIX_PEAK_HOLD_COUNT_I32,

    ENUM_DTS_PARAM_ILDETECT_UPMIX_ORIGLR_MIXBACK_I32,

    ENUM_DTS_PARAM_ILDETECT_UPMIX_SURROUND_GAIN_I32,

    ENUM_DTS_PARAM_ILDETECT_UPMIX_SRRND_DELAY_ENABLE_I32,

    ENUM_DTS_PARAM_ILDETECT_UPMIX_PROCESS_DISCARD_I32,

    ENUM_DTS_PARAM_ILDETECT_UPMIX_CONTROLS_STU,

    ENUM_DTS_PARAM_ILDETECT_UPMIX_LAST_PARAM = ENUM_DTS_PARAM_ILDETECT_UPMIX_CONTROLS_STU
};

struct AUDIO_VIRTUALX_ILDetectUpmix_PARAM_INFO {
	enum_dtsParamILDetectUpmixType ParameterType;
	int ValueSize;
	int Value[50];
};
/**
...
struct AUDIO_RPC_SET_DEFAULT_PRL
{
  long instanceID;
  long defaultPRL;
  long dec_port;
...
struct AUDIO_RPC_SET_AC4_DIALENHANCEGAIN
{
  long instanceID;
  long DialEnhanceGain;
  long dec_port;
};

struct AUDIO_RPC_GST_DECODER_INIT_PROCESS {
	AUDIO_RPC_CONNECTION connection;
	AUDIO_RPC_REFCLOCK dec_refclock;
	AUDIO_RPC_REFCLOCK ao_refclock;
	AUDIO_RPC_FOCUS focus;
	AUDIO_RPC_SENDIO bs_flush;
	long ao_run_instanceID;
};

struct AUDIO_RPC_SET_AC4_PRES_GROUP_IDX
{
  long instanceID;
  long PresGroupIndex;
  long dec_port;
...
enum ENUM_AUDIO_QUICK_SHOW_TYPE{
    ENUM_AUDIO_QUICK_SHOW_GET_INIT_TABLE = 0
};

struct AUDIO_QUICK_SHOW_PARAM
{
   ENUM_AUDIO_QUICK_SHOW_TYPE type;
   int value[10];
};

enum ENUM_AUDIO_EQ_BASS_FILTER_TYPE
{
    ENUM_AUDIO_EQ_BASS_FILTER_TYPE_LPF,
    ENUM_AUDIO_EQ_BASS_FILTER_TYPE_BPF,
    ENUM_AUDIO_EQ_BASS_FILTER_TYPE_HPF
};

enum ENUM_AUDIO_EQ_BASS_MODE
{
    ENUM_AUDIO_EQ,
    ENUM_AUDIO_BASS_TREBLE_LR,
    ENUM_AUDIO_BASS_TREBLE_LSRS,
    ENUM_AUDIO_BASS_TREBLE_CSW
};

enum ENUM_EQ_BASS_CMD_TYPE
{
    ENUM_EQ_BASS_CMD_TYPE_SETPARAM,
    ENUM_EQ_BASS_CMD_TYPE_SETENABLE,
    ENUM_EQ_BASS_CMD_TYPE_SET_AUDIO_DATA_PATH
};

struct AUDIO_EQ_BASS_PARAM_INFO {
    ENUM_EQ_BASS_CMD_TYPE type;
    int size;
    int data[6];
};
