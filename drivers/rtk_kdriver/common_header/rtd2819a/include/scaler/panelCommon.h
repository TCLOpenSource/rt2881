...
typedef struct _PANEL_CONFIG_PARAMETER{
    ...
    UINT32 iCONFIG_PANEL_HSR_ENABLE:1;
    UINT32 iCONFIG_PANEL_HSR_SUPPORT_ALL_TIMING:1;
    UINT32 iCONFIG_PANEL_HSR_DOWN_SAMPLE:1;
    UINT32 iCONFIG_PANEL_HSR:29;
    UINT8 iCONFIG_PANEL_SSCG_ENABLE;
    UINT32 iCONFIG_PANEL_SSCG_PERCENT;
    UINT32 iCONFIG_PANEL_SSCG_PERIOD;
    ...
    UINT8 iCONFIG_EDP_FORCE_ALTERNATE_SR_CAP;
    UINT8 iCONFIG_APP_TYPE;
#ifdef CONFIG_CUSTOMER_TV010
    ////for TV010
...
typedef enum {
    ...
    P_VBY1_4K1K,                //V By 1     output 4k1k timing only
...
typedef enum {
    ...
    VBY_ONE_PANEL_innolux_4K2K_144HZ_2S_16L,
    ...
    VBY_ONE_PANEL_4K2K_144HZ_1S_16L,
    VBY_ONE_PANEL_WQHD_165HZ_1S_16L,
    VBY_ONE_PANEL_WQHD_OLED_240HZ_1S_16L,
    VBY_ONE_PANEL_CSOT_HSR_4K2K144_4K1K288,
    VBY_ONE_PANEL_HKC_HSR_4K2K144_4K1K288,
    VBY_ONE_PANEL_innolux_4K1K_144HZ_1S_8L,
    VBY_ONE_PANEL_LG_4K2K_144HZ_2S_16L,

    P_LVDS_BENQ_PANEL,

    /* 4k2k30 / 2k1k120 dynamic output timing series*/
    DYNAMIC_OUTPUT_PANEL_SERIES_BEGIN=0x21,
    ...
    P_EDP_P0_QHD_165_648M,
    P_EDP_P0_4K1K_120_656M,
    //eDP 4k2k panel@Port2
    P_EDP_P0_4K2K_144_652M,
    P_EDP_P0_4K2K_165_762M,
#if 0
...
#endif
    VBY_ONE_PANEL_RTK_5K2K_60HZ_1S_16L,
    VBY_ONE_PANEL_RTK_5K1K_120HZ_1S_16L,
    VBY_ONE_PANEL_RTK_5K2K_120HZ_1S_16L,
    VBY_ONE_PANEL_RTK_5K2880_60HZ_1S_16L,
    VBY_ONE_PANEL_RTK_4K2K_165HZ_1S_16L,
    VBY_ONE_PANEL_LG_4K2K_120HZ_1S_16L_PN,
    //MIPI panel
    P_MIPI_KD060HDFID001_hd_60hz_1port_8b,
    P_MIPI_KD060HDFID001_hd_dual_60hz_2port_8b,
    P_MIPI_WT0697UD7_fhd_dsc_120hz_1Port_8b,
    P_MIPI_WT0697UD7_fhd_dsc_dual_120hz_2Port_8b,
    P_MIPI_EE50QBC61_3K_dsc1_60hz_2Port_10b,
    P_PANEL_CUSTOM_INDEX_MAX
}PANEL_CUSTOM_INDEX;    //PANEL_CUSTOM_INDEX;

#define VBY1_BOE_HSR120_PANEL_NAME         "VBY1_BOE_HV650QUB_F71_HSR120"
#define VBY1_BOE_HSR240_PANEL_NAME         "VBY1_BOE_HV650QUB_E70_HSR240"
#define VBY1_BOE_HSR288_PANEL_NAME         "VBY1_BOE_HV650QUB_E75_HSR288"
#define VBY1_BOE_HV750QUB_E92_HSR_4k2k144   "VBY1_BOE_HV750QUB_E92_4k2k144"
#define VBY1_BOE_HV650QUB_E72_HSR_4k2k144   "VBY1_BOE_HV650QUB_E72_4k2k144"
#define VBY1_BOE_HV650QUB_E75_HSR_4k2k144   "VBY1_BOE_HV650QUB_E75_4k2k144"
#define VBY1_BOE_HV980QUB_E11_HSR_4k2k144   "VBY1_BOE_HV980QUB_E11_4k2k144"
#define VBY1_PT850G_T02_D_HSR_4k2k144       "VBY1_PT850G_T02_D_HSR_4k2k144"
#define VBY1_CHOT_CV850U1_T01_V01_HSR120    "VBY1_CHOT_CV850U1_T01_HSR120"
#define VBY1_BOE_HF550QUB_F21_HSR120        "VBY1_BOE_HF550QUB_F21_HSR120"
#define VBY1_V430DK1_Q01_HSR_4k2k144         "VBY1_V430DK1_Q01_4k2k144"
#define VBY1_V500DK4_Q01_HSR_4k2k144         "VBY1_V500DK5_Q01_4k2k144"

//tconless
#define TCONLESS_HV650QUB_F71_4K2K_60Hz_PCEDS  "TCONLESS_HV650QUB_F71_HSR120"
#define TCONLESS_HV750QUB_F92_4K2K_60Hz_PCEDS  "TCONLESS_HV750QUB_F92_HSR120"
#define TCONLESS_PT550GTS08_1_4K2K_60Hz_PISP   "TCONLESS_PT550GTS08_1_HSR120"
#define TCONLESS_ST6451D08_5_4k2k144_PISP      "TCONLESS_ST6451D08_5_4k2k144"
#define TCONLESS_ST5461D20_5_4k2k144_PISP      "TCONLESS_ST5461D20_5_4k2k144"

#define VBY1_2K4K60_PANEL_NAME         "VBY1_2K4K60_PANEL_8LANE"

typedef enum dtg_app_type
{
    DTG_DISPLAY_MONITOR,
    DTG_DUAL_DISPLAY,
    DTG_STREAM_SWITCHER,
    DTG_LIVING_STREAMING,
    DTG_COMMERCIAL_MONITORY,
    DTG_WINDOW6,
    DTG_NON_WINDOW6
}DTG_APP_TYPE;
