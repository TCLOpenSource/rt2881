...
#define V_FREQ_short_OFFSET				500		// 0.500Hz
#define V_FREQ_medium_OFFSET			1000	// 1.000Hz
#define V_FREQ_long_OFFSET				2000	// 2.000Hz

#define V_FREQ_24000					24000
#define V_FREQ_24000_mOFFSET			( V_FREQ_24000 - V_FREQ_short_OFFSET )

#define V_FREQ_24500					24500

#define V_FREQ_25000					25000
#define V_FREQ_25000_pOFFSET			( V_FREQ_25000 + V_FREQ_short_OFFSET )

#define V_FREQ_30000					30000
#define V_FREQ_30000_mOFFSET			( V_FREQ_30000 - V_FREQ_short_OFFSET )
#define V_FREQ_30000_pOFFSET			( V_FREQ_30000 + V_FREQ_short_OFFSET )

#define V_FREQ_48000					48000
#define V_FREQ_48000_mOFFSET			( V_FREQ_48000 - V_FREQ_short_OFFSET )
#define V_FREQ_48000_pOFFSET			( V_FREQ_48000 + V_FREQ_short_OFFSET )

#define V_FREQ_50000					50000
#define V_FREQ_50000_mOFFSET			( V_FREQ_50000 - V_FREQ_short_OFFSET )
#define V_FREQ_50000_pOFFSET			( V_FREQ_50000 + V_FREQ_short_OFFSET )

#define V_FREQ_60000					60000
#define V_FREQ_60000_mOFFSET			( V_FREQ_60000 - V_FREQ_short_OFFSET )
#define V_FREQ_60000_pOFFSET			( V_FREQ_60000 + V_FREQ_short_OFFSET )

#define V_FREQ_100000					100000
#define V_FREQ_100000_mOFFSET			( V_FREQ_100000 - V_FREQ_medium_OFFSET )
#define V_FREQ_100000_pOFFSET			( V_FREQ_100000 + V_FREQ_medium_OFFSET )

#define V_FREQ_120000					120000
#define V_FREQ_120000_mOFFSET			( V_FREQ_120000 - V_FREQ_medium_OFFSET )
#define V_FREQ_120000_pOFFSET			( V_FREQ_120000 + V_FREQ_medium_OFFSET )

#define V_FREQ_144000					144000
#define V_FREQ_144000_mOFFSET			( V_FREQ_144000 - V_FREQ_medium_OFFSET )
#define V_FREQ_144000_pOFFSET			( V_FREQ_144000 + V_FREQ_medium_OFFSET )

#define V_FREQ_165000					165000
#define V_FREQ_165000_mOFFSET			( V_FREQ_165000 - V_FREQ_medium_OFFSET )
#define V_FREQ_165000_pOFFSET			( V_FREQ_165000 + V_FREQ_medium_OFFSET )

#define V_FREQ_200000					200000
#define V_FREQ_200000_mOFFSET			( V_FREQ_200000 - V_FREQ_medium_OFFSET )
#define V_FREQ_200000_pOFFSET			( V_FREQ_200000 + V_FREQ_medium_OFFSET )

#define V_FREQ_240000					240000
#define V_FREQ_240000_mOFFSET			( V_FREQ_240000 - V_FREQ_medium_OFFSET )
#define V_FREQ_240000_pOFFSET			( V_FREQ_240000 + V_FREQ_medium_OFFSET )

#define V_FREQ_288000					288000
#define V_FREQ_288000_mOFFSET			( V_FREQ_288000 - V_FREQ_medium_OFFSET )
#define V_FREQ_288000_pOFFSET			( V_FREQ_288000 + V_FREQ_long_OFFSET )
...
#define	REDUCE_SDNR_WIDTH_LIMIT_THRESHOLD		5120//this is for RTRN input max size
#define	REDUCE_DI_HSD_WIDTH_LIMIT_THRESHOLD		5120//this is for RTRN input max size
//
//[crixus]scart out
...
#ifndef BUILD_QUICK_SHOW
#define GAV_PIC_QUEUE_MAX       4
#define GAV_LOCAL_QUEUE_MAX     64
#define GAV_STOP_STATE  0
#define GAV_START_STATE 1
#define GAV_RUN_STATE   2
#endif

#define Rotate_Disp_Buf_Num 3
#define Rotate_Cap_Buf_Num 1
#define Rotate_Mdomain_Buf_Num (Rotate_Disp_Buf_Num + Rotate_Cap_Buf_Num)
...
/**
 * DC2H enable color conversion for vt/vr.
 */
typedef enum _DC2H_Enable_rgb2yuv{
	DC2H_Colconv_INVALID = -1,
	DC2H_Colconv_DISABLE = 0,
	DC2H_Colconv_RGBtoYUV = 1,
	DC2H_Colconv_YUVtoRGB = 2,
	DC2H_Colconv_MAX_CASE,
}DC2H_Enable_rgb2yuv;
...
typedef enum _SCALER_IDDMA_DEV_{
	I3DDMA_DEV = 0,
	I4DDMA_DEV,
	I5DDMA_DEV,
	I6DDMA_DEV,
...
typedef enum _DMA_VGIP_SOURCE_SEL_E_ {
    DMA_VGIP_SEL_HDMI1,
    DMA_VGIP_SEL_HDMI2,
    DMA_VGIP_SEL_VD,
    DMA_VGIP_SEL_VODMA,
    ...
    DMA_VGIP_SEL_HDMI4,
    DMA_VGIP_SEL_MAX,
}DMA_VGIP_SOURCE_SEL_E;

typedef enum _VGIP_SOURCE_SEL_E_ {
    VGIP_SEL_HDMI1 = 0,
    VGIP_SEL_HDMI2,
    VGIP_SEL_VD,
    VGIP_SEL_VODMA,
...
typedef enum _VGIP_SOURCE_SEL_VODMA {
    VGIP_SEL_VODMA1 = 0,
    VGIP_SEL_VODMA2,
}VGIP_SOURCE_SEL_VODMA;

typedef enum _HDR_SOURCE_SEL_E_ {
    HDR_SEL_VO = 0,
    HDR_SEL_HDMI0,
    HDR_SEL_HDMI1,
    HDR_SEL_HDMI2,
...
#ifndef BUILD_QUICK_SHOW
/* --- [Ref] NUMDEV-1536 --- start */
// flags enum to enable bbd/svp/pq
typedef enum {
    FLAG_ENABLE_NONE = 0,
    FLAG_ENABLE_BBD = 0x1,
    FLAG_SECURE = 0x2,
...
typedef struct _VO_GAV_BUFFER_T {
    uint32_t phyaddrY;
    uint32_t phyaddrC;
    uint32_t pitchY;
    uint32_t pitchC;
...
// compress header for input
typedef struct _VO_GAV_COMPRESS_HEADER_T {
    uint32_t phyaddrY;
    uint32_t phyaddrC;
    uint32_t pitchY;
    uint32_t pitchC;
    ...
    uint32_t packingUnit;
    uint32_t cmprs48bAlignData;
    uint32_t cmprs48bAlignHdr;
} VO_GAV_COMPRESS_HEADER_T;

// bbd crop structure for output
typedef struct _VO_GAV_BBD_CROP_T {
    uint32_t left;
    uint32_t top;
    uint32_t right;
    uint32_t bottom;
...
// input vbm frame data structure
typedef struct _VO_GAV_DATA_INPUT_T {
    int32_t version;
    VO_GAV_FLAGS_T flags;
    /* 0: raw, 1: lossless, 2: lossy */
    uint32_t cmprsMode;
    VO_GAV_BUFFER_T buffer;
    VO_GAV_COMPRESS_HEADER_T header;
} VO_GAV_DATA_INPUT_T;

// output graphic buffer data structure
typedef struct _VO_GAV_DATA_OUTPUT_T {
    int32_t version;
    VO_GAV_FLAGS_T flags;
    VO_GAV_BUFFER_T buffer;
    VO_GAV_BBD_CROP_T crop;
} VO_GAV_DATA_OUTPUT_T;

// arg data structure for queue
typedef struct _VO_GAV_DATA_INARG_T {
    int32_t version;
    VO_GAV_DATA_INPUT_T input;
    VO_GAV_DATA_OUTPUT_T output;
} VO_GAV_DATA_INARG_T;
/* --- [Ref] NUMDEV-1536 --- end */

typedef struct _VO_GAV_QUEUE_T {
    unsigned int in_write;
    unsigned int in_read;
    unsigned int out_write;
    unsigned int out_read;
    VO_GAV_DATA_INARG_T q_data_in[GAV_PIC_QUEUE_MAX]; //4data in queue
    VO_GAV_DATA_OUTPUT_T q_data_out[GAV_PIC_QUEUE_MAX]; //4pic out queue
} VO_GAV_QUEUE_T;
#endif
...
typedef struct _SLR_VOINFO {
    ...
    unsigned int                        v_freq_1000;    ///< vertical frequency in digit 3
    ...
    unsigned int                        src_h_wid;      ///< added to keep original src_size
    unsigned int                        src_v_len;      ///< added to keep original src_size without crop
	...
	unsigned int 						camera_flow_flag;//for camera flow
    ...
    */
    ...
    unsigned int                        src_v_freq_1000;///< added for true framerate in digit 3
    unsigned int                        is2KCP;
    unsigned int                        is8K;
    unsigned int                        depth;          //  Y pixel length
    VODMA_INPUT_CHROMA_FMT              i_fmt;
    unsigned int                        update_pts;
    unsigned int                        vo_vdec_src_type;
    unsigned int                        vo_dma_output_chroma_fmt;//for vo dma output color format not inlcude hdr block
    unsigned int                        voRealFramerate;
} SLR_VOINFO;
// oliver-
...
typedef struct _Panel_Parameter_INFO {
	...
	unsigned int disp_v_total_60Hz_min;
	unsigned int disp_panel_pixel_mode_count;
	unsigned int disp_hsr_down_sample;	
...
typedef struct _SCLAER_ZOOM_INFO{
	//added by rika 20140628
		...
		unsigned int zoom_fs;//imdSmoothInfo[Smooth_Toggle_dislay].IMD_SMOOTH_FRAMESYNC_1000
...
typedef struct _SCALER_ROTATE_INFO{
    ...
    unsigned int vi_vflip_en;
    unsigned int block_size;
    unsigned int buffer_addr_y[Rotate_Mdomain_Buf_Num];
    unsigned int buffer_addr_c[Rotate_Mdomain_Buf_Num];
}SCALER_ROTATE_INFO;
...
typedef struct _StructDisplayInfo{
	...
	unsigned int IVFreq_1000;				// Input Vertical Frequency in digit 3
	unsigned int SrcIVFreq_1000;			// Original Input Vertical Frequency in digit 3
    ...
    unsigned char subSrnnEnable;
	unsigned char input_src_pixel_mode;		//HDMI or DP 2 pixel mode
	unsigned char vsc_src_type;
	unsigned char original_color_space;
}StructDisplayInfo;
...
typedef enum
{
    VDEC_SRC_PLAYBACK = 0,    /* 0: playback source */
    VDEC_SRC_DTV,             /* 1: DTV source */
    VDEC_SRC_AIRPLAY,         /* 2: Airplay source */
    VDEC_SRC_MIRACAST,        /* 3  Miracast source */
    VDEC_SRC_ATSC3,           /* 4: ATSC3.0 source*/
    VDEC_SRC_JP4K,            /* 5: JP4K source */
    VDEC_SRC_CP,              /* 6: CP source */
} VO_VDEC_SOURCE_TYPE ;
...
typedef struct _SCALER_DISP_INFO {
	...
	unsigned int	IVFreq_1000;	// vertical frequency in digit 3
	unsigned int	CapWid;
	unsigned int	CapLen;
	...
	unsigned int	scaler_input_2_pixel_mode;//Pixel mode setting about scaler input path. 0: 1 pixel mode , 1: 2 pixel mode
	unsigned int	source_input_2_pixel_mode;//Pixel mode setting about input source. 0: 1 pixel mode , 1: 2 pixel mode
	unsigned int	vrr_en;
	unsigned int	freesync_en;
	unsigned int    dlg_mode;
} SCALER_DISP_INFO;
...
typedef struct _DOLBY_BUFFER_INFO_T
{
	unsigned char metadataBuffer;	//normal: 0~1, i3 triple buffer: 0~2
	unsigned char frameIndex;	//0~15 at VIDEO_RPC_DOBLBY_VISION_SHM
}DOLBY_BUFFER_INFO;

typedef struct _DOLBY_VIDEO_CORRESPOND_T
{
	DOLBY_BUFFER_INFO video0;
	DOLBY_BUFFER_INFO video1;
	DOLBY_BUFFER_INFO video2;
}DOLBY_VIDEO_CORRESPOND_T;
...
typedef struct _SMOOTH_TOGGLE_UPDATE_INFO {
	...
	unsigned int IMD_SMOOTH_V_FREQ_1000; // in digit 3
...
#define SHAREMEM_IDX_NUM 50//how many share memory index max
// From scalerVBI.h
typedef enum
{
    // === scalerVIP.c ===
   ...
   // HDR Dolby Vision
	...
	SCALER_BSP_ERROR_REPORT_INFO_BUFFER_IDX,//for bsp error info
	CINEMA_MODE_ENABLE_IDX,
	VO_TRACK_ENABLE_IDX,
	VO_TRACK_I3_ENABLE_IDX,
	I3_NN_SHARE_BUF_STATUS_IDX,
	I3DDMA_VODMA_COMP_ATTR_IDX,
	HDMI_QMS_MODE_STATUS_IDX,//share hdmi qms mode sattus to video fw
	SCALERIOC_GAMEMODE_DATA_IDX,// share game mode info to video. notice current is game mode or not. and use line buffer  or data frc when game mode full vertical size
	VO_TRACK_I3_M_STAGE_IDX,
	VO_IVS_SRC_INFO_IDX,
	VO_FORCE_60_FRAMERATE_IDX,
	I3_CAPTURE_INDEX_IDX,
	DOLBY_BUFFER_IDX,
    SCALERIOC_SET_I3DDMA_SW_BUF_NUM_IDX,
    SCLAERIOC_SET_I3DDMA_SW_CAP0_LAST_WRITE_FLAG_IDX,
    SUB_SRNN_IDX,
    SMT_STATUS_UNDER_GAME_MODE_IDX,
    SCLAERIOC_SET_VT_DC2H_BUF_STATUS_IDX,
    FORCE_RUN_FAKE_SCALER_IDX,
    HDMI_DOLBY_VSEM_IDX,//dolby vsem info sharememory address
    GAV_START_MODE_IDX,
    GAV_QUEUE_DATA_IDX,
    GAV_ENABLE_STATE_IDX,

    /***** keep RPC_SHARE_MEM_INDEX_MAX be the lastest one!*****/
...
typedef enum
{
    I3DDMA_VIDEO_DELAY = 0,
    M_DOMAIN_VIDEO_DELAY,
    UNKNOW_VIDEO_DELAY_TYPE,
}VIDEO_DELAY_TYPE;
...
typedef enum VSC_INPUT_TYPE
{
    ...
    VSC_INPUTSRC_DP,
    VSC_INPUTSRC_CAMERA,
    VSC_INPUTSRC_MAX = VSC_INPUTSRC_CAMERA,
    VSC_INPUTSRC_MAXN,
} VSC_INPUT_TYPE_T;
...
typedef enum{
	...
	I3DDMA_CROP_CAP,
	I3DDMA_MAX_CAP,
}I3DDMA_NN_CAP_MODE_E;

typedef enum{
	I3DDMA_NN_BUFF_IN_USE,
	I3DDMA_NN_BUFF_WRITE_DONE,
}I3DDMA_NN_BUF_STATUS_E;

typedef enum{
	I3DDMA_CAP_1_1,  //1:1  uzd:crop
	I3DDMA_CAP_3_1,  //3:1
	I3DDMA_CAP_1_3,  //1:3
}I3DDMA_NN_CAP_RATIO_E;

typedef struct _I3DDMA_NN_BUFFER_ATTR_T{	//share memory
	I3DDMA_NN_CAP_MODE_E cap_mode;
	I3DDMA_NN_BUF_STATUS_E buf_status;
	unsigned int y_buffer_addr;
	unsigned int c_buffer_addr;
	unsigned long long timestamp;
}I3DDMA_NN_BUFFER_ATTR_T;

typedef enum{
	I3DDMA_UZD_CAP_ONLY,
	I3DDMA_CROP_CAP_ONLY,
	I3DDMA_CAP_MIX,
}I3DDMA_NN_SUPPORT_CAP_MODE_E;

typedef struct _I3DDMA_NN_CAP_INFO_T{	//rpc struct
	I3DDMA_NN_SUPPORT_CAP_MODE_E support_cap_mode;
	unsigned char buffer_num;
	I3DDMA_NN_CAP_RATIO_E cap_ratio;
	unsigned int start_buffer_addr;
	unsigned int buffer_size;
}I3DDMA_NN_CAP_INFO_T;

typedef enum
{
    _VO_FORCE_FRAMERATE_NONE,
	_VO_FORCE_FRAMERATE_24HZ,
    _VO_FORCE_FRAMERATE_25HZ,
    _VO_FORCE_FRAMERATE_30HZ,
    _VO_FORCE_FRAMERATE_50HZ,
    _VO_FORCE_FRAMERATE_60HZ,
} _VO_FORCE_FRAMERATE_TYPE;



#define QMS_BUFFER_NUM 3
typedef struct {
 	unsigned int QMS_ENABLE;//curent QMS mode
 	unsigned int QMS_READY;//QMS frame rate ready
	unsigned int QMS_PRE_READY;//QMS frame rate previous frame ready
 	unsigned int QMS_STABLE_FRAME_RATE;//qms stable frame rate
	unsigned int QMS_I3CAP_WRITE_IDX;//qms i3ddma capture write index
	unsigned int QMS_VODMA_READ_IDX;//qms vo dma read index
	unsigned int DMA_BUFFER_SIZE;//qms bufffer size
	unsigned int DMA_BUFFER_ADDR[QMS_BUFFER_NUM];//qms vo dma read index
}HDMI_QMS_MODE_STATUS;
...
typedef enum
{
    LOW_LATENCY_MODE_DISABLE=0,
    LOW_LATENCY_MODE_ENABLE,
    LOW_LATENCY_MODE_AUTO,
}LOW_LATENCY_MODE_INFO;
...
typedef enum VBE_INPUT_FRAMERATE_SOURCE
{
	VBE_INPUT_FRAMERATE_INFO,
	VBE_INPUT_FRAMERATE_VOPERIOD
}VBE_INPUT_FRAMERATE_SOURCE_T;

typedef enum VBE_DVTOTAL_STATUS
{
	VBE_DVTOTAL_BY_DISP,
	VBE_DVTOTAL_PRECISE,
	VBE_DVTOTAL_BY_VFREQ
}VBE_DVTOTAL_STATUS_T;

typedef struct _SEND_HDMITX_INFO{
	unsigned int hdmitx_enable;
	unsigned int hdmitx_framerate;
}SEND_HDMITX_INFO;

typedef enum
{
    SMT_NONE_STATUS,
	SMT_SMALL_TO_FULL_SCREEN_GOING,
    SMT_SMALL_TO_FULL_SCREEN_DONE,
    SMT_FULL_TO_SMALL_SCREEN_GOING,
    SMT_FULL_TO_SMALL_SCREEN_DONE,
    SMT_SMALL_TO_SMALL_SCREEN_GOING,
    SMT_SMALL_TO_SMALL_SCREEN_DONE,
} SMT_STATUS_UNDER_GAME_MODE;
typedef struct _SMOOTH_TOGGLE_STATUS_UNDER_GAME_MODE{
	SMT_STATUS_UNDER_GAME_MODE status;
}SMOOTH_TOGGLE_STATUS_UNDER_GAME_MODE;
...
typedef struct _StructUVCInfo {
	unsigned short 	  state;                  ///! the state of this display (Search, Active ...)
	unsigned short    IPH_ACT_STA;            //x
	unsigned short    IPV_ACT_STA;            //y
	unsigned short    IPH_ACT_WID;            //w
	unsigned short    IPV_ACT_LEN;            //h
	unsigned short    IHFreq;                 // Input Horizontal Frequency
	unsigned short    IVFreq;                 // Input Vertical Frequency
	unsigned short    IHTotal;                // Input Horizontal Total Length
	unsigned short    IVTotal;                // Input Vertical Total Length

	unsigned short    Crop_H_STA;             //x
	unsigned short    Crop_V_STA;             //y
	unsigned short    Crop_WID;               //w
	unsigned short    Crop_LEN;               //h

	unsigned char 	  H_ScalingDown;          ///! UVC Horizontal scaling down
	unsigned char	  V_ScalingDown;          ///! UVC Vertical scaling down
	unsigned char 	  H_ScalingUp;            ///! UVC Horizontal scaling up
	unsigned char	  V_ScalingUp;            ///! UVC Vertical scaling up

	unsigned short    UZU_H_STA;              //x
	unsigned short    UZU_V_STA;              //y
	unsigned short    UZU_WID;                //w
	unsigned short    UZU_LEN;                //h
	unsigned short    Cap_Wid;                ///! capture window width
	unsigned short    Cap_Len;                ///! capture window length
	unsigned short    UVC_OutputWid;          ///! display widnow width
	unsigned short    UVC_OutputLen;          ///! display window length
	unsigned short    UVC_OutputFrameRate;    ///! display window
	unsigned short	  UVC_OutputFormat;       ///! display window format

	unsigned char 	  Input_Position;         ///! input source of UVC
	unsigned char     Input_Color_Space;
	unsigned char     Input_Color_Depth;
	UVC_WINDOW_ZOOM_TYPE Zoom_Type;

} StructUVCInfo;


typedef struct _StructTxPreInfo {
    unsigned short  state;                    ///! the state of this display (Search, Active ...)
    unsigned short  IPH_ACT_STA;              // input act h sta
    unsigned short  IPV_ACT_STA;              // input act v sta
    unsigned short  IPH_ACT_WID;              // input act h wid
    unsigned short  IPV_ACT_LEN;              // input act v len
    unsigned short  IHFreq;                   // Input Horizontal Frequency
    unsigned short  IVFreq;                   // Input Vertical Frequency
    unsigned short  IHTotal;                  // Input Horizontal Total Length
    unsigned short  IVTotal;                  // Input Vertical Total Length
    unsigned short  IHsync;                   // Input Hsync width
    unsigned short  IVsync;                   // Input Vsync width
    unsigned short  Polarity;                 // BIT0: H Polarity, Bit1: V Polarity
    ...
    unsigned char   H_ScalingDown;            ///! txpre Horizontal scaling down
    unsigned char   V_ScalingDown;            ///! txpre Vertical scaling down

    unsigned short  Cap_Wid;                  ///! capture window width
    unsigned short  Cap_Len;                  ///! capture window length

    unsigned short  TXPRE_OUTPUT_DEN_HSTA;
    unsigned short  TXPRE_OUTPUT_DEN_HEND;
    unsigned short  TXPRE_OUTPUT_DEN_VSTA;
    unsigned short  TXPRE_OUTPUT_DEN_VEND;

    unsigned short  TXPRE_OUTPUT_ACT_HSTA;
    unsigned short  TXPRE_OUTPUT_ACT_VSTA;
    unsigned short  TXPRE_OUTPUT_ACT_WID;     ///! display widnow width
    unsigned short  TXPRE_OUTPUT_ACT_LEN;     ///! display window length
    unsigned short  TXPRE_OUTPUT_HTOTAL;
    unsigned short  TXPRE_OUTPUT_VTOTAL;
    unsigned short  TXPRE_OUTPUT_HSYNC;
    unsigned short  TXPRE_OUTPUT_VSYNC;
    unsigned short  TXPRE_OUTPUT_FRAMERATE;    ///! display window
    unsigned short  TXPRE_OUTPUT_FORMAT;       ///! display window format

    unsigned char   Input_Src;                ///! input source of tx_pre
    unsigned char   Input_Color_Space;
    unsigned char   Input_Color_Depth;
    unsigned char   Output_Color_Space;
    unsigned char   Output_Color_Depth;

    unsigned char   Interlace;                ///! interlace or progressive
    unsigned char   isVRR;                    ///! 1: vrr mode
    unsigned char   isDsc;                    ///! 1: dsc mode
} StructTxPreInfo;
