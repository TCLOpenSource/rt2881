...
//#define CONFIG_PST_ENABLE
//#define ENABLE_IMD_PST_SMOOTHTOGGLE  // enable imd pst smoothtoggle
#define PST_CMD_NUMBER 8 //hw setting + 1

//#define CONFIG_DATA_FRAMESYNC_FORCE_422_CAP

//move here for video and kdrievr
 //dtg master to golden vsync delay line & pixel, depends on memc internel delay
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE 0x75     // Merlin9 test value - would be formulated later
#define DTGM_2_GOLDEN_VSYNC_DELAY_4k1k_LINE 0x6b
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_120PANEL 0x67
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_144PANEL 0x87
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_240PANEL 0x43
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_165PANEL 0x71
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL_165PANEL 0x40
#define DTGM_2_GOLDEN_VSYNC_DELAY_ASUS_LINE_165PANEL 0x6c
#define DTGM_2_GOLDEN_VSYNC_DELAY_ASUS_PIXEL_165PANEL 0x80

#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_INX_144PANEL 0x84
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL 0x10E2  // Merlin9 test value - would be formulated later
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL_144PANEL 0x9c
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL_240PANEL 0x98
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL_INX_144PANEL 0x66
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_GAMEMODE  0x7 // since nnsr mode enlarge delay, add extra 0x30 delay to avoid frame tear
#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_4k1k_GAMEMODE 0x20

#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_67 0x67
#define DTGM_2_GOLDEN_VSYNC_DELAY_PIXEL_3C  0x3c

#define DTGM_2_GOLDEN_VSYNC_DELAY_LINE_GAMEMODE_OLED 0x27
#define DTG_MEMC_FREERUN_DEN_OFFSET -14
#define DTG_DEFAULT_S1IP_LINE_DELAY 0x2b //hw default setting 43
#define DTG_DEFAULT_TIME_BORROW_V 0x15 //hw default setting for time borrow 21
#define DTG_S1IP_4k1k_PANEL_BYPASSMEMC 23

#define DTG_ORBIT_MAX_EXTEND_V 0x10 //orbit max extend v 32/2
#define DTG_ULTRA_LOWDELAY_S1IP_LINE_DELAY 0x6 //ultra lowdelay, meet memc internal delay
#define DTG_ORBIT_STORE_MODE_OFFSET 0x2
...
#define STAGE1_STAGE2_FIFO_MARGIN 0

// data fsync parameter
#define _DTG_TIME_BORROW_LINE 21
#define _DTG_S1IP_MAX_DELAY_LINE 43
#define _M_PRE_READ_MARGIN 6	//merlin8 use 6
#define _M_PRE_READ_MARGIN_FHD 6
#define _M_DATA_FS_PRE_READ 5
#define MAX_UZD_TO_MDOMAIN_LINE_DELAY 3
#define MAX_UZU_LINE_BUFFER_LINE_CNT 4
#define _M_DATA_FS_GATTING_MASK_LINE 0
#define _M_DATA_FRC_GATTING_MASK_LINE 100

#define _VRR_MAX_SUPPORT_FRAMERATE (Get_DISPLAY_REFRESH_RATE()*1000)
#define _VRR_MIN_SUPPORT_FRAMERATE 40000

#define CONFIG_ENABLE_HDMI_NN 1
#define NN_CAP_BUFFER_NUM 4     //i3ddma capture buffer num
#define TOTAL_NN_CAP_BUFFER_NUM (NN_CAP_BUFFER_NUM)

#define WIDTH_FOR_EDGESMOOTH_DECIDE_LINE_MODE 2560 


#define ENABLE_SMOOTHTOGGLE_TEST  //open smooth toggle test case flow
#ifdef ENABLE_SMOOTHTOGGLE_TEST
#define SMT_TEST_DUMMY_REGISTER SCALEUP_DM_UZU_V8CTRL_reg  //use dummy register to decide smooth toggle test case
#define SMT_TEST_CONTROL_BIT _BIT4 
#define SMT_TEST_24HZ_BIT _BIT5 
#define SMT_TEST_30HZ_BIT _BIT6 
#define SMT_TEST_48HZ_BIT _BIT7 
#define SMT_TEST_50HZ_BIT _BIT8 
#define SMT_TEST_60HZ_BIT _BIT9 
#define SMT_TEST_120HZ_BIT _BIT10 

#define SMT_TEST_2160P_BIT _BIT16 
#define SMT_TEST_1080P_BIT _BIT17 
#define SMT_TEST_720P_BIT _BIT18 
#define SMT_TEST_540P_BIT _BIT19 
#define SMT_TEST_1080I_BIT _BIT24 
#define SMT_TEST_576I_BIT _BIT25 
#define SMT_TEST_480I_BIT _BIT26 
#define SMT_TEST_TIMING_CHANGE_BITS (SMT_TEST_24HZ_BIT|SMT_TEST_30HZ_BIT|SMT_TEST_48HZ_BIT|SMT_TEST_50HZ_BIT|SMT_TEST_60HZ_BIT|SMT_TEST_120HZ_BIT \
							|SMT_TEST_2160P_BIT|SMT_TEST_1080P_BIT|SMT_TEST_720P_BIT|SMT_TEST_540P_BIT|SMT_TEST_1080I_BIT|SMT_TEST_576I_BIT|SMT_TEST_480I_BIT)
#endif

//timing fsync + Fsync_fll_mode need adjust lastline delay,
//each chip is difference, need check with DIC when bringup
#define DTG_HTOTAL_LASTLINE_DELAY 7

#define SW_I3DDMA_CAP_NUM     (8)
...
SCALERIOC_VIP_SMARTPIC_CLUS_REMOVED, //no more use it(uncached share mem have worse performance in AutoMA)
...
SCALERIOC_SET_DC2H2_SWMODE_ENABLE,
...
SCALERIOC_DATA_PATH_INFO_TABLE,
...
SCALERIOC_BSP_ERROR_REPORT_INFO_BUFFER,
...
SCALERIOC_I3_NN_SEND_CAP_INFO,
SCALERIOC_I3_NN_SHARE_BUF_STATUS,
SCALERIOC_SET_I3DDMA_VODMA_COMP_ATTR,
SCALERIOC_GAMEMODE_FS_ENABLE,
SCALERIOC_SET_VO_FREERUN,
SCALERIOC_VO_TRACK_I3_ENABLE,
SCALERIOC_SET_I3DDMA_VODMA_SINGLE_BUFFER,
SCALERIOC_MDMI_QMS_INFO,//share hdmi qms mode status to video fw
SCALERIOC_GAMEMODE_DATA,
SCALERIOC_VO_TRACK_I3_M_STAGE,
SCALERIOC_SET_VO_IVS_SRC_HDMI,
SCALERIOC_SET_VO_I3_BUF_SW_MODE,
SCALERIOC_VO_IVS_SRC_INFO,
SCALERIOC_SET_VO_FORCE_FRAMERATE, //for measure latency purpose.
SCALERIOC_VO_FORCE_60_FRAMERATE_STATE,
SCALERIOC_I3_CAPTURE_INDEX,
SCALERIOC_DOLBY_BUFFER,
SCALERIOC_LOW_POWER_CONTROL_VIDEOFW,//vodma and isr
SCALERIOC_SET_I3DDMA_SW_BUF_BUM,
SCALERIOC_I3DDMA_CAP0_LAST_WRITE_FLAG,
SCALERIOC_SUB_SRNN,
SCLAERIOC_SET_VT_DC2H_BUF_STATUS,
SCALERIOC_SEND_HDMITX_INFO,
FORCE_RUN_FAKE_SCALER_STATE,
HDMI_DOLBY_VSEM_FLAG,
SCALERIOC_GAV_START_MODE,
SCALERIOC_GAV_QUEUE_DATA,
SCALERIOC_GAV_ENABLE_STATE,
...
{//for SCALERIOC_MAIN_INPUT_OUTPUT_BUFFER_INFO and SCALERIOC_SUB_INPUT_OUTPUT_BUFFER_INFO
	...
	unsigned short inputregion_type; //inputregion type:inputregion,inputregionEx,inputregion_adaptive
} INPUT_OUTPUT_INFO_T;
...
enum PresetModeDef
{
	...
	_MODE_848x480_60HZ,// Mode 92
	_MODE_1600x900_60HZ_RB,			// Mode 93
	_MODE_1024x576_60HZ,			// Mode 94:for MAC
	_MODE_1024x768I_43HZ,			// Mode 95
	_MODE_1280x1024_60HZ_MSPG,		// Mode 96
	_MODE_1280x768_50HZ_MSPG,		// Mode 97
	_MODE_1280x768_60HZ_MSPG,		// Mode 98
	_MODE_1280x768_75HZ_MSPG,		// Mode 99
	_MODE_1280x768_85HZ_MSPG,		// Mode 100
	_MODE_1920x1080_60Hz_173MAC,	// Mode 101:for MAC
	_MODE_PC_TIMING_END = _MODE_1920x1080_60Hz_173MAC,	//93 By Gilbert(2009/6/19) Set the end point of PC Timing

//for YPbPr & Video8
	_MODE_480I,						// Mode 102:
	_MODE_576I,						// Mode 103:
	_MODE_480P,						// Mode 104: YPbPr  720x 480px50HZ (802R)
	_MODE_576P,						// Mode 105: YPbPr  720x 576px50HZ (802R)
	_MODE_720P50,					// Mode 106: YPbPr 1280x 720px50HZ
	_MODE_720P60,					// Mode 107: YPbPr 1280x 720px60HZ (802R)
	_MODE_1080I25,					// Mode 108: YPbPr 1920x1080ix50HZ (802R)
	_MODE_1080I30,					// Mode 109: YPbPr 1920x1080ix60HZ (802R)
	_MODE_1080P50,					// Mode 110: YPbPr 1920x1080px50HZ (802R)
	_MODE_1080P60,					// Mode 111:  YPbPr 1920x1080px60HZ (802R)
	_MODE_720P25,                   // Mode 112
	_MODE_720P30,                   // Mode 113
	// CSW+ 0971225 Add YPbPr timing 1080P/25HZ/24HZ/23.97HZ/29.97HZ/30HZ
	_MODE_1080P23,					// Mode 114: YPbPr 1920x1080px23.976HZ (802R)
	_MODE_1080P24,					// Mode 115: YPbPr 1920x1080px24HZ (802R)
	_MODE_1080P25,					// Mode 116: YPbPr 1920x1080px25HZ (802R)
	_MODE_1080P29,					// Mode 117: YPbPr 1920x1080px29.976HZ (802R)
	_MODE_1080P30,					// Mode 118 YPbPr 1920x1080px30HZ (802R)};
// for HDMI :Justin
	_MODE_1080PM50,					// Mode 119:  HDMI 960x1080px50HZ (802R) //forster modified 050823
	_MODE_1080PM60,					// Mode 120:  HDMI 960x1080px60HZ (802R) //forster modified 050823
	_MODE_480I_DH,					// Mode 121
	_MODE_576I_DH,					// Mode 122
	_MODE_VIDEO_TIMING_END = _MODE_576I_DH, //112 for API have same video timing condition

	_MODE_1920x1200_60HZ,			// Mode 123
	_MODE_4k2kI30,					// Mode 124
	_MODE_4k2kP30,					// Mode 125
	_MODE_4k2kP24,					// Mode 126
	_MODE_4k2kP25,					// Mode 127
	_MODE_4k2kP48,					// Mode 128
	_MODE_4k2kP50,					// Mode 129
	_MODE_4k2kP60,					// Mode 130
	_MODE_3840_540_60P,//Mode 131: 4k 0.5k verify mode timng
	_MODE_1080_1920_60P,//Mode 132:1k 2k verify mode timng
...
#define DATAFS_VDEC_RUN_DATAFS_WIDTH 1920
#define DATAFS_VDEC_RUN_DATAFS_HEIGHT 1080
...
#if 1 // 6_buffer
#define ME_TOTAL_SIZE 0x673A40//0x654000
#define ME_SHARE_TOTAL_SIZE 0x84E40//0x1fa40
#define MV_INFO_TOTAL_SIZE 0x8b380
...
#define KME_TOTAL_SIZE (ME_TOTAL_SIZE + ME_SHARE_TOTAL_SIZE + MV_INFO_TOTAL_SIZE)
#define KMC_TOTAL_SIZE_8buf_8bit 0x3ce8800
#define KMC_TOTAL_SIZE_8buf_8bit_QS	(0x2DFA50)
#define KMC_TOTAL_SIZE_8buf_10bit 0x4cba800 // 0x3ce8800
#define KMC_TOTAL_SIZE_6buf_10bit 0x398be00
#define KMC_TOTAL_SIZE 0x398be00 // (MEMC_KMC_00_START_TOTAL_SIZE + MEMC_KMC_01_START_TOTAL_SIZE) //
#define KME1_RPT_TOTAL_SIZE (MEMC_KME1_RPT_PPFV_TOTAL_SIZE + MEMC_KME1_RPT_PFV_TOTAL_SIZE)
#define KMEMC_TOTAL_SIZE_8buf_8bit (KME_TOTAL_SIZE + MEMC_IPME_TOTAL_SIZE + KME1_RPT_TOTAL_SIZE + KMC_TOTAL_SIZE_8buf_8bit)
#define KMEMC_TOTAL_SIZE_8buf_8bit_QS (KME_TOTAL_SIZE + MEMC_IPME_TOTAL_SIZE + KME1_RPT_TOTAL_SIZE + KMC_TOTAL_SIZE_8buf_8bit_QS)
#define KMEMC_TOTAL_SIZE_8buf_10bit (KME_TOTAL_SIZE + MEMC_IPME_TOTAL_SIZE + KME1_RPT_TOTAL_SIZE + KMC_TOTAL_SIZE_8buf_10bit)
#define KMEMC_TOTAL_SIZE_6buf_10bit (KME_TOTAL_SIZE + MEMC_IPME_TOTAL_SIZE + KME1_RPT_TOTAL_SIZE + KMC_TOTAL_SIZE_6buf_10bit)
#define KMEMC_TOTAL_SIZE (KME_TOTAL_SIZE + KMC_TOTAL_SIZE + MEMC_IPME_TOTAL_SIZE + KME1_RPT_TOTAL_SIZE)
#else
#define KME_TOTAL_SIZE (MEMC_KME_00_TOTAL_SIZE + MEMC_KME_08_TOTAL_SIZE + MEMC_KME_10_TOTAL_SIZE + MEMC_KME_12_TOTAL_SIZE + MEMC_KME_14_TOTAL_SIZE + MEMC_KMV_01_TOTAL_SIZE + MEMC_KMV_02_TOTAL_SIZE + MEMC_KMV_04_TOTAL_SIZE + MEMC_KMV_05_TOTAL_SIZE) // 0x6fedc0 // 
#define KMC_TOTAL_SIZE 0x398be00 // (MEMC_KMC_00_START_TOTAL_SIZE + MEMC_KMC_01_START_TOTAL_SIZE) // 
#define KME1_RPT_TOTAL_SIZE (MEMC_KME1_RPT_PPFV_TOTAL_SIZE + MEMC_KME1_RPT_PFV_TOTAL_SIZE)
#define KMEMC_TOTAL_SIZE (KME_TOTAL_SIZE + KMC_TOTAL_SIZE + MEMC_IPME_TOTAL_SIZE + KME1_RPT_TOTAL_SIZE)
#endif
...
#define MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(CMP_WID, CMP_LEN, CMP_RATIO) (drvif_memory_get_data_align(calc_comp_line_sum_bit((CMP_WID), (CMP_RATIO)) * 128 / 8, DMA_SPEEDUP_ALIGN_VALUE) * (CMP_LEN) + FINAL_BURST_LENTH)
...
#ifdef CONFIG_RTK_KDRV_DV_IDK_DUMP
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_MAX_SIZE, M_DOMAIN_LEN_MAX_SIZE, 12)//Update M-domain 2k1k 12bits for PQDC align
#else//#ifdef CONFIG_RTK_KDRV_DV_IDK_DUMP
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_CARVEOUT, M_DOMAIN_LEN_CARVEOUT, 12)//Update M-domain 2k1k 12bits for PQDC align
#endif
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_4K MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_MAX_SIZE, M_DOMAIN_LEN_MAX_SIZE, 12)//Update M-domain 2k1k 12bits for PQDC align
#else //#ifdef CONFIG_BW_96B_ALIGNED
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_CARVEOUT, M_DOMAIN_LEN_CARVEOUT, 12)
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_4K  MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_MAX_SIZE, M_DOMAIN_LEN_MAX_SIZE, 12)
#endif
...
#ifdef CONFIG_RTK_KDRV_DV_IDK_DUMP
#define MDOMAIN_MAIN_BUFFER_SIZE_20BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_MAX_SIZE, M_DOMAIN_LEN_MAX_SIZE, 20) //M-domain RGB444 mode 20bits
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_MAX_SIZE, M_DOMAIN_LEN_MAX_SIZE, 16) //livezoomcase
#else
#define MDOMAIN_MAIN_BUFFER_SIZE_20BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_CARVEOUT, M_DOMAIN_LEN_CARVEOUT, 20) //M-domain RGB444 mode 20bits
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_CARVEOUT, M_DOMAIN_LEN_CARVEOUT, 16) //livezoomcase
#endif
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_MAX_SIZE, M_DOMAIN_LEN_MAX_SIZE, 16) //livezoomcase
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K120_CO_BUFFER (MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_MAX_SIZE, M_DOMAIN_LEN_MAX_SIZE, 16)  + FINAL_BURST_LENTH)//4k120 co buffer size
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_HDMI MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_CARVEOUT, M_DOMAIN_LEN_CARVEOUT, 16) //livezoomcase
#else //#ifdef CONFIG_BW_96B_ALIGNED
#define MDOMAIN_MAIN_BUFFER_SIZE_20BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_CARVEOUT, M_DOMAIN_LEN_CARVEOUT, 20)//M-domain RGB444 mode 20bits
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_CARVEOUT, M_DOMAIN_LEN_CARVEOUT, 16)//livezoomcase
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_4K MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_MAX_SIZE, M_DOMAIN_LEN_MAX_SIZE, 16)//livezoomcase
...
#define MDOMAIN_MAIN_BUFFER_SIZE_MULT2K_12BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_2K, M_DOMAIN_LEN_2K, 12)
#define MDOMAIN_MAIN_BUFFER_SIZE_MULT4K_12BITS MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_MAX_SIZE, M_DOMAIN_LEN_MAX_SIZE, 12)

/* apvr and livezoom sub size*/
#define MDOMAIN_SUB_BUFFER_SIZE MDOMAIN_CMP_LINE_MODE_BUFFER_SIZE(M_DOMAIN_WIDTH_2K, M_DOMAIN_LEN_2K, 12) //2k1k 12 bits
...
#define VIP_DeMura_BUFFER_SIZE (1024 * 1024 * 4) //k5lp DeMura 1M
...
typedef enum
{
	DOLBY_HDMI_DRM_DISABLE = 0,
	DOLBY_HDMI_DRM,
}DOLBY_HDMI_DRM_T;

typedef enum
{
	DOLBY_DP_SDP_DISABLE = 0,
	DOLBY_DP_SDP_STD,
	DOLBY_DP_SDP_LL,
} DOLBY_DP_SDP_T;
...
typedef enum
{
	DOLBY_DP_VSC_EXT_VESA_SDP_DISABLE = 0,
	DOLBY_DP_VSC_EXT_VESA_SDP_STD,
	DOLBY_DP_VSC_EXT_VESA_SDP_LL,
} DOLBY_DP_VSC_EXT_VESA_SDP_T;

typedef enum
{
	DOLBY_DP_NONE = 0,
	DOLBY_DP_SDP,
	DOLBY_DP_VSC_EXT_VESA_SDP,
	DOLBY_DP_DRM,
} DOLBY_DP_TYPE;
...
typedef enum {
    SCALER_INPUT_COLOR_RGB = 0x00,
    SCALER_INPUT_COLOR_YUV422,
    SCALER_INPUT_COLOR_YUV444,
    SCALER_INPUT_COLOR_YUV420,
    SCALER_INPUT_COLOR_UNKNOW
} SCALER_INPUT_COLOR_SPACE_T;//Scaler input path color space
...
typedef enum {
    _T_HDMI_2K1K_1P = 0,    // Match INPUT_TIMING_INDEX {HDMI_2K1K_30, HDMI_2K1K_60, HDMI_2K1K_120}
    _T_HDMI_2K1K_2P,        // Match INPUT_TIMING_INDEX {HDMI_2K1K_240}
    _T_HDMI_4K2K_1P,        // Match INPUT_TIMING_INDEX {HDMI_4K2K_30, HDMI_4K2K_60}
    _T_HDMI_4K2K_2P,        // Match INPUT_TIMING_INDEX {HDMI_4K2K_120, HDMI_8K4K_30, HDMI_8K4K_60}
    _T_AVD_2K1K_1P,
    _T_QMS_2K1K_1P,
    _T_QMS_2K1K_2P,
    _T_QMS_4K2K_1P,
    ...
    _T_DOLBY_4K2K_1P,
    _T_DOLBY_4K2K_2P,
    _T_VO_2K1K_1P,          // Match INPUT_TIMING_INDEX {VO_2K1K_30, VO_2K1K_60, VO_2K1K_120}
    _T_VO_4K1K_1P,          // Match INPUT_TIMING_INDEX {VO_4K1K_120}
    _T_VO_4K2K_1P,          // Match INPUT_TIMING_INDEX {VO_4K2K_30, VO_4K2K_60}
    _T_VO_4K2K_2P,          // Match INPUT_TIMING_INDEX {VO_4K2K_120, VO_8K4K_30, VO_8K4K_60}
    _T_CP_2K1K_1P,          // Match INPUT_TIMING_INDEX {CP_2K1K_30, CP_2K1K_60, CP_2K1K_120}
    _T_CP_4K1K_1P,          // Match INPUT_TIMING_INDEX {CP_4K1K_120}
    _T_CP_4K2K_1P,          // Match INPUT_TIMING_INDEX {CP_4K2K_30, CP_4K2K_60}
    _T_CP_4K2K_2P,          // Match INPUT_TIMING_INDEX {CP_4K2K_120, CP_8K4K_30, CP_8K4K_60}
    _T_JPEG_INDEX,          // Match INPUT_TIMING_INDEX {JPEG_2K1K_30, JPEG_4K2K_30, JPEG_8K4K_30}
    _T_TIMING_INVAILD
} SRC_TIMING_INDEX;

typedef struct VSC_DATA_PATH_INDICATOR{
    // SRC_TIMING_INDEX    index;
    unsigned int        free_run;       // 0: frc, 1: frame sync
    unsigned int        runI3ddma;      // 0: not runI3ddma, 1: runI3ddma
}VSC_DATA_PATH_INDICATOR;

typedef struct VSC_DATA_PATH_INFO{
	VSC_DATA_PATH_INDICATOR vsc_data_path[_T_TIMING_INVAILD];
}VSC_DATA_PATH_INFO;
...
typedef struct _PST_START_ADDR {
	...
	unsigned int	main_mdom_buf_delay_cnt_addr;
	unsigned int	sub_mdom_buf_delay_cnt_addr;
} PST_START_ADDR;
...
/*
1. Main smooth toggle fail
2. Sub smooth toggle fail
3. Main M domain PQC error
4. Main M domain PQDC error
5. Sub M domain PQC error
6. Sub M domain PQDC error
7. Line buffer sync error
8. MEMC PQC error
9. MEMC PQDC error
10 MEMC DMA error
11.I3DDMA pqc error
12 VO i3ddma PQDC error
13 VO1 vdec compress error
14 VO1 vdec decompress error
13 VO2 vdec compress error
14 VO2 vdec decompress error
15.DI PQC error
16.DI PQDC error
17.OD PQC error
18.OD PQDC error
...
typedef enum
{
	Main_Smooth_Toggle_Fail = 0,
	Sub_Smooth_Toggle_Fail,
	Main_M_domain_PQC_error,
	Main_M_domain_PQDC_error,
	Sub_domain_PQC_error,
	Sub_domain_PQDC_error,
	Main_VI_error,
	Sub_VI_error,
	Line_Buffer_Sync_Error,
	MEMC_PQC_Error,
	MEMC_PQDC_Error,
	MEMC_DMA_Error,
	I3DDMA_PQC_Error,
	VO_I3ddma_PQDC_Error,
	VO1_Vdec_DMA_error,
	VO1_Vdec_Decompress_error,
	VO2_Vdec_DMA_error,
	VO2_Vdec_Decompress_error,
	DI_PQC_Error,
	DI_PQDC_Error,
	OD_DMA_Error,
	OD_PQC_Error,
	OD_PQDC_Error,
	BSP_ERROR_REPORT_TYPE_TOTAL_NUM,//total error type. can not change position. This is for video fw dma error max
	Abnormal_Run_Scaler = 150,//some error need to re run scaler kernel handler
	Main_Mute_Time_Abnormal,//Main path keep mute long time when AP already mute off kernel handler
	Sub_Mute_Time_Abnormal,//Sub path keep mute long time when AP already mute off kernel handler
} BSP_ERROR_REPORT_TYPE_INDEX;

#define	BSP_ERROR_REPORT_RING_BUFFER_SIZE (BSP_ERROR_REPORT_TYPE_TOTAL_NUM*2)
#define	BSP_ERROR_REPORT_INFO_UPDATE_WAIT_FRAME_NUM 300

typedef struct
{//for BSP error info
	unsigned int error_type;//error type
	unsigned int system_time;//90k counter
} BSP_ERROR_TYPE_INFO_T;

typedef struct
{//for BSP error message ring buffer
	unsigned short reset_read_idx;//When set search state
	unsigned short reset_write_idx;//When set search state
	unsigned int read_idx;//update at kernel
	unsigned int write_idx;//update at video fw
	unsigned int error_update_counter[BSP_ERROR_REPORT_TYPE_TOTAL_NUM];//frame number is zero to update
	unsigned int error_type_buffer[BSP_ERROR_REPORT_RING_BUFFER_SIZE];
} BSP_ERROR_REPORT_RING_BUFFER_INFO_T;

typedef enum
{
    DMA_ERR_H3DDMA_PQ_CMP_IRQ_ST_IDX = 0,
    DMA_ERR_VODMA_PQ_DECMP_IDX,
    DMA_ERR_VODMA_VGIP_INTST_IDX,
    DMA_ERR_VODMA_WRAP_FIFO_IDX,
    DMA_ERR_DECOMP_CORE_STATUS_IDX,
    DMA_ERR_DI_DDR_DMA_STATUS_IDX,
    DMA_ERR_DI_MVF_DDR_DMA_STATUS_IDX,
    DMA_ERR_DI_PQ_CMP_IRQ_ST_IDX,
    DMA_ERR_DI_PQ_DECMP_IRQ_ST_IDX,
    DMA_ERR_CAP2_DDR_FIFO_STATUS_IDX,
    DMA_ERR_CAP1_DDR_FIFO_STATUS_IDX,
    DMA_ERR_CAP2_HELP_DEBUG_STATUS_IDX,
    DMA_ERR_CAP1_HELP_DEBUG_STATUS_IDX,
    DMA_ERR_CPA2_ICH12_IBUFF_STATUS_IDX,
    DMA_ERR_CPA1_ICH12_IBUFF_STATUS_IDX,
    DMA_ERR_CAP_PQ_CMP_IRQ_ST_IDX,
    DMA_ERR_CAPS_PQ_CMP_IRQ_ST_IDX,
    DMA_ERR_VI_MAIN_INTST_IDX,
    DMA_ERR_VI_SUB_INTST_IDX,
    DMA_ERR_DISP_DDR_FIFO_STATUS_IDX,
    DMA_ERR_DISP_HELP_DEBUG_IDX,
    DMA_ERR_DISP_MAIN_PQ_DECMP_IRQ_ST_IDX,
    DMA_ERR_DISP_SUB_PQ_DECMP_IRQ_ST_IDX,
    DMA_ERR_UZU_BUF_UDF_IDX,
    DMA_ERR_ODDMA_STATUS_IDX,
    DMA_ERR_ODDMA_PQ_CMP_IRQ_ST_IDX,
    DMA_ERR_ODDMA_PQ_DECMP_IRQ_ST_IDX,
    DMA_ERR_DC2H_CAP_DDR_OVER_RANGE_IDX,
    DMA_ERR_DC2H_CAP_FIFO_OVERFLOW_IDX,
    DMA_ERR_DC2H_CAP_FIFO_UNDERFLOW_IDX,
    DMA_ERR_MC_LF_PQ_CMP_IRQ_ST_IDX,
    DMA_ERR_MC_LF_PQ_DECMP_IFRAME_IDX,
    DMA_ERR_MC_LF_PQ_DECMP_PFRAME_IDX,
    DMA_ERR_MC_LF_PQ_DECMP_REPEAT_IFRAME_IDX,
    DMA_ERR_MC_LF_PQ_DECMP_REPEAT_PFRAME_IDX,
    DMA_ERR_MC_HF_PQ_CMP_IRQ_ST_IDX,
    DMA_ERR_MC_HF_PQ_DECMP_IFRAME_IDX,
    DMA_ERR_MC_HF_PQ_DECMP_PFRAME_IDX,
    DMA_ERR_MC_HF_PQ_DECMP_REPEAT_IFRAME_IDX,
    DMA_ERR_MC_HF_PQ_DECMP_REPEAT_PFRAME_IDX,
    DMA_ERR_MC_LF_WR_STATUS_IDX,
    DMA_ERR_MC_HF_WR_STATUS_IDX,
    DMA_ERR_STATUS_IDX,
    DMA_ERR_STATUS_MAX_IDX
} DMA_ERROR_STATUS_INDEX;

typedef struct
{
    unsigned int dma_err_status[DMA_ERR_STATUS_MAX_IDX];
    unsigned int dma_err_counter[DMA_ERR_STATUS_MAX_IDX];
} DMA_ERROR_STATUS_RECORD_T;
...
typedef enum {
	GAMEMODE_NONE = 0,//current is  not game mode
	GAMEMODE_FRC = 1,//current is game mode and use data frc when vertical full panel
	GAMEMODE_FS = 2,//current is game mode and use line buffer when vertical full panel
} GAMEMODE_TYPE;

typedef struct _GAME_MODE_DATA {
	GAMEMODE_TYPE game_mode_type;//decide game mode or not.  or game mode using line buffer or data frc
	unsigned int is_2k_memory_buffer_source;//m domain using 2k memory size
} GAME_MODE_DATA;
typedef enum SUB_SRNN_TYPE
{
    SUB_UZD_SRNN,
    SUB_MDOMAIN_SRNN,
}SUB_SRNN_TYPE_E;

//for share i3ddma and vodma pqc/pqdc compression attributes
typedef struct{
	unsigned int bOnOff; //comp on/off
	unsigned int comp_mode; //comp mode
	unsigned int comp_bits; //comp bits 
}I3DDMA_VODMA_COMP_ATTR_T;

typedef enum{
	DEFAULT_KEEP_FRAMERATE = 0,            
	VO_ORIGINAL_24_FORCE_60 = 1,
	VO_60_CHANGE_ORIGINAL_24 = 2,
	VO_24_TRIGGER_SMT = 3,
	VO_SMT_24_FINISH = 4,//4
}_VO_24_FORCE_60_FRAMERATE_STATE;
