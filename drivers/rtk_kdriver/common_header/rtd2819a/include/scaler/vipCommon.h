...
typedef struct {
	...
	int v_offset7;
	int v_offset8;
} Color_Independent_uvoffset_curve;
...
typedef struct {
    ...
    #ifdef vip_3
    Color_Independent_uvoffset_curve S_DCC_Skin_Tone_uvoffset_curve;
    #endif
...
typedef enum _VIP_YUV2RGB_INPUT_DATA_MODE {
	...
	YUV2RGB_INPUT_MODE_RGB2RGB_Full,
	YUV2RGB_INPUT_MODE_RGB2RGB_Limit,
...
typedef struct _DRV_VIP_YUV2RGB_COEF_By_Y {
	...
	unsigned short K21[VIP_YUV2RGB_Y_Seg_Max];	
	unsigned short K31[VIP_YUV2RGB_Y_Seg_Max];
	unsigned short bt2020_K13;
	unsigned short bt2020_K32;
...
typedef struct _VIP_USING_YUV2RGB_CSMatrix {
	...
	unsigned char Input_Data_Mode_sub;
...
typedef struct {
//ctl1  data_sel, maxlen, psmth, lpmode, engdiv, offdiv, uvgain, dcti_mode, uvalign_en, cur_sel, dcti_en
...
typedef struct {
//ctl4  rate_align_weight, rate_align, th_align, align_minGain, th_gtran
...
typedef struct {
//ctl5  th_uvMinDiff, rate_stair2, rate_stair1, th_stair, th_align_weight
...
typedef struct {
//ctl6  rate_engSync, rate_unMinDiff, th_engSync
#ifdef vip_3
    unsigned char rate_engSync;
	unsigned char rate_unMinDiff;
...
typedef struct {
//ctl7  debug_shiftbit, debug_mode
...
typedef struct {
//ctl5  static_en, th_uvMinDiff, rate_stair2, rate_stair1, th_stair, th_align_weight
#ifdef vip_3
	unsigned char static_en;
	unsigned char th_uvMinDiff;
	unsigned char rate_stair2;
	unsigned char rate_stair1;
	unsigned char th_stair;
...
typedef struct {
    //ctl6  static_hist, rate_engSync, rate_unMinDiff, th_engSync
#ifdef vip_3
	unsigned int  static_hist;
	unsigned char rate_engSync;
	unsigned char rate_unMinDiff;
	unsigned char th_engSync;
#else
...
typedef struct {
	...
	short Reserved10;/*magellan2*/
	short pndu;/*Merlin4*/
	short detail_v_edg_en;/*Merlin3*/
	short detail_v_tex_en;/*Merlin3*/
	short detail_edg_en;/*Merlin3*/
	short detail_tex_en;/*Merlin3*/
...
typedef struct {
	unsigned char diff_gain_en;
	unsigned char positive_diff_gain;
	unsigned char negative_diff_gain;
} DRV_LC_Shp_DiffGain;
typedef struct {
...
#define SRNN_DEFAULT_WEIGHT_TABLE_NUM_MAX (4)
...
#define SRNN_WEIGHT_NUM_MAX (30000)
...
/*0*/	VIP_SRNN_60HZ_2X_480,
/*1*/	VIP_SRNN_60HZ_2X_576,
/*2*/	VIP_SRNN_60HZ_2X_720,
/*3*/	VIP_SRNN_60HZ_2X_PREDOWN,
/*4*/	VIP_SRNN_60HZ_3X_576,
/*5*/	VIP_SRNN_60HZ_3X_720,
/*6*/	VIP_SRNN_60HZ_4X, 
/*7*/	VIP_SRNN_120HZ_2X_480,
/*8*/	VIP_SRNN_120HZ_2X_576,
/*9*/	VIP_SRNN_120HZ_2X_720,
/*10*/	VIP_SRNN_120HZ_3X_576,
/*11*/	VIP_SRNN_120HZ_3X_720,
/*12*/	VIP_SRNN_120HZ_4X,
/*13*/	VIP_SRNN_HSR_2X_480,
/*14*/	VIP_SRNN_HSR_2X_576,
/*15*/	VIP_SRNN_HSR_2X_720,
/*16*/	VIP_SRNN_HSR_2X_PREDOWN,
/*17*/	VIP_SRNN_HSR_3X_576,
/*18*/	VIP_SRNN_HSR_3X_720,
/*19*/	VIP_SRNN_HSR_4X,
/*20*/	VIP_SRNN_SQM_4K_4K,
/*21*/	VIP_SRNN_SQM_4K_2KGOOD,
/*22*/	VIP_SRNN_SQM_4K_2KNORM,
/*23*/	VIP_SRNN_SQM_4K_720,
/*24*/	VIP_SRNN_SQM_4K_480,
/*25*/	VIP_SRNN_SQM_2K_2KGOOD,
/*26*/	VIP_SRNN_SQM_2K_2KNORM,
/*27*/	VIP_SRNN_SQM_2K_720,
/*28*/	VIP_SRNN_SQM_2K_480,
/*29*/	VIP_SRNN_TIMING_MAX,
...
typedef struct {
	VIP_SRNN_POST_CTRL PostProc;
} DRV_SRNN_CTRL_TABLE;

typedef struct VIP_SRNN_BLOCK_CTRL {
	unsigned char BlockDisable[6];
	unsigned char FeatReduce[6];
} VIP_SRNN_BLOCK_CTRL;
...
typedef struct {
	unsigned short Param_SRNN_60HZ_2X_480[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_60HZ_2X_576[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_60HZ_2X_720[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_60HZ_2X_PREDOWN[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_60HZ_3X_576[SRNN_WEIGHT_NUM_MODE5];
	unsigned short Param_SRNN_60HZ_3X_720[SRNN_WEIGHT_NUM_MODE5];
	unsigned short Param_SRNN_60HZ_4X[SRNN_WEIGHT_NUM_MODE7];
	unsigned short Param_SRNN_120HZ_2X_480[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_120HZ_2X_576[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_120HZ_2X_720[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_120HZ_3X_576[SRNN_WEIGHT_NUM_MODE5];
	unsigned short Param_SRNN_120HZ_3X_720[SRNN_WEIGHT_NUM_MODE5];
	unsigned short Param_SRNN_120HZ_4X[SRNN_WEIGHT_NUM_MODE7];
	unsigned short Param_SRNN_HSR_2X_480[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_HSR_2X_576[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_HSR_2X_720[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_HSR_2X_PREDOWN[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_HSR_3X_576[SRNN_WEIGHT_NUM_MODE5];
	unsigned short Param_SRNN_HSR_3X_720[SRNN_WEIGHT_NUM_MODE5];
	unsigned short Param_SRNN_HSR_4X[SRNN_WEIGHT_NUM_MODE7];
	unsigned short Param_SRNN_SQM_4K_4K[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_SQM_4K_2KGOOD[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_SQM_4K_2KNORM[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_SQM_4K_720[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_SQM_4K_480[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_SQM_2K_2KGOOD[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_SQM_2K_2KNORM[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_SQM_2K_720[SRNN_WEIGHT_NUM_MODE2];
	unsigned short Param_SRNN_SQM_2K_480[SRNN_WEIGHT_NUM_MODE2];
}DRV_SRNN_PARAM;
...
typedef struct {
    ...
    DRV_CDLC CDLC_TBL[LC_Table_NUM];
    DRV_LC_ToneMapping_Yavg_Yin_Blend LC_ToneMapping_Yavg_Yin_Blend_TBL[LC_Table_NUM];
    DRV_LC_Shp_DiffGain LC_Shp_DiffGain_TBL[LC_Table_NUM];
...
typedef struct {
	...
	unsigned char HDR_flag_sub;
	unsigned char DolbyHDR_flag_sub;
...
typedef struct
{
	...
	unsigned char ld_spatialcoef_div;/*Merlin8 add SpatialCoef_div*//*ml9 no hw*/
...
typedef struct{
	...
	unsigned short ld_bpl_first_avg; // K25 remove
	unsigned short ld_local_bv_gain_avg;
	unsigned short ld_ai_brightness_avg;
	unsigned short ld_blu_spi_avg;   // K25 add
	unsigned short ld_abi_avg;       // K25 remove
	unsigned short ld_third_bpl_avg; // K25 remove
	unsigned short ld_backlightboost_avg;
	unsigned short ld_apl_global_mean_avg; // K25 add
}DRV_LD_Average_Bv;/*read only*/

typedef struct{
	unsigned char ld_3x3lpf_en;/*no this HW*/
	unsigned char ld_3x3lpfcoef3;/*no this HW*/
	unsigned char ld_3x3lpfcoef2;/*no this HW*/
	unsigned char ld_3x3lpfcoef1;/*no this HW*/
	unsigned char ld_3x3lpfcoef0;/*no this HW*/
...
}DRV_LD_Spatial_Remap3;/*no this HW*/
...
typedef struct {
	...
	unsigned char ld_tmp_gain_sel; // new feature for daul
...
typedef struct {
	...
	DRV_LD_Spatial_Remap2 LD_Spatial_Remap2;
	DRV_LD_Spatial_Remap3 LD_Spatial_Remap3;
	...
	DRV_LD_Backlight_LPF LD_Backlight_LPF;
	DRV_LD_Global_Gain LD_Global_Gain;
	DRV_LD_Bl_Pixel_Bv_Gain_Offset LD_Pixel_Bv_Gain_Offset;
...
typedef enum _SLR_AI_Sematic_Items{
		...
		SLR_AI_Sematic_Items_dummy0,
		SLR_AI_Sematic_Items_dummy1,
...
typedef struct {
    ...
    short vpk_gain_pos;
    short vpk_gain_neg;    
    short vpk_edg_gain_pos;
    short vpk_edg_gain_neg;
}SLR_AI_Shp_CDS;

typedef struct {
	unsigned char ICM_en;
...
typedef enum _AIPQ_level{
    AIPQ_level_OFF=0,
    AIPQ_level_LOW, 
    AIPQ_level_Mid, 
    AIPQ_level_High, 
    AIPQ_level_Not_apply,
    
    AIPQ_level_MAX,
}AIPQ_level; 

typedef struct {
      unsigned char OD_Level;
      DRV_OD_Gain OD_Gain;;
}AI_PQ_OD_Item;
...
typedef struct {
      ...
      unsigned short Sharpness_value;
      unsigned char DCC_Level;
      unsigned char NR_Level;
      unsigned char MPEG_NR_Leve;
      unsigned char Smooth_Gradation;
      AI_PQ_OD_Item OD_item;
}AI_PQ_Item;
#endif
...
#ifdef AIPQ_2819a
#define SLR_AI_DETECT_NUM 9
typedef struct _SLR_VIP_TABLE_AIPQ {
	SLR_AI_Tune_ICM_table Tune_ICM_table[SLR_AI_TBL_NUM];
	SLR_AI_Old_Skin_DCC DCC_Old_Skin_table[SLR_AI_TBL_NUM];
	SLR_AI_Shp_CDS AI_Shp_CDS_TBL[SLR_AI_TBL_NUM];
    SLR_AI_ICM_RGB_Offset_table tICM_RGB_Offset_AIPQ[SLR_AI_DETECT_NUM];
    LC_Offset_table LC_Offset[SLR_AI_DETECT_NUM];
    SLR_AI_WB AI_WB_table[SLR_AI_DETECT_NUM];
    UVOffsetbyY_Offset_table UVOffsetbyY_Offset[SLR_AI_DETECT_NUM];
    AI_PQ_Item AIPQ_APDEM[SLR_AI_DETECT_NUM];
...
typedef struct {
        ...
        unsigned char last_zero_dir;    /*0:MSB{zero,data}  1:LSB{data,zero}*/
        unsigned char last_zero_padding; /*merin9: for RL6982-602, multi add using padding zero way*/
...
typedef struct {
    ...
    unsigned short  bpl_average; /*（bpl_result）use when sw mode write == spec's bpl_result*/
    unsigned short  sram_hw_write_num_set;/*same as output number*/
    unsigned short  bpl_compare; /*1.bpl compare mode 0:original bpl mode*/
    unsigned short  apl_bpl_map_shift; /*0:[7:0] 1:[8:1]...8:[15:8]*/
    unsigned short  bpl_sw;   /*for compare mode info,used when bpl ccompare:1*/
    unsigned short  bpl_sw_r; /*for dual panel,compare mode info,used when bpl ccompare:1*/
    unsigned short  bpl_average_r; /*for dual panel,write when not comapre mode and sw mode == spec's bpl_result_r*/
} DRV_LDINTERFACE_APLBPL;

/*APL_BPL Status*/
typedef struct {

    unsigned short  apl_average;
    unsigned short  apl_max;
    unsigned short  apl_min;
    unsigned short  apl_average_r;
    unsigned short  apl_max_r;
    unsigned short  apl_min_r;
    unsigned short  bpl_average; /*spec's bpl_average*/
    unsigned short  bpl_average_r; /*spec's bpl_average_r*/
} DRV_LDINTERFACE_APLBPLStatus;

/*Checksum Info*/
typedef struct{
    unsigned char check_sum_minus;
    unsigned char check_sum_start;
    unsigned char check_sum_position;
}DRV_LDINTERFACE_Checksum;

/*sdo adjust*/
typedef struct{
    unsigned char sdo_phase_adjust0;
    unsigned char sdo_phase_adjust1;
    unsigned char sdo_phase_adjust2;//res in mac9q
    unsigned char sdo_phase_adjust3;//res in mac9q
}DRV_LDINTERFACE_SdoAdjust;

/*Double Sram Ctrl*/
typedef struct{
    unsigned char ldspi_buf_sel;
    unsigned char ld_buf_sel;
    unsigned char datasram_double_en;
}DRV_LDINTERFACE_DoubleSram;

/*Double vs*/
typedef struct{
    unsigned char memc_output_frame_en;
    unsigned char remove_num_sel;
    unsigned char db_vs_en;
}DRV_LDINTERFACE_DoubleVs;

/*Boost Gain*/
typedef struct{
    unsigned char bpl_current_mode_en;
    unsigned char bpl_Current_APL_SW_set;
    unsigned char bpl_current_shift;
    unsigned char bpl_initial_gain;//default:0x3ff
    unsigned char bpl_map_en;//when ldspi data>bpl_map_th, ld_spi_data change to 16h'ffff
    unsigned char bpl_map_th;
    unsigned char smooth_en;
    unsigned short smooth_th1; //10 bit
    unsigned short smooth_th2; //10 bit
    unsigned short smooth_step1;//10 bit
    unsigned short smooth_step2;//10 bit
    unsigned short smooth_step3;//10 bit
}DRV_LDINTERFACE_CurrentGain;


/*Boost Gain Status*/
typedef struct{
    unsigned char bpl_gain_update;
    unsigned char bpl_update_error;
    unsigned char apl_avg_update;
    unsigned char bpl_current_gain_diff_dir;
    unsigned char bpl_current_gain;
    unsigned char bpl_current_gain_diff;
    unsigned char bpl_current_pre_gain;
}DRV_LDINTERFACE_CurrentGainStatus;

/*extra append function*/
typedef struct{
    unsigned char app_bit15_val;
    unsigned char app_bit14_val;
    unsigned char app_bit13_val;
    unsigned char app_bit12_val;
    unsigned char app_bit11_val;
    unsigned char app_bit10_val;
    unsigned char app_bit09_val;
    unsigned char app_bit08_val;
    unsigned char app_bit07_val;
    unsigned char app_bit06_val;
    unsigned char app_bit05_val;
    unsigned char app_bit04_val;
    unsigned char app_bit03_val;
    unsigned char app_bit02_val;
    unsigned char app_bit01_val;
    unsigned char app_bit00_val;
    unsigned char app_bit15_en;
    unsigned char app_bit14_en;
    unsigned char app_bit13_en;
    unsigned char app_bit12_en;
    unsigned char app_bit11_en;
    unsigned char app_bit10_en;
    unsigned char app_bit09_en;
    unsigned char app_bit08_en;
    unsigned char app_bit07_en;
    unsigned char app_bit06_en;
    unsigned char app_bit05_en;
    unsigned char app_bit04_en;
    unsigned char app_bit03_en;
    unsigned char app_bit02_en;
    unsigned char app_bit01_en;
    unsigned char app_bit00_en;
}DRV_LDINTERFACE_AppendDataCtrl;
...
typedef struct {
    ...
    unsigned char   rx_data_format;
	unsigned char   rx_done_int_en;
    unsigned char   read_port0_swap;//port map, for read which port
