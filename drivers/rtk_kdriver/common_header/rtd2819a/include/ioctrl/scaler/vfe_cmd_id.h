...
#define VFE_HDMI_H5X_EXTERNAL_PORT_INDEX 0xAA

#define VFE_HDMI_TIMING_OUTPUT_OF_DISP_LIMIT 0x1
#define VFE_HDMI_TIMING_BYPASSABLE   0x2
...
typedef enum
{
	KADP_VFE_HDMI_ACP_GENERIC_AUDIO,
	KADP_VFE_HDMI_ACP_IEC_60958,
	KADP_VFE_HDMI_ACP_DVD_AUDIO,
	KADP_VFE_HDMI_ACP_SUPER_AUDIO,
	KADP_VFE_HDMI_ACP_RESERVED,
}KADP_HAL_VFE_HDMI_ACP_TYPE_T;
...
typedef struct
{
	...
	KADP_HAL_VFE_HDMI_ACP_TYPE_T ACP_Type;
	unsigned char Reserved;
	unsigned char ACP_Type_Dependent[28];
} KADP_HAL_VFE_HDMI_ACP_T;
...
//=============================================================
//                           HDMI GamingVRR/QMSVRR/Freesync Info.
//=============================================================

typedef enum {
	KADP_VFE_HDMI_VSYNC_MODE_NON_VRR   = 0x00,
	KADP_VFE_HDMI_VSYNC_MODE_GAMINGVRR, // HDMI Forum VRR
	KADP_VFE_HDMI_VSYNC_MODE_FREESYNC, // AMD Freesync
	KADP_VFE_HDMI_VSYNC_MODE_ADAPTIVE_SYNC, // DP Freesync
	KADP_VFE_HDMI_VSYNC_MODE_QMSVRR,
	KADP_VFE_HDMI_VSYNC_MODE_NUM
}KADP_HAL_VFE_HDMI_VSYNC_MODE_T;

 typedef enum
{
	KADP__VFE_HDMI_TIMING_INFO_RESERVED
}KADP_HAL_VFE_HDMI_TIMING_INFO_RESERVED_T;

//=============================================================
//							 HDMI TIMING Info.
//=============================================================
typedef enum {
	KADP_VFE_HDMI_ONE_PIXEL_MODE = 1,
	KADP_VFE_HDMI_TWO_PIXEL_MODE = 2,
	KADP_VFE_HDMI_FOUR_PIXEL_MODE = 4,
	KADP_VFE_HDMI_PIXEL_MODE_SUPPORT_420_OVER_600M,
	KADP_VFE_HDMI_PIXEL_MODE_RESERVED
} KADP_HAL_VFE_HDMI_PIXEL_MODE_E;
...
typedef struct
{
    ...
    KADP_HAL_VFE_HDMI_VSYNC_MODE_T vsyncMode;
    unsigned int ext_flags;

	unsigned char isALLM;
	KADP_HAL_VFE_HDMI_PIXEL_MODE_E pixel_mode;
...
}__attribute__((packed)) KADP_HAL_HDMI_AMD_FREE_SYNC_INFO;
...
#define VFE_HDMI_ACP_TYPE_DEPENDENT_LEN         28
...
typedef enum {
	VFE_HDMI_VSYNC_MODE_NON_VRR   = 0x00,
	VFE_HDMI_VSYNC_MODE_GAMINGVRR, // HDMI Forum VRR
	VFE_HDMI_VSYNC_MODE_FREESYNC, // AMD Freesync
	VFE_HDMI_VSYNC_MODE_ADAPTIVE_SYNC, // DP Freesync
	VFE_HDMI_VSYNC_MODE_QMSVRR,
	VFE_HDMI_VSYNC_MODE_NUM
} vfe_hdmi_vsync_mode_e;

 typedef enum
{
	VFE_HDMI_TIMING_INFO_RESERVED
} vfe_hdmi_timing_info_reserved_e;
...
typedef enum
{
	...
	VFE_HDMI_AVI_ADDITIONAL_COLORIMETRY_BT_2100,
...
typedef enum {
	...
	KADP_VFE_HDMI_EMP_SBTM,		/*Source-Based Tone Mapping Extended Metadata*/
	KADP_VFE_HDMI_EMP_RSV0,		/*reserved packet for EM*/
	KADP_VFE_HDMI_EMP_RSV1,		/*reserved packet for EM*/
 ...
 * vfe_hdmi_acp_t
 * @param [IN] port, hdmi port selection
 * @param [OUT] others, acp infoframe
 *
 * HDMI ACP Info.
 * see HDMI Spec. v1.4 or above
*/
typedef struct
{
	unsigned char port;
	unsigned char packet_type;
	unsigned char acp_type;
	unsigned char reserved;
	unsigned char acp_type_dependent[VFE_HDMI_ACP_TYPE_DEPENDENT_LEN];
} vfe_hdmi_acp_t;
...
typedef enum {
	VFE_HDMI_ONE_PIXEL_MODE = 1,
	VFE_HDMI_TWO_PIXEL_MODE = 2,
	VFE_HDMI_FOUR_PIXEL_MODE = 4,
	VFE_HDMI_PIXEL_MODE_SUPPORT_420_OVER_600M,
	VFE_HDMI_PIXEL_MODE_RESERVED
} vfe_hdmi_pixel_mode_e;
...
typedef struct
{
	...
	vfe_hdmi_vsync_mode_e vsyncMode;
	unsigned int ext_flags;   //0x1:Timing is over DISP limit, 0x2:Timing is able to bypass
	vfe_hdmi_vsi_video_format_e vidoe_fmt;
	vfe_hdmi_vsi_3d_structure_e struct_3d;
	...
	vfe_hdmi_pixel_mode_e pixel_mode;
} vfe_hdmi_timing_info_t;
...
}__attribute__((packed)) VFE_HDMI_AMD_FREE_SYNC_INFO;
...
typedef enum
{
    KADP_VFE_HDMI_PURE_BYPASS,
    KADP_VFE_HDMI_COMMON_BYPASS,
} KADP_HAL_VFE_HDMI_BYPASS_MODE_T;

typedef struct
{
    unsigned char port;
    KADP_HAL_VFE_HDMI_BYPASS_MODE_T bypass_mode;
}vfe_hdmi_bypass_mode_set_t;
...
enum vfe_ioc_hdmi_cmd_idx_e
{
	...
	VFE_IOC_HDMI_CMD_IDX_MAXUM=170,
};
...
#define VFE_IOC_HDMI_QS_INIT							_IO(VFE_IOC_MAGIC,  VFE_IOC_HDMI_IDX_46)
#define VFE_IOC_HDMI_GET_QS_CURRENT_PORT				_IOR(VFE_IOC_MAGIC,  VFE_IOC_HDMI_IDX_47, int)
#define VFE_IOC_HDMI_GET_AMDFREESYNCINFO				_IOWR(VFE_IOC_MAGIC,VFE_IOC_HDMI_IDX_48, VFE_HDMI_AMD_FREE_SYNC_INFO)
#define VFE_IOC_HDMI_IS_FAST_SWITCH						_IOR(VFE_IOC_MAGIC,  VFE_IOC_HDMI_IDX_49, unsigned char)
#define VFE_IOC_HDMI_HDCP_REPEATER_MODE					_IOW(VFE_IOC_MAGIC,  VFE_IOC_HDMI_IDX_50, unsigned char)
#define VFE_IOC_HDMI_BYPASS_MODE_SET					_IOWR(VFE_IOC_MAGIC,  VFE_IOC_HDMI_IDX_51, vfe_hdmi_bypass_mode_set_t)
typedef struct
{
...
#define VFE_HDMI_PHY_FRL_STATUS           VFE_HDMI_PHY_CMD(3)
#define VFE_HDMI_PHY_CEC_OPTION           VFE_HDMI_PHY_CMD(4)
...
#define VFE_IOC_HDMI_GET_PORT_ACP_INFO    _IOWR(VFE_IOC_MAGIC,VFE_IOC_HDMI_IDX_52, vfe_hdmi_acp_t)

/**
 * vfe_hdmi_frame_rate_t
 * @param [IN] port, hdmi port selection
 * @param [OUT] baseFrameRate;
 * @param [OUT] currentVRRFrameRate
*/
typedef struct
{
    unsigned char port;
    unsigned int baseFrameRate;
    unsigned int currentVRRFrameRate;
} vfe_hdmi_frame_rate_t;
#define VFE_IOC_HDMI_GET_FRAME_RATE       _IOWR(VFE_IOC_MAGIC, VFE_IOC_HDMI_IDX_53, vfe_hdmi_frame_rate_t)

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                     DPRX IOCTL START                                                           //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#define VFE_IOC_DPRX_CMD_BASE_NUM  (VFE_IOC_HDMI_CMD_IDX_MAXUM+1)

enum vfe_ioc_dprx_cmd_idx_e
{
	VFE_IOC_DPRX_IDX_0 = VFE_IOC_DPRX_CMD_BASE_NUM,//170
	VFE_IOC_DPRX_IDX_1,//171
	VFE_IOC_DPRX_IDX_2,//172
	VFE_IOC_DPRX_IDX_3,//173
	VFE_IOC_DPRX_IDX_4,//174
	VFE_IOC_DPRX_IDX_5,//175
	VFE_IOC_DPRX_IDX_6,//176
	VFE_IOC_DPRX_IDX_7,//177
	VFE_IOC_DPRX_IDX_8,//178
	VFE_IOC_DPRX_IDX_9,//179
	VFE_IOC_DPRX_IDX_10,//180
	VFE_IOC_DPRX_IDX_11,//181
	VFE_IOC_DPRX_IDX_12,//182
	VFE_I1C_DPRX_IDX_13,//183
	VFE_IOC_DPRX_IDX_14,//184
	VFE_IOC_DPRX_IDX_15,//185
	VFE_IOC_DPRX_IDX_16,//186
	VFE_IOC_DPRX_IDX_17,//187
	VFE_IOC_DPRX_IDX_18,//188
	VFE_IOC_DPRX_IDX_19,//189
	VFE_IOC_DPRX_IDX_20,//190
	VFE_IOC_DPRX_IDX_21,//191
	VFE_IOC_DPRX_IDX_22,//192
	VFE_IOC_DPRX_IDX_23,//193
	VFE_IOC_DPRX_IDX_24,//194
	VFE_IOC_DPRX_IDX_25,//195
	VFE_IOC_DPRX_IDX_26,//196
	VFE_IOC_DPRX_IDX_27,//197
	VFE_IOC_DPRX_IDX_28,//198
	VFE_IOC_DPRX_IDX_29,//199
	VFE_IOC_DPRX_CMD_IDX_MAXUM=199,
};
#define IS_VFE_DPRX_IOC(cmd)    (_IOC_TYPE(cmd)== VFE_IOC_MAGIC && _IOC_NR(cmd) >=VFE_IOC_DPRX_CMD_BASE_NUM && _IOC_NR(cmd)<=VFE_IOC_DPRX_CMD_IDX_MAXUM)

#include "vfe_cmd_id-dprx.h"  // detialed definition of DPRX data structure and cmd id
...
enum vfe_ioc_sustomer_idx
{
	...
	VFE_IOC_CUSTOMER_IDX_14,//214
	VFE_IOC_CUSTOMER_IDX_15,//215
...
#define VFE_IOC_SET_VIDEO_COMMON					_IOW(VFE_IOC_MAGIC, VFE_IOC_CUSTOMER_IDX_14, unsigned int)
#define VFE_IOC_GET_VIDEO_COMMON_COUNT				_IOR(VFE_IOC_MAGIC, VFE_IOC_CUSTOMER_IDX_15, unsigned char)


//Macro for video common
#define VIDEO_COMMON_VFE_COMMAND_ENCODE(vc_id, vfe_sel) 		((vfe_sel<<8) | (vc_id & 0xff))
#define VIDEO_COMMON_VFE_COMMAND_DECONDE_VC_ID(command)			(command & 0xff)		
#define VIDEO_COMMON_VFE_COMMAND_DECONDE_VFE_SEL(command)		((command>>8) & 0xff)		
#define VFE_SET_VIDEO_COMMON_ENCODE(vc_id,vfe_sel) 	VIDEO_COMMON_VFE_COMMAND_ENCODE(vc_id, vfe_sel) //Legacy macro

typedef enum
{
    VFE_SRC_TYPE_NULL = 0,  // NULL device
    VFE_SRC_TYPE_CVBS = 1,
    VFE_SRC_TYPE_COMP = 2,
    VFE_SRC_TYPE_HDMI = 3,
    VFE_SRC_TYPE_DPRX = 4,
...
#define VIDEO_COMMON_VFE_SEL_ENCODE(src_type, port)				(((src_type & 0x7) <<2) | (port & 0x3))
#define VIDEO_COMMON_VFE_SEL_DECODE_SRC_TYPE(vfe_sel)			((vfe_sel>>2) & 0x7)
#define VIDEO_COMMON_VFE_SEL_DECODE_PORT(vfe_sel)				(vfe_sel & 0x3)	

#define VIDEO_COMMON_VFE_SEL_IS_DPRX(vfe_sel)					(VIDEO_COMMON_VFE_SEL_DECODE_SRC_TYPE(vfe_sel)==VFE_SRC_TYPE_DPRX)
#define VIDEO_COMMON_VFE_SEL_IS_HDMI(vfe_sel)					(VIDEO_COMMON_VFE_SEL_DECODE_SRC_TYPE(vfe_sel)==VFE_SRC_TYPE_HDMI)
