...
/**
 *  \fn HRESULT   AUDIO_RPC_ToAgent_SetDefaultPrl(AUDIO_RPC_SET_DEFAULT_PRL)
 *  \brief  To inform f/w default PRL
 *  \return
 *  \param  a default PRL value
 */
HRESULT   AUDIO_RPC_ToAgent_SetDefaultPrl(AUDIO_RPC_SET_DEFAULT_PRL) = 163;

/**
 *  \fn HRESULT   AUDIO_RPC_ToAgent_Set_AC4_DialEnhanceGain(AUDIO_RPC_SET_AC4_DIALENHANCEGAIN)
 *  \brief  To inform f/w AC4 dialogue enhance gain
 *  \return
 *  \param  a dialogue enhance gain
  */
HRESULT   AUDIO_RPC_ToAgent_Set_AC4_DialEnhanceGain(AUDIO_RPC_SET_AC4_DIALENHANCEGAIN)=164;

/**
 *  \fn HRESULT   AUDIO_RPC_ToAgent_Set_AC4_PresGroupIdx(AUDIO_RPC_SET_AC4_PRESGROUPIDX)
 *  \brief  To inform f/w AC4 preselection group index
 *  \return
 *  \param  a preselection group index
  */
HRESULT   AUDIO_RPC_ToAgent_Set_AC4_PresGroupIdx(AUDIO_RPC_SET_AC4_PRES_GROUP_IDX)=165;
...
/** temp **/
  ...
  HRESULT       AUDIO_RPC_ToAgent_SetSegmentShm(AUDIO_RPC_SEGMENTSHM)=299;
 /**
...
/* Audio AO function RPC call */
  ...
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn000_1(AUDIO_RPC_LGSE)=279;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn002(AUDIO_RPC_LGSE)=280;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn002_1(AUDIO_RPC_LGSE)=281;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn004_1(AUDIO_RPC_LGSE_SETFN004)=282;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn008_1(AUDIO_RPC_LGSE)=283;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn017_2(AUDIO_RPC_LGSE)=284;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn017_3(AUDIO_RPC_LGSE)=285;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn019_1(AUDIO_RPC_LGSE)=286;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn022_1(AUDIO_RPC_LGSE)=287;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn022_2(AUDIO_RPC_LGSE)=288;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn030(AUDIO_RPC_LGSE)=289;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn030_1(AUDIO_RPC_LGSE)=290;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn031(AUDIO_RPC_LGSE)=291;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetFn032(AUDIO_RPC_LGSE)=292;
  HRESULT       AUDIO_RPC_ToAgent_AO_LGSE_SetDownMix(AUDIO_RPC_LGSE)=293;
