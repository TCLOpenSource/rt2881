...
{
  rpc_s32_t instanceID ;
  rpc_s32_t pRefClock ; /* pointer to reference clock structure */
};

/**
 * \brief VIDEO_DEC_RPC_ToAgent_ATSCFilmCtrl() use this struct as parameter.
 *
 *  Please look the description of VIDEO_DEC_RPC_ToAgent_ATSCFilmCtrl().
 */
 ...
 *           represents has less than 32 bits to occupy the entire 'rpc_s32_t' word,
 *           the MSBs are set to zero.
 */
struct VIDEO_RPC_DEC_SEQ_INFO
{
  rpc_s32_t  hor_size ;      /* decoded picture horizontal size */
  rpc_s32_t  ver_size ;      /* decoded picture vertical   size */
  rpc_s32_t  aspect_ratio ;  /* 'aspect_ratio_information' as defined in ISO/IEC 13818-2 sec. 6.3.3 (Table 6-3) */
                        /* 0: forbidden, 1: square sample, 2: 3/4, 3: 9/16, 4: 1/2.21, 5~15: reserved      */
  rpc_s32_t  frame_rate ;    /* 'frame_rate_code'          as defined in ISO/IEC 13818-2 sec. 6.3.3 (Table 6-4) */
  rpc_s32_t  bit_rate ;      /* video elementary stream bit rate in units of 400 bits/second */
  rpc_s32_t  vbv_buf_size ;  /* VBV buffer size as defined in ISO/IEC 13818-2 sec. 6.3.3 and Annex C */
  rpc_s32_t  profile_level ; /* MPEG-2 profile and level identification as defined in ISO/IEC 13818-2 sec. 8 */
  rpc_s32_t  chroma_format ; /* MPEG-2 chroma format                    as defined in ISO/IEC 13818-2 sec. 6.3.5 (Table 6-5) */
                        /* 0: reserved, 1: 420, 2: 422, 3: 444                                                          */
  rpc_s32_t  video_format ;  /* MPEG-2 video format                     as defined in ISO/IEC 13818-2 sec. 6.3.6 (Table 6-6) */
                        /* 0: component, 1: PAL, 2: NTSC, 3: SECAM, 4: MAC, 5: unspecified video format, 6~7: reserved  */
  rpc_s32_t  disp_hor_size ; /* MPEG-2 display horizontal size          as defined in ISO/IEC 13818-2 sec. 6.3.6 */
  rpc_s32_t  disp_ver_size ; /* MPEG-2 display vertical   size          as defined in ISO/IEC 13818-2 sec. 6.3.6 */
  rpc_s32_t  isProg ;        /* progressive frame, 0:interlace  1:progressive  -1:unknown                        */
  rpc_s32_t  isMVC ;         /* 0:non-MVC   1:MVC          -1:unknown                                            */
  rpc_s32_t  is4k2k_MVC;     /* 0:non-4k2kMVC 1:4k2kMVC    -1:unknown                                            */
  rpc_s32_t  isREALD;        /* 0:non-realD 1:QUINCUNX 2:SIMPLE_HORZONTAL_SQUEEZE -1:unknown                     */
  rpc_s32_t  prog_sequence ; /* MPEG-2 progressive_sequence as defined in ISO/IEC 13818-2 sec. 6.3.5             */
  rpc_s32_t  pic_type ;      /* 1: I, 2: P, 3: B                                                                 */
  rpc_s32_t  temp_ref ;      /* MPEG-2 temporal_reference as defined in ISO/IEC 13818-2 sec. 6.3.10              */
  rpc_s32_t  pic_struct ;    /* 0: top field, 1: bottom field, 2: frame picture                                  */
  rpc_s32_t  top_ff ;        /* MPEG-2 top_field_first as defined in ISO/IEC 13818-2 sec. 6.3.11                 */
  rpc_s32_t  rept_ff ;       /* MPEG-2 repeat_first_field as defined in ISO/IEC 13818-2 sec. 6.3.11              */
...
{
    rpc_s32_t  instanceID ;
  rpc_u32_t  C_prog_seq ;      /* progressive_sequence flag, see ISO/IEC 13818-2 sec. 6.3.5 */
  rpc_u32_t  C_aspect_ratio ;  /* aspect ratio information,  see ISO/IEC 13818-2 sec. 6.3.3 */
  rpc_u32_t  C_intra_QM ;      /* index to the sequence intra quantiser matrix circular buffer.
  ...
  rpc_u32_t  C_non_intra_QM ;  /* index to the sequence non-intra quantiser matrix circular buffer.
                               If set to UNKNOWN_INDEX_C (defined in MPEG_Decode_def.h), then use
                               default matrix for non-intra blocks defined in ISO/IEC 13818-2 sec. 6.3.11 */
  rpc_u32_t  H_hor_size ;      /* width  of the displayable part of the decoded luma frame */
  rpc_u32_t  H_ver_size ;      /* height of the displayable part of the decoded luma frame */
  rpc_u32_t  H_disp_hor_size ; /* width  of the actual display. see ISO/IEC 13818-2 sec. 6.3.6 */
  rpc_u32_t  H_disp_ver_size ; /* height of the actual display. see ISO/IEC 13818-2 sec. 6.3.6 */
  rpc_u32_t  H_frame_rate ;
  rpc_u32_t  L_frame_PTSinc;   /* PTS increament of two successive frames, derived from frame_rate_code, frame_rate_extension_n and frame_rate_extension_d */
  rpc_u32_t  L_bit_rate ;      /* coded bit rate in units of 400 bits/second */
  rpc_u32_t  C_Mpeg1 ;         /* 1 if it is an MPEG-1 Sequence, i.e., no Sequence Extension following the Sequence Header
                               0 if it is an MPEG-2 Sequence */
  rpc_u32_t  active_format ;   /* ETSI TS 101 154 V1.91(2009-09) B.3.4 Table B.5 -- Active Format */
  rpc_u32_t  L_Num_Pics ;      /* number of pictures in the sequence */
...
{
  rpc_s32_t address ;   /* base address of a contiguous memory chunk */
  rpc_s32_t size ;      /* size of the memory chunk */
} ;


struct VIDEO_RPC_VIDEO_FREE_MEMORY
{
  rpc_s32_t  numMemChunks ; /* number of free memory chunks:                                                   */
                       /*                                                                                 */
...
struct VIDEO_RPC_DEC_DRIP_INFO
{
  rpc_s32_t pDripData;
  rpc_s32_t dripSize;
  rpc_s32_t dripType;       /* 0: VDEC_DRIP_I_FRAME, 1: VDEC_DRIP_NORMAL */
  enum VIDEO_STREAM_TYPE codecType;
  rpc_s32_t targetFormat;   /* 0: none, 1: ARGB8888, 2: BGR888, 3: JPEG */
  rpc_s32_t targetWidth;
  rpc_s32_t targetHeight;
  rpc_s32_t targetBufSize;
  rpc_s32_t pTargetAddr;
  rpc_s32_t timeOut;        /* millisecond */
} ;
...
{
    rpc_s32_t                      instanceID ;
    rpc_s32_t                  type;         /* Filter type in init state, such as MPEG1_ENCODER... */
...
struct VIDEO_RPC_ENC_SET_TF{
    rpc_s32_t        instanceID;
    rpc_s32_t        mode;    /* off, MATF or MCTF */
...
{
    rpc_s32_t        instanceID;
  rpc_s32_t        startMode; /* 0: wait for input; 1: start immediately */
};
...
{
    rpc_s32_t        instanceID;
	rpc_s32_t       vbv_buf_size ;      /* VBV buffer size     */
	rpc_s32_t       vbv_buf_fullness ;  /* VBV buffer fullness */
};
...
{
  rpc_s32_t colorFormat;				  /* 0: YUV, 1: RGB8888, 2: RGB565, 3: RGB332 */
                            ...
                            */
  rpc_s32_t pBitstreamRB;				/* Linear address of bitstream ring buffer. */
  rpc_s32_t pTargetLuma;					/* Linear address of Luman buffer. */
  rpc_s32_t pTargetChroma;				/* Linear address of Chroma buffer. */
  rpc_s32_t pitch;

  rpc_s32_t targetRectX;
  rpc_s32_t targetRectY;
  rpc_s32_t targetRectWidth; 		/* width of the target rectangle to store the decoded picture */
  rpc_s32_t targetRectHeight;		/* height of the target rectangle to store the decoded picture */
  rpc_s32_t centerToTargetRect;      /* if 1, decode to center of the target rectangle.
  ...
  */
  ...
  /*                    - the values are defined below.
			...
			3	= 270
  */
  rpc_s32_t srcRectAlignmentRatioX;   /* The alignment ratio is expressed as a 1.8 fixed-point number.
                                    For example,
  ...
  rpc_s32_t srcRectAlignmentRatioY;   /* The alignment ratio is expressed as a 1.8 fixed-point number.
                                    For example,
  ...
  rpc_s32_t srcRectZoomFactor;        /* The zoom factor is expressed as a 1.8 fixed-point number.
                                    For example,
  ...
  rpc_s32_t initOption;			     /* if -1, initialize only.
  ...
  rpc_s32_t useWholePictureOnly;      /* If 0, FIRMWARE can optionally choose either the whole picture or the embedded thumbnail picture to decode.
  ...
  rpc_s32_t ScaleUpToRect;	/* if image is smaller than Target Rect
                         0: keep actual size, but can't apply to ZOOM
                         1: scale-up to Rect
                         2: turn on acutal zoom */

  rpc_s32_t FillBlackInRect;	/* fill black if image is smaller than Target Rect */
  rpc_s32_t SmoothLevel;	/* 0~9 to smooth more or not */

  enum VIDEO_JPEG_MIRROR mirror ; /* don't support YUV */

  rpc_s32_t pTargetLuma_right ;    /* set right eye bufferID to -1 if VO isn't 3D display  */
  ...
  rpc_s32_t pLumaSeq ;             /* sequential buffer address for Y */
  rpc_s32_t pChromaSeq ;           /* sequential buffer address for UV */
...
{
  rpc_s32_t number;          /* how many JPEG are decoded */
  rpc_s32_t structure_addr;  /* shared memory of data structure struct VIDEO_RPC_JPEG_DEC */
};
...
struct VIDEO_RPC_TRANSITION_EFFECT
{
	...
	rpc_s32_t width;
	rpc_s32_t height;
	rpc_s32_t type;			/* transition type in VIDEO_TRANSITION_TYPE */
	rpc_s32_t frame_num;		/* how many frames for this transition */
	rpc_s32_t PTS_inc;		/* PTS between each frames */
	rpc_s32_t start_x;       /* for TRANSITION_MOVE effect */
	rpc_s32_t start_y;
	...
	rpc_s32_t YBufID_A_right ;   /* set right eye bufferID to -1 if VO isn't 3D display or source is 3D picture */
...
{
  unsigned int                  ulAddr[60];       /* struct memory addr in share memory */
} ;
...
{
	enum VO_VIDEO_PLANE		videoPlane ;		/* video plane */
	rpc_s32_t					destAddrY;			/* the destination physical address for luma*/
	rpc_s32_t					destAddrC;			/* the destination physical address for chroma*/
} ;
...
struct VIDEO_RPC_VOUT_CONFIG_HDMI_3D
{
  ...
  unsigned int			cap_buffer_size;
  unsigned int          sw_bufnub;
  unsigned int          sw_videosize;
  unsigned int          sw_cap_buf[15];
  int					reserved4 ;
} ;
...
#define VIDEO_RPC_VO_CAMERA_FUNC_BASE		13000
...
/**
 *  \fn  HRESULT  VIDEO_RPC_ToAgent_Run (rpc_s32_t)
 *
 ...
 *
 */
  HRESULT     VIDEO_RPC_ToAgent_Run(rpc_s32_t x) = VIDEO_RPC_COMMON_FUNC_BASE + 40 ;




/**
 *  \fn  HRESULT  VIDEO_RPC_ToAgent_Pause (rpc_s32_t)
 *
 ...
 */
  HRESULT     VIDEO_RPC_ToAgent_Pause(rpc_s32_t x) = VIDEO_RPC_COMMON_FUNC_BASE + 50 ;
...
/**
 *  \fn  HRESULT  VIDEO_RPC_ToAgent_Stop (rpc_s32_t)
 *
 ...
 *  \param
 */
  HRESULT     VIDEO_RPC_ToAgent_Stop(rpc_s32_t x) = VIDEO_RPC_COMMON_FUNC_BASE + 60 ;
...
/**
 *  \fn  HRESULT  VIDEO_RPC_ToAgent_Destroy (rpc_s32_t)
 *
 ...
 *  \param
 */
  HRESULT VIDEO_RPC_ToAgent_Destroy(rpc_s32_t x) = VIDEO_RPC_COMMON_FUNC_BASE + 70 ;
...
/**
 *  \fn  HRESULT  VIDEO_RPC_ToAgent_Flush (rpc_s32_t)
 *
 ...
 *  \param
 */
  HRESULT VIDEO_RPC_ToAgent_Flush(rpc_s32_t x) = VIDEO_RPC_COMMON_FUNC_BASE + 80 ;



/**
 *  \fn  HRESULT  VIDEO_RPC_VOUT_ToAgent_VOCompFlush (rpc_s32_t x)
 *
 *  \brief
 *
 *  \return
 ...
 *  \param
 */
  HRESULT VIDEO_RPC_VOUT_ToAgent_VOCompFlush(rpc_s32_t x) = VIDEO_RPC_COMMON_FUNC_BASE + 81 ;
...
/**
 *  \fn  VIDEO_CONFIG_DATA  VIDEO_RPC_ToAgent_GetVideoConfigure (rpc_s32_t configType)
 *
 *  \brief To get the configure of video firmware
 */
  VIDEO_CONFIG_DATA  VIDEO_RPC_ToAgent_GetVideoConfigure(rpc_s32_t configType) = VIDEO_RPC_COMMON_FUNC_BASE + 106 ;




/**
 *  \fn  VIDEO_RPC_VIDEO_FREE_MEMORY   VIDEO_RPC_ToAgent_VideoMemoryConfig (rpc_s32_t configMode)
 *
 ...
 *
 */
  VIDEO_RPC_VIDEO_FREE_MEMORY   VIDEO_RPC_ToAgent_VideoMemoryConfig(rpc_s32_t configMode) = VIDEO_RPC_COMMON_FUNC_BASE + 108 ;
...
/**
 * \fn  HRESULT  VIDEO_RPC_ToAgent_ReleaseBuffer (rpc_s32_t)
 *
 ...
 */
  HRESULT VIDEO_RPC_ToAgent_ReleaseBuffer(rpc_s32_t bufferID) = VIDEO_RPC_COMMON_FUNC_BASE + 130 ;



/**
 * \fn  HRESULT  VIDEO_RPC_ToAgent_ConfigLowDelay (rpc_s32_t)
 *
...
/**
 * \fn  HRESULT  VIDEO_RPC_ToAgent_SetDebugMemory (rpc_s32_t)
 *
 ...
 */
  HRESULT VIDEO_RPC_ToAgent_SetDebugMemory (rpc_s32_t debugMemAddr) = VIDEO_RPC_COMMON_FUNC_BASE + 140 ;
 ...
 ************************************************************************
 */
  HRESULT VIDEO_RPC_ToAgent_VideoHalt (rpc_s32_t reserved) = VIDEO_RPC_COMMON_FUNC_BASE + 150;
...
/**
 * \fn  HRESULT  VIDEO_RPC_DEC_ToAgent_GetVideoSequenceInfo (rpc_s32_t)
 * \brief This function is used to return detailed video sequence information to system.
 *
 * \return
 * \param  A VIDEO_RPC_DEC_SEQ_INFO struct.
 */
  VIDEO_RPC_DEC_SEQ_INFO  VIDEO_RPC_DEC_ToAgent_GetVideoSequenceInfo (rpc_s32_t instanceID) = VIDEO_RPC_VDEC_FUNC_BASE + 35 ;
...
/**
 * \fn  HRESULT  VIDEO_RPC_DEC_ToAgent_Capability (rpc_s32_t mask)
...
/**
 * \fn  HRESULT  VIDEO_RPC_DEC_ToAgent_GetMPEGSequenceHdr (rpc_s32_t)
 * \brief This function is used to return MPEG sequence header to system.
 *
 * \return
 * \param  A VIDEO_RPC_DEC_MPEG_SEQ_HDR struct.
 */
  VIDEO_RPC_DEC_MPEG_SEQ_HDR  VIDEO_RPC_DEC_ToAgent_GetMPEGSequenceHdr (rpc_s32_t instanceID) = VIDEO_RPC_VDEC_FUNC_BASE + 95 ;

/**
 * \fn  HRESULT  VIDEO_RPC_DEC_ToAgent_SetMPEGSequenceHdr (rpc_s32_t)
...
/**
 * \fn  HRESULT  VIDEO_RPC_DEC_ToAgent_GetMPEGSequenceHdr_New (rpc_s32_t)
...
/**
 *  \fn  HRESULT  VIDEO_DEC_RPC_ToAgent_ATSCFilmCtrl (VIDEO_RPC_DEC_ATSC_FILM_CTRL)
 *
 *  \brief Inform agent where to find reference clock.
 */
  HRESULT VIDEO_DEC_RPC_ToAgent_ATSCFilmCtrl(VIDEO_RPC_DEC_ATSC_FILM_CTRL x) = VIDEO_RPC_VDEC_FUNC_BASE + 150 ;
...
/*  ------------------------------------------------------------------------------------
 ...
 /*  ------------------------------------------------------------------------------------
  ...
  --------------------------------------------------------------------------------------*/
  HRESULT VIDEO_RPC_ENC_ToAgent_IsRunnable(rpc_s32_t instanceID) = VIDEO_RPC_VENC_FUNC_BASE + 200;
...
/*  ------------------------------------------------------------------------------------
  Signature:
  HRESULT     VIDEO_RPC_ENC_ToAgent_SetEncode_Dummy_Frame(VIDEO_RPC_ENC_SET_DUMMYFRAME x) = 280;

  Function:
    Set Encoder Dummy Frame to
      ------------------------------------------------------------------------------------ */
  HRESULT     VIDEO_RPC_ENC_ToAgent_SetEncode_Dummy_Frame(VIDEO_RPC_ENC_SET_DUMMYFRAME x) = VIDEO_RPC_VENC_FUNC_BASE + 280 ;
 ...
 ************************************************************************
 */
HRESULT VIDEO_RPC_VO_FILTER_ToAgent_Step (rpc_s32_t instanceID) = VIDEO_RPC_VOUT_FUNC_BASE + 300 ;
...
/**
 *  \fn  HRESULT  VIDEO_RPC_VO_FILTER_ToAgent_FlushVideoOut (rpc_s32_t)
 *
 *  \brief
 ...
 *  \param  instanceID
 */
HRESULT VIDEO_RPC_VO_FILTER_ToAgent_FlushVideoOut(rpc_s32_t instanceID) = VIDEO_RPC_VOUT_FUNC_BASE + 350 ;
...
/**
 * \fn  HRESULT  VIDEO_RPC_ToAgent_SetScalerVBICCBuf (rpc_s32_t)
 *
 ...
 */
  HRESULT VIDEO_RPC_ToAgent_SetScalerVBICCBuf (rpc_s32_t vbiccbufAddr) = VIDEO_RPC_VOUT_FUNC_BASE + 680;
...
/**
 * \fn  HRESULT  VIDEO_RPC_VO_FILTER_ToAgent_GetVoInfo (rpc_s32_t)
 * \brief This function is used to return detailed VoInfo to system.
 *
 * \return
 * \param  A VO_PRC_VOINFO struct.
 */
VO_PRC_VOINFO VIDEO_RPC_VO_FILTER_ToAgent_GetVoInfo (rpc_s32_t instanceID) =VIDEO_RPC_VOUT_FUNC_BASE + 940 ;
 ...
 ************************************************************************
 */
HRESULT VIDEO_RPC_SUBPIC_DEC_ToAgent_ShowSubPicture (rpc_s32_t instanceID) = VIDEO_RPC_SPDEC_FUNC_BASE + 20 ;
 ...
 ************************************************************************
 */
HRESULT VIDEO_RPC_SUBPIC_DEC_ToAgent_HideSubPicture (rpc_s32_t instanceID) = VIDEO_RPC_SPDEC_FUNC_BASE + 30 ;
 ...
 ************************************************************************
 */
CHANNEL_RES VIDEO_RPC_TVD_ToAgent_ChangeChannel_Start(rpc_s32_t x) = VIDEO_RPC_VIN_FUNC_BASE + 120 ;
 ...
 ************************************************************************
 * \brief
 *    This function is used to vo photo to set VO_DisplayPicture parameters
 *
 * \return
 *
 ************************************************************************
 */
HRESULT VIDEO_RPC_VO_PHOTO_ToAgent_SetAddr () = VIDEO_RPC_VO_PHOTO_FUNC_BASE + 90 ;


/**
 *  \defgroup Camera VO APIs
 *  VODMA read the video frame buffer from comera then output to the scaler IMD domain.
 *
 *  \author shane.wu
 *  @{
 */
 ...
 ************************************************************************
 * \brief
 *    This function is used to open Camera VO function
 *
 * \return
 *
 * \param  version_num:
 ...
 ************************************t************************************
 */
HRESULT VIDEO_RPC_CAMERA_VO_ToAgent_Open (VIDEO_RPC_CAMERA_VO_RUN) = VIDEO_RPC_VO_CAMERA_FUNC_BASE + 10 ;
 ...
 ************************************************************************
 */
HRESULT VIDEO_RPC_CAMERA_VO_ToAgent_Run () = VIDEO_RPC_VO_CAMERA_FUNC_BASE + 20 ;
 ...
 ************************************************************************
 */
HRESULT VIDEO_RPC_CAMERA_VO_ToAgent_Stop () = VIDEO_RPC_VO_CAMERA_FUNC_BASE + 30 ;
 ...
 ************************************************************************
 */
HRESULT VIDEO_RPC_CAMERA_VO_ToAgent_Flush () = VIDEO_RPC_VO_CAMERA_FUNC_BASE + 40 ;
