...
struct RPC_RINGBUFFER {
    ...
    rpc_s32_t        pinID;
    rpc_s32_t        readPtrIndex;

    rpc_s32_t        pRINGBUFF_HEADER;
};
...
enum VIDEO_VF_TYPE
{
    ...
    VF_TYPE_VIDEO_VVC_DECODER,
    VF_TYPE_VIDEO_AVS3_DECODER,
    VF_TYPE_VIDEO_HEVC_ENCODER
};
...
enum VIDEO_RESOURCE_INFO_TYPE
{
    VIDEO_RESOURCE_INFO_DTV_PLAYBACK = 0,
    VIDEO_RESOURCE_INFO_CP,
    VIDEO_RESOURCE_INFO_ATSC,
    VIDEO_RESOURCE_INFO_JP4K,
    VIDEO_RESOURCE_INFO_CAMERA,
    VIDEO_RESOURCE_INFO_DTV_LIVE,
    VIDEO_RESOURCE_INFO_OTT_MJPEG
};
