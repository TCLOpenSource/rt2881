...
xdr_RPC_RINGBUFFER (XDR *xdrs, RPC_RINGBUFFER *objp)
{
	 ...
	 if (!xdr_rpc_s32_t (xdrs, &objp->pinID))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->readPtrIndex))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->pRINGBUFF_HEADER))
		 return FALSE;
	return TRUE;
}
...
bool_t
xdr_VIDEO_ENC_LEVEL (XDR *xdrs, VIDEO_ENC_LEVEL *objp)
{
	 if (!xdr_enum (xdrs, (enum_t *) objp))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_VIDEO_RESOURCE_INFO_TYPE (XDR *xdrs, VIDEO_RESOURCE_INFO_TYPE *objp)
{
	 if (!xdr_enum (xdrs, (enum_t *) objp))
		 return FALSE;
	return TRUE;
