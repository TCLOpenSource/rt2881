...
HRESULT *
VIDEO_RPC_ENC_ToSystem_EndOfStream_0(rpc_s32_t *argp, CLNT_STRUCT *clnt)
{
...
HRESULT *
VIDEO_RPC_ToSystem_Deliver_GenInfo_0(rpc_s32_t *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
...
HRESULT *
VIDEO_RPC_ToSystem_Deliver_FrameInfo_0(rpc_s32_t *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
...
HRESULT *
VIDEO_RPC_ToSystem_Deliver_WSSInfo_0(rpc_s32_t *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
...
HRESULT *
VIDEO_RPC_ToSystem_Deliver_PauseInfo_0(rpc_s32_t *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
...
HRESULT *
VIDEO_RPC_ToSystem_ScaleModeSCART_0(rpc_s32_t *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
...
HRESULT *
VIDEO_RPC_ToSystem_VideoHaltDone_0(rpc_s32_t *argp, CLNT_STRUCT *clnt)
{
#if defined(ENABLE_RPC_PROXY_INIT_CHECK)
  #if 1 == BUILD_FOR_MACARTHUR3
  #pragma message( "BUILD_FOR_MACARTHUR3 is #define'd to 1" )
