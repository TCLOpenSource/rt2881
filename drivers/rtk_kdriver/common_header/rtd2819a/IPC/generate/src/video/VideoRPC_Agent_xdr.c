...
xdr_VIDEO_RPC_ENC_ELEM_FRAME_INFO (XDR *xdrs, VIDEO_RPC_ENC_ELEM_FRAME_INFO *objp)
{
	 ...
	 if (!xdr_int (xdrs, &objp->frameSize))
		 return FALSE;
	 if (!xdr_vector (xdrs, (char *)objp->dma_fd, 4,
		sizeof (u_int), (xdrproc_t) xdr_u_int))
		 return FALSE;
	return TRUE;
}
...
{
	 if (!xdr_rpc_s32_t (xdrs, &objp->SP_instanceID))
		 return FALSE;
	return TRUE;
}
...
xdr_VIDEO_RPC_DEC_JPEG_INFO (XDR *xdrs, VIDEO_RPC_DEC_JPEG_INFO *objp)
{
	 if (!xdr_rpc_s32_t (xdrs, &objp->instanceID))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->destWidth))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->destHeight))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->eventID))
		 return FALSE;
...
{
	 if (!xdr_rpc_s32_t (xdrs, &objp->decodedWidth))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->decodedHeight))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->bitstreamEnd))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->cancel))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->status))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->orgJpegWidth))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->orgJpegHeight))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->croppedJpegX))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->croppedJpegY))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->croppedJpegWidth))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->croppedJpegHeight))
		 return FALSE;
	 if (!xdr_VIDEO_JPEG_ROTATION (xdrs, &objp->orientation))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->percentage))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->reserved3))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->JPEG_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->BITMAP_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->TIFF_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->GIF_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->PNG_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->Format1_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->Format2_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->Format3_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->bitstreamStart))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->outInstanceID))
		 return FALSE;
	 if (!xdr_VIDEO_IMG_TYPE (xdrs, &objp->imgType))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->pScratchBase))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->scratchSize))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->WEBP_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->PSEUDOIMG_CTRL))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->HEIF_CTRL))
		 return FALSE;
	return TRUE;
}
...
xdr_VIDEO_RPC_DEC_ERROR_INFO (XDR *xdrs, VIDEO_RPC_DEC_ERROR_INFO *objp)
{
	 if (!xdr_rpc_s32_t (xdrs, &objp->instanceID))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->errCode))
		 return FALSE;
	return TRUE;
}
...
xdr_VIDEO_RPC_DEC_MESSAGE (XDR *xdrs, VIDEO_RPC_DEC_MESSAGE *objp)
{
	 if (!xdr_rpc_s32_t (xdrs, &objp->instanceID))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->message))
		 return FALSE;
	return TRUE;
}
...
xdr_VIDEO_RPC_TRANSITION_EFFECT_CTRL (XDR *xdrs, VIDEO_RPC_TRANSITION_EFFECT_CTRL *objp)
{
	 ...
	 if (!xdr_VO_RECTANGLE (xdrs, &objp->winEnd_B))
		 return FALSE;
	 if (!xdr_rpc_s32_t (xdrs, &objp->timeForKenBurns))
		 return FALSE;
	return TRUE;
}
