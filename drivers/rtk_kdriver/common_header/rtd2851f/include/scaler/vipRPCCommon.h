...
typedef struct _VIP_PQ_LD_INFO {
	unsigned char data_apply;
	unsigned short ld_blu_spitotal;
	unsigned short PQ_LD_AlgoSRAM_Data[1024];
	unsigned char header_tail_apply;
	unsigned char header_tail_length;
	unsigned short header_tail_position;
	unsigned short header_tail_data[32];
} VIP_PQ_LD_INFO;
