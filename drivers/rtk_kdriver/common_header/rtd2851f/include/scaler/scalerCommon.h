...
typedef struct _SLR_VOINFO {
    ...
    VODMA_DDOMAIN_CHROMA_FMT            chroma_fmt;     ///< chroma format // for vgip
...
typedef enum
{
	...
	SCALER_VO_AR_16_9_CUSTOMER2,	//panel 16:9 , cutomer mode
...
typedef struct {	//initialization in scalerstruct.c
	...
	unsigned char Main_Run_Scaler_flag;
	unsigned char Main_Output_Set_flag;
	unsigned char Main_force_frc_flag;
	unsigned char Main_force_frc_fs_flag;
	unsigned char Main_Scaler_Stop_flag;
	unsigned char Main_Request_ForceBG_ctrl;
	unsigned char Main_Reset_Mode_flag;
	...
	unsigned char memc_realcinema_run_flag;
	unsigned char separator_vsc;

	//smooth toggle
	unsigned char check_only_xy_shift_same_region;
	unsigned char Main_smooth_toggle_set_flag;
	unsigned char Sub_smooth_toggle_set_flag;//run  sub smooth toggle flag
	unsigned char Main_SetOutput_request_muteoff_smooth_toggle_set_flag;
	...
	unsigned char Main_ATV_Go_Smooth_Toggle_flag;
	unsigned char Main_ATV_PassThrought_output_flag;
	...
	unsigned char run_iv2dv_slow_tuning_flag;
...
//#ifdef CONFIG_DUAL_CHANNEL
	...
	unsigned char Sub_Run_Scaler_flag;
	unsigned char Sub_Output_Set_flag;
	unsigned char Sub_Scaler_Stop_flag;
	unsigned char Sub_AutoRunScaler;
	unsigned char Sub_ATV_Go_Smooth_Toggle_flag;
	unsigned char Sub_Request_ForceBG_ctrl;
	unsigned char Sub_Reset_Mode_flag;
