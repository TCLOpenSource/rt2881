...
#define SW_I3DDMA_CAP_NUM     (13)
#define _VO_GATTING_OFFSET 2  // vo lead to den start tolerance
...
//	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS (drvif_memory_get_data_align((_DISP_WID * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * _DISP_LEN)//Update M-domain 4k2k 12bits for PQDC align @Crixus 20170620
...
#else
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS (drvif_memory_get_data_align((1920 * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * 1080 + FINAL_BURST_LENTH)//Update M-domain 2k1k 12bits for PQDC align
	...
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_HDMI (drvif_memory_get_data_align((M_DOMAIN_WIDTH_CARVEOUT * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_CARVEOUT + FINAL_BURST_LENTH)//Update M-domain 2k1k 12bits for PQDC align
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_HDMI_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE + FINAL_BURST_LENTH)//Update M-domain 2k1k 12bits for PQDC align
#else
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_HDMI (drvif_memory_get_data_align((M_DOMAIN_WIDTH_CARVEOUT * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_CARVEOUT + FINAL_BURST_LENTH)//Update M-domain 2k1k 12bits for PQDC align
	#define MDOMAIN_MAIN_BUFFER_SIZE_12BITS_HDMI_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 12 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE + FINAL_BURST_LENTH)//Update M-domain 2k1k 12bits for PQDC align
...
#define MDOMAIN_2K_ROTATE_BUFFER_SIZE (M_DOMAIN_LEN_2K * M_DOMAIN_LEN_2K * 12 / 8 + 0x40000)
...
#else
#define MDOMAIN_MAIN_BUFFER_SIZE_20BITS (drvif_memory_get_data_align((1920 * 20 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * 1080 + FINAL_BURST_LENTH) //M-domain RGB444 mode 20bits
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS (drvif_memory_get_data_align((1920 * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * 1080 + FINAL_BURST_LENTH)//livezoomcase
...
#define MDOMAIN_MAIN_BUFFER_SIZE_20BITS_HDMI (drvif_memory_get_data_align((M_DOMAIN_WIDTH_CARVEOUT * 20 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_CARVEOUT + FINAL_BURST_LENTH) //M-domain RGB444 mode 20bits
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_HDMI (drvif_memory_get_data_align((M_DOMAIN_WIDTH_CARVEOUT * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_CARVEOUT + FINAL_BURST_LENTH)//livezoomcase
#define MDOMAIN_MAIN_BUFFER_SIZE_16BITS_HDMI_4K (drvif_memory_get_data_align((M_DOMAIN_WIDTH_MAX_SIZE * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_MAX_SIZE + FINAL_BURST_LENTH)//livezoomcase
#else
...
#define MDOMAIN_SUB_BUFFER_SIZE (drvif_memory_get_data_align((M_DOMAIN_WIDTH_2K * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * M_DOMAIN_LEN_2K + FINAL_BURST_LENTH) //2k1k 12 bits
