...
void lib_hdmi_set_yuv420_in_sel(unsigned char nport, COMMON_420_REG_YUV420_IN_SEL_T source_in)
{
    ...
    //only HDMI source, don't need to config it
    #if 0
...
void lib_hdmi_mac_init(unsigned char nport, unsigned char br_swap)
{
    ...
    hdmi_mask(HDMI_EX_P0_EX_PHY_FIFO_CR1_reg,
        ~(HDMI_EX_P0_EX_PHY_FIFO_CR1_port2_rclk_inv_mask|HDMI_EX_P0_EX_PHY_FIFO_CR1_port2_gclk_inv_mask|HDMI_EX_P0_EX_PHY_FIFO_CR1_port2_bclk_inv_mask),
       (HDMI_EX_P0_EX_PHY_FIFO_CR1_port2_rclk_inv_mask|HDMI_EX_P0_EX_PHY_FIFO_CR1_port2_gclk_inv_mask|HDMI_EX_P0_EX_PHY_FIFO_CR1_port2_bclk_inv_mask));    // port2
