...
#include <rbus/hdmirx_2p0_phy_p0_reg.h>  //
#include <rbus/hdmirx_2p0_phy_p1_reg.h>  //
#include <rbus/hdmirx_2p0_phy_p2_reg.h>  //
...
//ESD 0x1803CA18 
#define TOP_IN_3_P0_IO_OV (_BIT18|_BIT17)
#define TOP_IN_3_P0_POWER_OV (_BIT20|_BIT19)

#define TOP_IN_2_P1_IO_OV (_BIT13|_BIT12)
#define TOP_IN_2_P1_POWER_OV (_BIT15|_BIT14)
