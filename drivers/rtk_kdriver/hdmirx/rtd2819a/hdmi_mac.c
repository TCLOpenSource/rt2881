...
#define WAIT_H_SYNC_COUNT_THD    10
...
{
    unsigned int clken_pre_mask = HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_pre0_mask;
    unsigned int clken_hdcp_pre_mask = HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_hdcp_pre0_mask;
    unsigned int rstn_pre_mask = HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_pre0_mask;
    unsigned int rstn_hdcp_pre_addr = HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_hdcp_pre0_mask;
...
void lib_hdmi_mac_crt_perport_on(unsigned char nport)
{
    ...
    unsigned int clken_pre_mask = HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_pre0_mask << nport;
    unsigned int clken_hdcp_pre_mask = HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_hdcp_pre0_mask << nport;
    unsigned int rstn_pre_mask = HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_pre0_mask << nport;
    unsigned int rstn_hdcp_pre_addr = HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_hdcp_pre0_mask << nport;
...
void lib_hdmi_sys_crt_on(void)
{
    ...
    if ((!((hdmi_in(SYS_REG_SYS_CLKEN6_reg) & SYS_REG_SYS_CLKEN6_clken_gdirx_phy_p0_mask) &&
          (hdmi_in(SYS_REG_SYS_SRST6_reg) & SYS_REG_SYS_SRST6_rstn_gdirx_phy_p0_mask)))||
         (!((hdmi_in(SYS_REG_SYS_CLKEN6_reg) & SYS_REG_SYS_CLKEN6_clken_gdirx_phy_p1_mask) &&
          (hdmi_in(SYS_REG_SYS_SRST6_reg) & SYS_REG_SYS_SRST6_rstn_gdirx_phy_p1_mask)))||
          (!((hdmi_in(SYS_REG_SYS_CLKEN6_reg) & SYS_REG_SYS_CLKEN6_clken_gdirx_phy_p2_mask) &&
          (hdmi_in(SYS_REG_SYS_SRST6_reg) & SYS_REG_SYS_SRST6_rstn_gdirx_phy_p2_mask)))||
          (!((hdmi_in(SYS_REG_SYS_CLKEN6_reg) & SYS_REG_SYS_CLKEN6_clken_gdirx_phy_p3_mask) &&
          (hdmi_in(SYS_REG_SYS_SRST6_reg) & SYS_REG_SYS_SRST6_rstn_gdirx_phy_p3_mask))))
    {
        hdmi_out(SYS_REG_SYS_SRST6_reg, SYS_REG_SYS_SRST6_rstn_gdirx_phy_p0_mask|SYS_REG_SYS_SRST6_rstn_gdirx_phy_p1_mask|
			SYS_REG_SYS_SRST6_rstn_gdirx_phy_p2_mask|SYS_REG_SYS_SRST6_rstn_gdirx_phy_p3_mask|SYS_REG_SYS_SRST6_write_data_mask);
        udelay(5);
        hdmi_out(SYS_REG_SYS_CLKEN6_reg, SYS_REG_SYS_CLKEN6_clken_gdirx_phy_p0_mask|SYS_REG_SYS_CLKEN6_clken_gdirx_phy_p1_mask|
			SYS_REG_SYS_CLKEN6_clken_gdirx_phy_p2_mask|SYS_REG_SYS_CLKEN6_clken_gdirx_phy_p3_mask|SYS_REG_SYS_CLKEN6_write_data_mask);
    }
    ...
    hdmi_out(SYS_REG_SYS_CLKEN2_reg, (SYS_REG_SYS_CLKEN2_clken_dispm_main_cap_mask|SYS_REG_SYS_CLKEN2_clken_dispm_main_disp_mask|SYS_REG_SYS_CLKEN2_write_data_mask));
...
void lib_hdmi_crt_off(unsigned char nport)
{
    ...
    {
        case 0:
            val = HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_pre0_mask|HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_hdcp_pre0_mask;
            break;
        case 1:
            val = HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_pre1_mask|HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_hdcp_pre1_mask;
            break;
        case 2:
            val = HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_pre2_mask|HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_hdcp_pre2_mask;
            break;
        case 3:
            val = HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_pre3_mask|HDMI_TOP_COMMON_hdmi_clken0_clken_hdmi_hdcp_pre3_mask;
            break;
        default:
            return;
    }
    ...
    {
        case 0:
            val = HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_pre0_mask|HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_hdcp_pre0_mask;
            break;
        case 1:
            val = HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_pre1_mask|HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_hdcp_pre1_mask;
            break;
        case 2:
            val = HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_pre2_mask|HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_hdcp_pre2_mask;
            break;
        case 3:
            val = HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_pre3_mask|HDMI_TOP_COMMON_hdmi_rst0_rstn_hdmi_hdcp_pre3_mask;
            break;
        default:
            return;
    }
...
#ifndef IS_SUPPORT_MULTI_HDMI_COMMON
...
{
    if (HDMI_hdmi_clken0_get_clken_hdmi_common(hdmi_in(HDMI_hdmi_clken0_reg)) &&
        HDMI_hdmi_rst0_get_rstn_hdmi_common(hdmi_in(HDMI_hdmi_rst0_reg)))
        return 1;
...
#else
void lib_hdmi_crt_reset_hdmi_common_by_port(unsigned char nport)
{
    UINT32 hdmi_common_clk_mask[HDMI_PORT_TOTAL_NUM] = {
        HDMI_hdmi_clken0_clken_hdmi_common_mask,
        HDMI_hdmi_clken0_clken_hdmi_common1_mask,
        HDMI_hdmi_clken0_clken_hdmi_common2_mask,
        HDMI_hdmi_clken0_clken_hdmi_common3_mask};

    UINT32 hdmi_common_rst_mask[HDMI_PORT_TOTAL_NUM] = {
        HDMI_hdmi_rst0_rstn_hdmi_common_mask,
        HDMI_hdmi_rst0_rstn_hdmi_common1_mask,
        HDMI_hdmi_rst0_rstn_hdmi_common2_mask,
        HDMI_hdmi_rst0_rstn_hdmi_common3_mask};
    ...
    // Clock = 0
    hdmi_mask(HDMI_hdmi_clken0_reg,~hdmi_common_clk_mask[nport], 0x0);
    udelay(5);

    // RST = 0
    hdmi_mask(HDMI_hdmi_rst0_reg,~hdmi_common_rst_mask[nport], 0x0);
    udelay(5);

    // Clock = 1 : start clock to make sure HW can detect reset=Low
    hdmi_mask(HDMI_hdmi_clken0_reg,~hdmi_common_clk_mask[nport], hdmi_common_clk_mask[nport]);
    udelay(5);
    ...
    // RST = 1   : release reset
    hdmi_mask(HDMI_hdmi_rst0_reg,~hdmi_common_rst_mask[nport], hdmi_common_rst_mask[nport]);
    udelay(5);
...
void lib_hdmi_crt_off_hdmi_common_by_port(unsigned char nport)
{
    UINT32 hdmi_common_clk_mask[HDMI_PORT_TOTAL_NUM] = {
        HDMI_hdmi_clken0_clken_hdmi_common_mask,
        HDMI_hdmi_clken0_clken_hdmi_common1_mask,
...
unsigned char lib_hdmi_crt_is_hdmi_common_enabled_by_port(unsigned char nport)
{
    if (nport >= HDMI_PORT_TOTAL_NUM)
        return 0;

    if ((nport == 0) && HDMI_hdmi_clken0_get_clken_hdmi_common(hdmi_in(HDMI_hdmi_clken0_reg)) &&
        HDMI_hdmi_rst0_get_rstn_hdmi_common(hdmi_in(HDMI_hdmi_rst0_reg)))
        return 1;
    else if ((nport == 1) && HDMI_hdmi_clken0_get_clken_hdmi_common1(hdmi_in(HDMI_hdmi_clken0_reg)) &&
            HDMI_hdmi_rst0_get_rstn_hdmi_common1(hdmi_in(HDMI_hdmi_rst0_reg)))
        return 1;
    else if ((nport == 2) && HDMI_hdmi_clken0_get_clken_hdmi_common2(hdmi_in(HDMI_hdmi_clken0_reg)) &&
                HDMI_hdmi_rst0_get_rstn_hdmi_common2(hdmi_in(HDMI_hdmi_rst0_reg)))
        return 1;
    else if ((nport == 3) && HDMI_hdmi_clken0_get_clken_hdmi_common3(hdmi_in(HDMI_hdmi_clken0_reg)) &&
            HDMI_hdmi_rst0_get_rstn_hdmi_common3(hdmi_in(HDMI_hdmi_rst0_reg)))
        return 1;
...
void lib_hdmi_stb_wakeup_by_tmds_init(unsigned char nport, unsigned char en)
{
    if(en)
    {
...
void lib_hdmi_power(unsigned char nport, unsigned char enable)
{
    if (enable) {
...
#endif
        lib_hdmi_z0_set(nport, LN_ALL, 1, newbase_get_CLK_Wake_Up());
    } else {
        ...
        lib_hdmi_z0_set(nport, LN_ALL, 0, newbase_get_CLK_Wake_Up());
    }
}
...
void lib_hdmi_toggle_hdirq_en(unsigned char nport)
{
    lib_hdmi_set_hdirq_en(nport, 0);
    lib_hdmi_set_hdirq_en(nport, 1);
    lib_hdmi_set_hdirq_en(nport, 0);
}


unsigned char lib_hdmi_is_need_toggle_hdirq_en(unsigned char nport)
{
    return 1;
}
...
unsigned char lib_hdmi_get_colorspace(unsigned char nport)
{
    if (hdmi_rx[nport].hdmi_2p1_en)
    {
        if(TRUE == newbase_hdmi_is_run_dsc(nport))
        {
            if(TRUE == newbase_hdmi_get_convert_rgb(nport))
                return COLOR_RGB;
            else if((1 == newbase_hdmi_get_native_422(nport)) && (1 != newbase_hdmi_get_version_minor(nport))
                && (0 == newbase_hdmi_get_simple_422(nport)) && (0 == newbase_hdmi_get_native_420(nport)))
            {
                return COLOR_YUV422;
            }
            else if((0 == newbase_hdmi_get_native_422(nport)) && (1 == newbase_hdmi_get_simple_422(nport))
                && (0 == newbase_hdmi_get_native_420(nport)))
            {
                return COLOR_YUV422;
            }
            else if((0 == newbase_hdmi_get_native_422(nport)) && (1 != newbase_hdmi_get_version_minor(nport))
                && (0 == newbase_hdmi_get_simple_422(nport)) && (1 == newbase_hdmi_get_native_420(nport)))
            {
                return COLOR_YUV420;
            }
            else if((0 == newbase_hdmi_get_native_422(nport)) && (0 == newbase_hdmi_get_native_420(nport))
                && (0 == newbase_hdmi_get_simple_422(nport)))
            {
                return COLOR_YUV444;
            }
        }
    ...
    /*
        if (lane_mode == HDMI_4LANE)
            hdmi_mask(HDMI21_P0_HD21_PHY_FIFO_CR0_reg,
                ~(HDMI21_P0_HD21_PHY_FIFO_CR0_port0_c_afifo_en_mask|HDMI21_P0_HD21_PHY_FIFO_CR0_port0_c_flush_mask),
                  (HDMI21_P0_HD21_PHY_FIFO_CR0_port0_c_afifo_en_mask|HDMI21_P0_HD21_PHY_FIFO_CR0_port0_c_flush_mask));
        else
            hdmi_mask(HDMI21_P0_HD21_PHY_FIFO_CR0_reg, ~(HDMI21_P0_HD21_PHY_FIFO_CR0_port0_c_afifo_en_mask|HDMI21_P0_HD21_PHY_FIFO_CR0_port0_c_flush_mask),0x0);
*/
    }
}
...
COMMON_420_REG_YUV420_IN_SEL_T lib_hdmi_get_yuv420_in_sel(void)
{
    return HDMI_DP_COMMON_VIDEO_AND_OFFMS_PATH_SEL_get_yuv420_in_sel(hdmi_in(HDMI_DP_COMMON_VIDEO_AND_OFFMS_PATH_SEL_reg));
}

void lib_hdmi_set_yuv420_in_sel(unsigned char nport, COMMON_420_REG_YUV420_IN_SEL_T source_in)
{
    HDMI_EMG("[lib_hdmi_set_yuv420_in_sel nport:%d] set COMMONRX 420 sel, source_in=%d\n", nport, source_in);

    if(source_in<COMMON_420_IN_NUM)
    {
        rtd_maskl(HDMI_DP_COMMON_VIDEO_AND_OFFMS_PATH_SEL_reg, ~(HDMI_DP_COMMON_VIDEO_AND_OFFMS_PATH_SEL_yuv420_in_sel_mask), HDMI_DP_COMMON_VIDEO_AND_OFFMS_PATH_SEL_yuv420_in_sel(source_in));
    }
    else
    {
        HDMI_EMG("[lib_hdmi_set_yuv420_in_sel] INVALID input para nport=%d, source_in=%d\n", nport, source_in);
    }
}

void lib_hdmi_420_en(unsigned char nport, unsigned char en)
{
    unsigned int addr = HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_0_reg + nport * 0x1000;
    ...
    hdmi_mask(addr, ~HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_0_yuv420_cr_en_mask, HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_0_yuv420_cr_en(en?1:0));
}


void lib_hdmi_set_420_vactive(unsigned char nport, unsigned int vactive)
{
    unsigned int addr = HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_reg + nport * 0x1000;
    ...
    hdmi_mask(addr, ~HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_cr1_mode_mask, HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_cr1_mode_mask);
    hdmi_mask(addr, ~HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_cr1_vactive_mask, HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_cr1_vactive(vactive));
...
void lib_hdmi_420_fva_ds_mode(unsigned char nport, unsigned char en)
{
    ...
    hdmi_mask(addr, ~HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_cr1_fva_ds_mode_mask, HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_cr1_fva_ds_mode(en?1:0));
}
...
unsigned int lib_hdmi_get_420_fva_ds_mode(unsigned char nport)
{
    ...
    return HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_get_yuv420_cr1_fva_ds_mode(hdmi_in(addr));
}
...
void lib_hdmi_video_pll_init(unsigned char nport)
{
    ...
    hdmi_mask(addr, ~HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_cr1_mode_mask, 0);
    //hdmi_mask(HDMI_YUV420_CR1_reg, ~HDMI_YUV420_CR1_vactive_mask, HDMI_P0_YUV420_CR1_vactive(0));
    hdmi_mask(addr, ~HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_cr1_vactive_mask, HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_cr1_vactive(0));
    lib_hdmi_420_clkgen_en(nport, FALSE);
...
unsigned char lib_hdmi_set_video_dprxpll(
    unsigned char           nport,
    unsigned int            b_clk,
...
#define PLL_M_MIN    22
    ...
    *pll_pixelclockx1024 = pixel_clock;
    ...
    if (frl_mode == MODE_TMDS)
        hdmi_mask(HDMI_DPRXPLL_CLK_IN_MUX_SEL_reg,~HDMI_DPRXPLL_HDMI_DPRXPLL_CLK_IN_MUX_SEL_sclkg_pll_in_sel_mask,HDMI_DPRXPLL_HDMI_DPRXPLL_CLK_IN_MUX_SEL_sclkg_pll_in_sel_mask);
    else
        hdmi_mask(HDMI_DPRXPLL_CLK_IN_MUX_SEL_reg,~HDMI_DPRXPLL_HDMI_DPRXPLL_CLK_IN_MUX_SEL_sclkg_pll_in_sel_mask,0x0);

    hdmi_mask(HDMI_DPRXPLL_SETTING_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_sel_prediv_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_sel_prediv(n));  // hdmi_out(0xB8040430, 0x10110500);  //N=0, O=0, RS=5, Icp=0, CP=0
    hdmi_mask(HDMI_DPRXPLL_SETTING_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_o_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_o(o));
    hdmi_mask(HDMI_DPRXPLL_SETTING_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_rs_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_rs(dpll_rs));
    hdmi_mask(HDMI_DPRXPLL_SETTING_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_ip_mask,  HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_ip(dpll_ip));
    hdmi_mask(HDMI_DPRXPLL_SETTING_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_cp_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_cp(0));
    hdmi_mask(HDMI_DPRXPLL_SETTING_1_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_1_dprxpll_m_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_1_dprxpll_m(m));    // hdmi_out(0x18040434, 0x00320200);  //M=50
    //PLL_Out=27/(0+2)*(50+4)/2^0=729(MHz)
    hdmi_mask(HDMI_DPRXPLL_SETTING_2_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_2_dprxpll_wdrst_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_2_dprxpll_wdrst_mask); // hdmi_out(0xB8040438, 0x00000002);  //BPN=0
    hdmi_mask(HDMI_DPRXPLL_SETTING_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_ldopow_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_ldopow_mask); // hdmi_out(0xB8040430, 0x10810500);  //dprxpll_ldopow=1, dprxpll_ldo_ref2core=0, dprxpll_oeb=1 (disable)
    hdmi_mask(HDMI_DPRXPLL_SETTING_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_ldo_ref2core_mask, 0);
    hdmi_mask(HDMI_DPRXPLL_SETTING_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_oeb_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_oeb_mask);
    hdmi_mask(HDMI_DPRXPLL_SETTING_1_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_1_dprxpll_pow_mask, 0); // hdmi_out(0xB8040434, 0x00320000);  //dprxpll_pow=0, dprxpll_rstb=0 (reset)
    hdmi_mask(HDMI_DPRXPLL_SETTING_1_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_1_dprxpll_rstb_mask, 0);
    hdmi_mask(HDMI_DPRXPLL_SETTING_1_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_1_dprxpll_pow_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_1_dprxpll_pow_mask); // hdmi_out(0xB8040434, 0x00320200);  //dprxpll_pow=1
    hdmi_mask(HDMI_DPRXPLL_SETTING_1_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_1_dprxpll_rstb_mask, HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_1_dprxpll_rstb_mask);   // hdmi_out(0xB8040434, 0x00320300);  //dprxpll_pow=1, dprxpll_rstb=1 (normal)
    hdmi_mask(HDMI_DPRXPLL_SETTING_reg, ~HDMI_DPRXPLL_HDMI_DPRXPLL_SETTING_dprxpll_oeb_mask, 0); // hdmi_out(0xB8040430, 0x10800500);    //dprxpll_oeb=0 (enable)
    ...
    HDMI_INFO("430 HDMI_HDMI_VPLL_SETTING_reg=0x%x\n",hdmi_in(HDMI_DPRXPLL_SETTING_reg));
    HDMI_INFO("434 HDMI_HDMI_VPLL_SETTING_1_reg=0x%x\n",hdmi_in(HDMI_DPRXPLL_SETTING_1_reg));
    HDMI_INFO("438 HDMI_HDMI_VPLL_SETTING_2_reg=0x%x\n",hdmi_in(HDMI_DPRXPLL_SETTING_2_reg));
    HDMI_INFO("43c HDMI_DPRXPLL_CLK_IN_MUX_SEL_reg=0x%x\n",hdmi_in(HDMI_DPRXPLL_CLK_IN_MUX_SEL_reg));

    if(frl_mode !=MODE_TMDS)
    {//TBD, FRL MODE should set dpc corresponding Deep color value. Need more test on non FRL mode.

        hdmi_mask(addr, ~HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_clk_valid_en_mask, HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_clk_valid_en_mask);
        if(cd!=0)
            lib_hdmi_set_dpc_enable(nport,1);  // enable deep color support
    }
    else
    {
        hdmi_mask(addr, ~HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_yuv420_clk_valid_en_mask, 0);
        lib_hdmi_set_dpc_enable(nport,1);  // enable deep color support
        udelay(1);
    ...
    )
{
    ...
    unsigned int pll_pixelclock_4k120_420_thd = 0;
    unsigned int addr = HDMI_DP_COMMON_HDMIRX_YUV420_CTRL_1_reg + nport * 0x1000;

    HDMI_INFO("lib_hdmi_set_video_pll, port=%d, b_clk=%d, cd=%d, interlace=%d, is_420=%d, ver=%d\n", 
        nport, b_clk, cd, is_interlace, is_420, get_ic_version());
    if(nport < 2){
        return lib_hdmi_set_video_dprxpll(nport, b_clk, frl_mode, cd, is_interlace, is_420, pll_pixelclockx1024);
    }
    lib_hdmi_video_pll_init(nport);
...
#define FVCO_MAX    500
    ...
    *pll_pixelclockx1024 =pixel_clockx1024;
    ...
    pll_pixelclock_4k120_420_thd = hdmi_rx[nport].timing_t.single_p_mode_thd << 9; // max pll freq/2*1024 from g_panel_vfreq_hd21_pll_mapping_table

    if ((frl_mode == MODE_TMDS) && (is_420) && pixel_clockx1024 > pll_pixelclock_4k120_420_thd)
    {
        HDMI_EMG("[PLL] TMDS YUV420 with pixel_clock (%ld) > %d, can not excute 2x PLL \n", pixel_clockx1024, pll_pixelclock_4k120_420_thd);
        lib_hdmi_4k120_yu420_en(nport, 1);
...
void lib_hdmi_crc_continue_mode_en(unsigned char nport, unsigned char enable)
{
    if(enable)
...
int lib_hdmi_get_crc_continue_mode_status(unsigned char nport)
{
    return HDMI_CRC_Ctrl_get_crc_conti(hdmi_in(HDMI_CRC_Ctrl_reg));
}

void lib_hdmi_set_des_crc(unsigned char nport, unsigned int common_crc)
{
    hdmi_out(HDMI_DES_CRC_reg, common_crc);
}

int lib_hdmi_get_des_crc(unsigned char nport)
{
    return HDMI_DES_CRC_get_crc_des(hdmi_in(HDMI_DES_CRC_reg));
}


int lib_hdmi_get_crc_err_cnt(unsigned char nport)
{
    return HDMI_CRC_ERR_CNT0_get_crc_err_cnt(hdmi_in(HDMI_CRC_ERR_CNT0_reg));
}

void lib_hdmi_crc_auto_cmp_en(unsigned char nport, unsigned char enable)
{
    if(enable){
...
int lib_hdmi_get_crc_auto_cmp_status(unsigned char nport)
{
    return HDMI_CRC_Ctrl_get_crc_auto_cmp_en(hdmi_in(HDMI_CRC_Ctrl_reg));
}

int lib_hdmi_read_video_common_crc(unsigned char nport, unsigned char res_sel, unsigned int* p_crc, unsigned char is_continue_mode)
{// Common crc
    if(is_continue_mode)
    {
...
{
    hdmi_mask(HDMI_YUV422_CD_reg, ~(HDMI_YUV422_CD_det_en_mask), enable ? 1 : 0);
}

int lib_hdmi_get_yuv422_cd_det_en_status(unsigned char nport)
{
    return HDMI_YUV422_CD_get_det_en(hdmi_in(HDMI_YUV422_CD_reg));
}

void lib_hdmi_yuv422_cd_set_frame_cnt_thr(unsigned char nport)
{
    hdmi_mask(HDMI_YUV422_CD_reg, ~(HDMI_YUV422_CD_frame_cnt_thr_mask), HDMI_YUV422_CD_frame_cnt_thr(g_yun422_cd_frame_cnt_thd));
}

int lib_hdmi_yuv422_cd_get_frame_cnt_thr(unsigned char nport)
{
    return HDMI_YUV422_CD_get_frame_cnt_thr(hdmi_in(HDMI_YUV422_CD_reg));
}

void lib_hdmi_yuv422_cd_set_pixel_cnt_thr(unsigned char nport)
{
    hdmi_mask(HDMI_YUV422_CD_reg, ~(HDMI_YUV422_CD_pixel_cnt_thr_mask), HDMI_YUV422_CD_frame_cnt_thr(g_yuv422_cd_pixel_cnt_thd));
}

int lib_hdmi_yuv422_cd_get_pixel_cnt_thr(unsigned char nport)
{
    return HDMI_YUV422_CD_get_pixel_cnt_thr(hdmi_in(HDMI_YUV422_CD_reg));
}
...
YUV422_CD_STATUS_T lib_hdmi_yuv422_get_color_depth(unsigned char nport)
{
    if(lib_hdmi_get_yuv422_cd_det_en_status(nport) == 1)
    {
        ...
        det_12b_flag = HDMI_YUV422_CD_get_det_12b_flag(hdmi_in(HDMI_YUV422_CD_reg));
        det_10b_flag = HDMI_YUV422_CD_get_det_10b_flag(hdmi_in(HDMI_YUV422_CD_reg));
...
unsigned char lib_hdmi_mac_get_port_sel(unsigned char nport)
{
    return HDMI_PORT_SWITCH_get_port_sel(hdmi_in(HDMI_PORT_SWITCH_reg));
}
...
{//at video common, p0=p1=p2=p3 
    UINT32 hdmirx_2p_clk_sel_addr[HDMI_PORT_TOTAL_NUM] = {
            ...
            SYS_REG_SYS_DISPCLK_FRACT_2_reg,
            SYS_REG_SYS_DISPCLK_FRACT_2_reg,
            SYS_REG_SYS_DISPCLK_FRACT_2_reg};
    UINT32 hdmirx_2p_clk_sel_mask[HDMI_PORT_TOTAL_NUM] = {
            SYS_REG_SYS_CLKSEL_hdmirx0_2p_clk_sel_mask,
            SYS_REG_SYS_DISPCLK_FRACT_2_hdmirx1_2p_clk_sel_mask,
            SYS_REG_SYS_DISPCLK_FRACT_2_hdmirx2_2p_clk_sel_mask,
            SYS_REG_SYS_DISPCLK_FRACT_2_hdmirx3_2p_clk_sel_mask};
    ...
    case 1: // 1 pixel mode
        ...
        hdmi_mask(HDMI_COMMON_BYPASS_PATH_CTRL_reg, ~(HDMI_PORT_COMMON_BYPASS_PATH_CTRL_hd21_bypass_pixel_trans_clk_div_mask |HDMI_PORT_COMMON_BYPASS_PATH_CTRL_hd20_bypass_pixel_trans_clk_div_mask),
            (HDMI_PORT_COMMON_BYPASS_PATH_CTRL_hd21_bypass_pixel_trans_clk_div(1) | HDMI_PORT_COMMON_BYPASS_PATH_CTRL_hd20_bypass_pixel_trans_clk_div(1)));
        break;
    ...
    case 2: // 2 pixel mode
        ...
        hdmi_mask(HDMI_COMMON_BYPASS_PATH_CTRL_reg, ~(HDMI_PORT_COMMON_BYPASS_PATH_CTRL_hd21_bypass_pixel_trans_clk_div_mask |HDMI_PORT_COMMON_BYPASS_PATH_CTRL_hd20_bypass_pixel_trans_clk_div_mask),
            (HDMI_PORT_COMMON_BYPASS_PATH_CTRL_hd21_bypass_pixel_trans_clk_div(0) | HDMI_PORT_COMMON_BYPASS_PATH_CTRL_hd20_bypass_pixel_trans_clk_div(0)));
        break;
    case 4: // 4 pixel mode
...
void lib_hdmi_dsc_clk_div_sel_by_pixel_mode(unsigned char nport, unsigned char pixel_mode)
{
    switch(pixel_mode)
    {
        case 1: // 1 pixel mode
            hdmi_out(HDMI_support_dscd_clken_reg, (HDMI_SUPPORT_DSCD_CLKEN_support_dscd_clken(1)|
                                                   HDMI_SUPPORT_DSCD_CLKEN_dscd_out_div(2)|
                                                   HDMI_SUPPORT_DSCD_CLKEN_dscd_out_yuv420_r_div(2)|
                                                   HDMI_PORT_COMMON_SUPPORT_DSCD_CLKEN_dscd_pixel_trans_clk_div(1)));
            break;
        case 2: // 2 pixel mode
        default:
            hdmi_out(HDMI_support_dscd_clken_reg, (HDMI_SUPPORT_DSCD_CLKEN_support_dscd_clken(1)|
                                                   HDMI_SUPPORT_DSCD_CLKEN_dscd_out_div(1)|
                                                   HDMI_SUPPORT_DSCD_CLKEN_dscd_out_yuv420_r_div(1)));
            break;
    }
 ...
 *--------------------------------------------------*/
unsigned char lib_hdmi_get_fw_debug_bit(unsigned char nport, unsigned int debug_bit)
{
 ...
 * Retn : N/A
 *--------------------------------------------------*/
void lib_hdmi_set_fw_debug_bit(unsigned char nport, unsigned int debug_bit, unsigned char on)
{
...
void lib_hdmi_mac_init(unsigned char nport, unsigned char br_swap)
{
    ...
    // 1. ex phy fifo ck en
    hdmi_mask(HDMI_EX_PHY_FIFO_CR0_reg,
    ...
    // 2. ex phy afifo en
    hdmi_mask(HDMI_EX_PHY_FIFO_CR2_reg,
        ~(HDMI_EX_P0_EX_PHY_FIFO_CR2_port0_c_afifo_en_mask), HDMI_EX_P0_EX_PHY_FIFO_CR2_port0_c_afifo_en_mask);    // Port0_c_afifo_en & Port1_c_afifo_en = 

    // 3. ex mac  clk invert
    hdmi_mask(HDMI_EX_PHY_FIFO_CR1_reg,
    ...
    hdmi_mask(HDMI_EX_PHY_FIFO_CR3_reg,
        ~(HDMI_EX_P0_EX_PHY_FIFO_CR3_port0_cclk_inv_mask),HDMI_EX_P0_EX_PHY_FIFO_CR3_port0_cclk_inv_mask);    //Port0_cclk_inv & Port1_cclk_inv = 1
...
//    lib_hdmi_mac_afifo_enable(nport,HDMI_4LANE);
    ...
    // bypass hdmirx pkt to hdmitx
    lib_hdmi_drop_pkt_enable(nport, DROP_PKT_ALL, 1);
    lib_hdmi_pkt_to_hdmitx_output_enable(nport, 0);
}
...
{
#if WAIT_SCALER_READY // wait scaler ready
    ...
    hdmi_mask(DMA_VGIP_DMA_VGIP_PTN_H_VI_reg, ~DMA_VGIPz_DMA_VGIP_PTN_H_VI_dma_vcaptst_num_mask,
...
{
    unsigned char timeout_count = WAIT_H_SYNC_COUNT_THD;
...
void lib_hdmi_set_hdmi_scpu_irq_enable(unsigned char enable)
{
    ...
    HDMI_EMG("==================lib_hdmi_set_hdmi_scpu_irq_enable %d===================\n",enable);

    if(enable)
        // Enable HDMI SCPU IRQ
        hdmi_out(SYS_REG_INT_CTRL_MEMC_reg, (SYS_REG_INT_CTRL_MEMC_hdmi_irq_scpu_routing_en_mask|SYS_REG_INT_CTRL_MEMC_write_data_mask));
    else
        hdmi_out(SYS_REG_INT_CTRL_MEMC_reg, SYS_REG_INT_CTRL_MEMC_hdmi_irq_scpu_routing_en_mask);
}
...
void lib_hdmi_drop_pkt_enable(unsigned char nport, DROP_PKT_TYPE type, unsigned char enable)
{
    switch (type) {
        case DROP_PKT_AUDIO_DATA:
            HDMI_WARN("DROP_PKT_AUDIO_DATA = %d\n", enable);
            if (hdmi_rx[nport].hdmi_2p1_en)
                hdmi_mask(HD21_PKT_reg, ~HDMI21_P0_HD21_HDMI_PKT_pkt_aud_data_drop_en_mask, HDMI21_P0_HD21_HDMI_PKT_get_pkt_aud_data_drop_en(enable));
            else
                hdmi_mask(HDMI_PKT_reg, ~HDMI_P0_HDMI_PKT_pkt_aud_data_drop_en_mask, HDMI_P0_HDMI_PKT_get_pkt_aud_data_drop_en(enable));
            break;
        case DROP_PKT_NON_AUDIO_DATA:
            HDMI_WARN("DROP_PKT_NON_AUDIO_DATA = %d\n", enable);
            if (hdmi_rx[nport].hdmi_2p1_en)
                hdmi_mask(HD21_PKT_reg, ~HDMI21_P0_HD21_HDMI_PKT_pkt_non_aud_data_drop_en_mask, HDMI21_P0_HD21_HDMI_PKT_get_pkt_non_aud_data_drop_en(enable));
            else
                hdmi_mask(HDMI_PKT_reg, ~HDMI_P0_HDMI_PKT_pkt_non_aud_data_drop_en_mask, HDMI_P0_HDMI_PKT_get_pkt_non_aud_data_drop_en(enable));
            break;
        case DROP_PKT_HEAD:
            HDMI_WARN("DROP_PKT_HEAD = %d\n", enable);
            if (hdmi_rx[nport].hdmi_2p1_en)
                hdmi_mask(HD21_PKT_reg, ~HDMI21_P0_HD21_HDMI_PKT_pkt_head_drop_en_mask, HDMI21_P0_HD21_HDMI_PKT_get_pkt_head_drop_en(enable));
            else
                hdmi_mask(HDMI_PKT_reg, ~HDMI_P0_HDMI_PKT_pkt_head_drop_en_mask, HDMI_P0_HDMI_PKT_get_pkt_head_drop_en(enable));
            break;
        ...
        case DROP_PKT_ALL:
            ...
            if (hdmi_rx[nport].hdmi_2p1_en){
                if(enable){
                    hdmi_mask(HD21_PKT_reg, ~(HDMI21_P0_HD21_HDMI_PKT_pkt_aud_data_drop_en_mask | HDMI21_P0_HD21_HDMI_PKT_pkt_non_aud_data_drop_en_mask|HDMI21_P0_HD21_HDMI_PKT_pkt_head_drop_en_mask),
                    (HDMI21_P0_HD21_HDMI_PKT_pkt_aud_data_drop_en_mask | HDMI21_P0_HD21_HDMI_PKT_pkt_non_aud_data_drop_en_mask|HDMI21_P0_HD21_HDMI_PKT_pkt_head_drop_en_mask));
                }else{
                    hdmi_mask(HD21_PKT_reg, ~(HDMI21_P0_HD21_HDMI_PKT_pkt_aud_data_drop_en_mask | HDMI21_P0_HD21_HDMI_PKT_pkt_non_aud_data_drop_en_mask|HDMI21_P0_HD21_HDMI_PKT_pkt_head_drop_en_mask),0);
                }
            } else{
                if(enable){
                    hdmi_mask(HDMI_PKT_reg, ~(HDMI_P0_HDMI_PKT_pkt_aud_data_drop_en_mask | HDMI_P0_HDMI_PKT_pkt_non_aud_data_drop_en_mask|HDMI_P0_HDMI_PKT_pkt_head_drop_en_mask),
                    (HDMI_P0_HDMI_PKT_pkt_aud_data_drop_en_mask | HDMI_P0_HDMI_PKT_pkt_non_aud_data_drop_en_mask|HDMI_P0_HDMI_PKT_pkt_head_drop_en_mask));
                }else{
                    hdmi_mask(HDMI_PKT_reg, ~(HDMI_P0_HDMI_PKT_pkt_aud_data_drop_en_mask | HDMI_P0_HDMI_PKT_pkt_non_aud_data_drop_en_mask|HDMI_P0_HDMI_PKT_pkt_head_drop_en_mask),0);
                }
            }
            break;
        default:
...
void lib_hdmi_pkt_to_hdmitx_output_enable(unsigned char nport, unsigned char enable)
{
    if (hdmi_rx[nport].hdmi_2p1_en)
        hdmi_mask(HD21_PKT_reg, ~HDMI21_P0_HD21_HDMI_PKT_pkt_2hdmitx_output_en_mask, HDMI21_P0_HD21_HDMI_PKT_get_pkt_2hdmitx_output_en(enable));
    else
        hdmi_mask(HDMI_PKT_reg, ~HDMI_P0_HDMI_PKT_pkt_2hdmitx_output_en_mask, HDMI_P0_HDMI_PKT_get_pkt_2hdmitx_output_en(enable));
}

void lib_hdmirx_to_hdmitx_pkt_port_sel(unsigned char port)
{
    hdmi_mask(HDMI_TOP_COMMON_hdmirx2hdmitx_reg, ~(HDMI_TOP_COMMON_hdmirx2hdmitx_pkt_port_sel_mask), HDMI_TOP_COMMON_hdmirx2hdmitx_pkt_port_sel(port));
}
...
void newbase_hdmi_wakeup_by_tmds_en(unsigned char en)
{
	...
	HDMI_INFO("newbase_hdmi_wakeup_by_tmds_en = %d\n", en);
	if(en)
	{
		for(iNum = 0 ; iNum < HDMI_PORT_TOTAL_NUM; iNum++)
		{
			lib_hdmi21_stb_tmds_clk_wakeup_en(iNum, 1);
			newbase_hdmi_hd21_stb_dpm_init(iNum);
			//lib_hdmi_stb_tmds_clk_wakeup_en(1);
			if (newbase_hdmi_get_dpm_enable(iNum))
				lib_hdmi_stb_wakeup_by_tmds_init(iNum, 1);
			//newbase_hdmi_set_hpd(iNum, 1);
		}
	}
	else
	{
		for(iNum = 0 ; iNum < HDMI_PORT_TOTAL_NUM; iNum++)
		{
			lib_hdmi21_stb_tmds_clk_wakeup_en(iNum, 0);
			//lib_hdmi_stb_tmds_clk_wakeup_en(0);
			lib_hdmi_stb_wakeup_by_tmds_init(iNum, 0);
		}
	}
}

/**
 * @brief Enable or disable DPM function
 * @param[in] enable
 *      - 1     enable DPM function
 *      - 0     disable DPM function
 * @return 
 *      - 0     DPM status was set successfully
 *      - other set failed
 */ 
int newbase_hdmi_set_dpm_enable(unsigned int nport, int enable)
{
    int ret = 0;

    if (!GET_FLOW_CFG(HDMI_FLOW_CFG_DFE, HDMI_FLOW_CFG5_DPM_ENABLE))
    {
        HDMI_WARN("DPMS is not enabled\n");
        ret = -1;
    }
    else
    {
        ...
        {
            hdmi_mask(HDMI_STB_CLKDETSR_reg, ~(_BIT6), _BIT6); //[6]Clock detect enable
            newbase_set_CLK_Wake_Up(newbase_get_CLK_Wake_Up() | (unsigned char)(1 << nport));
        }
        else
            newbase_set_CLK_Wake_Up(newbase_get_CLK_Wake_Up() & (unsigned char)(~(1 << nport)));
    }

    HDMI_INFO("%s [port:%u] enable=%d, CLK_Wake_Up = 0x%x, ret =%d\n", __func__, nport, enable, newbase_get_CLK_Wake_Up(), ret);
    return ret;
}

/**
 * @brief get DPM status 
 * @return 
 *      - 0     The DPM function is disabled
 *      - 1     The DPM function is enabled
 */
int newbase_hdmi_get_dpm_enable(unsigned int nport)
{
    int ret = 0;
    ...
    {
        if ((hdmi_in(HDMI_STB_CLKDETSR_reg) & _BIT6) >> 6)
            return 1;
    }

    //HDMI_INFO("%s dpm enable = %d\n", __func__, ret);
    return ret;
}
...
void lib_hdmi_hd20_set_polarity_meas_mode(unsigned char nport, HD20_MEASURE_POLARITY_MEAS_MODE mode)
{
    hdmi_mask(HD20_MEAS_FRL_MEASURE_9_reg, ~(HDMI20_P0_MEAS_FRL_MEASURE_9_polarity_meas_mask), HDMI20_P0_MEAS_FRL_MEASURE_9_polarity_meas(mode));
}

HD20_MEASURE_POLARITY_MEAS_MODE lib_hdmi_hd20_get_polarity_meas_mode(unsigned char nport)
{
    return HDMI20_P0_MEAS_FRL_MEASURE_9_get_polarity_meas(hdmi_in(HD20_MEAS_FRL_MEASURE_9_reg));
}

unsigned int m_hd20_measure_last_vs_cnt[4] = {0,0,0,0};
HDMI20_MEASURE_RESULT lib_hdmi20_hd20_measure(unsigned char nport, MEASURE_TIMING_T* update_timing)
{
    ...
    lib_hdmi_hd20_set_polarity_meas_mode(nport, HD20_POLARITY_AUDIO_MEAS);
    ...
    if(HDMI20_P0_MEAS_FRL_MEASURE_9_get_vs_polarity(hdmi_in(HD20_MEAS_FRL_MEASURE_9_reg)) == 0)
        update_timing->polarity |= _BIT1;
    if(HDMI20_P0_MEAS_FRL_MEASURE_9_get_hs_polarity(hdmi_in(HD20_MEAS_FRL_MEASURE_9_reg)) == 0)
    ...
    if(GET_H_VIDEO_FSM(nport) < MAIN_FSM_HDMI_VIDEO_READY){
        HDMI_WARN("[HD20MS] MEASURE_3: 0x%x, MEASURE_4: 0x%x\n",hdmi_in(HD20_MEAS_FRL_MEASURE_3_reg), hdmi_in(HD20_MEAS_FRL_MEASURE_4_reg));
...
void lib_hdmi_hd20_clr_measure_last_vs_cnt(unsigned char nport)
{
    m_hd20_measure_last_vs_cnt[nport] = 0;
}

// 0: 4 frame pop  1: 1 frame pop
void lib_hdmi_hd20_meas_set_frame_pop_mode(unsigned char nport, unsigned char mode)
{
    hdmi_mask(HD20_MEAS_FRL_MEASURE_A_reg, ~HD20_MEAS_FRL_MEASURE_A_frame_pop_mode_mask, HD20_MEAS_FRL_MEASURE_A_frame_pop_mode(mode?1:0));
}

// 0: 4 frame pop  1: 1 frame pop
unsigned char lib_hdmi_hd20_meas_get_frame_pop_mode(unsigned char nport)
{
    return HD20_MEAS_FRL_MEASURE_A_get_frame_pop_mode(hdmi_in(HD20_MEAS_FRL_MEASURE_A_reg));
}


void lib_hd20ms_timing_check_h(UINT8 port, MEASURE_TIMING_T* update_timing)
{
...
void lib_hd20ms_timing_check_v(UINT8 port, MEASURE_TIMING_T* update_timing)
{
...
void lib_hd20_measure(unsigned char port, MEASURE_TIMING_T* update_timing)
{
    HDMI20_MEASURE_RESULT result = HDMI20_MEASURE_SUCCESS;
    result = lib_hdmi20_hd20_measure(port, update_timing);
    if(result == HDMI20_MEASURE_SUCCESS){
        lib_hd20ms_timing_check_h(port, update_timing);
        lib_hd20ms_timing_check_v(port, update_timing);
...
void lib_hdmi_output_disable(unsigned char port)
{
