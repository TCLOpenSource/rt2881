...
extern void lib_hdmi_hd21_vdrop_set(unsigned char nport, unsigned char enable, unsigned int htotal);
...
extern void lib_hdmi_hd21_timing_gen_en_vs_align(unsigned char nport,unsigned int delay_ms);
...
// IRQ
//------------------------------------------------------------------
extern unsigned char lib_hdmi_hd21_is_irq_pending(unsigned char nport);
extern void lib_hdmi_hd21_clr_irq_pending(unsigned char nport);
...
extern void newbase_hdmi_hd21_stb_dpm_init(unsigned char port);
...
#define lib_hdmi_hd21_vdrop_set(...)
