...
extern const unsigned char* p_default_hdmi_edid_384_table[5];
...
//---------------------------With CEC OSDNAME info-----------------------------------------------
	HDMI_SPECIFIC_DEVICE_U_PLUS_4K,     //WOSQRTK-17011
	HDMI_SPECIFIC_DEVICE_KT_STB_KI1100,     //WOSQRTK-16895
	HDMI_SPECIFIC_DEVICE_KT_STB_M770,     //WOSQRTK-16689
//---------------------------Without SPD info-----------------------------------------------
	...
	HDMI_SPECIFIC_DEVICE_APPLE_MACBOOK_PRO,
...
#define HDMI_COMP_CEC_OSDNAME_LEGNTH    16
typedef struct
{
     HDMI_SPECIFIC_DEVICE_E device_id;
     unsigned char check_cec_osdname[HDMI_COMP_CEC_OSDNAME_LEGNTH]; 
}HDMI_DEVICE_CHECK_CEC_CONDITION;
...
#define CHECK_FLAG_CEC_OSDNAME                         _BIT3
...
extern const HDMI_DEVICE_CHECK_CEC_CONDITION g_device_check_cec[];
extern const unsigned char g_device_check_cec_table_size;
...
typedef enum
{
     ...
     HDMI_FLOW_CFG7_HDMI_DVI_DETECT_CNT,
     HDMI_FLOW_CFG7_HD20_TIMING_MEASURE_EN,
     HDMI_FLOW_CFG7_HD21_TIMING_MEASURE_EN,
     HDMI_FLOW_CFG7_NUM
}HDMI_FLOW_CFG7_INDEX;    // for HDMI_FLOW_CFG_TIMING_MEASURE

typedef enum
{
     HDMI_FLOW_CFG8_VALID = 0,
     HDMI_FLOW_CFG8_HDMI_INFO_PACKET_THREAD_CYCLE_MS,
     HDMI_FLOW_CFG8_HDMI_AUDIO_THREAD_CYCLE_MS,
     HDMI_FLOW_CFG8_HDMI_NO_5V_THREAD_CYCLE_MS,
     HDMI_FLOW_CFG8_NUM
}HDMI_FLOW_CFG8_INDEX;
...
typedef struct
{
    unsigned short panel_h_active;
    unsigned short panel_v_active;
