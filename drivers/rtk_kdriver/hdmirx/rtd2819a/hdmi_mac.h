...
typedef enum
{
    COMMON_420_IN_HDMIRX,
    COMMON_420_IN_DPRX,
    COMMON_420_IN_HDMIRX_DSCD,
    COMMON_420_IN_DPRX_DSCD,
    COMMON_420_IN_NUM
} COMMON_420_REG_YUV420_IN_SEL_T;
//------------------------------------------------------------------
// CRT
//------------------------------------------------------------------
...
extern unsigned char lib_hdmi_crt_is_support_multi_hdmi_common(void);
extern void lib_hdmi_crt_reset_hdmi_common_by_port(unsigned char nport);
extern void lib_hdmi_crt_off_hdmi_common_by_port(unsigned char nport);
extern unsigned char lib_hdmi_crt_is_hdmi_common_enabled_by_port(unsigned char nport);
...
// Video Common CRC
//------------------------------------------------------------------
extern int lib_hdmi_read_video_common_crc(unsigned char nport, unsigned char res_sel, unsigned int* p_crc,unsigned char is_continue_mode);
extern void lib_hdmi_crc_continue_mode_en(unsigned char nport, unsigned char enable);
extern int lib_hdmi_get_crc_continue_mode_status(unsigned char nport);
extern int lib_hdmi_get_crc_auto_cmp_status(unsigned char nport);
extern void lib_hdmi_crc_auto_cmp_en(unsigned char nport, unsigned char enable);
extern int lib_hdmi_get_crc_err_cnt(unsigned char nport);
extern void lib_hdmi_set_des_crc(unsigned char nport, unsigned int common_crc);
extern int lib_hdmi_get_des_crc(unsigned char nport);
...
extern void lib_hdmi_output_disable(unsigned char port);
...
// YUV 420 ti 444
//------------------------------------------------------------------
extern COMMON_420_REG_YUV420_IN_SEL_T lib_hdmi_get_yuv420_in_sel(void);
extern void lib_hdmi_set_yuv420_in_sel(unsigned char nport, COMMON_420_REG_YUV420_IN_SEL_T source_in);
...
extern unsigned char lib_hdmi_mac_get_port_sel(unsigned char nport);
...
extern void lib_hdmi_dsc_clk_div_sel_by_pixel_mode(unsigned char nport, unsigned char pixel_mode);

// hdmirx bypass pkt to hdmitx
extern void lib_hdmi_drop_pkt_enable(unsigned char nport, DROP_PKT_TYPE type, unsigned char enable);
extern void lib_hdmi_pkt_to_hdmitx_output_enable(unsigned char nport, unsigned char enable);
extern void lib_hdmirx_to_hdmitx_pkt_port_sel(unsigned char port);


// FW Debug register control
extern unsigned char lib_hdmi_get_fw_debug_bit(unsigned char nport, unsigned int debug_bit);
extern void lib_hdmi_set_fw_debug_bit(unsigned char nport, unsigned int debug_bit, unsigned char val);
...
extern void lib_hd20_measure(unsigned char port, MEASURE_TIMING_T* update_timing);
extern void lib_hdmi_hd20_clr_measure_last_vs_cnt(unsigned char nport);
extern void lib_hdmi_hd20_meas_set_frame_pop_mode(unsigned char nport, unsigned char mode);
extern unsigned char lib_hdmi_hd20_meas_get_frame_pop_mode(unsigned char nport);
