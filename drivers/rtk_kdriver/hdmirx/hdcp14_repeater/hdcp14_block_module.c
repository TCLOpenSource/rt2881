...
void hdcp_linear_transformation_k(u32 ky, u32 kz, u32 *kxo, u32 *kyo)
{
	u8 ky_bits[28] = {0};
	u8 kz_bits[28] = {0};	
	u8 kx_out_bits[28] = {0};
...
{
	*kzo = hdcp_do_s_k_box(kx);
	hdcp_linear_transformation_k(ky, kz, kxo, kyo);		
} 
