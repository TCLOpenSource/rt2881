...
typedef struct {
	...
	u_int8_t ACDR_B_1_152_1;
	u_int8_t ACDR_B_1_152_1_32;
	u_int8_t ACDR_B_1_152_1_64;	
}APHY_Fix_tmds_1_T;
...
void APHY_Fix_tmds_Patch_1_func(unsigned char nport, TMDS_TIMING_PARAM_T value_param);
void Manual_DFE_tmds_Patch_1_func(unsigned char nport, TMDS_TIMING_PARAM_T value_param);
#endif
...
typedef struct {
	...
	u_int8_t DFE_ADAPT_EN_R_6_0_53_1_128;
	u_int8_t DFE_ADAPT_EN_R_6_0_53_1_192;
}LEQ_VTH_Tap0_3_4_Adapt_tmds_P_1_T;
...
typedef struct {
	...
	u_int8_t DFE_ADAPT_EN_R_6_0_31_1_128;
	u_int8_t DFE_ADAPT_EN_R_6_0_31_1_192;
}Tap0_to_Tap4_Adapt_tmds_P_1_T;

void TMDS_Main_P_Seq(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);

void DFE_ini_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void DPHY_Fix_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void DPHY_Para_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void APHY_Fix_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void APHY_Para_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void DPHY_Init_Flow_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void APHY_Init_Flow_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void DCDR_settings_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void DCDR_settings_tmds_P_2_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void Koffset_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void LEQ_VTH_Tap0_3_4_Adapt_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void Tap0_to_Tap4_Adapt_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void DCDR_settings_tmds_P_3_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void DCDR_settings_tmds_P_4_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void Manual_DFE_tmds_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T tmds_timing);
void APHY_Fix_tmds_Patch_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T value_param);
void Manual_DFE_tmds_Patch_P_1_func(unsigned char nport, TMDS_TIMING_PARAM_T value_param);
#endif
...
typedef struct {
	...
	u_int8_t DFE_ADAPT_EN_R_6_0_118_1;
	u_int8_t ck_fine_tune_start_142_1;
}LEQ_VTH_Tap0_3_4_Adapt_frl_P_1_T;
...
typedef struct {
	...
	u_int8_t DFE_ADAPT_EN_R_6_0_62_1;
	u_int8_t ck_fine_tune_start_68_1;
}Tap0_to_Tap4_Adapt_frl_P_1_T;

void FRL_Main_P_Seq(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);

void DFE_ini_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void DPHY_Fix_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void DPHY_Para_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void APHY_Fix_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void APHY_Para_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void DPHY_Init_Flow_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void APHY_Init_Flow_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void ACDR_settings_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void ACDR_settings_frl_P_2_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void Koffset_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void LEQ_VTH_Tap0_3_4_Adapt_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void Tap0_to_Tap4_Adapt_frl_P_1_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void ACDR_settings_frl_P_3_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
void ACDR_settings_frl_P_4_func(unsigned char nport, FRL_VALUE_PARAM_T frl_timing);
#endif
