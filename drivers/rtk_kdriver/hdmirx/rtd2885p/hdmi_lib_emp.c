...
{
    if (hdmi_rx[nport].hdmi_2p1_en) {
        if (HD21_SBTM_ST_get_em_sbtm_no(hdmi_in(HD21_SBTM_ST_reg))) { // No vsem
            hdmi_out(HD21_SBTM_ST_reg, HD21_SBTM_ST_em_sbtm_no_mask);
            return 0;
        }
        if (!HD21_SBTM_ST_get_em_sbtm_first(hdmi_in(HD21_SBTM_ST_reg))) { // No First Packet
            return 0;
        }

        if (!HD21_SBTM_ST_get_em_sbtm_last(hdmi_in(HD21_SBTM_ST_reg))) { // No Last Packet
            return 0;
        }
    }
    else {
...
{
    if (hdmi_rx[nport].hdmi_2p1_en) {
        hdmi_mask(HD21_SBTM_ST_reg, ~HD21_SBTM_ST_em_sbtm_no_mask, HD21_SBTM_ST_em_sbtm_no_mask);
        hdmi_mask(HD21_SBTM_ST_reg, ~HD21_SBTM_ST_em_sbtm_first_mask, HD21_SBTM_ST_em_sbtm_first_mask);
        hdmi_mask(HD21_SBTM_ST_reg, ~HD21_SBTM_ST_em_sbtm_last_mask, HD21_SBTM_ST_em_sbtm_last_mask);
    }
    else {
...
{
    if (hdmi_rx[nport].hdmi_2p1_en) {
        hdmi_mask(HD21_HDMI_SBTM_EMC_reg, ~HDMI21_P0_HD21_HDMI_SBTM_EMC_sbtm_clr_mask, HDMI21_P0_HD21_HDMI_SBTM_EMC_sbtm_clr_mask);
        hdmi_mask(HD21_HDMI_SBTM_EMC_reg, ~HDMI21_P0_HD21_HDMI_SBTM_EMC_sbtm_clr_mask, 0);
    }
    else {
