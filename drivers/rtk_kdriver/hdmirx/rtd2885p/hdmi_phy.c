...
void lib_hdmi_trigger_measurement(unsigned char nport)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		hdmi_mask(HDMIRX_PHY_mod_P_regd00,~HDMIRX_PHY_HD21_P0_MOD_REGD00_reg_p0_ck_md_rstb_mask,0);
		hdmi_mask(HDMIRX_PHY_mod_P_regd00,~HDMIRX_PHY_HD21_P0_MOD_REGD00_reg_p0_ck_md_rstb_mask,HDMIRX_PHY_HD21_P0_MOD_REGD00_reg_p0_ck_md_rstb_mask);
		hdmi_out(HDMIRX_PHY_mod_P_regd01, HDMIRX_PHY_HD21_P0_MOD_REGD01_p0_ck_md_ok_ro_mask);
...
unsigned char lib_hdmi_is_clk_ready(unsigned char nport)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		hdmi_out(HDMIRX_PHY_mod_P_regd01, HDMIRX_PHY_HD21_P0_MOD_REGD01_p0_ck_md_ok_ro_mask);
		udelay(40);
		if (HDMIRX_PHY_HD21_P0_MOD_REGD01_get_p0_ck_md_ok_ro(hdmi_in(HDMIRX_PHY_mod_P_regd01))) {
			return TRUE;
		} else {
			return FALSE;
		}
...
{   
	...
	{
		  //merlin8p IC , run merlin8p flow
		return HDMIRX_PHY_HD21_P0_MOD_REGD01_get_p0_ck_md_count_ro(hdmi_in(HDMIRX_PHY_mod_P_regd01));
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if (en) 
		{
			for (nport=0; nport<HDMI_PORT_TOTAL_NUM; nport++)
			{
				...
				hdmi_mask(HDMIRX_PHY_ck_cmu_1_P_reg,~(cmu_ck_1_HYS_AMP_EN|cmu_ck_1_MD_DET_SRC|cmu_ck_1_HYS_WIN_SEL|cmu_ck_1_CKIN_SEL|cmu_ck_1_NON_HYS_AMP_EN),
				(cmu_ck_1_HYS_AMP_EN|cmu_ck_1_NON_HYS_AMP_EN|cmu_ck_1_MD_DET_SRC|cmu_ck_1_ENHANCE_BIAS_10|cmu_ck_1_CKIN_SEL));
			}
		}
		else 
...
{
	lib_hdmi21_z0_set(port, lane, enable, CLK_Wake_Up);
#if 0
