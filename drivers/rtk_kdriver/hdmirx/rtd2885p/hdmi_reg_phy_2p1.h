...
//Merlin8p
#define HDMI_APHY0_BASEP	    (0xB80B4204)   // (P0)   
#define HDMI_APHY1_BASEP	    (0xB80B4A04) 
#define HDMI_APHY2_BASEP	    (0xB800A204)   
#define HDMI_APHY3_BASEP	    (0xB800AA04) 

#define HDMI_DPHY0_BASEP	    (0xB80B4300)   //(P0) 
#define HDMI_DPHY1_BASEP	    (0xB80B4B00)  
#define HDMI_DPHY2_BASEP	    (0xB800A300)    
#define HDMI_DPHY3_BASEP	    (0xB800AB00)   

#define HDMI_APHY0_RSTB_BASEP	    (0xB80B42FC) 
#define HDMI_APHY1_RSTB_BASEP	    (0xB80B4AFC) 
#define HDMI_APHY2_RSTB_BASEP	    (0xB800A2FC) 
#define HDMI_APHY3_RSTB_BASEP	    (0xB800AAFC) 
...
//Merlin8p
extern const struct hdmi21_aphy_reg_st *hd21_aphyp[4];
...
#define HDMIRX_PHY_z0k_P_reg     	 	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->z0k)//BA04            
#define HDMIRX_PHY_z0pow_P_reg    	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->z0pow)//BA08	        
#define HDMIRX_PHY_top_in_0_P_reg 	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->top_in_0)//BA10       
#define HDMIRX_PHY_top_in_1_P_reg 	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->top_in_1)//BA14	      
#define HDMIRX_PHY_top_in_2_P_reg 	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->top_in_2)//BA18	      
#define HDMIRX_PHY_top_out_0_P_reg 	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->top_out_0)//BA20      
#define HDMIRX_PHY_top_out_1_P_reg 	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->top_out_1)//BA24       
#define HDMIRX_PHY_rsvd0_P_reg    	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->rsvd0)//BA28          
#define HDMIRX_PHY_rsvd1_P_reg		  (unsigned int)(unsigned long)(&hd21_aphyp[nport]->rsvd1)//BA2C          
#define HDMIRX_PHY_ck0_P_reg			(unsigned int)(unsigned long)(&hd21_aphyp[nport]->ck0)//BA30             
#define HDMIRX_PHY_ck1_P_reg			(unsigned int)(unsigned long)(&hd21_aphyp[nport]->ck1)//BA34             
#define HDMIRX_PHY_ck2_P_reg 		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->ck2)//BA38             
#define HDMIRX_PHY_ck3_P_reg 		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->ck3)//BA3C             
#define HDMIRX_PHY_ck4_P_reg			(unsigned int)(unsigned long)(&hd21_aphyp[nport]->ck4)//BA40             
#define HDMIRX_PHY_acdr_ck0_P_reg	 (unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_ck0)//BA44       
#define HDMIRX_PHY_acdr_ck1_P_reg	 (unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_ck1)//BA48       
#define HDMIRX_PHY_acdr_ck2_P_reg 	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_ck2)//BA4C       
#define HDMIRX_PHY_b0_P_reg       		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->b0)//BA50             
#define HDMIRX_PHY_b1_P_reg       		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->b1)//BA54             
#define HDMIRX_PHY_b2_P_reg       		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->b2)//BA58             
#define HDMIRX_PHY_b3_P_reg       		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->b3)//BA5C             
#define HDMIRX_PHY_b4_P_reg      		 (unsigned int)(unsigned long)(&hd21_aphyp[nport]->b4)//DA60             
#define HDMIRX_PHY_acdr_b0_P_reg  	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_b0)//BA64        
#define HDMIRX_PHY_acdr_b1_P_reg  	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_b1)//BA68        
#define HDMIRX_PHY_acdr_b2_P_reg 	 (unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_b2)//BA6C        
#define HDMIRX_PHY_g0_P_reg       		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->g0)//BA70             
#define HDMIRX_PHY_g1_P_reg       		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->g1)//BA74             
#define HDMIRX_PHY_g2_P_reg      		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->g2)//BA78             
#define HDMIRX_PHY_g3_P_reg       		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->g3)//BA7C             
#define HDMIRX_PHY_g4_P_reg			(unsigned int)(unsigned long)(&hd21_aphyp[nport]->g4)//BA80             
#define HDMIRX_PHY_acdr_g0_P_reg  	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_g0)//BA84        
#define HDMIRX_PHY_acdr_g1_P_reg		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_g1)//BA88        
#define HDMIRX_PHY_acdr_g2_P_reg		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_g2)//BA8C        
#define HDMIRX_PHY_r0_P_reg			(unsigned int)(unsigned long)(&hd21_aphyp[nport]->r0)//BA90             
#define HDMIRX_PHY_r1_P_reg			(unsigned int)(unsigned long)(&hd21_aphyp[nport]->r1)//BA94             
#define HDMIRX_PHY_r2_P_reg			(unsigned int)(unsigned long)(&hd21_aphyp[nport]->r2)//BA98             
#define HDMIRX_PHY_r3_P_reg			(unsigned int)(unsigned long)(&hd21_aphyp[nport]->r3)//BA9C             
#define HDMIRX_PHY_r4_P_reg			(unsigned int)(unsigned long)(&hd21_aphyp[nport]->r4)//BAA0             
#define HDMIRX_PHY_acdr_r0_P_reg		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_r0)//BAA4        
#define HDMIRX_PHY_acdr_r1_P_reg		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_r1)//BAA8        
#define HDMIRX_PHY_acdr_r2_P_reg		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->acdr_r2)//BAAC        
#define HDMIRX_PHY_rsvd2_P_reg		(unsigned int)(unsigned long)(&hd21_aphyp[nport]->rsvd2)//BAB0          
#define HDMIRX_PHY_ck_cmu_1_P_reg	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->ck_cmu_1)//BAB4      
#define HDMIRX_PHY_ck_cmu_2_P_reg	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->ck_cmu_2)//BAB8       
#define HDMIRX_PHY_ck_cmu_3_P_reg	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->ck_cmu_3)//BABC       
#define HDMIRX_PHY_ck_cmu_4_P_reg	(unsigned int)(unsigned long)(&hd21_aphyp[nport]->ck_cmu_4)//BAC0

#else

#define HDMIRX_PHY_z0k_P_reg     	 	(unsigned int)(&hd21_aphyp[nport]->z0k)//BA04            
#define HDMIRX_PHY_z0pow_P_reg    	(unsigned int)(&hd21_aphyp[nport]->z0pow)//BA08	        
#define HDMIRX_PHY_top_in_0_P_reg 	(unsigned int)(&hd21_aphyp[nport]->top_in_0)//BA10       
#define HDMIRX_PHY_top_in_1_P_reg 	(unsigned int)(&hd21_aphyp[nport]->top_in_1)//BA14	      
#define HDMIRX_PHY_top_in_2_P_reg 	(unsigned int)(&hd21_aphyp[nport]->top_in_2)//BA18	      
#define HDMIRX_PHY_top_out_0_P_reg 	(unsigned int)(&hd21_aphyp[nport]->top_out_0)//BA20      
#define HDMIRX_PHY_top_out_1_P_reg 	(unsigned int)(&hd21_aphyp[nport]->top_out_1)//BA24       
#define HDMIRX_PHY_rsvd0_P_reg    		(unsigned int)(&hd21_aphyp[nport]->rsvd0)//BA28          
#define HDMIRX_PHY_rsvd1_P_reg		(unsigned int)(&hd21_aphyp[nport]->rsvd1)//BA2C          
#define HDMIRX_PHY_ck0_P_reg			(unsigned int)(&hd21_aphyp[nport]->ck0)//BA30             
#define HDMIRX_PHY_ck1_P_reg			(unsigned int)(&hd21_aphyp[nport]->ck1)//BA34             
#define HDMIRX_PHY_ck2_P_reg 		(unsigned int)(&hd21_aphyp[nport]->ck2)//BA38             
#define HDMIRX_PHY_ck3_P_reg 		(unsigned int)(&hd21_aphyp[nport]->ck3)//BA3C             
#define HDMIRX_PHY_ck4_P_reg			(unsigned int)(&hd21_aphyp[nport]->ck4)//BA40             
#define HDMIRX_PHY_acdr_ck0_P_reg	 (unsigned int)(&hd21_aphyp[nport]->acdr_ck0)//BA44       
#define HDMIRX_PHY_acdr_ck1_P_reg	 (unsigned int)(&hd21_aphyp[nport]->acdr_ck1)//BA48       
#define HDMIRX_PHY_acdr_ck2_P_reg 	(unsigned int)(&hd21_aphyp[nport]->acdr_ck2)//BA4C       
#define HDMIRX_PHY_b0_P_reg       		(unsigned int)(&hd21_aphyp[nport]->b0)//BA50             
#define HDMIRX_PHY_b1_P_reg       		(unsigned int)(&hd21_aphyp[nport]->b1)//BA54             
#define HDMIRX_PHY_b2_P_reg       		(unsigned int)(&hd21_aphyp[nport]->b2)//BA58             
#define HDMIRX_PHY_b3_P_reg       		(unsigned int)(&hd21_aphyp[nport]->b3)//BA5C             
#define HDMIRX_PHY_b4_P_reg      		 (unsigned int)(&hd21_aphyp[nport]->b4)//DA60             
#define HDMIRX_PHY_acdr_b0_P_reg  	(unsigned int)(&hd21_aphyp[nport]->acdr_b0)//BA64        
#define HDMIRX_PHY_acdr_b1_P_reg  	(unsigned int)(&hd21_aphyp[nport]->acdr_b1)//BA68        
#define HDMIRX_PHY_acdr_b2_P_reg 	 (unsigned int)(&hd21_aphyp[nport]->acdr_b2)//BA6C        
#define HDMIRX_PHY_g0_P_reg       		(unsigned int)(&hd21_aphyp[nport]->g0)//BA70             
#define HDMIRX_PHY_g1_P_reg       		(unsigned int)(&hd21_aphyp[nport]->g1)//BA74             
#define HDMIRX_PHY_g2_P_reg      		(unsigned int)(&hd21_aphyp[nport]->g2)//BA78             
#define HDMIRX_PHY_g3_P_reg       		(unsigned int)(&hd21_aphyp[nport]->g3)//BA7C             
#define HDMIRX_PHY_g4_P_reg			(unsigned int)(&hd21_aphyp[nport]->g4)//BA80             
#define HDMIRX_PHY_acdr_g0_P_reg  	(unsigned int)(&hd21_aphyp[nport]->acdr_g0)//BA84        
#define HDMIRX_PHY_acdr_g1_P_reg		(unsigned int)(&hd21_aphyp[nport]->acdr_g1)//BA88        
#define HDMIRX_PHY_acdr_g2_P_reg		(unsigned int)(&hd21_aphyp[nport]->acdr_g2)//BA8C        
#define HDMIRX_PHY_r0_P_reg			(unsigned int)(&hd21_aphyp[nport]->r0)//BA90             
#define HDMIRX_PHY_r1_P_reg			(unsigned int)(&hd21_aphyp[nport]->r1)//BA94             
#define HDMIRX_PHY_r2_P_reg			(unsigned int)(&hd21_aphyp[nport]->r2)//BA98             
#define HDMIRX_PHY_r3_P_reg			(unsigned int)(&hd21_aphyp[nport]->r3)//BA9C             
#define HDMIRX_PHY_r4_P_reg			(unsigned int)(&hd21_aphyp[nport]->r4)//BAA0             
#define HDMIRX_PHY_acdr_r0_P_reg		(unsigned int)(&hd21_aphyp[nport]->acdr_r0)//BAA4        
#define HDMIRX_PHY_acdr_r1_P_reg		(unsigned int)(&hd21_aphyp[nport]->acdr_r1)//BAA8        
#define HDMIRX_PHY_acdr_r2_P_reg		(unsigned int)(&hd21_aphyp[nport]->acdr_r2)//BAAC        
#define HDMIRX_PHY_rsvd2_P_reg		(unsigned int)(&hd21_aphyp[nport]->rsvd2)//BAB0          
#define HDMIRX_PHY_ck_cmu_1_P_reg	(unsigned int)(&hd21_aphyp[nport]->ck_cmu_1)//BAB4      
#define HDMIRX_PHY_ck_cmu_2_P_reg	(unsigned int)(&hd21_aphyp[nport]->ck_cmu_2)//BAB8       
#define HDMIRX_PHY_ck_cmu_3_P_reg	(unsigned int)(&hd21_aphyp[nport]->ck_cmu_3)//BABC       
#define HDMIRX_PHY_ck_cmu_4_P_reg	(unsigned int)(&hd21_aphyp[nport]->ck_cmu_4)//BAC0
#endif
...
//Merlin8p
extern const struct hdmi21_aphy_rstb_reg_st *hd21_aphy_rstbp[4];

#define HDMIRX_PHY_rega00	(unsigned int)(unsigned long)(&hd21_aphy_rstb[nport]->rega00)//BAFC	      

//Merlin8p
#define HDMIRX_PHY_P_rega00	(unsigned int)(unsigned long)(&hd21_aphy_rstbp[nport]->rega00)//BAFC	      
...
//Merlin8p
extern const struct hdmi21_dphy_reg_st *hd21_dphyp[4];
...
#ifdef CONFIG_ARM64
#define HDMIRX_PHY_cdr_P_regd00				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd00)//BB00         
#define HDMIRX_PHY_cdr_P_regd01				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd01)//BB04         
#define HDMIRX_PHY_cdr_P_regd02				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd02)//BB08         
#define HDMIRX_PHY_cdr_P_regd03				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd03)//BB0C         
#define HDMIRX_PHY_cdr_P_regd04				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd04)//BB10         
#define HDMIRX_PHY_cdr_P_regd05				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd05)//BB14         
#define HDMIRX_PHY_cdr_P_regd06				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd06)//BB18         
#define HDMIRX_PHY_cdr_P_regd07				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd07)//BB1C         
#define HDMIRX_PHY_cdr_P_regd08				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd08)//BB20         
#define HDMIRX_PHY_cdr_P_regd09				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd09)//BB24         
#define HDMIRX_PHY_cdr_P_regd10				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd10)//BB28         
#define HDMIRX_PHY_cdr_P_regd11				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd11)//BB2C         
#define HDMIRX_PHY_cdr_P_regd12				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd12)//BB30         
#define HDMIRX_PHY_cdr_P_regd13				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd13)//BB34         
#define HDMIRX_PHY_cdr_P_regd14				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd14)//BB38         
#define HDMIRX_PHY_cdr_P_regd15				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->cdr_regd15)//BB3C         
#define HDMIRX_PHY_clk_P_regd00				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->clk_regd00)//BB40         
//KOFF B                                                                                            
#define HDMIRX_PHY_koff_P_regd00				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd00)//BB44        
#define HDMIRX_PHY_koff_P_regd01				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd01)//BB48        
#define HDMIRX_PHY_koff_P_regd02				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd02)//BB4C        
#define HDMIRX_PHY_koff_P_regd03				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd03)//BB50        
 //KOFF G                                                                                           
#define HDMIRX_PHY_koff_P_regd04				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd04)//BB54        
#define HDMIRX_PHY_koff_P_regd05				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd05)//BB58        
#define HDMIRX_PHY_koff_P_regd06				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd06)//BB5C        
#define HDMIRX_PHY_koff_P_regd07				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd07)//BB60        
 //KOFF R                                                                                           
#define HDMIRX_PHY_koff_P_regd08				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd08)//BB64        
#define HDMIRX_PHY_koff_P_regd09				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd09)//BB68        
#define HDMIRX_PHY_koff_P_regd10				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd10)//BB6C        
#define HDMIRX_PHY_koff_P_regd11				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd11)//BB70        
 //KOFF CK                                                                                           
#define HDMIRX_PHY_koff_P_regd12				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd12)//BB74        
#define HDMIRX_PHY_koff_P_regd13				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd13)//BB78        
#define HDMIRX_PHY_koff_P_regd14				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd14)//BB7C         
#define HDMIRX_PHY_koff_P_regd15				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd15)//BB80         
                                                                                            
#define HDMIRX_PHY_koff_P_regd16				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->koff_regd16)//BB84         
#define HDMIRX_PHY_data_P_regd00				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd00)//BB88         
#define HDMIRX_PHY_data_P_regd01				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd01)//BB8C         
#define HDMIRX_PHY_data_P_regd02				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd02)//BB90         
#define HDMIRX_PHY_data_P_regd03				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd03)//BB94         
                                                                                            
#define HDMIRX_PHY_data_P_regd04				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd04)//BB98         
                           
#define HDMIRX_PHY_data_P_regd05				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd05)//BB9C        
#define HDMIRX_PHY_data_P_regd06				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd06)//BBA0        
#define HDMIRX_PHY_data_P_regd07				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd07)//BBA4        
#define HDMIRX_PHY_data_P_regd08				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd08)//BBA8        
#define HDMIRX_PHY_data_P_regd09				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd09)//BBC        
#define HDMIRX_PHY_data_P_regd10				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->data_regd10)//BBB0        
#define HDMIRX_PHY_rsvd4_P					(unsigned int)(unsigned long)(&hd21_dphyp[nport]->rsvd4)//BBB4                    
 //FLD_B                                                                                            
#define HDMIRX_PHY_fld_P_regd00				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd00)//BBB8          
#define HDMIRX_PHY_fld_P_regd01				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd01)//BBBC          
#define HDMIRX_PHY_fld_P_regd02				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd02)//BBC0          
#define HDMIRX_PHY_fld_P_regd03				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd03)//BBC4          
#define HDMIRX_PHY_fld_P_regd04				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd04)//BBC8          
#define HDMIRX_PHY_fld_P_regd05				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd05)//BBCC          
#define HDMIRX_PHY_fld_P_regd06				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd06)//BBD0          
                                                                                            
#define HDMIRX_PHY_rsvd5_P					(unsigned int)(unsigned long)(&hd21_dphyp[nport]->rsvd5)//BBD4                    
 //FLD_G                                                                                           
#define HDMIRX_PHY_fld_P_regd07				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd07)//BBD8          
#define HDMIRX_PHY_fld_P_regd08				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd08)//BBDC          
#define HDMIRX_PHY_fld_P_regd09				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd09)//BBE0		      
#define HDMIRX_PHY_fld_P_regd10				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd10)//BBE4		      
#define HDMIRX_PHY_fld_P_regd11				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd11)//BBE8		      
#define HDMIRX_PHY_fld_P_regd12				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd12)//BBEC		      
#define HDMIRX_PHY_fld_P_regd13				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd13)//BBF0		      
 //FLD_R                                                                                            
#define HDMIRX_PHY_fld_P_regd14				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd14)//BBF4          
#define HDMIRX_PHY_fld_P_regd15				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd15)//BBF8		      
#define HDMIRX_PHY_fld_P_regd16				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd16)//BBFC		      
#define HDMIRX_PHY_fld_P_regd17				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd17)//BC00          
#define HDMIRX_PHY_fld_P_regd18				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd18)//BC004		      
#define HDMIRX_PHY_fld_P_regd19				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd19)//BC008		      
#define HDMIRX_PHY_fld_P_regd20				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd20)//BC00C		      
 //FLD_CK                                                                                           
#define HDMIRX_PHY_fld_P_regd21				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd21)//BC010		      
#define HDMIRX_PHY_fld_P_regd22				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd22)//BC014		      
#define HDMIRX_PHY_fld_P_regd23				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd23)//BC018		      
#define HDMIRX_PHY_fld_P_regd24				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd24)//BC01C		      
#define HDMIRX_PHY_fld_P_regd25				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd25)//BC020		      
#define HDMIRX_PHY_fld_P_regd26				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd26)//BC024          
#define HDMIRX_PHY_fld_P_regd27				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->fld_regd27)//BC028          
                                                                                            
#define HDMIRX_PHY_mod_P_regd00				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->mod_regd00)//BC02C	        
#define HDMIRX_PHY_mod_P_regd01				(unsigned int)(unsigned long)(&hd21_dphyp[nport]->mod_regd01)//BC030	        
#define HDMIRX_PHY_pllcdr_P_regd00			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd00)//BC034	  
#define HDMIRX_PHY_pllcdr_P_regd01			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd01)//BC038	  
                                                                                            
#define HDMIRX_PHY_pllcdr_P_regd02			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd02)//BC03C	  
#define HDMIRX_PHY_pllcdr_P_regd03			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd03)//BC040    
#define HDMIRX_PHY_pllcdr_P_regd04			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd04)//BC044    
                                                                                            
#define HDMIRX_PHY_pllcdr_P_regd05			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd05)//BC048    
#define HDMIRX_PHY_pllcdr_P_regd06			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd06)//BC04C    
#define HDMIRX_PHY_pllcdr_P_regd07			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd07)//BC050    
                                                                                            
#define HDMIRX_PHY_pllcdr_P_regd08			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd08)//BC054    
#define HDMIRX_PHY_pllcdr_P_regd09			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd09)//BC058    
#define HDMIRX_PHY_pllcdr_P_regd10			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd10)//BC05C    
                                                                                            
#define HDMIRX_PHY_pllcdr_P_regd11			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd11)//BC060    
#define HDMIRX_PHY_pllcdr_P_regd12			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd12)//BC064    
#define HDMIRX_PHY_pllcdr_P_regd13			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->pllcdr_regd13)//BC068    
                                                                                            
#define HDMIRX_PHY_psave_P_regd00			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->psave_regd00)//BC06C      
#define HDMIRX_PHY_dfe_P_regd00			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->dfe_regd00)//BC070          
#define HDMIRX_PHY_dfe_P_regd01			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->dfe_regd01)//BC074          
#define HDMIRX_PHY_dfe_P_regd02			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->dfe_regd02)//BC078          
#define HDMIRX_PHY_misc_P_regd00			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->misc_regd00)//BC07C        
#define HDMIRX_PHY_misc_P_regd01			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->misc_regd01)//BC080        
#define HDMIRX_PHY_misc_P_regd02			(unsigned int)(unsigned long)(&hd21_dphyp[nport]->misc_regd02)//BC084        

#else
                                                                                            
#define HDMIRX_PHY_cdr_P_regd00				(unsigned int)(&hd21_dphyp[nport]->cdr_regd00)//BB00         
#define HDMIRX_PHY_cdr_P_regd01				(unsigned int)(&hd21_dphyp[nport]->cdr_regd01)//BB04         
#define HDMIRX_PHY_cdr_P_regd02				(unsigned int)(&hd21_dphyp[nport]->cdr_regd02)//BB08         
#define HDMIRX_PHY_cdr_P_regd03				(unsigned int)(&hd21_dphyp[nport]->cdr_regd03)//BB0C         
#define HDMIRX_PHY_cdr_P_regd04				(unsigned int)(&hd21_dphyp[nport]->cdr_regd04)//BB10         
#define HDMIRX_PHY_cdr_P_regd05				(unsigned int)(&hd21_dphyp[nport]->cdr_regd05)//BB14         
#define HDMIRX_PHY_cdr_P_regd06				(unsigned int)(&hd21_dphyp[nport]->cdr_regd06)//BB18         
#define HDMIRX_PHY_cdr_P_regd07				(unsigned int)(&hd21_dphyp[nport]->cdr_regd07)//BB1C         
#define HDMIRX_PHY_cdr_P_regd08				(unsigned int)(&hd21_dphyp[nport]->cdr_regd08)//BB20         
#define HDMIRX_PHY_cdr_P_regd09				(unsigned int)(&hd21_dphyp[nport]->cdr_regd09)//BB24         
#define HDMIRX_PHY_cdr_P_regd10				(unsigned int)(&hd21_dphyp[nport]->cdr_regd10)//BB28         
#define HDMIRX_PHY_cdr_P_regd11				(unsigned int)(&hd21_dphyp[nport]->cdr_regd11)//BB2C         
#define HDMIRX_PHY_cdr_P_regd12				(unsigned int)(&hd21_dphyp[nport]->cdr_regd12)//BB30         
#define HDMIRX_PHY_cdr_P_regd13				(unsigned int)(&hd21_dphyp[nport]->cdr_regd13)//BB34         
#define HDMIRX_PHY_cdr_P_regd14				(unsigned int)(&hd21_dphyp[nport]->cdr_regd14)//BB38         
#define HDMIRX_PHY_cdr_P_regd15				(unsigned int)(&hd21_dphyp[nport]->cdr_regd15)//BB3C         
#define HDMIRX_PHY_clk_P_regd00				(unsigned int)(&hd21_dphyp[nport]->clk_regd00)//BB40         
//KOFF B                                                                                            
#define HDMIRX_PHY_koff_P_regd00				(unsigned int)(&hd21_dphyp[nport]->koff_regd00)//BB44        
#define HDMIRX_PHY_koff_P_regd01				(unsigned int)(&hd21_dphyp[nport]->koff_regd01)//BB48        
#define HDMIRX_PHY_koff_P_regd02				(unsigned int)(&hd21_dphyp[nport]->koff_regd02)//BB4C        
#define HDMIRX_PHY_koff_P_regd03				(unsigned int)(&hd21_dphyp[nport]->koff_regd03)//BB50        
 //KOFF G                                                                                           
#define HDMIRX_PHY_koff_P_regd04				(unsigned int)(&hd21_dphyp[nport]->koff_regd04)//BB54        
#define HDMIRX_PHY_koff_P_regd05				(unsigned int)(&hd21_dphyp[nport]->koff_regd05)//BB58        
#define HDMIRX_PHY_koff_P_regd06				(unsigned int)(&hd21_dphyp[nport]->koff_regd06)//BB5C        
#define HDMIRX_PHY_koff_P_regd07				(unsigned int)(&hd21_dphyp[nport]->koff_regd07)//BB60        
 //KOFF R                                                                                           
#define HDMIRX_PHY_koff_P_regd08				(unsigned int)(&hd21_dphyp[nport]->koff_regd08)//BB64        
#define HDMIRX_PHY_koff_P_regd09				(unsigned int)(&hd21_dphyp[nport]->koff_regd09)//BB68        
#define HDMIRX_PHY_koff_P_regd10				(unsigned int)(&hd21_dphyp[nport]->koff_regd10)//BB6C        
#define HDMIRX_PHY_koff_P_regd11				(unsigned int)(&hd21_dphyp[nport]->koff_regd11)//BB70        
 //KOFF CK                                                                                           
#define HDMIRX_PHY_koff_P_regd12				(unsigned int)(&hd21_dphyp[nport]->koff_regd12)//BB74        
#define HDMIRX_PHY_koff_P_regd13				(unsigned int)(&hd21_dphyp[nport]->koff_regd13)//BB78        
#define HDMIRX_PHY_koff_P_regd14				(unsigned int)(&hd21_dphyp[nport]->koff_regd14)//BB7C         
#define HDMIRX_PHY_koff_P_regd15				(unsigned int)(&hd21_dphyp[nport]->koff_regd15)//BB80         
                                                                                            
#define HDMIRX_PHY_koff_P_regd16				(unsigned int)(&hd21_dphyp[nport]->koff_regd16)//BB84         
#define HDMIRX_PHY_data_P_regd00				(unsigned int)(&hd21_dphyp[nport]->data_regd00)//BB88         
#define HDMIRX_PHY_data_P_regd01				(unsigned int)(&hd21_dphyp[nport]->data_regd01)//BB8C         
#define HDMIRX_PHY_data_P_regd02				(unsigned int)(&hd21_dphyp[nport]->data_regd02)//BB90         
#define HDMIRX_PHY_data_P_regd03				(unsigned int)(&hd21_dphyp[nport]->data_regd03)//BB94         
                                                                                            
#define HDMIRX_PHY_data_P_regd04				(unsigned int)(&hd21_dphyp[nport]->data_regd04)//BB98         
                           
#define HDMIRX_PHY_data_P_regd05				(unsigned int)(&hd21_dphyp[nport]->data_regd05)//BB9C        
#define HDMIRX_PHY_data_P_regd06				(unsigned int)(&hd21_dphyp[nport]->data_regd06)//BBA0        
#define HDMIRX_PHY_data_P_regd07				(unsigned int)(&hd21_dphyp[nport]->data_regd07)//BBA4        
#define HDMIRX_PHY_data_P_regd08				(unsigned int)(&hd21_dphyp[nport]->data_regd08)//BBA8        
#define HDMIRX_PHY_data_P_regd09				(unsigned int)(&hd21_dphyp[nport]->data_regd09)//BBC        
#define HDMIRX_PHY_data_P_regd10				(unsigned int)(&hd21_dphyp[nport]->data_regd10)//BBB0        
#define HDMIRX_PHY_rsvd4_P					(unsigned int)(&hd21_dphyp[nport]->rsvd4)//BBB4                    
 //FLD_B                                                                                            
#define HDMIRX_PHY_fld_P_regd00				(unsigned int)(&hd21_dphyp[nport]->fld_regd00)//BBB8          
#define HDMIRX_PHY_fld_P_regd01				(unsigned int)(&hd21_dphyp[nport]->fld_regd01)//BBBC          
#define HDMIRX_PHY_fld_P_regd02				(unsigned int)(&hd21_dphyp[nport]->fld_regd02)//BBC0          
#define HDMIRX_PHY_fld_P_regd03				(unsigned int)(&hd21_dphyp[nport]->fld_regd03)//BBC4          
#define HDMIRX_PHY_fld_P_regd04				(unsigned int)(&hd21_dphyp[nport]->fld_regd04)//BBC8          
#define HDMIRX_PHY_fld_P_regd05				(unsigned int)(&hd21_dphyp[nport]->fld_regd05)//BBCC          
#define HDMIRX_PHY_fld_P_regd06				(unsigned int)(&hd21_dphyp[nport]->fld_regd06)//BBD0          
                                                                                            
#define HDMIRX_PHY_rsvd5_P					(unsigned int)(&hd21_dphyp[nport]->rsvd5)//BBD4                    
 //FLD_G                                                                                           
#define HDMIRX_PHY_fld_P_regd07				(unsigned int)(&hd21_dphyp[nport]->fld_regd07)//BBD8          
#define HDMIRX_PHY_fld_P_regd08				(unsigned int)(&hd21_dphyp[nport]->fld_regd08)//BBDC          
#define HDMIRX_PHY_fld_P_regd09				(unsigned int)(&hd21_dphyp[nport]->fld_regd09)//BBE0		      
#define HDMIRX_PHY_fld_P_regd10				(unsigned int)(&hd21_dphyp[nport]->fld_regd10)//BBE4		      
#define HDMIRX_PHY_fld_P_regd11				(unsigned int)(&hd21_dphyp[nport]->fld_regd11)//BBE8		      
#define HDMIRX_PHY_fld_P_regd12				(unsigned int)(&hd21_dphyp[nport]->fld_regd12)//BBEC		      
#define HDMIRX_PHY_fld_P_regd13				(unsigned int)(&hd21_dphyp[nport]->fld_regd13)//BBF0		      
 //FLD_R                                                                                            
#define HDMIRX_PHY_fld_P_regd14				(unsigned int)(&hd21_dphyp[nport]->fld_regd14)//BBF4          
#define HDMIRX_PHY_fld_P_regd15				(unsigned int)(&hd21_dphyp[nport]->fld_regd15)//BBF8		      
#define HDMIRX_PHY_fld_P_regd16				(unsigned int)(&hd21_dphyp[nport]->fld_regd16)//BBFC		      
#define HDMIRX_PHY_fld_P_regd17				(unsigned int)(&hd21_dphyp[nport]->fld_regd17)//BC00          
#define HDMIRX_PHY_fld_P_regd18				(unsigned int)(&hd21_dphyp[nport]->fld_regd18)//BC004		      
#define HDMIRX_PHY_fld_P_regd19				(unsigned int)(&hd21_dphyp[nport]->fld_regd19)//BC008		      
#define HDMIRX_PHY_fld_P_regd20				(unsigned int)(&hd21_dphyp[nport]->fld_regd20)//BC00C		      
 //FLD_CK                                                                                           
#define HDMIRX_PHY_fld_P_regd21				(unsigned int)(&hd21_dphyp[nport]->fld_regd21)//BC010		      
#define HDMIRX_PHY_fld_P_regd22				(unsigned int)(&hd21_dphyp[nport]->fld_regd22)//BC014		      
#define HDMIRX_PHY_fld_P_regd23				(unsigned int)(&hd21_dphyp[nport]->fld_regd23)//BC018		      
#define HDMIRX_PHY_fld_P_regd24				(unsigned int)(&hd21_dphyp[nport]->fld_regd24)//BC01C		      
#define HDMIRX_PHY_fld_P_regd25				(unsigned int)(&hd21_dphyp[nport]->fld_regd25)//BC020		      
#define HDMIRX_PHY_fld_P_regd26				(unsigned int)(&hd21_dphyp[nport]->fld_regd26)//BC024          
#define HDMIRX_PHY_fld_P_regd27				(unsigned int)(&hd21_dphyp[nport]->fld_regd27)//BC028          
                                                                                            
#define HDMIRX_PHY_mod_P_regd00				(unsigned int)(&hd21_dphyp[nport]->mod_regd00)//BC02C	        
#define HDMIRX_PHY_mod_P_regd01				(unsigned int)(&hd21_dphyp[nport]->mod_regd01)//BC030	        
#define HDMIRX_PHY_pllcdr_P_regd00			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd00)//BC034	  
#define HDMIRX_PHY_pllcdr_P_regd01			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd01)//BC038	  
                                                                                            
#define HDMIRX_PHY_pllcdr_P_regd02			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd02)//BC03C	  
#define HDMIRX_PHY_pllcdr_P_regd03			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd03)//BC040    
#define HDMIRX_PHY_pllcdr_P_regd04			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd04)//BC044    
                                                                                            
#define HDMIRX_PHY_pllcdr_P_regd05			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd05)//BC048    
#define HDMIRX_PHY_pllcdr_P_regd06			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd06)//BC04C    
#define HDMIRX_PHY_pllcdr_P_regd07			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd07)//BC050    
                                                                                            
#define HDMIRX_PHY_pllcdr_P_regd08			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd08)//BC054    
#define HDMIRX_PHY_pllcdr_P_regd09			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd09)//BC058    
#define HDMIRX_PHY_pllcdr_P_regd10			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd10)//BC05C    
                                                                                            
#define HDMIRX_PHY_pllcdr_P_regd11			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd11)//BC060    
#define HDMIRX_PHY_pllcdr_P_regd12			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd12)//BC064    
#define HDMIRX_PHY_pllcdr_P_regd13			(unsigned int)(&hd21_dphyp[nport]->pllcdr_regd13)//BC068    
                                                                                            
#define HDMIRX_PHY_psave_P_regd00			(unsigned int)(&hd21_dphyp[nport]->psave_regd00)//BC06C      
#define HDMIRX_PHY_dfe_P_regd00			(unsigned int)(&hd21_dphyp[nport]->dfe_regd00)//BC070          
#define HDMIRX_PHY_dfe_P_regd01			(unsigned int)(&hd21_dphyp[nport]->dfe_regd01)//BC074          
#define HDMIRX_PHY_dfe_P_regd02			(unsigned int)(&hd21_dphyp[nport]->dfe_regd02)//BC078          
#define HDMIRX_PHY_misc_P_regd00			(unsigned int)(&hd21_dphyp[nport]->misc_regd00)//BC07C        
#define HDMIRX_PHY_misc_P_regd01			(unsigned int)(&hd21_dphyp[nport]->misc_regd01)//BC080        
#define HDMIRX_PHY_misc_P_regd02			(unsigned int)(&hd21_dphyp[nport]->misc_regd02)//BC084        
#endif
...
//Merlin8
#define  HDMIRX_PHY_ADPHY_REG4_P0_reg                                               0xB800DD10
#define  HDMIRX_PHY_ADPHY_REG4_P1_reg                                               0xB803BD10

//Merlin8p
#define  HDMIRX_PHY_ADPHY_REG4_P0_P_reg                                           0xB80B4510
#define  HDMIRX_PHY_ADPHY_REG4_P1_P_reg                                            0xB80B4D10
