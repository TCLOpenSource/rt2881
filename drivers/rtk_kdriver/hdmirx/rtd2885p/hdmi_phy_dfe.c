...
void lib_hdmi_set_dfe_close(unsigned char nport,unsigned char lane_mode)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		hdmi_mask(REG_DFE_CTRL_BA_P_reg,~(REG_dfe_adapt_en_TAP0|REG_dfe_adapt_en_TAP1|REG_dfe_adapt_en_TAP2|REG_dfe_adapt_en_TAP3|REG_dfe_adapt_en_TAP4),0);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,~(REG_dfe_adapt_en_LE),0);
		hdmi_mask(REG_DFE_CTRL_B2_P_reg,~(REG_dfe_adapt_en_VTH_DFE_EN|REG_dfe_adapt_en_VTH_EN),0);

		hdmi_mask(REG_DFE_CTRL_GA_P_reg,~(REG_dfe_adapt_en_TAP0|REG_dfe_adapt_en_TAP1|REG_dfe_adapt_en_TAP2|REG_dfe_adapt_en_TAP3|REG_dfe_adapt_en_TAP4),0);
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(REG_dfe_adapt_en_LE),0);
		hdmi_mask(REG_DFE_CTRL_G2_P_reg,~(REG_dfe_adapt_en_VTH_DFE_EN|REG_dfe_adapt_en_VTH_EN),0);

		hdmi_mask(REG_DFE_CTRL_RA_P_reg,~(REG_dfe_adapt_en_TAP0|REG_dfe_adapt_en_TAP1|REG_dfe_adapt_en_TAP2|REG_dfe_adapt_en_TAP3|REG_dfe_adapt_en_TAP4),0);
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,~(REG_dfe_adapt_en_LE),0);
		hdmi_mask(REG_DFE_CTRL_R2_P_reg,~(REG_dfe_adapt_en_VTH_DFE_EN|REG_dfe_adapt_en_VTH_EN),0);

		if (lane_mode == HDMI_4LANE)
		{
			hdmi_mask(REG_DFE_CTRL_CKA_P_reg,~(REG_dfe_adapt_en_TAP0|REG_dfe_adapt_en_TAP1|REG_dfe_adapt_en_TAP2|REG_dfe_adapt_en_TAP3|REG_dfe_adapt_en_TAP4),0);
			hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(REG_dfe_adapt_en_LE),0);
			hdmi_mask(REG_DFE_CTRL_CK2_P_reg,~(REG_dfe_adapt_en_VTH_DFE_EN|REG_dfe_adapt_en_VTH_EN),0);

		}
	//Stop limit value record
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,~(DFE_P0_REG_DFE_CTRL_B3_P0_timer_en_b_mask),DFE_P0_REG_DFE_CTRL_B3_P0_recorder_limit_en_b(0));
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_timer_en_g_mask),DFE_P0_REG_DFE_CTRL_G3_P0_recorder_limit_en_g(0));
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,~(DFE_P0_REG_DFE_CTRL_R3_P0_timer_en_r_mask),DFE_P0_REG_DFE_CTRL_R3_P0_recorder_limit_en_r(0));
		if (lane_mode == HDMI_4LANE)
		{
			hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_timer_en_ck_mask),DFE_P0_REG_DFE_CTRL_CK3_P0_recorder_limit_en_ck(0));
		}
...
void lib_hdmi_dfe_record_enable(unsigned char nport, unsigned char onoff)
{
	...
	{
	        //merlin8p IC , run merlin8p flow
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,~(DFE_P0_REG_DFE_CTRL_B3_P0_timer_en_b_mask),DFE_P0_REG_DFE_CTRL_B3_P0_recorder_limit_en_b(onoff));
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_timer_en_g_mask),DFE_P0_REG_DFE_CTRL_G3_P0_recorder_limit_en_g(onoff));
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,~(DFE_P0_REG_DFE_CTRL_R3_P0_timer_en_r_mask),DFE_P0_REG_DFE_CTRL_R3_P0_recorder_limit_en_r(onoff));
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_timer_en_ck_mask),DFE_P0_REG_DFE_CTRL_CK3_P0_recorder_limit_en_ck(onoff));
	}
}
...
unsigned char lib_hdmi_dfe_is_record_enable(unsigned char nport)
{
	...
	{
		        //merlin8p IC , run merlin8p flow
		return DFE_P0_REG_DFE_CTRL_B3_P0_get_recorder_limit_en_b(hdmi_in(REG_DFE_CTRL_B3_P_reg));
	}
}
...
void lib_hdmi_dfe_init_vth(unsigned char nport, unsigned char bgrc, unsigned char value)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		        //merlin8p IC , run merlin8p flow
		if (bgrc&LN_CK) {
		hdmi_mask(REG_DFE_CTRL_CKA_P_reg,~(DFE_P0_REG_DFE_CTRL_CKA_P0_vthp_init_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CKA_P0_vthp_init_ck_4_0(value)));
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_vth_load_in_ck_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_vth_load_in_ck(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_vth_load_in_ck_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_vth_load_in_ck(0)));
		}
		if (bgrc&LN_R) {
		hdmi_mask(REG_DFE_CTRL_RA_P_reg,~(DFE_P0_REG_DFE_CTRL_RA_P0_vthp_init_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_RA_P0_vthp_init_r_4_0(value)));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_vth_load_in_r_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_vth_load_in_r(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_vth_load_in_r_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_vth_load_in_r(0)));
		}
		if (bgrc&LN_G) {
		hdmi_mask(REG_DFE_CTRL_GA_P_reg,~(DFE_P0_REG_DFE_CTRL_GA_P0_vthp_init_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_GA_P0_vthp_init_g_4_0(value)));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_G3_P0_vth_load_in_g_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_vth_load_in_g(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_G3_P0_vth_load_in_g_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_vth_load_in_g(0)));
		}
		if (bgrc&LN_B) {

		hdmi_mask(REG_DFE_CTRL_BA_P_reg,~(DFE_P0_REG_DFE_CTRL_BA_P0_vthp_init_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_BA_P0_vthp_init_b_4_0(value)));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_vth_load_in_b_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_vth_load_in_b(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_vth_load_in_b_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_vth_load_in_b(0)));
...
void lib_hdmi_dfe_init_vthn(unsigned char nport, unsigned char bgrc, unsigned char value)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		        //merlin8p IC , run merlin8p flow
		if (bgrc&LN_CK) {
		hdmi_mask(REG_DFE_CTRL_CKA_P_reg,~(DFE_P0_REG_DFE_CTRL_CKA_P0_vthn_init_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CKA_P0_vthn_init_ck_4_0(value)));
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_vth_load_in_ck_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_vth_load_in_ck(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_vth_load_in_ck_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_vth_load_in_ck(0)));
		}
		if (bgrc&LN_R) {
		hdmi_mask(REG_DFE_CTRL_RA_P_reg,~(DFE_P0_REG_DFE_CTRL_RA_P0_vthn_init_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_RA_P0_vthn_init_r_4_0(value)));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_vth_load_in_r_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_vth_load_in_r(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_G3_P0_vth_load_in_g_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_vth_load_in_r(0)));
		}
		if (bgrc&LN_G) {
		hdmi_mask(REG_DFE_CTRL_GA_P_reg,~(DFE_P0_REG_DFE_CTRL_GA_P0_vthn_init_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_GA_P0_vthn_init_g_4_0(value)));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_G3_P0_vth_load_in_g_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_vth_load_in_g(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_G3_P0_vth_load_in_g_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_vth_load_in_g(0)));
		}
		...
		hdmi_mask(REG_DFE_CTRL_BA_P_reg,~(DFE_P0_REG_DFE_CTRL_BA_P0_vthn_init_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_BA_P0_vthn_init_b_4_0(value)));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_vth_load_in_b_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_vth_load_in_b(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_vth_load_in_b_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_vth_load_in_b(0)));
		}
...
void lib_hdmi_dfe_init_tap0(unsigned char nport, unsigned char bgrc, unsigned char value)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		        //merlin8p IC , run merlin8p flow
		if (bgrc&LN_CK) {
		hdmi_mask(REG_DFE_CTRL_CK9_P_reg,~(DFE_P0_REG_DFE_CTRL_CK9_P0_tap0_init_ck_7_0_mask), (DFE_P0_REG_DFE_CTRL_CK9_P0_tap0_init_ck_7_0(value)));
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(LOAD_IN_INIT_TAP0)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(0)));
		}
		if (bgrc&LN_R) {
		hdmi_mask(REG_DFE_CTRL_R9_P_reg,	~(DFE_P0_REG_DFE_CTRL_R9_P0_tap0_init_r_7_0_mask), (DFE_P0_REG_DFE_CTRL_R9_P0_tap0_init_r_7_0(value)));
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(LOAD_IN_INIT_TAP0)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(0)));
		}
		if (bgrc&LN_G) {
		hdmi_mask(REG_DFE_CTRL_G9_P_reg,~(DFE_P0_REG_DFE_CTRL_G9_P0_tap0_init_g_7_0_mask), (DFE_P0_REG_DFE_CTRL_G9_P0_tap0_init_g_7_0(value)));
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(LOAD_IN_INIT_TAP0)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(0)));
		}
		if (bgrc&LN_B) {
		hdmi_mask(REG_DFE_CTRL_B9_P_reg,	~(DFE_P0_REG_DFE_CTRL_B9_P0_tap0_init_b_7_0_mask), (DFE_P0_REG_DFE_CTRL_B9_P0_tap0_init_b_7_0(value)));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(LOAD_IN_INIT_TAP0)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(0)));
		}
...
void lib_hdmi_dfe_init_tap1(unsigned char nport, unsigned char bgrc, signed char value)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if (bgrc&LN_CK) {
			if(value<0)
			{
				hdmi_mask(REG_DFE_CTRL_CKD_P_reg,	~(DFE_P0_REG_DFE_CTRL_CKD_P0_tap1_init_ck_6_mask), (DFE_P0_REG_DFE_CTRL_CKD_P0_tap1_init_ck_6(1)));
				value =-value;
			}
			else
			{
				hdmi_mask(REG_DFE_CTRL_CKD_P_reg,	~(DFE_P0_REG_DFE_CTRL_CKD_P0_tap1_init_ck_6_mask), (DFE_P0_REG_DFE_CTRL_CKD_P0_tap1_init_ck_6(0)));
			}
			hdmi_mask(REG_DFE_CTRL_CK9_P_reg,~(DFE_P0_REG_DFE_CTRL_CK9_P0_tap1_init_ck_5_0_mask), (DFE_P0_REG_DFE_CTRL_CK9_P0_tap1_init_ck_5_0(value)));
			hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(LOAD_IN_INIT_TAP1_P1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(0)));
		}
		if (bgrc&LN_R) {
			if(value<0)
			{
				hdmi_mask(REG_DFE_CTRL_RD_P_reg,	~(DFE_P0_REG_DFE_CTRL_RD_P0_tap1_init_r_6_mask), (DFE_P0_REG_DFE_CTRL_RD_P0_tap1_init_r_6(1)));
				value =-value;
			}
			else
			{
				hdmi_mask(REG_DFE_CTRL_RD_P_reg,	~(DFE_P0_REG_DFE_CTRL_RD_P0_tap1_init_r_6_mask), (DFE_P0_REG_DFE_CTRL_RD_P0_tap1_init_r_6(0)));
			}
			hdmi_mask(REG_DFE_CTRL_R9_P_reg,	~(DFE_P0_REG_DFE_CTRL_R9_P0_tap1_init_r_5_0_mask), (DFE_P0_REG_DFE_CTRL_R9_P0_tap1_init_r_5_0(value)));
			hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(LOAD_IN_INIT_TAP1_P1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(0)));
		}
		if (bgrc&LN_G) {
			if(value<0)
			{
				hdmi_mask(REG_DFE_CTRL_GD_P_reg,	~(DFE_P0_REG_DFE_CTRL_GD_P0_tap1_init_g_6_mask), (DFE_P0_REG_DFE_CTRL_GD_P0_tap1_init_g_6(1)));
				value =-value;
			}
			else
			{
				hdmi_mask(REG_DFE_CTRL_GD_P_reg,	~(DFE_P0_REG_DFE_CTRL_GD_P0_tap1_init_g_6_mask), (DFE_P0_REG_DFE_CTRL_GD_P0_tap1_init_g_6(0)));
			}
				
			hdmi_mask(REG_DFE_CTRL_G9_P_reg,~(DFE_P0_REG_DFE_CTRL_G9_P0_tap1_init_g_5_0_mask), (DFE_P0_REG_DFE_CTRL_G9_P0_tap1_init_g_5_0(value)));
			hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(LOAD_IN_INIT_TAP1_P1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(0)));
		}
		if (bgrc&LN_B) {
			if(value<0)
			{
				hdmi_mask(REG_DFE_CTRL_BD_P_reg,	~(DFE_P0_REG_DFE_CTRL_BD_P0_tap1_init_b_6_mask), (DFE_P0_REG_DFE_CTRL_BD_P0_tap1_init_b_6(1)));
				value =-value;
			}
			else
			{
				hdmi_mask(REG_DFE_CTRL_BD_P_reg,	~(DFE_P0_REG_DFE_CTRL_BD_P0_tap1_init_b_6_mask), (DFE_P0_REG_DFE_CTRL_BD_P0_tap1_init_b_6(0)));
			}
			hdmi_mask(REG_DFE_CTRL_B9_P_reg,	~(DFE_P0_REG_DFE_CTRL_B9_P0_tap1_init_b_5_0_mask), (DFE_P0_REG_DFE_CTRL_B9_P0_tap1_init_b_5_0(value)));
			hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(LOAD_IN_INIT_TAP1_P1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(0)));
...
void lib_hdmi_dfe_init_tap2(unsigned char nport, unsigned char bgrc, signed char value)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		       //merlin8p IC , run merlin8p flow
		if (bgrc&LN_CK) {
		hdmi_mask(REG_DFE_CTRL_CK9_P_reg,~(DFE_P0_REG_DFE_CTRL_CK9_P0_tap1_init_ck_5_0_mask), (DFE_P0_REG_DFE_CTRL_CK9_P0_tap2_init_ck_5_0(value)));
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(LOAD_IN_INIT_TAP2_P1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(0)));
		}
		if (bgrc&LN_R) {
		hdmi_mask(REG_DFE_CTRL_R9_P_reg,	~(DFE_P0_REG_DFE_CTRL_R9_P0_tap1_init_r_5_0_mask), (DFE_P0_REG_DFE_CTRL_R9_P0_tap2_init_r_5_0(value)));
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(LOAD_IN_INIT_TAP2_P1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(0)));
		}
		if (bgrc&LN_G) {
		hdmi_mask(REG_DFE_CTRL_G9_P_reg,~(DFE_P0_REG_DFE_CTRL_G9_P0_tap1_init_g_5_0_mask), (DFE_P0_REG_DFE_CTRL_G9_P0_tap2_init_g_5_0(value)));
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(LOAD_IN_INIT_TAP2_P1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(0)));
		}
		if (bgrc&LN_B) {

		hdmi_mask(REG_DFE_CTRL_B9_P_reg,	~(DFE_P0_REG_DFE_CTRL_B9_P0_tap1_init_b_5_0_mask), (DFE_P0_REG_DFE_CTRL_B9_P0_tap2_init_b_5_0(value)));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(LOAD_IN_INIT_TAP2_P1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(0)));
...
void lib_hdmi_dfe_init_le(unsigned char nport, unsigned char bgrc, unsigned char value)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if (bgrc&LN_CK) {
			hdmi_mask(REG_DFE_CTRL_CK8_P_reg,~(DFE_P0_REG_DFE_CTRL_CK8_P0_leq_init_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK8_P0_leq_init_ck_4_0(value)));
			hdmi_mask(REG_DFE_CTRL_CK2_P_reg,~(DFE_P0_REG_DFE_CTRL_CK2_P0_eq_selreg_ck_mask), (DFE_P0_REG_DFE_CTRL_CK2_P0_eq_selreg_ck(1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_CK2_P_reg,~(DFE_P0_REG_DFE_CTRL_CK2_P0_eq_selreg_ck_mask), (DFE_P0_REG_DFE_CTRL_CK2_P0_eq_selreg_ck(0)));
		}

		if (bgrc&LN_R) {
			hdmi_mask(REG_DFE_CTRL_R8_P_reg,	~(DFE_P0_REG_DFE_CTRL_R8_P0_leq_init_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R8_P0_leq_init_r_4_0(value)));
			hdmi_mask(REG_DFE_CTRL_R2_P_reg,	~(DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r_mask), (DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r(1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_R2_P_reg,	~(DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r_mask), (DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r(0)));
		}
		if (bgrc&LN_G) {
			hdmi_mask(REG_DFE_CTRL_G8_P_reg,~(DFE_P0_REG_DFE_CTRL_G8_P0_leq_init_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G8_P0_leq_init_g_4_0(value)));
			hdmi_mask(REG_DFE_CTRL_G2_P_reg,~(DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g_mask), (DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g(1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_G2_P_reg,~(DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g_mask), (DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g(0)));
		}
		if (bgrc&LN_B) {
			hdmi_mask(REG_DFE_CTRL_B8_P_reg,	~(DFE_P0_REG_DFE_CTRL_B8_P0_leq_init_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B8_P0_leq_init_b_4_0(value)));
			//load in
			hdmi_mask(REG_DFE_CTRL_B2_P_reg,	~(DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b_mask), (DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b(1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_B2_P_reg,	~(DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b_mask), (DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b(0)));
		}	
...
unsigned char lib_hdmi_dfe_get_vth(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0(COEF_SEL_VTHP_COEF));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg));
		}
		else if(lane==1)//G
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0(COEF_SEL_VTHP_COEF));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg));
		}
		else if(lane==2)//R
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0(COEF_SEL_VTHP_COEF));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg));
		}
		else if(lane==3)//CK
		{
			hdmi_mask(REG_DFE_CTRL_CK5_P_reg, ~DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0_mask, DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0(COEF_SEL_VTHP_COEF));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_coef_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg));
		}
		return 0;
...
unsigned char lib_hdmi_dfe_get_tap0(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0(COEF_SEL_TAP0));//
			return DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg));
		}
		else if(lane==1)//G
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0(COEF_SEL_TAP0));//
			return DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg));
		}
		else if(lane==2)//R
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0(COEF_SEL_TAP0));//
			return DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg));
		}
		else if(lane==3)//CK
		{
			hdmi_mask(REG_DFE_CTRL_CK5_P_reg, ~DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0_mask, DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0(COEF_SEL_TAP0));//
			return DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_coef_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg));
		}
		return 0;
...
unsigned char lib_hdmi_dfe_get_tap0max(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_limit_sel_b_4_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_limit_sel_b_4_0(LIMIT_SEL_TAP0_MAX));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_limit_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg));
		}
		else if(lane==1)//G
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_limit_sel_g_4_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_limit_sel_g_4_0(LIMIT_SEL_TAP0_MAX));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_limit_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg));
		}
		else if(lane==2)//R
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_limit_sel_r_4_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_limit_sel_r_4_0(LIMIT_SEL_TAP0_MAX));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_limit_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg));
		}
		else if(lane==3)//CK
		{
			hdmi_mask(REG_DFE_CTRL_CK5_P_reg, ~DFE_P0_REG_DFE_CTRL_CK5_P0_limit_sel_ck_4_0_mask, DFE_P0_REG_DFE_CTRL_CK5_P0_limit_sel_ck_4_0(LIMIT_SEL_TAP0_MAX));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_limit_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg));
		}
		return 0;
...
char lib_hdmi_dfe_get_tap1(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0(COEF_SEL_TAP1));//
			return get_TAP1_coef_sign(hdmi_in(REG_DFE_CTRL_BC_reg))? \
					-get_TAP1_coef(DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg))):
					get_TAP1_coef(DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg)));
		}
		...
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0(COEF_SEL_TAP1));//
			return get_TAP1_coef_sign(hdmi_in(REG_DFE_CTRL_GC_reg))? \
					-get_TAP1_coef(DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg))):
					get_TAP1_coef(DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg)));
		...
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0(COEF_SEL_TAP1));//
			return get_TAP1_coef_sign(hdmi_in(REG_DFE_CTRL_RC_reg))? \
					-get_TAP1_coef(DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg))):
					get_TAP1_coef(DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg)));
		...
		{
			hdmi_mask(REG_DFE_CTRL_CK5_P_reg, ~DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0_mask, DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0(COEF_SEL_TAP1));//
			return get_TAP1_coef_sign(hdmi_in(REG_DFE_CTRL_CKC_reg))? \
					-get_TAP1_coef(DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_coef_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg))):
					get_TAP1_coef(DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_coef_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg)));
...
unsigned char lib_hdmi_dfe_get_tap1max(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_limit_sel_b_4_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_limit_sel_b_4_0(LIMIT_SEL_TAP1_MAX));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_limit_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg));
		}
		else if(lane==1)//G
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_limit_sel_g_4_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_limit_sel_g_4_0(LIMIT_SEL_TAP1_MAX));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_limit_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg));
		}
		else if(lane==2)//R
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_limit_sel_r_4_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_limit_sel_r_4_0(LIMIT_SEL_TAP1_MAX));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_limit_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg));
		}
		else if(lane==3)//CK
		{
			hdmi_mask(REG_DFE_CTRL_CK5_P_reg, ~DFE_P0_REG_DFE_CTRL_CK5_P0_limit_sel_ck_4_0_mask, DFE_P0_REG_DFE_CTRL_CK5_P0_limit_sel_ck_4_0(LIMIT_SEL_TAP1_MAX));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_limit_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg));
		}	
		return 0;
...
unsigned char lib_hdmi_dfe_get_tap1min(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_limit_sel_b_4_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_limit_sel_b_4_0(LIMIT_SEL_TAP1_MIN));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_limit_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg));
		}
		else if(lane==1)//G
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_limit_sel_g_4_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_limit_sel_g_4_0(LIMIT_SEL_TAP1_MIN));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_limit_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg));
		}
		else if(lane==2)//R
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_limit_sel_r_4_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_limit_sel_r_4_0(LIMIT_SEL_TAP1_MIN));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_limit_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg));
		}
		else if(lane==3)//CK
		{
			hdmi_mask(REG_DFE_CTRL_CK5_P_reg, ~DFE_P0_REG_DFE_CTRL_CK5_P0_limit_sel_ck_4_0_mask, DFE_P0_REG_DFE_CTRL_CK5_P0_limit_sel_ck_4_0(LIMIT_SEL_TAP1_MIN));//0x0	LIMIT SEL
			return DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_limit_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg));
		}
		return 0;
...
char lib_hdmi_dfe_get_tap2(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0(COEF_SEL_TAP2));//
			return get_TAP2_coef_sign(hdmi_in(REG_DFE_CTRL_BC_reg))? \
					-get_TAP2_coef(DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg))):
					get_TAP2_coef(DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg)));
		}
		...
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0(COEF_SEL_TAP2));//
			return get_TAP2_coef_sign(hdmi_in(REG_DFE_CTRL_GC_reg))? \
					-get_TAP2_coef(DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg))):
					get_TAP2_coef(DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg)));
		...
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0(COEF_SEL_TAP2));//
			return get_TAP2_coef_sign(hdmi_in(REG_DFE_CTRL_RC_reg))? \
					-get_TAP2_coef(DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg))):
					get_TAP2_coef(DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg)));
...
char lib_hdmi_dfe_get_tap3(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0(COEF_SEL_TAP3));//
			return get_TAP3_coef_sign(hdmi_in(REG_DFE_CTRL_BC_reg))? \
				-get_TAP3_coef(DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg))):
				get_TAP3_coef(DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg)));
		...
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0(COEF_SEL_TAP3));//
			return get_TAP3_coef_sign(hdmi_in(REG_DFE_CTRL_GC_reg))? \
				-get_TAP3_coef(DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg))):
				get_TAP3_coef(DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg)));		
		}
		...
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0(COEF_SEL_TAP3));//
			return get_TAP3_coef_sign(hdmi_in(REG_DFE_CTRL_RC_reg))? \
				-get_TAP3_coef(DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg))):
				get_TAP3_coef(DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg)));
		}
		...
		{
			hdmi_mask(REG_DFE_CTRL_CK5_P_reg, ~DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0_mask, DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0(COEF_SEL_TAP3));//
			return get_TAP3_coef_sign(hdmi_in(REG_DFE_CTRL_CKC_reg))? \
				-get_TAP3_coef(DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_coef_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg))):
				get_TAP3_coef(DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_coef_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg)));
		}
...
char lib_hdmi_dfe_get_tap4(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0(COEF_SEL_TAP4));//
			return get_TAP4_coef_sign(hdmi_in(REG_DFE_CTRL_BC_reg))? \
			-get_TAP4_coef(DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg))):
			get_TAP4_coef(DFE_P0_REG_DFE_CTRL_BC_P0_get_dfe_coef_data_ro_b_7_0(hdmi_in(REG_DFE_CTRL_BC_reg)));
		}
		...
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0(COEF_SEL_TAP4));//
			return get_TAP4_coef_sign(hdmi_in(REG_DFE_CTRL_GC_reg))? \
			-get_TAP4_coef(DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg))):
			get_TAP4_coef(DFE_P0_REG_DFE_CTRL_GC_P0_get_dfe_coef_data_ro_g_7_0(hdmi_in(REG_DFE_CTRL_GC_reg)));
		}
		...
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0(COEF_SEL_TAP4));//
			return get_TAP4_coef_sign(hdmi_in(REG_DFE_CTRL_RC_reg))? \
			-get_TAP4_coef(DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg))):
			get_TAP4_coef(DFE_P0_REG_DFE_CTRL_RC_P0_get_dfe_coef_data_ro_r_7_0(hdmi_in(REG_DFE_CTRL_RC_reg)));
		}
		...
		{
			hdmi_mask(REG_DFE_CTRL_CK5_P_reg, ~DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0_mask, DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0(COEF_SEL_TAP4));//
			return get_TAP4_coef_sign(hdmi_in(REG_DFE_CTRL_CKC_reg))? \
			-get_TAP4_coef(DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_coef_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg))):
			get_TAP4_coef(DFE_P0_REG_DFE_CTRL_CKC_P0_get_dfe_coef_data_ro_ck_7_0(hdmi_in(REG_DFE_CTRL_CKC_reg)));
		}
...
unsigned char lib_hdmi_dfe_get_le(unsigned char nport, unsigned char lane)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if(lane==0)//B
		{
			hdmi_mask(REG_DFE_CTRL_B5_P_reg, ~DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0_mask, DFE_P0_REG_DFE_CTRL_B5_P0_debug_sel_b_3_0(COEF_SEL_LE));//
			return rtd_part_inl(REG_DFE_CTRL_BC_reg, 15, 10);
		}
		else if(lane==1)//G
		{
			hdmi_mask(REG_DFE_CTRL_G5_P_reg, ~DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0_mask, DFE_P0_REG_DFE_CTRL_G5_P0_debug_sel_g_3_0(COEF_SEL_LE));//
			return rtd_part_inl(REG_DFE_CTRL_GC_reg, 15, 10);
		}
		else if(lane==2)//R
		{
			hdmi_mask(REG_DFE_CTRL_R5_P_reg, ~DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0_mask, DFE_P0_REG_DFE_CTRL_R5_P0_debug_sel_r_3_0(COEF_SEL_LE));//
			return rtd_part_inl(REG_DFE_CTRL_RC_reg, 15, 10);
		}
		else if(lane==3)//CK
		{
			hdmi_mask(REG_DFE_CTRL_CK5_P_reg, ~DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0_mask, DFE_P0_REG_DFE_CTRL_CK5_P0_debug_sel_ck_3_0(COEF_SEL_LE));//
			return rtd_part_inl(REG_DFE_CTRL_CKC_reg, 15, 10);
		}	
		return 0;
...
void lib_hdmi_dfe_update_le(unsigned char nport, unsigned char eq_ch0, unsigned char eq_ch1, unsigned char eq_ch2)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		{
			if (bgrc&LN_R) {
				hdmi_mask(REG_DFE_CTRL_R8_P_reg,	~(DFE_P0_REG_DFE_CTRL_R8_P0_leq_init_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R8_P0_leq_init_r_4_0(eq_ch2)));
				hdmi_mask(REG_DFE_CTRL_R2_P_reg,	~(DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r_mask), (DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r(1)));
				udelay(1);
				hdmi_mask(REG_DFE_CTRL_R2_P_reg,	~(DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r_mask), (DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r(0)));
			}
			if (bgrc&LN_G) {
				hdmi_mask(REG_DFE_CTRL_G8_P_reg,~(DFE_P0_REG_DFE_CTRL_G8_P0_leq_init_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G8_P0_leq_init_g_4_0(eq_ch1)));
				hdmi_mask(REG_DFE_CTRL_G2_P_reg,~(DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g_mask), (DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g(1)));
				udelay(1);
				hdmi_mask(REG_DFE_CTRL_G2_P_reg,~(DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g_mask), (DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g(0)));
			}
			if (bgrc&LN_B) {
				hdmi_mask(REG_DFE_CTRL_B8_P_reg,	~(DFE_P0_REG_DFE_CTRL_B8_P0_leq_init_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B8_P0_leq_init_b_4_0(eq_ch0)));
				//load in
				hdmi_mask(REG_DFE_CTRL_B2_P_reg,	~(DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b_mask), (DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b(1)));
				udelay(1);
				hdmi_mask(REG_DFE_CTRL_B2_P_reg,	~(DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b_mask), (DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b(0)));
		...
		else if (mode == 3)
		{
			...
			if (bgrc&LN_R) {
			hdmi_mask(REG_DFE_CTRL_R9_P_reg,	~(DFE_P0_REG_DFE_CTRL_R9_P0_tap1_init_r_5_0_mask), (DFE_P0_REG_DFE_CTRL_R9_P0_tap1_init_r_5_0(eq_ch2)));
			hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(LOAD_IN_INIT_TAP1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(0)));
			}
			if (bgrc&LN_G) {
			hdmi_mask(REG_DFE_CTRL_G9_P_reg,~(DFE_P0_REG_DFE_CTRL_G9_P0_tap1_init_g_5_0_mask), (DFE_P0_REG_DFE_CTRL_G9_P0_tap1_init_g_5_0(eq_ch1)));
			hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(LOAD_IN_INIT_TAP1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(0)));
			}
			if (bgrc&LN_B) {

			hdmi_mask(REG_DFE_CTRL_B9_P_reg,	~(DFE_P0_REG_DFE_CTRL_B9_P0_tap1_init_b_5_0_mask), (DFE_P0_REG_DFE_CTRL_B9_P0_tap1_init_b_5_0(eq_ch0)));
			hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(LOAD_IN_INIT_TAP1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(0)));
			}
		}
...
void lib_hdmi_load_tap0_max(unsigned char nport,unsigned char lane_mode)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if (lane_mode == HDMI_4LANE) {
			hdmi_mask(REG_DFE_CTRL_CK9_P_reg,~(DFE_P0_REG_DFE_CTRL_CK9_P0_tap0_init_ck_7_0_mask), (DFE_P0_REG_DFE_CTRL_CK9_P0_tap0_init_ck_7_0(tap0max[3])));
			hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(LOAD_IN_INIT_TAP0)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(0)));
		}

		hdmi_mask(REG_DFE_CTRL_R9_P_reg,	~(DFE_P0_REG_DFE_CTRL_R9_P0_tap0_init_r_7_0_mask), (DFE_P0_REG_DFE_CTRL_R9_P0_tap0_init_r_7_0(tap0max[2])));
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(LOAD_IN_INIT_TAP0)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(0)));

		hdmi_mask(REG_DFE_CTRL_G9_P_reg,~(DFE_P0_REG_DFE_CTRL_G9_P0_tap0_init_g_7_0_mask), (DFE_P0_REG_DFE_CTRL_G9_P0_tap0_init_g_7_0(tap0max[1])));
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(LOAD_IN_INIT_TAP0)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(0)));

		hdmi_mask(REG_DFE_CTRL_B9_P_reg,	~(DFE_P0_REG_DFE_CTRL_B9_P0_tap0_init_b_7_0_mask), (DFE_P0_REG_DFE_CTRL_B9_P0_tap0_init_b_7_0(tap0max[0])));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(LOAD_IN_INIT_TAP0)));
			udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(0)));
...
void lib_hdmi_load_tap1_add(unsigned char nport,unsigned char lane_mode,unsigned char value)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if (lane_mode == HDMI_4LANE) {
		hdmi_mask(REG_DFE_CTRL_CK9_P_reg,~(DFE_P0_REG_DFE_CTRL_CK9_P0_tap1_init_ck_5_0_mask), (DFE_P0_REG_DFE_CTRL_CK9_P0_tap1_init_ck_5_0(tap1[3])));
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(LOAD_IN_INIT_TAP1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_CK3_P_reg,~(DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK3_P0_tap_load_in_ck_4_0(0)));
		}

		hdmi_mask(REG_DFE_CTRL_R9_P_reg,	~(DFE_P0_REG_DFE_CTRL_R9_P0_tap1_init_r_5_0_mask), (DFE_P0_REG_DFE_CTRL_R9_P0_tap1_init_r_5_0(tap1[2])));
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(LOAD_IN_INIT_TAP1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_R3_P_reg,	~(DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R3_P0_tap_load_in_r_4_0(0)));

		hdmi_mask(REG_DFE_CTRL_G9_P_reg,~(DFE_P0_REG_DFE_CTRL_G9_P0_tap1_init_g_5_0_mask), (DFE_P0_REG_DFE_CTRL_G9_P0_tap1_init_g_5_0(tap1[1])));
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(LOAD_IN_INIT_TAP1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_G3_P_reg,~(DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G3_P0_tap_load_in_g_4_0(0)));

		hdmi_mask(REG_DFE_CTRL_B9_P_reg,	~(DFE_P0_REG_DFE_CTRL_B9_P0_tap1_init_b_5_0_mask), (DFE_P0_REG_DFE_CTRL_B9_P0_tap1_init_b_5_0(tap1[0])));
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(LOAD_IN_INIT_TAP1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B3_P_reg,	~(DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B3_P0_tap_load_in_b_4_0(0)));
...
void lib_hdmi_load_le_add(unsigned char nport,unsigned char lane_mode,unsigned char value)
{
	...
	else //if(get_mach_type()==MACH_ARCH_RTK2885P2)||if(get_mach_type()==MACH_ARCH_RTK2885PP
	{
		...
		if (lane_mode == HDMI_4LANE) {
			hdmi_mask(REG_DFE_CTRL_CK8_P_reg,~(DFE_P0_REG_DFE_CTRL_CK8_P0_leq_init_ck_4_0_mask), (DFE_P0_REG_DFE_CTRL_CK8_P0_leq_init_ck_4_0(le[3])));
			hdmi_mask(REG_DFE_CTRL_CK2_P_reg,~(DFE_P0_REG_DFE_CTRL_CK2_P0_eq_selreg_ck_mask), (DFE_P0_REG_DFE_CTRL_CK2_P0_eq_selreg_ck(1)));
			udelay(1);
			hdmi_mask(REG_DFE_CTRL_CK2_P_reg,~(DFE_P0_REG_DFE_CTRL_CK2_P0_eq_selreg_ck_mask), (DFE_P0_REG_DFE_CTRL_CK2_P0_eq_selreg_ck(0)));
		}

		hdmi_mask(REG_DFE_CTRL_R8_P_reg,	~(DFE_P0_REG_DFE_CTRL_R8_P0_leq_init_r_4_0_mask), (DFE_P0_REG_DFE_CTRL_R8_P0_leq_init_r_4_0(le[2])));
		hdmi_mask(REG_DFE_CTRL_R2_P_reg,	~(DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r_mask), (DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_R2_P_reg,	~(DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r_mask), (DFE_P0_REG_DFE_CTRL_R2_P0_eq_selreg_r(0)));

		hdmi_mask(REG_DFE_CTRL_G8_P_reg,~(DFE_P0_REG_DFE_CTRL_G8_P0_leq_init_g_4_0_mask), (DFE_P0_REG_DFE_CTRL_G8_P0_leq_init_g_4_0(le[1])));
		hdmi_mask(REG_DFE_CTRL_G2_P_reg,~(DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g_mask), (DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_G2_P_reg,~(DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g_mask), (DFE_P0_REG_DFE_CTRL_G2_P0_eq_selreg_g(0)));

		hdmi_mask(REG_DFE_CTRL_B8_P_reg,	~(DFE_P0_REG_DFE_CTRL_B8_P0_leq_init_b_4_0_mask), (DFE_P0_REG_DFE_CTRL_B8_P0_leq_init_b_4_0(le[0])));
		hdmi_mask(REG_DFE_CTRL_B2_P_reg,	~(DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b_mask), (DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b(1)));
		udelay(1);
		hdmi_mask(REG_DFE_CTRL_B2_P_reg,	~(DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b_mask), (DFE_P0_REG_DFE_CTRL_B2_P0_eq_selreg_b(0)));
...
void lib_dfe_tap0_disable(unsigned char nport, unsigned char lane_mode)
{
	...
	{
		  //merlin8p IC , run merlin8p flow
		hdmi_mask(REG_DFE_CTRL_BA_P_reg,~(REG_dfe_adapt_en_TAP0),0);
		hdmi_mask(REG_DFE_CTRL_GA_P_reg,~(REG_dfe_adapt_en_TAP0),0);
		hdmi_mask(REG_DFE_CTRL_RA_P_reg,~(REG_dfe_adapt_en_TAP0),0);
		if (lane_mode == HDMI_4LANE)
		{
			hdmi_mask(REG_DFE_CTRL_CKA_P_reg,~(REG_dfe_adapt_en_TAP0),0);
		}
