...
#define lib_hdmi_crt_reset_hdmi_common_by_port(port)
#define lib_hdmi_crt_off_hdmi_common_by_port(port)
#define lib_hdmi_crt_is_hdmi_common_enabled_by_port(port)       0
...
extern void lib_hdmi_set_run_m8p_flag(void);
extern unsigned char lib_hdmi_get_run_m8p_flag(void);
