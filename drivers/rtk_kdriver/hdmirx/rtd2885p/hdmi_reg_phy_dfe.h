...
//Merlin8p
#define HDMI_DFE0_BASEP           (0xb80B4600)
#define HDMI_DFE1_BASEP           (0xb80B4E00)
#define HDMI_DFE2_BASEP           (0xb800A600)
#define HDMI_DFE3_BASEP           (0xb800AE00)
...
//Merlin8P
extern const struct hdmi21_dfe_reg_st *hd21_dfep[4];  //hd20 & hd21 share
...
#ifdef CONFIG_ARM64
// new
#define REG_DFE_CTRL_R0_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R0)//DE00 BE00 CE00 2E00   
#define REG_DFE_CTRL_R1_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R1)//DE04 BE04 CE04 2E04   
#define REG_DFE_CTRL_R2_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R2)//DE08 BE08 CE08 2E08   
#define REG_DFE_CTRL_R3_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R3)//DE0C BE0C CE0C 2E0C   
#define REG_DFE_CTRL_R4_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R4)//DE10 BE10 CE10 2E10   
#define REG_DFE_CTRL_R5_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R5)//DE14 BE14 CE14 2E14   
#define REG_DFE_CTRL_R6_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R6)//DE18 BE18 CE18 2E18   
#define REG_DFE_CTRL_R7_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R7)//DE1C BE1C CE1C 2E1C   
#define REG_DFE_CTRL_R8_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R8)//DE20 BE20 CE20 2E20   
#define REG_DFE_CTRL_R9_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_R9)//DE24 BE24 CE24 2E24   
#define REG_DFE_CTRL_RA_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_RA)//DE28 BE28 CE28 2E28   
#define REG_DFE_CTRL_RB_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_RB)//DE2C BE2C CE2C 2E2C   
#define REG_DFE_CTRL_RC_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_RC)//DE30 BE30 CE30 2E30   
#define REG_DFE_CTRL_RD_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_RD)//DE34 BE34 CE34 2E34   
                                                                                             
#define REG_DFE_CTRL_G0_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G0)//DE40 BE40 CE40 2E40   
#define REG_DFE_CTRL_G1_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G1)//DE44 BE44 CE44 2E44   
#define REG_DFE_CTRL_G2_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G2)//DE48 BE48 CE48 2E48   
#define REG_DFE_CTRL_G3_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G3)//DE4C BE4C CE4C 2E4C   
#define REG_DFE_CTRL_G4_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G4)//DE50 BE50 CE50 2E50   
#define REG_DFE_CTRL_G5_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G5)//DE54 BE54 CE54 2E54   
#define REG_DFE_CTRL_G6_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G6)//DE58 BE58 CE58 2E58   
#define REG_DFE_CTRL_G7_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G7)//DE5C BE5C CE5C 2E5C   
#define REG_DFE_CTRL_G8_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G8)//DE60 BE60 CE60 2E60   
#define REG_DFE_CTRL_G9_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_G9)//DE64 BE64 CE64 2E64   
#define REG_DFE_CTRL_GA_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_GA)//DE68 BE68 CE68 2E68   
#define REG_DFE_CTRL_GB_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_GB)//DE6C BE6C CE6C 2E6C   
#define REG_DFE_CTRL_GC_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_GC)//DE70 BE70 CE70 2E70   
#define REG_DFE_CTRL_GD_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_GD)//DE74 BE74 CE74 2E74   
                                                                                        
#define REG_DFE_CTRL_B0_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B0)//DE80 BE80 CE80 2E80   
#define REG_DFE_CTRL_B1_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B1)//DE84 BE84 CE84 2E84   
#define REG_DFE_CTRL_B2_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B2)//DE88 BE88 CE88 2E88   
#define REG_DFE_CTRL_B3_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B3)//DE8C BE8C CE8C 2E8C   
#define REG_DFE_CTRL_B4_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B4)//DE90 BE90 CE90 2E90   
#define REG_DFE_CTRL_B5_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B5)//DE94 BE94 CE94 2E94   
#define REG_DFE_CTRL_B6_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B6)//DE98 BE98 CE98 2E98   
#define REG_DFE_CTRL_B7_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B7)//DE9C BE9C CE9C 2E9C   
#define REG_DFE_CTRL_B8_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B8)//DEA0 BEA0 CEA0 2EA0   
#define REG_DFE_CTRL_B9_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_B9)//DEA4 BEA4 CEA4 2EA4   
#define REG_DFE_CTRL_BA_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_BA)//DEA8 BEA8 CEA8 2EA8   
#define REG_DFE_CTRL_BB_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_BB)//DEAC BEAC CEAC 2EAC   
#define REG_DFE_CTRL_BC_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_BC)//DEB0 BEB0 CEB0 2EB0  
#define REG_DFE_CTRL_BD_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_BD)//DEB4 BEB4 CEB4 2EB4   
                                                                                             
#define REG_DFE_CTRL_CK0_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK0)//DEC0 BEC0 CEC0 2EC0 
#define REG_DFE_CTRL_CK1_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK1)//DEC4 BEC4 CEC4 2EC4 
#define REG_DFE_CTRL_CK2_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK2)//DEC8 BEC8 CEC8 2EC8 
#define REG_DFE_CTRL_CK3_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK3)//DECC BECC CECC 2ECC 
#define REG_DFE_CTRL_CK4_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK4)//DED0 BED0 CED0 2ED0 
#define REG_DFE_CTRL_CK5_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK5)//DED4 BED4 CED4 2ED4 
#define REG_DFE_CTRL_CK6_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK6)//DED8 BED8 CED8 2ED8 
#define REG_DFE_CTRL_CK7_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK7)//DEDC BEDC CEDC 2EDC 
#define REG_DFE_CTRL_CK8_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK8)//DEE0 BEE0 CEE0 2EE0 
#define REG_DFE_CTRL_CK9_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CK9)//DEE4 BEE4 CEE4 2EE4 
#define REG_DFE_CTRL_CKA_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CKA)//DEE8 BEE8 CEE8 2EE8 
#define REG_DFE_CTRL_CKB_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CKB)//DEEC BEEC CEEC 2EEC 
#define REG_DFE_CTRL_CKC_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CKC)//DEF0 BEF0 CEF0 2EF0 
#define REG_DFE_CTRL_CKD_P_reg (unsigned int)(unsigned long)(&hd21_dfep[nport]->CTRL_CKD)//DEF4 BEF4 CEF4 2EF4 

#else

// New
#define REG_DFE_CTRL_R0_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R0)//7C00 9C00 AC00 CC00   
#define REG_DFE_CTRL_R1_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R1)//7C04 9C04 AC04 CC04   
#define REG_DFE_CTRL_R2_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R2)//7C08 9C08 AC08 CC08   
#define REG_DFE_CTRL_R3_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R3)//7C0C 9C0C AC0C CC0C   
#define REG_DFE_CTRL_R4_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R4)//7C10 9C10 AC10 CC10   
#define REG_DFE_CTRL_R5_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R5)//7C14 9C14 AC14 CC14   
#define REG_DFE_CTRL_R6_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R6)//7C18 9C18 AC18 CC18   
#define REG_DFE_CTRL_R7_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R7)//7C1C 9C1C AC1C CC1C   
#define REG_DFE_CTRL_R8_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R8)//7C20 9C20 AC20 CC20   
#define REG_DFE_CTRL_R9_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_R9)//7C24 9C24 AC24 CC24   
#define REG_DFE_CTRL_RA_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_RA)//7C28 9C28 AC28 CC28   
#define REG_DFE_CTRL_RB_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_RB)//7C2C 9C2C AC2C CC2C   
#define REG_DFE_CTRL_RC_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_RC)//7C30 9C30 AC30 CC30   
#define REG_DFE_CTRL_RD_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_RD)//7C34 9C34 AC34 CC34   
                                                                                             
#define REG_DFE_CTRL_G0_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G0)//7C40 9C40 AC40 CC40   
#define REG_DFE_CTRL_G1_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G1)//7C44 9C44 AC44 CC44   
#define REG_DFE_CTRL_G2_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G2)//7C48 9C48 AC48 CC48   
#define REG_DFE_CTRL_G3_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G3)//7C4C 9C4C AC4C CC4C   
#define REG_DFE_CTRL_G4_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G4)//7C50 9C50 AC50 CC50   
#define REG_DFE_CTRL_G5_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G5)//7C54 9C54 AC54 CC54   
#define REG_DFE_CTRL_G6_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G6)//7C58 9C58 AC58 CC58   
#define REG_DFE_CTRL_G7_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G7)//7C5C 9C5C AC5C CC5C   
#define REG_DFE_CTRL_G8_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G8)//7C60 9C60 AC60 CC60   
#define REG_DFE_CTRL_G9_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_G9)//7C64 9C64 AC64 CC64   
#define REG_DFE_CTRL_GA_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_GA)//7C68 9C68 AC68 CC68   
#define REG_DFE_CTRL_GB_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_GB)//7C6C 9C6C AC6C CC6C   
#define REG_DFE_CTRL_GC_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_GC)//7C70 9C70 AC70 CC70   
#define REG_DFE_CTRL_GD_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_GD)//7C74 9C74 AC74 CC74   
                                                                                        
#define REG_DFE_CTRL_B0_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B0)//7C80 9C80 AC80 CC80   
#define REG_DFE_CTRL_B1_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B1)//7C84 9C84 AC84 CC84   
#define REG_DFE_CTRL_B2_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B2)//7C88 9C88 AC88 CC88   
#define REG_DFE_CTRL_B3_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B3)//7C8C 9C8C AC8C CC8C   
#define REG_DFE_CTRL_B4_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B4)//7C90 9C90 AC90 CC90   
#define REG_DFE_CTRL_B5_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B5)//7C94 9C94 AC94 CC94   
#define REG_DFE_CTRL_B6_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B6)//7C98 9C98 AC98 CC98   
#define REG_DFE_CTRL_B7_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B7)//7C9C 9C9C AC9C CC9C   
#define REG_DFE_CTRL_B8_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B8)//7CA0 9CA0 ACA0 CCA0   
#define REG_DFE_CTRL_B9_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_B9)//7CA4 9CA4 ACA4 CCA4   
#define REG_DFE_CTRL_BA_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_BA)//7CA8 9CA8 ACA8 CCA8   
#define REG_DFE_CTRL_BB_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_BB)//7CAC 9CAC ACAC CCAC   
#define REG_DFE_CTRL_BC_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_BC)//7CB0 9A0 ACA0 CCA0   
#define REG_DFE_CTRL_BD_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_BD)//7CB4 9CA4 ACA4 CCA4   
                                                                                             
#define REG_DFE_CTRL_CK0_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK0)//7CC0 9CC0 ACC0 CCC0 
#define REG_DFE_CTRL_CK1_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK1)//7CC4 9CC4 ACC4 CCC4 
#define REG_DFE_CTRL_CK2_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK2)//7CC8 9CC8 ACC8 CCC8 
#define REG_DFE_CTRL_CK3_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK3)//7CCC 9CCC ACCC CCCC 
#define REG_DFE_CTRL_CK4_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK4)//7CD0 9CD0 ACD0 CCD0 
#define REG_DFE_CTRL_CK5_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK5)//7CD4 9CD4 ACD4 CCD4 
#define REG_DFE_CTRL_CK6_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK6)//7CD8 9CD8 ACD8 CCD8 
#define REG_DFE_CTRL_CK7_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK7)//7CDC 9CDC ACDC CCDC 
#define REG_DFE_CTRL_CK8_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK8)//7CE0 9CE0 ACE0 CCE0 
#define REG_DFE_CTRL_CK9_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CK9)//7CE4 9CE4 ACE4 CCE4 
#define REG_DFE_CTRL_CKA_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CKA)//7CE8 9CE8 ACE8 CCE8 
#define REG_DFE_CTRL_CKB_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CKB)//7CEC 9CEC ACEC CCEC 
#define REG_DFE_CTRL_CKC_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CKC)//7CF0 9CF0 ACF0 CCF0 
#define REG_DFE_CTRL_CKD_P_reg (unsigned int)(&hd21_dfep[nport]->CTRL_CKD)//7CF4 9CF4 ACF4 CCF4 
#endif
...
#define get_TAP1_coef_sign(data)                    (0x2000&(data))
#define get_TAP1_coef(data)                         (0x1F&(data))

#define get_TAP2_coef_sign(data)                    (0x2000&(data))
#define get_TAP2_coef(data)                         (0x1F&(data))
#define get_TAP3_coef_sign(data)                    (0x2000&(data))
#define get_TAP3_coef(data)                         (0x1F&(data))
#define get_TAP4_coef_sign(data)                    (0x2000&(data))
