...
#define DEMUX_MAX_NUM_TO_SET        24
...
#define DEMUX_IOC_GET_TP_BUF_STATUS_COMPAT     (_IOWR(DEMUX_IOC_MAGIC, 83, u32))
#define DEMUX_IOC_GET_ES_BUF_STATUS             (_IOWR(DEMUX_IOC_MAGIC, 84, DEMUX_ES_BUF_STATUS_T*))
#define DEMUX_IOC_GET_ES_BUF_STATUS_COMPAT     (_IOWR(DEMUX_IOC_MAGIC, 84, u32))
