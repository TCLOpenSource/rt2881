			   ...
			   struct drm_fb_helper_surface_size *sizes)
{
	...
	DRM_NOTE("%s %d width:%u height:%u %u %u %u %u",__func__,__LINE__, sizes->surface_width, sizes->surface_height, sizes->fb_width, sizes->fb_height, sizes->surface_bpp, sizes->surface_depth);
