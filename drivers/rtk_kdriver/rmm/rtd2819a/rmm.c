...
//	{0x12280000,  0*_MB_/*17920*_KB_*/},			// CARVEDOUT_VDEC_COMEM
	...
	{0x17f00000, 1*_MB_},							// CARVEDOUT_MAP_GIC
	...
	{0x1b200000, 12*_MB_},							// CARVEDOUT_A_OS
	{CONST_LOGBUF_MEM_ADDR_START, CONST_LOGBUF_MEM_SIZE}, // CARVEDOUT_LOGBUF
	{0xffff0000, 0x00010000},						// CARVEDOUT_ROMCODE
...
//	{AUDIO_RINGBUFFER_START,  AUDIO_RINGBUFFER_SIZE}, // CARVEDOUT_AUDIO_RINGBUF
  ...
  // MM_LAYOUT_DEFAULT_NC    for TV 4K 2GB
  {
	{0x00000000,  1.5*_MB_},							// CARVEDOUT_BOOTCODE
	{DEMOD_CARVED_OUT,  0*_MB_},					// CARVEDOUT_DEMOD
	{0x10000000,  0*_MB_},							// CARVEDOUT_AV_DMEM
//	{0x12280000,  0*_MB_/*17920*_KB_*/},			// CARVEDOUT_VDEC_COMEM
	...
	{_TBD_, _TBD_},									// CARVEDOUT_DDR_BOUNDARY
	{_TBD_, _TBD_},									// CARVEDOUT_DDR_BOUNDARY_2
	{NC_VIDEO_RINGBUFFER_START,  NC_VIDEO_RINGBUFFER_SIZE}, // CARVEDOUT_VDEC_RINGBUF
//	{NC_AUDIO_RINGBUFFER_START,  NC_AUDIO_RINGBUFFER_SIZE}, // CARVEDOUT_AUDIO_RINGBUF
	{_TBD_, _TBD_},				// CARVEDOUT_GAL
	{_TBD_, _TBD_},									// CARVEDOUT_SNAPSHOT
...
//	{0x12280000,  0*_MB_/*17920*_KB_*/},							// CARVEDOUT_VDEC_COMEM
	...
	{0x1b180000,  0x00080000},										// CARVEDOUT_MAP_RPC
	{0x1b200000, 12*_MB_},											// CARVEDOUT_A_OS
	{DISP_5K_CONST_LOGBUF_MEM_ADDR_START, DISP_5K_CONST_LOGBUF_MEM_SIZE}, // CARVEDOUT_LOGBUF
	{0xffff0000, 0x00010000},										// CARVEDOUT_ROMCODE
	{0x1fd00000, 0x010000},											// CARVEDOUT_RAMOOPS
	{0x1ffff000, 0x00001000},						// CARVEDOUT_IR_TABLE
	{_TBD_, _TBD_},													// CARVEDOUT_DDR_BOUNDARY
	{_TBD_, _TBD_},									// CARVEDOUT_DDR_BOUNDARY_2
	{DISP_5K_VIDEO_RINGBUFFER_START,  DISP_5K_VIDEO_RINGBUFFER_SIZE}, // CARVEDOUT_VDEC_RINGBUF
//	{DISP_5K_AUDIO_RINGBUFFER_START,  DISP_5K_AUDIO_RINGBUFFER_SIZE}, // CARVEDOUT_AUDIO_RINGBUF
	{_TBD_, _TBD_},				// CARVEDOUT_GAL
	{_TBD_, _TBD_},													// CARVEDOUT_SNAPSHOT
	{DISP_5K_SCLAER_MODULE_START, DISP_5K_SCALER_MODULE_SIZE},		// CARVEDOUT_SCALER
	{DISP_5K_SCALER_MEMC_START, DISP_5K_SCALER_MEMC_SIZE},			// CARVEDOUT_SCALER_MEMC
	{DISP_5K_SCALER_MDOMAIN_START, DISP_5K_SCALER_MDOMAIN_SIZE},	// CARVEDOUT_SCALER_MDOMAIN
	{DISP_5K_SCALER_DI_NR_START, DISP_5K_SCALER_DI_NR_SIZE},		// CARVEDOUT_SCALER_DI_NR
	{DISP_5K_SCALER_NN_START, DISP_5K_SCALER_NN_SIZE},				// CARVEDOUT_SCALER_NN
	{DISP_5K_SCALER_VIP_START, DISP_5K_SCALER_VIP_SIZE},			// CARVEDOUT_SCALER_VIP
	{DISP_5K_SCALER_OD_START, DISP_5K_SCALER_OD_SIZE},				// CARVEDOUT_SCALER_OD
	{DISP_5K_VDEC_BUFFER_START, DISP_5K_VDEC_BUFFER_SIZE},			// CARVEDOUT_VDEC_VBM
	{DISP_5K_DEMUX_TP_BUFFER_START, DISP_5K_DEMUX_TP_BUFFER_SIZE},	// CARVEDOUT_TP
	...
	{0, _TBD_},														// CARVEDOUT_CMA_LOW_LIMIT
	{0, _TBD_},														// CARVEDOUT_CMA_BW
	{DISP_5K_VDEC_BUFFER_START, DISP_5K_VDEC_BUFFER_SIZE},			// CARVEDOUT_CMA_VBM
...
#if 0 // no small_dram_XX in 2819a dc_sys_reg.h
...
static int is_ddr_diff_size_enabled(void)
{
	...
	//2819a has no en_ddr_diff_size as 6702
...
{
        dc_sys_dc_sys_misc1_RBUS dc_sys_misc1;
        dc_mc_mc_sys_0_RBUS dc_mc1_mc_sys;
        dc_mc_mc_sys_0_RBUS dc_mc3_mc_sys;
        //dc_mc_mc_sys_2_RBUS dc_mc1_mc_sys_2;
        //dc_mc_mc_sys_2_RBUS dc_mc3_mc_sys_2;
        unsigned int ddr_bitwidth = 0;

        dc_sys_misc1.regValue = rtd_inl(DC_SYS_DC_SYS_MISC1_reg);
        dc_mc1_mc_sys.regValue = rtd_inl(DC_MC_MC_SYS_0_reg); //mc1
        dc_mc3_mc_sys.regValue = rtd_inl(DC_MC_MC_SYS_0_reg + 0x2000); //mc3
        //dc_mc1_mc_sys_2.regValue = rtd_inl(DC_MC_MC_SYS_2_reg); //mc1
        //dc_mc3_mc_sys_2.regValue = rtd_inl(DC_MC_MC_SYS_2_reg + 0x2000); //mc3
        ...
        //if ddr4, 1bank 16bit page size=2k, 1mc only 
        //dc_sys_misc1.page_size 0:2k:1bank at 1mc, 1:4k:means 2bank at 1mc
        //if lpddr4, always 2bank 32bit page size=4k, 1mc+2mc 1:1
        if(dc_mc1_mc_sys.ddr4_en==1 && dc_sys_misc1.page_size==0) //dc1 ddr type
		ddr_bitwidth += 16;
        else
		ddr_bitwidth += 32;
	
        if(dc_mc3_mc_sys.ddr4_en==1 && dc_sys_misc1.page_size_dc2==0) //dc2 ddr type
		ddr_bitwidth += 16;
        else
		ddr_bitwidth += 32;
...
{
#ifndef BUILD_QUICK_SHOW
#define MAGIC_CAVEDOUT (0xdeca)
	if (get_platform_model() == PLATFORM_MODEL_5K)
		return true;
	
    return rtd_part_inl(STB_SW_DATA9_reg, 31, 16) == MAGIC_CAVEDOUT ? 0 : 1;
#else
    return true;
#endif
}
...
unsigned int carvedout_buf_get_layout_idx(void)
{
	...
	/* currently no any spcific platform model for 4GB condition 
	 * so just unite it
	 */
	if (DRAM_size >= 0x100000)
		layout_idx = MM_LAYOUT_4GB;
...
void __init rtk_reserve(void)
{
	...
	rtd_pr_rmm_info("[MEM] rtd2819a rtk_reserve, DRAM_size = 0x%x, layout_idx = 0x%x\n", (unsigned int)DRAM_size, layout_idx);
	...
	/* for A & V fw */
	memblock_remove(carvedout_buf[layout_idx][CARVEDOUT_V_OS][0], carvedout_buf[layout_idx][CARVEDOUT_V_OS][1]);
	memblock_remove(carvedout_buf[layout_idx][CARVEDOUT_A_OS][0], carvedout_buf[layout_idx][CARVEDOUT_A_OS][1]);
