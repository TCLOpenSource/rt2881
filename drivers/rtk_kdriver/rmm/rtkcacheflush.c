...
#else
extern void __rtk_v7_dma_flush_range(const void *, const void *);
extern void __rtk_v7_dma_clean_range(const void *, const void *);
extern void __rtk_v7_dma_inv_range(const void *, const void *);
#endif
...
#else
	__rtk_v7_dma_flush_range(virt_start, virt_end);
#endif
}
...
#else
	__rtk_v7_dma_clean_range(virt_start, virt_end);
#endif
}
...
#else
	__rtk_v7_dma_inv_range(virt_start, virt_end);
#endif
}
