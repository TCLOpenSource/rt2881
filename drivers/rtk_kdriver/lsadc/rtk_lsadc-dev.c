...
extern irqreturn_t rtk_lsadc_interrupt_handler(int irq, void *dev_id);
/*
...
{
    int ret = 0;
    if((rtd_inl(STB_ST_CLKEN1_reg) & BIT(STB_ST_CLKEN1_clken_lsadc_shift)) == 0) {
        LSADC_ClockEnable(1);
    }
