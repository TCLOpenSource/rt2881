...
#define _USB_PRODUCT_ID_L                       0xBB
#define _USB_PRODUCT_ID_H                       0x54
...
#define P64_00_HS_USP_CTL               0x000
#define P64_04_HS_USP_STS               0x010
#define P64_20_HS_USP_IRQ               0x080
#define P64_C6_CMU480_PLL_DIV_CFG0      0
#define P64_74_HS_USB2_RESET            0x1D0
#define P64_52_HS_DEV_G_STA             0x148
#define P64_53_HS_UP_TEST               0x14C
#define P64_54_HS_DEV_ADDR              0x150
#define P64_56_HS_DEV_G_CFG             0x158
//#define P80_0E_XTAL_CTRL0      0
//#define P80_0F_XTAL_CTRL1      0
#define P98_00_HS_EP0_IRQ               0x300
#define P98_01_HS_EP0_IRQ_EN            0x304
#define P98_04_HS_EP0_CTRL              0x310
#define P98_06_HS_EP0_TX_BC             0x318
#define P98_08_HS_EP0_SETUP0            0x320
#define P98_09_HS_EP0_SETUP1            0x324
#define P98_0A_HS_EP0_SETUP2            0x328
#define P98_0B_HS_EP0_SETUP3            0x32C
#define P98_0C_HS_EP0_SETUP4            0x330
#define P98_0D_HS_EP0_SETUP5            0x334
#define P98_0E_HS_EP0_SETUP6            0x338
#define P98_0F_HS_EP0_SETUP7            0x33C
#define P9A_00_BB_BUF0_WR_ADDR          0x400
#define P9A_01_BB_BUF0_WR_DATA          0x404
#define P9A_02_BB_BUF0_RD_ADDR          0x408
#define P9A_03_BB_BUF0_RD_DATA          0x40C
...
#define USB_BB_MODE_CHECK_TIMEOUT  msecs_to_jiffies(10)

struct USB_BB_PRIVATE_DATA
{
	struct platform_device *pdev;
	unsigned int io_base;
	unsigned int id;
	struct task_struct * usb_bb_task;
	struct completion usb_bb_check_thread_exited;
	int usb_bb_check_thread_exited_flag;
	spinlock_t rtk_bb_lock;
	int setup_check;
	unsigned int event_flag;
	unsigned int share_memory_reg;
	unsigned int share_memory_reg_bit_mask;
	unsigned char ucUsbBillboardMuxSelPort;
	unsigned char ucUsbBillboardUsbHostEnableRemoteWakeup;
	unsigned char ucUsbBillboardUsbConfigurationValue;
	unsigned char ucUsbBillboardUsbVendorComEnb;	
#if(_USB_TYPE_C_BB_PROGRAM_SUPPORT == _ON)	
	bool bUsbBillboardIspInfoReadyFlag;
	bool bUsbBillboardFlashWriteFlag;
	unsigned char pucUsbBillboardGetISPinfo[16];
	StructUsbBillboardIspCommandInfo stUsbBillboardIspCommandInfo;
#endif
	StructTypeCBillboardInfo pstUsbBillboardAltModeInfo[_USB_MAX_ALTERNATE_MODE_NUM];
	struct hrtimer bb_trigger_timer;
...
extern void UsbBillboardStandardRequest(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorSetRegisterByte(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorGetRegisterByte(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorReadFlash(struct USB_BB_PRIVATE_DATA *private_data);

#if(_FLASH_WRITE_FUNCTION_SUPPORT == _ON)
#if(_USB_TYPE_C_BB_PROGRAM_SUPPORT == _ON)
extern void UsbBillboardVendorWriteFlash(struct USB_BB_PRIVATE_DATA *private_data);
#endif
extern void UsbBillboardVendorSectorErase(struct USB_BB_PRIVATE_DATA *private_data);
#endif
extern void UsbBillboardVendorBankErase(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorIspEnable(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorHandshake(struct USB_BB_PRIVATE_DATA *private_data);

#if(_USB_TYPE_C_BB_PROGRAM_SUPPORT == _ON)
extern void UsbBillboardVendorDualBankProcess1(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorDualBankProcess2(struct USB_BB_PRIVATE_DATA *private_data);

extern void UsbBillboardVendorGetIspStartBank(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorGetIspKeyAddr(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorGetIspFalgAddr(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorGetIspSignatureAddr(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorGetVerifyCopyResult(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorGetCurrentKeyAddr(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorGetFWInfo(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorSwitchCode(struct USB_BB_PRIVATE_DATA *private_data);
#endif

extern void UsbBillboardVendorDebugMsgEventStart(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorDebugMsgEventFinish(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorDebugMsgStart(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorDebugMsgEnd(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorDebugMsgGetValue(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorDebugMsgGetString(struct USB_BB_PRIVATE_DATA *private_data);

extern void UsbBillboardVendorWriteSyseeprom(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardVendorReadSyseeprom(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardTransmtDataToHost(struct USB_BB_PRIVATE_DATA *private_data, unsigned int usLength, unsigned char *pucDataBuf);
extern void UsbBillboardVendorRequest(struct USB_BB_PRIVATE_DATA *private_data);

extern void UsbBillboardEepromWrite(struct USB_BB_PRIVATE_DATA *private_data, bool bSysDefualtIICPin, unsigned char ucSlaveAddr, unsigned char ucSubAddrLength, unsigned int usSubAddr, unsigned int usLength, unsigned char *pucWriteArray);
extern void UsbBillboardEepromRead(struct USB_BB_PRIVATE_DATA *private_data, bool bSysDefualtIICPin, unsigned char ucSlaveAddr, unsigned char ucSubAddrLength, unsigned int usSubAddr, unsigned int usLength, unsigned char *pucWriteArray);
extern void UsbBillboardGetDescriptor(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardSetAddr(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardSetConf(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardGetInterface(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardSetInterface(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardGetStatus(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardGetConf(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardSetFeature(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardClearFeature(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardInitCtrlVariable(struct USB_BB_PRIVATE_DATA *private_data);
extern void UsbBillboardGetAltModeInfo(struct USB_BB_PRIVATE_DATA *private_data);
extern bool UsbBillboardCtrlXfer(struct USB_BB_PRIVATE_DATA *private_data, unsigned char ucXferType, unsigned char ucIsLastPacket);
extern bool UsbBillboardXferForGetDescriptor(struct USB_BB_PRIVATE_DATA *private_data, unsigned char ucXferType, unsigned char ucIsLastPacket);
