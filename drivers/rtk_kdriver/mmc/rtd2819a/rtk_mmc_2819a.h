 ...
 * Realtek MMC driver
 *
 * For definition re-define.
 * Since the register names of different SOCs may be different,
 * redefining them avoids the need for the main program to be
 * modified according to different SOCs.
 */
//rename this file to "rtkemmc_2819a.h"
#ifndef _RTK_MMC_2885P_H_
#define _RTK_MMC_2885P_H_
