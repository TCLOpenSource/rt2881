...
#ifdef MISC_I2C4_I2C4_GPIO_MODE_CTRL_reg
...
#ifdef ISO_I2C_I2C5_GPIO_MODE_CTRL_reg
...
static const rtk_i2c_port RTK_I2C_i2c0_port[] =
{
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 5),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 4),
		.input_mux[0]      = {0xB8060240, (0x0<<12), (0x0<<12)},//SCL
		.input_mux[1]      = {0xB8060240, (0x0<<8), (0x0<<8)},//SDA
		.pin_mux[0]        = {0xb8060204, (0xF<<20),  (0x6<<20),  (0xF<<20)},
		.pin_mux[1]        = {0xb8060204, (0xF<<28), (0x6<<28), (0xF<<28)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 21),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 20),
		.input_mux[0]      = {0xB8060240, (0x1<<12), (0x1<<12)},
		.input_mux[1]      = {0xB8060240, (0x1<<8), (0x1<<8)},
		.pin_mux[0]        = {0xB8060214, (0xF<<20), (0x6<<20), (0xF<<20)},
		.pin_mux[1]        = {0xB8060214, (0xF<<28),  (0x6<<28),  (0xF<<28)},
	},
};
...
{
	{
		...
		.input_mux[0]      = {0xb80008c4, (0x0<<20), (0x0<<20)},//table not match register
		.input_mux[1]      = {0xb80008c4, (0x0<<16), (0x0<<16)},
		.pin_mux[0]        = {0xb8000864,(0xF<<20), (0x6<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb8000864,(0xF<<28), (0x6<<28), (0xF<<28)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 13),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 12),
		.input_mux[0]      = {0xb80008c4, (0x1<<20), (0x1<<20)},//table not match register
		.input_mux[1]      = {0xb80008c4, (0x1<<16), (0x1<<16)},
		.pin_mux[0]        = {0xb806020c,(0xF<<20), (0x6<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb806020c,(0xF<<28), (0x6<<28), (0xF<<28)},
	},
};
...
{
	{
		...
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 26),
		.input_mux[0]      = {0xb80008c4, (0x0<<12), (0x0<<12)},
		.input_mux[1]      = {0xb80008c4, (0x0<<8),  (0x0<<8)},
		.pin_mux[0]        = {0xb800085c, (0xF<<20), (0x6<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb800085c, (0xF<<28), (0x6<<28), (0xF<<28)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 17),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 16),
		.input_mux[0]      = {0xb80008c4, (0x1<<12), (0x1<<12)},
		.input_mux[1]      = {0xb80008c4, (0x1<<8),  (0x1<<8)},
		.pin_mux[0]        = {0xb8060210, (0xF<<20), (0x6<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb8060210, (0xF<<28),  (0x6<<28),  (0xF<<28)},
	},
};
...
{
	{
		...
		.input_mux[0]      = {0xb80008c4, (0x0<<4),  (0x0<<4)},
		.input_mux[1]      = {0xb80008c4, (0x0<<0),  (0x0<<0)},
		.pin_mux[0]        = {0xb8000838, (0xF<<28), (0x6<<28), (0xF<<28)},
		.pin_mux[1]        = {0xb8000834, (0xF<<4), (0x6<<4), (0xF<<4)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 9),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 8),
		.input_mux[0]      = {0xb80008c4, (0x1<<4), (0x1<<4)},
		.input_mux[1]      = {0xb80008c4, (0x1<<0), (0x1<<0)},
		.pin_mux[0]        = {0xb8060208, (0xF<<20),(0x6<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb8060208, (0xF<<28),(0x6<<28), (0xF<<28)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 41),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 40),
		.input_mux[0]      = {0xb80008c4, (0x2<<4), (0x2<<4)},
		.input_mux[1]      = {0xb80008c4, (0x2<<0), (0x2<<0)},
		.pin_mux[0]        = {0xb8000868, (0xF<<4),(0x6<<4), (0xF<<4)},
		.pin_mux[1]        = {0xb8000868, (0xF<<12),(0x6<<12), (0xF<<12)},
	},
};
...
{
	{
		...
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 35),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 34),
		.input_mux[0]      = {0xb80008f8, (0x3<<28), (0x0<<28)},
		.input_mux[1]      = {0xb80008f8, (0x3<<24), (0x0<<24)},
		.pin_mux[0]        = {0xb8000868, (0xF<<16), (0xB<<16), (0xF<<16)},
	...
	},
	{
		...
		.input_mux[0]      = {0xb80008f8, (0x3<<28), (0x1<<28)},
		.input_mux[1]      = {0xb80008f8, (0x3<<24), (0x1<<24)},
		.pin_mux[0]        = {0xb8000800, (0xF<<4),  (0xB<<4), (0xF<<4)},
...
{
	{
		...
		.input_mux[0]      = {0xb8060244, (0x3<<12), (0x0<<12)},
		.input_mux[1]      = {0xb8060244, (0x3<<8),  (0x0<<8)},
	...
	},
	{
		...
		.input_mux[0]      = {0xb8060244, (0x3<<12), (0x1<<12)},
		.input_mux[1]      = {0xb8060244, (0x3<<8),  (0x1<<8)},
	...
	},
	{
		...
		.input_mux[0]      = {0xb8060244, (0x3<<12), (0x2<<12)},
		.input_mux[1]      = {0xb8060244, (0x3<<8),  (0x2<<8)},
