...
{
	{
		...
		.input_mux[0]      = {0xB8060244, (0x3<<20), (0x0<<20)},//SCL
		.input_mux[1]      = {0xB8060244, (0x3<<16), (0x0<<16)},//SDA
		.pin_mux[0]        = {0xb806020C, (0xF<<4),  (0xB<<4),  (0xF<<4)},
		.pin_mux[1]        = {0xb806020C, (0xF<<12), (0xB<<12), (0xF<<12)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 51),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 52),
		.input_mux[0]      = {0xB8060244, (0x3<<20), (0x1<<20)},
		.input_mux[1]      = {0xB8060244, (0x3<<16), (0x1<<16)},
		.pin_mux[0]        = {0xB806022C, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xB806022C, (0xF<<4),  (0xB<<4),  (0xF<<4)},
	},
};
...
{
	{
		...
		.input_mux[1]      = {0x0, (0), (0)},
		.pin_mux[0]        = {0xb8000848,(0xF<<20), (0xB<<20), (0xF<<20)},
...
{
	{
		...
		.input_mux[0]      = {0xb80008f4, (0x3<<12), (0x0<<12)},
		.input_mux[1]      = {0xb80008f4, (0x3<<8),  (0x0<<8)},
		.pin_mux[0]        = {0xb80008C0, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb80008C0, (0xF<<20), (0xB<<20), (0xF<<20)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(ISO_GPIO, 4),
		.g2c_sda           = rtk_gpio_id(ISO_GPIO, 5),
		.input_mux[0]      = {0xb80008f4, (0x3<<12), (0x1<<12)},
		.input_mux[1]      = {0xb80008f4, (0x3<<8),  (0x1<<8)},
		.pin_mux[0]        = {0xb8060208, (0xF<<12), (0xB<<12), (0xF<<12)},
		.pin_mux[1]        = {0xb8060208, (0xF<<4),  (0xB<<4),  (0xF<<4)},
	},
};
...
{
	{
		...
		.input_mux[0]      = {0xb80008f4, (0x3<<4),  (0x0<<4)},
		.input_mux[1]      = {0xb80008f4, (0x3<<0),  (0x0<<0)},
		.pin_mux[0]        = {0xb8000808, (0xF<<20), (0xB<<20), (0xF<<20)},
		.pin_mux[1]        = {0xb8000808, (0xF<<28), (0xB<<28), (0xF<<28)},
	},
	{
		.gpio_mapped       = 1,
		.g2c_scl           = rtk_gpio_id(MIS_GPIO, 37),
		.g2c_sda           = rtk_gpio_id(MIS_GPIO, 36),
		.input_mux[0]      = {0xb80008f4, (0x3<<4), (0x1<<4)},
		.input_mux[1]      = {0xb80008f4, (0x3<<0), (0x1<<0)},
		.pin_mux[0]        = {0xb800080C, (0xF<<12),(0xB<<12), (0xF<<12)},
