...
#define AUDIO_IOC_ATV_SET_AUDIO_IN_HANDLE			_IOW(AUDIO_IOC_ATV_MAGIC, 42, uint32_t)
#define AUDIO_IOC_ATV_SET_SUB_AUDIO_IN_HANDLE			_IOW(AUDIO_IOC_ATV_MAGIC, 43, uint32_t)
