...
#ifndef BUILD_QUICK_SHOW
extern DTV_STATUS_T RHAL_AUDIO_SetPBOutVolume(SINT32 dbGains, UINT32 ch_id);
extern DTV_STATUS_T RHAL_AUDIO_SetPBOutMute(BOOLEAN bOnOff, UINT32 ch_id);
extern DTV_STATUS_T RHAL_AUDIO_SetPBOutBalance(SINT32 dbGains, UINT32 ch_id);
extern void RHAL_AUDIO_SyncVolumeFromQs(UINT32 ch_id, SINT32 vol);
extern void RHAL_AUDIO_SyncBalanceFromQs(SINT32 balance);
...
int32_t Audio_HwpSetBalance(int32_t  Balance, APP_BALANCE_CH_ID Channel)
{
	...
	return AIO_OK;
        ...
        RHAL_AUDIO_SetPBOutBalance(Balance, ch_id);
        #else
        //let qs drv and audio fw handle
        #endif
...
#else
        #ifndef BUILD_QUICK_SHOW
        RHAL_AUDIO_SetPreScaleVolume(vol, ch_id);
        #else
        //let qs drv and audio fw handle
       #endif
#endif
...
#else
        #ifndef BUILD_QUICK_SHOW
        RHAL_AUDIO_SetPBOutVolume(vol, ch_id);
        #else
        //let qs drv and audio fw handle
        #endif
#endif
...
#else
#ifndef BUILD_QUICK_SHOW
        RHAL_AUDIO_SyncVolumeFromQs(ch_id, vol);
#else
        //let qs drv and audio fw handle
#endif
#endif
...
#else
#ifndef BUILD_QUICK_SHOW
        RHAL_AUDIO_SyncBalanceFromQs(balance);
#else
        //let qs drv and audio fw handle
#endif
#endif
...
#else
        #ifndef BUILD_QUICK_SHOW
        RHAL_AUDIO_SetPBOutMute(para,  ch_id);
        #else
        //let qs drv and audio fw handle
        #endif
        ret = AIO_OK;
...
#if 0//2851f/2885p/2875q not support hw eq
...
if(!g_runtime_state)
{
#if 0//2851f/2885p/1875q not support hw eq
	for (i = 0; i < APP_EQ_BAND_NUM; i++) {
