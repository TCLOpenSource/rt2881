...
static long app_hwp_set_avc2(void __user *arg)
{
	...
	} else if (d.p_cfg_avc2.avc2_channel == APP_AVC2_CH_ID_CH45) {
	    if (Audio_HwpSetCH45AVC2(d.para, &d.p_cfg_avc2)) {
		return -ENOTTY;
	    }
	} else if (d.p_cfg_avc2.avc2_channel == APP_AVC2_CH_ID_CH67) {
	    if (Audio_HwpSetCH67AVC2(d.para, &d.p_cfg_avc2)) {
		return -ENOTTY;
	    }
	}
