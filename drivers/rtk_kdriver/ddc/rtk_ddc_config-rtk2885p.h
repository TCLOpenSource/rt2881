...
#include <rbus/M8P_iso_misc_reg.h>
...
// #define RTK_DDC_HW_SEGMENT_AUTO_CLEAR   // define to enable HW Segment auto clear
...
#define DDC_DDC_SCR_I2C_M_RD_ST_STS(value) 					ISO_MISC_DDC1_DDC_SCR_i2c_m_rd_sp_sts(value)
#define DDC_DDC_SCR_GET_I2C_M_RD_ST_STS(value) 				ISO_MISC_DDC1_DDC_SCR_get_i2c_m_rd_sp_sts(value)

#define DDC_DDC_SCR_I2C_M_RD_SP_STS_MASK					ISO_MISC_DDC1_DDC_SCR_i2c_m_rd_st_sts_mask
#define DDC_DDC_SCR_I2C_M_RD_SP_STS(value) 					ISO_MISC_DDC1_DDC_SCR_i2c_m_rd_st_sts(value)
#define DDC_DDC_SCR_GET_I2C_M_RD_SP_STS(value) 				ISO_MISC_DDC1_DDC_SCR_get_i2c_m_rd_st_sts(value)
...
#define DDC_DDC_SPR_GET_SEG_CLR_EN(value)					ISO_MISC_DDC1_DDC_SPR_get_seg_clr_en(value)
...
#define DDC_ST_CLKEN_GET_DDC4(value) 						STB_ST_CLKEN1_get_clken_ddc4(value)
#define DDC_ST_CLKEN_GET_DDC3(value) 						STB_ST_CLKEN1_get_clken_ddc3(value)
#define DDC_ST_CLKEN_GET_DDC2(value) 						STB_ST_CLKEN1_get_clken_ddc2(value)
#define DDC_ST_CLKEN_GET_DDC1(value) 						STB_ST_CLKEN1_get_clken_ddc1(value)
#define DDC_ST_CLKEN_GET_DDC0(value) 						STB_ST_CLKEN1_get_clken_ddc(value)
