...
void scalerVIP_color_noise_mpeg_apply(void)
{
	...
	if(
		...
		if(scalerVIP_color_noise_mpeg_h_detect__yen){// ||scalerVIP_color_noise_mpeg_h_detect__z_turn==scalerVIP_color_noise_mpeg_h_detect__y_turn
			...
			//*/
			if( scalerVIP_color_noise_mpeg_h_detect__y_scaling!=4096 || scalerVIP_color_noise_mpeg_h_detect__y_turn>2 )
			{
				if( mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x>0 )
				{
					mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x=mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x-1;
				}
			}
			else
			if( mpegnr_ich1_blend_nr_hor_step_r.cp_mpghor_blend_xstep!=scalerVIP_color_noise_mpeg_h_detect__y_scaling || mpegnr_ich1_mpegnr2_r.cp_mpgidx_x!=scalerVIP_color_noise_mpeg_h_detect__amax1p[0][scalerVIP_color_noise_mpeg_h_detect__y_turn] )
			{
				// different xstep
				if( mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x<1 )
				{
					// can change xstep
					if( scalerVIP_color_noise_mpeg_h_detect__y_scaling==4096 )
					{
						mpegnr_ich1_blend_nr_hor_step_r.cp_mpghor_blend_xstep=scalerVIP_color_noise_mpeg_h_detect__y_scaling;
					}
					if( scalerVIP_color_noise_mpeg_h_detect__y_turn<3 )
					{
			...
			if( mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x>scalerVIP_color_noise_mpeg_detect_y4 )
			{
				if( mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x>0 )
				{
					mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x=mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x-1;
			...
			//// mpegnr_ich1_blend_nr_hor_step_r.cp_mpghor_blend_xstep=scalerVIP_color_noise_mpeg_h_detect__y_scaling;
			//// mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x=scalerVIP_color_noise_mpeg_detect_y4;
			mpegnr_ich1_mpegnr_ub_delta2_r.cp_mpgub_delta3=scalerVIP_color_noise_mpeg_detect_y4>0?scalerVIP_color_noise_mpeg_detect_y_delta3*mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x/scalerVIP_color_noise_mpeg_detect_y4:0;
			mpegnr_ich1_mpegnr_ub_delta1_r.cp_mpgub_delta2=mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x;

			if( mpegnr_ich1_blend_nr_hor_step_r.cp_mpghor_blend_xstep==12288 )
					mpeg_ratio = 3;
			else if( mpegnr_ich1_blend_nr_hor_step_r.cp_mpghor_blend_xstep==8192 )
					mpeg_ratio = 2;
			else if( mpegnr_ich1_blend_nr_hor_step_r.cp_mpghor_blend_xstep==4096 )
					mpeg_ratio = 1;


			if(mpegnr_ich1_blend_nr_hor_step_r.cp_mpghor_blend_xstep<scalerVIP_color_noise_mpeg_h_apply__x_14641){
				mpegnr_ich1_mpegnr_ub_delta1_r.cp_mpgub_delta1=apply__detect_y;
				mpegnr_ich1_mpegnr1_r.cp_mpgnr_filter_sel=0;
			}else{
				if(mpegnr_ich1_blend_nr_hor_step_r.cp_mpghor_blend_xstep<scalerVIP_color_noise_mpeg_h_apply__x_24442){
					...
					mpegnr_ich1_mpegnr_ub_delta1_r.cp_mpgub_delta1=mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x*5/6;
				}else{
					...
					mpegnr_ich1_mpegnr_ub_delta1_r.cp_mpgub_delta1=mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x*2/3;
}
			}// todo : mpegai
		}
                else
		...
		#if 0
		{
			...
			reg_mpegnr_ich1_accessdata_posctrl_pk_reg.startx=scalerVIP_color_noise_mpeg_detect_y4*2+100;
			reg_mpegnr_ich1_accessdata_posctrl_pk_reg.starty=scalerVIP_color_noise_mpeg_h_detect__amax1p[0][scalerVIP_color_noise_mpeg_h_detect__y_turn]*16+96;
			...
			if( !scalerVIP_color_noise_mpeg_h_detect__yen )
			{
				reg_mpegnr_ich1_writedata_data_pk_reg.u=4;
				reg_mpegnr_ich1_writedata_data_pk_reg.v=4;
			}
			else
			if( scalerVIP_color_noise_mpeg_h_detect__y_scaling<=4096 )
			{
				reg_mpegnr_ich1_writedata_data_pk_reg.u=12;
				reg_mpegnr_ich1_writedata_data_pk_reg.v=4;
			}
			else
			if( scalerVIP_color_noise_mpeg_h_detect__y_scaling<=0x1556 )
			{
				reg_mpegnr_ich1_writedata_data_pk_reg.u=4;
				reg_mpegnr_ich1_writedata_data_pk_reg.v=12;
			}
			else
			if( scalerVIP_color_noise_mpeg_h_detect__y_scaling<=0x2aab )
			{
				reg_mpegnr_ich1_writedata_data_pk_reg.u=12;
				reg_mpegnr_ich1_writedata_data_pk_reg.v=12;
			}
		...
		#if 0
		{
			scaledown_accessdata_ctrl_uzd_RBUS reg_scaledown_accessdata_ctrl_uzd_reg;
			scaledown_accessdata_posctrl_uzd_RBUS reg_scaledown_accessdata_posctrl_uzd_reg;
			scaledown_writedata_data_uzd_RBUS reg_scaledown_writedata_data_uzd_reg;
			
			reg_scaledown_accessdata_ctrl_uzd_reg.regValue=IoReg_Read32( SCALEDOWN_AccessData_CTRL_UZD_reg );
			reg_scaledown_accessdata_posctrl_uzd_reg.regValue=IoReg_Read32( SCALEDOWN_AccessData_PosCtrl_UZD_reg );
			reg_scaledown_writedata_data_uzd_reg.regValue=IoReg_Read32( SCALEDOWN_WriteData_DATA_UZD_reg );
			
			reg_scaledown_accessdata_ctrl_uzd_reg.write_en=1;
			reg_scaledown_accessdata_ctrl_uzd_reg.cross_bar_en=1;
			
			reg_scaledown_accessdata_posctrl_uzd_reg.startx=mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x*2+100;
			reg_scaledown_accessdata_posctrl_uzd_reg.starty=mpegnr_ich1_mpegnr2_r.cp_mpgidx_x*16+100;
			
			reg_scaledown_writedata_data_uzd_reg.y=10;
			reg_scaledown_writedata_data_uzd_reg.u=8;
			reg_scaledown_writedata_data_uzd_reg.v=8;
			if( !mpegnr_ich1_mpegnr2_r.cp_mpegenable_x )
			{
				reg_scaledown_writedata_data_uzd_reg.u=4;
				reg_scaledown_writedata_data_uzd_reg.v=4;
			}
			else
			if( mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x<=4096 )
			{
				reg_scaledown_writedata_data_uzd_reg.u=12;
				reg_scaledown_writedata_data_uzd_reg.v=4;
			}
			else
			if( mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x<=0x1556 )
			{
				reg_scaledown_writedata_data_uzd_reg.u=4;
				reg_scaledown_writedata_data_uzd_reg.v=12;
			}
			else
			if( mpegnr_ich1_mpegnr1_r.cp_mpgupperbound_x<=0x2aab )
			{
				reg_scaledown_writedata_data_uzd_reg.u=12;
				reg_scaledown_writedata_data_uzd_reg.v=12;
			}
			
			IoReg_Write32( SCALEDOWN_AccessData_CTRL_UZD_reg , reg_scaledown_accessdata_ctrl_uzd_reg.regValue );
			IoReg_Write32( SCALEDOWN_AccessData_PosCtrl_UZD_reg , reg_scaledown_accessdata_posctrl_uzd_reg.regValue );
			IoReg_Write32( SCALEDOWN_WriteData_DATA_UZD_reg , reg_scaledown_writedata_data_uzd_reg.regValue );
			//IoReg_Write32( MPEGNR_ICH1_MPEG_UB_X_client_reg , (scalerVIP_color_noise_mpeg_detect_y4&0x3ff) );
		}
		#endif
...
void scalerVIP_color_noise_mpeg_v_apply(void){
	...
	if(
		...
		if(apply__y_scaling!=scalerVIP_color_noise_mpeg_v_detect__y_scaling || nr_dch1_mpegnr1_r.cp_mpgidx_y!=scalerVIP_color_noise_mpeg_v_detect__amax1p[0][scalerVIP_color_noise_mpeg_v_detect__y_turn] )
		{
			// resolution different, decrease
			if(apply__detect_y>0)
			{
