...
void scalerVIP_DI_MiddleWare_MCNR_Ctrl2(unsigned char weight)
{
	...
	__attribute__((unused)) static int Vpan_flag_n=0;
	...
	UINT8 Pan_flag=0;
	__attribute__((unused)) UINT32	mv_index=0;
...
{
	short i = 0;
	__attribute__((unused)) unsigned char fadein_pass_total = 0, fadeout_pass_total = 0;
	unsigned int total_energy = 0;
...
void scalerVIP_colorMABeanDrop(unsigned char mode, unsigned int en_test)
{
	...
	__attribute__((unused)) unsigned char en_BeanTest = 0;
...
int scalerVIP_colorMABeerProblem(unsigned int en_test)
{
	...
	__attribute__((unused)) unsigned char en_BeerTest = 0;
