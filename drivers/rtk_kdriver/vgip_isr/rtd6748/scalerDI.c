...
#if 1
	if(cur_source == VIP_QUALITY_DTV_576I || cur_source == VIP_QUALITY_PVR_576I) // for 576i need more time to enter pan
        {
...
//		rtd_clearbits(DI_IM_DI_HMC_ADJUSTABLE_reg, _BIT17);
	...
	else
	{
		...
		di_hmc_adjustable4_reg.hmc_mv_refine_mor_hh_h_th = 20;
...
void scalerVIP_DI_MiddleWare_PAN_Apply(void)
{
	...
	{
		extern int a_film_topline_case[99];
		if( a_film_topline_case[35]>0 )
		{
			di_im_di_pan_detection_control_2_reg.pan_mc_teeth_check_en = 1;
		}
	}
	...
	if (pre_reg_mv_avg !=di_im_di_hmc_pan_control_reg.pan_me_fw_control_motion_vector) {
	...
	pre_reg_mv_avg = di_im_di_hmc_pan_control_reg.pan_me_fw_control_motion_vector;
...
{
	static unsigned char film32_debounce_FieldNum = 0x5;
	static unsigned char film22_debounce_FieldNum = 0x5;
	...
	if(	im_di_si_film_motion_reg.film_motionstatus_399_380 == 0 &&
		...
		im_di_film_motion_sum_th_reg.film32_debounce_fieldnum = 0x5;
		im_di_film_motion_sum_th_reg.film22_debounce_fieldnum = 0x5;
