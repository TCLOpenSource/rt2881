...
#include "rbus/rtk_dtv_demod_dtmb_reg.h"
...
int REALTEK_R_DTMB_Init(DEMOD* pDemodKernel)
{
	...
	rtd_maskl(RTK_DTV_DEMOD_SYS_DEMOD_SEL_reg, ~RTK_DTV_DEMOD_SYS_DEMOD_SEL_demod_sel_mask, RTK_DTV_DEMOD_SYS_DEMOD_SEL_demod_sel(0x0)); //[1:0]demod_sel, 0x0: DTMB
...
int REALTEK_R_DTMB_AcquireSignalThread(DEMOD* pDemodKernel)
{
	...
	unsigned int maxCorr = 0, peakSaveR = 0, aveSaveR = 0, papr10 = 0, TpsLockStatus = 0, hiSnrTpsLockCnt = 0;
	...
	maxCorr = (RTK_DTV_DEMOD_DTMB_MAX_CORR_1_get_max_corr_15_8(rtd_inl(RTK_DTV_DEMOD_DTMB_MAX_CORR_1_reg)) << 8) | (RTK_DTV_DEMOD_DTMB_MAX_CORR_0_get_max_corr_7_0(rtd_inl(RTK_DTV_DEMOD_DTMB_MAX_CORR_0_reg)));
	if ((no_signal == 0) && (maxCorr < 0x20 * 16)) {
		peakSaveR = (RTK_DTV_DEMOD_DTMB_AVE_PWR_R_2_get_peak_save_r_20_18(rtd_inl(RTK_DTV_DEMOD_DTMB_AVE_PWR_R_2_reg)) << 18) | (RTK_DTV_DEMOD_DTMB_PEAK_SAVE_R_2_get_peak_save_r_17_10(rtd_inl(RTK_DTV_DEMOD_DTMB_PEAK_SAVE_R_2_reg)) << 10) | (RTK_DTV_DEMOD_DTMB_PEAK_SAVE_R_1_get_peak_save_r_9_2(rtd_inl(RTK_DTV_DEMOD_DTMB_PEAK_SAVE_R_1_reg)) << 2) | (RTK_DTV_DEMOD_DTMB_AVE_SAVE_PEAK_SAVE_R_get_peak_save_r_1_0(rtd_inl(RTK_DTV_DEMOD_DTMB_AVE_SAVE_PEAK_SAVE_R_reg)));
		aveSaveR = (RTK_DTV_DEMOD_DTMB_RX_MODE_MD_BACQ_LOCK_R_get_ave_save_r_16_14(rtd_inl(RTK_DTV_DEMOD_DTMB_RX_MODE_MD_BACQ_LOCK_R_reg)) << 14) | (RTK_DTV_DEMOD_DTMB_AVE_SAVE_PEAK_SAVE_R_get_ave_save_r_13_8(rtd_inl(RTK_DTV_DEMOD_DTMB_AVE_SAVE_PEAK_SAVE_R_reg)) << 8) | (RTK_DTV_DEMOD_DTMB_AVE_SAVE_R_0_get_ave_save_r_7_0(rtd_inl(RTK_DTV_DEMOD_DTMB_AVE_SAVE_R_0_reg)));
