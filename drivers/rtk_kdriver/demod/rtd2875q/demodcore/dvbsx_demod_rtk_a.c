...
#include "rbus/atb_demod_dvbs_reg.h"
#include "rbus/pll27x_reg_reg.h"
#include "rbus/dtv_demod_misc_reg.h"
#include "rbus/atb_demod_dvbsnew_reg.h"
...
RTK_A_DVBSX_STATUS RTK_A_DVBSX_SetLdpc1p6XMaxIteration(DVBSX_DEMOD_MODULE *pDemod, unsigned int symbolrate, unsigned int acq_mode)
{
	...
	if(status == RTK_DEMOD_SUCCESSFUL && u8DVBSxMode == RTK_DEMOD_DVBS2_MODE && symbolrate > 19900) /*DVB-S2/S2X mode && SR > 19.9M*/
	{
		...
		if(u8ISINumber != 1)
		{
			...
			if(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_get_s2x_ldpc_config_iter_5_0(rtd_inl(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_reg)) != 0x0 || ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_get_s2x_ldpc_config_flag(rtd_inl(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_reg)) != 0x0 || SYS_REG_SYS_CLKDIV_get_dtv_demod_atb_clk_sel(rtd_inl(SYS_REG_SYS_CLKDIV_reg)) != SYS_REG_SYS_CLKDIV_dtv_demod_atb_clk_sel_mask)
			{
				REALTEK_A_DVBSX_INFO("Set Reg\n");
				rtd_maskl(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_reg, ~(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_s2x_ldpc_config_iter_5_0_mask), ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_s2x_ldpc_config_iter_5_0(0x0));
				rtd_maskl(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_reg, ~(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_s2x_ldpc_config_flag_mask), ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_s2x_ldpc_config_flag(0));
		...
		for(u8i = 0; u8i < DVBSX_LDPC_ITERATION_TABLE_SIZE; u8i++)
		{
				...
				sDvbSxLdpcIterationTable[u8i].DVBS2X_CodeRate == stDVBSxParams.DVBS2XCodeRate)
			{
				...
				if(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_get_s2x_ldpc_config_iter_5_0(rtd_inl(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_reg)) != NewMaxIterationNumber || ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_get_s2x_ldpc_config_flag(rtd_inl(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_reg)) != 0x1 || SYS_REG_SYS_CLKDIV_get_dtv_demod_atb_clk_sel(rtd_inl(SYS_REG_SYS_CLKDIV_reg)) != 0x0)
				{
					REALTEK_A_DVBSX_INFO("Set Reg, Pre MaxIter = %u, Change MaxIterationNumber(Max 63): %u => %u\n", ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_get_s2x_ldpc_config_iter_5_0(rtd_inl(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_reg)), MaxIterationNumber, NewMaxIterationNumber);
					rtd_maskl(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_reg, ~(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_s2x_ldpc_config_iter_5_0_mask), ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_ITER_5_0_s2x_ldpc_config_iter_5_0(NewMaxIterationNumber));
					rtd_maskl(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_reg, ~(ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_s2x_ldpc_config_flag_mask), ATB_DEMOD_LDPC_S2X_LDPC_CONFIG_FLAG_s2x_ldpc_config_flag(1));
...
RTK_A_DVBSX_STATUS RTK_A_DVBSX_PilotTrackingAdjust(DVBSX_DEMOD_MODULE *pDemod, unsigned int symbolrate)
{
	...
	//REALTEK_A_DVBSX_INFO("Check Maxnum = %u SNR=%d \n", rtd_inl(ATB_DEMOD_LDPC_LDPC_ITER_NUM_5_0_reg), Snr);
	return ui8Status;
}
