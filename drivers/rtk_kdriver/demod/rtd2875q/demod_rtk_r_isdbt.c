...
int RTK_R_ISDBT_GetSignalInfo(DEMOD* pDemodKernel, TV_SIG_INFO* pInfo)
{
	...
	RTK_R_ISDB_INFO("GetSignalInfo, FFT = %d, GI = %d, Seg = %d/%d/%d, MaxSeglayer = %d, [A]MODU = %d, CR = %d, [B]MODU = %d, CR = %d, [C]MODU = %d, CR = %d\n",
		pInfo->isdbt.trans_mode, pInfo->isdbt.guard_interval, pInfo->isdbt.layer[ISDBT_HIERARCHICAL_LAYER_A].segment_num, pInfo->isdbt.layer[ISDBT_HIERARCHICAL_LAYER_B].segment_num, pInfo->isdbt.layer[ISDBT_HIERARCHICAL_LAYER_C].segment_num, MaxSeglayer,
		pInfo->isdbt.layer[ISDBT_HIERARCHICAL_LAYER_A].constellation, pInfo->isdbt.layer[ISDBT_HIERARCHICAL_LAYER_A].code_rate,
		pInfo->isdbt.layer[ISDBT_HIERARCHICAL_LAYER_B].constellation, pInfo->isdbt.layer[ISDBT_HIERARCHICAL_LAYER_B].code_rate,
		pInfo->isdbt.layer[ISDBT_HIERARCHICAL_LAYER_C].constellation, pInfo->isdbt.layer[ISDBT_HIERARCHICAL_LAYER_C].code_rate
		);
	pDemodKernel->Unlock(pDemodKernel);
...
#endif
		pQuality->snr = SnrNum * 10000 / SnrDen;
		RTK_R_ISDB_INFO("\033[1;32;32m""SNR = "PT_U32BITS", AGC = "PT_U32BITS", ISDBT_layer = %d, BerNum = "PT_U32BITS", PerNum = "PT_U32BITS"\n""\033[m", pQuality->snr, pQuality->agc, MaxSeglayer , BerNum, PerNum);
		break;
