...
#include "rbus/atb_demod_freq_reg.h"
...
)
{
	...
	rtd_maskl(ATB_DEMOD_FREQ_LDPC_CFG_EN_0_reg, ~ATB_DEMOD_FREQ_LDPC_CFG_EN_0_ldpc_cfg_en_0_mask, ATB_DEMOD_FREQ_LDPC_CFG_EN_0_ldpc_cfg_en_0(0x0));	//Set ldpc_cfg_en = 0
	rtd_maskl(ATB_DEMOD_FREQ_LDPC_CFG_ADDR_7_0_reg, ~ATB_DEMOD_FREQ_LDPC_CFG_ADDR_7_0_ldpc_cfg_addr_7_0_mask, ATB_DEMOD_FREQ_LDPC_CFG_ADDR_7_0_ldpc_cfg_addr_7_0(0x2F));	//Set ldpc_cfg_adr = 47
	rtd_maskl(ATB_DEMOD_FREQ_LDPC_CFG_DAT_7_0_reg, ~ATB_DEMOD_FREQ_LDPC_CFG_DAT_7_0_ldpc_cfg_dat_7_0_mask, ATB_DEMOD_FREQ_LDPC_CFG_DAT_7_0_ldpc_cfg_dat_7_0(0x1));	//Set ldpc_cfg_dat = 1
	rtd_maskl(ATB_DEMOD_FREQ_LDPC_CFG_EN_0_reg, ~ATB_DEMOD_FREQ_LDPC_CFG_EN_0_ldpc_cfg_en_0_mask, ATB_DEMOD_FREQ_LDPC_CFG_EN_0_ldpc_cfg_en_0(0x1));	//Set ldpc_cfg_en = 1
