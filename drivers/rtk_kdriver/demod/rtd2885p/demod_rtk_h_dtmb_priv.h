...
//--------------------------------------------------------------------------
static const REG_VALUE_ENTRY_RBUS MXL661_OPT_VALUE_DTMB_H[] = {
	// RegBitName,              Value
	{DTMB_H_AAGC_TARGET_reg,             0xB4    },     // Default 0xA4, change to 0xB4
};
static const REG_VALUE_ENTRY_RBUS R840_OPT_VALUE_DTMB_H[] = {
	// RegBitName,              Value
	{DTMB_H_AAGC_TARGET_reg,             0xB4    },     // Default 0xA4, change to 0xB4
};
static const REG_VALUE_ENTRY_RBUS TDA18275A_OPT_VALUE_DTMB_H[] = {
	// RegBitName,              Value
	{DTMB_H_AAGC_TARGET_reg,             0xB4    },     // Default 0xA4, change to 0xB4
};
static const REG_VALUE_ENTRY_RBUS SI2151_OPT_VALUE_DTMB_H[] = {
	// RegBitName,              Value
	{DTMB_H_AAGC_TARGET_reg,             0xB4    },     // Default 0xA4, change to 0xB4
};
static const REG_VALUE_ENTRY_RBUS SUTRX243_OPT_VALUE_DTMB_H[] = {
	// RegBitName,              Value
	{DTMB_H_AAGC_TARGET_reg,             0xA8    },     // Default 0xA4, change to 0xA8
};
static const REG_VALUE_ENTRY_RBUS ATBM253_OPT_VALUE_DTMB_H[] = {
	// RegBitName,              Value
	{DTMB_H_AAGC_TARGET_reg,             0xB4    },     // Default 0xA4, change to 0xB4
};
