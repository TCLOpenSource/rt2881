...
UINT8 DTMBIP_GetSignalSNRSC(S32BITS *SignalSNR)
{
	...
	if (Pnmode == DTMB_H_PN_945) {
		PnValue = 945;
	} else if (Pnmode == DTMB_H_PN_595) {
		PnValue = 595;
	} else if (Pnmode == DTMB_H_PN_420) {
		PnValue = 420;
	}
...
UINT8 DTMBIP_GetSignalSNR(S32BITS *SignalSNR)
{
	...
	if (CarrierMode == DTMB_H_CARRIER_SINGLE) {
		DTMBIP_GetSignalSNRSC(SignalSNR);
	} else if (CarrierMode == DTMB_H_CARRIER_MULTI) {
