...
int  realtek_r_atsc3_LDM_EnhancedLayerOnly_detect(
	ATSC3_DEMOD_MODULE * pDemod,
	unsigned char* enhancedOnlyFlag
);

int  realtek_r_atsc3_ctiDepth724_TiExtInter_detect(
	ATSC3_DEMOD_MODULE * pDemod, 
	unsigned char* flag,
	TV_ATSC3_PLP_ID* pAtsc3PlpAll,
	TV_ATSC3_PLP_ID* pAtsc3PlpLlsOnly
...
int  realtek_r_atsc3_L1D_plpSize_change_check(
	ATSC3_DEMOD_MODULE * pDemod 
);

int  realtek_r_atsc3_GI4864_SettingModify(
	ATSC3_DEMOD_MODULE * pDemod, 
	unsigned char* flag
);
