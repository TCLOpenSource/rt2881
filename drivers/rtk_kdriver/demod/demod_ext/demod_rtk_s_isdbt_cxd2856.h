#ifndef __DEMOD_CXD2856_S_ISDBT_H__
#define __DEMOD_CXD2856_S_ISDBT_H__
...
#define CXD2856_S_ISDBT_DBG(fmt, args...)        rtd_extdemod_print(KERN_DEBUG, "CXD2856_ISDBT_DEBUG, " fmt, ##args);
#define CXD2856_S_ISDBT_INFO(fmt, args...)       rtd_extdemod_print(KERN_INFO, "CXD2856_ISDBT_INFO, " fmt, ##args);
#define CXD2856_S_ISDBT_WARNING(fmt, args...)    rtd_extdemod_print(KERN_WARNING, "CXD2856_ISDBT_WARNING, " fmt, ##args);

#endif // __DEMOD_CXD2856_S_ISDBT_H__
