#ifndef __DEMOD_EXT_DEF_H__
#define __DEMOD_EXT_DEF_H__
...
typedef enum {
	...
	RTK_DEMOD_MODE_ATV,
	RTK_DEMOD_MODE_ISDBT_EXT,
	RTK_DEMOD_MODE_ISDBS_EXT,
	RTK_DEMOD_MODE_ISDBS3_EXT,
	RTK_DEMOD_MODE_MAX
} RTK_DEMOD_MODE;
