...
#include "demod/demod_ext/CXD2856Family_refcode/i2c/sony_i2c.h"
#include "./sony_dtv.h"
...
#define CXD2856_S_DEMOD_DBG(fmt, args...)        rtd_extdemod_print(KERN_DEBUG, "CXD2856_DEBUG, " fmt, ##args);
#define CXD2856_S_DEMOD_INFO(fmt, args...)       rtd_extdemod_print(KERN_INFO, "CXD2856_INFO, " fmt, ##args);
#define CXD2856_S_DEMOD_WARNING(fmt, args...)    rtd_extdemod_print(KERN_WARNING, "CXD2856_WARNING, " fmt, ##args);
