...
#include "demod/demod_ext/CXD2856Family_refcode/isdb_terr/sony_demod_isdbt.h"
#endif
...
#include "demod/demod_ext/CXD2856Family_refcode/isdb_sat/sony_demod_isdbs.h"
#endif

#ifdef SONY_DEMOD_SUPPORT_ISDBS3
#include "demod/demod_ext/CXD2856Family_refcode/isdb_sat/sony_demod_isdbs3.h"
#endif
...
sony_result_t sony_demod_Initialize (sony_demod_t * pDemod)
{
	...
	CXD2856_S_DEMOD_INFO("pDemod->chipId = 0x%x", pDemod->chipId);
...
sony_result_t sony_demod_Switch_TS_Output(sony_demod_t * pDemod, uint32_t on_off)
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER("sony_demod_Switch_TS_Output");
...
sony_result_t sony_demod_Get_TS_Output(sony_demod_t * pDemod, uint32_t* on_off)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
    SONY_TRACE_ENTER("sony_demod_Get_TS_Output");
