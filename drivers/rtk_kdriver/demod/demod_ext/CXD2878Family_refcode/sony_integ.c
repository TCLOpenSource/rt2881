...
/*------------------------------------------------------------------------------
 Functions
------------------------------------------------------------------------------*/
sony_result_t CXD2878_integ_Create (sony_integ_t * pInteg,
                                 sony_demod_t * pDemod,
                                 ...
                                 )
{
    ...
    result = CXD2878_demod_Create (pDemod, pCreateParam, pDemodI2c);
    ...
    CXD2878_integ_ClearCancel (pInteg);

    SONY_TRACE_RETURN (result);
}

sony_result_t CXD2878_integ_Initialize (sony_integ_t * pInteg)
{
    sony_result_t result = SONY_RESULT_OK;
    ...
    result = CXD2878_demod_Initialize (pInteg->pDemod);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (result);
    }

    /* Enable the I2C repeater */
    result = CXD2878_demod_I2cRepeaterEnable (pInteg->pDemod, 0x01);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (result);
    }
    ...
    result = CXD2878_demod_I2cRepeaterEnable (pInteg->pDemod, 0x00);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (result);
    }
...
sony_result_t CXD2878_integ_Sleep (sony_integ_t * pInteg)
{
    sony_result_t result = SONY_RESULT_OK;
    ...
    result = CXD2878_demod_Sleep (pInteg->pDemod);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (result);
    }
...
sony_result_t CXD2878_integ_Shutdown (sony_integ_t * pInteg)
{
    sony_result_t result = SONY_RESULT_OK;
    ...
    result = CXD2878_demod_Shutdown (pInteg->pDemod);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (result);
    }
...
sony_result_t CXD2878_integ_Cancel (sony_integ_t * pInteg)
{
...
sony_result_t CXD2878_integ_ClearCancel (sony_integ_t * pInteg)
{
...
sony_result_t CXD2878_integ_CheckCancellation (sony_integ_t * pInteg)
{
