...
#include "demod/demod_ext/CXD2878Family_refcode/lib/sony_math.h"
...
/*------------------------------------------------------------------------------
 Functions
------------------------------------------------------------------------------*/
sony_result_t CXD2878_demod_isdbt_monitor_SyncStat (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbt_monitor_IFAGCOut (sony_demod_t * pDemod,
                                                 uint32_t * pIFAGCOut)
{
    uint8_t rdata[2];
...
sony_result_t CXD2878_demod_isdbt_monitor_ModeGuard (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbt_monitor_CarrierOffset (sony_demod_t * pDemod,
                                                      int32_t * pOffset)
{
    ...
    *pOffset = CXD2878_Convert2SComplement(iregCrcgCtrlval, 29);
...
sony_result_t CXD2878_demod_isdbt_monitor_PreRSBER (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbt_monitor_PacketErrorNumber (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbt_monitor_SpectrumSense (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbt_monitor_SNR (sony_demod_t * pDemod,
                                            int32_t * pSNR)
{
    ...
    *pSNR = 100 * (int32_t)CXD2878_math_log10(iregSnmonOd) - 9031;

    SONY_TRACE_RETURN (result);
}

sony_result_t CXD2878_demod_isdbt_monitor_SamplingOffset (sony_demod_t * pDemod,
                                                      int32_t * pPPM)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t CXD2878_demod_isdbt_monitor_PER (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbt_monitor_TSRate (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbt_monitor_PresetInfo(sony_demod_t*                   pDemod,
...
sony_result_t CXD2878_demod_isdbt_monitor_TMCCInfo(sony_demod_t*           pDemod,
...
sony_result_t CXD2878_demod_isdbt_monitor_ACEEWInfo(sony_demod_t * pDemod,
                                                 uint8_t * pIsExist,
...
sony_result_t CXD2878_demod_isdbt_monitor_EWSChange (sony_demod_t * pDemod,
                                                  uint8_t * pEWSChange)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
...
sony_result_t CXD2878_demod_isdbt_monitor_TMCCChange (sony_demod_t * pDemod,
                                                   uint8_t * pTMCCChange)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
...
sony_result_t CXD2878_demod_isdbt_ClearEWSChange (sony_demod_t * pDemod)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t CXD2878_demod_isdbt_ClearTMCCChange (sony_demod_t * pDemod)
{
    sony_result_t result = SONY_RESULT_OK;
...
static sony_result_t IsDmdLocked(sony_demod_t* pDemod)
{
    ...
    result = CXD2878_demod_isdbt_monitor_SyncStat(pDemod, &dmdLock, &tsLock, &unlock);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN(result);
    }
...
static sony_result_t setTmccInfo(uint8_t* pData, sony_isdbt_tmcc_info_t* pTmccInfo)
{
    ...
    /* System */
    pTmccInfo->systemId = (sony_isdbt_system_t)CXD2878_BitSplitFromByteArray(pData, 0, 2);
    /* Count down index Bit 2-5 */
    pTmccInfo->countDownIndex = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 2, 4);
    /* EWS flag Bit 6 */
    pTmccInfo->ewsFlag = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 6, 1);


    /* Current Info Bit 7 */
    pTmccInfo->currentInfo.isPartial = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 7, 1);

    /* Layer-A Modulation Bit 8-10 */
    pTmccInfo->currentInfo.layerA.modulation = (sony_isdbt_modulation_t)CXD2878_BitSplitFromByteArray(pData, 8, 3);
    /* Layer-A Code rate Bit 11-13 */
    pTmccInfo->currentInfo.layerA.codingRate = (sony_isdbt_coding_rate_t)CXD2878_BitSplitFromByteArray(pData, 11, 3);
    /* Layer-A Interleave Bit 14-16 */
    pTmccInfo->currentInfo.layerA.ilLength = (sony_isdbt_il_length_t)CXD2878_BitSplitFromByteArray(pData, 14, 3);
    /* Layer-A Segment Num 17-20 */
    pTmccInfo->currentInfo.layerA.segmentsNum = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 17, 4);


    /* Layer-B Modulation Bit 21-23 */
    pTmccInfo->currentInfo.layerB.modulation = (sony_isdbt_modulation_t)CXD2878_BitSplitFromByteArray(pData, 21, 3);
    /* Layer-B Code rate Bit 24-26 */
    pTmccInfo->currentInfo.layerB.codingRate = (sony_isdbt_coding_rate_t)CXD2878_BitSplitFromByteArray(pData, 24, 3);
    /* Layer-B Interleave Bit 27-29 */
    pTmccInfo->currentInfo.layerB.ilLength = (sony_isdbt_il_length_t)CXD2878_BitSplitFromByteArray(pData, 27, 3);
    /* Layer-B Segment Num 30-33 */
    pTmccInfo->currentInfo.layerB.segmentsNum = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 30, 4);


    /* Layer-C Modulation Bit 34-36 */
    pTmccInfo->currentInfo.layerC.modulation = (sony_isdbt_modulation_t)CXD2878_BitSplitFromByteArray(pData, 34, 3);
    /* Layer-C Code rate Bit 37-39 */
    pTmccInfo->currentInfo.layerC.codingRate = (sony_isdbt_coding_rate_t)CXD2878_BitSplitFromByteArray(pData, 37, 3);
    /* Layer-C Interleave Bit 40-42 */
    pTmccInfo->currentInfo.layerC.ilLength = (sony_isdbt_il_length_t)CXD2878_BitSplitFromByteArray(pData, 40, 3);
    /* Layer-C Segment Num 43-46 */
    pTmccInfo->currentInfo.layerC.segmentsNum = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 43, 4);


    /* Next 47 */
    pTmccInfo->nextInfo.isPartial = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 47, 1);

    /* Layer-A Modulation Bit 48-50 */
    pTmccInfo->nextInfo.layerA.modulation = (sony_isdbt_modulation_t)CXD2878_BitSplitFromByteArray(pData, 48, 3);
    /* Layer-A Code rate Bit 51-53 */
    pTmccInfo->nextInfo.layerA.codingRate = (sony_isdbt_coding_rate_t)CXD2878_BitSplitFromByteArray(pData, 51, 3);
    /* Layer-A Interleave Bit 54-56 */
    pTmccInfo->nextInfo.layerA.ilLength = (sony_isdbt_il_length_t)CXD2878_BitSplitFromByteArray(pData, 54, 3);
    /* Layer-A Segment Num 57-60 */
    pTmccInfo->nextInfo.layerA.segmentsNum = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 57, 4);


    /* Layer-B Modulation Bit 61-63 */
    pTmccInfo->nextInfo.layerB.modulation = (sony_isdbt_modulation_t)CXD2878_BitSplitFromByteArray(pData, 61, 3);
    /* Layer-B Code rate Bit 64-66 */
    pTmccInfo->nextInfo.layerB.codingRate = (sony_isdbt_coding_rate_t)CXD2878_BitSplitFromByteArray(pData, 64, 3);
    /* Layer-B Interleave Bit 67-69 */
    pTmccInfo->nextInfo.layerB.ilLength = (sony_isdbt_il_length_t)CXD2878_BitSplitFromByteArray(pData, 67, 3);
    /* Layer-B Segment Num 70-73 */
    pTmccInfo->nextInfo.layerB.segmentsNum = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 70, 4);


    /* Layer-C Modulation Bit 74-76 */
    pTmccInfo->nextInfo.layerC.modulation = (sony_isdbt_modulation_t)CXD2878_BitSplitFromByteArray(pData, 74, 3);
    /* Layer-C Code rate Bit 77-79 */
    pTmccInfo->nextInfo.layerC.codingRate = (sony_isdbt_coding_rate_t)CXD2878_BitSplitFromByteArray(pData, 77, 3);
    /* Layer-C Interleave Bit 80-82 */
    pTmccInfo->nextInfo.layerC.ilLength = (sony_isdbt_il_length_t)CXD2878_BitSplitFromByteArray(pData, 80, 3);
    /* Layer-C Segment Num 83-86 */
    pTmccInfo->nextInfo.layerC.segmentsNum = (uint8_t)CXD2878_BitSplitFromByteArray(pData, 83, 4);
                                          ...
                                          uint8_t * pLayerCExist)
{
    ...
    /* Layer-A Modulation Bit 8-10 */
    mod = (sony_isdbt_modulation_t) CXD2878_BitSplitFromByteArray (data, 8 - 8, 3);
    *pLayerAExist = (mod == SONY_ISDBT_MODULATION_UNUSED_7) ? 0 : 1;

    /* Layer-B Modulation Bit 21-23 */
    mod = (sony_isdbt_modulation_t) CXD2878_BitSplitFromByteArray (data, 21 - 8, 3);
    *pLayerBExist = (mod == SONY_ISDBT_MODULATION_UNUSED_7) ? 0 : 1;

    /* Layer-C Modulation Bit 34-36 */
    mod = (sony_isdbt_modulation_t) CXD2878_BitSplitFromByteArray (data, 34 - 8, 3);
