...
/*------------------------------------------------------------------------------
 Functions
------------------------------------------------------------------------------*/
sony_result_t CXD2878_demod_isdbt_Tune (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbt_EWSTune (sony_demod_t * pDemod,
                                        sony_isdbt_tune_param_t * pTuneParam)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t CXD2878_demod_isdbt_Sleep (sony_demod_t * pDemod)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t CXD2878_demod_isdbt_EWSTuneEnd (sony_demod_t * pDemod)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t CXD2878_demod_isdbt_CheckDemodLock (sony_demod_t * pDemod,
                                               sony_demod_lock_result_t * pLock)
{
    ...
    *pLock = SONY_DEMOD_LOCK_RESULT_NOTDETECT;
    ...
    result = CXD2878_demod_isdbt_monitor_SyncStat (pDemod, &dmdlock, &tslock, &unlockDetected);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (result);
    }
...
sony_result_t CXD2878_demod_isdbt_CheckTSLock (sony_demod_t * pDemod,
                                            sony_demod_lock_result_t * pLock)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t CXD2878_demod_isdbt_SetPreset (sony_demod_t * pDemod,
...
static sony_result_t SLtoAIT(sony_demod_t * pDemod)
{
    ...
    if (CXD2878_i2c_SetRegisterBits (pDemod->pI2c, pDemod->i2cAddressSLVT, 0x80, 0x08, 0x1F) != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (SONY_RESULT_ERROR_I2C);
    }
...
static sony_result_t SLtoEWS(sony_demod_t * pDemod)
{
    ...
    if (CXD2878_i2c_SetRegisterBits (pDemod->pI2c, pDemod->i2cAddressSLVT, 0x80, 0x0F, 0x1F) != SONY_RESULT_OK) {
        SONY_TRACE_RETURN (SONY_RESULT_ERROR_I2C);
    }
