...
/*----------------------------------------------------------------------------
  Functions
----------------------------------------------------------------------------*/
sony_result_t CXD2878_demod_isdbs_monitor_SyncStat (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbs_monitor_CarrierOffset (sony_demod_t * pDemod,
                                                      int32_t * pOffset)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t data[3];
...
sony_result_t CXD2878_demod_isdbs_monitor_IFAGCOut (sony_demod_t * pDemod,
                                                 uint32_t * pIFAGCOut)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t data[2] = {0, 0};
...
sony_result_t CXD2878_demod_isdbs_monitor_CNR (sony_demod_t * pDemod,
                                            int32_t * pCNR)
{
...
sony_result_t CXD2878_demod_isdbs_monitor_PER (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbs_monitor_ModCod (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbs_monitor_PreRSBER (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbs_monitor_TMCCInfo (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbs_monitor_SlotNum (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbs_monitor_SiteDiversityInfo (sony_demod_t * pDemod,
...
sony_result_t CXD2878_demod_isdbs_monitor_EWSChange (sony_demod_t * pDemod,
                                                  uint8_t * pEWSChange)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
...
sony_result_t CXD2878_demod_isdbs_monitor_TMCCChange (sony_demod_t * pDemod,
                                                   uint8_t * pTMCCChange)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
...
sony_result_t CXD2878_demod_isdbs_ClearEWSChange (sony_demod_t * pDemod)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t CXD2878_demod_isdbs_ClearTMCCChange (sony_demod_t * pDemod)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t CXD2878_demod_isdbs_monitor_TSIDError (sony_demod_t * pDemod, uint8_t * pTSIDError)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
...
sony_result_t CXD2878_demod_isdbs_monitor_LowCN (sony_demod_t * pDemod,
                                              uint8_t * pLowCN)
{
    uint8_t rdata[4];
...
sony_result_t CXD2878_demod_isdbs_ClearLowCN (sony_demod_t * pDemod)
{
