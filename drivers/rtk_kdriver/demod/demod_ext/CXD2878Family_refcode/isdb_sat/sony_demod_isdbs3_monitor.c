...
/*----------------------------------------------------------------------------
  Functions
----------------------------------------------------------------------------*/
sony_result_t CXD2878_demod_isdbs3_monitor_SyncStat (sony_demod_t * pDemod,
                                                  ...
                                                  uint8_t * pTMCCLockStat)
{
    ...
    uint8_t data[2];
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_SyncStat");
	...
	//CXD2878_S_DEMOD_INFO("isdbs3 TMCC = %u TLVLock = %u", (data[1] & 0x80), (data[1] & 0x40));
...
sony_result_t CXD2878_demod_isdbs3_monitor_CarrierOffset (sony_demod_t * pDemod,
                                                       int32_t * pOffset)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t data[3];
    ...
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_CarrierOffset");
    ...
    cfrl_ctrlval = CXD2878_Convert2SComplement (regValue, 21);
...
sony_result_t CXD2878_demod_isdbs3_monitor_IFAGCOut (sony_demod_t * pDemod,
                                                  uint32_t * pIFAGCOut)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t data[2] = {0, 0};
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_IFAGCOut");
...
sony_result_t CXD2878_demod_isdbs3_monitor_IQSense (sony_demod_t * pDemod,
                                                 sony_demod_sat_iq_sense_t * pSense)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;

    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_IQSense");
...
sony_result_t CXD2878_demod_isdbs3_monitor_CNR (sony_demod_t * pDemod,
                                             int32_t * pCNR)
{
    ...
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_CNR");
    ...
    CXD2878_S_DEMOD_INFO("rdata[0] =  0x%x", rdata[0]);
    if ((rdata[0] & 0x01) == 0) {
...
sony_result_t CXD2878_demod_isdbs3_monitor_PreLDPCBER (sony_demod_t * pDemod,
                                                    uint32_t * pBERH, uint32_t * pBERL)
{
    ...
    uint32_t tempR = 0;
    int i = 0;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_PreLDPCBER");
...
sony_result_t CXD2878_demod_isdbs3_monitor_PreBCHBER (sony_demod_t * pDemod,
                                                   uint32_t * pBERH, uint32_t * pBERL)
{
    uint8_t rdata[3];
    uint8_t valid[2] = {0};
    ...
    uint32_t tempB = 0;
    int i = 0;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_PreBCHBER");
...
sony_result_t CXD2878_demod_isdbs3_monitor_PostBCHFER (sony_demod_t * pDemod,
                                                    uint32_t * pFERH, uint32_t * pFERL)
{
    ...
    uint32_t tempR = 0;
    int i = 0;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_PostBCHFER");
...
sony_result_t CXD2878_demod_isdbs3_monitor_ModCod (sony_demod_t * pDemod,
                                                ...
                                                sony_isdbs3_cod_t * pCodH, sony_isdbs3_cod_t * pCodL)
{
    ...
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_ModCod");
...
sony_result_t CXD2878_demod_isdbs3_monitor_ValidSlotNum (sony_demod_t * pDemod,
                                                      uint8_t * pSlotNumH, uint8_t * pSlotNumL)
{
    ...
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_ValidSlotNum");
...
sony_result_t CXD2878_demod_isdbs3_monitor_TMCCInfo (sony_demod_t * pDemod,
                                                  sony_isdbs3_tmcc_info_t * pTMCCInfo)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t data[240] = {0x00};
    uint32_t i = 0;
    SONY_TRACE_ENTER("CXD2878_demod_isdbs3_monitor_TMCCInfo");
...
sony_result_t CXD2878_demod_isdbs3_monitor_CurrentStreamModCodSlotNum (sony_demod_t *pDemod, sony_isdbs3_tmcc_info_t * pTmccInfo,
                                                                    sony_isdbs3_mod_t * pModH, sony_isdbs3_mod_t * pModL,
                                                                    sony_isdbs3_cod_t * pCodH, sony_isdbs3_cod_t * pCodL,
                                                                    uint8_t * pSlotNumH, uint8_t * pSlotNumL)
{
    ...
    SONY_TRACE_ENTER("CXD2878_demod_isdbs3_monitor_CurrentStreamModCodSlotNum");
...
sony_result_t CXD2878_demod_isdbs3_monitor_SiteDiversityInfo (sony_demod_t * pDemod,
                                                           uint8_t * pSiteDiversityInfo)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_SiteDiversityInfo");
...
sony_result_t CXD2878_demod_isdbs3_monitor_EWSChange (sony_demod_t * pDemod,
                                                   uint8_t * pEWSChange)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_EWSChange");
...
sony_result_t CXD2878_demod_isdbs3_monitor_TMCCChange (sony_demod_t * pDemod,
                                                    uint8_t * pTMCCChange)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_TMCCChange");
...
sony_result_t CXD2878_demod_isdbs3_ClearEWSChange (sony_demod_t * pDemod)
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_ClearEWSChange");
...
sony_result_t CXD2878_demod_isdbs3_ClearTMCCChange (sony_demod_t * pDemod)
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_ClearTMCCChange");
...
sony_result_t CXD2878_demod_isdbs3_monitor_StreamIDError (sony_demod_t * pDemod, uint8_t * pStreamIDError)
{
    sony_result_t result = SONY_RESULT_OK;
    uint8_t rdata = 0;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_StreamIDError");
...
sony_result_t CXD2878_demod_isdbs3_monitor_LowCN (sony_demod_t * pDemod,
                                               uint8_t * pLowCN)
{
    uint8_t rdata[5];
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_monitor_LowCN");
...
sony_result_t CXD2878_demod_isdbs3_ClearLowCN (sony_demod_t * pDemod)
{
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs3_ClearLowCN");
...
static sony_result_t IsDmdLocked(sony_demod_t* pDemod)
{
    ...
    result = CXD2878_demod_isdbs3_monitor_SyncStat(pDemod, &agcLock, &tstlvLock, &tmccLock);
    if (result != SONY_RESULT_OK) {
        SONY_TRACE_RETURN(result);
    }
