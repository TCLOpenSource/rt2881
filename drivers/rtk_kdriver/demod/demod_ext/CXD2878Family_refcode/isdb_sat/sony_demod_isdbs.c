...
/*------------------------------------------------------------------------------
 Functions
------------------------------------------------------------------------------*/
sony_result_t CXD2878_demod_isdbs_Tune (sony_demod_t * pDemod,
                                     sony_isdbs_tune_param_t * pTuneParam)
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("CXD2878_demod_isdbs_Tune");
...
sony_result_t CXD2878_demod_isdbs_Sleep (sony_demod_t * pDemod)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t CXD2878_demod_isdbs_CheckTSLock (sony_demod_t * pDemod,
