...
#include "demod/demod_ext/CXD2878Family_refcode/i2c/sony_i2c.h"
#include "./sony_dtv.h"
...
typedef enum {
    ...
    */
    ...
    /**
    @brief ATSC 3.0 PLP ID packet insertion setting for Multi PLP

        Values:
        - 0: Insert ALP packet (PLP ID included) every time (Default)
        - 3: No insersion
    */
    SONY_DEMOD_CONFIG_ATSC3_PLPID_PACKET_MPLP,
...
/**
 @brief Demod parameters for ::CXD2878_demod_Create().
*/
typedef struct {
    /**
...
/**
 ...
 @return SONY_RESULT_OK if successful.
*/
sony_result_t CXD2878_demod_TunerI2cEnable (sony_demod_t * pDemod,
                                         sony_demod_tuner_i2c_config_t tunerI2cConfig);
...
/**
 ...
 @return SONY_RESULT_OK if successful.
*/
sony_result_t CXD2878_demod_I2cRepeaterEnable (sony_demod_t * pDemod,
                                            uint8_t enable);
...
#define CXD2878_S_DEMOD_DBG(fmt, args...)        rtd_extdemod_print(KERN_DEBUG, "SDEMOD_DEBUG, " fmt, ##args);
#define CXD2878_S_DEMOD_INFO(fmt, args...)       rtd_extdemod_print(KERN_INFO, "SDEMOD_INFO, " fmt, ##args);
#define CXD2878_S_DEMOD_WARNING(fmt, args...)    rtd_extdemod_print(KERN_WARNING, "SDEMOD_WARNING, " fmt, ##args);
