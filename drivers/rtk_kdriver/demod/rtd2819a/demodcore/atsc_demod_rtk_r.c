...
)
{
	...
	static const INIT_REG_ENTRY InitRegTable[] = {
		...
		{0xd56f,		   3,		0,		0x0 			},// Burst Noise, [5]: opt_erasure_df, [4]: opt_erasure_num_fix, [3:0]opt_erasure_num, 0x2: enable
		{0xd572,		   7,		0,		0x14 			},// Monitoring CR offset diff, [7:0]cr_offset_dif_start_unit=0x14 (20ms)
		{0xd57f,		   0,		0,		0x1 			},// Monitoring CR offset diff, [0]cr_offset_dif_read_en, 0x1: enable
...
// ATSC Demod 8051 FW V2.D (B815C1D4 = 0x2d)
// fsm_cr_fmu/fsm_cr_pmu (st32,33,34), KTK-5745 patch, ADJ_DET, and FS2 range ML5 (LxE K-Six), 20190724
// CR offset diff. monitor (K-TwentyFour), 20230401
...
// fsm_cr_fmu/fsm_cr_pmu (st32,33,34), KTK-5745 patch, ADJ_DET, and FS2 range,
// CR flag SW mode ML7 (LxE K-Eight), 20210427
// REALTEK_R ATSC 8051 demod firmware code table
