...
int REALTEK_R_ATV_SetTVSysEx(DEMOD* pDemodKernel, TV_SYSTEM sys, const	TV_SIG_INFO *pSigInfo)
{
	...
	pRealtekAtv = (REALTEK_R_ATV*)(pDemodKernel->private_data);
	DEMOD_INFO("\033[1;32;31m" "REALTEK_R_ATV_SetTVSysEx() "PT_U32BITS"\n" "\033[m", pSigInfo->analog.freq);
	...
	DEMOD_INFO("\033[1;32;31m" "[SetTVSysEx] pAtvModule->video_mode = %u, pAtvModule->audio_mode = %d, pAtvModule->scan_mode = %d\n" "\033[m",
...
int REALTEK_R_ATV_GetCarrierOffset(DEMOD* pDemodKernel, S32BITS *pOffset)
{
	...
	*pOffset = drv_ifd_get_cr_offset_100hz() * 100;
	...
	DEMOD_INFO("\033[1;32;31m" "GetCarrierOffset= "PT_S32BITS"Hz\n" "\033[m", * pOffset);
	pDemodKernel->Unlock(pDemodKernel);
...
int REALTEK_R_ATV_KernelAutoTune(DEMOD *pDemodKernel, unsigned char *pProcessEnFlag) {
