...
#if (defined(CONFIG_MLD_KERNEL_PATCH) || (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 19, 2)) || defined(CONFIG_RTD299X_GKI))
...
check_bss:
	...
	if (rtw_to_roam(padapter) > 0) {
		...
		#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 12, 0)
		#if defined(CONFIG_MLD_KERNEL_PATCH) || defined(CONFIG_RTD299X_GKI)
