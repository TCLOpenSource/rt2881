...
static int cec_device_num = 0;
static cec_device_st cec_device_list[] = 
{
    { 0x00 , {0, 0, 0, 0}, "TV"           , "NONE", 0},
    { 0x01 , {0, 0, 0, 0}, "RECORD_1"     , "NONE", 0},
    { 0x02 , {0, 0, 0, 0}, "RECORD_2"     , "NONE", 0},
    { 0x03 , {0, 0, 0, 0}, "TUNER_1"      , "NONE", 0},
    { 0x04 , {0, 0, 0, 0}, "PLAYBACK_1"   , "NONE", 0},
    { 0x05 , {0, 0, 0, 0}, "AUDIOSYSTEM"  , "NONE", 0},
    { 0x06 , {0, 0, 0, 0}, "TUNER_2"      , "NONE", 0},
    { 0x07 , {0, 0, 0, 0}, "TUNER_3"      , "NONE", 0},
    { 0x08 , {0, 0, 0, 0}, "PLAYBACK_2"   , "NONE", 0},
    { 0x09 , {0, 0, 0, 0}, "RECORD_3"     , "NONE", 0},
    { 0x0A , {0, 0, 0, 0}, "TUNER_4"      , "NONE", 0},
    { 0x0B , {0, 0, 0, 0}, "PLAYBACK_3"   , "NONE", 0},
    { 0x0C , {0, 0, 0, 0}, "BACKUP_1"     , "NONE", 0},
    { 0x0D , {0, 0, 0, 0}, "BACKUP_2"     , "NONE", 0},
    { 0x0E , {0, 0, 0, 0}, "SPECIFIC"     , "NONE", 0},
};
...
void rtk_cec_get_device(cec_device_st device_list[])
{
    ...
    {
        device_list[index] = cec_device_list[index];
    }
}
...
{
    unsigned char i = 0;
    int cec_device_num = 0;

    for(i = 0; i<CEC_DEVICE_TOTAL_NUM; i++ )
    {
        if(cec_device_list[i].connect_st == 1)
            cec_device_num++;
    }

    return cec_device_num;
}
...
void rtk_cec_remove_device(unsigned char port)
{
    int index = 0;
    int addr_index = 0;
    char init_addr[4] = {0, 0, 0, 0};
    char init_osd[] = "NONE";
    unsigned char ui_port = port + 1;
    for (index=0; index<CEC_DEVICE_TOTAL_NUM; index++) 
    {
        if(cec_device_list[index].physical_addr[0] == ui_port)
        {
            strcpy(cec_device_list[index].osd_name, init_osd);
            for(addr_index = 0 ; addr_index < 4; addr_index++)
            {
               cec_device_list[index].physical_addr[addr_index] = init_addr[addr_index];
            }
            cec_device_list[index].connect_st = 0;
        }
    }
}
