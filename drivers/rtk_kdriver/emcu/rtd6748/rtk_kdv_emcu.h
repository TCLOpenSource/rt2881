...
#define EMCU_BT_WAKEUP_PIN_NAME        "PIN_BT_WAKEUP"
...
#define EMCU_RL_ON_POWER_NAME	   "PIN_RL_ON_SOC"	//for POWER BORAD
...
#define IDX_BT_WAKE_UP      (0xD0ULL)	//GPO for BT wake up pin
...
#define IO_TPYE_BT_WAKE         (IDX_BT_WAKE_UP << IDX_SHIFT)
...
#define PARAM_LEN_PWEN          12	//max pin count of power pin
