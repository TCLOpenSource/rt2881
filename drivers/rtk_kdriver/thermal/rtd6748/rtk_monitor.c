...
static void Kernal_ZqCalibration(void)
{
    ...
    if((test_mode & 0x2) == 0x2)   //[1]Main Enable
    {
        ...
        rtd_pr_zq_debug("update soc zq calibration data\n");
        {
            ...
            rtd_maskl(0xb80c9238, 0xfffffffc, 0x00000001);   //fw_set[1:0]=[01] read/write during refresh update
            rtd_maskl(0xb80ca238, 0xfffffffc, 0x00000001);   //fw_set[1:0]=[01] read/write during refresh update
            ...
            {             
                ...
                rtd_maskl(0xb80c9238, 0xfffffffc, 0x00000000);   //fw_set[1:0]=[00] read: no read / write:during refresh update
                rtd_maskl(0xb80ca238, 0xfffffffc, 0x00000000);   //fw_set[1:0]=[00] read: no read / write:during refresh update
            }
