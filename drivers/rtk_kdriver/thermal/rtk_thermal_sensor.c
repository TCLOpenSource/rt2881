...
{
#ifndef RTK_THERMAL_SETTING_FROM_HWSETTING
	...
	SET_THERMAL_SENSOR_1(THERMAL_TM_A(0x08e80000));
		...
		SET_THERMAL_SENSOR_1(THERMAL_TM_A(0x080A0000));
#else
...
#elif defined(CONFIG_ARCH_RTK2851A)
        SET_THERMAL_SENSOR_2(THERMAL_TM_OSR(0x1) | THERMAL_TM_CHOPEN(0x1) | THERMAL_TM_ADCCKSEL(0x1) |
                                         THERMAL_TM_B(0xDCC80091>>PLL_REG_TEMP_SENSOR_2_tm_b_shift));
#else
    SET_THERMAL_SENSOR_2(THERMAL_TM_OSR(0x1) | THERMAL_TM_CHOPEN(0x1) | THERMAL_TM_ADCCKSEL(0x1) |
    ...
    mdelay(8);
#else
	THERMAL_WARNING("Thermal setting from hwsetting\n");
#endif
