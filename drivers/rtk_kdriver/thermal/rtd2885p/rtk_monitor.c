...
static void ZQ_VREF_SET(unsigned int set_num)
{
	...
	if(set_num<=3) //SET0~3
	{
		...
		rtd_maskl(0xb80c91f4,0x0003ffff,0x92b80000); //Vref_range[27]=0:29%~92%,ZQ_Vref[26:21]=0x16->50%
		rtd_outl(0xb80c9130,0x04080c99); //[27]=1:zq auto update,[26:25]=2'b10:zclk/32,[19]=1:R240 external,zq_cal_cmd[7]=1
		rtd_outl(0xb80c923c,0x00000003); //update write delay tap
		udelay(10);
	}
	else  //SET4~7
	{
		...
		rtd_maskl(0xb80c91f4,0x0003ffff,0x96780000); //Vref_range[27]=0:29%~92%,ZQ_Vref[26:21]=0x33->80%
		rtd_outl(0xb80c9130,0x04080c19); //[27]=1:zq auto update,[26:25]=2'b10:zclk/32,[19]=1:R240 external,zq_cal_cmd[7]=0
		rtd_outl(0xb80c923c,0x00000003); //update write delay tap
		udelay(10);
...
static void DC2_ZQ_VREF_SET(unsigned int set_num)
{
	...
	if(set_num<=3) //SET0~3
	{
		...
		rtd_maskl(0xb80ca1f4,0x0003ffff,0x92b80000); //Vref_range[27]=0:29%~92%,ZQ_Vref[26:21]=0x16->50%
		rtd_outl(0xb80ca130,0x04080c99); //[27]=1:zq auto update,[26:25]=2'b10:zclk/32,[19]=1:R240 external,zq_cal_cmd[7]=1
		rtd_outl(0xb80ca23c,0x00000003); //update write delay tap
		udelay(10);
	}
	else  //SET4~7
	{
		...
		rtd_maskl(0xb80ca1f4,0x0003ffff,0x96780000); //Vref_range[27]=0:29%~92%,ZQ_Vref[26:21]=0x33->80%
		rtd_outl(0xb80ca130,0x04080c19); //[27]=1:zq auto update,[26:25]=2'b10:zclk/32,[19]=1:R240 external,zq_cal_cmd[7]=0
		rtd_outl(0xb80ca23c,0x00000003); //update write delay tap
		udelay(10);
