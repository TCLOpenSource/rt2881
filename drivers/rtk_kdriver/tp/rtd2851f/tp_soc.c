...
INT32 Tp_ENG_RawModeEnable( TPK_TP_ENGINE_T tp_id, BOOL enable)
{
        ...
        if(enable == 1){
            if(tp_id == TP_TP0)
                tp_dmy_b_reg.dmy = 0x04;
            if(tp_id == TP_TP1)
                tp_dmy_b_reg.dmy = 0x08;
            else if(tp_id == TP_TP2)
                tp_dmy_b_reg.dmy = 0x10;
            else if(tp_id == TP_TP3)
                tp_dmy_b_reg.dmy = 0x20;
            else
                tp_dmy_b_reg.dmy = 0x0;
        }else{
            tp_dmy_b_reg.dmy = 0x0;
        }
        WRITE_REG32(TP_TP_DMY_B_reg, tp_dmy_b_reg.regValue);
#endif
