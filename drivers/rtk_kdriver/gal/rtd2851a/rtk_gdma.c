...
#if IS_ENABLED(CONFIG_CUSTOMER_TV006) && IS_ENABLED(CONFIG_SUPPORT_SCALER)
...
= {
	...
	{ GDMA_AFBC1_DATA_SRAM_BASE_reg, 0 },
	{ GDMA_AFBC2_DATA_SRAM_BASE_reg, 0 },
#endif
...
//RTK mark for netfix
	...
	case GDMA_READ_UI_RESOLUTION:
	{
		...
		if((ui_re == UI_RESOLUTION_4K) || (ui_re ==UI_RESOLUTION_OTHER))
			...
			ui_resolution=1920;
		else if(ui_re == UI_RESOLUTION_720P)
			ui_resolution=1280;
