...
bool KGAL_NV12_StretchBlit_tee(KGAL_SURFACE_INFO_T *pSrcSurface, KGAL_RECT_T *pSrcRect, KGAL_SURFACE_INFO_T *pDstSurface, KGAL_RECT_T *pDstRect, KGAL_BLIT_FLAGS_T *pBlitFlags, KGAL_BLIT_SETTINGS_T *pBlitSettings, unsigned int src_c1_addr, unsigned int dst_c1_addr);
