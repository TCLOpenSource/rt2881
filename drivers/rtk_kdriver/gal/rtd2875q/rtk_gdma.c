...
#endif
#if (defined(CONFIG_ARCH_RTK288O) || defined(CONFIG_ARCH_RTK2875) || defined(CONFIG_ARCH_RTK2885M) || defined(CONFIG_ARCH_RTK6748) || defined(CONFIG_ARCH_RTK2875Q)) && defined(THRESHOLD_DETECT)
...
#if defined(CONFIG_ARCH_RTK288O) || defined(CONFIG_ARCH_RTK2875) || defined(CONFIG_ARCH_RTK2885M) || defined(CONFIG_ARCH_RTK6748) || defined(CONFIG_ARCH_RTK2875Q)
#else
...
void gdma_config_multi_seg(CONFIG_OSD_MULTI_SEG_PARA multi_seg, GDMA_DISPLAY_PLANE displane, unsigned char enable) 
{
	...
	if(enable)
	{
		...
		else
		{
			...
			if(O2_buffer_index ==0 )
			{
				buffer_offset = 0;
			}
			else
			{
				buffer_offset = 1112 +  (O2_buffer_index-1) *24;//1112 = FD4C - F8F4
			}
			gdma_afbc1_o_start_0_reg.addr = multi_seg.vir_top_addr;
			gdma_afbc1_o_end_0_reg.addr = multi_seg.vir_top_addr + multi_seg.buffer_size1;
			gdma_afbc1_t_start_0_reg.addr = multi_seg.phy_addr1;
			...
			buffer_offset = O2_buffer_index *24 ;
			gdma_afbc1_o_start_1_reg.addr = multi_seg.vir_top_addr + multi_seg.buffer_size1;
			gdma_afbc1_o_end_1_reg.addr = multi_seg.vir_top_addr + multi_seg.buffer_size1 + multi_seg.buffer_size2;
			gdma_afbc1_t_start_1_reg.addr = multi_seg.phy_addr2;
...
#if defined(CONFIG_ARCH_RTK287O) || defined(CONFIG_ARCH_RTK288O) || defined(CONFIG_ARCH_RTK2875) || defined(CONFIG_ARCH_RTK2885M) || defined(CONFIG_ARCH_RTK6748) || defined(CONFIG_ARCH_RTK2875Q)
#else
...
#if (defined(CONFIG_ARCH_RTK288O) || defined(CONFIG_ARCH_RTK6748) || defined(CONFIG_ARCH_RTK2875Q)) && defined(THRESHOLD_DETECT)
	unsigned int i;
#endif
...
#if !defined(CONFIG_ARCH_RTK2875) && !defined(CONFIG_ARCH_RTK2885M) && !defined(CONFIG_ARCH_RTK6748) && !defined(CONFIG_ARCH_RTK2875Q)
...
int GDMA_Debug(KADP_HAL_GAL_CTRL_T *data)
{
	...
	switch (data->type) {
		...
		{
			debug_multi_set.buffer_size1 = 1920*540*4;
			debug_multi_set.buffer_size2 = 1920*540*4;
		}
		break;
		default:
			break;
...
#if (defined(CONFIG_ARCH_RTK6748)) || defined(CONFIG_ARCH_RTK2875Q)
