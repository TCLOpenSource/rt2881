	...
	void*			pExtraParam)
{
	...
	if(pSeSourceProcInfo->trans_start_addr1 !=0 && pSeSourceProcInfo->trans_start_addr2 !=0)
	{
		
		se_ext_stch.WordMulti0.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti0.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti0.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_ADDR0 );

		se_ext_stch.WordMulti0_1.RegisterValue = pSeSourceProcInfo->ori_start_addr1;
		
		se_ext_stch.WordMulti1.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti1.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti1.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_ADDR1 );

		se_ext_stch.WordMulti1_1.RegisterValue = pSeSourceProcInfo->ori_end_addr1;
		
		se_ext_stch.WordMulti2.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti2.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti2.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_ADDR2 );

		se_ext_stch.WordMulti2_1.RegisterValue = pSeSourceProcInfo->trans_start_addr1;
		
		se_ext_stch.WordMulti3.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti3.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti3.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_ADDR3 );

		se_ext_stch.WordMulti3_1.RegisterValue = pSeSourceProcInfo->trans_end_addr1;
		
		se_ext_stch.WordMulti4.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti4.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti4.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_ADDR0 + 4);

		se_ext_stch.WordMulti4_1.RegisterValue = pSeSourceProcInfo->ori_start_addr2;
		
		se_ext_stch.WordMulti5.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti5.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti5.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_ADDR1 + 4);

		se_ext_stch.WordMulti5_1.RegisterValue = pSeSourceProcInfo->ori_end_addr2;
		
		se_ext_stch.WordMulti6.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti6.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti6.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_ADDR2 + 4);

		se_ext_stch.WordMulti6_1.RegisterValue = pSeSourceProcInfo->trans_start_addr2;
		
		se_ext_stch.WordMulti7.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti7.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti7.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_ADDR3 + 4);

		se_ext_stch.WordMulti7_1.RegisterValue = pSeSourceProcInfo->trans_end_addr2;
		
		se_ext_stch.WordMulti8.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti8.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti8.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_CTRL );

		se_ext_stch.WordMulti8_1.RegisterValue = 0x80000002;//enable[31] q0_r[1]
		
		se_ext_stch.WordMulti9.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti9.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti9.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_CTRL + 4);

		se_ext_stch.WordMulti9_1.RegisterValue = 0x80000002;
		
		se_ext_stch.WordMulti10.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti10.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti10.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_CTRL );

		se_ext_stch.WordMulti10_1.RegisterValue = 0;
		
		se_ext_stch.WordMulti11.OpCode = SEINFO_OPCODE_WRITE_REGISTER;
		se_ext_stch.WordMulti11.Clut = SEINFO_REGMODE_REGISTER;
		se_ext_stch.WordMulti11.RegisterAddress = (SEINFO_WRITEREG) (SEINFO_REG_MULTI_SEG_BUF_CTRL + 4);

		se_ext_stch.WordMulti11_1.RegisterValue = 0;
	}
	else
	{
		se_ext_stch.WordMulti0.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti0_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti1.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti1_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti2.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti2_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti3.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti3_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti4.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti4_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti5.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti5_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti6.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti6_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti7.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti7_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti8.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti8_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti9.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti9_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti10.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti10_1.RegisterValue = SEINFO_OPCODE_NOP;
		
		se_ext_stch.WordMulti11.OpCode = SEINFO_OPCODE_NOP;
		se_ext_stch.WordMulti11_1.RegisterValue = SEINFO_OPCODE_NOP;
	}
	...
	if (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8) {
		se_ext_stch.Word6.src1_tfbdc_lossy = pSeSourceProcInfo->uCompressionRatio;
	}
...
//-------------------------------------------------------------
	...
	if (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8) {
		se_ext_rop.Word6.src1_tfbdc_lossy = pSeSourceProcInfo->uCompressionRatio;
	}
...
//-------------------------------------------------------------
	...
	if (pEx->src1_format == SEINFO_EXT_COLOR_FORMAT_FBDC_U8U8U8U8) {
		se_ext_conv.Word6.src1_tfbdc_lossy = pSeSourceProcInfo->uCompressionRatio;
	}
