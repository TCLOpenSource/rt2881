...
typedef struct
{
	uint32_t	ori_start_addr1;	
	uint32_t	ori_end_addr1;
	uint32_t	trans_start_addr1;
	uint32_t	trans_end_addr1;
	uint32_t	ori_start_addr2;	
	uint32_t	ori_end_addr2;
	uint32_t	trans_start_addr2;
	uint32_t	trans_end_addr2;
} KGAL_MULTI_SETTINGS_T;
