...
typedef struct {
  ...
  UINT8 ntp_leap_indecator;
} DELIVERY_DELIVERY_NTP_T ;

typedef struct {
    DELIVERY_CHANNEL_T  ch ;
    UINT32  count;
    UINT32  pMapping_info;
} DELIVERY_DELIVERY_MAPPINT_INFO_COMPAT_T ;
...
#define DELIVERY_IOC_DELIVERY_GET_TLV_HWNTP         (_IOWR (DELIVERY_IOC_MAGIC, 109, DELIVERY_DELIVERY_TLV_NTP_T))
...
#define DELIVERY_IOC_DELIVERY_SET_TLV_FILTER        (_IOWR (DELIVERY_IOC_MAGIC, 115, DELIVERY_DELIVERY_TLV_FILTER_INFO_T))
#define DELIVERY_IOC_DELIVERY_GET_NTP               (_IOWR (DELIVERY_IOC_MAGIC, 116, DELIVERY_DELIVERY_NTP_T ))
#ifdef CONFIG_COMPAT
#define DELIVERY_IOC_DELIVERY_GET_MAPPINF_INFO      (_IOWR (DELIVERY_IOC_MAGIC, 117, DELIVERY_DELIVERY_MAPPINT_INFO_COMPAT_T))
#else
#define DELIVERY_IOC_DELIVERY_GET_MAPPINF_INFO      (_IOWR (DELIVERY_IOC_MAGIC, 117, DELIVERY_DELIVERY_MAPPINT_INFO_T ))
#endif

#define DELIVERY_IOC_MAXNR           120
