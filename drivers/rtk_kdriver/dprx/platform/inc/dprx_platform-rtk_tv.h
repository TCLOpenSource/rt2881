 ...
 * Format  : 
 *
 * Example : #define DP_FLOW_CFG			   (DP_IGNORE_DPCD_ERR_OFF)
 *****************************************************************/

// [63:63] DP_IGNORE_DSC_ERR
#define DP_IGNORE_DSC_ERR(x)           ((unsigned long long)(x & 0x1)<<63)
#define DP_IGNORE_DSC_ERR_OFF          DP_IGNORE_DSC_ERR(0)
#define DP_IGNORE_DSC_ERR_ON           DP_IGNORE_DSC_ERR(1)
#define DP_IGNORE_DSC_ERR_MASK         DP_IGNORE_DSC_ERR(1)
#define GET_DP_IGNORE_DSC_ERR(x)       ((x & DP_IGNORE_DSC_ERR_MASK)>>63)
