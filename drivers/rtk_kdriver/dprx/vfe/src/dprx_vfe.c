 ...
 *-----------------------------------------------*/
dprx_dev_t* dprx_vfe_create_dprx_adapter_by_config(DP_PORT_CFG* p_cfg, DP_FLOW_CFG* p_flow_cfg)
{
    ...
    case DP_TYPE_USB_TYPE_C:
        ...
        p_dev = create_rtk_dprx_adapter(p_cfg, p_flow_cfg);
        break;
#endif
 ...
 * Retn : int
 *-----------------------------------------------*/
int dprx_vfe_set_dolby_vision_check_mode_function(
    long (*fp)(unsigned char)
    )
{
    return set_dolby_vision_check_mode_function(fp);
}
#endif
