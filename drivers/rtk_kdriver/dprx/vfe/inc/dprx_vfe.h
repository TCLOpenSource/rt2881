...
extern unsigned char g_dprx_vfe_suspend_mode[MAX_DPRX_PORT];
 ...
 *-----------------------------------------------*/
extern dprx_dev_t* dprx_vfe_create_dprx_adapter_by_config(DP_PORT_CFG* p_cfg, DP_FLOW_CFG* p_flow_cfg);

extern dprx_dev_t* g_connected_dprx;

#ifdef CONFIG_SUPPORT_DOLBY_VISION_DP
extern int dprx_vfe_set_dolby_vision_check_mode_function(long (*fp)(unsigned char));
#endif
