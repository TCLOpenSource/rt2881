    ...
    )
{
    ...
    case MEASURE_ONMS1_MAIN:
        rtd_maskl(ONMS_onms1_ctrl_reg, ~(ONMS_onms1_ctrl_on1_htotal_of_th_mask |
        ...
        rtd_maskl(ONMS_onms1_ctrl_reg, ~(ONMS_onms1_ctrl_1_on1_vtotal_of_th_mask),ONMS_onms1_ctrl_1_on1_vtotal_of_th(1));
#endif
        break;
...
#if !defined(CONFIG_ARCH_RTK2819A)
        rtd_maskl(ONMS_onms3_ctrl_reg, ~(ONMS_onms3_ctrl_1_on3_vtotal_of_th_mask),ONMS_onms3_ctrl_1_on3_vtotal_of_th(1));
#endif
        break;
    default:
        //
