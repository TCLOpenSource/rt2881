                ...
                case MISC_UART_PINMUX_SWITCH:
                {
                        ...
                        switch(param)
                        {
                                case UART0_PINMUX_ENABLE:
                                        rtd_maskl(PINMUX_ST_GPIO_ST_CFG_0_reg, 0x0F0FFFFF, 0x60600000); //switch uart0 pinmux
                                        rtd_maskl(PINMUX_ST_Pin_Mux_Ctrl1_reg, 0xFFFFFFF0, 0x0); //switch uart rx src0 6:0x18060244[3:0] = 0x0
                                        break;
                                case UART1_PINMUX_ENABLE:
                                        rtd_maskl(PINMUX_ST_GPIO_ST_CFG_0_reg, 0x0F0FFFFF, 0x70700000); //switch uart1 pinmux
                                        rtd_maskl(PINMUX_ST_Pin_Mux_Ctrl2_reg, 0x0FFFFFFF, 0x10000000); //switch uart rx src1 7:0x18060248[31:28] = 0x1
                                        break;
                                case UART0_UART1_PINMUX_DISABLE:
                                        rtd_maskl(PINMUX_ST_GPIO_ST_CFG_0_reg, 0x0F0FFFFF, 0xF0F00000); //switch to GPIO pin
                                        break;
                                default:
