...
static int rtk_qos_load_mc_decoder_4k_ddr4_setting(void)
{
	...
	rtd_outl(0xb80c2a60,0x0984080e); //CH0
	rtd_outl(0xb80c2a64,0x5f005f00);
	rtd_outl(0xb80c2a68,0x80004008);
	rtd_outl(0xb80c2a6c,0x40004081);

	rtd_outl(0xb80c2a80,0x0984080e); //CH1
	rtd_outl(0xb80c2a84,0x7f007f00);
	rtd_outl(0xb80c2a88,0x80010008);
	rtd_outl(0xb80c2a8c,0x80008041);

	rtd_outl(0xb80c2aa0,0x0984080e); //CH2
	rtd_outl(0xb80c2aa4,0x7f007f00);
	rtd_outl(0xb80c2aa8,0x20004008);
	rtd_outl(0xb80c2aac,0x80020081);

	rtd_outl(0xb80c2ac0,0x0984080e); //CH3
	rtd_outl(0xb80c2ac4,0x7f007f00);
	rtd_outl(0xb80c2ac8,0x20004008);
	rtd_outl(0xb80c2acc,0x80020081);

	rtd_outl(0xb80c2ae0,0x09840802); //CH4
	rtd_outl(0xb80c2ae4,0x4e004e00);
	rtd_outl(0xb80c2ae8,0x80010008);
	rtd_outl(0xb80c2aec,0x60020061);

	rtd_outl(0xb80c2b00,0x09840802); //CH5
	rtd_outl(0xb80c2b04,0x4e004e00);
	rtd_outl(0xb80c2b08,0x80010008);
	rtd_outl(0xb80c2b0c,0x60020061);

	rtd_outl(0xb80c2b20,0x0984080e); //CH6
	rtd_outl(0xb80c2b24,0x4f004f00);
	rtd_outl(0xb80c2b28,0x80004008);
	rtd_outl(0xb80c2b2c,0x40004081);

	rtd_outl(0xb80c2b40,0x09840800); //CH7
	rtd_outl(0xb80c2b44,0x5f005f00);
	rtd_outl(0xb80c2b48,0x10004008);
	rtd_outl(0xb80c2b4c,0x42008021);

	rtd_outl(0xb80c2b60,0x09840800); //CH8
	rtd_outl(0xb80c2b64,0x4f004f00);
	rtd_outl(0xb80c2b68,0x10004008);
	rtd_outl(0xb80c2b6c,0x42008021);
	...
	rtd_outl(0xb80c3a60,0x0984080e); //CH0
	rtd_outl(0xb80c3a64,0x5f005f00);
	rtd_outl(0xb80c3a68,0x80004008);
	rtd_outl(0xb80c3a6c,0x40004081);

	rtd_outl(0xb80c3a80,0x0984080e); //CH1
	rtd_outl(0xb80c3a84,0x7f007f00);
	rtd_outl(0xb80c3a88,0x80010008);
	rtd_outl(0xb80c3a8c,0x80008041);

	rtd_outl(0xb80c3aa0,0x0984080e); //CH2
	rtd_outl(0xb80c3aa4,0x7f007f00);
	rtd_outl(0xb80c3aa8,0x20004008);
	rtd_outl(0xb80c3aac,0x80020081);

	rtd_outl(0xb80c3ac0,0x0984080e); //CH3
	rtd_outl(0xb80c3ac4,0x7f007f00);
	rtd_outl(0xb80c3ac8,0x20004008);
	rtd_outl(0xb80c3acc,0x80020081);

	rtd_outl(0xb80c3ae0,0x09840802); //CH4
	rtd_outl(0xb80c3ae4,0x4e004e00);
	rtd_outl(0xb80c3ae8,0x80010008);
	rtd_outl(0xb80c3aec,0x60020061);

	rtd_outl(0xb80c3b00,0x09840802); //CH5
	rtd_outl(0xb80c3b04,0x4e004e00);
	rtd_outl(0xb80c3b08,0x80010008);
	rtd_outl(0xb80c3b0c,0x60020061);

	rtd_outl(0xb80c3b20,0x0984080e); //CH6
	rtd_outl(0xb80c3b24,0x4f004f00);
	rtd_outl(0xb80c3b28,0x80004008);
	rtd_outl(0xb80c3b2c,0x40004081);

	rtd_outl(0xb80c3b40,0x09840800); //CH7
	rtd_outl(0xb80c3b44,0x5f005f00);
	rtd_outl(0xb80c3b48,0x10004008);
	rtd_outl(0xb80c3b4c,0x42008021);

	rtd_outl(0xb80c3b60,0x09840800); //CH8
	rtd_outl(0xb80c3b64,0x4f004f00);
	rtd_outl(0xb80c3b68,0x10004008);
	rtd_outl(0xb80c3b6c,0x42008021);
...
int rtk_bw_limit_tvsb2_client_HW_set_mode(RTK_BW_LIMIT_TVSBX_CLIENT_HW_MODE_T mode)
{
	if(RTK_BW_LMMIT_TVSBX_CLIENT_HW_LEN != mode && RTK_BW_LMMIT_TVSBX_CLIENT_HW_REQ != mode) {
		rtd_pr_qos_err("[QoS][ERR] unknown parameter.\n");
		return 0xff;
	}
	rtd_outl(TVSB2_TV_SB2_DCU1_bw_limit_en0_reg, mode);
	return 0;
}
EXPORT_SYMBOL(rtk_bw_limit_tvsb2_client_HW_set_mode);

int rtk_bw_limit_tvsb2_client_HW_set_threshold(RTK_BRIG_TVSB2_CLIENT_T brig_tvsb2_client, unsigned int timer, unsigned int request)
{
	tvsb2_tv_sb2_dcu1_bw_limit_0_RBUS tv_sb2_dcu1_bw_limit_xx;
	unsigned int reg_timer_request;
	tv_sb2_dcu1_bw_limit_xx.regValue = 0;
	switch (brig_tvsb2_client) {
		case RTK_BRIG_TVSB2_MAIN_CAP: //0x2
			reg_timer_request = TVSB2_TV_SB2_DCU1_bw_limit_2_reg;
			break;

		case RTK_BRIG_TVSB2_MAIN_DIS: //0x3
			reg_timer_request = TVSB2_TV_SB2_DCU1_bw_limit_3_reg;
			break;
	...
	tv_sb2_dcu1_bw_limit_xx.req_thr_0 = request;
	tv_sb2_dcu1_bw_limit_xx.time_thr_0 = timer;
	rtd_outl(reg_timer_request, tv_sb2_dcu1_bw_limit_xx.regValue);

	return 0;
}
EXPORT_SYMBOL(rtk_bw_limit_tvsb2_client_HW_set_threshold);

int rtk_bw_limit_tvsb2_client_HW_en(RTK_BRIG_TVSB2_CLIENT_T brig_tvsb2_client, bool enable)
{
	tvsb2_tv_sb2_dcu1_bw_limit_en1_RBUS tv_sb2_dcu1_bw_limit_en1;
	tv_sb2_dcu1_bw_limit_en1.regValue = rtd_inl(TVSB2_TV_SB2_DCU1_bw_limit_en1_reg);
	switch (brig_tvsb2_client) {
		case RTK_BRIG_TVSB2_MAIN_CAP: //0x2
			tv_sb2_dcu1_bw_limit_en1.bw_limit_en_2 = enable;
			break;

		case RTK_BRIG_TVSB2_MAIN_DIS: //0x3
			tv_sb2_dcu1_bw_limit_en1.bw_limit_en_3 = enable;
			break;
	...
	rtd_outl(TVSB2_TV_SB2_DCU1_bw_limit_en1_reg, tv_sb2_dcu1_bw_limit_en1.regValue);

	return 0;
}
EXPORT_SYMBOL(rtk_bw_limit_tvsb2_client_HW_en);
...
extern int __init rtk_util_init(void);
...
static int __init rtk_qos_init(void)
{
	...
	rtk_util_init(); // new bwinfo under new sysfs path
