...
#define RTD_SHARE_MEM_BASE      0xb8060500
               ...
               case MISC_GET_MODULE_TEST_PIN:
			   {
                ...
                case MISC_UART_PINMUX_SWITCH:
                {
                        ...
                        switch(param)
                        {
                                ...
                                case UART1_PINMUX_ENABLE:
                                        rtd_maskl(PINMUX_MAIN_ST_GPIO_ST_CFG_4_reg, 0x0FFFFFFF, 0x70000000); //disable uart0 pinmux
                                        rtd_maskl(PINMUX_MAIN_ST_GPIO_ST_CFG_0_reg, 0xFFFFFF0F, 0x00000070); //disable uart0 pinmux
                                        
                                        //rtd_maskl(PINMUX_MAIN_GPIO_TLEFT_CFG_1_reg, 0x0FFF0FFF, 0x70007000); //switch uart1 pinmux
                                        rtd_maskl(PINMUX_MAIN_ST_Pin_Mux_Ctrl1_reg, 0xFFFFF0FF, 0x100); //switch uart rx src 0x18060258[11:8]
                                        break;
                ...
                {
                        unsigned int tmp_val = rtd_inl(PINMUX_MAIN_ST_GPIO_ST_CFG_4_reg);

                        if( (tmp_val & 0xF0000000) == 0x60000000)
                        {
                                tmp_val = 1;
                        }
                        else
                ...
                case MISC_UART_GET_UART1_ENABLE:
                {
                        ...
                        if( (tmp_val & 0xF0000000) == 0x70000000)
                        {
                                tmp_val = 1;
                        }
                        else
