...
static int rtk_qos_load_mc_normal_setting(void)
{
    ...
    // VER: commit  828d723700d8fd7def3e0b56523f3525e579835d 
    // VER: [ML8PBU-81][Boot][Feat]: add pcie dts support
    // VER: Change-Id: I37f1c217c863f1af5eeed0135f1ac271923f7306
	...
	rtd_outl(0xb80c4a2c,0x001f0054);
	rtd_outl(0xb80c4a30,0x000f0007);
	rtd_outl(0xb80c4a34,0x03ff0000);
	rtd_outl(0xb80c4a3c,0x00ffffff);
	// ch0
	rtd_outl(0xb80c4a60,0x0984080c);
	rtd_outl(0xb80c4a64,0x6e007f00);
	rtd_outl(0xb80c4a68,0x19002008);
	rtd_outl(0xb80c4a6c,0x43010081);
	// ch1
	rtd_outl(0xb80c4a80,0x0984089c);
	rtd_outl(0xb80c4a84,0x46004600);
	rtd_outl(0xb80c4a88,0x80080008);
	rtd_outl(0xb80c4a8c,0x23004041);
	// ch2
	rtd_outl(0xb80c4aa0,0x09840806);
	rtd_outl(0xb80c4aa4,0x78007800);
	rtd_outl(0xb80c4aa8,0x80008008);
	rtd_outl(0xb80c4aac,0x23010031);
	// ch3
	rtd_outl(0xb80c4ac0,0x09840806);
	rtd_outl(0xb80c4ac4,0x78007800);
	rtd_outl(0xb80c4ac8,0x80008008);
	rtd_outl(0xb80c4acc,0x23010031);
	// ch4
	rtd_outl(0xb80c4ae0,0x09840800);
	rtd_outl(0xb80c4ae4,0x3c003c00);
	rtd_outl(0xb80c4ae8,0x80080008);
	rtd_outl(0xb80c4aec,0x00008031);
	// ch5
	rtd_outl(0xb80c4b00,0x09840800);
	rtd_outl(0xb80c4b04,0x32003200);
	rtd_outl(0xb80c4b08,0x80080008);
	rtd_outl(0xb80c4b0c,0x00008031);
	// ch6
	rtd_outl(0xb80c4b20, 0x0984080e); // def
	rtd_outl(0xb80c4b24, 0x6e007f00);
	rtd_outl(0xb80c4b28, 0x19002008);
	rtd_outl(0xb80c4b2c, 0x43010081);
	// ch7
	//def
	// ch8
	//def
...
static int rtk_qos_load_mc_decoder_4k_ddr4_setting(void)
{
	...
	rtd_outl(0xb80c2a24,0x00180630);
	rtd_outl(0xb80c2a28,0x00002100);
	rtd_outl(0xb80c2a2c,0x001f00a3);
	rtd_outl(0xb80c2a30,0x000f0007);
	rtd_outl(0xb80c2a34,0x03ff0000);
	rtd_outl(0xb80c2a3c,0x00ffffff);

	rtd_outl(0xb80c2a60,0x09840800);
	rtd_outl(0xb80c2a64,0x7f007f00);
	rtd_outl(0xb80c2a68,0x10002008);
	rtd_outl(0xb80c2a6c,0x80010081);

	rtd_outl(0xb80c2a80,0x09840800);
	rtd_outl(0xb80c2a84,0x40004000);
	rtd_outl(0xb80c2a88,0x8007ff08);
	rtd_outl(0xb80c2a8c,0x40008041);

	rtd_outl(0xb80c2aa0,0x0984080e);
	rtd_outl(0xb80c2aa4,0x5f005f00);
	rtd_outl(0xb80c2aa8,0x7ff08008);
	rtd_outl(0xb80c2aac,0x80020081);

	rtd_outl(0xb80c2ac0,0x0984080e);
	rtd_outl(0xb80c2ac4,0x4f004f00);
	rtd_outl(0xb80c2ac8,0x7ff08008);
	rtd_outl(0xb80c2acc,0x80020081);

	rtd_outl(0xb80c2ae0,0x09840800);
	rtd_outl(0xb80c2ae4,0x3f003f00);
	rtd_outl(0xb80c2ae8,0x4007ff08);
	rtd_outl(0xb80c2aec,0x00020030);

	rtd_outl(0xb80c2b00,0x09840800);
	rtd_outl(0xb80c2b04,0x2f002f00);
	rtd_outl(0xb80c2b08,0x5dc7ff08);
	rtd_outl(0xb80c2b0c,0x00020031);

	rtd_outl(0xb80c2b20,0x09840800);
	rtd_outl(0xb80c2b24,0x6f006f00);
	rtd_outl(0xb80c2b28,0x10002008);
	rtd_outl(0xb80c2b2c,0x80010081);
	...
	rtd_outl(0xb80c4a24,0x00180630);
	rtd_outl(0xb80c4a28,0x00002100);
	rtd_outl(0xb80c4a2c,0x001f00a3);
	rtd_outl(0xb80c4a30,0x000f0007);
	rtd_outl(0xb80c4a34,0x03ff0000);
	rtd_outl(0xb80c4a3c,0x00ffffff);

	rtd_outl(0xb80c4a60,0x09840800);
	rtd_outl(0xb80c4a64,0x7f007f00);
	rtd_outl(0xb80c4a68,0x10002008);
	rtd_outl(0xb80c4a6c,0x80010081);

	rtd_outl(0xb80c4a80,0x09840800);
	rtd_outl(0xb80c4a84,0x40004000);
	rtd_outl(0xb80c4a88,0x8007ff08);
	rtd_outl(0xb80c4a8c,0x40008041);

	rtd_outl(0xb80c4aa0,0x0984080e);
	rtd_outl(0xb80c4aa4,0x5f005f00);
	rtd_outl(0xb80c4aa8,0x7ff08008);
	rtd_outl(0xb80c4aac,0x80020081);

	rtd_outl(0xb80c4ac0,0x0984080e);
	rtd_outl(0xb80c4ac4,0x4f004f00);
	rtd_outl(0xb80c4ac8,0x7ff08008);
	rtd_outl(0xb80c4acc,0x80020081);

	rtd_outl(0xb80c4ae0,0x09840800);
	rtd_outl(0xb80c4ae4,0x3f003f00);
	rtd_outl(0xb80c4ae8,0x4007ff08);
	rtd_outl(0xb80c4aec,0x00020030);

	rtd_outl(0xb80c4b00,0x09840800);
	rtd_outl(0xb80c4b04,0x2f002f00);
	rtd_outl(0xb80c4b08,0x5dc7ff08);
	rtd_outl(0xb80c4b0c,0x00020031);

	rtd_outl(0xb80c4b20,0x09840800);
	rtd_outl(0xb80c4b24,0x6f006f00);
	rtd_outl(0xb80c4b28,0x10002008);
	rtd_outl(0xb80c4b2c,0x80010081);

	rtd_outl(0xb80c4b40,0x09840800);
	rtd_outl(0xb80c4b44,0x5f005f00);
	rtd_outl(0xb80c4b48,0x10004008);
	rtd_outl(0xb80c4b4c,0x42008021);

	rtd_outl(0xb80c4b60,0x09840800);
	rtd_outl(0xb80c4b64,0x4f004f00);
	rtd_outl(0xb80c4b68,0x10004008);
	rtd_outl(0xb80c4b6c,0x42008021);
...
static int rtk_qos_load_mc_hdmi_4k_ddr4_setting(void)
{
	...
	rtd_outl(0xb80c2a24,0x00180630);
	rtd_outl(0xb80c2a28,0x00002100);
	rtd_outl(0xb80c2a2c,0x001f00a5);
	rtd_outl(0xb80c2a30,0x000f0007);
	rtd_outl(0xb80c2a34,0x03ff0000);
	rtd_outl(0xb80c2a3c,0x00ffffff);
	...
	rtd_outl(0xb80c2a80,0x09840800);
	rtd_outl(0xb80c2a84,0x1f001f00);
	rtd_outl(0xb80c2a88,0x8007ff08);
	rtd_outl(0xb80c2a8c,0x40008021);

	rtd_outl(0xb80c2aa0,0x0984080e);
	rtd_outl(0xb80c2aa4,0x5f005f00);
	rtd_outl(0xb80c2aa8,0x7ff10008);
	rtd_outl(0xb80c2aac,0x80020081);

	rtd_outl(0xb80c2ac0,0x0984080e);
	rtd_outl(0xb80c2ac4,0x4f004f00);
	rtd_outl(0xb80c2ac8,0x7ff10008);
	rtd_outl(0xb80c2acc,0x80020081);

	rtd_outl(0xb80c2ae0,0x09840800);
	rtd_outl(0xb80c2ae4,0x3f003f00);
	rtd_outl(0xb80c2ae8,0x4007ff08);
	rtd_outl(0xb80c2aec,0x00020020);

	rtd_outl(0xb80c2b00,0x09840800);
	rtd_outl(0xb80c2b04,0x2f002f00);
	rtd_outl(0xb80c2b08,0x5dc7ff08);
	rtd_outl(0xb80c2b0c,0x00020021);
	...
	rtd_outl(0xb80c2b40,0x09840800);
	rtd_outl(0xb80c2b44,0x5f005f00);
	rtd_outl(0xb80c2b48,0x10010008);
	rtd_outl(0xb80c2b4c,0x42008021);

	rtd_outl(0xb80c2b60,0x09840800);
	rtd_outl(0xb80c2b64,0x4f004f00);
	rtd_outl(0xb80c2b68,0x10010008);
	rtd_outl(0xb80c2b6c,0x42008021);
	...
	rtd_outl(0xb80c4a24,0x00180630);
	rtd_outl(0xb80c4a28,0x00002100);
	rtd_outl(0xb80c4a2c,0x001f00a5);
	rtd_outl(0xb80c4a30,0x000f0007);
	rtd_outl(0xb80c4a34,0x03ff0000);
	rtd_outl(0xb80c4a3c,0x00ffffff);
	...
	rtd_outl(0xb80c4a80,0x09840800);
	rtd_outl(0xb80c4a84,0x1f001f00);
	rtd_outl(0xb80c4a88,0x8007ff08);
	rtd_outl(0xb80c4a8c,0x40008021);

	rtd_outl(0xb80c4aa0,0x0984080e);
	rtd_outl(0xb80c4aa4,0x5f005f00);
	rtd_outl(0xb80c4aa8,0x7ff10008);
	rtd_outl(0xb80c4aac,0x80020081);

	rtd_outl(0xb80c4ac0,0x0984080e);
	rtd_outl(0xb80c4ac4,0x4f004f00);
	rtd_outl(0xb80c4ac8,0x7ff10008);
	rtd_outl(0xb80c4acc,0x80020081);

	rtd_outl(0xb80c4ae0,0x09840800);
	rtd_outl(0xb80c4ae4,0x3f003f00);
	rtd_outl(0xb80c4ae8,0x4007ff08);
	rtd_outl(0xb80c4aec,0x00020020);

	rtd_outl(0xb80c4b00,0x09840800);
	rtd_outl(0xb80c4b04,0x2f002f00);
	rtd_outl(0xb80c4b08,0x5dc7ff08);
	rtd_outl(0xb80c4b0c,0x00020021);
	...
	rtd_outl(0xb80c4b40,0x09840800);
	rtd_outl(0xb80c4b44,0x5f005f00);
	rtd_outl(0xb80c4b48,0x10010008);
	rtd_outl(0xb80c4b4c,0x42008021);

	rtd_outl(0xb80c4b60,0x09840800);
	rtd_outl(0xb80c4b64,0x4f004f00);
	rtd_outl(0xb80c4b68,0x10010008);
	rtd_outl(0xb80c4b6c,0x42008021);
