...
#include "rbus/tvsb1_reg.h" //for latency_threshold
...
//if test, open it
//#define CONFIG_TVSBX_PC_LAT_INT_ENABLE // bridge latency threshold interrupt
...
static int rtk_qos_load_mc_normal_setting(void)
{
    ...
    // VER: commit  f9125763e59f7b7ab1539fc37221c979313f6587 
    // VER: [MAC9PBU-1139][Bootcode][Feat]: modified STR setting
    // VER: Change-Id: I6b7bc80000339592b4da7e79d760eb92d4043b2e
	/* MC1 */
	rtd_outl(0xb80c2a00, 0x00000643);
	...
	rtd_outl(0xb80c2a28, 0x00007f01);
	rtd_outl(0xb80c2a2c, 0x03af00a3);
	rtd_outl(0xb80c2a30, 0x00080005);
	rtd_outl(0xb80c2a34, 0x03ff0000);
	rtd_outl(0xb80c2a3c, 0x00ffffff);
	rtd_outl(0xb80c2090, 0x00001337);
	rtd_outl(0xb80c2098, 0x00004a6e);
	// ch0
	rtd_outl(0xb80c2a60, 0x09840802);
	rtd_outl(0xb80c2a64, 0x2f002f00);
	rtd_outl(0xb80c2a68, 0x80002008);
	rtd_outl(0xb80c2a6c, 0x84004081);
	// ch1
	rtd_outl(0xb80c2a80, 0x09840806);
	rtd_outl(0xb80c2a84, 0x7f007f00);
	rtd_outl(0xb80c2a88, 0x80004008);
	rtd_outl(0xb80c2a8c, 0x21004081);
	// ch2
	rtd_outl(0xb80c2aa0, 0x09840806);
	rtd_outl(0xb80c2aa4, 0x4f004f00);
	rtd_outl(0xb80c2aa8, 0x80002008);
	rtd_outl(0xb80c2aac, 0x44008081);
	// ch3
	rtd_outl(0xb80c2ac0, 0x09840806);
	rtd_outl(0xb80c2ac4, 0x3f003f00);
	rtd_outl(0xb80c2ac8, 0x80004008);
	rtd_outl(0xb80c2acc, 0x44008081);
	// ch4
	rtd_outl(0xb80c2ae0, 0x09840802);
	rtd_outl(0xb80c2ae4, 0x6f006f00);
	rtd_outl(0xb80c2ae8, 0x80002008);
	rtd_outl(0xb80c2aec, 0x22008081);
	// ch5
	rtd_outl(0xb80c2b00, 0x09840802);
	rtd_outl(0xb80c2b04, 0x5f005f00);
	rtd_outl(0xb80c2b08, 0x80004008);
	rtd_outl(0xb80c2b0c, 0x22008081);
	// ch6
	rtd_outl(0xb80c2b20, 0x09840802);
	rtd_outl(0xb80c2b24, 0x1f001f00);
	rtd_outl(0xb80c2b28, 0x80040008);
	rtd_outl(0xb80c2b2c, 0x42004081);
	// ch7
	rtd_outl(0xb80c2b40, 0x09840802);
	rtd_outl(0xb80c2b44, 0x6f006f00);
	rtd_outl(0xb80c2b48, 0x80080008);
	rtd_outl(0xb80c2b4c, 0x44008081);
	// ch8
	rtd_outl(0xb80c2b60, 0x09840802);
	rtd_outl(0xb80c2b64, 0x5f005f00);
	rtd_outl(0xb80c2b68, 0x80080008);
	rtd_outl(0xb80c2b6c, 0x44008081);
	// ch9
	rtd_outl(0xb80c2b80, 0x09840806);
	rtd_outl(0xb80c2b84, 0x4f004f00);
	rtd_outl(0xb80c2b88, 0x80020008);
	rtd_outl(0xb80c2b8c, 0x44008081);
	/* MC3 */
	rtd_outl(0xb80c4a00, 0x00000643);
	...
	rtd_outl(0xb80c4a28, 0x00007f01);
	rtd_outl(0xb80c4a2c, 0x03af00a3);
	rtd_outl(0xb80c4a30, 0x00080005);
	rtd_outl(0xb80c4a34, 0x03ff0000);
	rtd_outl(0xb80c4a3c, 0x00ffffff);
	rtd_outl(0xb80c4090, 0x00001337);
	rtd_outl(0xb80c4098, 0x00004a6e);
	// ch0
	rtd_outl(0xb80c4a60, 0x09840802);
	rtd_outl(0xb80c4a64, 0x2f002f00);
	rtd_outl(0xb80c4a68, 0x80002008);
	rtd_outl(0xb80c4a6c, 0x84004081);
	// ch1
	rtd_outl(0xb80c4a80, 0x09840806);
	rtd_outl(0xb80c4a84, 0x7f007f00);
	rtd_outl(0xb80c4a88, 0x80004008);
	rtd_outl(0xb80c4a8c, 0x21004081);
	// ch2
	rtd_outl(0xb80c4aa0, 0x09840806);
	rtd_outl(0xb80c4aa4, 0x4f004f00);
	rtd_outl(0xb80c4aa8, 0x80002008);
	rtd_outl(0xb80c4aac, 0x44008081);
	// ch3
	rtd_outl(0xb80c4ac0, 0x09840806);
	rtd_outl(0xb80c4ac4, 0x3f003f00);
	rtd_outl(0xb80c4ac8, 0x80004008);
	rtd_outl(0xb80c4acc, 0x44008081);
	// ch4
	rtd_outl(0xb80c4ae0, 0x09840802);
	rtd_outl(0xb80c4ae4, 0x6f006f00);
	rtd_outl(0xb80c4ae8, 0x80002008);
	rtd_outl(0xb80c4aec, 0x22008081);
	// ch5
	rtd_outl(0xb80c4b00, 0x09840802);
	rtd_outl(0xb80c4b04, 0x5f005f00);
	rtd_outl(0xb80c4b08, 0x80004008);
	rtd_outl(0xb80c4b0c, 0x22008081);
	// ch6
	rtd_outl(0xb80c4b20, 0x09840802);
	rtd_outl(0xb80c4b24, 0x1f001f00);
	rtd_outl(0xb80c4b28, 0x80040008);
	rtd_outl(0xb80c4b2c, 0x42004081);
	// ch7
	rtd_outl(0xb80c4b40, 0x09840802);
	rtd_outl(0xb80c4b44, 0x6f006f00);
	rtd_outl(0xb80c4b48, 0x80080008);
	rtd_outl(0xb80c4b4c, 0x44008081);
	// ch8
	rtd_outl(0xb80c4b60, 0x09840802);
	rtd_outl(0xb80c4b64, 0x5f005f00);
	rtd_outl(0xb80c4b68, 0x80080008);
	rtd_outl(0xb80c4b6c, 0x44008081);
	// ch9
	rtd_outl(0xb80c4b80, 0x09840806);
	rtd_outl(0xb80c4b84, 0x4f004f00);
	rtd_outl(0xb80c4b88, 0x80020008);
	rtd_outl(0xb80c4b8c, 0x44008081);
#endif
...
__maybe_unused static void __qos_case0_48b(void)
{
	// 0119_case0_purechkmem_48b

	//0x180C2A00~0x180C2BFF
	...
	rtd_outl(0xb80c2b40, 0x09840806);
	rtd_outl(0xb80c2b44, 0x00005000);
	rtd_outl(0xb80c2b48, 0x80010008);
	rtd_outl(0xb80c2b4c, 0x53010041);
	rtd_outl(0xb80c2b60, 0x09840806);
	rtd_outl(0xb80c2b64, 0x00005000);
	rtd_outl(0xb80c2b68, 0x80010008);
	rtd_outl(0xb80c2b6c, 0x53010041);

	//0x180C3A00~0x180C3BFF
	...
	rtd_outl(0xb80c3a2c, 0x001f0054);
	rtd_outl(0xb80c3a30, 0x000f0007);
	rtd_outl(0xb80c3a34, 0x03ff0000);
	rtd_outl(0xb80c3a3c, 0x00ffffff);
	rtd_outl(0xb80c3a60, 0x0984080c);
	rtd_outl(0xb80c3a64, 0x6e007f00);
	rtd_outl(0xb80c3a68, 0x19002008);
	rtd_outl(0xb80c3a6c, 0x43010081);
	rtd_outl(0xb80c3a80, 0x0984089c);
	rtd_outl(0xb80c3a84, 0x46004600);
	rtd_outl(0xb80c3a88, 0x80080008);
	rtd_outl(0xb80c3a8c, 0x23004041);
	rtd_outl(0xb80c3aa0, 0x09840806);
	rtd_outl(0xb80c3aa4, 0x78007800);
	rtd_outl(0xb80c3aa8, 0x80008008);
	rtd_outl(0xb80c3aac, 0x23010031);
	rtd_outl(0xb80c3ac0, 0x09840806);
	rtd_outl(0xb80c3ac4, 0x78007800);
	rtd_outl(0xb80c3ac8, 0x80008008);
	rtd_outl(0xb80c3acc, 0x23010031);
	rtd_outl(0xb80c3ae0, 0x09840800);
	rtd_outl(0xb80c3ae4, 0x3c003c00);
	rtd_outl(0xb80c3ae8, 0x80080008);
	rtd_outl(0xb80c3aec, 0x00008031);
	rtd_outl(0xb80c3b00, 0x09840800);
	rtd_outl(0xb80c3b04, 0x32003200);
	rtd_outl(0xb80c3b08, 0x80080008);
	rtd_outl(0xb80c3b0c, 0x00008031);
	rtd_outl(0xb80c3b20, 0x0984080e);
	rtd_outl(0xb80c3b24, 0x6e007f00);
	rtd_outl(0xb80c3b28, 0x19002008);
	rtd_outl(0xb80c3b2c, 0x43010081);
	rtd_outl(0xb80c3b40, 0x09840806);
	rtd_outl(0xb80c3b44, 0x00005000);
	rtd_outl(0xb80c3b48, 0x80010008);
	rtd_outl(0xb80c3b4c, 0x53010041);
	rtd_outl(0xb80c3b60, 0x09840806);
	rtd_outl(0xb80c3b64, 0x00005000);
	rtd_outl(0xb80c3b68, 0x80010008);
	rtd_outl(0xb80c3b6c, 0x53010041);
}


static void __qos_case3_48b(void)
{
	// 0328_for_all_source
	...
	rtd_outl(0xb80c2a34, 0x03ff0000);
	rtd_outl(0xb80c2a3c, 0x00ffffff);
	rtd_outl(0xb80c2a60, 0x0984080e);
	rtd_outl(0xb80c2a64, 0x4f004f00);
	rtd_outl(0xb80c2a68, 0x80002008);
	rtd_outl(0xb80c2a6c, 0x21002041);
	rtd_outl(0xb80c2a80, 0x0984080e);
	rtd_outl(0xb80c2a84, 0x5f005f00);
	rtd_outl(0xb80c2a88, 0x40002008);
	rtd_outl(0xb80c2a8c, 0x21004081);
	rtd_outl(0xb80c2aa0, 0x09840806);
	rtd_outl(0xb80c2aa4, 0x7f007f00);
	rtd_outl(0xb80c2aa8, 0x7ff04008);
	rtd_outl(0xb80c2aac, 0x42008081);
	rtd_outl(0xb80c2ac0, 0x09840806);
	rtd_outl(0xb80c2ac4, 0x6f006f00);
	rtd_outl(0xb80c2ac8, 0x7ff08008);
	rtd_outl(0xb80c2acc, 0x42008081);
	rtd_outl(0xb80c2ae0, 0x09840806);
	rtd_outl(0xb80c2ae4, 0x2f002f00);
	rtd_outl(0xb80c2ae8, 0x8007ff08);
	rtd_outl(0xb80c2aec, 0x22008081);
	rtd_outl(0xb80c2b00, 0x09840806);
	rtd_outl(0xb80c2b04, 0x1f001f00);
	rtd_outl(0xb80c2b08, 0x8007ff08);
	rtd_outl(0xb80c2b0c, 0x22008081);
	rtd_outl(0xb80c2b20, 0x09840806);
	rtd_outl(0xb80c2b24, 0x3f003f00);
	rtd_outl(0xb80c2b28, 0x80040008);
	rtd_outl(0xb80c2b2c, 0x21002041);
	rtd_outl(0xb80c2b40, 0x09840806);
	rtd_outl(0xb80c2b44, 0x00005000);
	rtd_outl(0xb80c2b48, 0x80010008);
	rtd_outl(0xb80c2b4c, 0x53010041);
	...
	rtd_outl(0xb80c3a00, 0x00000643);
	rtd_outl(0xb80c3a10, 0x00000000);
	rtd_outl(0xb80c3a14, 0x00000000);
	rtd_outl(0xb80c3a18, 0x40000000);
	rtd_outl(0xb80c3a1c, 0x012c0000);
	rtd_outl(0xb80c3a20, 0x00fa00fa);
	rtd_outl(0xb80c3a24, 0x00180630);
	rtd_outl(0xb80c3a28, 0x00007f01);
	rtd_outl(0xb80c3a2c, 0x03af00a3);
	rtd_outl(0xb80c3a30, 0x00080005);
	rtd_outl(0xb80c3a34, 0x03ff0000);
	rtd_outl(0xb80c3a3c, 0x00ffffff);
	rtd_outl(0xb80c3a60, 0x0984080e);
	rtd_outl(0xb80c3a64, 0x4f004f00);
	rtd_outl(0xb80c3a68, 0x80002008);
	rtd_outl(0xb80c3a6c, 0x21002041);
	rtd_outl(0xb80c3a80, 0x0984080e);
	rtd_outl(0xb80c3a84, 0x5f005f00);
	rtd_outl(0xb80c3a88, 0x40002008);
	rtd_outl(0xb80c3a8c, 0x21004081);
	rtd_outl(0xb80c3aa0, 0x09840806);
	rtd_outl(0xb80c3aa4, 0x7f007f00);
	rtd_outl(0xb80c3aa8, 0x7ff04008);
	rtd_outl(0xb80c3aac, 0x42008081);
	rtd_outl(0xb80c3ac0, 0x09840806);
	rtd_outl(0xb80c3ac4, 0x6f006f00);
	rtd_outl(0xb80c3ac8, 0x7ff08008);
	rtd_outl(0xb80c3acc, 0x42008081);
	rtd_outl(0xb80c3ae0, 0x09840806);
	rtd_outl(0xb80c3ae4, 0x2f002f00);
	rtd_outl(0xb80c3ae8, 0x8007ff08);
	rtd_outl(0xb80c3aec, 0x22008081);
	rtd_outl(0xb80c3b00, 0x09840806);
	rtd_outl(0xb80c3b04, 0x1f001f00);
	rtd_outl(0xb80c3b08, 0x8007ff08);
	rtd_outl(0xb80c3b0c, 0x22008081);
	rtd_outl(0xb80c3b20, 0x09840806);
	rtd_outl(0xb80c3b24, 0x3f003f00);
	rtd_outl(0xb80c3b28, 0x80040008);
	rtd_outl(0xb80c3b2c, 0x21002041);
	rtd_outl(0xb80c3b40, 0x09840806);
	rtd_outl(0xb80c3b44, 0x00005000);
	rtd_outl(0xb80c3b48, 0x80010008);
	rtd_outl(0xb80c3b4c, 0x53010041);
...
static int is_DDR4(void)
{
	...
	return dc_mc_mc_sys_0.ddr4_en?1:0;
}


static int __qos_set_mode(RTK_QOS_MODE_T mode)
{
	switch (mode) {
	...
	default:
		rtd_pr_qos_err("[QOS] Unknown QOS mode[%d]\n", mode);
		return -1;
	}
...
int rtk_qos_set_mode(RTK_QOS_MODE_T mode)
{
	...
	g_rtk_qos_current_setting = mode;
	...
	if (tmp_value)
	{
		//NN BW limit would be 4GB under camera app
#if IS_ENABLED(CONFIG_RTK_AICAM_DRV)
		if(rtk_ai_get_enable_status(AI_CAMERA))
...
ssize_t rtk_qos_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
	...
	else
	{
		...
		else // if other unexpected to be forced
			return sprintf(buf, "current is force mode %d\n", g_rtk_qos_force_setting);
...
int rtk_qos_set_force_mode(RTK_QOS_MODE_T mode)
{
...
//arb_en ID for latency threshold bring-up test
//  0x1801c304
#define TVSB1_ID_P0         0 // VDEC
#define TVSB1_ID_P1         1 // AUDIO1_W
#define TVSB1_ID_P2         2 // AUDIO2_R
//  0x1801c404
#define TVSB2_ID_P0         0 // Main Capture C W
#define TVSB2_ID_P1         1 // Main Display C R
#define TVSB2_ID_P2         4 // Main Capture Y W
//  0x1801c604
#define TVSB4_ID_P0         1 // OD R
#define TVSB4_ID_P1         2 // DC2H W
#define TVSB4_ID_P2         7 // Demura R
//  0x1801cc04
#define TVSB6_ID_P0         6 // VO1 Y R
#define TVSB6_ID_P1         7 // VO1 C R
#define TVSB6_ID_P2         10 // I3DDMA Y R
//  0x1801cd04
#define TVSB8_ID_P0         0 // OSD1 R
#define TVSB8_ID_P1         1 // OSD2 R
#define TVSB8_ID_P2         2 // OSD3 R


__maybe_unused static irqreturn_t tvsb1_pc_intr(int irq, void *dev_id)
{
	unsigned long tvsb1_pc_lat_int;
	unsigned long tvsb1_pc_lat_int_mask =
		TVSB1_TV_SB1_DCU1_PC_prog_ctrl2_pc_prog0_lat_interrupt_mask |
		TVSB1_TV_SB1_DCU1_PC_prog_ctrl2_pc_prog1_lat_interrupt_mask |
		TVSB1_TV_SB1_DCU1_PC_prog_ctrl2_pc_prog2_lat_interrupt_mask;

	tvsb1_pc_lat_int = rtd_inl(TVSB1_TV_SB1_DCU1_PC_prog_ctrl2_reg);
	if (tvsb1_pc_lat_int & tvsb1_pc_lat_int_mask) {

		rtd_pr_qos_err("[PC_INT] tvsb1 %x\n", (tvsb1_pc_lat_int & tvsb1_pc_lat_int_mask));

		// handling interrupt or event to defer serivce
		rtd_setbits(TVSB1_TV_SB1_DCU1_PC_prog_ctrl2_reg, tvsb1_pc_lat_int_mask);

		// disable & stop performance counter
		rtd_outl(TVSB1_TV_SB1_DCU1_PC_CTRL_reg, 0x0);
#if 0
		// enable & start performance counter
		rtd_outl(TVSB1_TV_SB1_DCU1_PC_CTRL_reg, TVSB1_TV_SB1_DCU1_PC_CTRL_pc_lat_interrupt_en(0x1) |
			TVSB1_TV_SB1_DCU1_PC_CTRL_pc_rd_only(0x1) | TVSB1_TV_SB1_DCU1_PC_CTRL_pc_go(0x1));
...
__maybe_unused static void tvsb1_pc_intr_setup(void)
{
	struct device_node *np = NULL;
	int irq_num;
	unsigned int idx;

	np = of_find_node_by_name(NULL, "tvsb");
	if (!np) {
		rtd_pr_qos_err("[PC_INT] there is no tvsb device node\n");
		return;
	}
	irq_num = irq_of_parse_and_map(np, 0); // rtd2819a.dts
	rtd_pr_qos_info("[PC_INT] tvsb1 irq_num = %d\n", irq_num);
	...
	if (request_irq(
		...
		"TVSB1",
		tvsb1_pc_intr)) {
		rtd_pr_qos_err("[PC_INT] TVSB1: cannot register IRQ \n");
		return ;
	}
	...
	/* pc sets monitor progs */ // always need to assign everyone of 3?
	rtd_outl(TVSB1_TV_SB1_DCU1_PC_prog_ctrl1_reg, (TVSB1_ID_P0) << 0 |
		(TVSB1_ID_P1) << 8 | (TVSB1_ID_P2) << 16);

	// set lat threshold for each prog
	for (idx = 0; idx < PC_PROG_NUM; idx++)
		rtd_outl(TVSB1_TV_SB1_DCU1_PC_prog_0_latency_threshold_reg - 0x4*idx, PC_LATENCY_THRESHOLD);

#if 0
	// enable pc
	rtd_outl(TVSB1_TV_SB1_DCU1_PC_CTRL_reg,
		TVSB1_TV_SB1_DCU1_PC_CTRL_pc_lat_interrupt_en(0x1) |
		TVSB1_TV_SB1_DCU1_PC_CTRL_pc2_rd_only(0x1) |
		TVSB1_TV_SB1_DCU1_PC_CTRL_pc1_rd_only(0x1) |
		TVSB1_TV_SB1_DCU1_PC_CTRL_pc0_rd_only(0x1) |
		TVSB1_TV_SB1_DCU1_PC_CTRL_pc_go_lat(0x1) |
		TVSB1_TV_SB1_DCU1_PC_CTRL_pc_go(0x1));
#endif

}


__maybe_unused static irqreturn_t tvsb2_pc_intr(int irq, void *dev_id)
{
	unsigned long tvsb2_pc_lat_int;
	unsigned long tvsb2_pc_lat_int_mask =
		TVSB2_TV_SB2_DCU1_PC_prog_ctrl2_pc_prog0_lat_interrupt_mask |
		TVSB2_TV_SB2_DCU1_PC_prog_ctrl2_pc_prog1_lat_interrupt_mask |
		TVSB2_TV_SB2_DCU1_PC_prog_ctrl2_pc_prog2_lat_interrupt_mask;

	tvsb2_pc_lat_int = rtd_inl(TVSB2_TV_SB2_DCU1_PC_prog_ctrl2_reg);
	if (tvsb2_pc_lat_int & tvsb2_pc_lat_int_mask) {

		rtd_pr_qos_err("[PC_INT] tvsb2 %x\n", (tvsb2_pc_lat_int & tvsb2_pc_lat_int_mask));

		// handling interrupt or event to defer serivce
		rtd_setbits(TVSB2_TV_SB2_DCU1_PC_prog_ctrl2_reg, tvsb2_pc_lat_int_mask);
...
__maybe_unused static void tvsb2_pc_intr_setup(void)
{
	struct device_node *np = NULL;
	int irq_num;
	unsigned int idx;
	...
	np = of_find_node_by_name(NULL, "tvsb");
	if (!np) {
		rtd_pr_qos_err("[PC_INT] there is no tvsb2 device node\n");
		return;
	}
	irq_num = irq_of_parse_and_map(np, 1);
	rtd_pr_qos_info("[PC_INT] tvsb2 irq_num = %d\n", irq_num);
	...
	if (request_irq(
		...
		"TVSB2",
		tvsb2_pc_intr)) {
		rtd_pr_qos_err("[PC_INT] TVSB2: cannot register IRQ \n");
		return ;
	}
	...
	/* pc sets monitor progs */ // always need to assign everyone of 3?
	rtd_outl(TVSB2_TV_SB2_DCU1_PC_prog_ctrl1_reg, (TVSB2_ID_P0) << 0 |
		(TVSB2_ID_P1) << 8 | (TVSB2_ID_P2) << 16);
...
#if 0
	// enable pc
	rtd_outl(TVSB2_TV_SB2_DCU1_PC_CTRL_reg,
		TVSB2_TV_SB2_DCU1_PC_CTRL_pc_lat_interrupt_en(0x1) |
		TVSB2_TV_SB2_DCU1_PC_CTRL_pc2_rd_only(0x1) |
		TVSB2_TV_SB2_DCU1_PC_CTRL_pc1_rd_only(0x1) |
		TVSB2_TV_SB2_DCU1_PC_CTRL_pc0_rd_only(0x1) |
		TVSB2_TV_SB2_DCU1_PC_CTRL_pc_go_lat(0x1) |
		TVSB2_TV_SB2_DCU1_PC_CTRL_pc_go(0x1));
#endif
...
__maybe_unused static irqreturn_t tvsb4_pc_intr(int irq, void *dev_id)
{
	unsigned long tvsb4_pc_lat_int;
	unsigned long tvsb4_pc_lat_int_mask =
		TVSB4_TV_SB4_DCU1_PC_prog_ctrl2_pc_prog0_lat_interrupt_mask |
		TVSB4_TV_SB4_DCU1_PC_prog_ctrl2_pc_prog1_lat_interrupt_mask |
		TVSB4_TV_SB4_DCU1_PC_prog_ctrl2_pc_prog2_lat_interrupt_mask;

	tvsb4_pc_lat_int = rtd_inl(TVSB4_TV_SB4_DCU1_PC_prog_ctrl2_reg);
	if (tvsb4_pc_lat_int & tvsb4_pc_lat_int_mask) {
		rtd_pr_qos_err("[PC_INT] tvsb4 %x\n", (tvsb4_pc_lat_int & tvsb4_pc_lat_int_mask));

		// handling interrupt or event to defer serivce
		rtd_setbits(TVSB4_TV_SB4_DCU1_PC_prog_ctrl2_reg, tvsb4_pc_lat_int_mask);

		// disable & stop performance counter
		rtd_outl(TVSB4_TV_SB4_DCU1_PC_CTRL_reg, 0x0);
#if 0
		// enable & start performance counter
		rtd_outl(TVSB4_TV_SB4_DCU1_PC_CTRL_reg,
			TVSB4_TV_SB4_DCU1_PC_CTRL_pc_lat_interrupt_en(0x1) |
			TVSB4_TV_SB4_DCU1_PC_CTRL_pc_rd_only(0x1) |
			TVSB4_TV_SB4_DCU1_PC_CTRL_pc_go(0x1));
...
__maybe_unused static void tvsb4_pc_intr_setup(void)
{
	struct device_node *np = NULL;
	int irq_num;
	unsigned int idx;
	...
	np = of_find_node_by_name(NULL, "tvsb");
	if (!np) {
		rtd_pr_qos_err("[PC_INT] there is no device node\n");
		return;
	}
	irq_num = irq_of_parse_and_map(np, 2);
	rtd_pr_qos_info("[PC_INT] tvsb4 irq_num = %d\n", irq_num);
	...
	if (request_irq(irq_num,
		...
		"TVSB4",
		tvsb4_pc_intr)) {
		rtd_pr_qos_err("[PC_INT] TVSB4: cannot register IRQ \n");
		return ;
	}
	...
	rtd_outl(TVSB4_TV_SB4_DCU1_PC_prog_ctrl1_reg, (TVSB4_ID_P0) << 0 |
		(TVSB4_ID_P1) << 8 | (TVSB4_ID_P2) << 16);
	// set lat threshold for each prog
	for (idx = 0; idx < PC_PROG_NUM; idx++)
	...
	rtd_outl(TVSB4_TV_SB4_DCU1_PC_CTRL_reg,
		TVSB4_TV_SB4_DCU1_PC_CTRL_pc_lat_interrupt_en(0x1) |
		TVSB4_TV_SB4_DCU1_PC_CTRL_pc2_rd_only(0x1) |
		TVSB4_TV_SB4_DCU1_PC_CTRL_pc1_rd_only(0x1) |
		TVSB4_TV_SB4_DCU1_PC_CTRL_pc0_rd_only(0x1) |
		TVSB4_TV_SB4_DCU1_PC_CTRL_pc_go_lat(0x1) |
		TVSB4_TV_SB4_DCU1_PC_CTRL_pc_go(0x1));
#endif
...
__maybe_unused static irqreturn_t tvsb6_pc_intr(int irq, void *dev_id)
{
	unsigned long tvsb6_pc_lat_int;
	unsigned long tvsb6_pc_lat_int_mask =
		TVSB6_TV_SB6_DCU1_PC_prog_ctrl2_pc_prog0_lat_interrupt_mask |
		TVSB6_TV_SB6_DCU1_PC_prog_ctrl2_pc_prog1_lat_interrupt_mask |
		TVSB6_TV_SB6_DCU1_PC_prog_ctrl2_pc_prog2_lat_interrupt_mask;

	tvsb6_pc_lat_int = rtd_inl(TVSB6_TV_SB6_DCU1_PC_prog_ctrl2_reg);
	if (tvsb6_pc_lat_int & tvsb6_pc_lat_int_mask) {

		rtd_pr_qos_err("[PC_INT] tvsb6 %x\n", (tvsb6_pc_lat_int & tvsb6_pc_lat_int_mask));

		// handling interrupt or event to defer serivce
		rtd_setbits(TVSB6_TV_SB6_DCU1_PC_prog_ctrl2_reg, tvsb6_pc_lat_int_mask);

		// disable & stop performance counter
		rtd_outl(TVSB6_TV_SB6_DCU1_PC_CTRL_reg, 0x0);
#if 0
		// enable & start performance counter
		rtd_outl(TVSB6_TV_SB6_DCU1_PC_CTRL_reg, TVSB6_TV_SB6_DCU1_PC_CTRL_pc_lat_interrupt_en(0x1) |
			TVSB6_TV_SB6_DCU1_PC_CTRL_pc_rd_only(0x1) | TVSB6_TV_SB6_DCU1_PC_CTRL_pc_go(0x1));
...
__maybe_unused static void tvsb6_pc_intr_setup(void)
{
	struct device_node *np = NULL;
	int irq_num;
	unsigned int idx;
	...
	np = of_find_node_by_name(NULL, "tvsb");
	if (!np) {
		rtd_pr_qos_err("[PC_INT] there is no tvsb6 device node\n");
		return;
	}
	irq_num = irq_of_parse_and_map(np, 3);
	rtd_pr_qos_info("[PC_INT] tvsb6 irq_num = %d\n", irq_num);
	...
	if (request_irq(
		...
		"TVSB6",
		tvsb6_pc_intr)) {
		rtd_pr_qos_err("[PC_INT] TVSB6: cannot register IRQ \n");
		return ;
	}
	...
	/* pc sets monitor progs */ // always need to assign everyone of 3?
	rtd_outl(TVSB6_TV_SB6_DCU1_PC_prog_ctrl1_reg, (TVSB6_ID_P0) << 0 |
		(TVSB6_ID_P1) << 8 | (TVSB6_ID_P2) << 16);

	// set lat threshold for each prog
	for (idx = 0; idx < PC_PROG_NUM; idx++)
		rtd_outl(TVSB6_TV_SB6_DCU1_PC_prog_0_latency_threshold_reg - 0x4*idx, PC_LATENCY_THRESHOLD);

#if 0
	// enable pc
	rtd_outl(TVSB6_TV_SB6_DCU1_PC_CTRL_reg,
		TVSB6_TV_SB6_DCU1_PC_CTRL_pc_lat_interrupt_en(0x1) |
		TVSB6_TV_SB6_DCU1_PC_CTRL_pc2_rd_only(0x1) |
		TVSB6_TV_SB6_DCU1_PC_CTRL_pc1_rd_only(0x1) |
		TVSB6_TV_SB6_DCU1_PC_CTRL_pc0_rd_only(0x1) |
		TVSB6_TV_SB6_DCU1_PC_CTRL_pc_go_lat(0x1) |
		TVSB6_TV_SB6_DCU1_PC_CTRL_pc_go(0x1));
#endif

}


__maybe_unused static irqreturn_t tvsb8_pc_intr(int irq, void *dev_id)
{
	unsigned long tvsb8_pc_lat_int;
	unsigned long tvsb8_pc_lat_int_mask =
		TVSB8_TV_SB8_DCU1_PC_prog_ctrl2_pc_prog0_lat_interrupt_mask |
		TVSB8_TV_SB8_DCU1_PC_prog_ctrl2_pc_prog1_lat_interrupt_mask |
		TVSB8_TV_SB8_DCU1_PC_prog_ctrl2_pc_prog2_lat_interrupt_mask;

	tvsb8_pc_lat_int = rtd_inl(TVSB8_TV_SB8_DCU1_PC_prog_ctrl2_reg);
	if (tvsb8_pc_lat_int & tvsb8_pc_lat_int_mask) {

		rtd_pr_qos_err("[PC_INT] tvsb8 %x\n", (tvsb8_pc_lat_int & tvsb8_pc_lat_int_mask));

		// handling interrupt or event to defer serivce
		rtd_setbits(TVSB8_TV_SB8_DCU1_PC_prog_ctrl2_reg, tvsb8_pc_lat_int_mask);

		// disable & stop performance counter
		rtd_outl(TVSB8_TV_SB8_DCU1_PC_CTRL_reg, 0x0);
#if 0
		// enable & start performance counter
		rtd_outl(TVSB8_TV_SB8_DCU1_PC_CTRL_reg, TVSB8_TV_SB8_DCU1_PC_CTRL_pc_lat_interrupt_en(0x1) |
			TVSB8_TV_SB8_DCU1_PC_CTRL_pc_rd_only(0x1) | TVSB8_TV_SB8_DCU1_PC_CTRL_pc_go(0x1));
...
__maybe_unused static void tvsb8_pc_intr_setup(void)
{
	struct device_node *np = NULL;
	int irq_num;
	unsigned int idx;
	...
	np = of_find_node_by_name(NULL, "tvsb");
	if (!np) {
		rtd_pr_qos_err("[PC_INT] there is no tvsb8 device node\n");
		return;
	}
	irq_num = irq_of_parse_and_map(np, 4);
	rtd_pr_qos_info("[PC_INT] tvsb8 irq_num = %d\n", irq_num);
	...
	if (request_irq(
		...
		"TVSB8",
		tvsb8_pc_intr)) {
		rtd_pr_qos_err("[PC_INT] TVSB8: cannot register IRQ \n");
		return ;
	}
	...
	/* pc sets monitor progs */ // always need to assign everyone of 3?
	rtd_outl(TVSB8_TV_SB8_DCU1_PC_prog_ctrl1_reg, (TVSB8_ID_P0) << 0 |
		(TVSB8_ID_P1) << 8 | (TVSB8_ID_P2) << 16);

	// set lat threshold for each prog
	for (idx = 0; idx < PC_PROG_NUM; idx++)
		rtd_outl(TVSB8_TV_SB8_DCU1_PC_prog_0_latency_threshold_reg - 0x4*idx, PC_LATENCY_THRESHOLD);

#if 0
	// enable pc
	rtd_outl(TVSB8_TV_SB8_DCU1_PC_CTRL_reg,
		TVSB8_TV_SB8_DCU1_PC_CTRL_pc_lat_interrupt_en(0x1) |
		TVSB8_TV_SB8_DCU1_PC_CTRL_pc2_rd_only(0x1) |
		TVSB8_TV_SB8_DCU1_PC_CTRL_pc1_rd_only(0x1) |
		TVSB8_TV_SB8_DCU1_PC_CTRL_pc0_rd_only(0x1) |
		TVSB8_TV_SB8_DCU1_PC_CTRL_pc_go_lat(0x1) |
		TVSB8_TV_SB8_DCU1_PC_CTRL_pc_go(0x1));
#endif

}


#endif // CONFIG_TVSBX_PC_LAT_INT_ENABLE
...
static int __init rtk_qos_init(void)
{
	...
	//default hwsetting or rtk_qos_load_mc_normal_setting before
