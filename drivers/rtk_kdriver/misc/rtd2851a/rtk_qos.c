...
static int rtk_qos_load_mc_decoder_2k_ddr4_setting(void)
{
	...
	rtd_outl(0xb8008a00,  0x00000643);
	rtd_outl(0xb8008a10,  0x00000000);
	rtd_outl(0xb8008a14,  0x00000000);
	rtd_outl(0xb8008a18,  0x40000000);
	rtd_outl(0xb8008a1c,  0x012c0000);
	rtd_outl(0xb8008a20,  0x00fa00fa);
	rtd_outl(0xb8008a24,  0x00180630);
	rtd_outl(0xb8008a28,  0x00002100);
	rtd_outl(0xb8008a2c,  0x03af00a3);
	rtd_outl(0xb8008a30,  0x000f0007);
	rtd_outl(0xb8008a34,  0x03ff0000);
	rtd_outl(0xb8008a3c,  0x00ffffff);

	rtd_outl(0xb8008a40,  0x0984080e);
	rtd_outl(0xb8008a44,  0x5f005f00);
	rtd_outl(0xb8008a48,  0x80004008);
	rtd_outl(0xb8008a4c,  0x40004081);

	rtd_outl(0xb8008a50,  0x0984080e);
	rtd_outl(0xb8008a54,  0x7f007f00);
	rtd_outl(0xb8008a58,  0x80010008);
	rtd_outl(0xb8008a5c,  0x80008041);

	rtd_outl(0xb8008a60,  0x0984080e);
	rtd_outl(0xb8008a64,  0x7f007f00);
	rtd_outl(0xb8008a68,  0x20004008);
	rtd_outl(0xb8008a6c,  0x80020081);

	rtd_outl(0xb8008a70,  0x0984080e);
	rtd_outl(0xb8008a74,  0x7f007f00);
	rtd_outl(0xb8008a78,  0x20004008);
	rtd_outl(0xb8008a7c,  0x80020081);

	rtd_outl(0xb8008a80,  0x09840802);
	rtd_outl(0xb8008a84,  0x4e004e00);
	rtd_outl(0xb8008a88,  0x80010008);
	rtd_outl(0xb8008a8c,  0x60020061);

	rtd_outl(0xb8008a90,  0x09840802);
	rtd_outl(0xb8008a94,  0x4e004e00);
	rtd_outl(0xb8008a98,  0x80010008);
	rtd_outl(0xb8008a9c,  0x60020061);

	rtd_outl(0xb8008aa0,  0x0984080e);
	rtd_outl(0xb8008aa4,  0x4f004f00);
	rtd_outl(0xb8008aa8,  0x80004008);
	rtd_outl(0xb8008aac,  0x40004081);
