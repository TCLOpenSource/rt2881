...
EXPORT_SYMBOL(rtk_timer_set_mode);
...
EXPORT_SYMBOL(rtk_timer_get_value);
...
EXPORT_SYMBOL(rtk_timer_set_value);
...
EXPORT_SYMBOL(rtk_timer_set_target);
...
EXPORT_SYMBOL(rtk_timer_control);
