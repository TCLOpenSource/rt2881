...
typedef struct
{
	char name[20];
        ...
        unsigned long long start;//start addr,force 32B align by hw
        unsigned long long end;//end addr,force 32B align by hw
#else
        unsigned int start;//start addr,force 32B align by hw
        unsigned int end;//end addr,force 32B align by hw
#endif
        ...
        int entry_special_warning_level ; 
} DC_MT_DESC;
...
enum DCMT_INTR_MODE
{
        ...
        DCMT_INTR_MODE_EXTREME_SIMPLE = 1,
        DCMT_INTR_MODE_SIMPLE = 2,
        DCMT_INTR_MODE_PRINT = 3,
        DCMT_INTR_MODE_PANIC = 4,
...
#define kimage_vaddr 0xC0000000
