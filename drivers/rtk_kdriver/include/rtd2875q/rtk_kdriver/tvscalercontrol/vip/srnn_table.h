...
extern const unsigned int gSrnnWeightNum[6];
extern unsigned short srnn_current_table[SRNN_WEIGHT_NUM_MAX];
extern unsigned short srnn_blending_table[SRNN_WEIGHT_NUM_MAX];
extern VIP_SRNN_SQM_INFO gSrnnSQMInfo;



// Default table for init
extern unsigned short mode2_default_table[SRNN_DEFAULT_WEIGHT_TABLE_NUM_MAX][SRNN_WEIGHT_NUM_MODE2];	// 60Hz
extern unsigned short mode3_default_table[SRNN_DEFAULT_WEIGHT_TABLE_NUM_MAX][SRNN_WEIGHT_NUM_MODE3];	// 120Hz
extern unsigned short mode4_default_table[SRNN_DEFAULT_WEIGHT_TABLE_NUM_MAX][SRNN_WEIGHT_NUM_MODE4];	// 60Hz
extern unsigned short mode5_default_table[SRNN_DEFAULT_WEIGHT_TABLE_NUM_MAX][SRNN_WEIGHT_NUM_MODE5];	// 120Hz
extern unsigned short mode6_default_table[SRNN_DEFAULT_WEIGHT_TABLE_NUM_MAX][SRNN_WEIGHT_NUM_MODE6];	// 60Hz
extern unsigned short mode7_default_table[SRNN_DEFAULT_WEIGHT_TABLE_NUM_MAX][SRNN_WEIGHT_NUM_MODE7];	// 120Hz


//extern SRNN_VIP_TABLE gVipSRNNTbl;
/* ----- ----- ----- ----- ----- FUNCTIONS ----- ----- ----- ----- ----- */
void SrnnCtrl_VIP_SRNN_TBL_Register(SRNN_VIP_TABLE * pTBL);
SRNN_VIP_TABLE *SrnnCtrl_GetSRNN_TBL(void);
void SrnnLib_SrnnSQMInfo_Reset(void);
void SrnnLib_SrnnSQMInfo_Init(VIP_SRNN_SOURCE_TIMING src_timing);
unsigned char SrnnLib_SrnnSQMInfo_GetDirection(VIP_SRNN_SOURCE_TIMING src_timing, VIP_SRNN_SOURCE_TIMING tgt_timing);
unsigned char SrnnLib_SrnnSQMInfo_GetNextSQMTiming(VIP_SRNN_SOURCE_TIMING src_timing, unsigned char sqm_direction);
unsigned short * SrnnLib_TimingToSRNNParam(SRNN_VIP_TABLE *SRNN_TBL, VIP_SRNN_SOURCE_TIMING src_timing);
