...
typedef struct _PST_DISPM_SCPU_VIR_START_ADDR {
	...
	unsigned long	s0_nnsr_st_vir_addr;//0xB8028C00-0xB8028DF8
	unsigned long	s0_nnsr_mask1_st_vir_addr;//0xB8079400-0xB807941c
	unsigned long	s0_nnsr_mask2_st_vir_addr;//0xB8079240-0xB8079284
