...
static const MODULE_INFO module_info[] =
{
        ...
        MODULE_STR(TVSB2_SNR_SSB),
        MODULE_STR(TVSB2_3DTABLE),
        MODULE_STR(TVSB2),
        ...
        MODULE_STR(TVSB3_SE0),
        MODULE_STR(TVSB3_SE1),
        MODULE_STR(TVSB3),
        //4
        MODULE_STR(GPU_NKC),
        MODULE_STR(GPU_KC),
...
unsigned char key_table_audio[] = {MODULE_ACPU};
...
unsigned char key_table_cpus[] = {MODULE_SB2_VCPU, MODULE_SB2_VCPU2};
