...
typedef struct
{
	...
	unsigned char	u8_MVChaos_cnt;

	unsigned char	u8_large_DTL_cnt;

	unsigned char	u8_after_sc_cnt;
	unsigned char	u8_FastUniformBaground_cnt;
	unsigned char	u8_after_FastUniformBaground_cnt;
}_OUTPUT_FBLevelCtrl;
