...
VOID Identification_Pattern_wrtAction_Reset(_OUTPUT_WRT_COM_REG *pOutput);
...
VOID Identification_Pattern_wrtAction_TV010_HSR(const _PARAM_WRT_COM_REG *pParam, _OUTPUT_WRT_COM_REG *pOutput);
