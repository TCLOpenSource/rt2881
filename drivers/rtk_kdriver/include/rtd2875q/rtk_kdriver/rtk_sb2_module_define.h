...
static const t_sb2_timout_moudle module_sb2_info[] =
{
    ...
    {0x1800D000, 0x1800D3ff, "HDMI"},
	{0x1800D400, 0x1800D4ff, "hdmi_ex_p1"},
	{0x1800D500, 0x1800D9ff, "HDMI"},
    {0x1800DA00, 0x1800Deff, "hdmi_ex_p0"},
	{0x1800Df00, 0x1800Dfff, "HDMI"},
    ...
    {0x1803BA00, 0x1803BEFF, "HDMIEX_P1"},
	{0x1803BF00, 0x1803BFFF, "HDMI"},
	{0x1803C000, 0x1803C9FF, "HDMI"},
    {0x1803CA00, 0x1803CEFF, "HDMIEX_P2"},
	{0x1803CF00, 0x1803CFFF, "HDMI"},
    ...
    //{0x18079000, 0x18079FFF, ""},
    //{0x1807A000, 0x1807AFFF, ""},
    {0x1807B000, 0x1807BFFF, "HDMI DP Common"},
    ...
    {0x180B2000, 0x180B29FF, "HDMI"},
	{0x180B2a00, 0x180B2FFF, "HDMIEX"},
    ...
    //1818_0000  - 181a_ffff
    {0x18180000, 0x181AFFFF, "GPU"},
    
    //181b_0000  - 181b_ffff
    {0x181B0000, 0x181BFFFF, "GPU"},
    
    //181c_0000  - 181c_ffff
    {0x181C0000, 0x181C1FFF, "GPU_wrapper"},
    /* 0x181C2000-0x181CFFFF  reserved*/
    
    //181d_0000s  - 181f_ffff
};
