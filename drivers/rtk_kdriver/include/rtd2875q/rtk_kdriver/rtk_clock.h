...
//Enable it when bringup stage (will set rtk_cpu_dvfs_disable to 1)
//#define RTK_CPUFREQ_BRINGUP_VERIFY
...
#define RTK_CPUFREQ_CPU_RATE_TO_PLL_MUL		(9)
#define RTK_CPUFREQ_CPU_RATE_TO_PLL_SHIFT	(3)

#define RTK_CPUFREQ_CPU_RATE_TO_PLL_MUL_OTP         (5)
#define RTK_CPUFREQ_CPU_RATE_TO_PLL_SHIFT_OTP       (2)
