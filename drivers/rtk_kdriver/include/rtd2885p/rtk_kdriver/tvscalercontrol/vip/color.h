...
typedef enum _VIP_DITHER_SEQUENCE {
	...
	VIP_DITHER_SEQUENCE_MEMC_INTERNAL,
...
typedef enum _VIP_DITHER_TEMPORAL {
	...
	VIP_DITHER_TEMPORAL_MEMC_INTERNAL,  //MEMC internal dither
...
typedef struct __attribute__((packed)) {
	unsigned int R_d1 : 10;
	unsigned int R_d0 : 10;
	unsigned int R_index : 14;
	unsigned int G_d1 : 10;
	unsigned int G_d0 : 10;
	unsigned int G_index : 14;
	unsigned int B_d1 : 10;
	unsigned int B_d0 : 10;
	unsigned int B_index : 14;
	unsigned int padding : 26;
} GAMMA_DMA_GRID_ST, OUT_GAMMA_DMA_GRID_ST;

typedef struct {
	GAMMA_DMA_GRID_ST grid[512];
} GAMMA_DMA_DATA_FMT_ST, OUT_GAMMA_DMA_DATA_FMT_ST;

typedef struct __attribute__((packed)) {
	unsigned int R_d1 : 8;
	unsigned int R_d0 : 8;
	unsigned int R_index : 12;
	unsigned int G_d1 : 8;
	unsigned int G_d0 : 8;
	unsigned int G_index : 12;
	unsigned int B_d1 : 8;
	unsigned int B_d0 : 8;
	unsigned int B_index : 12;
	unsigned int padding1 : 12;
	unsigned int padding2 : 32;
} INV_OUT_GAMMA_DMA_GRID_ST;

typedef struct {
	INV_OUT_GAMMA_DMA_GRID_ST grid[512];
} INV_OUT_GAMMA_DMA_DATA_FMT_ST;
