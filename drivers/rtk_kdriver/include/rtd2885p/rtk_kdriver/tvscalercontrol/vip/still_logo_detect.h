...
#endif
#define CONFIG_SUPPORT_SLD_BY_DEMURA 1       // => SLD by Demura
#define CONFIG_SUPPORT_SLD_BY_MEMC_DEMURA
#define CONFIG_LOGO_480_DDR
...
#define SLD_DMA_APL_Ready_CNT_th_max 10//25  => SLD Read APL period
#define SLD_APL_ON 1
...
typedef struct{
	int cmd_LC_APL_Hblk_Num;
	int cmd_LC_APL_Vblk_Num;
	int cmd_highY_frame_thl;
	int cmd_APL_HighY_Ratio_0;
	int cmd_APL_HighY_Ratio_1;
	int cmd_APL_HighY_Ratio_2;
	int cmd_HighY_blk_final_pixel_gain_0;
	int cmd_HighY_blk_final_pixel_gain_1;
	int cmd_HighY_blk_final_pixel_gain_2;
	int cmd_HighY_pixel_gain_decrease_step;
	int cmd_max_logo_protect_thl;
	int cmd_memc_sc_motion1_thl;
	int cmd_memc_sc_motion2_thl;
	int cmd_scene_chg_idx_step1;
	int cmd_scene_chg_idx_step2;
	int cmd_scene_chg_thl1;
	int cmd_scene_chg_thl2;
	int cmd_still_cond_return;
	int cmd_scenechange_cond_return;
	int cmd_circle_pattern_return;
	int cmd_highY_return;
	int cmd_shopp_logo_return;
	int cmd_big_logo_return	;
	int cmd_scene_chg_logo_area_thl;
	int cmd_highY_logo_area_thl;
	int cmd_pixel_gain_increase_step;
	int cmd_scenechange_and_circle_cond_return;
	int cmd_scene_chg_and_circle_idx_step;
	int cmd_big_logo_max_idx_thl;
	int cmd_still_memc_sc_motion1_thl;
	int cmd_still_memc_sc_motion2_thl;
	int cmd_still_pixel_gain_decrease_step;
	int cmd_still_idx_decrease_step;
	int cmd_scene_change_flag_global_cnt;
	int cmd_circle4_flag_global_thl;
}DRV_SLD_FW_CMD;

typedef struct{
	int sld_fw_pixel_gain;
	int sld_fw_idx_ctrl_step;
	int sld_fw_max_pre_idx;
}DRV_SLD_FW_INFO;

typedef struct{
	int up_Left_counter_highY_blk;
	int pixe_gain_decrease_flag;
	int circle4_flag;
	int LR_LOGO_Flag_L;
	int LR_LOGO_Flag_R;
	int max_logo_cnt;
	int near_max_logo_cnt;
	int memc_scene_change_flag_global;
	int near_max_logo_not_update_cnt;
	int dilation_type;
	int circle4_flag_global_cnt;
}DRV_SLD_O_INFO;

typedef struct{
	char still_condition;
	char scene_change_condition;
	char circle_condition;
	char highY_block_condition;
	char LR_LOGO_LandR_condition;
	char LR_logo_condition;
	char normal_condition;
}DRV_SLD_CONDITION_INFO;
