...
//void scalerPQMask_GetDefocusARGBBuffer_semantic(unsigned char *dstBuf, unsigned char hRatio, unsigned char vRatio, unsigned char Alpha);
...
//void scalerPQMask_GetDefocusARGBBuffer_deepness(unsigned char *dstBuf, unsigned char hRatio, unsigned char vRatio, unsigned char Alpha);
