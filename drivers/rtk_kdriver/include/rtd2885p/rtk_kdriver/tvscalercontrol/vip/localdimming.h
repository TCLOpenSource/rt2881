...
typedef struct{
	unsigned int BV_avg_1;
	unsigned int BV_avg_2;
	unsigned int BV_avg_3;
	unsigned int BV_avg_4;
	unsigned int BV_avg_5;
	unsigned int BV_avg_6;
	unsigned int BV_avg_7;
	unsigned int BV_avg_8;
	unsigned int BV_avg_9;
...
typedef struct{
	...
	unsigned int Index_5;
	unsigned int Index_6;
	unsigned int Index_7;
	unsigned int Index_8;
	unsigned int Index_9;
	unsigned int Index_10;
	unsigned int Index_11;
	unsigned int Index_12;
	unsigned int Index_13;
	unsigned int Index_14;
	unsigned int Index_15;
	unsigned int Index_16;
	unsigned int Index_17;
	unsigned int Index_18;
	unsigned int Index_19;
	unsigned int Index_20;
	unsigned int Index_21;
	unsigned int Index_22;
	unsigned int Index_23;
	unsigned int Index_24;
	unsigned int Index_25;
	unsigned int Index_26;
	unsigned int Index_27;
	unsigned int Index_28;
	unsigned int Index_29;
	unsigned int Index_30;
	unsigned int Index_31;
	
	
}DRV_LD_Gamma_Index;

typedef struct{
	unsigned char enable; // 0xb802B358[31]
	DRV_LD_Gamma_BV_avg BV_avg; // 9 bv_avg table
	DRV_LD_Gamma_Index Gamma_Index; // table index
	unsigned int Gamma_table[3][9][33]; // RGB¡B9 bv_avg table¡B33 index in 1 talbe 
...
void drvif_HAL_VPQ_LED_InitLDSPI(unsigned char bCtrl);
