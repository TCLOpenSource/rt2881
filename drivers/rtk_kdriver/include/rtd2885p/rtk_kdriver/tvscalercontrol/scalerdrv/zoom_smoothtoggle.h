...
typedef struct _SMOOTH_TOGGLE_INFO {
	...
	unsigned char IMD_SCALER_INPUT_2P_MODE;  // 0: scaler input use 1 pixel mode, 1: scaler input use 2 pixel mode
} SMOOTH_TOGGLE_INFO;
...
void zoom_smoothtoggle_gamemode_set_smt_status(unsigned char display,unsigned char value);
