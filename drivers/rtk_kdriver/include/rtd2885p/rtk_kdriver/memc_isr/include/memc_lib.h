...
#define MEMC_VER_MAJOR	(1) //max:63
#define MEMC_VER_MINOR	(5) //max:127
#define DATE_YEAR		(24) //23 for 2023 year, max:127(2127)
#define DATE_MONTH		(7)
#define DATE_DATE		(19)
#define DATE_TIME		(1) //max:7
...
typedef enum
{
	...
	INPUT_125HZ,						///< input 125Hz
	INPUT_144HZ,						///< input 144Hz
	INPUT_165HZ,						///< input 165Hz
	INPUT_240HZ,						///< input 240Hz
	INPUT_FRAME_MAX,
...
typedef enum
{
	...
	OUTPUT_125HZ,						///< output 125Hz
	OUTPUT_144HZ,						///< output 144Hz
	OUTPUT_150HZ,						///< output 150Hz
    OUTPUT_165HZ,						///< output 165Hz
	OUTPUT_200HZ,						///< output 200Hz
	OUTPUT_225HZ,						///< output 225Hz
...
VOID MEMC_me1_bgmask_newalgo_init_RTK2885p(VOID);
VOID MEMC_dehalo_newalgo_bgmaskBase_init_RTK2885p(VOID);
    //merlin8
VOID MEMC_newalgo_me0_init_RTK2885p(VOID);
VOID MEMC_newalgo_smallobj_init_RTK2885p(VOID);
VOID MEMC_newalgo_dehalo_add_init_RTK2885p(VOID);



VOID MEMC_LibRTK_init_PQL_0_RTK2885p(VOID);
#if 0//REMOVE_DUMMY_API
...
VOID MEMC_Lib_FB_Style_Select(VOID);
VOID MEMC_Lib_ME_Style_Select(VOID);
unsigned char MEMC_Lib_Get_ME_Sytle(VOID);
VOID MEMC_Lib_Style_Select(VOID);
VOID Set_MEMC_Style_By_Bin(VOID);
void MEMC_Lib_Set_QS_SLD_Param(void);
...
void MEMC_Lib_set_SLD_protect_cnt(unsigned char frame_cnt);
unsigned char MEMC_Lib_get_SLD_protect_cnt(void);
void MEMC_Lib_YHistBigChg_Check(void);
void MEMC_Lib_set_YHistBigChg_cnt(unsigned char hold_cnt);
unsigned char MEMC_Lib_get_YHistBigChg_cnt(void);
void MEMC_LibSetMEMC_PCModeEnable_QS(BOOL enable);

void set_MEMC_Lib_DelayTime_Calc(int delay_frame);
unsigned int get_MEMC_Lib_DelayTime_Calc(void);
void set_MEMC_Lib_sum_rmvxy_max(void);
unsigned int get_MEMC_Lib_sum_rmvxy_max(void);

void MEMC_Lib_Set_Change_Size_Force_mode(unsigned char enable);
unsigned char MEMC_Lib_Get_Change_Size_Force_mode(void);

void MEMC_Lib_Set_Sub_Mode_Type(int type);
unsigned char MEMC_Lib_Get_Sub_Mode_Type(void);

void MEMC_Lib_Set_MEMC_Regen_Address(void);
void MEMC_Lib_Set_Memory_Write_Done(unsigned char enable);
unsigned char MEMC_Lib_Get_Memory_Write_Done(void);
void MEMC_Lib_Set_Memory_Quary_Success(unsigned char enable);
unsigned char MEMC_Lib_Get_Memory_Quary_Success(void);
void MEMC_Lib_Set_CMA_Release_Stage(unsigned char enable);
unsigned char MEMC_Lib_Get_CMA_Release_Stage(void);
void MEMC_Lib_Set_InputVSXral_PCMode_422_change(unsigned char enable);
unsigned char MEMC_Lib_Get_InputVSXral_PCMode_422_change(void);
unsigned int MEMC_Lib_s16_speed_is_not_normal(void);
void MEMC_Lib_SC_fw_ctrl(BOOL bEnable);
void MEMC_lib_Med9flt_ctrl(BOOL bEnable);
BOOL Check_MEMC_DMA_Error(void);

void MEMC_Lib_debug_message_print_RTK2885pp(void);
void MEMC_Lib_debug_message_print_HS_RTK2885pp(void);
#endif
