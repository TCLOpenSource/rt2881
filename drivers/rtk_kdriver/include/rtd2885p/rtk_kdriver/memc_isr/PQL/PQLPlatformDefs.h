...
#if 1// config for sync fpga code
#define CONFIG_NEED_TUNNING		(1)
#define REMOVE_REDUNDANT_API	(0)
#define REMOVE_DUMMY_API		(0)
#define VFLIP_REALTE			(0) //no use can remove
#define ASK_AND_MODIFY			(0)
#define RBUS_NOT_READY			(0)
#define BLUE_SCREEN_REG		(0xB809ADE0)//RBUS_NOT_READY
#define RTICE_DEBUG_REG		(0xB809D938)//RBUS_NOT_READY
#define TIME_MEASURE_REG	(0xb809adec)//RBUS_NOT_READY
#define ME_UP_LIMIT_REG		(0xb8099bb0)//RBUS_NOT_READY
#define ME_DOWN_LIMIT_REG	(0xb8099bb4)//RBUS_NOT_READY
#define DEN_CHECK_REG		(0xb809e000)//RBUS_NOT_READY
#define DMA_CHECK

#define FIX_MISMATCH
#define MERLIN8P_MV_RELATE		(0)
#define REFINE_DMA				(1)
#define MODIFY_BY_RESOLUTION

#define __MERLIN8P_ERR__	("Merlin8P Error")
#ifndef RUN_MERLIN8P_API
#define RUN_MERLIN8P_API
#define RUN_MERLIN8P() ((get_mach_type()==MACH_ARCH_RTK2885P2 || get_mach_type()==MACH_ARCH_RTK2885PP)? (1) : (0))
#define RUN_MERLIN8() ((get_mach_type()==MACH_ARCH_RTK2885P)? (1) : (0))
#endif //RUN_MERLIN8P_API
#endif// config for sync fpga code
#endif
