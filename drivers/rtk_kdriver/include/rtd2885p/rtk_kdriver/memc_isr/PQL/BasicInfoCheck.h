...
typedef struct
{
	unsigned char u1_InfoCheck_en_db;
	unsigned char u1_InfoCheck_log_en;
	unsigned char u1_Check_Env_all_en;
	unsigned char u1_Check_Env_Shutdown;
	unsigned char u1_Check_Env_PTG_APL;
	unsigned char u1_Check_Env_PTG_POS;
	unsigned char u1_Check_Env_PTG_SQUARE;
	unsigned char u1_Check_Env_PTG_MV_INFO;
	unsigned char u1_Check_Env_DDR_BOUNDARY;
	unsigned char u1_Check_Env_RIM_BOUNDARY;
	unsigned char u1_Check_Env_LBMC;
	unsigned char u1_Check_Env_REGION;

	unsigned char u1_Check_PTG_CALIB_all_en;
	unsigned char u1_Check_PTG_CALIB_Shutdown;
	unsigned char u1_Check_PTG_CALIB_APL;
	unsigned char u1_Check_PTG_CALIB_DTL;
	unsigned char u1_Check_PTG_CALIB_SAD;
	unsigned char u1_Check_PTG_CALIB_SC;
	unsigned char u1_Check_PTG_CALIB_LBMC;
	unsigned char u1_Check_PTG_CALIB_YUV;
	unsigned char u1_Check_PTG_CALIB_LOGO_DETECT;
	unsigned char u1_Check_PTG_CALIB_MV_CONVERGENCY;
	unsigned char u1_Check_PTG_CALIB_SAD_CONVERGENCY;
	unsigned char u1_Check_PTG_CALIB_LOGO_CONVERGENCY;
	
	unsigned char u1_Check_PTG_CALIB_SINGLE_SAD_en;
	unsigned char u1_Check_PTG_CALIB_SINGLE_SAD_INDEX;

	unsigned char u1_Check_REALSTREAM_CALIB_MV_INFO;
	unsigned char u1_Check_REALSTREAM_CALIB_FB_BADREGION;
	unsigned char u1_Check_REALSTREAM_CALIB_MV_INFO_Shutdown;
	unsigned char u1_Check_REALSTREAM_CALIB_FB_BADREGION_Shutdown;
	
	unsigned char u1_AutoRegression_en_db;
	unsigned char u1_AutoRegression_reset;
	unsigned char u1_AutoRegression_log_en;
	unsigned char u1_AutoRegression_log_SC;
	unsigned char u1_AutoRegression_log_GFB;
	unsigned char u1_AutoRegression_log_LFB;
	unsigned char u1_AutoRegression_log_LOGO;
	unsigned char u8_AutoRegression_stream_id;
	
	unsigned char u1_AutoRegression_Verify_all;
	unsigned char u1_AutoRegression_Verify_single;
	unsigned char u1_AutoRegression_GetData_all;
	unsigned char u1_AutoRegression_GetData_single;

	unsigned char u1_Show_APL_Info;
	unsigned char u1_Show_DTL_Info;
	unsigned char u1_Show_SAD_Info;
}_PARAM_InfoCheck;
