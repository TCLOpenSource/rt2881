...
//	unsigned int u27_TempConsis_pre;
	...
	unsigned char u6_tri_ball_hold_cnt;
	unsigned char u6_tri_ball_hold_cnt_tv010;
}_OUTPUT_PATCH_M;
...
// VOID DoubleScan_Action_RTK2885p(unsigned char dbScan_en, unsigned char smallObj_en, unsigned char dh_close_en, _OUTPUT_PATCH_M *pOutput);
