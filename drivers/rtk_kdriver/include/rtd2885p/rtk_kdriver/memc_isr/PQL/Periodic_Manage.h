...
#define CONFIG_REPEAT_NEW_ALOG (0)
#else
...
typedef struct
{
	...
	unsigned char u1_detect_repeat_cnt;	
	unsigned char u1_detect_top_row_repeat;
	unsigned char u1_SC_disable_algo;
	unsigned char u1_SC_cnt;
	unsigned char u1_ZMV_disable_algo;
	unsigned char u1_ZMV_cnt;
	unsigned char u5_repeat_rgn_num;	
	unsigned char u5_stable_rgn_num;	
	unsigned char u5_unstable_repeat_reg_num;	
	unsigned char u8_rmv_unstable_cnt[4][8];	
	unsigned char u1_unstable_repeat_rgn[4][8];
	...
	bool u1_replace_repeat_mv;	
	bool u1_replace_repeat_mv_rgn[4][8];
