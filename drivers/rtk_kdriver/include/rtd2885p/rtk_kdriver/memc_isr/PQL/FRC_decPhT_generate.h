...
typedef  enum { // phase decoder info names, & pack start bit.
	EXTRA2_RESERVED = 0,
	EXTRA2_ME1_LOGO_DTS_P_INDEX,
	EXTRA2_ME1_LOGO_DTS_I_INDEX,
	EXTRA2_ME15_LOGO_DTS_P_INDEX_MSB,

	EXTRA2_NAMES_NUM,
}_PH_DECINFO_EXTRA2_NAMES;

typedef  enum { // phase decoder info names, & pack start bit.
	EXTRA_ME15_LOGO_DTS_P_INDEX_LSB,
	EXTRA_ME15_LOGO_DTS_I_INDEX,
	EXTRA_NO_USE,
	EXTRA_ME2_PHASE_LONG,
	EXTRA_ME15_DTS_P_INDEX,
	EXTRA_ME15_DTS_I_INDEX,
	EXTRA_ME_DTS_P_INDEX_MSB,
	EXTRA_ME_DTS_I_INDEX_MSB,
	EXTRA_ME2_IBME_P_INDEX_OFFSET_MSB,
	EXTRA_ME2_IBME_I_INDEX_OFFSET_MSB,
	EXTRA_MC_CTS_P_INDEX_MSB,
	EXTRA_MC_CTS_I_INDEX_MSB,
	EXTRA_NST_INDEX,

	EXTRA_NAMES_NUM,
}_PH_DECINFO_EXTRA_NAMES;
...
typedef struct PhaseDecoderPackInfo
{
	...
	unsigned char u8_extra[EXTRA_NAMES_NUM];
	unsigned char u8_extra2[EXTRA2_NAMES_NUM];
} Ph_Dec_Pack_Info;
...
typedef struct PhaseDecoderInfo
{
	...
	unsigned char  me1_i_offset:4;
	unsigned char  me1_p_offset:4;

	unsigned char  me2_i_offset:4;
	unsigned char  me2_p_offset:4;

	unsigned char  mc_i_offset:4;
	unsigned char  mc_p_offset:4;
	...
	unsigned char  me1_wrt_idx_oft:4;
	unsigned char  mc_wrt_idx_oft:4;
//	unsigned char  me2_wrt_idx_oft:3;

	unsigned char  nst_offset:4;

	unsigned char  mc_i_offset_msb:1;
	unsigned char  mc_p_offset_msb:1;

	unsigned char  me2_i_offset_msb:1;
	unsigned char  me2_p_offset_msb:1;

	unsigned char  me1_i_offset_msb:1;
	unsigned char  me1_p_offset_msb:1;

	unsigned char  me15_i_offset:4;
	unsigned char  me15_p_offset:4;

	unsigned char  me2_phase_long:7;

	unsigned char  me15_logo_i_offset:4;
	unsigned char  me15_logo_p_offset:4;

	unsigned char  me1_logo_i_offset:4;
	unsigned char  me1_logo_p_offset:4;
} Ph_Dec_Info;
...
extern Film_Wrt_Info     phTable_WrtInfoGen_vd_22_32[64];
//////////////////////////////////////////////////////////////////////////
