...
typedef struct{	
	...
	unsigned char y1;	
	unsigned char y2;
} _str_logo_n_step_table;

typedef struct{	
	unsigned char y0;	
	unsigned char y1;	
	unsigned char y2;
} _str_logo_p_step_table;
...
typedef struct
{
	...
	unsigned int me2_fsearch_ac_obme_mode;
	unsigned int me2_fsearch_dc_obme_mode_sel;
	unsigned int me2_fsearch_dc_obme_mode;
...
typedef struct
{
	...
	// HS merlin8 logo
	unsigned int u8_dh_logo_temporal_counter[32];	
	unsigned int u32_still_logo_cnt[32];	
	unsigned int u32_subtitle_flag[32];

	// HS merlin8 logo
	unsigned int lt_logo_cnt_avg_IIR;
	unsigned int rt_logo_cnt_avg_IIR;
	unsigned int lb_logo_cnt_avg_IIR;
	unsigned int rb_logo_cnt_avg_IIR;

	unsigned char  u1_logo_NearRim_dh_blklogo_status[5];
	unsigned char  u8_logo_NearRim_dh_blklogo_hold_frm[5];
}_OUTPUT_FRC_LGDet;
