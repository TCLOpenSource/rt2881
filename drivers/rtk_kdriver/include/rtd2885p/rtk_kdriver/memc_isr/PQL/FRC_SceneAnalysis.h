...
typedef struct
{
	...
	unsigned char	u5_acdc_bld_holdtime_sc;
	...
	unsigned char u8_dh_condition_cat_dhbypass_flag;//yaomaozhuan
	unsigned char u8_dh_condition_new_dhbypass_flag;
    ...
    unsigned char u8_me1_conditioh_halflittlebg_blackfg_flag;
    unsigned char u8_dh_condition_blackpro_off_in_cnt;
    unsigned char u8_dh_condition_blackpro_off;
    unsigned char u8_dh_condition_blackpro_off_hold_cnt;

    unsigned char u8_dh_condition_sk_diff;
    unsigned char u8_dh_condition_greyslow;
    unsigned char u8_dh_condition_smallfg_logooff_flag;
   
	unsigned char u8_dh_condition_vertical2_flag;
	unsigned char u8_dh_condition_slowmotion_bgstable;
	unsigned char u8_dh_condition_rotate_rmvdiff;
	unsigned char u8_dh_condition_slowomtion_midmove;
	unsigned char u8_dh_condition_mvchaos_move;
	unsigned char u8_dh_condition_predver_en;
    unsigned char u8_dh_condition_generalmvcor;
    unsigned char u8_dh_condition_bgunsatablebypass;
    unsigned char u8_dh_condition_fgextenden;
    unsigned char u8_dh_condition_sadoff_veren;

    unsigned char u8_dh_condition_bgcnt_diff;
	
    unsigned char u8_dh_condition_fast_bgmotion;
    unsigned char u8_dh_condition_onlyver_motion;
    unsigned char u8_dh_condition_rim_detect;

	unsigned char u8_dh_condition_rotate_mv_broken;//list248
	unsigned char u8_dh_condition_miyuezhuan_halo; //sky_worth miyuezhuan
	unsigned char u8_dh_condition_miyuezhuan_carriage;
	unsigned char u8_dh_condition_miyuezhuan_mancross;

    int region_fg_x;  //rgn_fgmv
    int region_fg_y;	
	
	unsigned char u8_dh_force_dc_bld_flag;
	unsigned char FadeInOut_flg;
