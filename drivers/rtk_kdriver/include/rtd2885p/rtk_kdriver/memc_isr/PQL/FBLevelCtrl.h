...
typedef struct
{
	...
	unsigned char	u8_FastMotion_cnt;
	unsigned char	u5_large_rmv_num;
	bool			u1_detect_GMV_fast;
	bool			u1_detect_RMV_fast;
	bool			u1_large_SAD;

	bool			u1_MV_Chaos;
	bool			u1_large_mv_unconf;
	unsigned		u8_MVChaos_cnt;

	////////// Merlin8p //////////
	unsigned char	u1_gfb_detect;
}_OUTPUT_FBLevelCtrl;
