...
typedef struct  
{
	...
	unsigned char  u1_mixMode_rgnEn[_FILM_MOT_NUM];
...
typedef struct  
{
	...
	unsigned char  u1_7006_60_BadEdit_flag;
	unsigned char  u8_7006_60_BadEdit_cnt;
	unsigned char  u8_7006_60_BadEdit_idx;

	unsigned char  u1_7006_30_BadEdit_flag;
	unsigned char  u8_7006_30_BadEdit_cnt;
	unsigned char  u8_7006_30_BadEdit_idx;

	unsigned char u8_BadEdit_flag;
	unsigned int  u32_BadEdit_cnt;
	unsigned char u8_cadence_sequence[KEEP_FRAME_NUM];
	bool ExchangeCad;
	bool u1_LowFrameCase;
	bool u1_match_flag;
