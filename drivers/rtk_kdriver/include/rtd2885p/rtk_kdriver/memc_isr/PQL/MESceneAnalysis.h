...
typedef struct
{
	...
	////////// Merlin8p //////////
	unsigned char u1_motion_info_calc_en;
	unsigned char u1_mc_var_lpf_calc_en;
	unsigned char u1_unstable_score_calc_en;
...
*/
	...
	//=========ME2 ZMV========= 
	unsigned int reg_kme_me2_vbuf_1st_zmv_en;
}MemcStatus;
...
typedef struct
{
	...
	bool u1_FixSubtitleBroken_en;
	bool u1_FixSubtitleBrokenLBMC_en;
...
//    bool u1_wrt_local_lpf_en;
	...
	////////// Merlin8p //////////
    bool u1_freq_scene;
    unsigned char u6_unstable_score;
    unsigned char u6_mean_unstable_score;
    unsigned char u6_unstable_score_cnt;
    unsigned char u6_temporal_adpt_cnt;
    unsigned char u5_small_unstb_cnt;
    unsigned char u6_global_unstb_cnt;
    unsigned char u6_global_mvd_unstb_cnt;
    unsigned char u6_rgn_unstable_score[32];
    unsigned char u8_final_rgn_unstable_score[32];
    unsigned char u10_mvdiff;
    unsigned char u10_gmv_grp01_mvdiff;
    unsigned char u10_t_gmv_mvdiff;
    unsigned char u10_med_mvdiff;
    short s10_global_bgmvy;
    short s11_global_bgmvx;
    short s10_global_fgmvy;
    short s11_global_fgmvx;
    unsigned short u10_global_fgmv_cnt_mean;
    unsigned short u10_global_fgmv_cnt_var;
    short s10_rgn_bgmvy[32];
    short s11_rgn_bgmvx[32];
    unsigned short u16_gmv_max_mv;
    bool u1_apl_upsample_en;
    bool u1_fast_motion_cond;
    bool u1_apl_var_cond;
    unsigned short u10_rmv_mvdiff[32];
    unsigned short u8_lfb_base64_th;
    unsigned short u9_lfb_gmv_grp1_max_th;
    unsigned short u16_avg_gmv;
    bool u1_large_rgn_unstb[32];

    unsigned char u2_var_lpf_sample_mode;
    bool u1_var_lpf_dynamic_gain_en;
    unsigned char u5_var_lpf_dynamic_gain_min_value;
    unsigned char u6_var_lpf_gain;
...
typedef enum {
	...
	RepeatCase_DetectRepeat_Slowmv=0xa,
	RepeatCase_DetectRepeat_Midmv=0xb,
	RepeatCase_BIGSAD,
...
typedef struct 
{
	unsigned short u10_med_mvdiff_t;
	signed short s10_global_t_bgmvy;
	signed short s11_global_t_bgmvx;
	signed short s10_global_t_fgmvy;
	signed short s11_global_t_fgmvx;
	unsigned short u10_global_t_fgmv_cnt;
	unsigned short u10_global_t_fgmv_ucf;

	signed short s10_global_t_rgn_bgmvy[32];
	signed short s11_global_t_rgn_bgmvx[32];
	signed short s10_me_t_rgn_bgmvy[32];
	signed short s11_me_t_rgn_bgmvx[32];

	signed short s10_t_gmv_mvy[3];
	signed short s11_t_gmv_mvx[3];
} _Motion_Temporal_Info;

typedef struct 
{
	unsigned short me15_invalid_cnt[32];
	unsigned short me15_invalid_rm_cnt[32];
	short me15_invalid_mvy[32];
	short me15_invalid_mvx[32];

	unsigned short me1_rmv_cnt[32][3];
	unsigned short me1_rmv_ucf[32][3];
	short me1_rmv_mvy[32][3];
	short me1_rmv_mvx[32][3];


	unsigned short me1_gmv_cnt[3];
	unsigned short me1_gmv_ucf[3];
	short me1_gmv_mvy[3];
	short me1_gmv_mvx[3];

	unsigned short me1_rgn_tcss[32];
	unsigned short me1_lfb_cnt[32];
} _Unstb_Input_Temporal_Info;

typedef struct 
{
    unsigned short dh_cov_cnt[32];
    unsigned short dh_ucov_cnt[32];
    unsigned short tcss_score[32];
} _Unstb_Output_Temporal_Info;
...
VOID MEMC_boundary_mv_convergence_Detect_RTK2885p(_OUTPUT_ME_SCENE_ANALYSIS *pOutput);
VOID MEMC_special_DRP_Detect_RTK2885p(_OUTPUT_ME_SCENE_ANALYSIS *pOutput);
...
VOID MEMC_info_Print_RTK2885p(_OUTPUT_ME_SCENE_ANALYSIS *pOutput);
VOID MEMC_Repeat_Periodic_detect_RTK2885p(const _PARAM_ME_SCENE_ANALYSIS *pParam,_OUTPUT_ME_SCENE_ANALYSIS *pOutput);
VOID MEMC_MAD_Rmv_detect_RTK2885p(_OUTPUT_ME_SCENE_ANALYSIS *pOutput);
...
#ifdef BG_MV_GET
VOID MEMC_BG_MV_Get_RTK2885p(const _PARAM_ME_SCENE_ANALYSIS *pParam, _OUTPUT_ME_SCENE_ANALYSIS *pOutput);
#endif
