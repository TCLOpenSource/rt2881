...
#include "memc_isr/PQL/PeriodicCtrl_extend.h"
#include "memc_isr/PQL/SObjCtrl_extend.h"
#include "memc_isr/PQL/FlickerCtrl_extend.h"
#include "memc_isr/PQL/FlashCtrl_extend.h"
#include "memc_isr/PQL/FadeInOutCtrl_extend.h"
#include "memc_isr/PQL/PanningCtrl_extend.h"
#include "memc_isr/PQL/FRC_LogoDetect.h"
#include "memc_isr/PQL/LogoCtrl_extend.h"
#include "memc_isr/PQL/BasicInfoCheck.h"

#define TAG_NAME_MEMC "MEMC"
#define TV010_SMALL_OBJECT_ALGO 	(0)
...
typedef struct
{
	...
	////////// Merlin8p //////////
	_PARAM_PERIODIC_CTRL       _param_periodic_ctrl;
	_PARAM_InfoCheck           _param_info_check;
	_PARAM_SOBJ_CTRL           _param_sobj_ctrl;
	_PARAM_FLASH_CTRL          _param_flash_ctrl;
	_PARAM_FADEINOUT_CTRL      _param_fadeinout_ctrl;
	_PARAM_PANNING_CTRL        _param_panning_ctrl;
	_PARAM_LOGO_CTRL           _param_logo_ctrl;
	_PARAM_PATCH_CTRL          _param_patch_ctrl;
	_PARAM_FLICKER_CTRL        _param_flicker_ctrl;
}_PQLPARAMETER;
...
typedef struct
{
	...
	////////// Merlin8p //////////
	_OUTPUT_PATCH_CTRL          _output_patch_ctrl;
	_OUTPUT_PERIODIC_CTRL       _output_periodic_ctrl;
	_OUTPUT_SOBJ_CTRL           _output_sobj_ctrl;
	_OUTPUT_FLASH_CTRL          _output_flash_ctrl;
	_OUTPUT_FADEINOUT_CTRL      _output_fadeinout_ctrl;
	_OUTPUT_PANNING_CTRL        _output_panning_ctrl;
	_OUTPUT_LOGO_CTRL           _output_logo_ctrl;
	_OUTPUT_FLICKER_CTRL        _output_flicker_ctrl;
}_PQLCONTEXT;
...
////////// Merlin8 //////////
VOID PQL_ContextProc_ReadParam_RTK2885p(_PQLPARAMETER *pParam);
