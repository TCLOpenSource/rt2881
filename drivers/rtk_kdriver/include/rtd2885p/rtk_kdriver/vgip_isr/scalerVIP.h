...
#define Pro_tv006 0//#include "memc_isr/PQL/PQLPlatformDefs.h"
...
void scalerVIP_HDRCID_Reset(void);
unsigned char scalerVIP_HDRCID_Enable_Get(void);
void scalerVIP_HDRCID_Hanlde(_system_setting_info* sysInfo, _RPC_system_setting_info* RPC_sysInfo, _clues* smartPic_clue, _RPC_clues* RPC_smartPic_clue);
