...
typedef struct KADP_SE_NV12_STCHBLIT_T {
	KGAL_SURFACE_INFO_T tSrcSurface;
	KGAL_RECT_T tSrcRect;
	KGAL_SURFACE_INFO_T tDstSurface;
	KGAL_RECT_T tDstRect;
	KGAL_BLIT_FLAGS_T tBlitFlags;
	KGAL_BLIT_SETTINGS_T tBlitSettings;
	unsigned int src_c1_addr;
	unsigned int dst_c1_addr;
	SE_LOCK_INFO_T pinfo;
} KADP_SE_NV12_STCHBLIT_ST;
...
#define SE_IOC_NV12_STCHBLIT			_IOR(SE_IOC_MAGIC,  35, int)
#define SE_IOC_CMD_FUNC_LOCK 		_IOR(SE_IOC_MAGIC, 36, SE_LOCK_INFO_T)
#define SE_IOC_CMD_FUNC_UNLOCK 		_IO(SE_IOC_MAGIC, 37)

#define SE_IOC_MAXNR 38
