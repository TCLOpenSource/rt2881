...
#define VIP_START_ADDRESS_KERNEL       0x31600000  // + 0300000 (+   3M)
#define OD_START_ADDRESS_KERNEL        0x31900000  // + 0900000 (+   9M)
...
#define NC_VBM_START_ADDRESS_KERNEL       0x20000000  // + f000000 (+ 240M)
#define NC_MEMC_START_ADDRESS_KERNEL      0x2f000000  // + 0000000 (+   0M)
#define NC_MDOMAIN_START_ADDRESS_KERNEL   0x2f000000  // + 0000000 (+   0M)
#define NC_DI_NR_START_ADDRESS_KERNEL     0x2f000000  // + 0000000 (+   0M)
#define NC_NN_START_ADDRESS_KERNEL        0x2f000000  // +       0 (+   0M)
#define NC_VIP_START_ADDRESS_KERNEL       0x2f000000  // + 0200000 (+   2M)
#define NC_OD_START_ADDRESS_KERNEL        0x2f200000  // + 0900000 (+   9M)

#define NC_VDEC_BUFFER_START (NC_VBM_START_ADDRESS_KERNEL)
#define NC_VDEC_BUFFER_SIZE 240*_MB_    // 4K lossy 50%, VVC/AVS3 luma not compressed, support dual decode 2K+4K+decimate
...
#define NC_SCALER_MEMC_SIZE (0*_MB_)  // No MEMC in Mac series
...
#define NC_SCALER_MDOMAIN_SIZE ( 0*_MB_) // 2K2K(2160x2160) x 12 bits x 4 frames
...
#define NC_SCALER_DI_NR_SIZE ( 0*_MB_) // 4K rolling mode w/o MASNR

#if (NC_DI_NR_START_ADDRESS_KERNEL != NC_SCALER_DI_NR_START)
#error "NC_Scaler DI_NR size doesn't match for kernel & drivers!"
#endif

#define NC_SCALER_NN_START (NC_SCALER_DI_NR_START + NC_SCALER_DI_NR_SIZE)
#define NC_SCALER_NN_SIZE (0*_MB_)

#if (NC_NN_START_ADDRESS_KERNEL != NC_SCALER_NN_START)
#error "NC_Scaler NN size doesn't match for kernel & drivers!"
#endif

#define NC_SCALER_VIP_START (NC_SCALER_NN_START + NC_SCALER_NN_SIZE)
#define NC_SCALER_VIP_SIZE  (2*_MB_)
...
#define NC_SCALER_MODULE_SIZE_QUERY (NC_SCALER_MEMC_SIZE + NC_SCALER_MDOMAIN_SIZE + NC_SCALER_DI_NR_SIZE + NC_SCALER_NN_SIZE + NC_SCALER_VIP_SIZE + NC_SCALER_OD_SIZE)
...
#define DDR_1G5_VIP_START_ADDRESS_KERNEL       0x2f200000  // + 0300000 (+   3M)
#define DDR_1G5_OD_START_ADDRESS_KERNEL        0x2f500000  // + 0900000 (+   9M)
...
#define DDR_1GB_OD_START_ADDRESS_KERNEL        0x2b300000  // + 0900000 (+   9M)
...
#define DDR_1GB_SCALER_OD_SIZE  9*_MB_
...
#define CMA_HIGHMEM_DIAS_1GB  76*1024*1024
#define CMA_HIGHMEM_DIAS_1G5 260*1024*1024
#define CMA_HIGHMEM_DIAS_2GB 772*1024*1024
#define CMA_HIGHMEM_TV_2K 384*1024*1024
#define CMA_HIGHMEM_TV_4K_1G5 252*1024*1024
#define CMA_HIGHMEM_TV_4K 764*1024*1024
