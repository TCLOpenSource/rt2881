...
#define I3DDMA_MAIN_CAP_BUF_NUM				1
...
#define FINAL_BURST_LENTH 1024//for boundary use. last burst avoid trash
    ...
    #define _4K_2K_MDOMAIN_16BIT_SIZE (drvif_memory_get_data_align((_4K_WID_3840 * 16 + 256) / 8, DMA_SPEEDUP_ALIGN_VALUE) * _2K_LEN + FINAL_BURST_LENTH) //for boundary use. last burst avoid trash
#else
    ...
    #define _4K_2K_MDOMAIN_16BIT_SIZE ((_4K_WID_3840 * 16 + 256)  * _2K_LEN / 8 + FINAL_BURST_LENTH) //for boundary use. last burst avoid trash
#endif
#ifdef CONFIG_BW_96B_ALIGNED
