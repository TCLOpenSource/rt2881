...
#define VIP_DMAto3DTable_HDR_3D_LUT_SIZE (120 * 1024)
#define VIP_DMAto3DTable_HDR_EOTF_SIZE (100 * 1024)
...
#define VIP_DMAto3DTable_TC_SIZE (80 * 1024)
#define VIP_DMAto3DTable_OD_SIZE (20 * 1024)
#if 1
/*========================= for INNX demura =================================*/
...
typedef struct _VIP_ODPH_LUT_Gain_Data {
	...
	short ODPH_Gain_byLUT[VIP_CHANNEL_RGB_MAX];	// RGB,
...
void fwif_color_write_InvOutputGamma_curve(UINT32 *pArray_R, UINT32 *pArray_G, UINT32 *pArray_B, unsigned char is_online, unsigned char ucDoCtrlBack);
...
bool fwif_color_od_init(unsigned char Y_mode);
...
char fwif_color_set_valc_valuetable(unsigned short* pInputLUT,unsigned char TableIndex, unsigned char channel);
...
void fwif_color_DeMura_encode_mode( short* tbl_ori, unsigned char table_mode, unsigned char table_separate, unsigned char plane_num, VIP_DeMura_TBL * Demura_TBL);
...
char fwif_color_set_ODPH_LUT(VIP_OD_TBL *pOD_LUT, DRV_OD_Gain *APDEMgain, DRV_OD_Gain *TBLgain, unsigned char isDMA);
char fwif_color_set_ODPH_Gain(DRV_OD_Gain *APDEMgain, DRV_OD_Gain *TBLgain);
...
void fwif_color_od_table_Target2Delta_17x17(unsigned char *pTableIn, char *pTableOut);
void fwif_color_od_table_Target2Delta_17x17_16(unsigned char *pTableIn, short *pTableOut16);
