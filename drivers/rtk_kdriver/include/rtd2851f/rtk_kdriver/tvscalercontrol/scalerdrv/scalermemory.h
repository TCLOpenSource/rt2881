...
typedef enum
{
	...
	MDOMAIN_SETTING_ERR_MAIN_2K_ROTATE_NO_MEM,
	MDOMAIN_SETTING_ERR_MAIN_2K_NO_MEM,
...
extern void (*CMA_use_i3ddma_buffer_reset_DCMT)(unsigned long i3ddma_start_addr, unsigned int i3ddma_size);
...
extern void (*drv_memory_display_set_input_fast)(unsigned char display, unsigned char enable);
