...
typedef enum _VIP_Color_Space_Target {
	...
	// And11 blind mode
	Color_Space_Target_And11_Mono_BLIND_MODE,    // all   
	Color_Space_Target_And11_Deutera_BLIND_MODE, // green
	Color_Space_Target_And11_Prota_BLIND_MODE,   // red
	Color_Space_Target_And11_Trita_BLIND_MODE,   // blue
