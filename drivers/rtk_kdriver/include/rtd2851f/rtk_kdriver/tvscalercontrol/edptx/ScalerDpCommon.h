...
typedef enum{
    EDPTX_TIMING_4K60_594M_4lane_hbr2=0,
    EDPTX_TIMING_4K60_530D64M_4lane_hbr2,
    EDPTX_TIMING_4K60_533D28M_4lane_hbr2,
    EDPTX_TIMING_QHD165_4lane_hbr2,
    EDPTX_TIMING_4K1K_120_4lane_hbr,
    EDPTX_TIMING_4K1K_60_4lane_hbr,
    EDPTX_TIMING_QHD180_4lane_hbr2,
    EDPTX_TIMING_NUM,
} edptx_timing_type;
...
#define _PANEL_DPTX_LANE_NUMBER _PANEL_DPTX_LANE_NUMBER_8 // _PANEL_DPTX_LANE_NUMBER_4 // 1port=4Lane, 4port=16Lane
...
#define _DPTX_PN_SWAP                                       0xff    // board PN swap setting for Mac8p
#else
#define _DPTX_PN_SWAP                                       0x0
#endif // #if (_PANEL_DPTX_PN_SWAP == _ENABLE)

#if (_PANEL_DPTX_LANE_SWAP == _ENABLE)
#define _DPTX_LANE_SWAP_3_0     0xE4 // 0x11100100
#define _DPTX_LANE_SOURCE_3_0   0x00010203
#define _DPTX_LANE_SOURCE_7_4   0x04050607
#else
#define _DPTX_LANE_SWAP_3_0     0x1B // 0x00011011
#define _DPTX_LANE_SOURCE_3_0   0x03020100
#define _DPTX_LANE_SOURCE_7_4   0x07060504
#endif
...
//int UserCommonPowerPanel_Init(EnumPanelPowerSeq pwrStatus);
