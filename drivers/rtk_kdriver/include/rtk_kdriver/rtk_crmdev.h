...
typedef enum _rtk_crmdev_cmd_t {
  ...
  RTK_CRMDEV_CMD_MONITOR_RESOURCE_CHANGE,
  RTK_CRMDEV_CMD_RESPONSE_RESOURCE_CHANGE,
} rtk_crmdev_cmd_t;
...
typedef enum _rtk_crmdev_status_t {
  ...
  RTK_CRMDEV_STATUS_RESOURCE_CHANGE,
  RTK_CRMDEV_STATUS_BUSY,
} rtk_crmdev_status_t;
...
typedef enum _rtk_crmdev_codec_type_t {
  ...
  RTK_CRMDEV_CODEC_TYPE_VT_CAPTURE = 0x10000,
  RTK_CRMDEV_CODEC_TYPE_VT_CAMERA,
  RTK_CRMDEV_CODEC_TYPE_VT_ACR,
  RTK_CRMDEV_CODEC_TYPE_VT_SCREENCAPTURE,
  RTK_CRMDEV_CODEC_TYPE_VT_MEDIA,
...
typedef enum _rtk_crmdev_audio_port_t {
  ...
  RTK_CRMDEV_AUDIO_PORT_2 = 4,
  RTK_CRMDEV_AUDIO_PORT_3 = 8,
...
typedef struct _rtk_crmdev_resource_status_t {
  char clientName[64];
  bool acquired;
  rtk_crmdev_codec_info_t info;
} rtk_crmdev_resource_status_t;

typedef struct _rtk_crmdev_resource_change_t {
  int32_t count;
  rtk_crmdev_resource_status_t resList[10];
} rtk_crmdev_resource_change_t;
