...
unsigned int rtktlb_uaccess_enable(void);
void rtktlb_uaccess_disable(unsigned int flags);
...
#define FAKEMEMORY_SIZE 0x4B000000
#else
#define FAKEMEMORY_SIZE 0x20000000
#endif
#define FAKEMEMORY_GAP_SIZE 0x04000000
