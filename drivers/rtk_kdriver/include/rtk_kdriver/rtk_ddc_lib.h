...
int  rtk_ddc_lib_is_crt_on(unsigned char ch);
...
int rtk_ddc_lib_aux_switch_port(unsigned char id,int aux_id);
...
#else
#define rtk_hddc_crt_on()
#define rtk_hddc_sync_reset(id)
#define rtk_hddc_set_write_debounce(id,clock)       0
#define rtk_hddc_write_edid(id, edid_tbl, len)      0
#define rtk_hddc_read_edid(id,edid_tbl, len)        0
#define rtk_hddc_enable(id,enable)                  0
#define rtk_hddc_lib_set_sda_delay(id,delay_sel)    0
#define rtk_hddc_lib_get_ddc_state(id,edid_sts)     0
#define rtk_hddc_lib_set_edid_address(id,address)   0
#endif
...
#define rtk_dprx_ddc_lib_aux_switch_port(id,aux_id)  rtk_ddc_lib_aux_switch_port(RTK_HDMI_DPRX_DDC(id),aux_id);
...
#define rtk_hddc_set_ddc_wakeup_addr(id,addr,enable) rtk_ddc_lib_set_ddc_wakeup_addr(RTK_HDMI_DDC(id), addr, enable)
