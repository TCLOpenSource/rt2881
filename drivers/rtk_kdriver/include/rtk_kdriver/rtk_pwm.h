...
typedef struct {
    unsigned char u8_pdim;
    unsigned char u8_adim;
} RTK_PWM_EFFECT_EX_T;
...
extern int rtk_pwm_bl_en_switch(PIN_MODE_T mode, int rtk_freq, int rtk_duty);
extern int rtk_pwm_mprt_func(char* pcbname,int rtk_freq, int rtk_duty);
