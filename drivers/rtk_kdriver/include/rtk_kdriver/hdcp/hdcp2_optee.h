...
#define HDCP2_CMD_SET_PROTECT                   0x40
...
#define HDCP2_CMD_LOAD_TX_KEY                   0x62
#define HDCP2_CMD_Delete_TX_key                 0x63
#define HDCP2_CMD_Certificate_TX_key            0x64
#define HDCP2_CMD_Burn_TX_KEY                   0x65  //an14 don't use this
...
extern void optee_hdcp2_repeater_set_enable(HDMI_DP_HDCP2_MODE_T hdmi_dp, unsigned char id, unsigned char nport, unsigned char enable);
extern void optee_hdcp2_repeater_set_rxinfo_ridlist(HDMI_DP_HDCP2_MODE_T hdmi_dp, unsigned char id, unsigned char nport, unsigned short rxinfo, unsigned char *ridlist, unsigned int size);
extern void optee_hdcp2_get_receiver_id(unsigned char id, unsigned char *data, unsigned int len);
extern int  optee_hdcp_set_protect(HDMI_DP_HDCP2_MODE_T hdmi_dp, unsigned char ch, unsigned short enable);
extern int optee_hdcp2_cert_key(unsigned char *dataBuf,unsigned int dataLen, char *device_id, unsigned int *len);
//tx
extern int optee_hdcp2_cert_tx_key(unsigned char *dataBuf, unsigned int dataLen, char *device_id, unsigned int *len);
extern int optee_hdcp2_del_tx_key(void);
extern int optee_hdcp2_burn_tx_key(unsigned char *dataBuf, unsigned int dataLen);
#endif
