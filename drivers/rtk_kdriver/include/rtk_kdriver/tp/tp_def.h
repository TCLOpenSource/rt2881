...
#define TP0_BUFFER_MASS_DATA                      1
#define TP0_BUFFER_INFO_PACK                      2
#define TP0_BUFFER_SECTION_DATA                   1
#define TP0_BUFFER_CI_DATA                        1
...
typedef struct {
        ...
        UINT32 monitor_pvr_rp;
        UINT32 monitor_pvr_wp;
