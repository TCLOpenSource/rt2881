...
typedef enum
{
	...
	TP_DELIVERY_MODE_DEMUX_TS   = 5,  //demux TS
...
TP_EXTERN INT32 tp_allocate_section_info_buffer(void);
TP_EXTERN void tp_release_section_info_buffer(void);
