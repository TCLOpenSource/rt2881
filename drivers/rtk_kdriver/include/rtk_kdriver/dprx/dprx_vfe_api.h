...
#define CURRENT_CHANNEL                 0xff //for legacy code
/*------------------------------------------------
 ...
 *        DPRX_DRV_HW_ERR / DPRX_DRV_ARG_ERR
 *-----------------------------------------------*/
extern int vfe_dprx_drv_get_pd_ready_status(unsigned char ch, unsigned char*  p_pd_ready_status);
#define DPRX_TYPEC_PD_READY   0
#define DPRX_TYPEC_PD_BUSY    1
 ...
 *        DPRX_DRV_HW_ERR / DPRX_DRV_ARG_ERR
 *-----------------------------------------------*/
extern int vfe_dprx_drv_ch_get_avmute_status(unsigned char ch, unsigned char* p_avmute);
#define vfe_dprx_drv_get_avmute_status(p_avmute)                        vfe_dprx_drv_ch_get_avmute_status(CURRENT_CHANNEL, p_avmute)

/*------------------------------------------------------
 * Func : vfe_dprx_drv_get_pixel_encoding_format
 *
 ...
 *        DPRX_DRV_HW_ERR / DPRX_DRV_ARG_ERR
 *------------------------------------------------------*/
extern int vfe_dprx_drv_ch_get_pixel_encoding_format(unsigned char ch, DP_PIXEL_ENCODING_FORMAT_T *pPixelEnFormat);
#define vfe_dprx_drv_get_pixel_encoding_format(pPixelEnFormat)          vfe_dprx_drv_ch_get_pixel_encoding_format(CURRENT_CHANNEL, pPixelEnFormat)
...
#define vfe_dprx_drv_get_audio_status(p_audio_status)                  vfe_dprx_drv_ch_get_audio_status(CURRENT_CHANNEL, p_audio_status) 
 ...
 *        DPRX_DRV_HW_ERR / DPRX_DRV_ARG_ERR
 *-----------------------------------------------*/
extern int vfe_dprx_drv_set_wakeup_mode(unsigned char ch, DP_WAKEUP_MODE_E mode);
 ...
 *        DPRX_DRV_HW_ERR / DPRX_DRV_ARG_ERR
 *-----------------------------------------------*/
extern int vfe_dprx_drv_get_wakeup_mode(unsigned char ch, DP_WAKEUP_MODE_E* p_mode);
 ...
 *        DPRX_DRV_HW_ERR / DPRX_DRV_ARG_ERR
 *-----------------------------------------------*/
extern int vfe_dprx_drv_ch_handle_online_measure_error(unsigned char ch, unsigned char flags);
#define vfe_dprx_drv_handle_online_measure_error(flags)             vfe_dprx_drv_ch_handle_online_measure_error(CURRENT_CHANNEL, flags) 
#else
