...
typedef struct
{
    ...
    #define DPRX_TIMING_OVER_DISP_LIMIT  0x1    // video is not able to be playback by DISP
    #define DPRX_TIMING_BYPASSABLE       0x2    // video is able to bypass without DISP
    #define DPRX_TIMING_V_DROP_EN       (0x1<<7)  // video vdrop (v/2)
    #define DPRX_TIMING_H_DROP_EN       (0x1<<6)  // video hdrop (h/2)
...
typedef enum
{
    DP_AVI_CSC_RGB = 0,    /**< DPRX CSC info */
    DP_AVI_CSC_YCBCR422 = 1,
    DP_AVI_CSC_YCBCR444 = 2,
    DP_AVI_CSC_YCBCR420 = 3,
    DP_AVI_CSC_FUTURE = 4,
    DP_AVI_CSC_IDO = 0x7,
} DP_AVI_CSC_T;
...
typedef enum
{
    DP_AVI_ACTIVE_FORMAT_ARC_PICTURE = 0, /**< DPRX info */
    DP_AVI_ACTIVE_FORMAT_ARC_4_3CENTER = 1,
    DP_AVI_ACTIVE_FORMAT_ARC_16_9CENTER = 2,
    DP_AVI_ACTIVE_FORMAT_ARC_14_9CENTER = 3,
    DP_AVI_ACTIVE_FORMAT_ARC_4 = 4,
    DP_AVI_ACTIVE_FORMAT_ARC_5_RESERVED = 5,
    DP_AVI_ACTIVE_FORMAT_ARC_6_RESERVED = 6,
    DP_AVI_ACTIVE_FORMAT_ARC_7_RESERVED = 7,
    DP_AVI_ACTIVE_FORMAT_ARC_8_FULL_FRAME_IMAGE = 8,
    DP_AVI_ACTIVE_FORMAT_ARC_9 = 9,
    DP_AVI_ACTIVE_FORMAT_ARC_10 = 10,
    DP_AVI_ACTIVE_FORMAT_ARC_11 = 11,
    DP_AVI_ACTIVE_FORMAT_ARC_12 = 12,
    DP_AVI_ACTIVE_FORMAT_ARC_13 = 13,
    DP_AVI_ACTIVE_FORMAT_ARC_14 = 14,
    DP_AVI_ACTIVE_FORMAT_ARC_15 = 15,
...
typedef enum
{
    DP_WAKUEP_MODE_SEL_ONLY_DP_PORT_WAKEUP = 0,
    DP_WAKUEP_MODE_SEL_CURRENT_PORT_WAKEUP = 1,
}DP_WAKUEP_MODE_SEL_MODE_E;
...
typedef enum
{
    ...
    // Video Common Sel
    DP_EXCTL_VIDEO_COMMON_SEL,

    // DPRX VRR(Adatpvie Sync/Free Sync) Enable
    DP_EXCTL_VRR_EN,

    DP_EXCTL_WAKUEP_MODE_SEL, // set wakuep mode sel(DPRX_CURRENT_PORT_WAKEUP/DPRX_ONLY_DP_PORT_WAKEUP)
    DP_EXCTL_WAKEUP_MODE,

    // DPRX HDCP2x/1x Enable
    DP_EXCTL_HDCP1x_KEY_INIT,
    DP_EXCTL_HDCP2x_KEY_INIT,

    // API for Stream Bypass
    DP_EXCTL_STREAM_BYPASS_MODE,
...
typedef enum
{
    DP_VIDEO_COMMON_SEL_NONE = 0,
    DP_VIDEO_COMMON_SEL_1,
    DP_VIDEO_COMMON_SEL_2,
    DP_VIDEO_COMMON_SEL_3,
    DP_VIDEO_COMMON_SEL_4,
}DP_VIDEO_COMMON_SEL;
