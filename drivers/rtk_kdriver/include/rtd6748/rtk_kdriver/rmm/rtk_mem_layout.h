...
#define VBM_START_ADDRESS_KERNEL       0x20400000  // + cc00000 (+ 204M)
#define MEMC_START_ADDRESS_KERNEL      0x2d000000  // + 5700000 (+  87M)
#define MDOMAIN_START_ADDRESS_KERNEL   0x32700000  // + 0e00000 (+  14M)
#define DI_NR_START_ADDRESS_KERNEL     0x33500000  // + 0e00000 (+  14M)
#define VIP_START_ADDRESS_KERNEL       0x34300000  // + 0300000 (+   3M)
#define OD_START_ADDRESS_KERNEL        0x34600000  // + 0900000 (+   9M)
#define NN_START_ADDRESS_KERNEL        0x34f00000  // + 0100000 (+   1M)
#define TP_START_ADDRESS_KERNEL        0x35000000  //
...
#define VDEC_BUFFER_SIZE  204*_MB_    // 
...
/**
 *  --- Default memory layout (Non-Carvedout) start ---
 */

#define NC_CPB_START_ADDRESS_KERNEL       0x3ec00000  //

#define NC_VBM_START_ADDRESS_KERNEL       0x20400000  // + cc00000 (+ 204M)
#define NC_MEMC_START_ADDRESS_KERNEL      0x2d000000  // + 0000000 (+   0M)
#define NC_MDOMAIN_START_ADDRESS_KERNEL   0x2d000000  // + 0000000 (+   0M)
#define NC_DI_NR_START_ADDRESS_KERNEL     0x2d000000  // + 0000000 (+   0M)
#define NC_VIP_START_ADDRESS_KERNEL       0x2d000000  // + 0300000 (+   3M)
#define NC_OD_START_ADDRESS_KERNEL        0x2d300000  // + 0900000 (+   9M)
#define NC_NN_START_ADDRESS_KERNEL        0x2dc00000  // + 0000000 (+   1M)
#define NC_TP_START_ADDRESS_KERNEL        0x2dd00000  //

#define NC_SVP_CPB_START (NC_CPB_START_ADDRESS_KERNEL)
#define NC_SVP_CPB_SIZE (16*_MB_)

#if (NC_CPB_START_ADDRESS_KERNEL != NC_SVP_CPB_START)
#error "NC_SVP_CPB size doesn't match for kernel & drivers!"
#endif

#define NC_CMA_LOW_LIMIT_START      (0x03000000)
#define NC_CMA_LOW_LIMIT_SIZE       24*_MB_              //
#if (NC_CMA_LOW_LIMIT_START & 0x3FFFFF) || (NC_CMA_LOW_LIMIT_SIZE & 0x3FFFFF)
#error "NC_CMA_LOW_LIMIT no follow 4MB alignment"
#endif

#if 0
#define NC_CMA_LOW_START      (0x20000000)
#define NC_CMA_LOW_SIZE        104*_MB_              //
#if (NC_CMA_LOW_START & 0x3FFFFF) || (NC_CMA_LOW_SIZE & 0x3FFFFF)
#error "NC_CMA_LOW no follow 4MB alignment"
#endif
#endif

#define NC_VDEC_BUFFER_START (NC_VBM_START_ADDRESS_KERNEL)
#define NC_VDEC_BUFFER_SIZE  204*_MB_    // 
...
#define NC_SCALER_MDOMAIN_SIZE (0*_MB_) // 13MB for 2K FRC, 37MB if 4K FRC is needed, +1MB for 3DDRs 2GB
...
#define NC_SCALER_OD_SIZE   9*_MB_
...
#define NC_SCALER_NN_SIZE (1*_MB_) // 1MB
...
#define NC_SCALER_MODULE_SIZE_QUERY (NC_SCALER_MEMC_SIZE + 	\
								  NC_SCALER_MDOMAIN_SIZE + \
								  NC_SCALER_DI_NR_SIZE + 	\
								  NC_SCALER_NN_SIZE + 		\
								  NC_SCALER_VIP_SIZE +	 	\
								  NC_SCALER_OD_SIZE)
...
#define NC_DEMUX_TP_BUFFER_START (NC_TP_START_ADDRESS_KERNEL)
#if 1//def CONFIG_RTK_KDRV_DEMUX
#define NC_DEMUX_TP_BUFFER_SIZE 0*_MB_  // move to CMA
#else
#define NC_DEMUX_TP_BUFFER_SIZE 0
#endif

#if (NC_TP_START_ADDRESS_KERNEL != NC_DEMUX_TP_BUFFER_START)
#error "NC_TP buffer size doesn't match for kernel & drivers!"
#endif

/**
 *  --- Default memory layout (Non-Carvedout) end ---
 */
...
#define DDR_1G5_VBM_START_ADDRESS_KERNEL       0x20c00000  // + cc00000 (+ 204M)
#define DDR_1G5_MEMC_START_ADDRESS_KERNEL      0x2d800000  // + 4700000 (+  71M)
#define DDR_1G5_MDOMAIN_START_ADDRESS_KERNEL   0x31f00000  // + 0d00000 (+  13M)
#define DDR_1G5_DI_NR_START_ADDRESS_KERNEL     0x32c00000  // + 0d00000 (+  13M)
#define DDR_1G5_NN_START_ADDRESS_KERNEL        0x33900000  // + 0100000 (+   1M)
#define DDR_1G5_VIP_START_ADDRESS_KERNEL       0x33a00000  // + 0300000 (+   3M)
#define DDR_1G5_OD_START_ADDRESS_KERNEL        0x33d00000  // + 0900000 (+   9M)
#define DDR_1G5_TP_START_ADDRESS_KERNEL        0x34600000  //
...
#define DDR_1G5_VDEC_BUFFER_SIZE  204*_MB_    // 
...
#define DDR_1G5_SCALER_VIP_SIZE  (3*_MB_)
...
#define DDR_1G5_SCALER_OD_SIZE  (9*_MB_)
...
/**
 *  --- 1.5GB noncarveout memory layout start ---
 */
#if IS_ENABLED(CONFIG_REALTEK_LOGBUF)
#define NC_1G5_CONST_LOGBUF_MEM_ADDR_START (0x1ca00000)
#define NC_1G5_CONST_LOGBUF_MEM_SIZE (512*1024)
#else
#define NC_1G5_CONST_LOGBUF_MEM_ADDR_START 0
#define NC_1G5_CONST_LOGBUF_MEM_SIZE 0
#endif

#ifdef CONFIG_CUSTOMER_TV006	//for GAL reserve mem, 4MB align
extern const int NC_1G5_GAL_MEM_SIZE;
extern const int NC_1G5_GAL_MEM_ADDR_START;
#else
#define NC_1G5_GAL_MEM_SIZE 0
#define NC_1G5_GAL_MEM_ADDR_START 0
#endif

#define NC_1G5_VBM_START_ADDRESS_KERNEL       0x20c00000  // + cc00000 (+ 204M)
#define NC_1G5_MEMC_START_ADDRESS_KERNEL      0x33900000  // + 0000000 (+   0M)
#define NC_1G5_MDOMAIN_START_ADDRESS_KERNEL   0x33900000  // + 0d00000 (+   0M)
#define NC_1G5_DI_NR_START_ADDRESS_KERNEL     0x33900000  // + 0d00000 (+   0M)
#define NC_1G5_NN_START_ADDRESS_KERNEL        0x33900000  // + 0100000 (+   1M)
#define NC_1G5_VIP_START_ADDRESS_KERNEL       0x33a00000  // + 0300000 (+   3M)
#define NC_1G5_OD_START_ADDRESS_KERNEL        0x33d00000  // + 0900000 (+   9M)
#define NC_1G5_TP_START_ADDRESS_KERNEL        0x34600000  //

#define NC_1G5_CPB_START_ADDRESS_KERNEL       0x3ec00000  // 

#define NC_1G5_SVP_CPB_START (DDR_1G5_CPB_START_ADDRESS_KERNEL)
#define NC_1G5_SVP_CPB_SIZE (16*_MB_)

#if (NC_1G5_CPB_START_ADDRESS_KERNEL != NC_1G5_SVP_CPB_START)
#error "NC 1.5GB SVP_CPB size doesn't match for kernel & drivers!"
#endif

#define NC_1G5_CMA_LOW_START      (0x03800000)
#define NC_1G5_CMA_LOW_SIZE        128*_MB_              //
#if (NC_1G5_CMA_LOW_START & 0x3FFFFF) || (NC_1G5_CMA_LOW_SIZE & 0x3FFFFF)
#error "NC 1G5 CMA_LOW no follow 4MB alignment"
#endif

#define NC_1G5_VDEC_BUFFER_START (NC_1G5_VBM_START_ADDRESS_KERNEL)
#define NC_1G5_VDEC_BUFFER_SIZE  204*_MB_    // 

#if (NC_1G5_VBM_START_ADDRESS_KERNEL != NC_1G5_VDEC_BUFFER_START)
#error "NC 1.5GB VBM size doesn't match for kernel & drivers!"
#endif

#define NC_1G5_SCALER_MEMC_START (NC_1G5_MEMC_START_ADDRESS_KERNEL)
#define NC_1G5_SCALER_MEMC_SIZE (0*_MB_)

#if (NC_1G5_MEMC_START_ADDRESS_KERNEL != NC_1G5_SCALER_MEMC_START)
#error "NC 1.5GB MEMC size doesn't match for kernel & drivers!"
#endif

#define NC_1G5_SCALER_MDOMAIN_START (NC_1G5_SCALER_MEMC_START + NC_1G5_SCALER_MEMC_SIZE)
#define NC_1G5_SCALER_MDOMAIN_SIZE (0*_MB_) // 13MB for 2K FRC, 37MB if 4K FRC is needed

#if (NC_1G5_MDOMAIN_START_ADDRESS_KERNEL != NC_1G5_SCALER_MDOMAIN_START)
#error "NC 1.5GB Scaler M-domain size doesn't match for kernel & drivers!"
#endif

#define NC_1G5_SCALER_DI_NR_START (NC_1G5_SCALER_MDOMAIN_START + NC_1G5_SCALER_MDOMAIN_SIZE)
#define NC_1G5_SCALER_DI_NR_SIZE (0*_MB_) // 13MB

#if (NC_1G5_DI_NR_START_ADDRESS_KERNEL != NC_1G5_SCALER_DI_NR_START)
#error "NC 1.5GB Scaler DI_NR size doesn't match for kernel & drivers!"
#endif

#define NC_1G5_SCALER_NN_START (NC_1G5_SCALER_DI_NR_START + NC_1G5_SCALER_DI_NR_SIZE)
#define NC_1G5_SCALER_NN_SIZE (1*_MB_) // 1MB

#if (NC_1G5_NN_START_ADDRESS_KERNEL != NC_1G5_SCALER_NN_START)
#error "NC 1.5GB Scaler NN size doesn't match for kernel & drivers!"
#endif

#define NC_1G5_SCALER_VIP_START (NC_1G5_SCALER_NN_START + NC_1G5_SCALER_NN_SIZE)
#define NC_1G5_SCALER_VIP_SIZE  (3*_MB_)

#if (NC_1G5_VIP_START_ADDRESS_KERNEL != NC_1G5_SCALER_VIP_START)
#error "NC 1.5GB Scaler VIP size doesn't match for kernel & drivers!"
#endif

#define NC_1G5_SCALER_OD_START (NC_1G5_SCALER_VIP_START + NC_1G5_SCALER_VIP_SIZE)
#define NC_1G5_SCALER_OD_SIZE  (9*_MB_)

//fixme: why can't enable this compile check in arm64?
#if (NC_1G5_OD_START_ADDRESS_KERNEL != NC_1G5_SCALER_OD_START)
#error "NC 1.5GB Scaler OD size doesn't match for kernel & drivers!"
#endif

#define NC_1G5_SCLAER_MODULE_START NC_1G5_SCALER_MEMC_START
#define NC_1G5_SCALER_MODULE_SIZE_QUERY (NC_1G5_SCALER_MEMC_SIZE +			\
										  NC_1G5_SCALER_MDOMAIN_SIZE + 		\
										  NC_1G5_SCALER_DI_NR_SIZE + 			\
										  NC_1G5_SCALER_NN_SIZE + 				\
										  NC_1G5_SCALER_VIP_SIZE + 			\
										  NC_1G5_SCALER_OD_SIZE)
#define NC_1G5_SCALER_MODULE_SIZE (NC_1G5_SCALER_MODULE_SIZE_QUERY)
//#define NC_1G5_SCALER_MODULE_SIZE DO_ALIGNMENT(NC_1G5_SCALER_MODULE_SIZE_QUERY, 4*_MB_)
//#define NC_1G5_SCALER_MODULE_BAND (NC_1G5_SCALER_MODULE_SIZE - NC_1G5_SCALER_MODULE_SIZE_QUERY)
//#if (NC_1G5_SCALER_MODULE_SIZE & 0x3FFFFF) // 4MB align
//#error "1.5GB Scaler module size didn't follow 4MB alignment"
//#endif

#define NC_1G5_DEMUX_TP_BUFFER_START (NC_1G5_SCLAER_MODULE_START + NC_1G5_SCALER_MODULE_SIZE)
#define NC_1G5_DEMUX_TP_BUFFER_SIZE (0*_MB_)

#if (NC_1G5_TP_START_ADDRESS_KERNEL != DDR_1G5_DEMUX_TP_BUFFER_START)
#error "NC 1.5GB TP buffer size doesn't match for kernel & drivers!"
#endif

/**
 *  --- 1.5GB noncarveout memory layout end ---
 */
...
#define CMA_HIGHMEM_LARGE 628*_MB_
#else
#define CMA_HIGHMEM_LARGE 708*_MB_
#endif
