...
typedef enum {
	RTK_BW_LMMIT_TVSBX_CLIENT_HW_REQ = 0x0,  /* request num, 1 unit = 1 request */
	RTK_BW_LMMIT_TVSBX_CLIENT_HW_LEN = 0x1  /* burst len, 1 unit = 16x128bits */
} RTK_BW_LIMIT_TVSBX_CLIENT_HW_MODE_T;

typedef enum {
	RTK_BRIG_TVSB2_MAIN_CAP = 0x2,
	RTK_BRIG_TVSB2_MAIN_DIS = 0x3,
	RTK_BRIG_TVSB2_ERROR = 0xdeaddead
} RTK_BRIG_TVSB2_CLIENT_T;
...
extern int rtk_bw_limit_tvsb2_client_HW_set_mode(RTK_BW_LIMIT_TVSBX_CLIENT_HW_MODE_T mode);
extern int rtk_bw_limit_tvsb2_client_HW_set_threshold(RTK_BRIG_TVSB2_CLIENT_T brig_tvsb2_client, unsigned int timer, unsigned int request);
extern int rtk_bw_limit_tvsb2_client_HW_en(RTK_BRIG_TVSB2_CLIENT_T brig_tvsb2_client, bool enable);
