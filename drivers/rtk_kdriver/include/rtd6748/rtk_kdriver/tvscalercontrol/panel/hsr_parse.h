...
typedef struct _Bin_Setting_Header {
       unsigned int Offset;
       unsigned int endCode;
}BIN_SETTING_HEADER;

typedef struct _Bin_Setting_Data{
...
{
    BIN_SETTING_DATA tcon[TCON_SETTING_MAX];
    unsigned int len;
}HSR_TCON_DATA;
...
typedef struct hsr_eye_diagrams_data
{
    BIN_SETTING_DATA eye_digrams[EYE_DIAGRAMS_MAX];
    unsigned int len;
}HSR_EYE_DIAGRAMS_DATA;

typedef struct hsr_eye_diagrams_setting
{
    HSR_EYE_DIAGRAMS_DATA eye_diagrams_data[HSR_MAX];
}HSR_EYE_DIAGRAMS_SETTING;
