...
typedef enum _VIP_Color_Space_Target {
	...
	// for blind mode
	Color_Space_Target_Mono_BLIND_MODE,    // all   
	Color_Space_Target_Deutera_BLIND_MODE, // green
	Color_Space_Target_Prota_BLIND_MODE,   // red
	Color_Space_Target_Trita_BLIND_MODE,   // blue
...
typedef enum _VIP_WCG_MODE {
	...
	WCG_reserve8,
	WCG_reserve9,
	WCG_Mono_BLIND_MODE,    // all   
	WCG_Deutera_BLIND_MODE, // green
	WCG_Prota_BLIND_MODE,   // red
	WCG_Trita_BLIND_MODE,   // blue
