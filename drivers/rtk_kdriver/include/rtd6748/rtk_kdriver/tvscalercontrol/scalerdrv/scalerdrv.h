...
//#define CONFIG_RESET_VODMA_BY_MEASURE 1
...
#define AI_TRANSLATION_FIXED_FRAME_RATE 300//30 hz frame rate
...
typedef enum{
    RESET_VODMA_PHASE_MEASURE,
    RESET_VODMA_PHASE_RESULT,
} RESET_VODMA_PHASE;
...
typedef enum{
    ...
    NON_OLED_RESET_TARGET_CASE_CP_RPL_60HZ,
    NON_OLED_2K_RESET_TARGET_CASE,
...
typedef struct _AI_TRANSLATION_INFO{
...
unsigned short GetAiTransFuncInfo(unsigned short *frameNum);//get ai translation enable or not
void SetAiTransFuncInfo(unsigned short enable, unsigned short delaynum);//update ai translation info
