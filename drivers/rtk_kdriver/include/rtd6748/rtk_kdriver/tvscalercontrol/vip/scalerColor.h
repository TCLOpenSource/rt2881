...
void fwif_color_LD_SW_BoostCurrent(void);
unsigned short fwif_color_get_LD_Current(void);
void fwif_color_set_LD_Current(unsigned short current_value);
...
void fwif_color_set_od_by_TBL(SLR_VIP_TABLE_OD *ptr);
...
unsigned char fwif_color_od_Y_Mode_check(unsigned char Y_mode_en);
unsigned char fwif_color_od_RecusiveTBL_check(unsigned char Rec_OD_en);
...
char fwif_color_GLC_byMotion_VPQTSK(void);
char fwif_color_GLC_VDF_ISR(void);
...
void fwif_color_set_srnn_wdsr_y_delta_gain_by_sharpness(unsigned char shp_osd);
...
unsigned char fwif_color_Set_I_De_Contour_Enable(unsigned char en);
unsigned char fwif_color_Set_block_De_Contour_Enable(unsigned char en);
