...
typedef enum{
	...
	SQM_MODE_DEMO_BAR,	//4 sqm detect enable and display SQD debug osd
}SQM_MODE;
...
typedef enum{
	...
	GENRE_MODE_PERF,	//4 genre detect enable and with higher fps
}GENRE_MODE;
...
// end lesley 1002_1
#if 0 // (!defined(VIP_SUPPORT_AIPQ_BIN_V2_2))	// move to vipcommon
// lesley 1007
typedef struct {
...
//unsigned char get_svp_protect_status_aipq_proc(void);
unsigned char scalerAI_get_secure_flag_from_video_path(void);
//end 1015
