...
#define VIP_AUTOMA_Time_Profile_Max 20
typedef enum _VIP_AUTOMA_active_Mode
{
	VIP_AUTOMA_active_byWorkQuene = 0,
	VIP_AUTOMA_active_byISR,

	VIP_AUTOMA_active_mode_max,
} VIP_AUTOMA_active_Mode;

typedef struct _VIP_AUTOMA_Time_CTRL {
	unsigned int pq_automa_task_log_en;
	unsigned int pq_automa_task_profile[VIP_AUTOMA_Time_Profile_Max];

	unsigned int scalerVIP_colorMaAutoISR_log_en;
	unsigned int scalerVIP_colorMaAutoISR_profile[VIP_AUTOMA_Time_Profile_Max];

	unsigned int scalerVIP_colorMaAuto_TASK_apply_log_en;
	unsigned int scalerVIP_colorMaAuto_TASK_apply_profile[VIP_AUTOMA_Time_Profile_Max];

	unsigned int colorMaAuto_active_Mode;
} VIP_AUTOMA_Time_CTRL;
...
/* ==========for MEMC infor jzl 20151231============================ */
/* ====================================== */
void scalerVIP_colorMaAuto_TASK_ini(void);
...
void scalerVIP_set_YH_Hist_Array_List_Len(unsigned char u8_len);
unsigned char scalerVIP_get_YH_Hist_Array_List_Len(void);
...
void scalerVIP_Decontour_OnOff_by_CG(void);
...
void scalerVIP_nnsr_deltaYgain_by_CG(void);

void scalerVIP_MonoScope_Improve(void);
unsigned char scalerVIP_is_karaoke_4k60(void);
#endif
