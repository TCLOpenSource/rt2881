...
typedef struct
{
	...
	bool u2_uniform_panning; //off:MEMC_Uniform_Panning_None
	unsigned char u8_MAD_x;
	unsigned char u8_MAD_y;
	signed short s11_avg_rmv_x;
	signed short s10_avg_rmv_y;
	
	bool u1_Special_Scene_still_picture_tour_bus_Detect_flag;
	...
	//MEMC_Subtitle_Moving_Detect
	bool u1_moving_subtitle;
	bool u1_bot_mv_match;
	bool u1_cen_mv_match;
	unsigned char u8_subtitle_cnt;
