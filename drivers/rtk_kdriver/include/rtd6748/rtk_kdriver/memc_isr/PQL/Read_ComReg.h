...
typedef struct
{
	...
	unsigned int u22_me_rSC_max;

	unsigned int u21_Adjacent_Blk_DTL_max;
	...
	unsigned short u11_max_rMV_vx;
	unsigned short u10_max_rMV_vy;
	unsigned short u11_max_boundary_vx;
	unsigned short u10_max_boundary_vy;
	...
	unsigned int u27_ipme_Mot_MovingAvg;
