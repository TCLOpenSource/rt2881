...
typedef enum _VIP_DEM_ARG_CTRL_ITEMS {
	...
	DEM_ARG_Blue_Stretch_level, //new_user_menu
	DEM_ARG_Black_Extension_level,//new_user_menu
	DEM_ARG_White_Extension_level,//new_user_menu
	DEM_ARG_Data_Range,//new_user_menu
	DEM_ARG_Gamma_exp_byOffset,//new_user_menu
	DEM_ARG_10p_Gamma_Offset,
	DEM_ARG_Gamma_idx_set,//new_user_menu
	DEM_ARG_Color_Space,
	DEM_ARG_D_3DLUT_Offset,//new_user_menu
	DEM_ARG_Gamma_CURVE_TBL_PANEL_Chromaticity,//new_user_menu
	DEM_ARG_LPF_Gain_ColorDataFac,//new_user_menu
	DEM_ARG_OD_Gain,//new_user_menu
	DEM_ARG_Dynamic_Black_Equalize_Gain,//new_user_menu
	DEM_ARG_Shadow_detail_Gain,//new_user_menu
	DEM_ARG_LowB_Gain,//new_user_menu
	DEM_ARG_Smooth_Gradation,//new_user_menu
...
typedef struct _VIP_VPQ_IOC_CT_DelaySet_CTRL 
{
	...
	unsigned int Gamma_10p[VIP_DEM_10p_Gamma_Offset_Num*VIP_GAMMA_CHANNEL_RGB_MAX];
