...
#if defined(CONFIG_KASAN) && (LINUX_VERSION_CODE <= KERNEL_VERSION(5, 5, 0))
...
#define DDR_1G5_MDOMAIN_START_ADDRESS_KERNEL   0x2f000000  // + 1c00000 (+  28M)
#define DDR_1G5_DI_NR_START_ADDRESS_KERNEL     0x30c00000  // + 0900000 (+   9M)
#define DDR_1G5_VIP_START_ADDRESS_KERNEL       0x31500000  // + 0200000 (+   2M)
#define DDR_1G5_OD_START_ADDRESS_KERNEL        0x31700000  // +       0 (+   0M)
#define DDR_1G5_NN_START_ADDRESS_KERNEL        0x31700000  // +       0 (+   0M)
#else
...
#define DDR_2K_MODEL_VIP_START_ADDRESS_KERNEL       0x22c00000  // + 0100000 (+   1M)
#define DDR_2K_MODEL_OD_START_ADDRESS_KERNEL        0x22d00000  // + 0000000 (+   0M)
#define DDR_2K_MODEL_NN_START_ADDRESS_KERNEL        0x22d00000  // + 0000000 (+   0M)
...
#define DDR_2K_MODEL_SCALER_VIP_SIZE  (1*_MB_)
...
/**
 *  --- 2K_MODEL memory layout (Non-Carvedout) start ---
 */
#define NC_DDR_2K_MODEL_VIDEO_RINGBUFFER_START         0x1b200000
#define NC_DDR_2K_MODEL_VIDEO_RINGBUFFER_SIZE			0x800000
#define NC_DDR_2K_MODEL_VIDEO_RINGBUFFER_SIZE_K2L_ONLY 		 0x1800000
#define NC_DDR_2K_MODEL_AUDIO_RINGBUFFER_START         (DDR_2K_MODEL_VIDEO_RINGBUFFER_START+DDR_2K_MODEL_VIDEO_RINGBUFFER_SIZE)
#define NC_DDR_2K_MODEL_AUDIO_RINGBUFFER_SIZE                      0x00600000

#if IS_ENABLED(CONFIG_REALTEK_LOGBUF)
#define NC_DDR_2K_MODEL_CONST_LOGBUF_MEM_ADDR_START (0x1ca00000)
#define NC_DDR_2K_MODEL_CONST_LOGBUF_MEM_SIZE (512*1024)
#else
#define NC_DDR_2K_MODEL_CONST_LOGBUF_MEM_ADDR_START 0
#define NC_DDR_2K_MODEL_CONST_LOGBUF_MEM_SIZE 0
#endif

#ifdef CONFIG_CUSTOMER_TV006	//for GAL reserve mem, 4MB align
extern const int NC_DDR_2K_MODEL_GAL_MEM_SIZE;
extern const int NC_DDR_2K_MODEL_GAL_MEM_ADDR_START;
#else
#define NC_DDR_2K_MODEL_GAL_MEM_SIZE 0
#define NC_DDR_2K_MODEL_GAL_MEM_ADDR_START 0
#endif

#define NC_DDR_2K_MODEL_VBM_START_ADDRESS_KERNEL       0x20000000  // + 2400000 (+  36M)
#define NC_DDR_2K_MODEL_MEMC_START_ADDRESS_KERNEL      0x22400000  // + 0000000 (+   0M)
#define NC_DDR_2K_MODEL_MDOMAIN_START_ADDRESS_KERNEL   0x22400000  // + 0000000 (+   0M)
#define NC_DDR_2K_MODEL_DI_NR_START_ADDRESS_KERNEL     0x22400000  // + 0000000 (+   0M)
#define NC_DDR_2K_MODEL_VIP_START_ADDRESS_KERNEL       0x22400000  // + 0100000 (+   1M)
#define NC_DDR_2K_MODEL_OD_START_ADDRESS_KERNEL        0x22500000  // + 0000000 (+   0M)
#define NC_DDR_2K_MODEL_NN_START_ADDRESS_KERNEL        0x22500000  // + 0000000 (+   0M)

#define NC_DDR_2K_MODEL_VDEC_BUFFER_START (DDR_2K_MODEL_VBM_START_ADDRESS_KERNEL)
#define NC_DDR_2K_MODEL_VDEC_BUFFER_SIZE 36*_MB_    // 50% lossy compression 23.5MB + 8.5MB, cmprs hdr 4MB (single decoding, 2nd decoding uses CMA)

#ifdef NC_DDR_2K_MODEL_VBM_START_ADDRESS_KERNEL
#if (NC_DDR_2K_MODEL_VBM_START_ADDRESS_KERNEL != NC_DDR_2K_MODEL_VDEC_BUFFER_START)
#error "NC_2K_MODEL VBM size doesn't match for kernel & drivers!"
#endif
#else
#error "NC_2K_MODEL No define VBM_START_ADDRESS_KERNEL"
#endif

#define NC_DDR_2K_MODEL_SCALER_MEMC_START (NC_DDR_2K_MODEL_VDEC_BUFFER_START + NC_DDR_2K_MODEL_VDEC_BUFFER_SIZE)
#define NC_DDR_2K_MODEL_SCALER_MEMC_SIZE (0*_MB_)

#if (NC_DDR_2K_MODEL_MEMC_START_ADDRESS_KERNEL != NC_DDR_2K_MODEL_SCALER_MEMC_START)
#error "NC_2K_MODEL Scaler M-domain size doesn't match for kernel & drivers!"
#endif

#define NC_DDR_2K_MODEL_SCALER_MDOMAIN_START (NC_DDR_2K_MODEL_SCALER_MEMC_START + NC_DDR_2K_MODEL_SCALER_MEMC_SIZE)
#define NC_DDR_2K_MODEL_SCALER_MDOMAIN_SIZE (0*_MB_) // 0MB(M-Domain)

#if (NC_DDR_2K_MODEL_MDOMAIN_START_ADDRESS_KERNEL != NC_DDR_2K_MODEL_SCALER_MDOMAIN_START)
#error "NC_2K_MODEL Scaler M-domain size doesn't match for kernel & drivers!"
#endif

#define NC_DDR_2K_MODEL_SCALER_DI_NR_START (NC_DDR_2K_MODEL_SCALER_MDOMAIN_START + NC_DDR_2K_MODEL_SCALER_MDOMAIN_SIZE)
#define NC_DDR_2K_MODEL_SCALER_DI_NR_SIZE (0*_MB_) // 8MB(DI/RTNR)

#if (NC_DDR_2K_MODEL_DI_NR_START_ADDRESS_KERNEL != NC_DDR_2K_MODEL_SCALER_DI_NR_START)
#error "NC_2K_MODEL Scaler DI_NR size doesn't match for kernel & drivers!"
#endif

#define NC_DDR_2K_MODEL_SCALER_VIP_START (NC_DDR_2K_MODEL_SCALER_DI_NR_START + NC_DDR_2K_MODEL_SCALER_DI_NR_SIZE)
#define NC_DDR_2K_MODEL_SCALER_VIP_SIZE  (1*_MB_)

//fixme: why can't enable this compile check in arm64?
#ifndef CONFIG_ARM64
#ifdef NC_DDR_2K_MODEL_VIP_START_ADDRESS_KERNEL
#if (NC_DDR_2K_MODEL_VIP_START_ADDRESS_KERNEL != NC_DDR_2K_MODEL_SCALER_VIP_START)
#error "NC_2K_MODEL Scaler VIP size doesn't match for kernel & drivers!"
#endif
#else
#error "No define NC_DDR_2K_MODEL_VIP_START_ADDRESS_KERNEL"
#endif
#endif

#define NC_DDR_2K_MODEL_SCALER_OD_START (NC_DDR_2K_MODEL_SCALER_VIP_START + NC_DDR_2K_MODEL_SCALER_VIP_SIZE)
#define NC_DDR_2K_MODEL_SCALER_OD_SIZE  0*_MB_

//fixme: why can't enable this compile check in arm64?
#ifndef CONFIG_ARM64
#ifdef NC_DDR_2K_MODEL_OD_START_ADDRESS_KERNEL
#if (NC_DDR_2K_MODEL_OD_START_ADDRESS_KERNEL != NC_DDR_2K_MODEL_SCALER_OD_START)
#error "NC_2K_MODEL Scaler OD size doesn't match for kernel & drivers!"
#endif
#else
#error "2K_MODEL No define NC_OD_START_ADDRESS_KERNEL"
#endif

#endif

#define NC_DDR_2K_MODEL_SCALER_NN_START (NC_DDR_2K_MODEL_SCALER_OD_START + NC_DDR_2K_MODEL_SCALER_OD_SIZE)
#define NC_DDR_2K_MODEL_SCALER_NN_SIZE (0*_MB_) //

#if (NC_DDR_2K_MODEL_NN_START_ADDRESS_KERNEL != NC_DDR_2K_MODEL_SCALER_NN_START)
#error "NC_2K_MODEL Scaler NN size doesn't match for kernel & drivers!"
#endif

#define NC_DDR_2K_MODEL_SCLAER_MODULE_START NC_DDR_2K_MODEL_SCALER_MEMC_START
#define NC_DDR_2K_MODEL_SCALER_MODULE_SIZE_QUERY (NC_DDR_2K_MODEL_SCALER_MEMC_SIZE +    \
                                               NC_DDR_2K_MODEL_SCALER_MDOMAIN_SIZE + \
                                               NC_DDR_2K_MODEL_SCALER_DI_NR_SIZE +   \
                                               NC_DDR_2K_MODEL_SCALER_NN_SIZE +      \
                                               NC_DDR_2K_MODEL_SCALER_VIP_SIZE +     \
                                               NC_DDR_2K_MODEL_SCALER_OD_SIZE)
#define NC_DDR_2K_MODEL_SCALER_MODULE_SIZE DO_ALIGNMENT(NC_DDR_2K_MODEL_SCALER_MODULE_SIZE_QUERY, 4*_MB_)
#define NC_DDR_2K_MODEL_SCALER_MODULE_BAND (NC_DDR_2K_MODEL_SCALER_MODULE_SIZE - NC_DDR_2K_MODEL_SCALER_MODULE_SIZE_QUERY)

#if (NC_DDR_2K_MODEL_SCALER_MODULE_SIZE & 0x3FFFFF) // 4MB align
#error "NC_2K_MODEL Scaler module size didn't follow 4MB alignment"
#endif

#define NC_DDR_2K_MODEL_DEMUX_TP_BUFFER_START (NC_DDR_2K_MODEL_SCLAER_MODULE_START + NC_DDR_2K_MODEL_SCALER_MODULE_SIZE)
#ifdef CONFIG_RTK_KDRV_DEMUX
#define NC_DDR_2K_MODEL_DEMUX_TP_BUFFER_SIZE 0 //32*_MB_  // must be 4MB page block alignment
#else
#define NC_DDR_2K_MODEL_DEMUX_TP_BUFFER_SIZE 0
#endif

#if defined(CONFIG_KASAN) && (LINUX_VERSION_CODE <= KERNEL_VERSION(5, 5, 0))
#define NC_DDR_2K_MODEL_KASAN_SHADOW_PHYS (NC_DDR_2K_MODEL_DEMUX_TP_BUFFER_START + NC_DDR_2K_MODEL_DEMUX_TP_BUFFER_SIZE)
#endif

/**
 *  --- 2K_MODEL memory layout (Non-Carvedout) end ---
 */
