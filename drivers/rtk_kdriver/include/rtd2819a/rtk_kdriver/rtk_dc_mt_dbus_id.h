...
{
        MODULE_STR(TVSB2_M_CAP_C ),
        MODULE_STR(TVSB2_M_DISP_C),
        MODULE_STR(TVSB2_S_CAP_C ),
        MODULE_STR(TVSB2_S_DISP_C),
        MODULE_STR(TVSB2_M_CAP_Y ),
        MODULE_STR(TVSB2_M_DISP_Y),
        MODULE_STR(TVSB2_S_CAP_Y ),
        MODULE_STR(TVSB2_S_DISP_Y),
        MODULE_STR(TVSB2_DIW),
        MODULE_STR(TVSB2_DIR),
        MODULE_STR(TVSB2_SNR),
        MODULE_STR(TVSB2),
        MODULE_STR(TVSB1_VD ),
        MODULE_STR(TVSB1_AUDIO_W),
        MODULE_STR(TVSB1_AUDIO_R),
        MODULE_STR(TVSB1_VBI),
        MODULE_STR(TVSB1),
        MODULE_STR(SB1_TP_TP2_KC),
        ...
        MODULE_STR(SB2_RTMMU),
        MODULE_STR(SB2_CP_KC),
        MODULE_STR(SB2_CP_NKC),
        MODULE_STR(SB2),
        MODULE_STR(TVSB6_MCAP_HDMI_TX_W ),
        MODULE_STR(TVSB6_MDISP_HDMI_TX_R),
        MODULE_STR(TVSB6_I4DDMA ),
        MODULE_STR(TVSB6_I5DDMA ),
        MODULE_STR(TVSB6_I6DDMA ),
        MODULE_STR(TVSB6_VO1_Y),
        MODULE_STR(TVSB6_VO1_C),
        MODULE_STR(TVSB6_VO2_Y),
        MODULE_STR(TVSB6_VO2_C),
        MODULE_STR(TVSB6_I3DDMA ),
        MODULE_STR(TVSB6),
        MODULE_STR(VE_VM1 ),
        MODULE_STR(VE_VM2 ),
        MODULE_STR(VE_PRD ),
        ...
        MODULE_STR(TVSB3_SETFBDC0_Q0),
        MODULE_STR(TVSB3_SETFBDC0_Q1),
        MODULE_STR(TVSB3),
        MODULE_STR(GPU_NKC),
        MODULE_STR(GPU_KC ),
        MODULE_STR(GPU10),
        ...
        MODULE_STR(TVSB4_UVC_W1 ),
        MODULE_STR(TVSB4_UVC2_W2),
        MODULE_STR(TVSB4_UVC_HEAD ),
        MODULE_STR(TVSB4_DEMURA ),
        MODULE_STR(TVSB4_USB3_DEVICE),
        MODULE_STR(TVSB4_DEMOD),
        MODULE_STR(TVSB4_DEBUGDMA ),
        MODULE_STR(TVSB4_DC2H2_W),
        MODULE_STR(TVSB4_RTK_LD_R ),
        MODULE_STR(TVSB4_SLD_W),
        MODULE_STR(TVSB4),
        MODULE_STR(TVSB8_OSD1 ),
        MODULE_STR(TVSB8_OSD2 ),
        MODULE_STR(TVSB8_OSD3 ),
        MODULE_STR(TVSB8_OSD4 ),
        MODULE_STR(TVSB8_OSD5 ),
        MODULE_STR(TVSB8_OSD1FBC),
        MODULE_STR(TVSB8_OSD2FBC),
        MODULE_STR(TVSB8_OSD4FBC),
        MODULE_STR(TVSB8_OSD5FBC),
        MODULE_STR(TVSB8_DMATO3DLUT ),
        MODULE_STR(TVSB8),
...
unsigned char key_table_audio[] = {MODULE_ACPU_S};
unsigned char key_table_se[] = {MODULE_TVSB3_SEQ0,MODULE_TVSB3_SEQ1};
//unsigned char key_table_ve[] = {MODULE_VE};
unsigned char key_table_dispi[] = {MODULE_TVSB2_DIW,MODULE_TVSB2_DIR,MODULE_TVSB6_VO1_Y,MODULE_TVSB6_VO1_C, MODULE_TVSB6_VO2_Y, MODULE_TVSB6_VO2_C,
                                                MODULE_TVSB6_I3DDMA,
                                                MODULE_TVSB2_SNR};
unsigned char key_table_dispm[] = {MODULE_TVSB2_M_CAP_C,MODULE_TVSB2_M_DISP_C};
...
#else
unsigned char key_table_memc[] ={};
#endif

unsigned char key_table_osd[] = {MODULE_TVSB8_OSD1,MODULE_TVSB8_OSD2,MODULE_TVSB8_OSD3, MODULE_TVSB8_OSD4,MODULE_TVSB8_OSD5};
...
unsigned char key_table_tp[] = {MODULE_SB1_TP_TP2_NKC,MODULE_SB1_TP_TP2_KC};
...
unsigned char key_table_demod[] = {MODULE_TVSB4_DEMOD};
...
unsigned char key_table_me[] = {};
//unsigned char key_table_subtitle[] = {MODULE_TVSB4_SUBT};
unsigned char key_table_dma[] = {MODULE_TVSB4_DEBUGDMA,MODULE_TVSB8_DMATO3DLUT};
...
unsigned char trap_table_kcpucp[] = {MODULE_SB2_CP_KC};
unsigned char trap_table_scpucp[] = {MODULE_SB2_CP_NKC};
unsigned char trap_table_kcputp[] = {MODULE_SB1_TP_TP2_KC};
unsigned char trap_table_scputp[] = {MODULE_SB1_TP_TP2_NKC};
