...
static const t_sb2_timout_moudle module_sb2_info[] =
{
    ...
    {0x18034000, 0x18034fff, "VE2"},
    {0x18035000, 0x18035FFF, "VE2"},
    ...
    /* 0x18046000-0x18046fff  reserved */
    {0x18047000, 0x18047FFF, "HDMITX_PHY"},
    {0x18048000, 0x18049FFF, "HDMITX"},
    {0x1804A000, 0x1804BFFF, "HDMI_PreProcess"},
    {0x1804C000, 0x1804FFFF, "HDMI_DP_common"},
    ...
    {0x1805F000, 0x1805FFFF, "USB3_Device"},
    ...
    {0x1807B000, 0x1807B7FF, "DSCE2"},
    {0x1807B800, 0x1807BFFF, "DSCD2"},
    {0x1807C000, 0x1807EFFF, "PCIE"},
    {0x1807F000, 0x1807FFFF, "SPI_SYNCHRONIZER"},

    //1808_0000  - 1808_ffff
    {0x18080000, 0x18087FFF, "DPRX"},
    {0x18088000, 0x1808FFFF, "DPRX2"},
    ...
    //180A_0000  - 180A_ffff
    {0x180A0000, 0x180A8FFF, "USB_OT2"},
    {0x180A9000, 0x180AFFFF, "USB3_Device"},
    ...
    {0x180D9000, 0x180D9FFF, "USB3_Device"},
    {0x180DA000, 0x180DAFFF, "USBEX"},
    {0x180DB000, 0x180DCFFF, "USB3_Device"},
    {0x180DD000, 0x180DDFFF, "USB_BB2"},
    {0x180DE000, 0x180DEFFF, "USB_HUB2"},
    {0x180DF000, 0x180DFFFF, "USBEX"},

    //180E_0000  - 180E_ffff
    {0x180E0000, 0x180EFFFF, "demod core"},

    //180F_0000  - 180F_ffff
    {0x180F0000, 0x180FFFFF, "demod core"},
    ...
    //1818_0000  - 181B_ffff
    {0x18180000, 0x181BFFFF, "GPU"},

    //181C_0000  - 181C_ffff
    {0x181C0000, 0x181C1FFF, "GPU_wrapper"},
    {0x181C2000, 0x181C3FFF, "DOLBY"},
    {0x181C4000, 0x181C4FFF, "GDMA"},
    /* 5000-5fff  reserved*/
    {0x181C6000, 0x181C7FFF, "LVDS"},
    /* 8000-ffff  reserved*/

    //181D_0000  - 181F_ffff reserved
};
