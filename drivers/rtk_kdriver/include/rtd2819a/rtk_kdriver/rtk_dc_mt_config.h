...
#define MODULE_TVSB2_M_CAP_C             MODULE_ID(0, 0)
#define MODULE_TVSB2_M_DISP_C            MODULE_ID(0, 1)
#define MODULE_TVSB2_S_CAP_C             MODULE_ID(0, 2)
#define MODULE_TVSB2_S_DISP_C            MODULE_ID(0, 3)
#define MODULE_TVSB2_M_CAP_Y             MODULE_ID(0, 4)
#define MODULE_TVSB2_M_DISP_Y            MODULE_ID(0, 5)
#define MODULE_TVSB2_S_CAP_Y             MODULE_ID(0, 6)
#define MODULE_TVSB2_S_DISP_Y            MODULE_ID(0, 7)
#define MODULE_TVSB2_DIW                  MODULE_ID(0, 8)   
#define MODULE_TVSB2_DIR                  MODULE_ID(0, 9)   
#define MODULE_TVSB2_SNR                  MODULE_ID(0, 0xa)
#define MODULE_TVSB2                      MODULE_ID(0x0, 0xf)
...
#define MODULE_SB1_TP_TP2_KC                    MODULE_ID(2, 0)
...
#define MODULE_SB1_TP_TP2_NKC                   MODULE_ID(2, 0xd)
...
#define MODULE_SB2_RTMMU                MODULE_ID(3, 0x9)
#define MODULE_SB2_CP_KC                MODULE_ID(3, 0xA)
#define MODULE_SB2_CP_NKC                MODULE_ID(3, 0xB)
#define MODULE_SB2                      MODULE_ID(3, 0xf)



#define MODULE_TVSB6_MCAP_HDMI_TX_W             MODULE_ID(4, 0)
#define MODULE_TVSB6_MDISP_HDMI_TX_R            MODULE_ID(4, 1)
#define MODULE_TVSB6_I4DDMA                           MODULE_ID(4, 2)
#define MODULE_TVSB6_I5DDMA                           MODULE_ID(4, 3)
#define MODULE_TVSB6_I6DDMA                           MODULE_ID(4, 4)

#define MODULE_TVSB6_VO1_Y                  MODULE_ID(4, 6)
#define MODULE_TVSB6_VO1_C                  MODULE_ID(4, 7)
#define MODULE_TVSB6_VO2_Y                  MODULE_ID(4, 8)
#define MODULE_TVSB6_VO2_C                  MODULE_ID(4, 9)

#define MODULE_TVSB6_I3DDMA                 MODULE_ID(4, 0xA)
#define MODULE_TVSB6                        MODULE_ID(4, 0xf)
...
#define MODULE_TVSB3_SETFBDC0_Q0            MODULE_ID(0x6 ,8)
#define MODULE_TVSB3_SETFBDC0_Q1            MODULE_ID(0x6 ,9)
...
#define MODULE_TVSB4_UVC_W1                             MODULE_ID(0xb ,4)
#define MODULE_TVSB4_UVC2_W2                            MODULE_ID(0xb ,5)
#define MODULE_TVSB4_UVC_HEAD                           MODULE_ID(0xb, 6)
#define MODULE_TVSB4_DEMURA                             MODULE_ID(0xb ,7)
#define MODULE_TVSB4_USB3_DEVICE                        MODULE_ID(0xb, 8)
#define MODULE_TVSB4_DEMOD                              MODULE_ID(0xb, 9)
#define MODULE_TVSB4_DEBUGDMA                           MODULE_ID(0xb, 0xa)
#define MODULE_TVSB4_DC2H2_W                            MODULE_ID(0xb,0xc)
#define MODULE_TVSB4_RTK_LD_R                           MODULE_ID(0xb,0xd)
#define MODULE_TVSB4_SLD_W                              MODULE_ID(0xb,0xe)
#define MODULE_TVSB4                                    MODULE_ID(0xb, 0xf)

#define MODULE_TVSB8_OSD1                       MODULE_ID(0xC, 0)     
#define MODULE_TVSB8_OSD2                       MODULE_ID(0xC, 1)     
#define MODULE_TVSB8_OSD3                       MODULE_ID(0xC, 2)     
#define MODULE_TVSB8_OSD4                       MODULE_ID(0xC, 3)     
#define MODULE_TVSB8_OSD5                       MODULE_ID(0xC, 4)     
#define MODULE_TVSB8_OSD1FBC                    MODULE_ID(0xC, 5)     
#define MODULE_TVSB8_OSD2FBC                    MODULE_ID(0xC, 6)     
#define MODULE_TVSB8_OSD4FBC                    MODULE_ID(0xC, 7)     
#define MODULE_TVSB8_OSD5FBC                    MODULE_ID(0xC, 8)     
#define MODULE_TVSB8_DMATO3DLUT                 MODULE_ID(0xC, 9)     
#define MODULE_TVSB8                            MODULE_ID(0xC,0xF)
...
#define  DCMT_MODULE_DEMOD       MODULE_TVSB4_DEMOD
#define  DCMT_MODULE_CP_KC       MODULE_SB2_CP_KC 
#define  DCMT_MODULE_M_CAP       MODULE_TVSB2_M_CAP_Y
#define  DCMT_MODULE_M_CAP_C     MODULE_TVSB2_M_CAP_C
#define  DCMT_MODULE_M_DISP      MODULE_TVSB2_M_DISP_Y
#define  DCMT_MODULE_M_DISP_C    MODULE_TVSB2_M_DISP_C
#define  DCMT_MODULE_S_CAP       MODULE_TVSB2_S_CAP_Y
#define  DCMT_MODULE_S_CAP_C     MODULE_TVSB2_S_CAP_C
#define  DCMT_MODULE_S_DISP      MODULE_TVSB2_S_DISP_Y
#define  DCMT_MODULE_S_DISP_C    MODULE_TVSB2_S_DISP_C
#define  DCMT_MODULE_SNR         MODULE_TVSB2_SNR
#define  DCMT_MODULE_DMATO3DLUT  MODULE_TVSB8_DMATO3DLUT 
#define  DCMT_MODULE_TP_KC       MODULE_SB1_TP_TP2_KC
#define  DCMT_MODULE_TP_NKC      MODULE_SB1_TP_TP2_NKC      
