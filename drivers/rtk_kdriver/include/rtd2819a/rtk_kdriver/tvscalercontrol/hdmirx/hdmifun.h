...
extern unsigned char             drvif_hdmi_audio_get_current_status(unsigned char ch);
extern unsigned char             drvif_hdmi_audio_get_channel_num(unsigned char ch);
extern unsigned int              drvif_hdmi_audio_get_hbr_sample_count(unsigned char ch);
extern unsigned int              drvif_hdmi_audio_get_sample_freq(unsigned char ch);
...
// HDCP related
extern HDMI_bool                 drvif_Hdmi_Multi_port_HdcpEnabled(unsigned char ch);

#define drvif_Hdmi_HdcpEnabled()        drvif_Hdmi_Multi_port_HdcpEnabled(HAL_VFE_HDMI_CURRENT_PORT)

//Timing info
extern HDMI_bool drvif_Hdmi_Multi_port_GetRawTimingInfo(unsigned char ch, MEASURE_TIMING_T *timing_info);
...
extern HDMI_bool drvif_Hdmi_TimingInfo_for_hdmitx(unsigned char ch, MEASURE_TIMING_T* timing_info);
...
extern void drvif_hdmi_bypass_port_set(unsigned char ch, unsigned char bypass_mode);
extern unsigned char drvif_hdmi_get_bypass_mode(unsigned char ch);
