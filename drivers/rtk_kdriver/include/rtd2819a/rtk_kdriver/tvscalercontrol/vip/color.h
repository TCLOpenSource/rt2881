...
typedef union
{
	...
	struct{
		...
		unsigned char control_by_PQ:1;	/* 1:control by PQ flow, 0: conctrol by AP/scaler/...	*/
	};
} HDR_IP_ctrl_bits;
...
#define HFC_OETF_CTRL_BY_LUMINANCE 251 //yvonne, 0302
#define HFC_EOTF_CTRL_BY_LUMINANCE 251 //yvonne, 0302
...
typedef struct {
	unsigned char index;
	GAMUT_3D_LUT_PT_T pt[VIP_D_3D_LUT_SIZE];
...
typedef enum _VIP_DataAccess_Debug_Sub_En {
	...
	DAD_PCID_En = 0x800,
	// new
	DAD_ColorTemp_En = 0x1000,
	DAD_VALC_En = 0x2000,

	DAD_ALL_Sub_En_MASK = (DAD_I3DDMA_En | DAD_HDR_1_En | DAD_HDR_2_En | DAD_Peaking_En | DAD_UZD_En | DAD_UZU_En | DAD_2_Step_En | DAD_SHP_En | DAD_ICM_En | DAD_Y2R_En | DAD_OD_En | DAD_PCID_En | DAD_ColorTemp_En | DAD_VALC_En),
...
#if 1	// demura_define_may_to_vipcommon
...
#define VIP_Demura_Encode_TBL_ROW 361/*136*/
#define VIP_Demura_Encode_TBL_COL 10278/*2928*/
...
// 641x361
#define VIP_DemuraTBL_LineSize_Y_641x361_3Plane 1472
#define VIP_DemuraTBL_LineSize_Y_641x361_4Plane 2064
#define VIP_DemuraTBL_LineSize_Y_641x361_5Plane 2576
#define VIP_DemuraTBL_LineSize_8bit_Y_641x361_3Plane 2064
#define VIP_DemuraTBL_LineSize_8bit_Y_641x361_4Plane 2576
#define VIP_DemuraTBL_LineSize_8bit_Y_641x361_5Plane 3424
#define VIP_DemuraTBL_LineSize_RGB_641x361_3Plane 4400
#define VIP_DemuraTBL_LineSize_RGB_641x361_4Plane 6160
#define VIP_DemuraTBL_LineSize_RGB_641x361_5Plane 7696
#define VIP_DemuraTBL_LineSize_8bit_RGB_641x361_3Plane 6160
#define VIP_DemuraTBL_LineSize_8bit_RGB_641x361_4Plane 7696
#define VIP_DemuraTBL_LineSize_8bit_RGB_641x361_5Plane 10256


// 321x181
#define VIP_DemuraTBL_LineSize_Y_321x181_3Plane 736
#define VIP_DemuraTBL_LineSize_Y_321x181_4Plane 1040
#define VIP_DemuraTBL_LineSize_Y_321x181_5Plane 1296
#define VIP_DemuraTBL_LineSize_8bit_Y_321x181_3Plane 1040
#define VIP_DemuraTBL_LineSize_8bit_Y_321x181_4Plane 1296
#define VIP_DemuraTBL_LineSize_8bit_Y_321x181_5Plane 1712
#define VIP_DemuraTBL_LineSize_RGB_321x181_3Plane 2208
#define VIP_DemuraTBL_LineSize_RGB_321x181_4Plane 3088
#define VIP_DemuraTBL_LineSize_RGB_321x181_5Plane 3856
#define VIP_DemuraTBL_LineSize_8bit_RGB_321x181_3Plane 3088
#define VIP_DemuraTBL_LineSize_8bit_RGB_321x181_4Plane 3856
#define VIP_DemuraTBL_LineSize_8bit_RGB_321x181_5Plane 5136
...
typedef enum _CONBRI_COLORKEY_MODE{
	BLOCK_DATA=0,//block data of color_key region = 0,
	REPLACE_DATA,//replace data into colorkey_replace_y/u/v
	
	MAX_COLORKEY_MODE,
}CONBRI_COLORKEY_MODE;
...
#define HDR2_EOTF_CURVE_LEN (EOTF_size)
#define HDR2_Y2Gain_CURVE_LEN (OETF_size)
#define HDR2_OETF_CURVE_LEN (OETF_size)
...
typedef struct {
	...
	unsigned short K32;
	unsigned short K33;
	unsigned short input_offset_1;
	unsigned short input_offset_2;
	unsigned short input_offset_3;
	unsigned short output_offset_1;
	unsigned short output_offset_2;
	unsigned short output_offset_3;
	unsigned short r_max;
	unsigned short r_min;
	unsigned short gb_max;
	unsigned short gb_min;
} DRV_HDR2_Y2R_Matrix;

typedef struct {
	// coefficient
	unsigned short m3x3_00;
	unsigned short m3x3_01;
	unsigned short m3x3_02;
	unsigned short m3x3_10;
	unsigned short m3x3_11;
	unsigned short m3x3_12;
	unsigned short m3x3_20;
	unsigned short m3x3_21;
	unsigned short m3x3_22;
	// scale
	unsigned short m3x3_Scale;
	// offset
	unsigned int m3x3_Ofst0;
	unsigned int  m3x3_Ofst1;
	unsigned int  m3x3_Ofst2;
} HDR2_3x3_COEF;

typedef struct {
	// coefficient
	unsigned char step[8];
	unsigned short grid_num_th[7];
	unsigned int oetf_th[7];
} HDR2_OETF_PRO;

typedef struct {
    SCALER_DISP_CHANNEL colorkey_source;
    CONBRI_COLORKEY_MODE replace_mode;
    unsigned int color_key_y_max;
    unsigned int color_key_u_min;
    unsigned int color_key_v_max;
    unsigned int color_key_y_min;
    unsigned int color_key_u_max;
    unsigned int color_key_v_min;
    unsigned int color_replace_y;
    unsigned int color_replace_u;   
    unsigned int color_replace_v;
} CONBRI_VIDEO_COLORKEY_PARA;
/*******************************************************************************
 * Program
 ******************************************************************************/
...
void drvif_color_set_Panel_Dither_Enable(unsigned char enable, unsigned char enable_temporal,unsigned char dual_panel, unsigned int nWidth, unsigned int nLength);
...
void drvif_color_colorwrite_inv_output_gamma_dual(unsigned char dual_panel, unsigned int nWidth,unsigned int nLength,
												  unsigned int *pArray_tbl_1, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx_tbl_1,
												  unsigned int *pArray_tbl_2, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx_tbl_2);
void drvif_color_colorwrite_inv_output_gamma(unsigned int  *pArray, unsigned int tabSel, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx);
void drvif_color_colorwrite_inv_output_gamma_Enable(unsigned char Enable);
void drvif_color_colorread_inv_output_gamma(unsigned int  *pArray, unsigned int tabSel, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx);
...
void drvif_color_colorread_gamma_enhance(unsigned int *pArray_d0d1, unsigned int *pArray_index, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx);
...
void drvif_color_colorRead_outGamma_enhance(unsigned int *pArray, unsigned int *pArray_index, unsigned int tabSel, VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx);
void drvif_color_colorwrite_outGamma_enhance(unsigned int *pArray, unsigned int *pArray_index, unsigned int tabSel,VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx);
void drvif_color_colorRead_outGamma_dual_panel(unsigned char dual_panel, unsigned int nWidth, unsigned int nLength,
											   unsigned int *pArray_tbl_1, unsigned int *pArray_index_tbl_1,  VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx_tbl_1,
											   unsigned int *pArray_tbl_2, unsigned int *pArray_index_tbl_2,  VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx_tbl_2);
void drvif_color_colorWrite_outGamma_dual_panel(unsigned char dual_panel, unsigned int nWidth, unsigned int nLength,
											   unsigned int *pArray_tbl_1, unsigned int *pArray_index_tbl_1,  VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx_tbl_1,
											   unsigned int *pArray_tbl_2, unsigned int *pArray_index_tbl_2,  VIP_GAMMA_CHANNEL_RGB RGB_chanel_idx_tbl_2);											   
...
void drvif_color_setrgbcolortemp_contrast_2(unsigned short r_con, unsigned short g_con, unsigned short b_con);
void drvif_color_setrgbcolortemp_bright_2(unsigned short r_bri, unsigned short g_bri, unsigned short b_bri);
...
*/
/* mac9 new HDR2 */
void drvif_color_set_HDR_sub_Y2R_en(unsigned char bEnable);
void drvif_color_set_HDR_sub_EOTF_Enable(unsigned char enable);
void drvif_color_set_HDR_sub_3x3_Enable(unsigned char enable);
void drvif_color_set_HDR_sub_BBC_Gain_Enable(unsigned char enable);
void drvif_color_set_HDR_sub_OETF_Enable(unsigned char enable);
//void drvif_color_set_HDR_sub_HDR2_InSel(unsigned char in_sel);
void drvif_color_set_HDR_sub_data_size(HDR2_DATA_SIZE *ptr);
void drvif_color_set_HDR_sub_Y2R(DRV_HDR2_Y2R_Matrix *ptr);
signed char drvif_color_set_HDR_sub_EOTF_3ch(unsigned int *EOTF_table32_R, unsigned int *EOTF_table32_G, unsigned int *EOTF_table32_B);
signed char drvif_color_set_HDR_sub_EOTF_1D_Buffer(unsigned int *EOTF_table32);
void drvif_color_set_HDR_sub_3x3(HDR2_3x3_COEF *ptr);
unsigned char drvif_color_set_HDR_sub_BBC_Y2Gain(unsigned short *pCurve);
signed char drvif_color_set_HDR_sub_OETF_3ch(unsigned short *OETF_table16_R, unsigned short *OETF_table16_G, unsigned short *OETF_table16_B);
signed char drvif_color_set_HDR_sub_OETF_YtoGin_1D_Buffer(unsigned char mode, unsigned short *pTable);
signed char drvif_color_get_HDR_sub_OETF_YtoGin_1D_Buffer_Status(unsigned char *tbl_sel, unsigned char *tbl_move);
signed char drvif_color_Wait_HDR_sub_OETF_YtoGin_1D_Buffer_done(void);
void drvif_color_set_HDR_sub_OETF_Programmable(HDR2_OETF_PRO *ptr);
/* mac9 new HDR2 */
...
// RL6951-484	RL6951-4 [Modify_Item][+6.5k/+0k][UVC][PQ] UVC datapath RGB2YUV
void drvif_color_uvc_rgb2yuv_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_uvc_rgb2yuv(unsigned int enable, unsigned int *pArray, 
							 unsigned int y_max,unsigned int y_min,
							 unsigned int uv_max,unsigned int uv_min);

// RL6951-485	RL6951-4 [Modify_Item][+6.5k/ +0k][UVC][PQ] UVC datapath YUV2RGB
void drvif_color_uvc_yuv2rgb_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_uvc_yuv2rgb(unsigned int enable, unsigned int *pArray, unsigned int r_max,unsigned int r_min,unsigned int gb_max,unsigned int gb_min);

// RL6951-486	RL6951-4 [Modify_Item][PQ][+4.2k/+0][UVC][PQ] UVC datapath RGB Con/bri
void drvif_color_uvc_conbri(unsigned int enable,
							unsigned int con_r, unsigned int con_g, unsigned int con_b,
							int bri_r,int bri_g,int bri_b);					
void drvif_color_uvc_conbri_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);

// RL6951-487	RL6951-4 [Modify_Item][PQ][+18.5k/+0k][UVC][PQ]UVC datapath RGB Sat/Hue		
void drvif_color_uvc_sathue_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_uvc_sathue_glb_ctrl(unsigned int uvc_sathue_en, unsigned int satbysat_en, unsigned int tabMode, unsigned int swap_in, unsigned int swap_out,unsigned int glb_hue_offt);
void drvif_color_uvc_satbysat_curve(unsigned int *pArray);

// RL6951-492	RL6951-4 [Modify_Item][+14.3K/+10K][DC2H12][DC2H1] [PQ] R2Y\Dihter\UZD
void drvif_color_dc2h1_rgb2yuv_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_dc2h1_rgb2yuv_glb_ctrl(unsigned int r2y_en,unsigned int sel_sign,unsigned int sel_rgb,unsigned int set_r_in_offset,unsigned int set_uv_out_offset,unsigned int sel_uv_off,unsigned int matrix_bypass,unsigned int sel_y_gain,unsigned int sel_2x_gain,unsigned int rgb_in_offset);
void drvif_color_dc2h1_rgb2yuv_422to444(unsigned int en_422to444,unsigned int dup,unsigned int cr_dly_cb);
void drvif_color_dc2h1_rgb2yuv_3x3_coeef(unsigned int *pArray, unsigned int y_gain, unsigned int yo_even, unsigned int yo_odd);

// RL6951-493	RL6951-4 [Modify_Item][+24.6K/+15.1K][DC2H12][DC2H2] [PQ] R2Y\Dihter\UZD
void drvif_color_dc2h2_rgb2yuv_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_dc2h2_rgb2yuv_glb_ctrl(unsigned int r2y_en,unsigned int sel_sign,unsigned int sel_rgb,unsigned int set_r_in_offset,unsigned int set_uv_out_offset,unsigned int sel_uv_off,unsigned int matrix_bypass,unsigned int sel_y_gain,unsigned int sel_2x_gain,unsigned int rgb_in_offset);
void drvif_color_dc2h2_rgb2yuv_422to444(unsigned int en_422to444,unsigned int dup,unsigned int cr_dly_cb);
void drvif_color_dc2h2_rgb2yuv_3x3_coeef(unsigned int *pArray, unsigned int y_gain, unsigned int yo_even, unsigned int yo_odd);

// RL6951-501	RL6951-4 [Modify_Item][+24.6K/+30.2K][I3][I3_0] [PQ] R2Y\Dihter\UZD
// RL6951-502	RL6951-4 [Modify_Item][+24.6K/+12.7K][I3][I3_1] [PQ] R2Y\Dither\UZD
void drvif_color_i3_0_rgb2yuv_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_i3_0_rgb2yuv_glb_ctrl(unsigned int r2y_en,unsigned int sel_sign,unsigned int sel_rgb,unsigned int set_r_in_offset,unsigned int set_uv_out_offset,unsigned int sel_uv_off,unsigned int matrix_bypass,unsigned int sel_y_gain,unsigned int sel_2x_gain,unsigned int rgb_in_offset);
void drvif_color_i3_0_rgb2yuv_422to444(unsigned int en_422to444,unsigned int dup,unsigned int cr_dly_cb);
void drvif_color_i3_0_rgb2yuv_444to422(unsigned int en_444to422,unsigned int drop_444to422,unsigned int cr_dly_cb_444to422);
void drvif_color_i3_0_rgb2yuv_3x3_coeef(unsigned int *pArray, unsigned int y_gain, unsigned int yo_even, unsigned int yo_odd);
void drvif_color_i3_1_rgb2yuv_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_i3_1_rgb2yuv_glb_ctrl(unsigned int r2y_en,unsigned int sel_sign,unsigned int sel_rgb,unsigned int set_r_in_offset,unsigned int set_uv_out_offset,unsigned int sel_uv_off,unsigned int matrix_bypass,unsigned int sel_y_gain,unsigned int sel_2x_gain,unsigned int rgb_in_offset);
void drvif_color_i3_1_rgb2yuv_422to444(unsigned int en_422to444,unsigned int dup,unsigned int cr_dly_cb);
void drvif_color_i3_1_rgb2yuv_444to422(unsigned int en_444to422,unsigned int drop_444to422,unsigned int cr_dly_cb_444to422);
void drvif_color_i3_1_rgb2yuv_3x3_coeef(unsigned int *pArray, unsigned int y_gain, unsigned int yo_even, unsigned int yo_odd);

// RL6951-503	RL6951-4 [Modify_Item][+14.6K/+12.7K][I456][I4] [PQ] R2Y\Dither\UZD
void drvif_color_i4_rgb2yuv_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_i4_rgb2yuv_glb_ctrl(unsigned int r2y_en,unsigned int sel_sign,unsigned int sel_rgb,unsigned int set_r_in_offset,unsigned int set_uv_out_offset,unsigned int sel_uv_off,unsigned int matrix_bypass,unsigned int sel_y_gain,unsigned int sel_2x_gain,unsigned int rgb_in_offset);
void drvif_color_i4_rgb2yuv_422to444(unsigned int en_422to444,unsigned int dup,unsigned int cr_dly_cb);
void drvif_color_i4_rgb2yuv_444to422(unsigned int en_444to422,unsigned int drop_444to422,unsigned int cr_dly_cb_444to422);
void drvif_color_i4_rgb2yuv_3x3_coeef(unsigned int *pArray, unsigned int y_gain, unsigned int yo_even, unsigned int yo_odd);

// RL6951-504	RL6951-4 [Modify_Item][+14.6K/+12.7K][I456][I5] [PQ] R2Y\Dither\UZD
void drvif_color_i5_rgb2yuv_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_i5_rgb2yuv_glb_ctrl(unsigned int r2y_en,unsigned int sel_sign,unsigned int sel_rgb,unsigned int set_r_in_offset,unsigned int set_uv_out_offset,unsigned int sel_uv_off,unsigned int matrix_bypass,unsigned int sel_y_gain,unsigned int sel_2x_gain,unsigned int rgb_in_offset);
void drvif_color_i5_rgb2yuv_422to444(unsigned int en_422to444,unsigned int dup,unsigned int cr_dly_cb);
void drvif_color_i5_rgb2yuv_444to422(unsigned int en_444to422,unsigned int drop_444to422,unsigned int cr_dly_cb_444to422);
void drvif_color_i5_rgb2yuv_3x3_coeef(unsigned int *pArray, unsigned int y_gain, unsigned int yo_even, unsigned int yo_odd);

// RL6951-505	RL6951-4 [Modify_Item][+14.6K/+12.7K][I456][I6] [PQ] R2Y\Dihter\UZD
void drvif_color_i6_rgb2yuv_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_i6_rgb2yuv_glb_ctrl(unsigned int r2y_en,unsigned int sel_sign,unsigned int sel_rgb,unsigned int set_r_in_offset,unsigned int set_uv_out_offset,unsigned int sel_uv_off,unsigned int matrix_bypass,unsigned int sel_y_gain,unsigned int sel_2x_gain,unsigned int rgb_in_offset);
void drvif_color_i6_rgb2yuv_422to444(unsigned int en_422to444,unsigned int dup,unsigned int cr_dly_cb);
void drvif_color_i6_rgb2yuv_444to422(unsigned int en_444to422,unsigned int drop_444to422,unsigned int cr_dly_cb_444to422);
void drvif_color_i6_rgb2yuv_3x3_coeef(unsigned int *pArray, unsigned int y_gain, unsigned int yo_even, unsigned int yo_odd);

void drvif_color_hdmitx_rgb2yuv_db_ctrl(unsigned int db_en, unsigned int db_apply, unsigned int db_read_sel);
void drvif_color_hdmitx_rgb2yuv_glb_ctrl(unsigned int r2y_en,unsigned int sel_sign,unsigned int sel_rgb,unsigned int set_r_in_offset,unsigned int set_uv_out_offset,unsigned int sel_uv_off,unsigned int matrix_bypass,unsigned int sel_y_gain,unsigned int sel_2x_gain,unsigned int rgb_in_offset);
void drvif_color_hdmitx_rgb2yuv_422to444(unsigned int en_422to444,unsigned int dup,unsigned int cr_dly_cb);
void drvif_color_hdmitx_rgb2yuv_444to422(unsigned int en_444to422,unsigned int drop_444to422,unsigned int cr_dly_cb_444to422);
void drvif_color_hdmitx_rgb2yuv_3x3_coeef(unsigned int *pArray, unsigned int y_gain, unsigned int yo_even, unsigned int yo_odd);
void drvif_color_gamma_table_ctrl(unsigned int gamma_tab_buf_ax_rw_sel, unsigned int  gamma_tab_buf_en, unsigned int gamma_tab_buf_apply);

void drvif_color_pip_colorkey_sel(SCALER_DISP_CHANNEL colorkey_source,CONBRI_COLORKEY_MODE mode);
void drvif_color_pip_colorkey_range(unsigned int color_key_y_max,unsigned int color_key_u_min,unsigned int color_key_v_max,unsigned int color_key_y_min,unsigned int color_key_u_max,unsigned int color_key_v_min);
void drvif_color_pip_colorkey_replace_color(unsigned int color_replace_y,unsigned int color_replace_u,unsigned int color_replace_v);
void drvif_color_set_UVC_Dither_Enable_verify(unsigned char enable);
void drvif_color_set_sdnr_4k120_mode(unsigned char display,unsigned char bEnable);
void drvif_color_Get_HDR_sub_OETF_3ch(unsigned short *OETF_table16_R, unsigned short *OETF_table16_G, unsigned short *OETF_table16_B);
void drvif_color_Get_HDR_sub_EOTF_3ch(unsigned int *EOTF_table32_R, unsigned int *EOTF_table32_G, unsigned int *EOTF_table32_B);
void drvif_color_Get_HDR_sub_BBC_Y2Gain(unsigned short *pCurve);
