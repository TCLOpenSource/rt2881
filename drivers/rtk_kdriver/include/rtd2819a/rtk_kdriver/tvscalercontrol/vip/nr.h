...
void drvif_color_DRV_sub_SNR_NR_Mask_W1W2(DRV_SNR_NR_Mask_W1W2 *ptr);
void drvif_color_DRV_sub_SNR_NR_Mask_W1W2(DRV_SNR_NR_Mask_W1W2 *ptr);
...
void drvif_color_DRV_sub_SNR_Mosquito_NR_En(unsigned char En_flag);
void drvif_color_DRV_sub_SNR_Weight_Adjust(DRV_SNR_WeightAdjust *ptr);
void drvif_color_DRV_sub_SNR_UVEdge(DRV_SNR_UVEdge *ptr);
...
void drvif_sub_IESM_frontporch_set(unsigned char game_mode_flag);
// end mac9q sub
