...
#define _H_DELAY_2P_CLOCK_DIVISOR       2
#endif
...
typedef enum _SLR_INPUT_INFO{
	...
	SLR_INPUT_V_FREQ,		// in digit 1 : reserved for dolby common code project
	SLR_INPUT_V_FREQ_1000,	// in digit 3
	...
	SLR_INPUT_VO_SRC_FRAMERATE_1000,	// in digit 3
    SLR_INPUT_SUB_SNRR_ENABLE,
    SLR_INPUT_SOURCE_PIXEL_MODE,
	SLR_INPUT_VSC_SOURCE_TYPE,
	SLR_INPUT_ORIGINAL_COLOR_SPACE,
}SLR_INPUT_INFO;
...
typedef enum _SLR_MODE_INFO{
	...
	SLR_MODE_POLARITY,
	SLR_MODE_IHFREQ,
	SLR_MODE_IVFREQ_1000,	// in digit 3
	SLR_MODE_IHLEN,
	SLR_MODE_IVLEN,
	SLR_MODE_IHWID,
	SLR_MODE_IVHEIGHT,
