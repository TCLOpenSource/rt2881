...
typedef enum {
	...
	GDMA_DBG_CMD_SHOW_VSYNC = 31,
	GDMA_DBG_CMD_MULTI_SEG_EN = 32,
    GDMA_DBG_CMD_OSDEXT_TEST = 33,
    GDMA_DBG_CMD_SPLIT_TEST = 34,
	GDMA_DBG_CMD_NUMBER
} GDMA_DBG_CMD_INDEX_T; //need sync with rtkgdma_cmd_str
...
typedef enum {
    ...
    GDMA_PLANE_OSD2 = 2,
    GDMA_PLANE_OSD3 = 3,
    GDMA_PLANE_MAXNUM_O1 = 4,  //for old mode compatible 
    GDMA_PLANE_OSD4 =4,    // GDMA_DISPLAY_OSD4 //RTK_ENABLE_GDMA_EXT
    GDMA_PLANE_OSD5 =5 ,
    GDMA_PLANE_ALL_MAXNUM ,
    GDMA_PLANE_MAXNUM = GDMA_PLANE_ALL_MAXNUM,
...
typedef enum {
    ...
    GDMA_PLANE_OSD3 = 3,
    GDMA_PLANE_MAXNUM = 4,
    GDMA_PLANE_MAXNUM_O1 = GDMA_PLANE_MAXNUM,
    GDMA_PLANE_NONE, 
} GDMA_DISPLAY_PLANE;
...
typedef enum {
    ...
    OSD_SR_ALL_MAXNUM= GDMA_PLANE_ALL_MAXNUM,
} OSD_SR_PLANE;
...
typedef enum {
    ...
    OSD_SR_3 = 3,
    OSD_SR_MAXNUM = 4,
    OSD_SR_ALL_MAXNUM= OSD_SR_MAXNUM,
} OSD_SR_PLANE;
#endif//
...
typedef struct {
	unsigned int vir_top_addr;
	unsigned int buffer_size1;
	unsigned int phy_addr1;
	unsigned int buffer_size2;
	unsigned int phy_addr2;
} CONFIG_OSD_MULTI_SEG_PARA;
...
typedef struct {
	...
	unsigned int color_range_en;
	unsigned int color_range_max;
	unsigned int color_range_min;
//#if defined(CONFIG_ARCH_RTK2875Q) || defined(CONFIG_ARCH_RTK2819A)
	CONFIG_OSD_MULTI_SEG_PARA multi_seg; /* for multi seg use*/
//#endif
} GDMA_PICTURE_OBJECT;
...
typedef struct {
	GDMA_DISPLAY_PLANE plane;
    int replace_mode;
    unsigned int color_key_r_max;
    unsigned int color_key_r_min;
    unsigned int color_key_g_max;
    unsigned int color_key_g_min;
    unsigned int color_key_b_max;
    unsigned int color_key_b_min;
    unsigned int color_replace_r;
    unsigned int color_replace_g;   
    unsigned int color_replace_b;
} CONFIG_VIDEO_COLORKEY_PARA;
...
int GDMA_ReceivePicture         (PICTURE_LAYERS_OBJECT *, bool);
