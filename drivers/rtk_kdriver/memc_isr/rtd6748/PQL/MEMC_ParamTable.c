...
//FB_STYLE
{
	//FB_STYLE_NORMAL
	{
		...
		128, //u10_LFB_dh_ph_fbgen_th //0~1023
		7, //u3_LFB_dh_fb_dtl_shift //0~7
	},
	...
	//FB_STYLE_CINEMA
	{
		...
		6, // u8_LFB_dh_ph_fbgen_slp; //0~255
		0, // u4_LFB_dh_ph_fbgen_sft //0~15
		0, //u10_LFB_dh_ph_fbgen_th //0~1023
		3, //u3_LFB_dh_fb_dtl_shift //0~7
	},
},
...
//ME_STYLE
{
	//ME_STYLE_NORMAL
	{
		...
		//LFSR
		0,
		{CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N,CTRL_N},
...
const _MEMC_PARAM_TABLE MEMC_PARAM_TABLE = {
	...
	//	hor 	P45 	ver 	N45			panning	fast-motion   normal
		...
		{{0x3,	0x6,	0x4,	0xb},		{5, 		6,			8}},	/*_PQL_OUT_2560x1440*/
	},
...
//		{{0x1bea3,	0x74ca3,	0xb9e51},	{0x1071e3,	0x1d7e20},	{0x1,	0x0,	0x1e,	0x0c,	0x04,	0xf},			0}, /*_PQL_OUT_3840x2160*/
	...
	//	pure_video	 	panning
		...
		{{0xa,	0xd},	{0xBAB9D0, 		0x4dcd6c},		{50}}, /*_PQL_OUT_2560x1440*/
	},
