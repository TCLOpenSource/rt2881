...
const _MEMC_STYLE_TABLE MEMC_STYLE_TABLE = {
{
	//FB_STYLE_NORMAL
	{
		...
		512, // u12_dh_fblvl_mvdiff_y1_default
		2304, // u12_dh_fblvl_mvdiff_y2_default
		3840, // u12_dh_fblvl_mvdiff_y3_default
	...
	//FB_STYLE_TV006_K8
	{
		0, // u1_GFB_MVChaos_total_en
		0, // u1_GFB_MVChaos_SC_en
		0, // u1_GFB_MVChaos_unconf_en
		80, // u7_GFB_MVChaos_SC_th
		47, // u8_GFB_MVChaos_unconf_th
		...
		0, // u1_LFB_Dtl_curve_en
		20, // u8_LFB_Dtl_strength_ratio
		
		0, // u1_LFB_MV_diff_curve_en
		40, // u8_LFB_MV_diff_strength_ratio
		512, // u12_dh_fblvl_mvdiff_y1_default
		2304, // u12_dh_fblvl_mvdiff_y2_default
		3840, // u12_dh_fblvl_mvdiff_y3_default
...
const _MEMC_PARAM_TABLE MEMC_PARAM_TABLE = {
	...
	//	 low th 	mid th		high th 	  low th	high th 	enable	mode	cut 	th		avg_th	num
		...
		{{0xe5a8,	0x1C710,	0x4A710},	{0x177e20,	0x1d7e20},	{0x1,	0x0,	0x1e,	0x0c,	0x04,	0xf},			0}, /*_PQL_OUT_3840x2160*/
...
//		{{0x1bea3,	0x74ca3,	0xb9e51},	{0x1071e3,	0x1d7e20},	{0x1,	0x0,	0x1e,	0x0c,	0x04,	0xf},			0}, /*_PQL_OUT_3840x2160*/
	...
	//		scCtrl_tuning_th
	//	pure_video	 	panning
		{{0xa,	0xd},	{0x980001,		0x400000},		{70}}, /*_PQL_OUT_1920x1080*/
		{{0xa,	0xd},	{0x980002,		0x400000},		{70}}, /*_PQL_OUT_1920x540*/
		{{0xa,	0xd},	{0xcc7c5c,		0x400000},		{70}}, /*_PQL_OUT_3840x2160*/
		{{0xa,	0xd},	{0x980004,		0x400000},		{70}}, /*_PQL_OUT_3840x1080*/
		{{0xa,	0xd},	{0x980005,		0x400000},		{70}}, /*_PQL_OUT_3840x540*/
		{{0xa,	0xd},	{0x980006,		0x400000},		{70}}, /*_PQL_OUT_768x480*/
		{{0xa,	0xd},	{0x980007,		0x400000},		{70}}, /*_PQL_OUT_1280x720*/
		{{0xa,	0xd},	{0x980008,		0x400000},		{70}}, /*_PQL_OUT_7680x4320*/
