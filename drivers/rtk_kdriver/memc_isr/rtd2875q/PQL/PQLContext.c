...
extern VOID SAD_Peak_Skip_GFB(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput);
...
const unsigned char g_FRCCADEN_60HZOUT_T[_PQL_IN_96HZ][_FRC_CADENCE_NUM_] =
{
	...
	//_PQL_IN_60HZ,
	{_VIDEO_T, _22_T, _32_T, _32322_T, _334_F, _22224_T, _2224_T, _3223_T, _55_T, _66_F, _44_F, _1112_T, _11112_T, _122_N, _11i23_N,_321_T},
};
#else
const unsigned char g_FRCCADEN_60HZOUT_T[_PQL_IN_96HZ][_FRC_CADENCE_NUM_] =
{
	...
	{_VIDEO_T, _22_T, _32_N, _32322_N, _334_F, _22224_N, _2224_N, _3223_N, _55_F, _66_F, _44_F, _1112_N, _11112_N, _122_T, _11i23_F,_321_N},
	//_PQL_IN_60HZ,
	{_VIDEO_T, _22_T, _32_T, _32322_T, _334_F, _22224_T, _2224_T, _3223_T, _55_F, _66_F, _44_F, _1112_T, _11112_T, _122_N, _11i23_N,_321_T},
};
#endif
...
VOID Debug_Msg_Print(_PQLPARAMETER* g_pParam, _PQLCONTEXT* pContext)
{
	...
	unsigned int disp_vtotal=0;
	unsigned int memc_crtc_vsdelay=0;
	...
	if(ppoverlay_dv_total_reg.dv_total !=0){
		disp_vtotal = ppoverlay_dv_total_reg.dv_total;
	}
	...
	if((log_en==1) || (display_timing_ctrl1_reg.disp_en == 1 && ((Scaler_DispGetInputInfoByDisp(SLR_MAIN_DISPLAY, SLR_INPUT_STATE) == _MODE_STATE_ACTIVE) || MEMC_error_status_print_flag) && MEMC_MuxEn) || ((u1_trig_iFrameRate_noMatch || u1_trig_oFrameRate_noMatch)&&(g_KERNEL_AFTER_QS_MEMC_FLG==false || u32_oFrameRate_Pre!=0))){
		...
		if(ippre_mute_hact != GS_image_hsize && GS_image_hsize!=0){
			input_size_err_cnt++;
		...
		if(ippre_mute_vact != GS_image_vsize && GS_image_vsize!=0){
			input_size_err_cnt++;
		...
		{
			memc_crtc_vsdelay = crtc1_crtc1_18_reg.crtc1_frc_vs_bporch + crtc1_crtc1_04_reg.crtc1_out_vs_width + crtc1_crtc1_14_reg.crtc1_frc_prede_lnum;

			if( (cnt_2<20) && (memc_crtc_vsdelay > disp_vtotal) ){
				rtd_pr_memc_notice( "[Timing_Check][warning](memc_crtc_vsdelay=%d)>(disp_vtotal=%d),(%d/%d/%d)(90K = %d)\n\r", memc_crtc_vsdelay,disp_vtotal, crtc1_crtc1_18_reg.crtc1_frc_vs_bporch,crtc1_crtc1_04_reg.crtc1_out_vs_width,crtc1_crtc1_14_reg.crtc1_frc_prede_lnum);
				cnt_1++;
			}
		}
...
VOID PQL_ContextProc_oneFifth_outputInterrupt(int iSliceIdx)
{
	...
	if(u32_rb_data)
	{
		...
		Clear_LogoRim_WrtAction(&(s_Context._output_rimctrl), &(s_Context._output_wrt_comreg));
...
VOID PQL_ContextProc_outputInterrupt(int iSliceIdx)
{
	...
	if(s_pParam == NULL){
		...
		MEMC_Lib_Manual_colormatrix(&(s_pParam->_param_me_sceneAnalysis), &(s_Context._output_me_sceneAnalysis));
	...
	if(u32_rb_data)
	{
		...
		// for synchronizing sad info, move SAD_Peak_Skip_GFB from FRC_SceneAnalysis_Proc_InputIntp to here
		SAD_Peak_Skip_GFB(&(s_pParam->_param_frc_sceneAnalysis),&(s_Context._output_frc_sceneAnalysis));
