...
unsigned int GS_me0_timing_en = 0;
...
unsigned int GS_blk480_logo_en = 0;
...
void MEMC_ChangeSize_init_AfterQS(const unsigned char MEMC_SZ_SEL)
{
	...
	if(GS_image_vsize_d1%16 != 0){
		GS_image_vsize = 16 * ((GS_image_vsize_d1/16) +1);
	}
	else{
...
// qs set buffer
	...
	rtd_pr_memc_notice("[%s][%d][%d,%d,%d][htotal,%d,%d,][size,%d,%d]\n\r", __FUNCTION__, __LINE__, MEMC_LoadSizeParam_Type, GS_MCBuffer_Size, GS_pqc_selection, GS_image_htotal, Get_DISP_HORIZONTAL_TOTAL(), Get_DISP_ACT_END_HPOS(), Get_DISP_ACT_END_VPOS());
...
void MEMC_ChangeSize_CRTC_to_scaler(void)
{
	...
	if(/*((get_product_type() == PRODUCT_TYPE_DIAS) &&*/ Get_DISP_ACT_END_HPOS() != 0){
	...
	if(/*((get_product_type() == PRODUCT_TYPE_DIAS) &&*/ Get_DISP_ACT_END_VPOS() != 0){
    ...
    if(gMEMC_SizeParamTable[MEMC_SZ_SEL].ME12_Merge) {
        ...
        org_vtrig_dly=0;
         //frc_vtrig_dly=frc_vtrig_dly+16; // coverity_ID : 770341, unused value
...
#if defined(MARK2) || defined(MERLIN7) ||defined(H5C2)||defined(MERLIN8)||defined(MERLIN9)
	if(Scaler_MEMC_GetPanelSizeByDisp() == MEMC_SIZE_4K1K){ 	
		frc_vs_bporch = 3;
		frc_vtrig_dly = (mc_vtrig + me2_vtrig + org_vtrig_dly + 1) - (out_vs_width + frc_vs_bporch) + 1;
...
//		printf("=== ERROR!!! lbmc_neg_vtrig_total_chk <=0  ===\n");
...
#if defined(MARK2) || defined(MERLIN7) ||defined(H5C2)||defined(MERLIN8)||defined(MERLIN9)
    crtc1_crtc1_98_reg.crtc1_out_htotal_long =  GS_image_htotal_to_scaler / out_h_div;
	...
	HAL_CRTC_Set_crtc1_out_htotal(crtc1_crtc1_98_reg.crtc1_out_htotal_long);

}
#endif

#if 1 // AUTO_GEN at 01/22/24 12:03:59
void MEMC_ChangeSize_CRTC(void)
{
    // parameter declaration
    //======= out timing
...
//		printf("=== ERROR!!! lbmc_neg_vtrig_total_chk <=0  ===\n");
    ...
    crtc1_crtc1_1c_reg.crtc1_me2_org_vtrig_dly = org_vtrig_dly;
    crtc1_crtc1_1c_reg.crtc1_ip_vtrig_dly = crtc1_ip_vtrig_dly;
	if(!MEMC_Lib_UltraLowDelayMode_Judge()){//control by scaler
...
void MEMC_ChangeSize_IPPRE(void)
{
    ...
    ippre1_ippre1_54_reg.bar_width = GS_image_hsize;
    ippre1_ippre1_64_reg.circle_center_v = GS_image_vsize;
    ippre1_ippre1_64_reg.circle_center_h = GS_image_hsize;
    ippre1_ippre1_b8_reg.ippre_mute_vact_max = GS_image_vsize+1;
    ippre1_ippre1_b8_reg.ippre_mute_vact_min = GS_image_vsize;
    ippre1_ippre1_bc_reg.ippre_mute_htotal_max = GS_image_htotal + 1;
    ippre1_ippre1_c0_reg.ippre_mute_vact = GS_image_vsize;
    ippre1_ippre1_c0_reg.ippre_mute_hact = GS_image_hsize;
    ippre1_ippre1_c4_reg.ippre_mute_hact_max = GS_image_hsize;
    ippre1_ippre1_c4_reg.ippre_mute_hact_min = GS_image_hsize;
	#else
    ippre1_ippre1_54_reg.bar_hight = GS_image_vsize;
...
#endif
#endif //#if (defined(H5C2)||defined(MERLIN8))
