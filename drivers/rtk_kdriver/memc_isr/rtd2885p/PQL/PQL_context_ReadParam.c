...
//		pParam->_param_frc_sceneAnalysis.u15_PanRMV_FitNumThr 			= (u32_RB_val >> 17)	& 0x7FFF;
		...
		pParam->_param_read_comreg.read_enable				= (u32_RB_val >> 31)  & 0x01;
...
#if RTK_MEMC_Performance_tunging_from_tv001
#if 1 // TV006 493813 temp mark to sync
...
//		pParam->_param_bRMV_rFB_ctrl.u8_rFB_level_curve_max = (u32_RB_val >> 8) & 0xff;
		...
		//o------ Detect rotate windmill ------o
		ReadRegister(SOFTWARE3_SOFTWARE3_24_reg, 0, 31, &u32_RB_val);
		pParam->_param_me_sceneAnalysis.u1_detect_Rotate_WindMill_en = (u32_RB_val >> 31) & 0x1;

		//o------ Fix repeat broken ------o
		ReadRegister(SOFTWARE3_SOFTWARE3_63_reg, 0, 31, &u32_RB_val);
		pParam->_param_me_sceneAnalysis.b_FixRepeat_db_en = (u32_RB_val >> 30) & 0x1;
		...
		pParam->_param_Patch_Manage.u1_sportscene_en = (u32_RB_val >> 4) & 0x1;
		pParam->_param_wrt_comreg.u1_SmallObject_en = (u32_RB_val >> 5) & 0x1;
	...
	ReadRegister(SOFTWARE2_SOFTWARE2_40_reg, 0, 31, &u32_RB_val);
	pParam->_param_wrt_comreg.u1_mc_blend_for_small_object_en = (u32_RB_val >> 31);
	#endif
}
