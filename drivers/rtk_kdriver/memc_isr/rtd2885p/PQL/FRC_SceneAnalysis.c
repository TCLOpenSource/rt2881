...
VOID FRC_SceneAnalysis_Init_RTK2885p(_OUTPUT_FRC_SceneAnalysis *pOutput)
{
	//////////////////////////////////////////////////////////////////////////
	//Fade In/Out
	//////////////////////////////////////////////////////////////////////////
...
VOID FRC_SceneAnalysis_Init_RTK2885pp(_OUTPUT_FRC_SceneAnalysis *pOutput)
{
	pOutput->u8_zoom_force_fb_cnt		= 0;
	pOutput->u1_still_frame	        	= 0;
...
#endif
VOID FRC_FadeInOut_Detect_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
...
#endif
VOID FRC_Dynamic_ACDCBld_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
	//fadeIn/Out for acdc.
	if ((pParam->u1_fadeInOut_en == 1))
...
VOID FRC_Dynamic_SearchRange_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_Dynamic_SAD_Diff_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_RgPanning_Detect_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
#if 0
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_SpecialSCFB_Detect_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam,  _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_ZMV_AdaptPenality_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_ME1_GMVD_Select_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_Good_Scene_Detect_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_SC_PFV_CDD_Number_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
    const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_Dynamic_SADDiffTh_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
...
VOID FRC_Dynamic_MVAccord_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_RgRotat_Detect_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_VideoZoom_Detect_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID MEMC_me1_bgmask_newalgo_Proc_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
...
VOID MEMC_dehalo_newalgo_bgmaskBase_Proc_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
    const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID MEMC_dehalo_newalgo_bgmaskBase_Proc_DHBYPASS_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
    const _PQLCONTEXT *s_pContext = GetPQLContext();
...
#if (!Pro_tv0302875P)
    if((light_left == 1)  ||(flag_mvchange == 1)||(flag_bgchange == 1)||(flag_sc_add == 1))          
    {
...
VOID MEMC_dehalo_newalgo_bgmaskBase_Proc_develop_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
    const _PQLCONTEXT *s_pContext = GetPQLContext();
...
VOID FRC_SceneAnalysis_Proc_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	...
	FRC_Dynamic_SearchRange_RTK2885p(pParam, pOutput);
	FRC_ZMV_AdaptPenality_RTK2885p(pParam, pOutput);
	FRC_ME1_GMVD_Select_RTK2885p(pParam, pOutput);
	FRC_Good_Scene_Detect_RTK2885p(pParam, pOutput);
	FRC_SC_PFV_CDD_Number_RTK2885p(pParam, pOutput);
	FRC_Dynamic_MVAccord_RTK2885p(pParam, pOutput);
        //FRC_Dynamic_SAD_Diff_RTK2885p(pParam, 	pOutput);
	#if !PQL_DYNAMIC_ADJUST_FIX_ISSUE
		return ;
	#endif
	FRC_FadeInOut_Detect_RTK2885p(pParam, pOutput);
//	FRC_InsidePanning_Detect(pParam, pOutput);
	FRC_Dynamic_ACDCBld_RTK2885p(pParam, pOutput);
...
//	FRC_RgPanning_Detect_RTK2885p(pParam, 	pOutput);

	// system zoom
	FRC_Zoom_Detect(pParam, pOutput);

	FRC_SpecialSCFB_Detect_RTK2885p(pParam, pOutput);

	FRC_RgRotat_Detect_RTK2885p(pParam, pOutput);
	FRC_VideoZoom_Detect_RTK2885p(pParam, pOutput);
	//FRC_Swing_Detect(pParam, pOutput);  //S&M saech on a hammock

	//normal check send flag
		time_2 = rtd_inl(TIMER_SCPU_CLK90K_LO_reg);
	MEMC_me1_bgmask_newalgo_Proc_RTK2885p(pParam, pOutput);
 
		time_3 = rtd_inl(TIMER_SCPU_CLK90K_LO_reg);
 	if(PatternParam->_param_read_comreg.read_enable) {
		MEMC_dehalo_newalgo_bgmaskBase_Proc_RTK2885p (pParam, pOutput);
 	}


         //MEMC_dehalo_newalgo_bgmaskBase_Proc_DHBYPASS_RTK2885p(pParam, pOutput);//k24 off
         //k24
         MEMC_dehalo_newalgo_bgmaskBase_Proc_develop_RTK2885p(pParam, pOutput);
...
VOID FRC_SceneAnalysis_Proc_RTK2885pp(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	unsigned int log_en = 0, time_1 = 0, time_2 = 0;
	ReadRegister(SOFTWARE2_SOFTWARE2_60_reg, 31, 31, &log_en);
	...
	if(log_en){
		rtd_pr_memc_notice("[%s][%d][time2-time1,%u][90K=,%d,]\n\r", __FUNCTION__, __LINE__,
			time_2-time_1, rtd_inl(TIMER_SCPU_CLK90K_LO_reg));
	}
...
VOID FRC_SceneAnalysis_Proc_InputIntp_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	//hdr <-> normal
	...
	#if 1
	SAD_Peak_Skip_GFB_RTK2885p(pParam, pOutput);
	FRC_is_not_natural_video_RTK2885p(pParam, pOutput);
	#endif
	
	// sc sad diff calc
	FRC_Dynamic_SADDiffTh_RTK2885p(pParam, pOutput);
}

VOID FRC_SceneAnalysis_Proc_InputIntp_RTK2885pp(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	//hdr <-> normal
	MEMC_HDR_PicChg_Protect(pParam, pOutput);
...
#if 1
VOID SAD_Peak_Skip_GFB_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
	unsigned int u32_RB_val;
	...
	ReadRegister(SOFTWARE3_SOFTWARE3_06_reg, 6, 6, &log_en);
		...
		u32_RB_val = ReadComReg_Calib_Data(u32_RB_val, CALIB_PARAM_SAD, 0, 0x7fffffff, false);
		...
		if(u32_RB_val >=sad_th) //currently get SAD data from 171
		{
...
void FRC_is_not_natural_video_RTK2885p(const _PARAM_FRC_SceneAnalysis *pParam, _OUTPUT_FRC_SceneAnalysis *pOutput)
{
#if Pro_tv0302875P
