...
VOID ME_Vst_ReadHistogram_RTK2885p(VOID);
VOID ME_Vst_Statistic_RTK2885p(VOID);
VOID ME_Vst_Detection_RTK2885p(_OUTPUT_ME_VST_CTRL *pOutput);
VOID ME_Vst_blackBG_Detection_RTK2885p(_OUTPUT_ME_VST_CTRL *pOutput);

VOID ME_Vst_Init_RTK2885p(_OUTPUT_ME_VST_CTRL *pOutput)
{
	pOutput->u1_detect = 0;
...
VOID ME_Vst_Proc_RTK2885p(const _PARAM_ME_VST_CTRL *pParam, _OUTPUT_ME_VST_CTRL *pOutput)
{
	ME_Vst_ReadHistogram_RTK2885p();
	ME_Vst_Statistic_RTK2885p();
	ME_Vst_blackBG_Detection_RTK2885p(pOutput);
	ME_Vst_Detection_RTK2885p(pOutput);
}
