 ...
 * @retval VOID
*/
VOID HAL_KME_METOP1_Set_ClearMVEnable_RTK2885p(BOOL bEnable)
{
...
VOID HAL_KME_METOP1_Set_ClearMVEnable_RTK2885pp(BOOL bEnable)
{
	M8P_rtme_me15_0_rtme_me15_2c_RBUS M8P_rtme_me15_0_rtme_me15_2c;
	M8P_rtme_me15_0_rtme_me15_2c.regValue = rtd_inl(M8P_RTME_ME15_0_RTME_ME15_2C_reg);
	M8P_rtme_me15_0_rtme_me15_2c.me15_sc_clear_en = bEnable;
	rtd_outl(M8P_RTME_ME15_0_RTME_ME15_2C_reg, M8P_rtme_me15_0_rtme_me15_2c.regValue);
}
VOID HAL_KME_METOP1_Set_ClearMVEnable(BOOL bEnable)
{
	if(RUN_MERLIN8P()){
		HAL_KME_METOP1_Set_ClearMVEnable_RTK2885pp(bEnable);
	}else if(RUN_MERLIN8()){
		HAL_KME_METOP1_Set_ClearMVEnable_RTK2885p(bEnable);
 ...
 * @retval VOID
*/
VOID HAL_KME_METOP1_Set_SC_en_RTK2885p(BOOL bEnable)
{
	// reg_me1_sc_me1_en
	//WriteRegister(FRC_TOP__KME_ME_TOP1__reg_metop_sc_clr_sw_control_en_ADDR no mat,FRC_TOP__KME_ME_TOP1__reg_metop_sc_clr_sw_control_en_BITSTART no mat,FRC_TOP__KME_ME_TOP1__reg_metop_sc_clr_sw_control_en_BITEND no mat, (unsigned int)bEnable);	
...
{
	if(RUN_MERLIN8P()){
		//Merlin8p always sc on
	}else if(RUN_MERLIN8()){
		HAL_KME_METOP1_Set_SC_en_RTK2885p(bEnable);
	}//RUN_MERLIN8P & RUN_MERLIN8
}
 ...
 * @retval VOID
*/
VOID HAL_KME_SetME2135To270_RTK2885p(BOOL bEnable)
{
...
VOID HAL_KME_SetME2135To270(BOOL bEnable)
{
	if(RUN_MERLIN8P()){
		...
		HAL_KME_SetME2135To270_RTK2885p(bEnable);
	}//RUN_MERLIN8P & RUN_MERLIN8
}
 ...
 * @retval VOID
*/
VOID HAL_KME_SetME2135To270RDInterval_RTK2885p(unsigned int u32Val)
{
...
VOID HAL_KME_SetME2135To270RDInterval(unsigned int u32Val)
{
	if(RUN_MERLIN8P()){
		...
		HAL_KME_SetME2135To270RDInterval_RTK2885p(u32Val);
	}//RUN_MERLIN8P & RUN_MERLIN8
}
 ...
 * @retval VOID
*/
VOID HAL_KME_SetME2135To270WaitRowNum_RTK2885p(unsigned int u32Val)
{
...
VOID HAL_KME_SetME2135To270WaitRowNum(unsigned int u32Val)
{
	if(RUN_MERLIN8P()){
		...
		HAL_KME_SetME2135To270WaitRowNum_RTK2885p(u32Val);
	}//RUN_MERLIN8P & RUN_MERLIN8
}
 ...
 * @retval VOID
*/
VOID HAL_KME_Set_ME2DoubleScanEnable_RTK2885p(BOOL bEnable)
{
...
VOID HAL_KME_Set_ME2DoubleScanEnable(BOOL bEnable)
{
	if(RUN_MERLIN8P()){
		...
		HAL_KME_Set_ME2DoubleScanEnable_RTK2885p(bEnable);
	}//RUN_MERLIN8P & RUN_MERLIN8
}
 ...
 * @retval VOID
*/
VOID HAL_KME_Set_Vbuf_Enable_RTK2885p(BOOL bEnable)
{
...
{
	if(RUN_MERLIN8P()){
		//python use me clock to control vbuf_en
	}else if(RUN_MERLIN8()){
		HAL_KME_Set_Vbuf_Enable_RTK2885p(bEnable);
	}//RUN_MERLIN8P & RUN_MERLIN8
}

VOID HAL_ME2_cand_wrtDriver_RTK2885p( _str_ME2_Candidate_table *CandiTbl)
{
...
VOID HAL_ME2_cand_wrtDriver_RTK2885pp( _str_ME2_Candidate_table *CandiTbl)
{
	//CONFIG_NEED_TUNNING
}
...
{
	if(RUN_MERLIN8P()){
		HAL_ME2_cand_wrtDriver_RTK2885pp(CandiTbl);
	}else if(RUN_MERLIN8()){
		HAL_ME2_cand_wrtDriver_RTK2885p(CandiTbl);
	}//RUN_MERLIN8P & RUN_MERLIN8
}

VOID HAL_ME1_cand_wrtDriver_RTK2885p( _str_ME1_Candidate_table *CandiTbl)
{
...
VOID HAL_ME1_cand_wrtDriver_RTK2885pp( _str_ME1_Candidate_table *CandiTbl)
{
	//CONFIG_NEED_TUNNING
}
...
{
	if(RUN_MERLIN8P()){
		HAL_ME1_cand_wrtDriver_RTK2885pp(CandiTbl);
	}else if(RUN_MERLIN8()){
		HAL_ME1_cand_wrtDriver_RTK2885p(CandiTbl);
	}//RUN_MERLIN8P & RUN_MERLIN8
}
...
*/
unsigned int HAL_ME_GetStatusScanSel_RTK2885p(void)
{
	unsigned int status_scan_sel = 0;
	...
	status_scan_sel = kme_me1_top10_status_sel_reg.status_scan_sel;
	return status_scan_sel;
}

unsigned int HAL_ME_GetStatusScanSel_RTK2885pp(void)
{
	unsigned int status_scan_sel = 0;
	M8P_rtme_hme1_top4_status_sel_RBUS M8P_rtme_hme1_top4_status_sel;
	M8P_rtme_hme1_top4_status_sel.regValue = rtd_inl(M8P_RTME_HME1_TOP4_status_sel_reg);
	status_scan_sel = M8P_rtme_hme1_top4_status_sel.status_scan_sel;
	return status_scan_sel;
}

unsigned int HAL_ME_GetStatusScanSel(void)
{
	unsigned int u32_StatusScanSel = 0;

	if(RUN_MERLIN8P()){
		u32_StatusScanSel = HAL_ME_GetStatusScanSel_RTK2885pp();
	}else if(RUN_MERLIN8()){
		u32_StatusScanSel = HAL_ME_GetStatusScanSel_RTK2885p();
	}//RUN_MERLIN8P & RUN_MERLIN8

	return u32_StatusScanSel;
}
