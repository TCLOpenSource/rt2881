...
static const unsigned short g_mdns_offloading_fw_patch_code[] =
{
 ...
 0x09F0, 0xE06E, 0x80FE, 0xC0FF, 0xD150, 0x1A26, 0x308A, 0x7322, 0x25B5,
 ...
 0xF14B, 0xE00F, 0x7FC0, 0xEA70, 0x7236, 0x0A20, 0x1B20, 0xEA5C, 0x0220,
 ...
 0xE0C2, 0xA8C0, 0xE914, 0x7C00, 0xD150, 0xCE80, 0x7C02, 0xFF00, 0x0500,
 ...
 0x7290, 0xE9F3, 0x0304, 0x9B90, 0xE77D, 0x7FC0, 0xEA06, 0x9D6E, 0x757A,
 ...
 0x76A2, 0x1602, 0xF106, 0x1E02, 0x9EA0, 0xE021, 0x6800, 0x7FD0, 0x1601,
 ...
 0x7C00, 0x48C0, 0x32A8, 0x0A10, 0x4322, 0x9C6C, 0x1A00, 0x9A0E, 0x1A2A,
 ...
 0xD150, 0x0780, 0xCD70, 0x0008, 0x1800, 0x0DDE, 0x0C02, 0xA554, 0xA5DC,
 ...
 0x7C00, 0x7C02, 0xC31B, 0x746E, 0x6580, 0x1500, 0xF004, 0x3125, 0x0401,
...
static const unsigned short g_mdns_offloading_fw_patch_code_merlin8p[] =
{
 0x1308, 0xF133, 0xC35A, 0x7260, 0x1200, 0xF12F, 0xC234, 0x1B00, 0x9B4A,
 0x7326, 0x49B4, 0xF006, 0xC22E, 0x734A, 0x4834, 0x9B4A, 0xE005, 0xC229,
 0x734A, 0x48B4, 0x9B4A, 0x1A18, 0x3091, 0xC323, 0x746A, 0x49C4, 0xF003,
 ...
 0x767A, 0x0601, 0x9E7A, 0x1D00, 0x9D7C, 0xC593, 0xE9D4, 0xC591, 0x76A0,
 0x1600, 0xF14B, 0x76AA, 0x49E3, 0xF1D9, 0xC5E5, 0x76A6, 0x0601, 0x9EA6,
 0x76A2, 0x1602, 0xF106, 0x1E02, 0x9EA0, 0xE021, 0x6000, 0x7FD0, 0x1601,
 0xF102, 0xE7CA, 0x1600, 0xF002, 0xE7C7, 0x1E00, 0xC22B, 0xC3F6, 0xC4F6,
 0x7580, 0x1500, 0xF00E, 0xB405, 0xB406, 0xE99B, 0xB006, 0xB005, 0x1401,
 0xF008, 0x0602, 0xC4EA, 0xA526, 0x30DC, 0x0D01, 0xF1F4, 0xE7B2, 0xC5BE,
 0x1E01, 0x9EA0, 0x7420, 0x48CF, 0x7526, 0x49D0, 0xF104, 0x1A18, 0x308A,
...
static const unsigned short * get_hw_mdns_offloading_patch_code(unsigned int *pLen)
{
	if(get_mach_type()==MACH_ARCH_RTK2885P2) {
		*pLen = sizeof(g_mdns_offloading_fw_patch_code_merlin8p) / sizeof(g_mdns_offloading_fw_patch_code_merlin8p[0]);
		return g_mdns_offloading_fw_patch_code_merlin8p;
	} else {
...
static void rtl8168_mac_hw_mdns_offloading_patch(struct rtl8168_private *tp)
{
	...
	if(get_mach_type()==MACH_ARCH_RTK2885P2) {
		...
		r8168_mac_ocp_write(tp, 0xF800, 0xC202);
		r8168_mac_ocp_write(tp, 0xF802, 0xBA00);
		r8168_mac_ocp_write(tp, 0xF804, 0xA000);
...
void rtl8168_mac_hw_mdns_offloading_setting(struct rtl8168_private *tp)
{
	...
	if(get_mach_type()==MACH_ARCH_RTK2885P2)
		r8168_mac_ocp_write(tp, 0xFC28, 0x09EF);//set break point address 0x0
	else
		r8168_mac_ocp_write(tp, 0xFC28, 0x09ED);//set break point address 0x0		
}
