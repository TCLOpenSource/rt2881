...
struct rtk_vdec_dmabuf_config {
	uint32_t version;
	uint32_t disableProtect;
	uint32_t reserve[14];
};
...
#define VDEC_IOC_SVP_DMABUF_PRE_RELEASE _IOWR(VDEC_IOC_MAGIC, 0x10005, int)

#define VDEC_IOC_SVP_DMABUF_SET_CONFIG _IOWR(VDEC_IOC_MAGIC, 0x10006, int)
