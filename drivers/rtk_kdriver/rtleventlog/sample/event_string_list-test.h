...
static struct event_eventtype_s sample_test_eventtype[]={
    {SAMPLE_TEST_TYPE_1, "TEST_TYPE_1", sample_test1_event},
    {SAMPLE_TEST_TYPE_2, "TEST_TYPE_2", sample_test2_event},
