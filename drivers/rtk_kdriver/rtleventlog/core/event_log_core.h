...
######################################################################################
*/
#ifdef CONFIG_RTK_EVENTLOG_UBOOT
#include <fw/uboot/osal.h>
#endif

#ifdef CONFIG_RTK_EVENTLOG_KDRIVER
...
######################################################################################
*/
#define MERGER_EVENT_DW1(fw,module,event_type,event) (((EVENT_SYNCBYTE) << 24) | ((fw) << 20)| ((event_type) << 16) | (module << 8)| (event))
/*
######################################################################################
# lOG DEFINE
######################################################################################
...
#elif CONFIG_RTK_EVENTLOG_UBOOT
#define LOG_SIZE                        0x2000 //(4M/16 size)
...
#define event_alert_print(fmt, args...)

#define event_err_print(fmt, args...)

#define event_warn_print(fmt, args...)
#else
