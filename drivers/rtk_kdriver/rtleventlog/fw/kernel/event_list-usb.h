...
typedef enum
{
    KERNEL_USB_KAROKE_OUT_EVENT_ID,
    KERNEL_USB_KAROKE_IN_EVENT_ID,
    KERNEL_USB_KAROKE_EVENT_MAX
}KERNEL_USB_KAROKE_EVENT_ID;

typedef enum
{
    KERNEL_USB_DEBUG_EHCI_TIME_PROFILE_EVENT_ID,
    KERNEL_USB_DEBUG_EVENT_MAX
}KERNEL_USB_DEBUG_EVENT_ID;
...
typedef enum
{
    ...
    KERNEL_USB_DEBUG_TYPE_ID,
    KERNEL_USB_KAROKE_TYPE_ID,
    KERNEL_USB_TYPE_MAX
}KERNEL_USB_TYPE_ID;
...
######################################################################################
*/
#define   KERNEL_USB_DW1_karoke_in    MERGER_EVENT_DW1(EVENT_FW_KERNEL, KERNEL_USB_MODULE_ID, KERNEL_USB_KAROKE_TYPE_ID, KERNEL_USB_KAROKE_IN_EVENT_ID)
#define   KERNEL_USB_DW1_karoke_out    MERGER_EVENT_DW1(EVENT_FW_KERNEL, KERNEL_USB_MODULE_ID, KERNEL_USB_KAROKE_TYPE_ID, KERNEL_USB_KAROKE_OUT_EVENT_ID)
#define   KERNEL_USB_DW1_debug_ehci_time_profile    MERGER_EVENT_DW1(EVENT_FW_KERNEL, KERNEL_USB_MODULE_ID, KERNEL_USB_DEBUG_TYPE_ID, KERNEL_USB_DEBUG_EHCI_TIME_PROFILE_EVENT_ID)
