...
#include <fw/kernel/event_string_list-bluetooth.h>
#include <fw/kernel/event_string_list-karaoke.h>
...
struct event_module_s kernel_module[]={
    ...
    {KERNEL_BLUETOOTH_MODULE_ID, "bluetooth", kernel_bluetooth_eventtype},
    {KERNEL_KARAOKE_MODULE_ID, "karaoke", kernel_karaoke_eventtype},
