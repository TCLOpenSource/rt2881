...
echo "#ifndef __RTK_MODULE_${fw^^}_${module^^}_H__
#define __RTK_MODULE_${fw^^}_${module^^}_H__
/*
######################################################################################
# ${module^^} EVENT DEFINE
######################################################################################
...
#define rtd_${fw,,}_${module,,}_event_log(type, event, event_val, module_reserved)     rtd_${fw,,}_event_log(type, $module_id, event, event_val, module_reserved)
#endif /* __RTK_MODULE_${fw^^}_${module^^}_H__ */
" > ${module_file}

echo "#ifndef __RTK_MODULE_${fw^^}_${module^^}_STRING_H__
#define __RTK_MODULE_${fw^^}_${module^^}_STRING_H__
/*
######################################################################################
...
#endif /* __RTK_MODULE_${fw^^}_${module^^}_STRING_H__ */
" > ${module_string_file}