...
cd ../fw/;mkdir ${fw};
echo "
#ifndef __RTK_MODULE_${fw^^}_DEFINE_H__
#define __RTK_MODULE_${fw^^}_DEFINE_H__
/*
######################################################################################
# MODULE DEFINE
######################################################################################
...
#endif /* __RTK_MODULE_${fw^^}_DEFINE_H__ */" > ${file}

echo "
#ifndef __RTK_MODULE_${fw^^}_STRING_DEFINE_H__
#define __RTK_MODULE_${fw^^}_STRING_DEFINE_H__
...
#endif /* __RTK_MODULE_${fw^^}_STRING_DEFINE_H__ */" > ${file_s}
