...
#include "hdmirx/hdcp14_repeater/hdcp14_api.h"
    ...
    )
{
    ...
    // compute m and r0
    return hdcp_14_block_cipher(km, (repeater) ? 1 : 0, an,  ks, m, r0);
}


/*------------------------------------------------------------------
 * Func : __hdcp_14_compute_v
 *
...
bool __hdcp_14_compute_v(
    ...
    unsigned char       v[20])
{
    return hdcp_14_compute_v(ksv_list, list_len, bstatus, m, v);
}
    ...
    )
{
    ...
    ret = hdcp_14_compute_v(ksv_list, list_len, bstatus, m, v);
    return ret;
}
...
#ifdef HDMI_FIX_RL6672_3031_HDCP14_KSV_FIFO
...
void rtk_hdcp2_set_repeater(unsigned char nport, unsigned char repeater)
{
	...
	optee_hdcp2_repeater_set_enable(HDMI_HDCP2_MODE, HDCP2_CMD_REPEATER_SET_ENABLE, nport,repeater);
}
...
void rtk_hdcp2_set_rxinfo_ridlist(unsigned char nport, unsigned short rxinfo, unsigned char *ridlist)
{
	...
	optee_hdcp2_repeater_set_rxinfo_ridlist(HDMI_HDCP2_MODE, HDCP2_CMD_REPEATER_SET_RXINFO_RIDLIST, nport,rxinfo,ridlist,DeviceCount*5);
}
