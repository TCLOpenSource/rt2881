...
void newbase_hdmi_hdcp_init(void)
{
    ...
    //for gki case
    SET_HDCP_TOPOLOGY_CALLBACK(newbase_hdmi_hdcp_repeater_update_downstream_topology);
#endif
#endif
...
#if IS_ENABLED(CONFIG_HDCPTX)
        SET_HDMIRX_HDCP_TYPE(0); //clear HDCPRX info to HDCPTX
#endif
...
#if IS_ENABLED(CONFIG_HDCPTX)
	SET_HDMIRX_HDCP_TYPE(1); //send HDCPRX14 info to HDCPTX
#endif
}
