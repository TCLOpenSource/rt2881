...
/***************************Enginner Menu End ********************************************/
    ...
    case 1240:// TOOLACCESS_FIML_Result:
	{
		extern int a_film_log5[6100];
		if (size > sizeof(int)*6100)
			return -ID_SIZE_ERR;
		...
		memcpy(buf, (unsigned char *)a_film_log5, size);
...
// end lesley 1016
	...
	case TOOLACCESS_OD_Table_17x17:
	{
		...
		// add for rtice tool
		drvif_color_od_table_read(od_table_tv006_store, 255, 0); // all channel, rbus lut
    ...
    break;	
	case TOOLACCESS_VIP_LD_Boost_Debug: /*2000 get*/
	{
		extern SW_BOOST_INFO tSW_BOOST_INFO;
		extern unsigned short vip_tar_gain;
		extern unsigned short vip_cur_gain;
		extern unsigned char vip_print_log;
		extern unsigned short vip_print_pos;
		...
		pwUINT16Temp[9] = (unsigned short)vip_print_log;
		pwUINT16Temp[10] = (unsigned short)vip_print_pos;
...
// end lesley 1016
    ...
    // Mac5p 17x17 henry
		...
		drvif_color_od_table_write(od_delta_table, 0, 255);// 0:delta mode 1:target mode(output mode)
    ...
    break;
	case TOOLACCESS_VIP_LD_Boost_Debug:	/*2000 set*/
	{
		extern SW_BOOST_INFO tSW_BOOST_INFO;
		extern unsigned char vip_print_log;
		extern unsigned short vip_print_pos;
		...
		vip_print_log 					= (unsigned char)pwUINT16Temp[9];
		vip_print_pos						= (unsigned short)pwUINT16Temp[10];
		vip_free(pwUINT16Temp);
		pwUINT16Temp = NULL;
...
//		vpq_PQ_setting_check();
	...
	case TOOLACCESS_VIP_ODPH_LUT_Data_Access:
		...
		fwif_color_set_ODPH_LUT(&gVIP_ODPH_Data.ODPH_TBL, &gVIP_ODPH_Data.ODPH_APDEMGain, &gVIP_ODPH_Data.ODPH_Gain, rtice_param.mode1);
	...
	break;
		...
		case TOOLACCESS_VIP_ODPH_Gain_Data_Access:
			...
			fwif_color_set_ODPH_Gain(&gVIP_ODPH_Data.ODPH_APDEMGain, &gVIP_ODPH_Data.ODPH_Gain);
