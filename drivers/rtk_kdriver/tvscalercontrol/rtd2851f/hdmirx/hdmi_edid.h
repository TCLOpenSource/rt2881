...
typedef struct
{
   ...
   unsigned int current_edid_length;
...
extern void newbase_hdmi_sync_qs_edid(unsigned char port);
...
extern void newbase_hdmi_edid_dump(unsigned char port);
extern void newbase_hdmi_edid_enable_print_edid(unsigned char port);
extern void newbase_hdmi_edid_reset_print_edid(unsigned char port);
extern unsigned char newbase_hdmi_edid_is_print_edid_enabled(unsigned char port);
