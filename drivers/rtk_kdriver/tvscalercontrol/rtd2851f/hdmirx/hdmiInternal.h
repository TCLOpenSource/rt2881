...
extern unsigned char newbase_hdmi_set_5v_wakeup(unsigned int port, unsigned char enable);
extern void newbase_hdmi_dpm_monitor(unsigned char port);
extern void newbase_hdmi_reset_dpm_variables(void);
extern void newbase_hdmi_dpm_update_status(void);
extern unsigned char newbase_hdmi_dpm_is_should_wakeup(unsigned char port);
extern void newbase_hdmi_dpm_set_signal_monitor(unsigned char start_signal_monitor);
