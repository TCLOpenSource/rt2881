...
void drvif_color_set_valc_enable(unsigned char bEnable, unsigned char bEnable2, unsigned char valc_en)
{
	...
	if( bEnable != 0 )
	{
		...
		display_timing_ctrl2_reg.pcid2_en = bEnable2;
#endif
	...
	valc_pcid_valc_ctrl_reg.valc_en= valc_en;
	IoReg_Write32(VALC_PCID_VALC_CTRL_2_reg, valc_pcid_valc_ctrl_reg.regValue);

}

unsigned char drvif_color_get_valc_enable(void)
{
	ppoverlay_display_timing_ctrl2_RBUS display_timing_ctrl2_reg;

	display_timing_ctrl2_reg.regValue = IoReg_Read32(PPOVERLAY_Display_Timing_CTRL2_reg);
	return display_timing_ctrl2_reg.pcid_en;
}

unsigned char drvif_color_get_valc_enable2(void)
{
	ppoverlay_display_timing_ctrl2_RBUS display_timing_ctrl2_reg;

	display_timing_ctrl2_reg.regValue = IoReg_Read32(PPOVERLAY_Display_Timing_CTRL2_reg);
	return display_timing_ctrl2_reg.pcid2_en;
}
