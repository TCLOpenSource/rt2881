...
extern struct semaphore VPQ_OD_DMA_TBL_Semaphore;
...
char fwif_color_set_bt2020_Handler_tv006(unsigned char display, unsigned char Enable_Flag, unsigned char bt2020_Mode)
{
	...
	/* set Inv Gamma*/
	fwif_color_set_Gamma_InvGamma_Ctrl(display, InvGamma_TBL_Sel, invGammaTBL, invGammaTBL, invGammaTBL, 1, 1);
...
char fwif_color_DM2_EOTF_OETF_3D_LUT_Handler(HAL_VPQ_HDR_MODE_T HDR_MODE, unsigned short EO_forceIndex, unsigned short OE_forceIndex)
{
	char ret_val = -1;
	unsigned char check_times = 0, check_times_max = 20;
	unsigned char DMA_set_times = 0, DMA_set_times_max = 3;
	unsigned int hlg_3dlut = 16384;
	extern VIP_HDR_OETF_Prog_Idx_TBL OETF_prog_idx_tbl[2];
	extern unsigned short OETF_Lmix[16];
	extern unsigned short OETF_3dlut;
		...
		for (DMA_set_times = 0;DMA_set_times<DMA_set_times_max;DMA_set_times++) {
			...
			if (HDR_MODE == HAL_VPQ_HDR_MODE_HDR10) {
					if (fwif_VIP_get_Project_ID() == VIP_Project_ID_TV030) {
						...
						Scaler_color_Get_HDR10_EOTF_ByMaxCLL_ByPanelLuminance(EO_forceIndex);
						drvif_DM2_OETF_Set_Prog_Index(&OETF_prog_idx_tbl[1]);
						drvif_DM2_OETF_Set_Prog_Index_th(&(OETF_prog_idx_tbl[1].oetf_th[0]));
						Scaler_color_Get_HDR10_OETF_ByMaxCLL_ByPanelLuminance(OE_forceIndex);
					}
					args.a3dLUT_16_pArray = (unsigned short*)HDR10_3DLUT_17x17x17;
					fwif_color_set_DM_HDR_3dLUT_17x17x17_16_TV006(&args);
					fwif_color_set_DM_HDR_3dLUT_CInv(OETF_3dlut); // OETF_3dlut set in Scaler_color_Get_HDR10_OETF_ByMaxCLL_ByPanelLuminance()
					...
					hlg_3dlut = min(max((int)HLG_EOTF_ByLuminance_TBL_cur.EOTF_setting[1] + HDR_3DLUT_offset, 0), 0x000FFFFF);
					fwif_color_set_DM_HDR_3dLUT_CInv(hlg_3dlut); 
					...
					fwif_color_set_DM_HDR_3dLUT_17x17x17_16_TV006(&args);
					fwif_color_set_DM_HDR_3dLUT_CInv(16384); 
