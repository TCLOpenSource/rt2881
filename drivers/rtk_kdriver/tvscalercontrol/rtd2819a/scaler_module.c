...
extern int __init v4l2_vtdev_capture1_init(void);
extern void __exit v4l2_vtdev_capture1_exit(void);
extern int __init v4l2_vtdev_capture2_init(void);
extern void __exit v4l2_vtdev_capture2_exit(void);
extern int __init v4l2_vtdev_capture3_init(void);
extern void __exit v4l2_vtdev_capture3_exit(void);
extern int __init v4l2_vtdev_capture4_init(void);
extern void __exit v4l2_vtdev_capture4_exit(void);
extern int __init v4l2_vtdev_capture5_init(void);
extern void __exit v4l2_vtdev_capture5_exit(void);
extern int __init v4l2_vtdev_capture6_init(void);
extern void __exit v4l2_vtdev_capture6_exit(void);
...
// UVC
extern int uvc_module_init(void);
extern void __exit uvc_module_exit(void);
...
//IDDMA
extern int __init iddma_isr_init_module(void);
extern void __exit iddma_isr_exit_module(void);
...
extern int hdmitx_init_module(void);
extern void __exit hdmitx_cleanup_module(void);
#else
#define hdmitx_init_module()
#define hdmitx_cleanup_module()
#endif
...
int __init scaler_module_init(void)
{
    ...
    v4l2_vtdev_capture1_init();
    v4l2_vtdev_capture2_init();
    v4l2_vtdev_capture3_init();
    v4l2_vtdev_capture4_init();
    v4l2_vtdev_capture5_init();
    v4l2_vtdev_capture6_init();
    vbe_module_init();
    uvc_module_init();
...
void __exit scaler_module_exit(void)
{
    ...
    vo_module_exit();
    vivt_cleanup_module();
    v4l2_vtdev_capture1_exit();
    v4l2_vtdev_capture2_exit();
    v4l2_vtdev_capture3_exit();
    v4l2_vtdev_capture4_exit();
    v4l2_vtdev_capture5_exit();
    v4l2_vtdev_capture6_exit();
    vbe_module_exit();
    uvc_module_exit();
