...
void PipmpSetSubActiveWindow(unsigned short DispHSta, unsigned short DispHEnd, unsigned short DispVSta, unsigned short DispVEnd)
{
	...
	scaler_dtg_get_sub_active_start_end(&h_v_info);
	...
	h_v_info.h_start = DispHSta;
	h_v_info.h_end = DispHEnd;
	h_v_info.v_start = DispVSta;
	h_v_info.v_end = DispVEnd;
	
	scaler_dtg_set_sub_active_start_end(&h_v_info);
