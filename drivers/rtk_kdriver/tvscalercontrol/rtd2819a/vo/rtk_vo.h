...
VO_GAV_BBD_CROP_T Scaler_Get_VO_BBD_outCrop(int *status_flag);
...
#ifndef BUILD_QUICK_SHOW
#define VO_IOC_GAV_START        _IOW(VO_IOC_MAGIC, 6, int)
#define VO_IOC_GAV_STOP         _IO(VO_IOC_MAGIC, 7)
#define VO_IOC_GAV_QUEUE        _IOWR(VO_IOC_MAGIC, 8, int)
#define VO_IOC_GAV_DEQUEUE      _IOWR(VO_IOC_MAGIC, 9, int)
#define VO_IOC_MAXNR            9
#else
...
#define GAV_OK                  0
#define GAV_ERROR               1
#define GAV_NOT_RUN             2
#define GAV_HAS_RUN             3
#define GAV_SHM_NULL            4
#define GAV_PENDING_PIC_IN      5
#define GAV_PENDING_PIC_OUT     6
#define GAV_RPC_FAIL            7
#define GAV_OVERFLOW            8
#endif
...
void Set_Val_vodma2_vdec_source(unsigned int type);//set vodma2 source type
unsigned int Get_Val_vodma2_vdec_source(void);//get vodam2 source type not
