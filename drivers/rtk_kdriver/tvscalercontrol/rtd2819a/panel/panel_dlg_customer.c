...
static void panel_dlg_dclk_setting(void)
{
    ...
    // Merlin9 MEMC clock setting guide ( from CRT spec )
    sys_reg_sys_dclk_gate_sel1_reg.dclk_memc_in_if_gate_sel = sys_reg_sys_dclk_gate_sel0_reg.dclk_s1_f1p_gate_sel;
    sys_reg_sys_dclk_gate_sel1_reg.dclk_mc_ippre_gate_sel = sys_reg_sys_dclk_gate_sel0_reg.dclk_s1_f1p_gate_sel;
    sys_reg_sys_dclk_gate_sel1_reg.dclk_mc_gate_sel = sys_reg_sys_dclk_gate_sel0_reg.dclk_s2_f1p_gate_sel;
