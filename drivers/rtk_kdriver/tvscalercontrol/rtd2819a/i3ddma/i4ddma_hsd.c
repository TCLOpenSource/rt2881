...
void I4DDMA_color_colorspacergb2yuvtransfer(DISPD_CAP_SRC idmaDispD_in_sel)
{
	unsigned short *table_index = 0;
	h4ddma_rgb2yuv_dither_4xxto4xx_hdmi4_rgb2yuv_ctrl_RBUS  i3ddma_rgb2yuv_ctrl_reg;
	h4ddma_rgb2yuv_dither_4xxto4xx_hdmi4_rgb2yuv_tab_m11_m12_RBUS tab2_M11_M12_REG;
	h4ddma_rgb2yuv_dither_4xxto4xx_hdmi4_rgb2yuv_tab_m13_m21_RBUS tab2_M13_M21_REG;
	h4ddma_rgb2yuv_dither_4xxto4xx_hdmi4_rgb2yuv_tab_m22_m23_RBUS tab2_M22_M23_REG;
	h4ddma_rgb2yuv_dither_4xxto4xx_hdmi4_rgb2yuv_tab_m31_m32_RBUS tab2_M31_M32_REG;
	h4ddma_rgb2yuv_dither_4xxto4xx_hdmi4_rgb2yuv_tab_m33_ygain_RBUS tab2_M33_YGain_REG;
	h4ddma_rgb2yuv_dither_4xxto4xx_hdmi4_rgb2yuv_tab_yo_RBUS tab2_Yo_REG;
	...
	IoReg_Write32(H4DDMA_RGB2YUV_DITHER_4XXTO4XX_HDMI4_RGB2YUV_TAB_M11_M12_reg, tab2_M11_M12_REG.regValue);

	tab2_M13_M21_REG.m13 = table_index [_RGB2YUV_m13];
	tab2_M13_M21_REG.m21 = table_index [_RGB2YUV_m21];
	IoReg_Write32(H4DDMA_RGB2YUV_DITHER_4XXTO4XX_HDMI4_RGB2YUV_TAB_M13_M21_reg, tab2_M13_M21_REG.regValue);
	...
	IoReg_Write32(H4DDMA_RGB2YUV_DITHER_4XXTO4XX_HDMI4_RGB2YUV_TAB_M22_M23_reg, tab2_M22_M23_REG.regValue);

	tab2_M31_M32_REG.m31 = table_index [_RGB2YUV_m31];
	tab2_M31_M32_REG.m32 = table_index [_RGB2YUV_m32];
	IoReg_Write32(H4DDMA_RGB2YUV_DITHER_4XXTO4XX_HDMI4_RGB2YUV_TAB_M31_M32_reg, tab2_M31_M32_REG.regValue);
	...
	IoReg_Write32(H4DDMA_RGB2YUV_DITHER_4XXTO4XX_HDMI4_RGB2YUV_TAB_M33_YGain_reg, tab2_M33_YGain_REG.regValue);

	tab2_Yo_REG.yo_odd= table_index [_RGB2YUV_Yo_odd];
	IoReg_Write32(H4DDMA_RGB2YUV_DITHER_4XXTO4XX_HDMI4_RGB2YUV_TAB_Yo_reg, tab2_Yo_REG.regValue);

	i3ddma_rgb2yuv_ctrl_reg.regValue = IoReg_Read32(H4DDMA_RGB2YUV_DITHER_4XXTO4XX_HDMI4_RGB2YUV_CTRL_reg);
	...
	IoReg_Write32(H4DDMA_RGB2YUV_DITHER_4XXTO4XX_HDMI4_RGB2YUV_CTRL_reg, i3ddma_rgb2yuv_ctrl_reg.regValue);

	return;
}

void I4DDMA_ultrazoom_auto_four_tap(void)
{
	unsigned int z_RBUS_reg;
	z_RBUS_reg = IoReg_Read32( H4DDMA_HSD_I4DDMA_UZD_CTRL1_reg );
	VPQ_SET_REG_FIELD( z_RBUS_reg , H4DDMA_HSD_I4DDMA_UZD_CTRL1_auto_four_tap_en , 1 );
	IoReg_Write32( H4DDMA_HSD_I4DDMA_UZD_CTRL1_reg , z_RBUS_reg );
}

void I4DDMA_ultrazoom_coef_db_apply(void)
{
	unsigned int z_RBUS_reg;
	z_RBUS_reg = IoReg_Read32( H4DDMA_HSD_I4DDMA_UZD_COEF_DB_CTRL_reg );
	VPQ_SET_REG_FIELD( z_RBUS_reg , H4DDMA_HSD_I4DDMA_UZD_COEF_DB_CTRL_coef_db_apply , 1 );
	IoReg_Write32( H4DDMA_HSD_I4DDMA_UZD_COEF_DB_CTRL_reg , z_RBUS_reg );
}
 ...
 */
void I4DDMA_ultrazoom_set_scale_down(SIZE* in_Size, SIZE* out_Size, unsigned char panorama)
{
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    h4ddma_hsd_i4ddma_uzd_ctrl0_RBUS				i3ddma_uzd_ctrl0_reg;
    h4ddma_hsd_i4ddma_uzd_scale_hor_factor_RBUS	i3ddma_hsd_scale_hor_factor_reg;
    h4ddma_hsd_i4ddma_uzd_scale_ver_factor_RBUS   	i3ddma_vsd_Scale_Ver_Factor_reg;
    h4ddma_hsd_i4ddma_uzd_initial_value_RBUS		i3ddma_uzd_initial_value_reg;
    h4ddma_hsd_i4ddma_uzd_initial_int_value_RBUS		i3ddma_uzd_initial_int_value_reg;
    h4ddma_hsd_i4ddma_uzd_ibuff_ctrl_RBUS		i3ddma_uzd_ibuff_ctrl_reg;
	
    i3ddma_uzd_ctrl0_reg.regValue		= IoReg_Read32(H4DDMA_HSD_I4DDMA_UZD_CTRL0_reg);
    i3ddma_hsd_scale_hor_factor_reg.regValue	= IoReg_Read32(H4DDMA_HSD_I4DDMA_UZD_SCALE_HOR_FACTOR_reg);
    i3ddma_vsd_Scale_Ver_Factor_reg.regValue = IoReg_Read32(H4DDMA_HSD_I4DDMA_UZD_SCALE_VER_FACTOR_reg);
   // i3ddma_hsd_hor_delta1_reg.regValue	= IoReg_Read32(H4DDMA_HSD_I4DDMA_UZD_HSD_Hor_Delta1_reg);
    i3ddma_uzd_initial_value_reg.regValue	= IoReg_Read32(H4DDMA_HSD_I4DDMA_UZD_INITIAL_VALUE_reg);
    i3ddma_uzd_initial_int_value_reg.regValue = IoReg_Read32(H4DDMA_HSD_I4DDMA_UZD_INITIAL_INT_VALUE_reg);
    i3ddma_uzd_ibuff_ctrl_reg.regValue = IoReg_Read32(H4DDMA_HSD_I4DDMA_UZD_IBUFF_CTRL_reg);
    ...
    if (in_Size->nWidth > out_Size->nWidth) {
        ...
        for (i=0; i<16; i++)
        {
            ...
            IoReg_Write32(H4DDMA_HSD_I4DDMA_UZD_FIR_COEF_TAB1_C0_reg+ i*4, tmp_data);
        }
    }
	...
	if (in_Size->nLength > out_Size->nLength) {
		...
		for (i=0; i<16; i++)
		{
			tmp_data = ((unsigned int)(*coef_pt++)<<16);
			tmp_data += (unsigned int)(*coef_pt++);
			IoReg_Write32(H4DDMA_HSD_I4DDMA_UZD_FIR_COEF_TAB2_C0_reg+ i*4, tmp_data);
		}

	}
	I4DDMA_ultrazoom_coef_db_apply();
...
//	CLR_422_Fr_SD();
	I4DDMA_ultrazoom_auto_four_tap();

	IoReg_Write32(H4DDMA_HSD_I4DDMA_UZD_CTRL0_reg, i3ddma_uzd_ctrl0_reg.regValue);
	IoReg_Write32(H4DDMA_HSD_I4DDMA_UZD_SCALE_HOR_FACTOR_reg, i3ddma_hsd_scale_hor_factor_reg.regValue);
	IoReg_Write32(H4DDMA_HSD_I4DDMA_UZD_SCALE_VER_FACTOR_reg, i3ddma_vsd_Scale_Ver_Factor_reg.regValue);
	IoReg_Write32(H4DDMA_HSD_I4DDMA_UZD_INITIAL_VALUE_reg, i3ddma_uzd_initial_value_reg.regValue);
	IoReg_Write32(H4DDMA_HSD_I4DDMA_UZD_INITIAL_INT_VALUE_reg, i3ddma_uzd_initial_int_value_reg.regValue);
	IoReg_Write32(H4DDMA_HSD_I4DDMA_UZD_IBUFF_CTRL_reg, i3ddma_uzd_ibuff_ctrl_reg.regValue);

	return;
}

void I4DDMA_ultrazoom_config_scaling_down(SIZE* in_Size, SIZE* out_Size, unsigned char panorama)
{
#ifdef CONFIG_ENABLE_HDMI3_0_NN
	rtd_pr_i3ddma_emerg("Don't do I4DDMA_ultrazoom_config_scaling_down\n");
#else
	...
	I4DDMA_ultrazoom_set_scale_down(in_Size, out_Size, panorama);
#endif
	return;
}
