...
void Scaler_disp_setting_QS(unsigned char display)
{
    ...
    {
		if( ( ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) >= V_FREQ_100000_mOFFSET ) && ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) < V_FREQ_100000_pOFFSET ) ) ||
			( ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) >= V_FREQ_120000_mOFFSET ) && ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) < V_FREQ_120000_pOFFSET ) ) ||
			( ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) >= V_FREQ_144000_mOFFSET ) && ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) < V_FREQ_144000_pOFFSET ) ) ||
			( ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) >= V_FREQ_240000_mOFFSET ) && ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) < V_FREQ_240000_pOFFSET ) ) ||
			( ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) >= V_FREQ_288000_mOFFSET ) && ( Scaler_DispGetInputInfoByDisp(display, SLR_INPUT_V_FREQ_1000) < V_FREQ_288000_pOFFSET ) ) 
			 )
        {
	...
	if((get_vsc_src_is_hdmi_or_dp(display)) && (vbe_disp_get_VRR_timingMode_flag() || vbe_disp_get_freesync_mode_flag()))
	{
