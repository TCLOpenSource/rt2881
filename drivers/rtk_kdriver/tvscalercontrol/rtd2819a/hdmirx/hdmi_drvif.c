...
/*------------------------------------------------------
 * Func : drvif_Hdmi_SetVideoCommonSel
 *
 * Desc : Set video common of the connected HDMI port
 ...
 * Retn : N/A
 *------------------------------------------------------*/
void drvif_Hdmi_SetVideoCommonSel(void)
{
	unsigned char port = newbase_hdmi_get_current_display_port();

	if (!newbase_hdmi_get_common_420_selection())
