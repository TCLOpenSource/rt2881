...
/*table0:test*/
	{
                ...
                {8, LD8BIT, 0,LD8BIT,0,LD8BIT,LD8BIT,0,DATSEP_DEFAULT, 0, 0 , 1, 0},/*DRV_LDINTERFACE_Output: \
                outputUnit(real unit),out_format,tailer_unit,tailer_format,header_unit,header_format,multiDelay_format,multi_add,data_sram_separate, shift_dir, shift_num,zero_dir, zero_padding*/
