...
/**
 * Sets the window mode settings for the VALC (Video Alpha Layer Controller).
 *
 * @param VALC_Win_Ctrl Pointer to a DRV_valc_win_ctrl_t structure containing the window mode control parameters.
 *                      The structure should include the following members:
 *                      - Boundary: A structure containing the boundary parameters of the window.
 *                        - valcWindowStartX: The starting X coordinate of the window.
 *                        - valcWindowStartY: The starting Y coordinate of the window.
 *                        - valcWindowHeight: The height of the window.
 *                        - valcWindowWidth: The width of the window.
 *                      - enable: A flag indicating whether to enable the window mode.
 *
 * @return None.
 *
 * @usage Call this function to set the window mode settings for the VALC.
 *        It configures the starting coordinates, height, and width of the window,
 *        and enables or disables the window mode based on the input parameters.
 */
...
/**
 * Enables or disables the multi-scene functionality of the VALC (Video Alpha Layer Controller).
 *
 * @param multi_en      A flag indicating whether to enable the multi-scene functionality.
 * @param overlap_en    A flag indicating whether to enable overlapping of scenes.
 * @param window_out_en A flag indicating whether to enable window output.
 *
 * @return None.
 *
 * @usage Call this function to enable or disable the multi-scene functionality of the VALC.
 *        It configures the multi-scene function, overlapping of scenes, and window output
...
void drvif_color_set_valc_multi_scene_inner_enable(unsigned char bEnable, unsigned char scene_sel)
{
	...
	{
		valc_valc_multi_scene3_ctrl_RBUS valc_valc_multi_scene3_ctrl_reg;
		valc_valc_multi_scene3_ctrl_reg.regValue = IoReg_Read32(VALC_VALC_MULTI_SCENE3_CTRL_reg);
		valc_valc_multi_scene3_ctrl_reg.valc_multi_scene3_en= bEnable;
		IoReg_Write32(VALC_VALC_MULTI_SCENE3_CTRL_reg, valc_valc_multi_scene3_ctrl_reg.regValue);
	}
	else if(scene_sel == 4)
	{	
		valc_valc_multi_scene4_ctrl_RBUS valc_valc_multi_scene4_ctrl_reg;
		valc_valc_multi_scene4_ctrl_reg.regValue = IoReg_Read32(VALC_VALC_MULTI_SCENE4_CTRL_reg);
		valc_valc_multi_scene4_ctrl_reg.valc_multi_scene4_en= bEnable;
		IoReg_Write32(VALC_VALC_MULTI_SCENE4_CTRL_reg, valc_valc_multi_scene4_ctrl_reg.regValue);
	}
	else
	{
...
void drvif_color_set_valc_multi_scene_inner_setting(DRV_valc_multi_scene_n_ctrl_t* VALC_Muti_Scene_Ctrl, unsigned char scene_sel)
{
	if(scene_sel == 1){
		...
		valc_valc_multi_scene3_ctrl_RBUS valc_valc_multi_scene3_ctrl_reg;
		valc_valc_multi_scene3_ctrl_2_RBUS valc_valc_multi_scene3_ctrl_2_reg;

		valc_valc_multi_scene3_ctrl_reg.regValue = IoReg_Read32(VALC_VALC_MULTI_SCENE3_CTRL_reg);
		valc_valc_multi_scene3_ctrl_2_reg.regValue = IoReg_Read32(VALC_VALC_MULTI_SCENE3_CTRL_2_reg);
		...
		IoReg_Write32(VALC_VALC_MULTI_SCENE3_CTRL_2_reg, valc_valc_multi_scene3_ctrl_2_reg.regValue);

	}else if(scene_sel == 4){

		valc_valc_multi_scene4_ctrl_RBUS valc_valc_multi_scene4_ctrl_reg;
		valc_valc_multi_scene4_ctrl_2_RBUS valc_valc_multi_scene4_ctrl_2_reg;

		valc_valc_multi_scene4_ctrl_reg.regValue = IoReg_Read32(VALC_VALC_MULTI_SCENE4_CTRL_reg);
		valc_valc_multi_scene4_ctrl_2_reg.regValue = IoReg_Read32(VALC_VALC_MULTI_SCENE4_CTRL_2_reg);
		...
		IoReg_Write32(VALC_VALC_MULTI_SCENE4_CTRL_2_reg, valc_valc_multi_scene4_ctrl_2_reg.regValue);
