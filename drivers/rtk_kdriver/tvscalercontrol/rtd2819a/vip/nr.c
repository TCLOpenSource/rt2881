...
void drvif_color_Mixer_ctrl_Vfilter(unsigned char channel, int select)
{
	...
	vfir_weight_bak = VLPF_Coef_0[select][0];
#endif
}
...
void drvif_color_DRV_MPG_H_tv006(DRV_MPEGNR_16_Table *ptr, unsigned char skipFWreg)
{
	...
	//mpegnr_ich1_mpegnr_ub_delta2_reg.cp_mpgub_dec_unif = ptr->S_MPEGNR_16_Flat_and_Dec.cp_mpgub_dec_unif;
	...
	//db en temp off because strange glitch
	//IoReg_SetBits(MPEGNR_ICH1_MPEGNR_DB_CTRL_reg, MPEGNR_ICH1_MPEGNR_DB_CTRL_mpegnr_db_en_mask);
	IoReg_ClearBits(MPEGNR_ICH1_MPEGNR_DB_CTRL_reg, MPEGNR_ICH1_MPEGNR_DB_CTRL_mpegnr_db_en_mask);

}

void drvif_color_DRV_s_MPG_H_tv006(DRV_MPEGNR_16_Table *ptr, unsigned char skipFWreg)
{

	mpegnr_sub_ich2_blend_nr_hor_step_RBUS	mpegnr_ich1_blend_nr_hor_step_reg	;
	mpegnr_sub_ich2_mpegnr1_RBUS	mpegnr_ich1_mpegnr1_reg	;
	mpegnr_sub_ich2_mpegnr_ub_delta1_RBUS	mpegnr_ich1_mpegnr_ub_delta1_reg	;
	mpegnr_sub_ich2_mpegnr_ub_delta2_RBUS	mpegnr_ich1_mpegnr_ub_delta2_reg	;
	mpegnr_sub_ich2_mpegnr_ub_cen_th_RBUS	mpegnr_ich1_mpegnr_ub_cen_th_reg	;
	mpegnr_sub_ich2_mpegnr2_RBUS	mpegnr_ich1_mpegnr2_reg	;
	mpegnr_sub_ich2_mpegnr_ub_cen_gain_RBUS	mpegnr_ich1_mpegnr_ub_cen_gain_reg	;
	mpegnr_sub_ich2_mpegnr_ub_dif_cmp_RBUS	mpegnr_ich1_mpegnr_ub_dif_cmp_reg	;
	mpegnr_sub_ich2_hist_blking_hor_range_RBUS	mpegnr_ich1_hist_blking_hor_range_reg	;
	mpegnr_sub_ich2_hist_blking_ver_range_RBUS	mpegnr_ich1_hist_blking_ver_range_reg	;
	mpegnr_sub_ich2_det_hist_hor_thd_hlh_RBUS	mpegnr_ich1_det_hist_hor_thd_hlh_reg	;
	mpegnr_sub_ich2_mpegstart_RBUS	mpegnr_ich1_mpegstart_reg	;
	mpegnr_sub_ich2_det_hist_hor_step_RBUS	mpegnr_ich1_det_hist_hor_step_reg	;
	mpegnr_sub_ich2_det_hist_hor_thd_RBUS	mpegnr_ich1_det_hist_hor_thd_reg	;

	mpegnr_ich1_blend_nr_hor_step_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_blend_NR_Hor_step_reg	);
	mpegnr_ich1_mpegnr1_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_MPEGNR1_reg	);
	mpegnr_ich1_mpegnr_ub_delta1_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_MPEGNR_UB_delta1_reg	);
	mpegnr_ich1_mpegnr_ub_delta2_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_MPEGNR_UB_delta2_reg	);
	mpegnr_ich1_mpegnr_ub_cen_th_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_MPEGNR_UB_Cen_Th_reg	);
	mpegnr_ich1_mpegnr2_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_MPEGNR2_reg	);
	mpegnr_ich1_mpegnr_ub_cen_gain_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_MPEGNR_UB_Cen_Gain_reg	);
	mpegnr_ich1_mpegnr_ub_dif_cmp_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_MPEGNR_UB_Dif_Cmp_reg	);
	mpegnr_ich1_hist_blking_hor_range_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_Hist_Blking_Hor_Range_reg	);
	mpegnr_ich1_hist_blking_ver_range_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_Hist_Blking_Ver_Range_reg	);
	mpegnr_ich1_det_hist_hor_thd_hlh_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_det_Hist_Hor_thd_hlh_reg	);
	mpegnr_ich1_mpegstart_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_MPEGStart_reg	);
	mpegnr_ich1_det_hist_hor_step_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_det_Hist_Hor_step_reg	);
	mpegnr_ich1_det_hist_hor_thd_reg	.regValue=IoReg_Read32(	MPEGNR_SUB_ICH2_det_Hist_Hor_thd_reg	);
	...
	mpegnr_ich1_mpegnr2_reg.cp_mpegresultweight_x = ptr->S_MPEGNR_16_LPF.result_weight;
	// mpegnr_ich1_mpegnr2_reg.cp_mpegresultweight_x =7; //fixed me for demo
	IoReg_Write32(	MPEGNR_SUB_ICH2_blend_NR_Hor_step_reg	,	mpegnr_ich1_blend_nr_hor_step_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_MPEGNR1_reg	,	mpegnr_ich1_mpegnr1_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_MPEGNR_UB_delta1_reg	,	mpegnr_ich1_mpegnr_ub_delta1_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_MPEGNR_UB_delta2_reg	,	mpegnr_ich1_mpegnr_ub_delta2_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_MPEGNR_UB_Cen_Th_reg	,	mpegnr_ich1_mpegnr_ub_cen_th_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_MPEGNR2_reg	,	mpegnr_ich1_mpegnr2_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_MPEGNR_UB_Cen_Gain_reg	,	mpegnr_ich1_mpegnr_ub_cen_gain_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_MPEGNR_UB_Dif_Cmp_reg	,	mpegnr_ich1_mpegnr_ub_dif_cmp_reg	.regValue);
	// computed_by_HW IoReg_Write32(	MPEGNR_SUB_ICH2_Hist_Blking_Hor_Range_reg	,	mpegnr_ich1_hist_blking_hor_range_reg	.regValue);
	// computed_by_HW IoReg_Write32(	MPEGNR_SUB_ICH2_Hist_Blking_Ver_Range_reg	,	mpegnr_ich1_hist_blking_ver_range_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_MPEGStart_reg	,	mpegnr_ich1_mpegstart_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_det_Hist_Hor_step_reg	,	mpegnr_ich1_det_hist_hor_step_reg	.regValue);
	IoReg_Write32(	MPEGNR_SUB_ICH2_det_Hist_Hor_thd_reg	,	mpegnr_ich1_det_hist_hor_thd_reg	.regValue);

	//db apply
	IoReg_SetBits(MPEGNR_SUB_ICH2_MPEGNR_DB_CTRL_reg, MPEGNR_SUB_ICH2_MPEGNR_DB_CTRL_mpegnr_db_apply_mask);
	//db en temp off because strange glitch
	//IoReg_SetBits(MPEGNR_SUB_ICH2_MPEGNR_DB_CTRL_reg, MPEGNR_SUB_ICH2_MPEGNR_DB_CTRL_mpegnr_db_en_mask);
	IoReg_ClearBits(MPEGNR_SUB_ICH2_MPEGNR_DB_CTRL_reg, MPEGNR_SUB_ICH2_MPEGNR_DB_CTRL_mpegnr_db_en_mask);
...
void drvif_color_DRV_MPG_V(DRV_MPEGNR_16_Table *ptr)
{
	...
	// vertical niy nr_dch1_mpegnr_ub_delta2_reg.cp_mpgub_dec_unif = ptr->S_MPEGNR_16_Flat_and_Dec.cp_mpgub_dec_unif;
...
void drvif_color_DRV_s_MPG_V(DRV_MPEGNR_16_Table *ptr)
{

	nr_sub_dch2_mpegnr1_RBUS	nr_dch1_mpegnr1_reg	;
	nr_sub_dch2_mpegnr2_RBUS	nr_dch1_mpegnr2_reg	;
	nr_sub_dch2_mpegnr3_RBUS	nr_dch1_mpegnr3_reg	;
	nr_sub_dch2_vist_blking_range_RBUS	nr_dch1_vist_blking_range_reg	;
	nr_sub_dch2_det_hist_vor_thd_hlh_RBUS	nr_dch1_det_hist_vor_thd_hlh_reg	;
	nr_sub_dch2_mpegstart_RBUS	nr_dch1_mpegstart_reg	;
	nr_sub_dch2_det_vist_hor_step_RBUS	nr_dch1_det_vist_hor_step_reg	;
	nr_sub_dch2_det_hist_hor_thd_RBUS	nr_dch1_det_hist_hor_thd_reg	;
	nr_sub_dch2_blend_nr_ver_step_RBUS	nr_dch1_blend_nr_ver_step_reg	;
	nr_sub_dch2_mpegnr_ub_delta1_RBUS	nr_dch1_mpegnr_ub_delta1_reg	;
	nr_sub_dch2_mpegnr_ub_delta2_RBUS	nr_dch1_mpegnr_ub_delta2_reg	;
	nr_sub_dch2_mpegnr_diff_th_RBUS	nr_dch1_mpegnr_diff_th_reg	;
	nr_sub_dch2_mpegnr_diff_gain_RBUS	nr_dch1_mpegnr_diff_gain_reg	;
	nr_sub_dch2_mpegnr_diff_cmp_RBUS	nr_dch1_mpegnr_diff_cmp_reg	;

	nr_dch1_mpegnr1_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_MPEGNR1_reg	);
	nr_dch1_mpegnr2_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_MPEGNR2_reg	);
	nr_dch1_mpegnr3_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_MPEGNR3_reg	);
	nr_dch1_vist_blking_range_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_Vist_Blking_Range_reg	);
	nr_dch1_det_hist_vor_thd_hlh_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_det_Hist_Vor_thd_hlh_reg);
	nr_dch1_mpegstart_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_MPEGStart_reg	);
	nr_dch1_det_vist_hor_step_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_det_Vist_Hor_step_reg	);
	nr_dch1_det_hist_hor_thd_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_det_Hist_Hor_thd_reg	);
	nr_dch1_blend_nr_ver_step_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_blend_NR_Ver_step_reg	);
	nr_dch1_mpegnr_ub_delta1_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_MPEGNR_UB_delta1_reg	);
	nr_dch1_mpegnr_ub_delta2_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_MPEGNR_UB_delta2_reg	);
	nr_dch1_mpegnr_diff_th_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_MPEGNR_Diff_Th_reg	);
	nr_dch1_mpegnr_diff_gain_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_MPEGNR_Diff_Gain_reg	);
	nr_dch1_mpegnr_diff_cmp_reg	.regValue=IoReg_Read32(	NR_SUB_DCH2_MPEGNR_Diff_Cmp_reg	);
	...
	IoReg_Write32(	NR_SUB_DCH2_MPEGNR1_reg	,	nr_dch1_mpegnr1_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_MPEGNR2_reg	,	nr_dch1_mpegnr2_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_MPEGNR3_reg	,	nr_dch1_mpegnr3_reg	.regValue);
	// computed_by_HW IoReg_Write32(	NR_SUB_DCH2_Vist_Blking_Range_reg	,	nr_dch1_vist_blking_range_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_det_Hist_Vor_thd_hlh_reg	,	nr_dch1_det_hist_vor_thd_hlh_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_MPEGStart_reg	,	nr_dch1_mpegstart_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_det_Vist_Hor_step_reg	,	nr_dch1_det_vist_hor_step_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_det_Hist_Hor_thd_reg	,	nr_dch1_det_hist_hor_thd_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_blend_NR_Ver_step_reg	,	nr_dch1_blend_nr_ver_step_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_MPEGNR_UB_delta1_reg	,	nr_dch1_mpegnr_ub_delta1_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_MPEGNR_UB_delta2_reg	,	nr_dch1_mpegnr_ub_delta2_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_MPEGNR_Diff_Th_reg	,	nr_dch1_mpegnr_diff_th_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_MPEGNR_Diff_Gain_reg	,	nr_dch1_mpegnr_diff_gain_reg	.regValue);
	IoReg_Write32(	NR_SUB_DCH2_MPEGNR_Diff_Cmp_reg	,	nr_dch1_mpegnr_diff_cmp_reg	.regValue);

	//db apply
	IoReg_SetBits(NR_SUB_DCH2_V_MPEGNR_DB_CTRL_reg, NR_SUB_DCH2_V_MPEGNR_DB_CTRL_mpegnr_db_apply_mask); // DB apply
}
...
void drvif_IESM_format_convert(void)// Merlin4 add
{
	...
	NRPprintf_Info("iesm_format:main(imode=%d, rtnr=%d, %d->%d, type:%d->%d)\n ",
...
void drvif_IESM_frontporch_set(unsigned char game_mode_check_flag)
{
	...
	if(front_porch_num >= front_porch_num_th && I_width <= WIDTH_FOR_EDGESMOOTH_DECIDE_LINE_MODE && (fmt_422to444==1))
		linemode_limit = 2; // 11 line mode
	...
	iedgeSmooth_line_mode = linemode_limit;
#endif
	IoReg_Write32(IEDGE_SMOOTH_EdgeSmooth_EX_CTRL_reg,edgesmooth_ex_ctrl_reg.regValue);

	PC_mode_check = Scaler_VPQ_check_PC_RGB444(SLR_MAIN_DISPLAY);
	if ((game_mode_check_flag ==1) || (PC_mode_check == VIP_HDMI_PC_RGB444) || (PC_mode_check == VIP_DP_PC_RGB444) 
		|| (Scaler_Get_DI_SNR_Borrow_Sram_Mode() == SNR_DI_Sram_VE_USE)) {
		drvif_color_set_iEdgeSmooth_linemode_disable(1, 0); // edgesmooth_ex_ctrl_reg.lbuf_disable =1;
	} else {
		drvif_color_set_iEdgeSmooth_linemode_disable(0, 0); // edgesmooth_ex_ctrl_reg.lbuf_disable =0;
	}
	...
	rtd_pr_vpq_info("MAIN: front_porch_num=vlen-actlen-actsta: %d=%d-%d-%d, size=%d*%d,lineMode=%d,fmt_422to444=%d,PC_mode_check=%d,game=%d,Sram=%d,\n",
		front_porch_num, Scaler_DispGetInputInfo(SLR_INPUT_V_LEN), Scaler_DispGetInputInfo(SLR_INPUT_IPV_ACT_LEN_PRE), Scaler_DispGetInputInfo(SLR_INPUT_IPV_ACT_STA),
		I_width, I_height, linemode_limit, fmt_422to444, PC_mode_check, game_mode_check_flag, Scaler_Get_DI_SNR_Borrow_Sram_Mode());
...
void drvif_color_DRV_IESM_Additional_setting(DRV_IESM_Additional_setting *ptr)
{
	...
	iedge_smooth_dejagging_ctrl0.i_dejag_corner99= ptr->i_dejag_corner99;
...
void drvif_color_DRV_s_IESM_Additional_setting(DRV_IESM_Additional_setting *ptr)
{
	// Merlin3 change
	iedge_smooth_sub_ich2_dejagging_ctrl0_RBUS iedge_smooth_dejagging_ctrl0;
	iedge_smooth_sub_ich2_dejagging_motion_support_RBUS iedge_smooth_dejagging_motion_support;
	iedge_smooth_sub_ich2_dejagging_smallword0_RBUS iedge_smooth_dejagging_smallword0;
	iedge_smooth_sub_ich2_dejagging_smallword1_RBUS iedge_smooth_dejagging_smallword1;

	iedge_smooth_dejagging_ctrl0.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_dejagging_ctrl0_reg);
	iedge_smooth_dejagging_motion_support.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_dejagging_motion_support_reg);
	iedge_smooth_dejagging_smallword0.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_dejagging_smallword0_reg);
	iedge_smooth_dejagging_smallword1.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_dejagging_smallword1_reg);
	iedge_smooth_dejagging_ctrl0.i_dejag_skip_hlh = ptr->IESM_skip_hlh;
	iedge_smooth_dejagging_ctrl0.i_dejag_level= ptr->IESM_level;
	// removed iedge_smooth_dejagging_ctrl0.i_dejag_smallword_weak= ptr->IESM_smallword_weak;
	// removed iedge_smooth_dejagging_motion_support.i_dejag_delta_weak= ptr->IESM_delta_weak;
	...
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_dejagging_ctrl0_reg, iedge_smooth_dejagging_ctrl0.regValue);
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_dejagging_motion_support_reg, iedge_smooth_dejagging_motion_support.regValue);
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_dejagging_smallword0_reg, iedge_smooth_dejagging_smallword0.regValue);
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_dejagging_smallword1_reg, iedge_smooth_dejagging_smallword1.regValue);
}
...
void drvif_color_Set_DRV_SNR_Clock(SCALER_DISP_CHANNEL display, unsigned char En_flag)
{
	UINT32 mask = (display == SLR_MAIN_DISPLAY) ?
				...
				VGIP_Data_Path_Select_2_s2_clk_en_mask;
	...
	{
		if (En_flag)
			IoReg_SetBits(VGIP_Data_Path_Select_2_reg, mask);
		else
			IoReg_ClearBits(VGIP_Data_Path_Select_2_reg, mask);
	}
}
...
unsigned char drvif_color_Get_DRV_SNR_Clock(SCALER_DISP_CHANNEL display, unsigned char En_flag)
{
	if (SLR_SUB_DISPLAY == display)
		return VGIP_Data_Path_Select_2_get_s2_clk_en(IoReg_Read32(VGIP_Data_Path_Select_2_reg));
	else
...
/*================================== sub driver ==============================*/
void drvif_color_DRV_sub_SNR_General_ctrl(DRV_SNR_General_ctrl *ptr)
{
	nr_sub_dch2_cp_ctrl_RBUS cp_ctrl_reg;
	//nr_sub_dch2_local_var2_RBUS sub_dch2_Local_Var2_Reg;
	nr_sub_dch2_mosquito_ctrl_RBUS nr_mosquito_ctrl_RBUS_reg;
	iedge_smooth_sub_ich2_prelpf_ctrl_RBUS prelpf_ctrl_reg;

	cp_ctrl_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CP_Ctrl_reg);
	//Local_Var2_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_Local_Var2_reg);
	nr_mosquito_ctrl_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_MOSQUITO_CTRL_reg);
	prelpf_ctrl_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_prelpf_ctrl_reg);

	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_en_mask); /* DB Enable */

	/*SNR*/
	cp_ctrl_reg.cp_spatialenabley = ptr->SNR_spatialenabley;
	cp_ctrl_reg.cp_spatialenablec =  ptr->SNR_spatialenablec;
	//cp_ctrl_reg.cp_impulseenable = ptr->SNR_impulseenable;
	//Local_Var2_Reg.cp_en_yedgeforc = ptr->SNR_en_yedgeforc;
	/*nr_mosquito_ctrl_RBUS_reg.mosquito_detect_en = ptr->SNR_mosquito_detect_en;*/	/* the spec is MosquitoNR Enable is controlled by MPEG NR UI */
	prelpf_ctrl_reg.prelpf_snr_sel = ptr->SNR_prelpf_snr_sel;
	cp_ctrl_reg.cp_sresultweight = ptr->SNR_sresultweight;
	//cp_ctrl_reg.vc_nr_maxmin_range_sel = ptr->SNR_maxmin_range; /*Merlin2*/

	IoReg_Write32(NR_SUB_DCH2_CP_Ctrl_reg, cp_ctrl_reg.regValue);
	//IoReg_Write32(NR_SUB_DCH2_Local_Var2_reg, Local_Var2_Reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MOSQUITO_CTRL_reg, nr_mosquito_ctrl_RBUS_reg.regValue);
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_prelpf_ctrl_reg, prelpf_ctrl_reg.regValue);
	...
	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_apply_mask); /* DB apply */

}

void drvif_color_DRV_sub_SNR_Spatial_NR_Y(DRV_SNR_Spatial_NR_Y *ptr)
{
	nr_sub_dch2_cp_ctrl_RBUS cp_ctrl_reg;
	nr_sub_dch2_spatial_thl_RBUS spatial_thl_reg;
	nr_sub_dch2_spatial_thl2_RBUS spatial_thl2_reg;
	nr_sub_dch2_spatial_weight_RBUS Spatial_Weight_Reg;
	//nr_sub_dch2_local_var2_RBUS Local_Var2_Reg;
	cp_ctrl_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CP_Ctrl_reg);
	spatial_thl_reg.regValue = IoReg_Read32(NR_SUB_DCH2_Spatial_Thl_reg);
	spatial_thl2_reg.regValue = IoReg_Read32(NR_SUB_DCH2_Spatial_Thl2_reg);
	Spatial_Weight_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_Spatial_Weight_reg);
	//Local_Var2_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_Local_Var2_reg);
	/*SNR Blending*/
	Spatial_Weight_Reg.cp_fixedweight1y = ptr->SNR_fixedweight1y;
	Spatial_Weight_Reg.cp_fixedweight2y = ptr->SNR_fixedweight2y;
	Spatial_Weight_Reg.cp_weight1y = ptr->SNR_weight1y;
	Spatial_Weight_Reg.cp_weight2y = ptr->SNR_weight2y;
	/* 3*9 LPF*/
	//cp_ctrl_reg.cp_zoranfiltersizey = ptr->SNR_zoranfiltersizey;
	//cp_ctrl_reg.cp_zoranweight2y = ptr->SNR_zoranweight2y;
	//cp_ctrl_reg.cp_zoranweight3y = ptr->SNR_zoranweight3y;
	//cp_ctrl_reg.cp_zoranweight4y = ptr->SNR_zoranweight4y;
	cp_ctrl_reg.cp_zoranweighty_sel = ptr->SNR_zoranweighty_sel;// Merlin4 add
	spatial_thl_reg.cp_spatialthly = ptr->SNR_spatialthly;
	spatial_thl_reg.cp_spatialthlyx2 = ptr->SNR_spatialthlyx2;
	spatial_thl2_reg.cp_spatialthlyx4 = ptr->SNR_spatialthlyx4;
	/*Sw Edge Control*/// Merlin4 remove
	//Local_Var2_Reg.cp_edge_weight = ptr->SNR_edge_weight;
	//Local_Var2_Reg.cp_en_sw_edge_thl = ptr->SNR_en_sw_edge_thl;
	//Local_Var2_Reg.cp_sw_edge_thl = ptr->SNR_sw_edge_thl;

	IoReg_SetBits(NR_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_en_mask); //DB en

	IoReg_Write32(NR_SUB_DCH2_CP_Ctrl_reg, cp_ctrl_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_Spatial_Thl_reg, spatial_thl_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_Spatial_Thl2_reg, spatial_thl2_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_Spatial_Weight_reg, Spatial_Weight_Reg.regValue);// Merlin4 remove
	//IoReg_Write32(NR_SUB_DCH2_Local_Var2_reg, Local_Var2_Reg.regValue);
...
void drvif_color_DRV_sub_SNR_Spatial_NR_C(DRV_SNR_Spatial_NR_C *ptr)
{
	nr_sub_dch2_cp_ctrl_RBUS cp_ctrl_reg;
	nr_sub_dch2_spatial_thl_RBUS spatial_thl_reg;
	nr_sub_dch2_spatial_thl2_RBUS spatial_thl2_reg;
	...
	Spatial_Weight_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_Spatial_Weight_reg);
	/*SNR C*/
	Spatial_Weight_Reg.cp_lpresultweightc = ptr->SNR_lpresultweightc;
	// Merlin4 remove
	//cp_ctrl_reg.cp_zoranfiltersizec = ptr->SNR_zoranfiltersizec;
	//cp_ctrl_reg.cp_zoranweight2c = ptr->SNR_zoranweight2c;
	//cp_ctrl_reg.cp_zoranweight3c = ptr->SNR_zoranweight3c;
	//cp_ctrl_reg.cp_zoranweight4c = ptr->SNR_zoranweight4c;
	cp_ctrl_reg.cp_zoranweightc_sel = ptr->SNR_zoranweightc_sel;// Merlin4 add
	spatial_thl_reg.cp_spatialthlc = ptr->SNR_spatialthlc;
	spatial_thl_reg.cp_spatialthlcx2 = ptr->SNR_spatialthlcx2;
	spatial_thl2_reg.cp_spatialthlcx4 = ptr->SNR_spatialthlcx4;

	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_en_mask); //DB en

	IoReg_Write32(NR_SUB_DCH2_CP_Ctrl_reg, cp_ctrl_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_Spatial_Thl_reg, spatial_thl_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_Spatial_Thl2_reg, spatial_thl2_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_Spatial_Weight_reg, Spatial_Weight_Reg.regValue);

	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_apply_mask); /* DB apply */

}

void drvif_color_DRV_sub_SNR_Modified_LPF(DRV_SNR_Modified_LPF *ptr)
{
	nr_sub_dch2_cp_ctrl_RBUS cp_ctrl_reg;
	nr_new_lpf_nearby_ctrl_RBUS new_lpf_nearby_ctrl_reg;
	nr_mosquito_ctrl_RBUS nr_mosquito_ctrl_RBUS_reg;
	//nr_edge_filter_RBUS nr_edge_filter_reg; /*Merlin2*/
	cp_ctrl_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CP_Ctrl_reg);
	new_lpf_nearby_ctrl_reg.regValue = IoReg_Read32(NR_SUB_DCH2_NEW_LPF_NEARBY_CTRL_reg);
	nr_mosquito_ctrl_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_MOSQUITO_CTRL_reg);
	//nr_edge_filter_reg.regValue = IoReg_Read32(NR_EDGE_FILTER_reg);  /*Merlin2*/

	/*modified lpf*/
	cp_ctrl_reg.vc_snr_lpf_sel = ptr->SNR_LPF_sel; //mac6:0:3, 1:5, 2:mod3, 3:mod5 // 0:3, 1:5, 2:mod3, 3:mod5, 4:11, 5:mod11 (Merlin, jyyang@20150615)(Merlin2, jyyang@20160617)
	new_lpf_nearby_ctrl_reg.modified_lpf_edge_gain	= ptr->SNR_modified_lpf_edge_gain; /*Mac3, leonard wu@20140722*/
	new_lpf_nearby_ctrl_reg.modified_lpf_thd_upbnd	= ptr->SNR_modified_lpf_thd_upbnd;
	new_lpf_nearby_ctrl_reg.modified_lpf_thd_lowbnd = ptr->SNR_modified_lpf_thd_lowbnd;
	new_lpf_nearby_ctrl_reg.modified_lpf_thd_step 	= ptr->SNR_modified_lpf_thd_step;
	...
	IoReg_Write32(NR_SUB_DCH2_CP_Ctrl_reg, cp_ctrl_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_NEW_LPF_NEARBY_CTRL_reg, new_lpf_nearby_ctrl_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MOSQUITO_CTRL_reg, nr_mosquito_ctrl_RBUS_reg.regValue);
	//IoReg_Write32(NR_EDGE_FILTER_reg, nr_edge_filter_reg.regValue);  /*Merlin2*/
}

void drvif_color_DRV_sub_SNR_Curve_Mapping_Mode(DRV_SNR_Curve_Mapping_Mode *ptr)
{
	nr_sub_dch2_curve_mapping_ctrl_RBUS curve_mapping_ctrl_reg;
	nr_sub_dch2_curve_mapping_step_0_RBUS curve_mapping_step_0_reg;
	nr_sub_dch2_curve_mapping_step_1_RBUS curve_mapping_step_1_reg;
	nr_sub_dch2_curve_mapping_step_2_RBUS curve_mapping_step_2_reg;
	nr_sub_dch2_curve_mapping_step_3_RBUS curve_mapping_step_3_reg;
	nr_sub_dch2_curve_mapping_w1_1_RBUS curve_mapping_w1_1_reg;
	nr_sub_dch2_curve_mapping_w1_2_RBUS curve_mapping_w1_2_reg;
	nr_sub_dch2_curve_mapping_w1_3_RBUS curve_mapping_w1_3_reg;
	nr_sub_dch2_curve_mapping_w2_1_RBUS curve_mapping_w2_1_reg;
	nr_sub_dch2_curve_mapping_w2_2_RBUS curve_mapping_w2_2_reg;
	nr_sub_dch2_curve_mapping_w2_3_RBUS curve_mapping_w2_3_reg;
	curve_mapping_ctrl_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_CTRL_reg);
	curve_mapping_step_0_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_STEP_0_reg);
	curve_mapping_step_1_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_STEP_1_reg);
	curve_mapping_step_2_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_STEP_2_reg);
	curve_mapping_step_3_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_STEP_3_reg);
	curve_mapping_w1_1_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_W1_1_reg);
	curve_mapping_w1_2_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_W1_2_reg);
	curve_mapping_w1_3_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_W1_3_reg);
	curve_mapping_w2_1_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_W2_1_reg);
	curve_mapping_w2_2_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_W2_2_reg);
	curve_mapping_w2_3_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CURVE_MAPPING_W2_3_reg);
	/*Curve Mapping Mode_Global Control*/
	curve_mapping_ctrl_reg.curvemappingmode_en = ptr->SNR_curvemappingmode_en;
	/*Curve Mapping Mode_step*/
	curve_mapping_step_0_reg.curvemapping_step1 =  ptr->SNR_curvemapping_step1;
	...
	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_en_mask); //DB en
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_CTRL_reg, curve_mapping_ctrl_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_STEP_0_reg, curve_mapping_step_0_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_STEP_1_reg, curve_mapping_step_1_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_STEP_2_reg, curve_mapping_step_2_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_STEP_3_reg, curve_mapping_step_3_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_W1_1_reg, curve_mapping_w1_1_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_W1_2_reg, curve_mapping_w1_2_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_W1_3_reg, curve_mapping_w1_3_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_W2_1_reg, curve_mapping_w2_1_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_W2_2_reg, curve_mapping_w2_2_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_CURVE_MAPPING_W2_3_reg, curve_mapping_w2_3_reg.regValue);
	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_apply_mask); //DB apply
}

void drvif_color_DRV_sub_SNR_NR_Mask(DRV_SNR_NR_Mask *ptr)
{
	nr_sub_dch2_mask1_ctrl1_RBUS MASK1_CTRL1_Reg;
	nr_sub_dch2_mask1_ctrl2_RBUS MASK1_CTRL2_Reg;
	nr_sub_dch2_mask2_ctrl1_RBUS MASK2_CTRL1_Reg;
	nr_sub_dch2_mask2_ctrl2_RBUS MASK2_CTRL2_Reg;
	nr_sub_dch2_mask3_ctrl1_RBUS MASK3_CTRL1_Reg;
	nr_sub_dch2_mask3_ctrl2_RBUS MASK3_CTRL2_Reg;
	MASK1_CTRL1_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_MASK1_CTRL1_reg);
	MASK1_CTRL2_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_MASK1_CTRL2_reg);
	MASK2_CTRL1_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_MASK2_CTRL1_reg);
	MASK2_CTRL2_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_MASK2_CTRL2_reg);
	MASK3_CTRL1_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_MASK3_CTRL1_reg);
	MASK3_CTRL2_Reg.regValue = IoReg_Read32(NR_SUB_DCH2_MASK3_CTRL2_reg);
	MASK1_CTRL2_Reg.cp_mask1_en = ptr->SNR_Mask1_En;
	MASK1_CTRL2_Reg.cp_mask1_dir = ptr->SNR_Mask1_Dir;
	MASK1_CTRL1_Reg.cp_mask1_ygain = ptr->SNR_Mask1_Y_Gain;
	MASK1_CTRL1_Reg.cp_mask1_cbgain = ptr->SNR_Mask1_Cb_Gain;
	MASK1_CTRL1_Reg.cp_mask1_crgain = ptr->SNR_Mask1_Cr_Gain;
	MASK1_CTRL2_Reg.cp_mask1_mapstep = ptr->SNR_Mask1_Step;
	MASK1_CTRL2_Reg.cp_mask1_mapthre = ptr->SNR_Mask1_Thd;
	MASK1_CTRL2_Reg.cp_mask1_maplimit = (ptr->SNR_Mask1_Limit-1);
	MASK1_CTRL1_Reg.cp_mask1_yref = ptr->SNR_Mask1_Y_Ref;
	MASK1_CTRL1_Reg.cp_mask1_cbref = ptr->SNR_Mask1_Cb_Ref;
	MASK1_CTRL1_Reg.cp_mask1_crref = ptr->SNR_Mask1_Cr_Ref;
	MASK2_CTRL2_Reg.cp_mask2_en = ptr->SNR_Mask2_En;
	MASK2_CTRL2_Reg.cp_mask2_dir = ptr->SNR_Mask2_Dir;
	MASK2_CTRL1_Reg.cp_mask2_ygain = ptr->SNR_Mask2_Y_Gain;
	MASK2_CTRL1_Reg.cp_mask2_cbgain = ptr->SNR_Mask2_Cb_Gain;
	MASK2_CTRL1_Reg.cp_mask2_crgain = ptr->SNR_Mask2_Cr_Gain;
	MASK2_CTRL2_Reg.cp_mask2_mapstep = ptr->SNR_Mask2_Step;
	MASK2_CTRL2_Reg.cp_mask2_mapthre = ptr->SNR_Mask2_Thd;
	MASK2_CTRL2_Reg.cp_mask2_maplimit = (ptr->SNR_Mask2_Limit-1);
	MASK2_CTRL1_Reg.cp_mask2_yref = ptr->SNR_Mask2_Y_Ref;
	MASK2_CTRL1_Reg.cp_mask2_cbref = ptr->SNR_Mask2_Cb_Ref;
	MASK2_CTRL1_Reg.cp_mask2_crref = ptr->SNR_Mask2_Cr_Ref;
	MASK3_CTRL2_Reg.cp_mask3_en = ptr->SNR_Mask3_En;
	MASK3_CTRL2_Reg.cp_mask3_dir = ptr->SNR_Mask3_Dir;
	MASK3_CTRL1_Reg.cp_mask3_ygain = ptr->SNR_Mask3_Y_Gain;
	MASK3_CTRL1_Reg.cp_mask3_cbgain = ptr->SNR_Mask3_Cb_Gain;
	MASK3_CTRL1_Reg.cp_mask3_crgain = ptr->SNR_Mask3_Cr_Gain;
	MASK3_CTRL2_Reg.cp_mask3_mapstep = ptr->SNR_Mask3_Step;
	MASK3_CTRL2_Reg.cp_mask3_mapthre = ptr->SNR_Mask3_Thd;
	MASK3_CTRL2_Reg.cp_mask3_maplimit = (ptr->SNR_Mask3_Limit-1);
	MASK3_CTRL1_Reg.cp_mask3_yref = ptr->SNR_Mask3_Y_Ref;
	MASK3_CTRL1_Reg.cp_mask3_cbref = ptr->SNR_Mask3_Cb_Ref;
	MASK3_CTRL1_Reg.cp_mask3_crref = ptr->SNR_Mask3_Cr_Ref;
	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_en_mask); //DB en
	IoReg_Write32(NR_SUB_DCH2_MASK1_CTRL1_reg, MASK1_CTRL1_Reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MASK1_CTRL2_reg, MASK1_CTRL2_Reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MASK2_CTRL1_reg, MASK2_CTRL1_Reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MASK2_CTRL2_reg, MASK2_CTRL2_Reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MASK3_CTRL1_reg, MASK3_CTRL1_Reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MASK3_CTRL2_reg, MASK3_CTRL2_Reg.regValue);
	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_apply_mask); //DB apply
}

void drvif_color_DRV_sub_SNR_NR_Mask_W1W2(DRV_SNR_NR_Mask_W1W2 *ptr)  /*Mac3, leonard wu@20140722*/
{
    nr_sub_dch2_mask_shift_ctrl1_RBUS   nr_mask_shift_ctrl1_reg;
    nr_sub_dch2_mask_shift_ctrl2_RBUS   nr_mask_shift_ctrl2_reg;
    nr_mask_shift_ctrl1_reg.regValue = IoReg_Read32(NR_SUB_DCH2_MASK_SHIFT_CTRL1_reg);
    nr_mask_shift_ctrl2_reg.regValue = IoReg_Read32(NR_SUB_DCH2_MASK_SHIFT_CTRL2_reg);

    nr_mask_shift_ctrl1_reg.nr_mask_shift_mode 	= ptr->SNR_mask_shift_mode;
    nr_mask_shift_ctrl1_reg.nr_mask1_filter_select = ptr->SNR_nrm1_filter_select;
    nr_mask_shift_ctrl1_reg.nr_mask1_w1_maplimit 	= ptr->SNR_nrm1_w1_limit;
    nr_mask_shift_ctrl1_reg.nr_mask1_w1_mapstep 	= ptr->SNR_nrm1_w1_step;
    nr_mask_shift_ctrl1_reg.nr_mask1_w2_maplimit 	= ptr->SNR_nrm1_w2_limit;
    nr_mask_shift_ctrl1_reg.nr_mask1_w2_mapstep 	= ptr->SNR_nrm1_w2_step;

    nr_mask_shift_ctrl1_reg.nr_mask2_filter_select = ptr->SNR_nrm2_filter_select;
    nr_mask_shift_ctrl1_reg.nr_mask2_w2_maplimit 	= ptr->SNR_nrm2_w2_limit;
    nr_mask_shift_ctrl1_reg.nr_mask2_w2_mapstep 	= ptr->SNR_nrm2_w2_step;
    nr_mask_shift_ctrl2_reg.nr_mask2_w1_maplimit 	= ptr->SNR_nrm2_w1_limit;
    nr_mask_shift_ctrl2_reg.nr_mask2_w1_mapstep 	= ptr->SNR_nrm2_w1_step;

    nr_mask_shift_ctrl2_reg.nr_mask3_filter_select = ptr->SNR_nrm3_filter_select;
    nr_mask_shift_ctrl2_reg.nr_mask3_w1_maplimit 	= ptr->SNR_nrm3_w1_limit;
    nr_mask_shift_ctrl2_reg.nr_mask3_w1_mapstep 	= ptr->SNR_nrm3_w1_step;
    nr_mask_shift_ctrl2_reg.nr_mask3_w2_maplimit 	= ptr->SNR_nrm3_w2_limit;
    nr_mask_shift_ctrl2_reg.nr_mask3_w2_mapstep 	= ptr->SNR_nrm3_w2_step;

    IoReg_Write32(NR_SUB_DCH2_MASK_SHIFT_CTRL1_reg, nr_mask_shift_ctrl1_reg.regValue);
    IoReg_Write32(NR_SUB_DCH2_MASK_SHIFT_CTRL2_reg, nr_mask_shift_ctrl2_reg.regValue);
}
void drvif_color_DRV_sub_SNR_Veritcal_NR(DRV_SNR_Veritcal_NR *ptr)
{
	iedge_smooth_sub_ich2_vfilter_0_RBUS vfilter_0_reg;
	iedge_smooth_sub_ich2_vfilter_1_RBUS vfilter_1_reg;
	iedge_smooth_sub_ich2_vfilter_2_RBUS vfilter_2_reg;
	iedge_smooth_sub_ich2_vfilter_3_RBUS vfilter_3_reg;
#if 0 //merlin2
	iedge_smooth_vfilter_4_RBUS vfilter_4_reg;
	iedge_smooth_vfilter_5_RBUS vfilter_5_reg;
	iedge_smooth_vfilter_6_RBUS vfilter_6_reg;
	...
	vfilter_0_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_0_reg);
	vfilter_1_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_1_reg);
	vfilter_2_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_2_reg);
	vfilter_3_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_3_reg);
#if 0 //merlin2
	vfilter_4_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_VFILTER_4_reg);
	vfilter_5_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_VFILTER_5_reg);
	vfilter_6_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_VFILTER_6_reg);
	...
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_0_reg, vfilter_0_reg.regValue);
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_1_reg, vfilter_1_reg.regValue);
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_2_reg, vfilter_2_reg.regValue);
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_3_reg, vfilter_3_reg.regValue);
...
void drvif_color_DRV_sub_SNR_Mosquito_NR(DRV_SNR_Mosquito_NR *ptr)
{
	nr_sub_dch2_mosquito_ctrl_RBUS nr_mosquito_ctrl_RBUS_reg;
	nr_sub_dch2_mosquito_nr_level_ctrl_RBUS nr_mosquito_nr_level_ctrl_RBUS_reg;
	nr_sub_dch2_mosquito_nr_level_ctrl_1_RBUS nr_mosquito_nr_level_ctrl_1_RBUS_reg;
	nr_sub_dch2_mosquito_nr_keep_edge_ctrl_RBUS 	nr_mosquito_nr_keep_edge_ctrl_reg;
	nr_sub_dch2_mosquito_nr_decay_ctrl_1_RBUS   	nr_mosquito_nr_decay_ctrl_1_reg;

	nr_mosquito_ctrl_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_MOSQUITO_CTRL_reg);
	nr_mosquito_nr_level_ctrl_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_MOSQUITO_NR_LEVEL_CTRL_reg);
	nr_mosquito_nr_level_ctrl_1_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_MOSQUITO_NR_LEVEL_CTRL_1_reg);
	nr_mosquito_nr_keep_edge_ctrl_reg.regValue 		= IoReg_Read32(NR_SUB_DCH2_MOSQUITO_NR_KEEP_EDGE_CTRL_reg);
	nr_mosquito_nr_decay_ctrl_1_reg.regValue		= IoReg_Read32(NR_SUB_DCH2_MOSQUITO_NR_DECAY_CTRL_1_reg);
	/*Mosquito_NR_MNR Global Control*/
	...
	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_en_mask); //DB en
	IoReg_Write32(NR_SUB_DCH2_MOSQUITO_CTRL_reg, nr_mosquito_ctrl_RBUS_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MOSQUITO_NR_LEVEL_CTRL_reg, nr_mosquito_nr_level_ctrl_RBUS_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MOSQUITO_NR_LEVEL_CTRL_1_reg, nr_mosquito_nr_level_ctrl_1_RBUS_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MOSQUITO_NR_KEEP_EDGE_CTRL_reg, nr_mosquito_nr_keep_edge_ctrl_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_MOSQUITO_NR_DECAY_CTRL_1_reg, nr_mosquito_nr_decay_ctrl_1_reg.regValue);
	IoReg_SetBits(NR_SUB_DCH2_SNR_DB_CTRL_reg, NR_SUB_DCH2_SNR_DB_CTRL_snr_db_apply_mask); //DB apply
}

void drvif_color_DRV_sub_SNR_Mosquito_NR_En(unsigned char En_flag)	/* Mosquito NR control is in general control*/
{
	nr_sub_dch2_mosquito_ctrl_RBUS nr_mosquito_ctrl_RBUS_reg;
	nr_mosquito_ctrl_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_MOSQUITO_CTRL_reg);
...
void drvif_color_DRV_sub_SNR_Weight_Adjust(DRV_SNR_WeightAdjust *ptr) /*mag2*/
{
	/*SNR weight adjust shift*/
	{
	nr_sub_dch2_cp_ctrl_RBUS sub_dch2_cp_ctrl_reg;

	sub_dch2_cp_ctrl_reg.regValue = IoReg_Read32(NR_SUB_DCH2_CP_Ctrl_reg);

	sub_dch2_cp_ctrl_reg.sresultweight_adjust_shift = ptr->SNR_sresultWeight_adjust_shift; /*mag2*/

	IoReg_Write32(NR_SUB_DCH2_CP_Ctrl_reg, sub_dch2_cp_ctrl_reg.regValue);
	}

	/* type detection*/
	{
	nr_sub_dch2_type_detect_ctrl0_RBUS nr_type_detect_ctrl0_RBUS_reg;
	nr_sub_dch2_type_detect_ctrl1_RBUS nr_type_detect_ctrl1_RBUS_reg;

	nr_type_detect_ctrl0_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_TYPE_DETECT_CTRL0_reg);
	nr_type_detect_ctrl1_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_TYPE_DETECT_CTRL1_reg);
	...
	IoReg_Write32(NR_SUB_DCH2_TYPE_DETECT_CTRL0_reg, nr_type_detect_ctrl0_RBUS_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_TYPE_DETECT_CTRL1_reg, nr_type_detect_ctrl1_RBUS_reg.regValue);
	}

	/*line keep*/
	{
	nr_sub_dch2_line_keep_ctrl0_RBUS nr_line_keep_ctrl0_RBUS_reg;
	nr_sub_dch2_line_keep_ctrl1_RBUS	nr_line_keep_ctrl1_RBUS_reg;

	nr_line_keep_ctrl0_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_LINE_KEEP_CTRL0_reg);
	nr_line_keep_ctrl1_RBUS_reg.regValue = IoReg_Read32(NR_SUB_DCH2_LINE_KEEP_CTRL1_reg);
	...
	IoReg_Write32(NR_SUB_DCH2_LINE_KEEP_CTRL0_reg, nr_line_keep_ctrl0_RBUS_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_LINE_KEEP_CTRL1_reg, nr_line_keep_ctrl1_RBUS_reg.regValue);
	}
}

void drvif_color_DRV_sub_SNR_UVEdge(DRV_SNR_UVEdge *ptr) /*Merlin jyyang 20150615*/
{
	nr_sub_dch2_uv_modified_mosquito_edge_ctrl0_RBUS nr_uv_modified_mosquito_edge_ctrl0_reg;
	nr_sub_dch2_uv_modified_mosquito_edge_ctrl1_RBUS nr_uv_modified_mosquito_edge_ctrl1_reg;

	nr_uv_modified_mosquito_edge_ctrl0_reg.regValue = IoReg_Read32(NR_SUB_DCH2_UV_MODIFIED_MOSQUITO_EDGE_CTRL0_reg);
	nr_uv_modified_mosquito_edge_ctrl1_reg.regValue = IoReg_Read32(NR_SUB_DCH2_UV_MODIFIED_MOSQUITO_EDGE_CTRL1_reg);
	...
	IoReg_Write32(NR_SUB_DCH2_UV_MODIFIED_MOSQUITO_EDGE_CTRL0_reg, nr_uv_modified_mosquito_edge_ctrl0_reg.regValue);
	IoReg_Write32(NR_SUB_DCH2_UV_MODIFIED_MOSQUITO_EDGE_CTRL1_reg, nr_uv_modified_mosquito_edge_ctrl1_reg.regValue);
}

void drvif_color_Set_sub_I_De_Contour_DB_En( bool DB_En )
{
	ipq_decontour_sub_sub_de_contour_db_reg_ctl_RBUS ipq_decontour_de_contour_db_reg_ctl_reg;

	ipq_decontour_de_contour_db_reg_ctl_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_db_reg_ctl_reg);
	ipq_decontour_de_contour_db_reg_ctl_reg.db_en = DB_En;
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_db_reg_ctl_reg, ipq_decontour_de_contour_db_reg_ctl_reg.regValue);

}

void drvif_color_Set_sub_I_De_Contour_DB_Apply(void)
{
	ipq_decontour_sub_sub_de_contour_db_reg_ctl_RBUS ipq_decontour_de_contour_db_reg_ctl_reg;
...
unsigned char  drvif_color_Set_sub_I_De_Contour(VIP_I_De_Contour_TBL *ptr)
{
	ipq_decontour_sub_sub_de_contour_ctrl_RBUS ipq_decontour_de_contour_ctrl_reg;
	ipq_decontour_sub_sub_de_contour_contrast_RBUS ipq_decontour_de_contour_contrast_reg;
	ipq_decontour_sub_sub_de_contour_neighbor_diff_RBUS ipq_decontour_de_contour_neighbor_diff_reg;
	ipq_decontour_sub_sub_de_contour_threshold_RBUS ipq_decontour_de_contour_threshold_reg;
	ipq_decontour_sub_sub_de_contour_diff_th_RBUS ipq_decontour_de_contour_diff_th_reg;
	ipq_decontour_sub_sub_de_contour_bottleneck_RBUS ipq_decontour_de_contour_bottleneck_reg;
	ipq_decontour_sub_sub_de_contour_diff_clamp_RBUS ipq_decontour_de_contour_diff_clamp_reg;
	ipq_decontour_sub_sub_de_contour_contrast_y_RBUS ipq_decontour_de_contour_contrast_y_reg;
	ipq_decontour_sub_sub_de_contour_contrast_c_RBUS ipq_decontour_de_contour_contrast_c_reg;
	ipq_decontour_sub_sub_de_contour_contrast2_RBUS ipq_decontour_de_contour_contrast2_reg;
	ipq_decontour_sub_sub_de_contour_contrast3_RBUS ipq_decontour_de_contour_contrast3_reg;
	ipq_decontour_sub_sub_de_contour_dark_RBUS ipq_decontour_de_contour_dark_reg;
	ipq_decontour_sub_sub_de_contour_gradation_RBUS ipq_decontour_de_contour_gradation_reg;
	ipq_decontour_sub_sub_de_contour_minmax_RBUS ipq_decontour_de_contour_minmax_reg;
	ipq_decontour_sub_sub_de_contour_level_RBUS ipq_decontour_de_contour_level_reg;

	ipq_decontour_de_contour_ctrl_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_CTRL_reg);
	ipq_decontour_de_contour_contrast_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast_reg);
	ipq_decontour_de_contour_neighbor_diff_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Neighbor_Diff_reg);
	ipq_decontour_de_contour_threshold_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Threshold_reg);
	ipq_decontour_de_contour_diff_th_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Diff_th_reg);
	ipq_decontour_de_contour_bottleneck_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Bottleneck_reg);
	ipq_decontour_de_contour_diff_clamp_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Diff_Clamp_reg);
	ipq_decontour_de_contour_contrast_y_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast_Y_reg);
	ipq_decontour_de_contour_contrast_c_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast_C_reg);
	ipq_decontour_de_contour_contrast2_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast2_reg);
	ipq_decontour_de_contour_contrast3_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast3_reg);
	ipq_decontour_de_contour_dark_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Dark_reg);
	ipq_decontour_de_contour_gradation_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Gradation_reg);
	ipq_decontour_de_contour_minmax_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Minmax_reg);
	ipq_decontour_de_contour_level_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Level_reg);
	...
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_CTRL_reg, ipq_decontour_de_contour_ctrl_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast_reg, ipq_decontour_de_contour_contrast_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Neighbor_Diff_reg, ipq_decontour_de_contour_neighbor_diff_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Threshold_reg, ipq_decontour_de_contour_threshold_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Diff_th_reg, ipq_decontour_de_contour_diff_th_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Bottleneck_reg, ipq_decontour_de_contour_bottleneck_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Diff_Clamp_reg, ipq_decontour_de_contour_diff_clamp_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast_Y_reg, ipq_decontour_de_contour_contrast_y_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast_C_reg, ipq_decontour_de_contour_contrast_c_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast2_reg, ipq_decontour_de_contour_contrast2_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Contrast3_reg, ipq_decontour_de_contour_contrast3_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Dark_reg, ipq_decontour_de_contour_dark_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Gradation_reg, ipq_decontour_de_contour_gradation_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Minmax_reg, ipq_decontour_de_contour_minmax_reg.regValue);
	IoReg_Write32(IPQ_DECONTOUR_SUB_Sub_De_Contour_Level_reg, ipq_decontour_de_contour_level_reg.regValue);
...
void drvif_color_sub_iEdgeSmooth_init(void)
{
// Merlin3 no old edgesmooth
	_system_setting_info *VIP_system_info_structure_table = (_system_setting_info*)Scaler_GetShareMemVirAddr(SCALERIOC_VIP_system_info_structure);
	UINT8  source = 255;
	iedge_smooth_sub_ich2_edgesmooth_ex_ctrl_RBUS edgesmooth_ex_ctrl_reg;
	iedge_smooth_sub_ich2_mixer_ctrl_RBUS mixer_ctrl_reg;
	iedge_smooth_sub_ich2_vfilter_0_RBUS vfilter_0_reg;

	source = fwif_vip_source_check(SLR_SUB_DISPLAY, 1);

	edgesmooth_ex_ctrl_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_EdgeSmooth_EX_CTRL_reg);
	mixer_ctrl_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_MIXer_ctrl_reg);
	vfilter_0_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_0_reg);
	...
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_EdgeSmooth_EX_CTRL_reg, edgesmooth_ex_ctrl_reg.regValue);
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_MIXer_ctrl_reg, mixer_ctrl_reg.regValue);
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_VFILTER_0_reg, vfilter_0_reg.regValue);
}

void drvif_sub_IESM_format_convert(void)
{

	iedge_smooth_sub_ich2_format_convert_RBUS edsm_format_convert_reg;

	edsm_format_convert_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_FORMAT_CONVERT_reg);

	// mac6p: i&p mode after rtnr/di is yuv444
	// sub no di // mac9q TBD
	if((Scaler_DispGetStatus(SLR_SUB_DISPLAY, SLR_DISP_422CAP) == FALSE) && ((Get_DisplayMode_Src(SLR_SUB_DISPLAY) == VSC_INPUTSRC_HDMI)||(Get_DisplayMode_Src(SLR_SUB_DISPLAY) == VSC_INPUTSRC_DP)))// spnr cbypass mode
	{
		edsm_format_convert_reg.sub_444_to_422_en = 0;
		edsm_format_convert_reg.sub_422_to_444_en = 0;
		edsm_format_convert_reg.sub_444_to_422_type = 0;
		edsm_format_convert_reg.sub_422_to_444_type = 0;
	}
	else
	{
		edsm_format_convert_reg.sub_444_to_422_en = 1;
	...
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_FORMAT_CONVERT_reg, edsm_format_convert_reg.regValue);

	IoReg_SetBits(IEDGE_SMOOTH_SUB_ICH2_EDSM_DB_CTRL_reg, IEDGE_SMOOTH_SUB_ICH2_EDSM_DB_CTRL_edsm_db_apply_mask); /* DB apply */

	// mac9q TBD
	NRPprintf_Info("iesm_format:main(imode=%d, rtnr=%d, %d->%d, type:%d->%d)\n ",
		Scaler_DispGetStatus(SLR_SUB_DISPLAY, SLR_DISP_THRIP),
		Scaler_DispGetStatus(SLR_SUB_DISPLAY, SLR_DISP_RTNR),
		edsm_format_convert_reg.sub_444_to_422_en, edsm_format_convert_reg.sub_422_to_444_en,
		edsm_format_convert_reg.sub_444_to_422_type, edsm_format_convert_reg.sub_422_to_444_type);

}

void drvif_sub_IESM_frontporch_set(unsigned char game_mode_check_flag)
{
	UINT8 front_porch_num_th;
	int front_porch_num, linemode_limit, I_width, I_height;
	int fmt_422to444;
	iedge_smooth_sub_ich2_format_convert_RBUS edsm_format_convert_reg;
	iedge_smooth_sub_ich2_edsm_db_ctrl_RBUS edsm_db_ctrl_reg;
	iedge_smooth_sub_ich2_edgesmooth_ex_ctrl_RBUS edgesmooth_ex_ctrl_reg;
...
// mac9q TBD
	...
	edsm_format_convert_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_FORMAT_CONVERT_reg);// Merlin4 add
	fmt_422to444 = edsm_format_convert_reg.sub_422_to_444_en;
...
// mac9q TBD
	...
	edsm_db_ctrl_reg.regValue = IoReg_Read32(IEDGE_SMOOTH_SUB_ICH2_EDSM_DB_CTRL_reg);
	edsm_db_ctrl_reg.edsm_db_en = 1;
	edsm_db_ctrl_reg.edsm_db_rd_sel = 1;
	IoReg_Write32(IEDGE_SMOOTH_SUB_ICH2_EDSM_DB_CTRL_reg, edsm_db_ctrl_reg.regValue);
	...
	rtd_pr_vpq_info("SUB: front_porch_num=vlen-actlen-actsta: %d=%d-%d-%d, size=%d*%d,lineMode=%d,fmt_422to444=%d\n",
		front_porch_num, Scaler_DispGetInputInfo(SLR_INPUT_V_LEN), Scaler_DispGetInputInfo(SLR_INPUT_IPV_ACT_LEN_PRE), Scaler_DispGetInputInfo(SLR_INPUT_IPV_ACT_STA),
