...
{
	lc_lc_local_shpnr_diff_gain_RBUS lc_lc_local_shpnr_diff_gain_reg;
	lc_lc_global_ctrl1_RBUS blu_lc_global_ctrl1;
	
	lc_lc_local_shpnr_diff_gain_reg.regValue = IoReg_Read32(LC_LC_Local_Shpnr_diff_gain_reg);
	...
	IoReg_Write32(LC_LC_Local_Shpnr_diff_gain_reg, lc_lc_local_shpnr_diff_gain_reg.regValue);
