...
char drvif_DM2_HDR_histogram_Get_ISR(unsigned int *histogram_table24)
{
	...
	for (i = 0; i < HDR_Histogram_size; i = i + 4)
	{
		...
		if (timeoutcnt2 < 10)
		{
			...
			rtd_pr_vpq_info("HDR_histogram data lenth!t=%d,i=%d\n", timeoutcnt2, i);
...
void drvif_DM_B05_Set(unsigned short *lutMap)
{
	...
	unsigned short *lut;
	__attribute__((unused)) unsigned short *lutS1;
	__attribute__((unused)) unsigned short *lutS2;
	__attribute__((unused)) unsigned short *lutS3;
...
void drvif_DM_HDR_Wait_VO_porch(void)
{
	...
	__attribute__((unused)) unsigned int vo_vstart;
...
char drvif_Wait_VO_start(short delay0, short delay1, unsigned int timeout)
{
	...
	__attribute__((unused)) unsigned int vo_vend;
	//unsigned int time_str = rtd_inl(0xb801b6a8);
	//unsigned int time_end;
	unsigned int cnt = 0;
	vodma_vodma_v1sgen_RBUS vodma_v1sgen_RBUS_reg;
...
unsigned char drvif_color_set_HDR10_Enable(unsigned char* enable)
{
    ...
    #endif
    __attribute__((unused)) unsigned char bUpdateDolbyMode;
