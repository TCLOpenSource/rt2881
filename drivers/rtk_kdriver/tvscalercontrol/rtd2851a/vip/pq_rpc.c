...
FILM_FWMode DETECTION_scalerVIP_film_FWmode(void)
{
	...
	__attribute__((unused)) static unsigned char hw_film_Status32Detected1,hw_film_Status32Detected2,hw_film_Status22Detected;
	__attribute__((unused)) static unsigned char hw_film_StatusFilmDetected,hw_film_StatusMixedFilmDetected,hw_film_MixedFilmConfuse;
	static unsigned int hw_film_StatusFilmSequence;
	__attribute__((unused)) static unsigned char hw_film_VerScrollingText_en,hw_film_thumbnail_en;
	static unsigned int hw_film_32Film,hw_film_22Film;
	__attribute__((unused)) static unsigned char hw_film_Enable;
	...
	static unsigned int hw_FieldStaticSumThl,hw_FieldMotionSumThl __attribute__((unused));
	...
	__attribute__((unused)) static unsigned char Detected_Sub32H, Detected_Sub22H;
	__attribute__((unused)) static unsigned char Detected_Sub32V, Detected_Sub22V;
	...
	__attribute__((unused)) static unsigned int FrameDiff_H1,FrameDiff_H2,FrameDiff_H3,FrameDiff_V1,FrameDiff_V2,FrameDiff_V3,FrameDiff_C;
