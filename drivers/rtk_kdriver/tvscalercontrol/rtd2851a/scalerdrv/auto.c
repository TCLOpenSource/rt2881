...
//	adc_adc_dcrestore_ctrl_RBUS adc_adc_dcrestore_ctrl_reg;
	...
	__maybe_unused unsigned short Y_Target_Offset=0;
	__maybe_unused unsigned short U_Target_Offset=0;
	__maybe_unused unsigned short V_Target_Offset=0;
...
{
	__maybe_unused unsigned char phase_tmp,filter_sel;
	adc_smartfit_adc_auto_phase_ctrl0_RBUS smartfit_auto_phase_ctrl0_reg;
...
void smartfit_no_hs_mode(unsigned char display, int *hstart, int *hend, int *vstart, int *vend)
{
