...
unsigned char VPQ_DEMOD_REGION[FORMAT_MAX][4] = 
{
	// [0] : always on
	// [1] : manual mode enable
	// [2] : format
	// [3] : manual mode value
	{ 0, 1, 0, 0x8A	}, /*NTSC*/ // checked
	{ 0, 1, 1, 0x96	}, /*PALM*/ // checked
	{ 0, 0, 2, 0x82	}, /*NTSC50*/
	{ 0, 1, 3, 0x9b	}, /*PALN*/ // checked
	{ 0, 1, 4, 0x88	}, /*NTSC443*/ // checked
	{ 0, 1, 5, 0x87	}, /*PAL60*/ // checked
	{ 0, 1, 6, 0x90	}, /*PALI*/ // checked
	{ 0, 0, 7, 0x8a	}, /*SECAM*/
};
