...
void module_vpq_demodulation_region_table_write(unsigned char *table)
{
	...
	if( table[0] != 0 ) {
		...
		vdpq_auto_mode_ycsep_demod_region_reg.ycsep_demod_region_always_on = 1;
		vdcf_outl(VDPQ_AUTO_MODE_YCSEP_DEMOD_REGION_reg, vdpq_auto_mode_ycsep_demod_region_reg.regValue);
	} else if( table[1] != 0 ) {
		// use manual mode and set the region
		vdpq_auto_mode_ycsep_demod_region_reg.regValue = vdcf_inl(VDPQ_AUTO_MODE_YCSEP_DEMOD_REGION_reg);
		vdpq_auto_mode_ycsep_demod_region_reg.auto_pos_modify_en_ycsep = 1;
		vdpq_auto_mode_ycsep_demod_region_reg.auto_pos_mode_sel_ycsep = table[2];
		vdpq_auto_mode_ycsep_demod_region_reg.hactive_start_ycsep = table[3];
		vdcf_outl(VDPQ_AUTO_MODE_YCSEP_DEMOD_REGION_reg, vdpq_auto_mode_ycsep_demod_region_reg.regValue);

		vdpq_auto_mode_ycsep_demod_region_reg.regValue = vdcf_inl(VDPQ_AUTO_MODE_YCSEP_DEMOD_REGION_reg);
		vdpq_auto_mode_ycsep_demod_region_reg.auto_pos_modify_en_ycsep = 0;
		vdcf_outl(VDPQ_AUTO_MODE_YCSEP_DEMOD_REGION_reg, vdpq_auto_mode_ycsep_demod_region_reg.regValue);

		vdpq_auto_mode_ycsep_demod_region_reg.regValue = vdcf_inl(VDPQ_AUTO_MODE_YCSEP_DEMOD_REGION_reg);
		vdpq_auto_mode_ycsep_demod_region_reg.ycsep_demod_region_always_on = 0;	
		vdpq_auto_mode_ycsep_demod_region_reg.hactivestartreg_en_ycsep = 1;
		vdcf_outl(VDPQ_AUTO_MODE_YCSEP_DEMOD_REGION_reg, vdpq_auto_mode_ycsep_demod_region_reg.regValue);
	} else {
		// set auto mode
		vdpq_auto_mode_ycsep_demod_region_reg.regValue = vdcf_inl(VDPQ_AUTO_MODE_YCSEP_DEMOD_REGION_reg);
		vdpq_auto_mode_ycsep_demod_region_reg.ycsep_demod_region_always_on = 0;	
		vdpq_auto_mode_ycsep_demod_region_reg.hactivestartreg_en_ycsep = 0;
		vdcf_outl(VDPQ_AUTO_MODE_YCSEP_DEMOD_REGION_reg, vdpq_auto_mode_ycsep_demod_region_reg.regValue);
	}
}
...
void module_vpq_digital_filter_set(unsigned char ucInYcSep, unsigned char ucInputSrc, unsigned char ucInputFormat)
{
	...
	/* PARAMETERS */
	__attribute__((unused)) unsigned char FrontDigitalFilter_108M = 0;
	__attribute__((unused)) unsigned char FrontDigitalFilter_108M_oversamp = 0;
	__attribute__((unused)) unsigned char FrontDigitalFilter_27M = 0;
	__attribute__((unused)) unsigned char FrontDigitalFilter_27M_oversamp = 0;
