...
void Scaler_SetColorTempData(TV001_COLOR_TEMP_DATA_S *colorTemp)
{
	...
	}else{fwif_color_set_color_temp(!Scaler_Get_CinemaMode_PQ(), colorTemp->redGain, colorTemp->greenGain, colorTemp->blueGain,
