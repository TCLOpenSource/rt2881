...
void lib_hdmi_eq_pi_power_en(unsigned char bport,unsigned char en)
{
        unsigned int B2_addr,G2_addr,R2_addr;
...
void lib_hdmi_eq_bias_band_setting(unsigned char bport, unsigned int b)
{
        unsigned int B1_addr,G1_addr,R1_addr;
        unsigned int B2_addr,G2_addr,R2_addr;
        unsigned int B3_addr,G3_addr,R3_addr;
...
#define FORE_KOFF_RANGE  3  // range maybe 0  1  2   3
	unsigned char i, k_cnt;
	unsigned int w_b_addr_control,w_g_addr_control,w_r_addr_control;
	unsigned int w_b_addr_result,w_g_addr_result,w_r_addr_result;
