...
void drvif_color_DRV_SNR_Spatial_NR_C(DRV_SNR_Spatial_NR_C *ptr)
{
	...
	//nr_mosquito_ctrl_RBUS_reg.nr_uv_lpf_gain = ptr->SNR_uv_lpf_gain;// c2 add ml8_add // ml9 hw not support
...
void drvif_color_DRV_SNR_Veritcal_NR(DRV_SNR_Veritcal_NR *ptr)
{
	...
	vfir_weight_bak = ptr->SNR_Veritcal_Y_Weight;
}
...
unsigned char  drvif_color_Set_I_De_Contour(VIP_I_De_Contour_TBL *ptr)
{
	...
	//ipq_decontour_de_contour_ctrl_reg.decont_blend_semantic_en = ptr->decont_blend_semantic_en;//mk2 // ml9 hw not support
...
void drvif_color_Set_Block_DeContour_Ctrl(DRV_Block_DeContour_Ctrl *ptr)
{
	...
	//blk_de_contour_ctrl_reg.bdecont_blend_semantic_en = ptr->bdecont_blend_semantic_en;				// mk2 // ml9 hw not support

	//blk_de_contour_ctrl_reg.bdecont_profile_diff_right_dn_en 		= ptr->bdecont_profile_diff_right_dn_en;	// h5c2  // ml8_add // ml9 hw not support
	//blk_de_profile_diff_dist_reg.bdecont_profile_diff_blkv_dn 		= ptr->bdecont_profile_diff_blkv_dn;		// h5c2 // ml9 hw not support
	//blk_de_profile_diff_dist_reg.bdecont_profile_diff_blkh_right 	= ptr->bdecont_profile_diff_blkh_right;	// h5c2 // ml9 hw not support
...
unsigned char  drvif_color_Get_Block_DeContour_Ctrl(DRV_Block_DeContour_Ctrl *ptr)
{
	...
	//ptr->bdecont_blend_semantic_en = blk_de_contour_ctrl_reg.bdecont_blend_semantic_en; // ml9 hw not support

	//ptr->bdecont_profile_diff_right_dn_en = blk_de_contour_ctrl_reg.bdecont_profile_diff_right_dn_en;	// c2  // ml8_add // ml9 hw not support
	//ptr->bdecont_profile_diff_blkv_dn = blk_de_profile_diff_dist_reg.bdecont_profile_diff_blkv_dn;		// c2 // ml9 hw not support
	//ptr->bdecont_profile_diff_blkh_right = blk_de_profile_diff_dist_reg.bdecont_profile_diff_blkh_right;	// c2 // ml9 hw not support
...
#else
	ipq_decontour_bdecont_diff_clamp_RBUS bdecont_diff_clamp_reg;

	bdecont_diff_clamp_reg.regValue = IoReg_Read32(IPQ_DECONTOUR_BDECONT_DIFF_CLAMP_reg);

	bdecont_diff_clamp_reg.bdecont_diff_clamp_y = ptr->bdecont_diff_clamp_y;
	bdecont_diff_clamp_reg.bdecont_diff_clamp_c = ptr->bdecont_diff_clamp_c;

	IoReg_Write32(IPQ_DECONTOUR_BDECONT_DIFF_CLAMP_reg, bdecont_diff_clamp_reg.regValue);
...
void drvif_color_Set_Block_DeContour_MAD(DRV_Block_DeContour_MAD *ptr) // ml7
{
	...
	//blk_de_contour_ctrl_reg.bdecont_mad_interp_en = ptr->bdecont_mad_interp_en; // ml8_add // ml9 hw not support
...
unsigned char drvif_color_Block_DeContour_run_tv006_dynamic(void)
{
	...
	//0xb8025598[29] to control the flow
	return (nr_dummy_reg.dummy18025598_31_16>>13);
}
...
extern unsigned int drv_memory_blk_decontour_Config(unsigned int phyAddr);// ml8_add
...
void drvif_color_Set_DRV_SNR_Clock(SCALER_DISP_CHANNEL display, unsigned char En_flag)
{
	...
	{
		mask = VGIP_Data_Path_Select_sub_s2_clk_en_mask;

		if (En_flag)
			IoReg_SetBits(VGIP_Data_Path_Select_sub_reg, mask);
		else
			IoReg_ClearBits(VGIP_Data_Path_Select_sub_reg, mask);
...
#else //ml9
	if (SLR_SUB_DISPLAY == display)
		return VGIP_Data_Path_Select_sub_get_s2_clk_en(IoReg_Read32(VGIP_Data_Path_Select_sub_reg));
	else
		return VGIP_Data_Path_Select_get_s1_clk_en(IoReg_Read32(VGIP_Data_Path_Select_reg));
#endif
