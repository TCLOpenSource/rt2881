 ...
 ************************************************************************/		
 		case VPQ_EXTERN_IOC_REGISTER_NEW_VIPTABLE:
		{
			...
			if (ret) {
				ret = 0;
				rtd_pr_hist_info("viptable xRegisterTable success\n");
			}
			else {
				ret = -1;
		...
		case VPQ_EXTERN_IOC_SET_VGA_ADCGainOffset:
		{
			...
			if (copy_from_user(&m_vgaGainOffset, (int __user *)arg, sizeof(ADCGainOffset))) {
				...
				rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_VGA_ADCGainOffset success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_vgaGainOffset={\n");
				rtd_pr_hist_info("%x %x %x ", m_vgaGainOffset.Gain_R, m_vgaGainOffset.Gain_G, m_vgaGainOffset.Gain_B);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		break;
		...
		case VPQ_EXTERN_IOC_SET_YPBPR_ADCGainOffset:
		{
			...
			if (copy_from_user(&m_yPbPrGainOffsetData, (int __user *)arg, sizeof(m_yPbPrGainOffsetData))) {
				...
				rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_YPBPR_ADCGainOffset success, sizeof(m_yPbPrGainOffsetData)=%d\n", sizeof(m_yPbPrGainOffsetData));
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_yPbPrGainOffsetData[16]={\n");
				for (i=0; i<SR_MAX_YPBPR_GAINOFFSET_MODE; i++) {
					//for (j=0; j<VIP_QUALITY_FUNCTION_TOTAL_CHECK; j++) {
					rtd_pr_hist_info("%x %x %x ", m_yPbPrGainOffsetData[i].Gain_R, m_yPbPrGainOffsetData[i].Gain_G, m_yPbPrGainOffsetData[i].Gain_B);
					//}
				rtd_pr_hist_info("\n");
				}
				rtd_pr_hist_info("} end\n");
		...
		case VPQ_EXTERN_IOC_SET_SLR_VIP_TABLE_CUSTOM_TV001:
		{
			...
			if (copy_from_user((SLR_VIP_TABLE_CUSTOM_TV001*)m_pVipTableCustom, (int __user *)arg, sizeof(SLR_VIP_TABLE_CUSTOM_TV001))) {
				...
				rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_SLR_VIP_TABLE_CUSTOM_TV001 success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_pVipTableCustom->InitParam[16]={\n");
				for (i=0; i<16; i++) {
					//for (j=0; j<VIP_QUALITY_FUNCTION_TOTAL_CHECK; j++) {
					rtd_pr_hist_info("%x ", tmp_pVipTableCustom->InitParam[i]);
					//}
					//printk("\n");
				}
				rtd_pr_hist_info("} end\n");

				rtd_pr_hist_info("m_pVipTableCustom->DCR_TABLE[][][]={\n");
				for (i=0; i<DCR_TABLE_ROW_NUM; i++) {
					for (j=0; j<DCR_TABLE_COL_NUM; j++) {
					rtd_pr_hist_info("%x ", tmp_pVipTableCustom->DCR_TABLE[New_DCR_TABLE_NUM-1][i][j]);
					}
					rtd_pr_hist_info("\n");
				}
				rtd_pr_hist_info("} end\n");
		...
		case VPQ_EXTERN_IOC_SET_SLR_VIP_TABLE:
		{
			...
			if (copy_from_user(m_pVipTable, (int __user *)arg, sizeof(SLR_VIP_TABLE))) {
				...
				// rtd_pr_hist_info( "kernel copy SLR_VIP_TABLE success\n");
				// rtd_pr_hist_info("%s %d\n", __FUNCTION__, __LINE__);
				ret = 0;


				#if 0
				rtd_pr_hist_info("m_pVipTable->VIP_QUALITY_Coef[][]={\n");
				for (i=0; i<3; i++) {
					for (j=0; j<VIP_QUALITY_FUNCTION_TOTAL_CHECK; j++) {
					rtd_pr_hist_info("%x ", m_pVipTable->VIP_QUALITY_Coef[i][j]);
					}
					rtd_pr_hist_info("\n");
				}
				rtd_pr_hist_info("} end\n");

				rtd_pr_hist_info("m_pVipTable->DrvSetting_Skip_Flag[]={\n");
				for (i=0; i<DrvSetting_Skip_Flag_item_Max; i++) {
					//for (j=0; j<VIP_QUALITY_FUNCTION_TOTAL_CHECK; j++) {
					rtd_pr_hist_info("%x ", m_pVipTable->DrvSetting_Skip_Flag[i]);
					//}
					//printk("\n");
				}
				rtd_pr_hist_info("} end\n");
		...
		case VPQ_EXTERN_IOC_SET_PIC_MODE_DATA_defaultPictureModeSet:
		{
			...
			if (copy_from_user(&m_defaultPictureModeSet, (int __user *)arg, sizeof(SLR_PICTURE_MODE_DATA)*7)) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_PIC_MODE_DATA_defaultPictureModeSet success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_defaultPictureModeSet={\n");
		...
		case VPQ_EXTERN_IOC_SET_PIC_MODE_DATA_DolbyHDRPictureModeSet:
		{
			...
			if (copy_from_user(&m_DolbyHDRPictureModeSet, (int __user *)arg, sizeof(SLR_PICTURE_MODE_DATA)*7)) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_PIC_MODE_DATA_DolbyHDRPictureModeSet success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_DolbyHDRPictureModeSet={\n");
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataType:
		{
			...
			if (copy_from_user(m_colorDataTable, (int __user *)arg, sizeof(StructColorDataType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataType success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_colorDataTable={\n");
				rtd_pr_hist_info("%x %x %x ", m_colorDataTable->MBPeaking, m_colorDataTable->Intensity, m_colorDataTable->Gamma);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataType_defaultSDColorData:
		{
			...
			if (copy_from_user(&m_defaultSDColorData, (int __user *)arg, sizeof(StructColorDataType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataType_defaultSDColorData success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_defaultSDColorData={\n");
				rtd_pr_hist_info("%x %x %x ", m_defaultSDColorData.MBPeaking, m_defaultSDColorData.Intensity, m_defaultSDColorData.Gamma);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataType_defaultHDColorData:
		{
			...
			if (copy_from_user(&m_defaultHDColorData, (int __user *)arg, sizeof(StructColorDataType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataType_defaultHDColorData success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_defaultHDColorData={\n");
				rtd_pr_hist_info("%x %x %x ", m_defaultHDColorData.MBPeaking, m_defaultHDColorData.Intensity, m_defaultHDColorData.Gamma);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		case VPQ_EXTERN_IOC_SET_COLOR_TEMP_DATA:
		{
			...
			if (copy_from_user(m_colorTempData, (int __user *)arg, sizeof(COLOR_TEMP_DATA))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_COLOR_TEMP_DATA success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_colorTempData={\n");
		...
		case VPQ_EXTERN_IOC_SET_COLOR_TEMP_DATA_defColorTempSet:
		{
			...
			if (copy_from_user(&m_defColorTempSet, (int __user *)arg, sizeof(SLR_COLORTEMP_DATA)*SLR_COLORTEMP_MAX_NUM)) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_COLOR_TEMP_DATA_defColorTempSet success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_defColorTempSet={\n");
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataFacModeType:
		{
			...
			if (copy_from_user(m_colorFacModeTable, (int __user *)arg, sizeof(StructColorDataFacModeType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataFacModeType success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_colorFacModeTable={\n");
				rtd_pr_hist_info("%x %x %x ", m_colorFacModeTable->Brightness_0, m_colorFacModeTable->Brightness_50, m_colorFacModeTable->Brightness_100);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_defaultColorFacMode:
		{
			...
			if (copy_from_user(&m_defaultColorFacMode, (int __user *)arg, sizeof(StructColorDataFacModeType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_defaultColorFacMode success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_defaultColorFacMode={\n");
				rtd_pr_hist_info("%x %x %x ", m_defaultColorFacMode.Brightness_0, m_defaultColorFacMode.Brightness_50, m_defaultColorFacMode.Brightness_100);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_AvColorFacMode:
		{
			...
			if (copy_from_user(&m_AvColorFacMode, (int __user *)arg, sizeof(StructColorDataFacModeType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_AvColorFacMode success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_AvColorFacMode={\n");
				rtd_pr_hist_info("%x %x %x ", m_AvColorFacMode.Brightness_0, m_AvColorFacMode.Brightness_50, m_AvColorFacMode.Brightness_100);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_YppColorFacMode:
		{
			...
			if (copy_from_user(&m_YppColorFacMode, (int __user *)arg, sizeof(StructColorDataFacModeType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_YppColorFacMode success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_YppColorFacMode={\n");
				rtd_pr_hist_info("%x %x %x ", m_YppColorFacMode.Brightness_0, m_YppColorFacMode.Brightness_50, m_YppColorFacMode.Brightness_100);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_VgaColorFacMode:
		{
			...
			if (copy_from_user(&m_VgaColorFacMode, (int __user *)arg, sizeof(StructColorDataFacModeType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_VgaColorFacMode success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_VgaColorFacMode={\n");
				rtd_pr_hist_info("%x %x %x ", m_VgaColorFacMode.Brightness_0, m_VgaColorFacMode.Brightness_50, m_VgaColorFacMode.Brightness_100);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_HdmiColorFacMode:
		{
			...
			if (copy_from_user(&m_HdmiColorFacMode, (int __user *)arg, sizeof(StructColorDataFacModeType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_HdmiColorFacMode success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_HdmiColorFacMode={\n");
				rtd_pr_hist_info("%x %x %x ", m_HdmiColorFacMode.Brightness_0, m_HdmiColorFacMode.Brightness_50, m_HdmiColorFacMode.Brightness_100);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		case VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_HdmiSDColorFacMode:
		{
			...
			if (copy_from_user(&m_HdmiSDColorFacMode, (int __user *)arg, sizeof(StructColorDataFacModeType))) {
				...
				// rtd_pr_hist_info( "kernel copy VPQ_EXTERN_IOC_SET_StructColorDataFacModeType_HdmiSDColorFacMode success\n");
				ret = 0;
				#if 0
				rtd_pr_hist_info("m_HdmiSDColorFacMode={\n");
				rtd_pr_hist_info("%x %x %x ", m_HdmiSDColorFacMode.Brightness_0, m_HdmiSDColorFacMode.Brightness_50, m_HdmiSDColorFacMode.Brightness_100);
				rtd_pr_hist_info("} end\n");
				#endif
			}
		}
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_BRIGHTNESS\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_BRIGHTNESS\n");
			unsigned int args = 0;
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_CONTRAST\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_CONTRAST\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_SATURATION\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_SATURATION\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_HUE\n");
			unsigned int hue = 0;
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_HUE\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_NR\n");
			unsigned int nr = 0;
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_NR\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_SHARPNESS\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_SHARPNESS_EXTERN\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_DE_BLOCKING\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_DE_BLOCKING\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_DE_RINGING\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_DE_RINGING\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_COLOR_TEMP\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_COLOR_TEMP_EXTERN\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_COLOR_GAIN\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_COLOR_GAIN_EXTERN\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_FLESH_TONE\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_FLESH_TONE\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_BACKLIGHT\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_BACKLIGHT\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_PANEL_BL\n");
		}
		break;
		case VPQ_EXTERN_IOC_GET_GAMMA_NUM:
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_GAMMA_NUM\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_GAMMA\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_PQ_MODULE\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_PQ_MODULE\n");
			RTK_PQModule_T PQModule_T;
			//unsigned int args = 0;
			if (copy_from_user(&PQModule_T,  (int __user *)arg,sizeof(RTK_PQModule_T))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_DEMO\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_DEBUG_MODE\n");
		}
		break;
		case VPQ_EXTERN_IOC_SET_DEBUG_MODE:
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_DEBUG_MODE\n");
		}
		break;
		case VPQ_EXTERN_IOC_GET_HISTOGRAM:
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_HISTOGRAM\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_SR_LEVEL\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_SR_LEVEL\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_BLACK_PATTERN_OUTPUT\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_WHITE_PATTERN_OUTPUT\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_OD_LEVEL\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_OD_READ_ENABLE\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_SRC_HDR_INFO\n");
		...
		{
			rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_SDR2HDR\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_SDR2HDR\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_DCI_TYPE\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_DOLBY_HDR_PIC_MODE\n");
		}
		break;
		case VPQ_EXTERN_IOC_SET_DOLBY_HDR_PIC_MODE:
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_DOLBY_HDR_PIC_MODE\n");
		}
		break;
		case VPQ_EXTERN_IOC_GET_HDR10_ENABLE:
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_HDR10_ENABLE\n");
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_HDR10_ENABLE\n");
			unsigned int args = 0;
			if (copy_from_user(&args,  (int __user *)arg,sizeof(unsigned int))) {
		...
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_DREAM_PANEL_LOG_ENABLE\n");
		}
		break;
		case VPQ_EXTERN_IOC_GET_DREAM_PANEL_BACKLIGHT:
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_GET_DREAM_PANEL_BACKLIGHT\n");
		}
		break;
		case VPQ_EXTERN_IOC_SET_DREAM_PANEL_BACKLIGHT:
		{
			// rtd_pr_hist_info("VPQ_EXTERN_IOC_SET_DREAM_PANEL_BACKLIGHT\n");
		}
		break;
		...
		case VPQ_EXTERN_IOC_SET_Scaler_SetDCC_Mode:
		{
			...
			if(copy_from_user(&mode,(int __user *)arg,sizeof(unsigned char)))
			{
				...
				// rtd_pr_hist_info( "Scaler_SetDCC_Mode= %d \n",mode);
				ret = 0;
		...
		case VPQ_EXTERN_IOC_GET_NOTIFY_PLATFORM_COLOT_TEMP:
		{
			 ...
			 if(copy_from_user(&mode,(void __user *)arg,sizeof(unsigned char)))
			 {
			  	rtd_printk(KERN_EMERG, TAG_NAME,"error: VPQ_EXTERN_IOC_GET_NOTIFY_PLATFORM_COLOT_TEMP \n");
                      	...
                      	rtd_pr_hist_info(" VPQ_EXTERN_IOC_GET_NOTIFY_PLATFORM_COLOT_TEMP mode=%d \n",mode);
	...
	default:
		rtd_pr_hist_info( "kernel IO command %d not found!\n", cmd);
		rtd_pr_hist_info("VPQ_EXTERN_IOC cmd=0x%x unknown\n", cmd);
		return -1;
			;
	}
	return ret;/*Success*/
...
{
	rtd_pr_hist_info("vpqex_module_init %d\n", __LINE__);
	...
	rtd_pr_hist_info("VPQEX_DEVICE init module major number = %d\n", vpqex_major);
...
{
	rtd_pr_hist_info("vpqex_module_exit\n");
