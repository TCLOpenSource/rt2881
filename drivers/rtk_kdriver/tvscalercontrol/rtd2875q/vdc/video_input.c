...
unsigned char AD_vdadc_adc_ctrl_9_8 = 0x1; //m9 modify 0x2 to 0x1 Vref
unsigned char AD_vdadc_reserve_2_1 = 0x1; //m9 modify 0x2 to 0x1 VCM
unsigned char FrontDigitalFilter_Table = VDC_108M_FDF_75MHZ; // T22 change to 108M setting
...
void module_vdc_ADC_common_setting(void)
{
	...
	tv_sb1_ana_vdadc_pow_ctl_reg.reg_vdadc_reserve_2_1 = AD_vdadc_reserve_2_1;		/* 2_005c[18:17]=2, default */
	...
	if (vd_opt==1){											//vd_otp : otp done flag
		...
		VDADC_ADC_CTRL_LDO1V0_sel = 0x1;					//default valure = 0x001(0.95V) for T22, 0x101(0.908) for T12
	}

	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.regValue = rtdf_inl(TV_SB1_ANA_VDADC_CORE_LPF_CTRL_reg);
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_15_14 = 0x2;	/* 2_0054[31:30]=01, default. k8 check IDNL to modify 0x2 */
	...
	tv_sb1_ana_vdadc_core_lpf_ctrl_reg.reg_vdadc_adc_ctrl_6 = 0x0;		/* (01:1.3V) */ //m9 modify 0x1 to 0x00 1.3v
