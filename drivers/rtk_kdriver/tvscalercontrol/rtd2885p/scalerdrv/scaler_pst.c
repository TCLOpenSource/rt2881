...
#define MAIN_NNSR_START_REGISTER				SRNN_PRE_POST_SRNN_PRE_POS_UZU_SEL_reg
#define MAIN_NNSR_END_REGISTER					SRNN_PRE_POST_srnn_prepost_timing_monitor_st_reg
...
#define MAIN_NNSR_DDR_range(addr)					((((addr>=SRNN_PRE_POST_SRNN_PRE_POS_UZU_SEL_reg) && (addr < SRNN_PRE_POST_SRNN_PRE_POS_db_reg_ctl_reg)) \
                                                      || ((addr>SRNN_PRE_POST_SRNN_PRE_POS_db_reg_ctl_reg) && (addr < SRNN_PRE_POST_srnn_prepost_timing_monitor_st_reg))) ? 1: 0 )

//nnsr mask   0xb8079400 - 0xb807941c
#define MAIN_NNSR_MASK1_START_REGISTER				SRNN_SRNN_INPUT_SIZE
#define MAIN_NNSR_MASK1_END_REGISTER					SRNN_SRNN_SU_RATIO_SEL
#define MAIN_NNSR_MASK1_REGISTER_NUM					((MAIN_NNSR_MASK1_END_REGISTER - MAIN_NNSR_MASK1_START_REGISTER + 4)/4)
#define MAIN_NNSR_MASK1_register_range(addr)				(((addr>=MAIN_NNSR_MASK1_START_REGISTER) &&(addr <=MAIN_NNSR_MASK1_END_REGISTER)) ? 1: 0 )
#define MAIN_NNSR_MASK1_DDR_range(addr)					(((addr>=MAIN_NNSR_MASK1_START_REGISTER) && (addr <= MAIN_NNSR_MASK1_END_REGISTER))  ? 1: 0 )


//nnsr mask   0xb8079240 - 0xb8079284
#define MAIN_NNSR_MASK2_START_REGISTER				PQMASK_SRNN_PQMASK_SRNN_O_Scaleup_Ver
#define MAIN_NNSR_MASK2_END_REGISTER					PQMASK_SRNN_PQMASK_SRNN_I_OutputSize_Ctrl2
#define MAIN_NNSR_MASK2_REGISTER_NUM					((MAIN_NNSR_MASK2_END_REGISTER - MAIN_NNSR_MASK2_START_REGISTER + 4)/4)
#define MAIN_NNSR_MASK2_register_range(addr)				(((addr>=MAIN_NNSR_MASK2_START_REGISTER) &&(addr <=MAIN_NNSR_MASK2_END_REGISTER)) ? 1: 0 )
#define MAIN_NNSR_MASK2_DDR_range(addr)					(((addr>=MAIN_NNSR_MASK2_START_REGISTER) && (addr <= MAIN_NNSR_MASK2_END_REGISTER))  ? 1: 0 )
