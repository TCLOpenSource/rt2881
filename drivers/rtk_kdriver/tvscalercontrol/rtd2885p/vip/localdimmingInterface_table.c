...
/*table0:test*/
	{
                ...
                {1, 0, 12, 12, 1, 0, 12, 0, 0, 0, 0, 0, 0, 0},      /*LDINTERFACE_APLBPL:\
                    apl_mode, apl_average, apl_avg_num, apl_spitota, bpl_mode, bpl_average, sram_hw_write_num_set, apl_sft_right, apl_sft_num, apl_bpl_map_shift, bpl_sft_right, bpl_sft_num */
                {0},		 /*APLBPL table:*/
                {0, 1, 2, 3},		/*DRV_LDINTERFACE_ChannelSwap*/
		   {
