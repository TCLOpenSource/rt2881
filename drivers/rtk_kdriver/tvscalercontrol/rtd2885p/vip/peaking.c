...
#include <rbus/M8P_color_sharp_reg.h>
...
// drvif_color_Set_color_sharp_dm_mkiii_shp_ctrl( &(ptr->MK3_Table) );
void drvif_color_Set_color_sharp_dm_mkiii_shp_ctrl( DRV_Mk3_t* x )
{
	if( !x )
	{
		return;
	...
	if(get_mach_type()==MACH_ARCH_RTK2885P)
	{
		...
		color_sharp_dm_mkiii_shp_ctrl.max_min_gain_en = x->MaxMin_Gain_En;
		color_sharp_dm_mkiii_shp_ctrl.max_min_gain_tex_en = x->max_min_gain_tex_en;
		color_sharp_dm_mkiii_shp_ctrl.max_min_gain_edg_en = x->max_min_gain_edg_en;
		color_sharp_dm_mkiii_shp_ctrl.max_min_gain_v_en = x->max_min_gain_v_en;
		color_sharp_dm_mkiii_shp_ctrl.lpf_weigh_en = x->Lpf_Weigh_En;
		color_sharp_dm_mkiii_shp_ctrl.lpf_weigh_tex_en = x->lpf_weigh_tex_en;
		color_sharp_dm_mkiii_shp_ctrl.lpf_weigh_edg_en = x->lpf_weigh_edg_en;
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_en = x->Gain_By_Y_En;
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_tex_en = x->gain_by_y_tex_en;
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_edg_en = x->gain_by_y_edg_en;
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_v_en = x->gain_by_y_v_en;
	...
	if(get_mach_type()==MACH_ARCH_RTK2885P2)
	{
		...
		color_sharp_dm_mkiii_shp_ctrl.lpf_weigh_tex_en = x->lpf_weigh_tex_en;
		color_sharp_dm_mkiii_shp_ctrl.lpf_weigh_edg_en = x->lpf_weigh_edg_en;
		color_sharp_dm_mkiii_shp_ctrl.res3 = (x->Gain_By_Y_En&1);
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_en = (x->Gain_By_Y_En>>1);
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_tex_en = x->gain_by_y_tex_en;
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_edg_en = x->gain_by_y_edg_en;
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_v_en = x->gain_by_y_v_en;
		IoReg_Write32(COLOR_SHARP_DM_MKIII_SHP_CTRL_reg, color_sharp_dm_mkiii_shp_ctrl.regValue);
	...
	if(get_mach_type()==MACH_ARCH_RTK2885PP)
	{
		...
		M8P_color_sharp_dm_mkiii_shp_ctrl_RBUS	color_sharp_dm_mkiii_shp_ctrl;
		color_sharp_dm_mkiii_shp_ctrl.regValue = IoReg_Read32(M8P_COLOR_SHARP_DM_MKIII_SHP_CTRL_reg);
		color_sharp_dm_mkiii_shp_ctrl.max_min_gain_en = x->MaxMin_Gain_En;
		color_sharp_dm_mkiii_shp_ctrl.max_min_gain_tex_en = x->max_min_gain_tex_en;
		color_sharp_dm_mkiii_shp_ctrl.max_min_gain_edg_en = x->max_min_gain_edg_en;
		color_sharp_dm_mkiii_shp_ctrl.max_min_gain_v_en = x->max_min_gain_v_en;
		...
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_edg_en = x->gain_by_y_edg_en;
		color_sharp_dm_mkiii_shp_ctrl.gain_by_y_v_en = x->gain_by_y_v_en;
		IoReg_Write32(M8P_COLOR_SHARP_DM_MKIII_SHP_CTRL_reg, color_sharp_dm_mkiii_shp_ctrl.regValue);
	}
}
...
/* set MK3 start */
	...
	// 2885pp color_sharp_dm_segpk_edgpk2.lv_by_y_enable = ptr->MK3_Table.lv_by_y_enable;
	// 2885pp color_sharp_dm_peaking_bound_0.lv_by_y_tex_enable = ptr->MK3_Table.lv_by_y_tex_enable;
	// 2885pp color_sharp_dm_segpk_edgpk2.lv_by_y_edg_enable = ptr->MK3_Table.lv_by_y_edg_enable;
	// 2885pp color_sharp_dm_segpk_vpk3.lv_by_y_v_enable = ptr->MK3_Table.lv_by_y_v_enable;
	// 2885pp color_sharp_dm_segpk_vpk5.lv_by_y_v_edg_enable = ptr->MK3_Table.lv_by_y_v_edg_enable;
	/*===== edge coef ====*/
...
/* set SR start */
	{
	color_sharp_dm_sr_ctrl_RBUS color_sharp_dm_sr_ctrl;
	// 2885pp color_sharp_dm_sr_continual_detail_gain_RBUS	color_sharp_dm_sr_continual_detail_gain;
	color_sharp_dm_sr_ctrl_3_RBUS color_sharp_dm_sr_ctrl_3;

	color_sharp_dm_sr_ctrl.regValue = IoReg_Read32(COLOR_SHARP_DM_SR_Ctrl_reg);
	// 2885pp color_sharp_dm_sr_continual_detail_gain.regValue = IoReg_Read32(COLOR_SHARP_DM_SR_continual_detail_gain_reg);
	color_sharp_dm_sr_ctrl_3.regValue = IoReg_Read32(COLOR_SHARP_DM_SR_Ctrl_3_reg);

	// 2885pp color_sharp_dm_sr_continual_detail_gain.gain = ptr->SR_Control.Gain;
	// 2885pp color_sharp_dm_sr_continual_detail_gain.offset = ptr->SR_Control.Offset;
	// 2885pp color_sharp_dm_sr_continual_detail_gain.period = ptr->SR_Control.Period;
	// 2885pp color_sharp_dm_sr_continual_detail_gain.sr_detail_tex_en = ptr->SR_Control.sr_detail_tex_en;
	// 2885pp // removed color_sharp_dm_sr_continual_detail_gain.sr_detail_edg_en = ptr->SR_Control.sr_detail_edg_en;
	// 2885pp color_sharp_dm_sr_continual_detail_gain.sr_detail_v_tex_en = ptr->SR_Control.sr_detail_v_tex_en;
	// 2885pp // removed color_sharp_dm_sr_continual_detail_gain.sr_detail_v_edg_en = ptr->SR_Control.sr_detail_v_edg_en;
	...
	// 2885pp IoReg_Write32(COLOR_SHARP_DM_SR_continual_detail_gain_reg, color_sharp_dm_sr_continual_detail_gain.regValue);
	}
/* set SR end */
/* Merlin3 no Edge SM
	{
...
/* set Merlin2 start  */
	{
	// 2885pp color_sharp_dm_segpk_ise_RBUS	color_sharp_dm_segpk_ise;
	// 2885pp color_sharp_dm_segpk_ise_2_RBUS color_sharp_dm_segpk_ise_2;
	color_sharp_dm_2d_shp_tex_flat_0_RBUS	color_sharp_dm_2d_shp_tex_flat_0;
	...
	// 2885pp color_sharp_dm_segpk_ise.regValue = IoReg_Read32(COLOR_SHARP_DM_SEGPK_ISE_reg);
	// 2885pp color_sharp_dm_segpk_ise_2.regValue = IoReg_Read32(COLOR_SHARP_DM_SEGPK_ISE_2_reg);
	...
	// 2885pp color_sharp_dm_segpk_ise.ise_en= ptr->SEGPK_ISE.ise_en;
	// 2885pp color_sharp_dm_segpk_ise.ise_step= ptr->SEGPK_ISE.ise_step;
	// 2885pp // color_sharp_dm_segpk_ise.ise_scale= ptr->SEGPK_ISE.ise_scale;
	// 2885pp color_sharp_dm_segpk_ise.ise_ub= ptr->SEGPK_ISE.ise_ub;
	// 2885pp color_sharp_dm_segpk_ise.ise_h_st= ptr->SEGPK_ISE.ise_h_st;
	// 2885pp color_sharp_dm_segpk_ise.ise_h_end= ptr->SEGPK_ISE.ise_h_end;
	// 2885pp color_sharp_dm_segpk_ise.ise_v_st= ptr->SEGPK_ISE.ise_v_st;
	// 2885pp color_sharp_dm_segpk_ise.ise_v_end= ptr->SEGPK_ISE.ise_v_end;
	// 2885pp color_sharp_dm_segpk_ise_2.ise_mul_max= ptr->SEGPK_ISE.ise_mul_max;
	// 2885pp color_sharp_dm_segpk_ise_2.ise_mul_min= ptr->SEGPK_ISE.ise_mul_min;
	...
	// 2885pp IoReg_Write32(COLOR_SHARP_DM_SEGPK_ISE_reg, color_sharp_dm_segpk_ise.regValue);
	// 2885pp IoReg_Write32(COLOR_SHARP_DM_SEGPK_ISE_2_reg, color_sharp_dm_segpk_ise_2.regValue);
...
void drvif_color_sharpness_set_2D_peaking_Debug_mode(unsigned int mode)
{
	color_sharp_dm_segpk_dbg_RBUS	color_sharp_dm_segpk_dbg;
	
	color_sharp_dm_segpk_dbg.regValue = IoReg_Read32(COLOR_SHARP_DM_SEGPK_DBG_reg);

	color_sharp_dm_segpk_dbg.debugmode = mode;
...
void drvif_color_Get_Sharpness_Table(DRV_Sharpness_Table *ptr)
{
	...
	if(get_mach_type()==MACH_ARCH_RTK2885P2)
	{
		...
		ptr->MK3_Table.lpf_weigh_tex_en = color_sharp_dm_mkiii_shp_ctrl.lpf_weigh_tex_en;
		ptr->MK3_Table.lpf_weigh_edg_en = color_sharp_dm_mkiii_shp_ctrl.lpf_weigh_edg_en;
		ptr->MK3_Table.Gain_By_Y_En = (color_sharp_dm_mkiii_shp_ctrl.gain_by_y_en<<1)|(color_sharp_dm_mkiii_shp_ctrl.res3&1);
		ptr->MK3_Table.gain_by_y_tex_en = color_sharp_dm_mkiii_shp_ctrl.gain_by_y_tex_en;
		ptr->MK3_Table.gain_by_y_edg_en = color_sharp_dm_mkiii_shp_ctrl.gain_by_y_edg_en;
		ptr->MK3_Table.gain_by_y_v_en = color_sharp_dm_mkiii_shp_ctrl.gain_by_y_v_en;
	}
	...
	*/
	...
	// 2885pp ptr->MK3_Table.lv_by_y_enable = color_sharp_dm_segpk_edgpk2.lv_by_y_enable;
	// 2885pp ptr->MK3_Table.lv_by_y_tex_enable = color_sharp_dm_peaking_bound_0.lv_by_y_tex_enable;
	// 2885pp ptr->MK3_Table.lv_by_y_edg_enable = color_sharp_dm_segpk_edgpk2.lv_by_y_edg_enable;
	// 2885pp ptr->MK3_Table.lv_by_y_v_enable = color_sharp_dm_segpk_vpk3.lv_by_y_v_enable;
	// 2885pp ptr->MK3_Table.lv_by_y_v_edg_enable = color_sharp_dm_segpk_vpk5.lv_by_y_v_edg_enable;
	...
	color_sharp_dm_sr_ctrl_3.regValue = IoReg_Read32(COLOR_SHARP_DM_SR_Ctrl_3_reg);
	// 2885pp ptr->SR_Control.Gain = color_sharp_dm_sr_continual_detail_gain.gain;
	// 2885pp ptr->SR_Control.Offset = color_sharp_dm_sr_continual_detail_gain.offset;
	// 2885pp ptr->SR_Control.Period = color_sharp_dm_sr_continual_detail_gain.period;
	// 2885pp ptr->SR_Control.sr_detail_tex_en = color_sharp_dm_sr_continual_detail_gain.sr_detail_tex_en;
	// 2885pp ptr->SR_Control.sr_detail_v_tex_en = color_sharp_dm_sr_continual_detail_gain.sr_detail_v_tex_en;
	...
	// 2885pp ptr->SEGPK_ISE.ise_en = color_sharp_dm_segpk_ise.ise_en;
	// 2885pp ptr->SEGPK_ISE.ise_step = color_sharp_dm_segpk_ise.ise_step;
	// 2885pp // ptr->SEGPK_ISE.ise_scale = color_sharp_dm_segpk_ise.ise_scale;
	// 2885pp ptr->SEGPK_ISE.ise_ub = color_sharp_dm_segpk_ise.ise_ub;
	// 2885pp ptr->SEGPK_ISE.ise_h_st = color_sharp_dm_segpk_ise.ise_h_st;
	// 2885pp ptr->SEGPK_ISE.ise_h_end = color_sharp_dm_segpk_ise.ise_h_end;
	// 2885pp ptr->SEGPK_ISE.ise_v_st = color_sharp_dm_segpk_ise.ise_v_st;
	// 2885pp ptr->SEGPK_ISE.ise_v_end = color_sharp_dm_segpk_ise.ise_v_end;
	// 2885pp ptr->SEGPK_ISE.ise_mul_max = color_sharp_dm_segpk_ise_2.ise_mul_max;
	// 2885pp ptr->SEGPK_ISE.ise_mul_min = color_sharp_dm_segpk_ise_2.ise_mul_min;
