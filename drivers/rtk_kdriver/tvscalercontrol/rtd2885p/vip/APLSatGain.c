...
#include "rbus/M8P_aplsatgain_reg.h"
...
void drvif_color_set_APLSatGain_Ctrl_Common(DRV_APLSatGain_Ctrl_Common *ptr)
{
	...
	{
		M8P_aplsatgain_aplsatgain_ctrl_0_RBUS aplsatgain_aplsatgain_ctrl_0_reg;
		M8P_aplsatgain_aplsatgain_ctrl_common_RBUS aplsatgain_aplsatgain_ctrl_common_reg;
		M8P_aplsatgain_aplsatgain_newapl_0_RBUS aplsatgain_aplsatgain_newapl_0_reg;
		M8P_aplsatgain_aplsatgain_double_buffer_ctrl_RBUS aplsatgain_aplsatgain_double_buffer_ctrl_reg;
		unsigned char shift_gain;

		// double buffer enable
		aplsatgain_aplsatgain_double_buffer_ctrl_reg.regValue = IoReg_Read32(M8P_APLSATGAIN_APLSATGAIN_DOUBLE_BUFFER_CTRL_reg);
		aplsatgain_aplsatgain_double_buffer_ctrl_reg.aplsatgain_db_en=1;
		IoReg_Write32(M8P_APLSATGAIN_APLSATGAIN_DOUBLE_BUFFER_CTRL_reg, aplsatgain_aplsatgain_double_buffer_ctrl_reg.regValue);

		shift_gain = 1 - ptr->shift_bit;
		if(shift_gain<0)
			shift_gain = 0;
		
		aplsatgain_aplsatgain_ctrl_common_reg.regValue = IoReg_Read32(M8P_APLSATGAIN_APLSATGAIN_CTRL_COMMON_reg);
		aplsatgain_aplsatgain_ctrl_common_reg.aplsatgain_shift_gain = shift_gain;
		aplsatgain_aplsatgain_ctrl_common_reg.aplsatgain_sat_mode = ptr->sat_mode;
		IoReg_Write32(M8P_APLSATGAIN_APLSATGAIN_CTRL_COMMON_reg, aplsatgain_aplsatgain_ctrl_common_reg.regValue);

		aplsatgain_aplsatgain_newapl_0_reg.regValue = IoReg_Read32(M8P_APLSATGAIN_APLSATGAIN_NEWAPL_0_reg);
		aplsatgain_aplsatgain_newapl_0_reg.aplsatgain_apl_blend_weight = ptr->APL_blend_weight;
		IoReg_Write32(M8P_APLSATGAIN_APLSATGAIN_NEWAPL_0_reg, aplsatgain_aplsatgain_newapl_0_reg.regValue);

		aplsatgain_aplsatgain_ctrl_0_reg.regValue = IoReg_Read32(M8P_APLSATGAIN_APLSATGAIN_CTRL_0_reg);
		aplsatgain_aplsatgain_ctrl_0_reg.aplsatgain_apl_mapping_en = ptr->blenking_grey_en;
		IoReg_Write32(M8P_APLSATGAIN_APLSATGAIN_CTRL_0_reg, aplsatgain_aplsatgain_ctrl_0_reg.regValue);
...
void drvif_color_set_APLSatGain_Gain_by_APL(DRV_APLSatGain_gain_by_apl *curve, unsigned char table_sel)
{
	...
	else if(get_mach_type()==MACH_ARCH_RTK2885P2) // merlin8p IC, run merlin8 flow
	{
		if(table_sel == 0)
		{
			...
			aplsatgain_aplsatgain_apl_gain_tbl0_0_reg.aplsatgain_gain_by_apl_tbl0_0 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[0]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_0_reg.aplsatgain_gain_by_apl_tbl0_1 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[1]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_0_reg.aplsatgain_gain_by_apl_tbl0_2 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[2]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_0_reg.aplsatgain_gain_by_apl_tbl0_3 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[3]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_1_reg.aplsatgain_gain_by_apl_tbl0_4 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[4]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_1_reg.aplsatgain_gain_by_apl_tbl0_5 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[5]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_1_reg.aplsatgain_gain_by_apl_tbl0_6 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[6]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_1_reg.aplsatgain_gain_by_apl_tbl0_7 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[7]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_2_reg.aplsatgain_gain_by_apl_tbl0_8 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[8]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_2_reg.aplsatgain_gain_by_apl_tbl0_9 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[9]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_2_reg.aplsatgain_gain_by_apl_tbl0_10 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[10]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_2_reg.aplsatgain_gain_by_apl_tbl0_11 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[11]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_3_reg.aplsatgain_gain_by_apl_tbl0_12 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[12]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_3_reg.aplsatgain_gain_by_apl_tbl0_13 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[13]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_3_reg.aplsatgain_gain_by_apl_tbl0_14 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[14]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_3_reg.aplsatgain_gain_by_apl_tbl0_15 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[15]*2);
			aplsatgain_aplsatgain_apl_gain_tbl0_4_reg.aplsatgain_gain_by_apl_tbl0_16 = CLIP(0,255,curve->gain_by_apl_curve_tbl0[16]*2);
		...
		else
		{
			...
			aplsatgain_aplsatgain_apl_gain_tbl1_0_reg.aplsatgain_gain_by_apl_tbl1_0 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[0]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_0_reg.aplsatgain_gain_by_apl_tbl1_1 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[1]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_0_reg.aplsatgain_gain_by_apl_tbl1_2 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[2]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_0_reg.aplsatgain_gain_by_apl_tbl1_3 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[3]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_1_reg.aplsatgain_gain_by_apl_tbl1_4 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[4]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_1_reg.aplsatgain_gain_by_apl_tbl1_5 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[5]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_1_reg.aplsatgain_gain_by_apl_tbl1_6 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[6]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_1_reg.aplsatgain_gain_by_apl_tbl1_7 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[7]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_2_reg.aplsatgain_gain_by_apl_tbl1_8 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[8]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_2_reg.aplsatgain_gain_by_apl_tbl1_9 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[9]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_2_reg.aplsatgain_gain_by_apl_tbl1_10 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[10]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_2_reg.aplsatgain_gain_by_apl_tbl1_11 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[11]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_3_reg.aplsatgain_gain_by_apl_tbl1_12 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[12]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_3_reg.aplsatgain_gain_by_apl_tbl1_13 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[13]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_3_reg.aplsatgain_gain_by_apl_tbl1_14 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[14]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_3_reg.aplsatgain_gain_by_apl_tbl1_15 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[15]*2);
			aplsatgain_aplsatgain_apl_gain_tbl1_4_reg.aplsatgain_gain_by_apl_tbl1_16 = CLIP(0,255,curve->gain_by_apl_curve_tbl1[16]*2);
...
void drvif_color_set_APLSatGain_source(unsigned char video_src, unsigned char sat_src, unsigned char apl_src)
{
	if(get_mach_type()==MACH_ARCH_RTK2885PP) //merlin8p IC , run merlin8p flow
	{
		...
		aplsatgain_aplsatgain_ctrl_0_reg.regValue = IoReg_Read32(M8P_APLSATGAIN_APLSATGAIN_CTRL_0_reg);
		aplsatgain_aplsatgain_ctrl_0_reg.aplsatgain_video_source = video_src;
		aplsatgain_aplsatgain_ctrl_0_reg.aplsatgain_sat_source = sat_src;
		aplsatgain_aplsatgain_ctrl_0_reg.aplsatgain_apl_source = apl_src;
		IoReg_Write32(M8P_APLSATGAIN_APLSATGAIN_CTRL_0_reg, aplsatgain_aplsatgain_ctrl_0_reg.regValue);
