...
#include <rbus/M8P_color_dtm_reg.h>
...
unsigned char drvif_color_dtm_write_One_Table(unsigned short dtm_One_table[RGBSEGMAX])
{
	...
	if(get_mach_type()==MACH_ARCH_RTK2885PP){
		M8P_color_dtm_dm_dtm_rw_tab_ctrl_RBUS m8p_color_dtm_dm_dtm_rw_tab_ctrl_reg;
		m8p_color_dtm_dm_dtm_rw_tab_ctrl_reg.regValue = rtd_inl(M8P_COLOR_DTM_DM_DTM_RW_TAB_CTRL_reg);
		m8p_color_dtm_dm_dtm_rw_tab_ctrl_reg.main_sub_sel = 2;
		rtd_outl(M8P_COLOR_DTM_DM_DTM_RW_TAB_CTRL_reg,m8p_color_dtm_dm_dtm_rw_tab_ctrl_reg.regValue);
	}
