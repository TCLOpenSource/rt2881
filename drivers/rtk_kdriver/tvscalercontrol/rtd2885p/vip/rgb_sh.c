...
void VPQ_RgbShp_RegCtrl_SetRgb_shp_yuvmode(unsigned char isYUVmode)
{
	if (isYUVmode)
		IoReg_SetBits(RGB_SHPNR_RGB_SHPNR_CTRL_reg, RGB_SHPNR_RGB_SHPNR_CTRL_rgb_sharp_yuvmode_mask);
	else
		IoReg_ClearBits(RGB_SHPNR_RGB_SHPNR_CTRL_reg, RGB_SHPNR_RGB_SHPNR_CTRL_rgb_sharp_yuvmode_mask);
