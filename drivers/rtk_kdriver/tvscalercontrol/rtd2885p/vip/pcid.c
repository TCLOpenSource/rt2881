...
void drvif_color_set_pcid_regional_table_setting(DRV_pcid_RgnTbl_t* pRgnTbl)
{
	...
	pcid_pcid_regional_index_horizontal_3_RBUS pcid_pcid_regional_index_horizontal_3_reg;
	...
	pcid_pcid_regional_index_horizontal_3_reg.regValue = IoReg_Read32(PCID_PCID_Regional_Index_Horizontal_3_reg);
	...
	pcid_pcid_regional_index_horizontal_1_reg.rt_hor_index3 = pRgnTbl->HorIdx[3];
	pcid_pcid_regional_index_horizontal_3_reg.rt_hor_index4 = pRgnTbl->HorIdx[4];
	pcid_pcid_regional_index_horizontal_3_reg.rt_hor_index5 = pRgnTbl->HorIdx[5];
	...
	pcid_pcid_regional_blendingstep_horizontal_reg.rt_hor_step3 = pRgnTbl->HorBldStep[3];
	pcid_pcid_regional_blendingstep_horizontal_reg.rt_hor_step4 = pRgnTbl->HorBldStep[4];
	pcid_pcid_regional_blendingstep_horizontal_reg.rt_hor_step5 = pRgnTbl->HorBldStep[5];
	...
	IoReg_Write32(PCID_PCID_Regional_Index_Horizontal_3_reg, pcid_pcid_regional_index_horizontal_3_reg.regValue);
...
void drvif_color_set_pcid_RgnWt_setting(DRV_pcid_RgnWt_t* pPcid_RgnWt)
{
	...
	pcid_pcid_regionaltable_index_h_reg.pcid_regional_weight_height = pPcid_RgnWt->Height;
	pcid_pcid_regionaltable_index_h_reg.pcid_regional_weight_width  = pPcid_RgnWt->Width;
	pcid_pcid_regionaltable_index_v_reg.pcid_regional_weight_horbldstep = pPcid_RgnWt->HorBldStep;
	pcid_pcid_regionaltable_index_v_reg.pcid_regional_weight_verbldstep = pPcid_RgnWt->VerBldStep;
	pcid_pcid_regionaltable_ctrl_reg.pcid_regional_8x24_en = pPcid_RgnWt->Enable;
...
void drvif_color_set_pcid_pixel_reference_cycle_setting(unsigned char cycle)
{
	M8P_pcid_pcid_ctrl_RBUS pcid_pcid_ctrl_reg;
	
	pcid_pcid_ctrl_reg.regValue = IoReg_Read32(M8P_PCID_PCID_CTRL_reg);
	pcid_pcid_ctrl_reg.reference_cycle = cycle;
	IoReg_Write32(M8P_PCID_PCID_CTRL_reg, pcid_pcid_ctrl_reg.regValue);
	
}

void drvif_color_set_pcid_RgnWt_HV_num_setting(unsigned char H_num,unsigned char V_num)
{
	M8P_pcid_pcid_regionaltable_regional_number_RBUS pcid_pcid_regionaltable_regional_number_reg;;
	
	pcid_pcid_regionaltable_regional_number_reg.regValue = IoReg_Read32(M8P_PCID_PCID_RegionalTable_Regional_Number_reg);
	pcid_pcid_regionaltable_regional_number_reg.pcid_regional_weight_h_num = H_num;
	pcid_pcid_regionaltable_regional_number_reg.pcid_regional_weight_v_num = V_num;
	IoReg_Write32(M8P_PCID_PCID_RegionalTable_Regional_Number_reg, pcid_pcid_regionaltable_regional_number_reg.regValue);
	...
	if(get_mach_type()==MACH_ARCH_RTK2885P){
		...
		IoReg_Write32(PCID_PCID_LUT_ADDR_reg, pcid_lut_addr_reg.regValue);
	       ...
	       unsigned int i =0;
			...
			pcid_pcid_regionaltable_regional_number_reg.regValue = IoReg_Read32(M8P_PCID_PCID_RegionalTable_Regional_Number_reg);
			pcid_pcid_regionaltable_regional_number_reg.pcid_regional_weight_h_num = 23;
			pcid_pcid_regionaltable_regional_number_reg.pcid_regional_weight_v_num = 7;
			IoReg_Write32(M8P_PCID_PCID_RegionalTable_Regional_Number_reg, pcid_pcid_regionaltable_regional_number_reg.regValue);
			...
			pcid_pcid_regionaltable_regional_number_reg.regValue = IoReg_Read32(M8P_PCID_PCID_RegionalTable_Regional_Number_reg);
			H_num = pcid_pcid_regionaltable_regional_number_reg.pcid_regional_weight_h_num + 1;
			V_num = pcid_pcid_regionaltable_regional_number_reg.pcid_regional_weight_v_num + 1;
			TableSize = H_num*V_num;
...
void drvif_color_enable_LGD_POD_CLK(void)
{
	if(get_mach_type()==MACH_ARCH_RTK2885P){
        ...
        if ((IoReg_Read32(SYS_REG_SYS_CLKEN3_reg) & _BIT14) == 0)	// LGD POD clk not enable
		{
	       ...
	       rtd_pr_vpq_emerg("Not support POD!\n");
	}else if(get_mach_type()==MACH_ARCH_RTK2885PP){
