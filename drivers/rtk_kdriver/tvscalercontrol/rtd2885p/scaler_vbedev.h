...
bool vbe_is_support_eco_mode(void);
void vbe_disp_check_eco_mode(bool forceRun);
void vbe_disp_eco_reset_dclk(void);
void vbe_disp_config_eco_dynamic_interface(void);
unsigned int vbe_get_vby1_laneNum(void);
unsigned int vbe_get_vby1_byte_mode(void);
unsigned int vbe_get_sfg_pixel_mode(void);
unsigned int vbe_get_ckin_dvin(unsigned int lanes, unsigned int pixel_mode);
void vbe_enable_vby1_panel_clks(bool enable);
void vbe_disp_config_eco_dynamic_interface_PIF_APHY(void);
void vbe_disp_config_eco_dynamic_interface_sfg(void);
#endif
#endif
...
int vbe_check_input_support_otp_clock(int htotal, int vtotal, int vFreq);
