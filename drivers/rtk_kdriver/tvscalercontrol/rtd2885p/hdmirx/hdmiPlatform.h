...
#define GET_MODE_IVFREQ()           (Scaler_ModeGet_Hdmi_ModeInfo(SLR_MODE_IVFREQ_1000))
...
#define SET_MODE_IVFREQ(x)          (Scaler_ModeSet_Hdmi_ModeInfo(SLR_MODE_IVFREQ_1000, (x)))
...
#define GET_PANEL_HACTIVE()    (Get_DISP_ACT_END_HPOS() - Get_DISP_ACT_STA_HPOS())
#define GET_PANEL_VACTIVE()    (Get_DISP_ACT_END_VPOS() - Get_DISP_ACT_STA_VPOS())
#else
...
extern unsigned int Get_DISP_ACT_END_HPOS(void);
extern unsigned int Get_DISP_ACT_STA_HPOS(void);
extern unsigned int Get_DISP_ACT_END_VPOS(void);
extern unsigned int Get_DISP_ACT_STA_VPOS(void);
#define GET_PANEL_REFRESH_RATE()    Get_DISPLAY_REFRESH_RATE()
#define GET_PANEL_HACTIVE()    (Get_DISP_ACT_END_HPOS() - Get_DISP_ACT_STA_HPOS())
#define GET_PANEL_VACTIVE()    (Get_DISP_ACT_END_VPOS() - Get_DISP_ACT_STA_VPOS())
#else
#define GET_PANEL_REFRESH_RATE()    0
#define GET_PANEL_HACTIVE()    0
#define GET_PANEL_VACTIVE()    0
#endif
#endif
...
#define SET_HDMI_DOLBY_VSIF_MODE(x,y)     {}
...
#endif // #if IS_ENABLED(CONFIG_RTK_KDRV_AUDIO)
