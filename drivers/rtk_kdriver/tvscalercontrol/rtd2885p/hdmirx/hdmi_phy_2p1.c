...
void lib_hdmi21_phy_init(void)
{
	...
	/*	
		...
		*/
		...
		_phy_rtd_part_outl(0x1800da04, 9, 9, 0x0); //[]  REG_Z0_FT_PN_SHORT_EN
		//*********************************** MD
		_phy_rtd_outl(0x1800da10,0xf0004800);//TOP_IN_2<3>  ,ck_test group sel.  0:CK test group1, 1:CK test group2
		_phy_rtd_outl(0x1800da10,0xf0004a00);//REG_TOP_IN_4<2:0>     ,ck_test sel in group1 and group2
