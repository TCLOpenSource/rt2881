...
extern INFOFRAME_READ_RESULT newbase_hdmi_update_RSV1_info(unsigned char port, unsigned char *pkt_buf, INFO_PACKET_CONFIG *config);
...
extern unsigned char newbase_hdmi_get_xperi_infoframe(unsigned char port, HDMI_VSI_T *p_vsi_t);
...
extern unsigned char newbase_hdmi_get_vic_from_vsi(unsigned char pkt_buf[HAL_VFE_HDMI_VENDOR_SPECIFIC_REGID_LEN], unsigned char pb4, unsigned char pb5);
extern unsigned char newbase_hdmi_get_vic_state(unsigned char port, HDMI_AVI_T *p_avt_t, HDMI_VSI_T *p_vsi_t, unsigned char* final_vic );
