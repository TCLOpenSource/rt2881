...
typedef enum
{
	...
	VPQ_INPUT_165HZ,						///< input 165Hz
	VPQ_INPUT_240HZ,						///< input 240Hz
	VPQ_INPUT_FRAME_MAX,
...
typedef enum
{
    ...
    VPQ_OUTPUT_150HZ,
    VPQ_OUTPUT_165HZ,						///< output 165Hz
	VPQ_OUTPUT_200HZ,						///< output 200Hz
	VPQ_OUTPUT_225HZ,						///< output 225Hz
...
typedef struct{
	...
	unsigned int MEMC_reg[MAX_PAGE_NUMBER+1][64];
