    ...
    if(attr != NULL)
    {
        ...
        case DPRX_VFE_ATTR_PORT_SET_WAKE_UP_MODE:
            if (attr->data_array==0)
            {
                ...
                ext_ctrl.id = DP_EXCTL_WAKUEP_MODE_SEL;
                ext_ctrl.param1 = DP_WAKUEP_MODE_SEL_ONLY_DP_PORT_WAKEUP;
                ret = vfe_dprx_drv_set_ext_ctrl(0, &ext_ctrl);
                ret = vfe_dprx_drv_set_ext_ctrl(1, &ext_ctrl);
