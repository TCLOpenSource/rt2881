...
void newbase_hdmi21_tmds_dfe_lo_speed(unsigned char nport, unsigned char lane_mode);
...
//		newbase_hdmi2p0_inc_scdc_toggle(p);
	...
	case PHY_PROC_RECOVER_LO:
		newbase_hdmi21_tmds_dfe_lo_speed(p,phy_st[p].lane_num);
		newbase_hdmi_err_detect_add(p);
		phy_st[p].phy_proc_state = PHY_PROC_RECORD;
...
void newbase_hdmi21_tmds_dfe_lo_speed(unsigned char nport, unsigned char lane_mode)
{
	...
	hdmi_mask(DFE_REG_DFE_EN_L0_reg,~(DFE_P0_REG_DFE_EN_L0_P0_le_init_lane0_p0_mask), (DFE_P0_REG_DFE_EN_L0_P0_le_init_lane0_p0(ManuLE)));
	hdmi_mask(DFE_REG_DFE_EN_L1_reg,~(DFE_P0_REG_DFE_EN_L1_P0_le_init_lane1_p0_mask), (DFE_P0_REG_DFE_EN_L1_P0_le_init_lane1_p0(ManuLE)));
	hdmi_mask(DFE_REG_DFE_EN_L2_reg,~(DFE_P0_REG_DFE_EN_L2_P0_le_init_lane2_p0_mask), (DFE_P0_REG_DFE_EN_L2_P0_le_init_lane2_p0(ManuLE)));
	if (lane_mode == HDMI_4LANE)
		hdmi_mask(DFE_REG_DFE_EN_L3_reg,~(DFE_P0_REG_DFE_EN_L3_P0_le_init_lane3_p0_mask), (DFE_P0_REG_DFE_EN_L3_P0_le_init_lane3_p0(ManuLE)));
	...
	hdmi_mask(HDMIRX_PHY_B2_reg,~(b_10_DFE_SUPAMP_DCGAIN_MAX),b_10_DFE_SUPAMP_DCGAIN_MAX);
	hdmi_mask(HDMIRX_PHY_G2_reg,~(g_10_DFE_SUPAMP_DCGAIN_MAX),b_10_DFE_SUPAMP_DCGAIN_MAX);
	hdmi_mask(HDMIRX_PHY_R2_reg,~(r_10_DFE_SUPAMP_DCGAIN_MAX),b_10_DFE_SUPAMP_DCGAIN_MAX);
	if (lane_mode == HDMI_4LANE)
		hdmi_mask(HDMIRX_PHY_CK2_reg,~(ck_10_DFE_SUPAMP_DCGAIN_MAX),b_10_DFE_SUPAMP_DCGAIN_MAX);
