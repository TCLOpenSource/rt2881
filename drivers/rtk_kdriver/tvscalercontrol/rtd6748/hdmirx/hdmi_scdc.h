...
extern void newbase_hdmi_enable_char_bit_debug_print_step(unsigned char nport);
extern void newbase_hdmi_reset_char_bit_debug_print_step(unsigned char nport);

//------------------------------------------------------------------------------
extern void newbase_hdmi_scdc_spin_lock_init(void);
