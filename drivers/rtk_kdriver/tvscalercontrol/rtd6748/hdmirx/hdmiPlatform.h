...
#define GET_PANEL_Is_Dynamic_DisplayTiming()    Get_DISPLAY_Is_Dynamic_DisplayTiming()
#define GET_PANEL_VERTICAL_TOTAL()    Get_DISP_VERTICAL_TOTAL()
#define GET_PANEL_HORIZONTAL_TOTAL()    Get_DISP_HORIZONTAL_TOTAL()
#else
...
#define GET_PANEL_Is_Dynamic_DisplayTiming()    0
#define GET_PANEL_VERTICAL_TOTAL()    0
#define GET_PANEL_HORIZONTAL_TOTAL()    0
#endif
