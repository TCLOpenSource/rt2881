...
#define HDMI_SCRAMBLE_BIT_ERROR_RECOVER_THD 22000
#define HDMI_SCRAMBLE_BIT_ERROR_DETECT_MIN 20
#define HDMI_SCRAMBLE_BIT_ERROR_DETECT_MAX 150
...
#define SET_H_DSC_VERSION_MINOR(port, ver) 	(hdmi_rx[port].timing_t.dsc_version_minor = ver)
#define SET_H_DSC_CONVERT_RGB(port, color) 	(hdmi_rx[port].timing_t.convert_rgb = color)
#define SET_H_DSC_SIMPLE_422(port, fmt) 	(hdmi_rx[port].timing_t.simple_422 = fmt)
#define SET_H_DSC_NATIVE_420(port, fmt) 	(hdmi_rx[port].timing_t.native_420 = fmt)
#define SET_H_DSC_NATIVE_422(port, fmt) 	(hdmi_rx[port].timing_t.native_422 = fmt)
...
#define GET_H_DSC_VERSION_MINOR(port) 	(hdmi_rx[port].timing_t.dsc_version_minor)
#define GET_H_DSC_CONVERT_RGB(port)	(hdmi_rx[port].timing_t.convert_rgb)
#define GET_H_DSC_SIMPLE_422(port) 	(hdmi_rx[port].timing_t.simple_422)
#define GET_H_DSC_NATIVE_420(port) 	(hdmi_rx[port].timing_t.native_420)
#define GET_H_DSC_NATIVE_422(port) 	(hdmi_rx[port].timing_t.native_422)
...
#define AVMUTE_ON_TO_OFF_TIME_THD    450   // ms
...
typedef struct {
	...
	unsigned int fw_bit_disp_error_overthd_cnt;
...
// -------------------------------------  hdmiHdmi ----------------------------------------------//
extern void newbase_hdmi_spin_lock_init(void);
...
extern unsigned char newbase_hdmi_is_need_check_vic_table(HDMI_AVI_T* avi_info,  HDMI_TIMING_T *tm, unsigned char select_vic, const VIC_TIMING_INFO* vic_timing_info);
...
extern unsigned char newbase_hdmi_get_version_minor(unsigned char port);
extern unsigned char newbase_hdmi_get_convert_rgb(unsigned char port);
extern unsigned char newbase_hdmi_get_simple_422(unsigned char port);
extern unsigned char newbase_hdmi_get_native_420(unsigned char port);
extern unsigned char newbase_hdmi_get_native_422(unsigned char port);
...
extern unsigned int newbase_hdmi_get_device_onms_det_mask(unsigned char port);
