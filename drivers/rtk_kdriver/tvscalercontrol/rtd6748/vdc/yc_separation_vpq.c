...
void module_vpq_VDPQTable_1DSet(unsigned char ucInputSrc, unsigned char ucFormat)
{
	...
	if( ucInputSrc == INPUT_SRC_AV ) {
		module_vpq_DCTI_Table_write(VPQ_POSTP_CTI_FROM_INI[INPUT_SRC_AV][YCSEP_STATUS_1D][ucFormat]);
	} else {
		module_vpq_DCTI_Table_write(VPQ_POSTP_CTI_FROM_INI[INPUT_SRC_TV][YCSEP_STATUS_1D][ucFormat]);
	}
...
void module_vpq_VDPQTable_2DSet(unsigned char ucInputSrc, unsigned char ucFormat)
{
	...
	if( ucInputSrc == INPUT_SRC_AV ) {
		module_vpq_DCTI_Table_write(VPQ_POSTP_CTI_FROM_INI[INPUT_SRC_AV][YCSEP_STATUS_2D3D][ucFormat]);
	} else {
		module_vpq_DCTI_Table_write(VPQ_POSTP_CTI_FROM_INI[INPUT_SRC_TV][YCSEP_STATUS_2D3D][ucFormat]);
	}
