...
typedef enum{
	VPQ_DEV_EXTERN_MEMC_PARAM_LOAD_BIN = 0,
	VPQ_DEV_EXTERN_MEMC_PARAM_MODE_MAX,
} VPQ_DEV_EXTERN_MEMC_PARAM_MODE;
...
unsigned char Scaler_MC_CMA_Memory_Alloc(void);
...
//void Scaler_MEMC_CMA_Memory_Release_StateMachine(void);
