...
void check_scaler_video_latency(void);
void check_scaler_current_video_latency(unsigned char display);
void set_scaler_video_latency_data(unsigned char display, unsigned int latency);
void reset_scaler_video_latency_data(unsigned char display);
...
unsigned char get_ac_on_first_source_connect(void);
void set_ac_on_first_source_connect(unsigned char enable);
...
unsigned char get_bypass_memc_cma_alloc_flag_scaler(void);
void set_bypass_memc_cma_alloc_flag_scaler(unsigned char enable);
unsigned char get_bypass_memc_cma_alloc_flag_ap(void);
void set_bypass_memc_cma_alloc_flag_ap(unsigned char enable);
