...
//---------------------------------------------------------------------------
	...
	rtd_pr_vpq_info("drvif_color_set_fcic_enable, t0-4=%d,%d,%d,%d,%d,pcid1_en=%d,pcid_2_en=%d,LGPOD_en=%d,fcic_en=%d,\n",
		t0, t1, t2, t3, t4, pcid1_en, pcid_2_en, LGPOD_en, fcic_en);
