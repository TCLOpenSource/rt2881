...
unsigned char  drvif_color_Set_I_De_Contour_Enable(unsigned char en)
{
	...
	ipq_decontour_de_contour_ctrl_reg.decont_en = en;
...
unsigned char drvif_color_Set_block_De_Contour_Enable(unsigned char en)
{
	...
	blk_de_contour_ctrl_reg.bdecont_en = en;
	blk_de_contour_ctrl_reg.bdecont_en_c = en;
