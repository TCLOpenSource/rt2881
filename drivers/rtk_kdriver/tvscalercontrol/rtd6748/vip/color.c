...
unsigned char is_HDR_DM_DB_Clean_Waitting = 0;
...
void drvif_color_colorwrite_mixer_gamma1_Enable(unsigned char Enable)
{
	...
	osdovl_mixer_osd_gamma_ctrl_REG.osd_gamma_position = 4;
...
unsigned char drvif_color_get_gamma_enable(unsigned char display)
{
	unsigned char ret=0;
...
void drvif_color_set_gamma_enable(unsigned char display, unsigned char enable)
{
	gamma_gamma_ctrl_2_RBUS gamma_ctrl_2_REG;
...
unsigned char drvif_color_out_gamma_control_enable_Get(void)
{
	outputgamma_out_gamma_ctrl_1_RBUS out_gamma_ctrl_1_REG;
...
char drvif_color_set_DeMura(DRV_DeMura_DMA_TBL* pDMA_TBL, DRV_DeMura_CTRL_TBL *ptr, unsigned char *pArray, unsigned int addr, unsigned int *vir_addr, unsigned int TBL_Line_size, unsigned char unpdateTBL_only)
{
	...
	demura_demura_dma_ctrl_RBUS demura_demura_dma_ctrl_reg;
	...
	*/
	...
	// outstanding
	demura_demura_dma_ctrl_reg.regValue = IoReg_Read32(DEMURA_DEMURA_DMA_CTRL_reg);
	demura_demura_dma_ctrl_reg.max_outstanding = 3;
	IoReg_Write32(DEMURA_DEMURA_DMA_CTRL_reg, demura_demura_dma_ctrl_reg.regValue);
...
unsigned char drvif_color_Get_MEMC_MUX_Enable(void)
{
	unsigned char MEMC_mux_bBgEn;

	MEMC_mux_bBgEn = PPOVERLAY_MEMC_MUX_CTRL_get_memc_out_bg_en(IoReg_Read32(PPOVERLAY_MEMC_MUX_CTRL_reg));

	return MEMC_mux_bBgEn;
}
...
#ifdef CONFIG_RTK_KDRV_NNSR_DISABLE
...
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/0, /*SRS*/0, /*HCIC*/0, /*SLD*/1, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/1, /*A10*/1, /*OD*/0},	/* MEX_LGD_OLED  */
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/0, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/1, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_BOE  */
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/0, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_BOE_120  */
...
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/1, /*SRS*/0, /*HCIC*/0, /*SLD*/1, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/1, /*A10*/1, /*OD*/0},	/* MEX_LGD_OLED  */
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/1, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/1, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_BOE  */
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/1, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_BOE_120  */
...
{/*DEMURA1*/1, /*DEMURA2*/0, /*SRNN*/1, /*SRS*/0, /*HCIC*/0, /*SLD*/0, /*LINE_OD*/1, /*PCLRC*/0, /*VALC*/1, /*POD*/0, /*A10*/0, /*OD*/1},	/* MEX_S_AUO  */
...
void drvif_color_set_Partten4AutoGamma(unsigned char  Enable, unsigned short  r_Val,unsigned short  g_Val,unsigned short  b_Val)
{
	...
	if(Enable)
	{
		...
		intPtnenabled = 1;
		rtd_pr_vpq_info("---------[autogamma] enable=1,rgb=%d,%d,%d ---------\n",r_Val,g_Val,b_Val);
	}
	else
	{
		//table_index = tYUV2RGB_COEF_601_YCbCr_limit2full_range;
		...
		rtd_pr_vpq_info("---------[autogamma] enable=0,rgb=%d,%d,%d ---------\n",r_Val,g_Val,b_Val);
...
unsigned char drvif_Get_NNSR_EFuse_Status(void)
{
	int ret = rtk_otp_field_read_int_by_name("sw_func_nnsr");

	rtd_pr_vpq_info("NNSR_otp_field ret=%d\n", ret);
	if (ret == 0)
		return ret;
	else
		return 1;
