...
//#define ATU_TRANS_ADDR
    /* Register::PCIE_WRAP_CTRL	0x1807E024
        0~4GB: set [33:32]=0x0
        4GB~8GB: set [33:32]=0x1
        8GB~12GB: set [33:32]=0x2
        12GB~16GB: set [33:32]=0x3
    */
#define PCIE_WRAP_PCIE_CTRL_reg 0xb807E024
#ifdef ATU_TRANS_ADDR
    /* translate address over iatu */
    rtd_outl(PCIE_WRAP_PCIE_CTRL_reg,0x03);
#else
    /* translate address over HW 32bit drop */
    rtd_outl(PCIE_WRAP_PCIE_CTRL_reg,0x00);
#endif
