...
#define RTICE_SYS_CMD_READ_PHYS_ADDR  \
	RTICE_OP_CODE(RTICE_CMD_GROUP_ID_SYSTEM, 6)
#define RTICE_SYS_CMD_READ_POWER_VALUE  \
	RTICE_OP_CODE(RTICE_CMD_GROUP_ID_SYSTEM, 7)
...
/*enum for indicating param in PreScale*/
typedef enum{
    apLR = 0,
    apLSRS,
    apCS,
    apCH78,
    ENUM_AUDIO_PreScale_PARAM_SIZE
}ENUM_AUDIO_PreScale_PARAM;
typedef enum{
    apsScale_a = 0,
    apsScale_b,
    ENUM_AUDIO_PreScale_Scale_PARAM_SIZE
}ENUM_AUDIO_PreScale_Scale_PARAM;
