...
static unsigned int bitsAreaValue(unsigned int v, int hbit, int lbit)
{
    unsigned int mask = ((0xFFFFffff >> (32 - (hbit - lbit + 1))) << lbit);
    v = (v & mask) >> lbit;
    return v;
}
/**
...
static int latencyThread(void *data)
{
	...
	while(gStop == 0){
		...
		if(dc_sys_dc_pc_sysh_prog_0_req_num.sysh_prog0_req_num){
			dcMaxLat = gReadOnly ? bitsAreaValue(dc_sys_dc_pc_sysh_prog_0_max_lat.regValue,15,0) : maxValue(bitsAreaValue(dc_sys_dc_pc_sysh_prog_0_max_lat.regValue,15,0),bitsAreaValue(dc_sys_dc_pc_sysh_prog_0_max_lat.regValue,31,16));
		...
		if(dc_sys_dc_pc_sysh_prog_1_req_num.sysh_prog1_req_num){
			dcMaxLat = gReadOnly ? bitsAreaValue(dc_sys_dc_pc_sysh_prog_1_max_lat.regValue,15,0) : maxValue(bitsAreaValue(dc_sys_dc_pc_sysh_prog_1_max_lat.regValue,15,0),bitsAreaValue(dc_sys_dc_pc_sysh_prog_1_max_lat.regValue,31,16));
		...
		if(dc_sys_dc_pc_sysh_prog_2_req_num.sysh_prog2_req_num){
			dcMaxLat = gReadOnly ? bitsAreaValue(dc_sys_dc_pc_sysh_prog_2_max_lat.regValue,15,0) : maxValue(bitsAreaValue(dc_sys_dc_pc_sysh_prog_2_max_lat.regValue,15,0),bitsAreaValue(dc_sys_dc_pc_sysh_prog_2_max_lat.regValue,31,16));
