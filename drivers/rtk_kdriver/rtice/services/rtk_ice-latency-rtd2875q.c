...
static int latencyThread(void *data)
{
	...
	unsigned int dcMaxLat = 0,scpuMaxLat = 0;
	...
	while(gStop == 0){
		...
		/*tvsb0*/
		tvsb0_tv_sb0_dcu1_pc_ctrl_RBUS tvsb0_tv_sb0_dcu1_pc_ctrl;
		tvsb0_tv_sb0_dcu1_pc_prog_0_max_lat_RBUS tvsb0_tv_sb0_dcu1_pc_prog_0_max_lat;
		tvsb0_tv_sb0_dcu1_pc_prog_0_req_num_RBUS tvsb0_tv_sb0_dcu1_pc_prog_0_req_num;
		/*tvsb1*/
		...
		/*start pc--tvsb0*/
		tvsb0_tv_sb0_dcu1_pc_ctrl.pc_rd_only = gReadOnly ? 1 : 0;
		tvsb0_tv_sb0_dcu1_pc_ctrl.pc_go = 1;
		tvsb0_tv_sb0_dcu1_pc_ctrl.pc_prog0_sel = clientId2;
		rtd_outl(TVSB0_TV_SB0_DCU1_PC_CTRL_reg,tvsb0_tv_sb0_dcu1_pc_ctrl.regValue);
		/*start pc--tvsb1*/
		...
		rtd_outl(DC_SYS_DC_PC_CTRL_reg,dc_sys_dc_pc_ctrl.regValue);
		/*stop pc-- tvsb0*/
		tvsb0_tv_sb0_dcu1_pc_ctrl.pc_go = 0;
		rtd_outl(TVSB0_TV_SB0_DCU1_PC_CTRL_reg,tvsb0_tv_sb0_dcu1_pc_ctrl.regValue);
		/*stop pc-- tvsb1*/
		...
		if(dc_sys_dc_pc_sysh_prog_0_req_num.sysh_prog0_req_num){
			dcMaxLat = gReadOnly ? dc_sys_dc_pc_sysh_prog_0_max_lat.sysh_prog0_max_r_lat : maxValue(dc_sys_dc_pc_sysh_prog_0_max_lat.sysh_prog0_max_r_lat,dc_sys_dc_pc_sysh_prog_0_max_lat.sysh_prog0_max_w_lat);
			addLatency(clientId % 16,0,1,dcMaxLat);
		}
		...
		if(dc_sys_dc_pc_sysh_prog_1_req_num.sysh_prog1_req_num){
			dcMaxLat = gReadOnly ? dc_sys_dc_pc_sysh_prog_1_max_lat.sysh_prog1_max_r_lat : maxValue(dc_sys_dc_pc_sysh_prog_1_max_lat.sysh_prog1_max_r_lat,dc_sys_dc_pc_sysh_prog_1_max_lat.sysh_prog1_max_w_lat);
			addLatency((clientId + 1) % 16,0,1,dcMaxLat);
		}
		...
		if(dc_sys_dc_pc_sysh_prog_2_req_num.sysh_prog2_req_num){
			dcMaxLat = gReadOnly ? dc_sys_dc_pc_sysh_prog_2_max_lat.sysh_prog2_max_r_lat : maxValue(dc_sys_dc_pc_sysh_prog_2_max_lat.sysh_prog2_max_r_lat,dc_sys_dc_pc_sysh_prog_2_max_lat.sysh_prog2_max_w_lat);
			addLatency((clientId + 2) % 16,0,1,dcMaxLat);
		}
		/*read latency--tvsb0*/
		tvsb0_tv_sb0_dcu1_pc_prog_0_req_num.regValue = rtd_inl(TVSB0_TV_SB0_DCU1_PC_prog_0_req_num_reg);
		tvsb0_tv_sb0_dcu1_pc_prog_0_max_lat.regValue = rtd_inl(TVSB0_TV_SB0_DCU1_PC_prog_0_max_lat_reg);
		if(tvsb0_tv_sb0_dcu1_pc_prog_0_req_num.prog_req_num)
			addLatency(9,clientId2,0,tvsb0_tv_sb0_dcu1_pc_prog_0_max_lat.prog_max_lat);	
		/*read latency--tvsb1*/
		...
		if(scpu_pc_prog_0_req_num.prog_req_num){
			scpuMaxLat = gReadOnly ? scpu_pc_prog_0_max_lat.prog_max_r_lat : maxValue(scpu_pc_prog_0_max_lat.prog_max_r_lat,scpu_pc_prog_0_max_lat.prog_max_w_lat);
			addLatency(0xf,0,1,scpuMaxLat);
		}
		/*read latency--sb1*/
