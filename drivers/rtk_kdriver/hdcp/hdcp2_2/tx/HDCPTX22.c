...
#include <hdcp/hdcp2_2/HDCPTX22.h>
#include <hdcp/hdcp2_2/HDCPTX22_TestKey.h>
...
if(i == 2)
{
	...
	RCP_HDCP2_GenDKey(hdcptx_parm.mKm, hdcptx_parm.mRtx,hdcptx_parm.mRrx, hdcptx_parm.mRn, 2, dkey_buf,1);
	spu_GetDKey2(dkey_buf);
}
else if(i == 1)
{
	RCP_HDCP2_GenDKey(hdcptx_parm.mKm, hdcptx_parm.mRtx,hdcptx_parm.mRrx, rn_xor_buf, 1, kd_buf,1);
	spu_GetKD(kd_buf);
...
{
	spu_SetKD(kd_buf);
	RCP_HDCP2_GenDKey(hdcptx_parm.mKm, hdcptx_parm.mRtx,hdcptx_parm.mRrx, rn_xor_buf, 0, kd_buf,1);
	spu_GetKD(kd_buf);
