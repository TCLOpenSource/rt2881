...
extern unsigned char g_enable_xhci_panic_dump;
                                        ...
                                        const char *buf, size_t count)
{
        ...
        else if (sscanf(buf, "panic_dump=%x\n", &val) == 1)
        {
                g_enable_xhci_panic_dump = !!val;
        }
	 else if (sscanf(buf, "ehci_dump=%x", &val) == 1)
        {
        	   g_enable_xhci_panic_dump = 1;
