...
static void xhci_init_wrapper_regs(struct rtk_xhci_drd *drd, unsigned int reg_start)
{
        ...
        //usb3 wrapper regs
        priv->wrapper_regs.XHCI_USB3_TOP_WRAP_CTR_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x0;
        priv->wrapper_regs.XHCI_USB3_TOP_GNR_INT_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x4;
        priv->wrapper_regs.XHCI_USB3_TOP_USB2_PHY_UTMI_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x8;
        priv->wrapper_regs.XHCI_USB3_TOP_USB3_PHY_PIPE_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xc;
        priv->wrapper_regs.XHCI_USB3_TOP_MDIO_CTR_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x10;
        priv->wrapper_regs.XHCI_USB3_TOP_VSTATUS0_OUT_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x14;
        priv->wrapper_regs.XHCI_USB3_TOP_SLP_BACK0_EN_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x18;
        priv->wrapper_regs.XHCI_USB3_TOP_SLP_BACK0_CTR_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x1c;
        priv->wrapper_regs.XHCI_USB3_TOP_SLP_BACK0_ST_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x20;
        priv->wrapper_regs.XHCI_USB3_TOP_PHY2_SLB0_EN_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x24;
        priv->wrapper_regs.XHCI_USB3_TOP_PHY2_SLB0_ST_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x28;
        priv->wrapper_regs.XHCI_USB3_TOP_SLP_BACK1_CTR_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x2c;
        priv->wrapper_regs.XHCI_USB3_TOP_SLP_BACK1_ST_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x30;
        priv->wrapper_regs.XHCI_USB3_TOP_PHY2_SLB1_EN_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x34;
        priv->wrapper_regs.XHCI_USB3_TOP_PHY2_SLB1_ST_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x38;

        priv->wrapper_regs.XHCI_USB3_TOP_MDIO_CTR_PORT1_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x4C;

        priv->wrapper_regs.XHCI_USB3_TOP_USB2_SPD_CTR_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x60;
        priv->wrapper_regs.XHCI_USB3_TOP_PHY3_SLB_EN_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x64;
        priv->wrapper_regs.XHCI_USB3_TOP_PHY3_SLB_CT_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x68;
        priv->wrapper_regs.XHCI_USB3_TOP_PHY3_SLB_ST_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x6c;
        priv->wrapper_regs.XHCI_USB3_TOP_USB_DBG_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x70;
        priv->wrapper_regs.XHCI_USB3_TOP_USB_SCTCH_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x74;
        priv->wrapper_regs.XHCI_USB3_TOP_USB_TMP_SP_0_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x78;

        priv->wrapper_regs.XHCI_USB3_TOP_USB_TMP_0_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x80;
        priv->wrapper_regs.XHCI_USB3_TOP_USB_TMP_1_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x84;
        priv->wrapper_regs.XHCI_USB3_TOP_USB_TMP_2_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x88;
        priv->wrapper_regs.XHCI_USB3_TOP_USB_TMP_3_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x8C;
        priv->wrapper_regs.XHCI_USB3_TOP_HMAC_CTR0_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x90;
        priv->wrapper_regs.XHCI_USB3_TOP_HMAC_CTR1_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x94;
        priv->wrapper_regs.XHCI_USB3_TOP_MAC3_HST_ST_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x98;
        priv->wrapper_regs.XHCI_USB3_TOP_USB2_PHY0_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x9C;

        priv->wrapper_regs.XHCI_USB3_TOP_USB2_PHY1_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xa0;

        priv->wrapper_regs.XHCI_USB3_TOP_RAM_CTR_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xac;
        priv->wrapper_regs.XHCI_USB3_TOP_RAM_ADDR_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xb0;
        priv->wrapper_regs.XHCI_USB3_TOP_RAM_WDATA_REG  = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xb4;
        priv->wrapper_regs.XHCI_USB3_TOP_RAM_RDATA_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xb8;
        priv->wrapper_regs.XHCI_USB3_TOP_USB3_OVR_CT_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xc0;
        priv->wrapper_regs.XHCI_USB3_TOP_ANA_PHY0_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xc4;
        priv->wrapper_regs.XHCI_USB2_TOP_ANA_PHY1_REG =  reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xc8;
        priv->wrapper_regs.XHCI_USB3_TOP_GBL_USB_CT_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0xcc;

        priv->wrapper_regs.XHCI_USB3_TOP_CRC_CNT_1_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x154;
        priv->wrapper_regs.XHCI_USB3_TOP_CRC_CNT_2_REG = reg_start + 0xA0000000 + DWC3_WRAP_REGS_OFST + 0x158;
}
...
int rtk_xhci_drd_usb3_phy_init(struct platform_device *pdev)
{
...
int rtk_xhci_drd_usb2_phy_init(struct platform_device *pdev)
{
        int ret = 0;
        struct rtk_xhci_drd *drd = platform_get_drvdata(pdev);
        struct device_node *p_node;
...
int rtk_xhci_drd_usb2_set_phy_from_otp(struct platform_device *pdev)
{
...
{
#ifndef CONFIG_XHCI_DRD_ONLY_MODE
        {
                .compatible = "rtk,xhci-top"
        },
#endif        
        {
                .compatible = "rtk,xhci-drd-top"
        }, 
        {
        }
};
