...
#define dmac_flush_range(a, b)    dcache_clean_inval_poc((unsigned long)a, (unsigned long)b)
#define dmac_inv_range(a, b)      dcache_inval_poc((unsigned long)a, (unsigned long)b)
